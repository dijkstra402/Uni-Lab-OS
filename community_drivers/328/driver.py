...
class Keithley2701VISADriver(Keithley27XXVISADriver):
    """VISA class driver for the Keithley 2701 Multimeter/Switch System
...
if __name__ == "__main__":
    try:
        ...
        # K2701 Instance of KeithleyVISADriver class (replace ASRL1::INSTR by the name of your resource)
        k2701 = Keithley2701VISADriver("ASRL1::INSTR")
        k2701.init_hardware()
        print("IDN?")
        print(k2701.get_idn())
        k2701.reset()
