...
class AttocubeTestApp(BaseMicroscopeApp):
    ...
    def setup(self):
        ...
        from ScopeFoundryHW.attocube_amc100.attocube_amc100_hw import AttoCubeAMC100StageHW
        hw = self.add_hardware(AttoCubeAMC100StageHW(self, ax_names='xyz'))
        ...
        self.add_measurement(AttoCubeStageControlMeasure(self, name='attocube_dev1', hw_name=hw.name))
