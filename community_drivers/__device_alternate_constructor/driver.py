...
Original: generated/nidaqmx/system/device.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver._DeviceAlternateConstructor")
...
__all__ = ["_DeviceAlternateConstructor"]
...
class _DeviceAlternateConstructor(Device):
    ...
    def __init__(self, name, interpreter):
        print("[UNILAB] _DeviceAlternateConstructor.__init__() called", flush=True)
        """
        Args:
