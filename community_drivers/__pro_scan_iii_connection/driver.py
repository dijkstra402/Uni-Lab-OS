...
Original: microscope/controllers/prior.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver._ProScanIIIConnection")
...
class _ProScanIIIConnection:
    ...
    def __init__(self, port: str, baudrate: int, timeout: float) -> None:
        print("[UNILAB] _ProScanIIIConnection.__init__() called", flush=True)
    ...
    def command(self, command: bytes) -> None:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.command() called")
        """Send command to device."""
        with self._lock:
            self._serial.write(command + b"\r")

    def readline(self) -> bytes:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.readline() called")
        """Read a line from the device connection."""
        with self._lock:
            return self._serial.read_until(b"\r")

    def read_until_timeout(self) -> None:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.read_until_timeout() called")
    ...
    def _command_and_validate(self, command: bytes, expected: bytes) -> None:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection._command_and_validate() called")
    ...
    def get_command(self, command: bytes) -> bytes:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.get_command() called")
    ...
    def move_command(self, command: bytes) -> None:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.move_command() called")
    ...
    def set_command(self, command: bytes) -> None:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.set_command() called")
    ...
    def get_description(self, command: bytes) -> bytes:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.get_description() called")
    ...
    def changed_timeout(self, new_timeout: float):
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.changed_timeout() called")
    ...
    def assert_filterwheel_number(self, number: int) -> None:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.assert_filterwheel_number() called")
        assert number > 0 and number < 4

    def _has_thing(self, command: bytes, expected_start: bytes) -> bool:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection._has_thing() called")
    ...
    def has_filterwheel(self, number: int) -> bool:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.has_filterwheel() called")
    ...
    def get_n_filter_positions(self, number: int) -> int:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.get_n_filter_positions() called")
        self.assert_filterwheel_number(number)
        answer = self.get_command(b"FPW %d" % number)
        return int(answer)

    def get_filter_position(self, number: int) -> int:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.get_filter_position() called")
        self.assert_filterwheel_number(number)
        answer = self.get_command(b"7 %d F" % number)
        return int(answer)

    def set_filter_position(self, number: int, pos: int) -> None:
        _unilab_logger.debug("[UNILAB] _ProScanIIIConnection.set_filter_position() called")
        self.assert_filterwheel_number(number)
