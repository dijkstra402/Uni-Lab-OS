...
Original: microscope/controllers/asi.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver._ASIController")
...
class _ASIController:
    ...
    def __init__(self, port: str, baudrate: int, timeout: float) -> None:
        print("[UNILAB] _ASIController.__init__() called", flush=True)
    ...
    def is_busy(self):
        _unilab_logger.debug("[UNILAB] _ASIController.is_busy() called")
        pass

    def get_number_axes(self):
        _unilab_logger.debug("[UNILAB] _ASIController.get_number_axes() called")
        return len(self.axis_list)

    def get_number_leds(self):
        _unilab_logger.debug("[UNILAB] _ASIController.get_number_leds() called")
        return len(self.led_list)

    def command(self, command: bytes) -> None:
        _unilab_logger.debug("[UNILAB] _ASIController.command() called")
        """Send command to device."""
        with self._lock:
            self._serial.write(command + b"\r")

    def readline(self) -> bytes:
        _unilab_logger.debug("[UNILAB] _ASIController.readline() called")
    ...
    def read_multiline(self):
        _unilab_logger.debug("[UNILAB] _ASIController.read_multiline() called")
        output = []
        line = True
        while line:
            line = self.readline()
    ...
    def read_until_timeout(self) -> None:
        _unilab_logger.debug("[UNILAB] _ASIController.read_until_timeout() called")
    ...
    def wait_until_idle(self) -> None:
        _unilab_logger.debug("[UNILAB] _ASIController.wait_until_idle() called")
    ...
    def _command_and_validate(self, command: bytes, expected: bytes) -> bytes:
        _unilab_logger.debug("[UNILAB] _ASIController._command_and_validate() called")
        with self._lock:
    ...
    def get_command(self, command: bytes) -> bytes:
        _unilab_logger.debug("[UNILAB] _ASIController.get_command() called")
    ...
    def set_command(self, command: bytes) -> None:
        _unilab_logger.debug("[UNILAB] _ASIController.set_command() called")
    ...
    def get_description(self, command: bytes) -> bytes:
        _unilab_logger.debug("[UNILAB] _ASIController.get_description() called")
    ...
    def changed_timeout(self, new_timeout: float):
        _unilab_logger.debug("[UNILAB] _ASIController.changed_timeout() called")
    ...
    def move_command(self, command: bytes) -> None:
        _unilab_logger.debug("[UNILAB] _ASIController.move_command() called")
    ...
    def move_by_relative_position(
        ...
        _unilab_logger.debug("[UNILAB] _ASIController.move_by_relative_position() called")
    ...
    def move_to_absolute_position(
        ...
        _unilab_logger.debug("[UNILAB] _ASIController.move_to_absolute_position() called")
        """Send a relative movement command to stated axis"""
        if axis not in self.axis_list:
            raise ValueError(
                f"Axis {axis} not present. Verify the name of the axis or your configuration files."
    ...
    def move_to_limit(self, axis: str, speed: int):
        _unilab_logger.debug("[UNILAB] _ASIController.move_to_limit() called")
        if axis not in self.axis_list:
            raise ValueError(
                f"Axis {axis} not present. Verify the name of the axis or your configuration files."
            )
    ...
    def motor_moving(self, axis: str) -> int:
        _unilab_logger.debug("[UNILAB] _ASIController.motor_moving() called")
        if axis not in self.axis_list:
            raise ValueError(
                f"Axis {axis} not present. Verify the name of the axis or your configuration files."
            )
    ...
    def set_speed(self, axis: str, speed: float) -> None:
        _unilab_logger.debug("[UNILAB] _ASIController.set_speed() called")
        if axis not in self.axis_list:
            raise ValueError(
                f"Axis {axis} not present. Verify the name of the axis or your configuration files."
            )
    ...
    def find_max_speed(self, axis: str):
        _unilab_logger.debug("[UNILAB] _ASIController.find_max_speed() called")
        if axis not in self.axis_list:
            raise ValueError(
                f"Axis {axis} not present. Verify the name of the axis or your configuration files."
            )
    ...
    def wait_for_motor_stop(self, axis: str):
        _unilab_logger.debug("[UNILAB] _ASIController.wait_for_motor_stop() called")
    ...
    def reset_position(self, axis: str):
        _unilab_logger.debug("[UNILAB] _ASIController.reset_position() called")
        if axis not in self.axis_list:
            raise ValueError(
                f"Axis {axis} not present. Verify the name of the axis or your configuration files."
            )
    ...
    def get_absolute_position(self, axis: str) -> float:
        _unilab_logger.debug("[UNILAB] _ASIController.get_absolute_position() called")
        if axis not in self.axis_list:
            raise ValueError(
                f"Axis {axis} not present. Verify the name of the axis or your configuration files."
            )
    ...
    def is_led_on(self, channel):
        _unilab_logger.debug("[UNILAB] _ASIController.is_led_on() called")
        return bool(self.get_led_power(channel))

    def get_led_power(self, channel):
        _unilab_logger.debug("[UNILAB] _ASIController.get_led_power() called")
        answer = self.get_command(b"LED " + self.led_list[channel] + b"?")
        return int(answer[3:-4]) / 100

    def set_led_power(self, channel, power):
        _unilab_logger.debug("[UNILAB] _ASIController.set_led_power() called")
