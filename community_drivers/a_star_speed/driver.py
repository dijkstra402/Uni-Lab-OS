...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AStarSpeed")
...
class AStarSpeed:
    def __init__(self):
        print("[UNILAB] AStarSpeed.__init__() called", flush=True)
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] AStarSpeed.update() called")
    ...
    def run_threaded(self):
        _unilab_logger.debug("[UNILAB] AStarSpeed.run_threaded() called")
        return self.speed # , self.linaccel

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] AStarSpeed.shutdown() called")
        # indicate that the thread should be stopped
        self.on = False
