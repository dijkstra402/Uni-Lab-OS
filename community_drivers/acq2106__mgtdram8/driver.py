...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Acq2106_Mgtdram8")
...
class Acq2106_Mgtdram8(Acq2106):
    ...
    def __init__(self, uut, monitor=True, s0_client=None):
        print("[UNILAB] Acq2106_Mgtdram8.__init__() called", flush=True)
    ...
    def run_mgt(self, filter = null_filter, set_arm=True):
        _unilab_logger.debug("[UNILAB] Acq2106_Mgtdram8.run_mgt() called")
        pm = ProcessMonitor(self, AcqPorts.MGTDRAM, filter, set_arm)
        while pm.quit_requested != True:
            time.sleep(1)

    def create_mgtdram_pull_client(self):
        _unilab_logger.debug("[UNILAB] Acq2106_Mgtdram8.create_mgtdram_pull_client() called")
