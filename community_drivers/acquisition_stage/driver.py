...
Original: pymepix/processing/baseacquisition.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AcquisitionStage")
...
class AcquisitionStage(Logger):
    ...
    def __init__(self, stage, num_processes=1):
        print("[UNILAB] AcquisitionStage.__init__() called", flush=True)
    ...
    @property
    def stage(self):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.stage() called")
    ...
    @property
    def numProcess(self):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.numProcess() called")
    ...
    def configureStage(self, pipeline_klass, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.configureStage() called")
    ...
    def setArgs(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.setArgs() called")
        self._args = args
        self._kwargs = kwargs

    @property
    def processes(self):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.processes() called")
        return self._pipeline_objects

    def build(self, input_queue=None, output_queue=None):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.build() called")
...
#                self._output_queue = p.outputQueues()[-1]
    ...
    def outputQueue(self):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.outputQueue() called")
        return self._output_queue

    def start(self):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.start() called")
    ...
    def stop(self, force=False):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.stop() called")
    ...
    def startTrainID(self):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.startTrainID() called")
    ...
    def stopTrainID(self):
        _unilab_logger.debug("[UNILAB] AcquisitionStage.stopTrainID() called")
