...
Original: core/src/drivers/plugins/python/opcua/address_space.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AddressSpaceBuilder")
...
# Vendored repo packages: core.src.drivers.plugins.python.opcua
import sys as _sys
...
try:
    from core.src.drivers.plugins.python.opcua.opcua_logging import log_debug, log_error, log_info, log_warn
    from core.src.drivers.plugins.python.opcua.opcua_types import VariableNode
    from core.src.drivers.plugins.python.opcua.opcua_utils import map_plc_to_opcua_type, convert_value_for_opcua
except ImportError:
...
class AddressSpaceBuilder:
    ...
    def __init__(
        ...
        print("[UNILAB] AddressSpaceBuilder.__init__() called", flush=True)
        """
    ...
    async def build(self) -> bool:
        _unilab_logger.debug("[UNILAB] AddressSpaceBuilder.build() called")
        """
    ...
    async def _create_simple_variable(
        ...
        _unilab_logger.debug("[UNILAB] AddressSpaceBuilder._create_simple_variable() called")
        """
    ...
    async def _create_struct(
        ...
        _unilab_logger.debug("[UNILAB] AddressSpaceBuilder._create_struct() called")
        """
    ...
    async def _create_struct_field(
        ...
        _unilab_logger.debug("[UNILAB] AddressSpaceBuilder._create_struct_field() called")
        """
    ...
    async def _create_array(
        ...
        _unilab_logger.debug("[UNILAB] AddressSpaceBuilder._create_array() called")
        """
    ...
    def _check_write_permission(self, permissions: VariablePermissions) -> bool:
        _unilab_logger.debug("[UNILAB] AddressSpaceBuilder._check_write_permission() called")
        """
    ...
    def get_variable_indices(self) -> list:
        _unilab_logger.debug("[UNILAB] AddressSpaceBuilder.get_variable_indices() called")
        """Get list of all variable indices for memory cache initialization."""
        return list(self.variable_nodes.keys())

__all__ = ["AddressSpaceBuilder"]
