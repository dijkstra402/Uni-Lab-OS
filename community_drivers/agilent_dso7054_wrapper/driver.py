...
Original: EGGS_labrad/servers/oscilloscopes/AgilentDSO7054.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AgilentDSO7054Wrapper")
...
class AgilentDSO7054Wrapper(GPIBDeviceWrapper):
    def __init__(self, guid, name):
        print("[UNILAB] AgilentDSO7054Wrapper.__init__() called", flush=True)
    ...
    @inlineCallbacks
    def reset(self):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.reset() called")
        yield self.write('*RST')

    @inlineCallbacks
    def clear_buffers(self):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.clear_buffers() called")
        yield self.write('*CLS')

    @inlineCallbacks
    def autoscale(self):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.autoscale() called")
        yield self.write(':AUT')

    # CHANNEL
    @inlineCallbacks
    def channel_info(self, channel):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.channel_info() called")
    ...
    def channel_coupling(self, channel, coupling=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.channel_coupling() called")
    ...
    def channel_scale(self, channel, scale=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.channel_scale() called")
    ...
    def channel_probe(self, channel, atten=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.channel_probe() called")
    ...
    def channel_toggle(self, channel, state=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.channel_toggle() called")
    ...
    def channel_invert(self, channel, invert=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.channel_invert() called")
    ...
    def channel_position(self, channel, position=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.channel_position() called")
    ...
    def trigger_channel(self, channel=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.trigger_channel() called")
    ...
    def trigger_slope(self, slope=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.trigger_slope() called")
    ...
    def trigger_level(self, channel, level=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.trigger_level() called")
    ...
    def trigger_mode(self, mode=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.trigger_mode() called")
        chString = ':TRIG:SWE'
        if mode is not None:
    ...
    def horizontal_offset(self, offset=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.horizontal_offset() called")
        chString = 'TIM:POS'
    ...
    def horizontal_scale(self, scale=None):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.horizontal_scale() called")
        chString = ':TIM:SCAL'
        if scale is not None:
    ...
    def trace(self, channel, points=1250000):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.trace() called")
        """
    ...
    def measure_setup(self, slot, channel, param):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.measure_setup() called")
    ...
    def measure(self, slot):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper.measure() called")
        valid_measurement_parameters = {
            "FREQ": "FREQ", "AMP": "VAMP", "MEAN": "VAV", "MAX": "VMAX", "MIN": "VMIN", "P2P": "VPP"
        }
    ...
    def _parsePreamble(preamble):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper._parsePreamble() called")
        """
    ...
    def _parseByteData(data):
        _unilab_logger.debug("[UNILAB] AgilentDSO7054Wrapper._parseByteData() called")
        """
        Parse byte data.
        """
