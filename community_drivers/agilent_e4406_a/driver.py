...
Original: src/labtoolkit/SpectrumAnalyser/AgilentE4406A.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AgilentE4406A")
...
class AgilentE4406A(IEEE488, SCPI):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] AgilentE4406A.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def __post__(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.__post__() called")
    ...
    @property
    def frequency(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.frequency() called")
    ...
    @property
    def span(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.span() called")
    ...
    @property
    def resbw(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.resbw() called")
    ...
    def screenshot(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.screenshot() called")
    ...
    def trace_prototype(self, kind):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.trace_prototype() called")
        """."""
    ...
    def measure_power_at_marker(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.measure_power_at_marker() called")
        timeout = self.inst.timeout
    ...
    def concatenator(self, start_freq, stop_freq, span=10e6):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.concatenator() called")
    ...
    @property
    def rfgain(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.rfgain() called")
    ...
    def resbw_ratio(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.resbw_ratio() called")
        return self.resbw * self.aper

    @property
    def decim(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.decim() called")
        return round(1.0 / (self.resbw * self.aper))

    @property
    def decimated_bw(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.decimated_bw() called")
    ...
    @aper.setter
    def aper(self, aper):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.aper() called")
        self.write(f'APER {aper}')

    @property
    def time(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.time() called")
    ...
    @property
    def stateiq(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.stateiq() called")
        return {
    ...
    def iqinit(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.iqinit() called")
    ...
    def iqrelease(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.iqrelease() called")
    ...
    def iq(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.iq() called")
    ...
    '''
    def MeasureIQ(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.MeasureIQ() called")
        """."""
    ...
    def trace(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.trace() called")
        self.write(':FORMat REAL,32')
        self.write(':FORMat:BORDer SWAPped')
    ...
    def VOID(self):
        _unilab_logger.debug("[UNILAB] AgilentE4406A.VOID() called")
        """
        Void.
