...
Original: src/labtoolkit/SpectrumAnalyser/AgilentE44nn.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AgilentE44nn")
...
class AgilentE44nn(IEEE488, SCPI):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] AgilentE44nn.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def __post__(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.__post__() called")
    ...
    @property
    def select(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.select() called")
        """."""
    ...
    @property
    def frequency(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.frequency() called")
        """Center frequency."""
    ...
    def frequency_center(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.frequency_center() called")
        """Center frequency."""
    ...
    def frequency_span(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.frequency_span() called")
        """Frequency Span."""
    ...
    def frequency_start(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.frequency_start() called")
        """Frequency Start."""
    ...
    def frequency_stop(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.frequency_stop() called")
        """Frequency Stop."""
    ...
    def sweep_points(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.sweep_points() called")
        """Sweep Points."""
    ...
    def sweep_points_max(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.sweep_points_max() called")
        return self.query_int(':SWEep:POINts? MAX')

    @property
    def view_range(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.view_range() called")
    ...
    @property
    def sweep_time(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.sweep_time() called")
        """Sweep Time."""
    ...
    def reference_level(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.reference_level() called")
        """Reference level."""
    ...
    def resolution_bandwidths(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.resolution_bandwidths() called")
        rbws = []
    ...
    def resolution_bandwidth(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.resolution_bandwidth() called")
    ...
    def video_bandwidth(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.video_bandwidth() called")
        """Video Bandwidth."""
        # N9030B  1 Hz to 3 MHz (10% steps), 4, 5, 6, 8 MHz
    ...
    @property
    def unit_power(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.unit_power() called")
        """Unit Power."""
    ...
    def detector(self, detector):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.detector() called")
    ...
    def input_attenuator(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.input_attenuator() called")
    ...
    @property
    def continuous(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.continuous() called")
    ...
    def input_attenuator_auto(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.input_attenuator_auto() called")
    ...
    @property
    def trace_type(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.trace_type() called")
    ...
    def external_gain(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.external_gain() called")
    ...
    @property
    def trace_data(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.trace_data() called")
        # :INST:SEL?
        # SA
    ...
    def screenshot(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.screenshot() called")
    ...
    @property
    def trace(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.trace() called")
        if self.select == 'SA':
    ...
    @property
    def trace_sa(self):
        _unilab_logger.debug("[UNILAB] AgilentE44nn.trace_sa() called")
