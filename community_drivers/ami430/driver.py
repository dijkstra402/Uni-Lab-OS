...
Original: pycqed/instrument_drivers/physical_instruments/american_magnetics/AMI430.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AMI430")
...
class AMI430(IPInstrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] AMI430.__init__() called", flush=True)
    ...
    def _can_start_ramping(self):
        _unilab_logger.debug("[UNILAB] AMI430._can_start_ramping() called")
        """
    ...
    def _ramp_to(self, value):
        _unilab_logger.debug("[UNILAB] AMI430._ramp_to() called")
    ...
    def _get_ramp_rate(self):
        _unilab_logger.debug("[UNILAB] AMI430._get_ramp_rate() called")
    ...
    def _set_ramp_rate(self, rate):
        _unilab_logger.debug("[UNILAB] AMI430._set_ramp_rate() called")
    ...
    def _set_persistent_switch(self, on):
        _unilab_logger.debug("[UNILAB] AMI430._set_persistent_switch() called")
        """
    ...
    def _connect(self):
        _unilab_logger.debug("[UNILAB] AMI430._connect() called")
        """
...
class AMI430_3D(Instrument):
    ...
    def _set_fields(self, values):
        _unilab_logger.debug("[UNILAB] AMI430._set_fields() called")
        """
    ...
    def _request_field_change(self, instrument, value):
        _unilab_logger.debug("[UNILAB] AMI430._request_field_change() called")
        """
    ...
    def _get_measured(self, *names):
        _unilab_logger.debug("[UNILAB] AMI430._get_measured() called")
    ...
    def _get_setpoints(self, *names):
        _unilab_logger.debug("[UNILAB] AMI430._get_setpoints() called")
    ...
    def _set_cartesian(self, values):
        _unilab_logger.debug("[UNILAB] AMI430._set_cartesian() called")
        x, y, z = values
        self._set_point.set_vector(x=x, y=y, z=z)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_x(self, x):
        _unilab_logger.debug("[UNILAB] AMI430._set_x() called")
        self._set_point.set_component(x=x)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_y(self, y):
        _unilab_logger.debug("[UNILAB] AMI430._set_y() called")
        self._set_point.set_component(y=y)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_z(self, z):
        _unilab_logger.debug("[UNILAB] AMI430._set_z() called")
        self._set_point.set_component(z=z)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_spherical(self, values):
        _unilab_logger.debug("[UNILAB] AMI430._set_spherical() called")
        r, theta, phi = values
        self._set_point.set_vector(r=r, theta=theta, phi=phi)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_r(self, r):
        _unilab_logger.debug("[UNILAB] AMI430._set_r() called")
        self._set_point.set_component(r=r)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_theta(self, theta):
        _unilab_logger.debug("[UNILAB] AMI430._set_theta() called")
        self._set_point.set_component(theta=theta)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_phi(self, phi):
        _unilab_logger.debug("[UNILAB] AMI430._set_phi() called")
        self._set_point.set_component(phi=phi)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_cylindrical(self, values):
        _unilab_logger.debug("[UNILAB] AMI430._set_cylindrical() called")
        rho, phi, z = values
        self._set_point.set_vector(rho=rho, phi=phi, z=z)
        self._set_fields(self._set_point.get_components("x", "y", "z"))

    def _set_rho(self, rho):
        _unilab_logger.debug("[UNILAB] AMI430._set_rho() called")
