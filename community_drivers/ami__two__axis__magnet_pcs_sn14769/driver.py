...
Original: pycqed/instrument_drivers/meta_instrument/AMI_Two_Axis_Magnet_with_PCS_SN14769.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AMI_Two_Axis_Magnet_PCS_SN14769")
...
class AMI_Two_Axis_Magnet_PCS_SN14769(Instrument):
    ...
    def get_all(self):
        print("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.__init__() called", flush=True)
    ...
    def get_source_current_z(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_source_current_z() called")
        return self.i_magnet_z.measurei()

    def get_source_current_y(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_source_current_y() called")
        return self.i_magnet_y.measurei()

    def set_source_current_z(self,current):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_source_current_z() called")
        self.i_magnet_z.seti(current)
        return 'Z-current set to '+str(current)+' A'

    def set_source_current_y(self,current):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_source_current_y() called")
        self.i_magnet_y.seti(current)
        return 'Y-current set to '+str(current)+' A'

    def get_heater_current_z(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_heater_current_z() called")
        return self.heater_mvolt_to_current_z*self.i_heater_z()

    def get_heater_current_y(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_heater_current_y() called")
        return self.heater_mvolt_to_current_y*self.i_heater_y()


    def get_switch_state_z(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_switch_state_z() called")
    ...
    def get_switch_state_y(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_switch_state_y() called")
    ...
    def set_switch_state_z(self,desired_state):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_switch_state_z() called")
    ...
    def set_switch_state_y(self,desired_state):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_switch_state_y() called")
        if desired_state == 'SuperConducting' and\
    ...
    def set_field(self,field):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_field() called")
    ...
    def get_field(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_field() called")
    ...
    def set_angle(self,angle):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_angle() called")
        if not self.protection_state:
            return 0.
        field = self.field()
    ...
    def get_angle(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_angle() called")
        # return 0.0 # Only add this line when doing the first initialization!
        if self.switch_state_z()=='SuperConducting':
            ## get the persistent field from the HDF5 file
    ...
    def set_field_z(self,field):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_field_z() called")
        if not self.protection_state:
            return 0.
        if self.switch_state_z() == 'SuperConducting':
    ...
    def set_field_y(self,field):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.set_field_y() called")
        if not self.protection_state:
            return 0.
        if self.switch_state_y() == 'SuperConducting':
    ...
    def get_field_z(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_field_z() called")
        # return 0.0 # Only add this line when doing the first initialization!
        if self.switch_state_z()=='SuperConducting':
            ## get the persistent field from the HDF5 file
    ...
    def get_field_y(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.get_field_y() called")
        # return 0.0 # Only add this line when doing the first initialization!
        if self.switch_state_y()=='SuperConducting':
            ## get the persistent field from the HDF5 file
    ...
    def step_z_magfield_to_value(self, field):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.step_z_magfield_to_value() called")
    ...
    def step_y_magfield_to_value(self, field):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.step_y_magfield_to_value() called")
    ...
    def disconnect_z_source(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.disconnect_z_source() called")
        if self.switch_state_z() == 'SuperConducting':
    ...
    def disconnect_y_source(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.disconnect_y_source() called")
        if self.switch_state_y() == 'SuperConducting':
    ...
    def bring_z_source_to_field(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.bring_z_source_to_field() called")
    ...
    def bring_y_source_to_field(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.bring_y_source_to_field() called")
    ...
    def measure_field_z(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.measure_field_z() called")
    ...
    def measure_field_y(self):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.measure_field_y() called")
    ...
    def BtoI_z(self, magfield):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.BtoI_z() called")
        MagCurrRatio = self.field_to_current_z # Tesla/Ampere
        I = magfield/MagCurrRatio
        return I

    def BtoI_y(self, magfield):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.BtoI_y() called")
        MagCurrRatio = self.field_to_current_y # Tesla/Ampere
        I = magfield/MagCurrRatio
        return I

    def ItoB_z(self, current):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.ItoB_z() called")
        MagCurrRatio = self.field_to_current_z # Tesla/Ampere
        B = current*MagCurrRatio
        return B

    def ItoB_y(self, current):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.ItoB_y() called")
        MagCurrRatio = self.field_to_current_y # Tesla/Ampere
        B = current*MagCurrRatio
        return B

    def fake_folder(self,folder_name):
        _unilab_logger.debug("[UNILAB] AMI_Two_Axis_Magnet_PCS_SN14769.fake_folder() called")
        '''
