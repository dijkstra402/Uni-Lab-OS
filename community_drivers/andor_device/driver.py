...
Original: wasatch/AndorDevice.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AndorDevice")
...
class AndorDevice(InterfaceDevice):
    ...
    def __init__(self, device_id, message_queue=None, alert_queue=None):
        print("[UNILAB] AndorDevice.__init__() called", flush=True)
    ...
    def _queue_message(self, setting, value):
        _unilab_logger.debug("[UNILAB] AndorDevice._queue_message() called")
        """
    ...
    def not_implemented(self):
        _unilab_logger.debug("[UNILAB] AndorDevice.not_implemented() called")
        pass

    def _init_process_funcs(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._init_process_funcs() called")
        process_f = {}
    ...
    def high_gain_mode_enable(self, enabled):
        _unilab_logger.debug("[UNILAB] AndorDevice.high_gain_mode_enable() called")
        if enabled:
    ...
    def set_fan_enable(self, x):
        _unilab_logger.debug("[UNILAB] AndorDevice.set_fan_enable() called")
        self.check_result(self.driver.SetFanMode(int(x)), f"Andor Fan On {x}")
        return SpectrometerResponse()

    def _get_default_data_dir(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._get_default_data_dir() called")
        if os.name == "nt":
    ...
    def _check_config_file(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._check_config_file() called")
    ...
    def _get_spectrum_raw(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._get_spectrum_raw() called")
        """
    ...
    def _take_one_averaged_reading(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._take_one_averaged_reading() called")
        """ 
    ...
    def get_detector_temperature_degC(self):
        _unilab_logger.debug("[UNILAB] AndorDevice.get_detector_temperature_degC() called")
        if self.tec_enabled:
    ...
    def _close_ex_shutter(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._close_ex_shutter() called")
    ...
    def _open_ex_shutter(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._open_ex_shutter() called")
    ...
    def check_result(self, result, func):
        _unilab_logger.debug("[UNILAB] AndorDevice.check_result() called")
        if result != self.SUCCESS:
    ...
    def connect(self):
        _unilab_logger.debug("[UNILAB] AndorDevice.connect() called")
        if self.dll_fail:
    ...
    def set_take_one_request(self, tor):
        _unilab_logger.debug("[UNILAB] AndorDevice.set_take_one_request() called")
        log.debug(f"set_take_one_request: storing {tor}")
        self.take_one_request = tor

    def set_vertical_binning(self, roi):
        _unilab_logger.debug("[UNILAB] AndorDevice.set_vertical_binning() called")
        """
    ...
    def save_config(self, eeprom=None):
        _unilab_logger.debug("[UNILAB] AndorDevice.save_config() called")
        """
    ...
    def update_config_from_eeprom(self, eeprom):
        _unilab_logger.debug("[UNILAB] AndorDevice.update_config_from_eeprom() called")
        """ 
    ...
    def _load_config_values(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._load_config_values() called")
        """
    ...
    def acquire_data(self):
        _unilab_logger.debug("[UNILAB] AndorDevice.acquire_data() called")
    ...
    def set_shutter_enable(self, enable):
        _unilab_logger.debug("[UNILAB] AndorDevice.set_shutter_enable() called")
        if enable:
    ...
    def set_integration_time_ms(self, ms):
        _unilab_logger.debug("[UNILAB] AndorDevice.set_integration_time_ms() called")
    ...
    def toggle_tec(self, toggle_state):
        _unilab_logger.debug("[UNILAB] AndorDevice.get_serial_number() called")
    ...
    def set_tec_setpoint(self, set_temp):
        _unilab_logger.debug("[UNILAB] AndorDevice.set_tec_setpoint() called")
    ...
    def init_detector_area(self):
        _unilab_logger.debug("[UNILAB] AndorDevice.init_detector_area() called")
        xPixels = c_int()
        yPixels = c_int()
    ...
    def _obtain_gain_info(self):
        _unilab_logger.debug("[UNILAB] AndorDevice._obtain_gain_info() called")
        num_gains = c_int()
    ...
    def init_detector_speed(self):
        _unilab_logger.debug("[UNILAB] AndorDevice.init_detector_speed() called")
        speed = c_float()
    ...
    def set_scans_to_average(self, value):
        _unilab_logger.debug("[UNILAB] AndorDevice.set_scans_to_average() called")
        value = int(value)
    ...
    def get_error_code_long(self, code):
        _unilab_logger.debug("[UNILAB] AndorDevice.get_error_code_long() called")
    ...
    def get_error_code(self, code):
        _unilab_logger.debug("[UNILAB] AndorDevice.get_error_code() called")
        if code in self.error_codes:
    ...
    def load_error_codes(self):
        _unilab_logger.debug("[UNILAB] AndorDevice.load_error_codes() called")
        self.error_codes = {
