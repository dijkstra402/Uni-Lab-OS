...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.APTPiezoInertiaActuator")
...
class APTPiezoInertiaActuator(APTPiezoDevice):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] APTPiezoInertiaActuator.__init__() called", flush=True)
    ...
    class PiezoChannel(APTPiezoDevice.PiezoDeviceChannel):
        ...
        def drive_op_parameters(self):
            _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.drive_op_parameters() called")
        ...
        def enabled_single(self):
            _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.enabled_single() called")
        ...
        def jog_parameters(self):
            _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.jog_parameters() called")
        ...
        def position_count(self):
            _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.position_count() called")
        ...
        def move_abs(self, pos):
            _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.move_abs() called")
            """
        ...
        def move_jog(self, direction="fwd"):
            _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.move_jog() called")
            """
        ...
        def move_jog_stop(self):
            _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.move_jog_stop() called")
    ...
    def enabled_multi(self):
        _unilab_logger.debug("[UNILAB] APTPiezoInertiaActuator.enabled_multi() called")
