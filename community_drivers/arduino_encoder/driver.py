...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ArduinoEncoder")
...
class ArduinoEncoder(object):
    def __init__(self, mm_per_tick=0.0000599, debug=False):
        print("[UNILAB] ArduinoEncoder.__init__() called", flush=True)
        import serial
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] ArduinoEncoder.update() called")
        while self.on:
            input = ''
    ...
    def run_threaded(self):
        _unilab_logger.debug("[UNILAB] ArduinoEncoder.run_threaded() called")
        self.speed 
        return self.speed 


    def shutdown(self):
        _unilab_logger.debug("[UNILAB] ArduinoEncoder.shutdown() called")
