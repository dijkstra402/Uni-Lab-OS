...
Original: src/science_jubilee/tools/AS7341.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AS7341")
...
class AS7341(Tool):
    ...
    def __init__(self, index, name, config):
        print("[UNILAB] AS7341.__init__() called", flush=True)
        """Constructor method"""
    ...
    def load_config(self, config):
        _unilab_logger.debug("[UNILAB] AS7341.load_config() called")
    ...
    def find_seeed(self) -> List[serial.Serial]:
        _unilab_logger.debug("[UNILAB] AS7341.find_seeed() called")
    ...
    def connect_seeed(self, ser_port_index: int = 0) -> serial.Serial:
        _unilab_logger.debug("[UNILAB] AS7341.connect_seeed() called")
    ...
    def disconnect_seeed(self) -> bool:
        _unilab_logger.debug("[UNILAB] AS7341.disconnect_seeed() called")
    ...
    def blink(self, cmd: Union[int, str]) -> None:
        _unilab_logger.debug("[UNILAB] AS7341.blink() called")
    ...
    def measure_spectrum(self, duty_cycle: int = 100) -> Dict[str, Any]:
        _unilab_logger.debug("[UNILAB] AS7341.measure_spectrum() called")
    ...
    def get_raw_spectrum(self, duty_cycle: int = 100) -> str:
        _unilab_logger.debug("[UNILAB] AS7341.get_raw_spectrum() called")
