...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AsciiAxis")
...
class AsciiAxis(object):
    ...
    def __init__(self, device, number):
        print("[UNILAB] AsciiAxis.__init__() called", flush=True)
        """
        Args:
    ...
    def send(self, message):
        _unilab_logger.debug("[UNILAB] AsciiAxis.send() called")
    ...
    def home(self):
        _unilab_logger.debug("[UNILAB] AsciiAxis.home() called")
    ...
    def move_abs(self, position, blocking = True):
        _unilab_logger.debug("[UNILAB] AsciiAxis.move_abs() called")
    ...
    def move_rel(self, distance, blocking = True):
        _unilab_logger.debug("[UNILAB] AsciiAxis.move_rel() called")
    ...
    def move_vel(self, speed, blocking = False):
        _unilab_logger.debug("[UNILAB] AsciiAxis.move_vel() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] AsciiAxis.stop() called")
    ...
    def get_status(self):
        _unilab_logger.debug("[UNILAB] AsciiAxis.get_status() called")
    ...
    def poll_until_idle(self):
        _unilab_logger.debug("[UNILAB] AsciiAxis.poll_until_idle() called")
