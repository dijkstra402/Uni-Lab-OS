...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ASCIIScanFile")
...
class ASCIIScanFile(ScanFile):
    ...
    def write_lines(self, buff):
        print("[UNILAB] ASCIIScanFile.__init__() called", flush=True)
    ...
    def write_extrapvs(self):
        _unilab_logger.debug("[UNILAB] ASCIIScanFile.write_extrapvs() called")
        "write extra PVS"
    ...
    def write_scanparams(self):
        _unilab_logger.debug("[UNILAB] ASCIIScanFile.write_scanparams() called")
    ...
    def write_timestamp(self, label='Now'):
        _unilab_logger.debug("[UNILAB] ASCIIScanFile.write_timestamp() called")
        "write timestamp"
        self.write_lines([f"{COM1} Scan.{label}: {get_timestamp()}"])

    def write_comments(self):
        _unilab_logger.debug("[UNILAB] ASCIIScanFile.write_comments() called")
        "write comment lines"
    ...
    def write_legend(self):
        _unilab_logger.debug("[UNILAB] ASCIIScanFile.write_legend() called")
        "write legend"
        cols = []
        icol = 0
    ...
    def write_data(self, breakpoint=0, clear=False, close_file=False, verbose=False):
        _unilab_logger.debug("[UNILAB] ASCIIScanFile.write_data() called")
        "write data"
        if breakpoint == 0:
    ...
    def read(self, filename=None):
        _unilab_logger.debug("[UNILAB] ASCIIScanFile.read() called")
        return StepScanData(filename)

__all__ = ["ASCIIScanFile"]
