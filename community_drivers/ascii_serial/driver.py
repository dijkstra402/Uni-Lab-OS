...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AsciiSerial")
...
class AsciiSerial(object):
    ...
    def __init__(self, port, baud = 115200, timeout = 5, inter_char_timeout = 0.01):
        print("[UNILAB] AsciiSerial.__init__() called", flush=True)
        """
        Args:
    ...
    def write(self, command):
        _unilab_logger.debug("[UNILAB] AsciiSerial.write() called")
    ...
    def read(self):
        _unilab_logger.debug("[UNILAB] AsciiSerial.read() called")
    ...
    def flush(self):
        _unilab_logger.debug("[UNILAB] AsciiSerial.flush() called")
        """Flushes the buffers of the underlying serial port."""
        self._ser.flush()

    def open(self):
        _unilab_logger.debug("[UNILAB] AsciiSerial.open() called")
        """Opens the serial port."""
        self._ser.open()

    def close(self):
        _unilab_logger.debug("[UNILAB] AsciiSerial.close() called")
        """Closes the serial port."""
        self._ser.close()

    def __enter__(self):
        _unilab_logger.debug("[UNILAB] AsciiSerial.__enter__() called")
        return self 

    def __exit__(self, exc_type, exc_value, traceback):
        _unilab_logger.debug("[UNILAB] AsciiSerial.__exit__() called")
        self.close()

    @property
    def timeout(self):
        _unilab_logger.debug("[UNILAB] AsciiSerial.timeout() called")
    ...
    @property
    def baudrate(self):
        _unilab_logger.debug("[UNILAB] AsciiSerial.baudrate() called")
