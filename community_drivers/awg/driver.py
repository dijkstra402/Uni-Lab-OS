...
Original: src/zhinst/qcodes/driver/devices/hdawg.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AWG")
...
class AWG(ZINode):
    ...
    def __init__(self, parent, tk_object, index, snapshot_cache=None, zi_node=None):
        print("[UNILAB] AWG.__init__() called", flush=True)
        ZINode.__init__(
    ...
    def enable_sequencer(self, *, single: bool) -> None:
        _unilab_logger.debug("[UNILAB] AWG.enable_sequencer() called")
    ...
    def wait_done(self, *, timeout: float = 10, sleep_time: float = 0.005) -> None:
        _unilab_logger.debug("[UNILAB] AWG.wait_done() called")
    ...
    def compile_sequencer_program(
        ...
        _unilab_logger.debug("[UNILAB] AWG.compile_sequencer_program() called")
    ...
    def load_sequencer_program(
        ...
        _unilab_logger.debug("[UNILAB] AWG.load_sequencer_program() called")
    ...
    def write_to_waveform_memory(
        ...
        _unilab_logger.debug("[UNILAB] AWG.write_to_waveform_memory() called")
    ...
    def read_from_waveform_memory(self, indexes: List[int] = None) -> Waveforms:
        _unilab_logger.debug("[UNILAB] AWG.read_from_waveform_memory() called")
