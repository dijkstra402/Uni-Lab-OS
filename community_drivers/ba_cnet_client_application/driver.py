...
Original: samples/polling_bac_client.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BACnetClientApplication")
...
# Vendored repo packages: samples, misty
import sys as _sys
...
class BACnetClientApplication(MSTPSimpleApplication):
    ...
    def __init__(self, localDevice=None, localAddress=None):
        print("[UNILAB] BACnetClientApplication.__init__() called", flush=True)
    ...
    def request(self, apdu):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.request() called")
        # forward it along
        MSTPSimpleApplication.request(self, apdu)

    def indication(self, apdu):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.indication() called")
    ...
    def process_IAmRequest(self, apdu):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.process_IAmRequest() called")
    ...
    def confirmation(self, apdu):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.confirmation() called")
        # forward it along
        MSTPSimpleApplication.confirmation(self, apdu)

    def make_rp_for_obj_list(self, device_id, device_addr):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.make_rp_for_obj_list() called")
    ...
    def handle_response_for_obj_list(self, iocb):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.handle_response_for_obj_list() called")
    ...
    def get_values_for_device(self, device_id, device_address, object_list):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.get_values_for_device() called")
    ...
    def get_obj_list_for_device(self, device_id, device_address):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.get_obj_list_for_device() called")
        dev_id = ("device", device_id)
        dev_addr = Address(device_address)
        deferred(self.make_rp_for_obj_list, dev_id, dev_addr)

    def trim_obj_list(self, obj_list):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.trim_obj_list() called")
        trim_list = []
    ...
    def write_values_to_csv(self, csv_filename):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.write_values_to_csv() called")
        """
    ...
    def fetch_values(self):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.fetch_values() called")
    ...
    def read_next_object(self, context):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.read_next_object() called")
    ...
    def all_props_results(self, iocb):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.all_props_results() called")
        try:
    ...
    def _all_props_results(self, iocb):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication._all_props_results() called")
    ...
    def who_is(self, low_limit=None, high_limit=None, address=None):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.who_is() called")
        if address is None:
            address = LocalBroadcast()
        super().who_is(low_limit, high_limit, address)

    def get_address_for_device_id(self, device_id):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.get_address_for_device_id() called")
        if device_id not in self.device_db:
            return None
        device_db = self.device_db[device_id]
    ...
    def write_property(
        ...
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.write_property() called")
        try:
            logger.info(
    ...
    def _write_property(
        ...
        _unilab_logger.debug("[UNILAB] BACnetClientApplication._write_property() called")
    ...
    def handle_write_prop_cb(self, iocb):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.handle_write_prop_cb() called")
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.start() called")
        deferred(run)

    def get_value_for_prop(self, device_id, obj_id, instance_no, prop_id):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.get_value_for_prop() called")
        if device_id not in self.values_dict:
            return None
    ...
    def set_value_for_prop(
        ...
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.set_value_for_prop() called")
        if device_id not in self.values_dict:
            return None
        device_values = self.values_dict[device_id]
        obj_id_tup = (obj_id, instance_no)
    ...
    def get_values_for_all_props(self, device_id, obj_id, instance_no):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.get_values_for_all_props() called")
        if device_id not in self.values_dict:
            return None
        device_values = self.values_dict[device_id]
        obj_id_tup = (obj_id, instance_no)
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.run() called")
        while True:
            run()

    def get_device_db(self):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.get_device_db() called")
        device_db = {}
        device_db.update(self.device_db)
        return device_db

    def get_values_dict(self):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.get_values_dict() called")
        values_dict = {}
    ...
    def read_property(
        ...
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.read_property() called")
    ...
    def read_property_callback(self, iocb):
        _unilab_logger.debug("[UNILAB] BACnetClientApplication.read_property_callback() called")
...
__all__ = ["BACnetClientApplication"]
