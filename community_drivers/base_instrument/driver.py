...
Original: libs/baseinstrument.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BaseInstrument")
...
from libs.data import load_config
...
class BaseInstrument:
    ...
    def _get_instrument_address(self, address: str, config_path: str) -> str:
        print("[UNILAB] BaseInstrument.__init__() called", flush=True)
        """获取仪器地址
    ...
    def _connect_instrument(self) -> None:
        _unilab_logger.debug("[UNILAB] BaseInstrument._connect_instrument() called")
        """建立仪器连接,返回仪器标识"""
    ...
    def set_opc_timeout(self, timeout: float=0.1, poll_interval: float = None):
        _unilab_logger.debug("[UNILAB] BaseInstrument.write() called")
        """临时设置OPC超时时间
    ...
    def wait_opc(self, timeout=None, opc_poll_interval=None):
        _unilab_logger.debug("[UNILAB] BaseInstrument.wait_opc() called")
        """等待OPC完成
        Args:
    ...
    @handle_instrument_error
    def close(self) -> None:
        _unilab_logger.debug("[UNILAB] BaseInstrument.close() called")
        """关闭仪器连接"""
        self.instrument.close()
