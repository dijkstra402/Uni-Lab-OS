...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BITalino")
...
# Vendored repo packages: OpenMuse, OpenMuse
import sys as _sys
...
from OpenMuse.backends import BleakBackend
from OpenMuse.clocks import ConstrainedRLSClock
from OpenMuse.utils import configure_lsl_api_cfg
...
class BITalino:
    ...
    def __init__(self, address: str):
        print("[UNILAB] BITalino.__init__() called", flush=True)
    ...
    def set_callback(self, callback: Callable[[List[int]], None]):
        _unilab_logger.debug("[UNILAB] BITalino.set_callback() called")
        """Set a callback function to receive decoded samples immediately."""
        self._data_callback = callback

    async def connect(self, timeout: float = 10.0):
        _unilab_logger.debug("[UNILAB] BITalino.connect() called")
    ...
    async def disconnect(self):
        _unilab_logger.debug("[UNILAB] BITalino.disconnect() called")
    ...
    async def start(
        ...
        _unilab_logger.debug("[UNILAB] BITalino.start() called")
        """
    ...
    async def stop(self):
        _unilab_logger.debug("[UNILAB] BITalino.stop() called")
        """Stops acquisition."""
    ...
    def _on_data_received(self, sender, data: bytearray):
        _unilab_logger.debug("[UNILAB] BITalino._on_data_received() called")
...
class BitalinoViewer:
    ...
    def __new__(cls, *args, **kwargs):
        from OpenMuse.view import RealtimeViewer
