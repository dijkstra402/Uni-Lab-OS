...
Original: openpylivox/BinaryFileReader.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BinaryReaders")
...
# Vendored repo packages: openpylivox
import sys as _sys
...
class BinaryReaders:
    ...
    def __init__(self, datapoints, imudata, datatype=None):
        print("[UNILAB] BinaryReaders.__init__() called", flush=True)
    ...
    def simplecloudreader(pathtofile, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.simplecloudreader() called")
        '''
    ...
    def data_type0_reader(fobj, totalbytesread, datatype_points, datasize_0=13, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.data_type0_reader() called")
        '''
    ...
    def data_type1_reader(fobj, totalbytesread, datatype_points, datasize_1=9, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.data_type1_reader() called")
        '''
    ...
    def data_type2_reader(fobj, totalbytesread, datatype_points, datasize_2=14, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.data_type2_reader() called")
        '''
    ...
    def data_type3_reader(fobj, totalbytesread, datatype_points, datasize_3=10, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.data_type3_reader() called")
        '''
    ...
    def data_type4_reader(fobj, totalbytesread, datatype_points, datasize_4=28, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.data_type4_reader() called")
        '''
    ...
    def data_type5_reader(fobj, totalbytesread, datatype_points, datasize_5=16, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.data_type5_reader() called")
        '''
    ...
    def data_type6_reader(fobj, totalbytesread, datatype_points, datasize_6=24, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.data_type6_reader() called")
        '''
    ...
    def read_package_header(fobj, totalbytesread, packagedatasize=19, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.read_package_header() called")
        '''
    ...
    def read_frame_header(fobj, frblocksize=24, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.read_frame_header() called")
        '''
    ...
    def lvxreader(cls, pathtofile, blockstoread=1, showmessages=False):
        _unilab_logger.debug("[UNILAB] BinaryReaders.lvxreader() called")
        '''
