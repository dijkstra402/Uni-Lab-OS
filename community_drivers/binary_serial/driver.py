...
Original: drivers/stages/luminos_stage/zaber/serial/binary.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BinarySerial")
...
from drivers.stages.luminos_stage.zaber.serial.exceptions import TimeoutError, UnexpectedReplyError
...
class BinarySerial(object):
    ...
    def __init__(self, port, baud = 9600, timeout = 5, inter_char_timeout = 0.01):
        print("[UNILAB] BinarySerial.__init__() called", flush=True)
    ...
    def write(self, *args):
        _unilab_logger.debug("[UNILAB] BinarySerial.write() called")
    ...
    def read(self, message_id = False):
        _unilab_logger.debug("[UNILAB] BinarySerial.read() called")
    ...
    def flush(self):
        _unilab_logger.debug("[UNILAB] BinarySerial.flush() called")
        """Flushes the buffers of the underlying serial port."""
        self._ser.flush()

    def open(self):
        _unilab_logger.debug("[UNILAB] BinarySerial.open() called")
        """Opens the serial port."""
        self._ser.open()

    def close(self):
        _unilab_logger.debug("[UNILAB] BinarySerial.close() called")
        """Closes the serial port."""
        self._ser.close()

    def __enter__(self):
        _unilab_logger.debug("[UNILAB] BinarySerial.__enter__() called")
        return self

    def __exit__(self, exc_type, exc_value, traceback):
        _unilab_logger.debug("[UNILAB] BinarySerial.__exit__() called")
        self._ser.close()

    @property
    def timeout(self):
        _unilab_logger.debug("[UNILAB] BinarySerial.timeout() called")
    ...
    @property
    def baudrate(self):
        _unilab_logger.debug("[UNILAB] BinarySerial.baudrate() called")
