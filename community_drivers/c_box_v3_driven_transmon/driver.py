...
Original: deprecated/pycqed/instrument_drivers/meta_instrument/qubit_objects/CC_transmon.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CBox_v3_driven_transmon")
...
# Vendored repo packages: deprecated, pycqed
import sys as _sys
...
from deprecated.pycqed.instrument_drivers.meta_instrument.qubit_objects.qubit_object import Transmon
...
class CBox_v3_driven_transmon(Transmon):
    ...
    def __init__(self, name, **kw):
        print("[UNILAB] CBox_v3_driven_transmon.__init__() called", flush=True)
    ...
    def add_parameters(self):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.add_parameters() called")
    ...
    def upload_qasm_file(self, qasm_file):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.upload_qasm_file() called")
    ...
    def prepare_for_continuous_wave(self):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.prepare_for_continuous_wave() called")
    ...
    def prepare_readout(self):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.prepare_readout() called")
        """
    ...
    def prepare_for_timedomain(self):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.prepare_for_timedomain() called")
    ...
    def prepare_for_fluxing(self, reset=True):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.prepare_for_fluxing() called")
        '''
    ...
    def _get_acquisition_instr(self):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon._get_acquisition_instr() called")
        return self._acquisition_instrument.name

    def _set_acquisition_instr(self, acq_instr_name):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon._set_acquisition_instr() called")
    ...
    def calibrate_mixer_offsets_drive(self, update=True):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.calibrate_pulse_restless() called")
        '''
    ...
    def calibrate_mixer_offsets_RO(self, update=True):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.calibrate_mixer_offsets_RO() called")
        '''
        Calibrates the mixer skewness and updates the I and Q offsets in
        the qubit object.
        signal hound needs to be given as it this is not part of the qubit
    ...
    def calibrate_mixer_skewness(self, update=True):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.calibrate_mixer_skewness() called")
        '''
    ...
    def measure_flux_timing(self, taus, MC=None, wait_between=220e-9):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.calibrate_MW_RO_latency() called")
        '''
    ...
    def get_operation_dict(self, operation_dict={}):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon.measure_ram_z() called")
    ...
    def _gated_RO_marker_instr(self):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon._gated_RO_marker_instr() called")
    ...
    def _triggered_RO_marker_instr(self):
        _unilab_logger.debug("[UNILAB] CBox_v3_driven_transmon._triggered_RO_marker_instr() called")
