...
Original: ctypes-based/aravis.py
...
class Camera(Device):
    ...
    def create_buffers(self, nb = 10):
        _unilab_logger.debug("[UNILAB] Camera.create_buffers() called")
        """
    ...
    def try_get_frame(self):
        _unilab_logger.debug("[UNILAB] Camera.try_get_frame() called")
        """
    ...
    def get_frame(self):
        _unilab_logger.debug("[UNILAB] Camera.get_frame() called")
        """
        return last frame. Wait if no frame available
    ...
    def trigger(self):
        _unilab_logger.debug("[UNILAB] Camera.trigger() called")
        """
    ...
    def __str__(self):
        _unilab_logger.debug("[UNILAB] Camera.__str__() called")
        return "Camera: " + self.name

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] Camera.__repr__() called")
        return self.__str__()

    def get_device(self):
        _unilab_logger.debug("[UNILAB] Camera.get_device() called")
        self._ar.dll.arv_camera_get_device.restype = POINTER(ArvDevice)
        return self._ar.dll.arv_camera_get_device(self._handle)

    def get_sensor_size(self):
        _unilab_logger.debug("[UNILAB] Camera.get_sensor_size() called")
        width = c_int()
        height = c_int()
    ...
    def get_region(self):
        _unilab_logger.debug("[UNILAB] Camera.get_region() called")
        x = c_int()
        y = c_int()
        width = c_int()
        height = c_int()
    ...
    def set_region(self, x, y, width, height):
        _unilab_logger.debug("[UNILAB] Camera.set_region() called")
        self._ar.dll.arv_camera_set_region(self._handle, x, y, width, height)
   
    def get_exposure_time(self):
        _unilab_logger.debug("[UNILAB] Camera.get_exposure_time() called")
    ...
    def get_payload(self):
        _unilab_logger.debug("[UNILAB] Camera.get_payload() called")
        self._ar.dll.arv_camera_get_payload.restype = c_uint
        return self._ar.dll.arv_camera_get_payload (self._handle)

    def get_frame_rate(self):
        _unilab_logger.debug("[UNILAB] Camera.get_frame_rate() called")
    ...
    def start_acquisition(self):
        _unilab_logger.debug("[UNILAB] Camera.start_acquisition() called")
    ...
    def start_acquisition_trigger(self):
        _unilab_logger.debug("[UNILAB] Camera.start_acquisition_trigger() called")
    ...
    def start_acquisition_continuous(self):
        _unilab_logger.debug("[UNILAB] Camera.start_acquisition_continuous() called")
        self.set_string_feature("AcquisitionMode", "Continuous") #no acquisition limits
    ...
    def stop_acquisition(self):
        _unilab_logger.debug("[UNILAB] Camera.stop_acquisition() called")
        self._ar.dll.arv_camera_stop_acquisition(self._handle)

    def create_stream(self):
        _unilab_logger.debug("[UNILAB] Camera.create_stream() called")
    ...
    def get_pixel_format_as_string(self): 
        _unilab_logger.debug("[UNILAB] Camera.get_pixel_format_as_string() called")
    ...
    def cleanup(self):
        _unilab_logger.debug("[UNILAB] Camera.cleanup() called")
