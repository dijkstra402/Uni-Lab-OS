...
Original: imswitch/imcontrol/model/interfaces/CameraESP32CamSerial.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CameraESP32CamSerial")
...
class CameraESP32CamSerial:
    def __init__(self, port=None):
        print("[UNILAB] CameraESP32CamSerial.__init__() called", flush=True)
        super().__init__()
    ...
    def connect_to_usb_device(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.connect_to_usb_device() called")
    ...
    def calculate_base64_length(self, width, height):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.calculate_base64_length() called")
    ...
    def initCam(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.initCam() called")
    ...
    def put_frame(self, frame):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.put_frame() called")
        self.frame = frame
        return frame

    def start_live(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.start_live() called")
        self.isRunning = True
        self.mThread = Thread(target=self.startStreamingThread) 
        self.mThread.start()

    def stop_live(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.stop_live() called")
        self.isRunning = False
        self.mThread.join()
    ...
    def suspend_live(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.suspend_live() called")
        self.isRunning = False

    def prepare_live(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.prepare_live() called")
        pass

    def close(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.close() called")
        try:self.serialdevice.close()
        except:pass

    def setPropertyValue(self, property_name, property_value):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.setPropertyValue() called")
    ...
    def getPropertyValue(self, property_name):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.getPropertyValue() called")
        # Check if the property exists.
        if property_name == "gain":
    ...
    def set_exposure_time(self, exposureTime):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.set_exposure_time() called")
        self.newCommand = "t"+str(exposureTime)
        self.exposureTime = exposureTime

    def set_analog_gain(self, gain):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.set_analog_gain() called")
        self.newCommand = "g"+str(gain)
        self.gain = gain
        
    def getLast(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.getLast() called")
        return self.frame

    def startStreamingThread(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.startStreamingThread() called")
    ...
    def getLastChunk(self):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.getLastChunk() called")
        return self.frame

    def setROI(self, hpos, vpos, hsize, vsize):
        _unilab_logger.debug("[UNILAB] CameraESP32CamSerial.setROI() called")
