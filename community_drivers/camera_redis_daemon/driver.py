...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CameraRedisDaemon")
...
class CameraRedisDaemon(Camera):
    def __init__(self, redis_conn, port, debug):
        print("[UNILAB] CameraRedisDaemon.__init__() called", flush=True)
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] CameraRedisDaemon.__del__() called")
        self.stop()
    
    def stop(self, dummy = None):
        _unilab_logger.debug("[UNILAB] CameraRedisDaemon.stop() called")
        self._redis_link.stop()
        
    def notify(self, prop):
        _unilab_logger.debug("[UNILAB] CameraRedisDaemon.notify() called")
