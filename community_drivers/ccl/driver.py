...
Original: pycqed/instrument_drivers/physical_instruments/QuTech_CCL.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CCL")
...
class CCL(SCPI):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] CCL.__init__() called", flush=True)
    ...
    def _init_submodules(self):
        _unilab_logger.debug("[UNILAB] CCL._init_submodules() called")
        """
    ...
    def stop(self, getOperationComplete=True):
        _unilab_logger.debug("[UNILAB] CCL.stop() called")
        self.run(0),
        self.enable(0)
    ...
    def start(self, getOperationComplete=True):
        _unilab_logger.debug("[UNILAB] CCL.start() called")
        self.enable(1)
        self.run(1)
        # Introduced to work around AWG8 triggering issue
        if getOperationComplete:
    ...
    def add_standard_parameters(self):
        _unilab_logger.debug("[UNILAB] CCL.add_standard_parameters() called")
        """
    ...
    def add_additional_parameters(self):
        _unilab_logger.debug("[UNILAB] CCL.add_additional_parameters() called")
        """
    ...
    def _read_parameters(self):
        _unilab_logger.debug("[UNILAB] CCL._read_parameters() called")
        """
    ...
    def get_idn(self):
        _unilab_logger.debug("[UNILAB] CCL.get_idn() called")
        self.version_info = {}
        try:
            id_string = ""
    ...
    def print_readable_idn(self):
        _unilab_logger.debug("[UNILAB] CCL.print_readable_idn() called")
        for key, value in self.version_info.items():
            print("{0: >30s} :  {1:}".format(key, value))

    def print_qisa_opcodes(self):
        _unilab_logger.debug("[UNILAB] CCL.print_qisa_opcodes() called")
    ...
    def print_control_store(self):
        _unilab_logger.debug("[UNILAB] CCL.print_control_store() called")
    ...
    def print_qisa_with_control_store(self):
        _unilab_logger.debug("[UNILAB] CCL.print_qisa_with_control_store() called")
        if self.microcode is None:
            log.info("The microcode unit of CCLight has not been"
                " initialized yet.")
            return
...
###############################################################################
    ...
    def _upload_instructions(self, filename):
        _unilab_logger.debug("[UNILAB] CCL._upload_instructions() called")
        """
    ...
    def _upload_microcode(self, filename):
        _unilab_logger.debug("[UNILAB] CCL._upload_microcode() called")
        """
    ...
    def _upload_opcode_qmap(self, filename: str):
        _unilab_logger.debug("[UNILAB] CCL._upload_opcode_qmap() called")
    ...
    def _set_vsm_chan_delay(self, chanNum, value):
        _unilab_logger.debug("[UNILAB] CCL._set_vsm_chan_delay() called")
        """
    ...
    def _get_vsm_chan_delay(self, chanNum):
        _unilab_logger.debug("[UNILAB] CCL._get_vsm_chan_delay() called")
        """
        This function is available for the user to 'hack' the
        vsm_channel_delay using just a single function name
        """
    ...
    def _change_file_ext(self, qumis_name, ext):
        _unilab_logger.debug("[UNILAB] CCL._change_file_ext() called")
