...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ClientAsync")
...
class ClientAsync(object):
    ...
    @inlineCallbacks
    def create(protocol):
        _unilab_logger.debug("[UNILAB] ClientAsync.create() called")
        cxn = ClientAsync(protocol)
        yield cxn._init()
        returnValue(cxn)

    def __init__(self, prot):
        print("[UNILAB] ClientAsync.__init__() called", flush=True)
    ...
    @inlineCallbacks
    def _init(self):
        _unilab_logger.debug("[UNILAB] ClientAsync._init() called")
    ...
    def _serverConnected(self, _c, data):
        _unilab_logger.debug("[UNILAB] ClientAsync._serverConnected() called")
    ...
    def _serverDisconnected(self, _c, data):
        _unilab_logger.debug("[UNILAB] ClientAsync._serverDisconnected() called")
    ...
    def onDisconnect(self):
        _unilab_logger.debug("[UNILAB] ClientAsync.onDisconnect() called")
        return self._cxn.onDisconnect

    def refresh(self):
        _unilab_logger.debug("[UNILAB] ClientAsync.refresh() called")
        return self._refreshLock.run(self._refresh)

    @inlineCallbacks
    def _refresh(self):
        _unilab_logger.debug("[UNILAB] ClientAsync._refresh() called")
    ...
    def _fixName(self, name):
        _unilab_logger.debug("[UNILAB] ClientAsync._fixName() called")
        pyName = mangle(name)
        if pyName in self._staticAttrs:
            pyName = 'lr_' + pyName
        return pyName
    ...
    def _addServer(self, name, ID):
        _unilab_logger.debug("[UNILAB] ClientAsync._addServer() called")
    ...
    def _refreshServer(self, name):
        _unilab_logger.debug("[UNILAB] ClientAsync._refreshServer() called")
    ...
    def _delServer(self, name):
        _unilab_logger.debug("[UNILAB] ClientAsync._delServer() called")
    ...
    def context(self):
        _unilab_logger.debug("[UNILAB] ClientAsync.context() called")
        """Create a new communication context for this connection."""
        return self._cxn.context()

    @inlineCallbacks
    def spawn(self):
        _unilab_logger.debug("[UNILAB] ClientAsync.spawn() called")
        p = yield self._cxn.spawn()
        cxn = yield ClientAsync.create(p)
        returnValue(cxn)

    def __getitem__(self, key):
        _unilab_logger.debug("[UNILAB] ClientAsync.__getitem__() called")
        return self.servers[key]

    def _send(self, target, records, *args, **kw):
        _unilab_logger.debug("[UNILAB] ClientAsync._send() called")
    ...
    def _sendMessage(self, target, records, *args, **kw):
        _unilab_logger.debug("[UNILAB] ClientAsync._sendMessage() called")
        """Send a message over this connection."""
        return self._cxn.sendMessage(target, records, *args, **kw)

    def disconnect(self):
        _unilab_logger.debug("[UNILAB] ClientAsync.disconnect() called")
        self._cxn.disconnect()

    @property
    def _addListener(self):
        _unilab_logger.debug("[UNILAB] ClientAsync._addListener() called")
        return self._cxn.addListener

    @property
    def _removeListener(self):
        _unilab_logger.debug("[UNILAB] ClientAsync._removeListener() called")
