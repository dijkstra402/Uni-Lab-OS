...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ClockLine")
...
class ClockLine(Device):
    ...
    def __init__(self, name, pseudoclock, connection, ramping_allowed=True, **kwargs):
        print("[UNILAB] ClockLine.__init__() called", flush=True)
    ...
    def add_device(self, device):
        _unilab_logger.debug("[UNILAB] ClockLine.add_device() called")
    ...
    def clock_limit(self):
        _unilab_logger.debug("[UNILAB] ClockLine.clock_limit() called")
    ...
    @property
    def minimum_clock_high_time(self):
        _unilab_logger.debug("[UNILAB] ClockLine.minimum_clock_high_time() called")
