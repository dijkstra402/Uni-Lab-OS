...
Original: PYME/Acquire/Hardware/Coherent/Sapphire.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CoherentSapphireLaser")
...
class CoherentSapphireLaser(Laser):
    ...
    def __init__(self, serial_port='COM7', turn_on=False, name='Sapphire', init_power=5, **kwargs):
        print("[UNILAB] CoherentSapphireLaser.__init__() called", flush=True)
        """
    ...
    def query(self, command):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.query() called")
        """
    ...
    def IsOn(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.IsOn() called")
        # Would be nice to check, but there is a performance hit (this gets tracked as a scope state to update the GUI)
        return self.is_on

    def TurnOn(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.TurnOn() called")
        self.query(b'L=1\r\n')
        self.is_on = True

    def TurnOff(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.TurnOff() called")
        self.query(b'L=0\r\n')
        # FIXME - would be nice to check this worked
        self.is_on = False

    def check_set_power(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.check_set_power() called")
        power = float(self.query(b'?SP\r\n')[0])
        return power

    def check_power_output(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.check_power_output() called")
        power = float(self.query(b'?P\r\n')[0])
        return power

    def SetPower(self, power):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.SetPower() called")
        # set power
        self.query(b'P=%f\r\n' % power)
    ...
    def GetMAX(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.GetMAX() called")

        return float(self.query(b'?MAXLP\r\n')[0])

    def GetMIN(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.GetMIN() called")

        return float(self.query(b'?MINLP\r\n')[0])

    def GetPower(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.GetPower() called")
        return self.power

    def Close(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.Close() called")
        print('Shutting down %s' % self.name)
        self.TurnOff()
        time.sleep(.1)

    def __del__(self):
        _unilab_logger.debug("[UNILAB] CoherentSapphireLaser.__del__() called")
        self.Close()

__all__ = ["CoherentSapphireLaser"]
