...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CommandProxy")
...
class CommandProxyReadCharacter(StrictEnum):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] CommandProxy.__init__() called", flush=True)
...
class CommandProxy(TangoProxy):
    ...
    def subscribe_callback(self, callback: Callback | None) -> None:
        _unilab_logger.debug("[UNILAB] CommandProxy.subscribe_callback() called")
        raise NotImplementedError("Cannot subscribe to commands")

    def unsubscribe_callback(self) -> None:
        _unilab_logger.debug("[UNILAB] CommandProxy.unsubscribe_callback() called")
        raise NotImplementedError("Cannot unsubscribe from commands")

    async def get(self) -> object:
        _unilab_logger.debug("[UNILAB] CommandProxy.get() called")
    ...
    async def get_w_value(self) -> object:
        _unilab_logger.debug("[UNILAB] CommandProxy.get_w_value() called")
        return self._last_w_value

    async def connect(self) -> None:
        _unilab_logger.debug("[UNILAB] CommandProxy.connect() called")
    ...
    async def put(  # type: ignore
        ...
        _unilab_logger.debug("[UNILAB] CommandProxy.put() called")
        value = self._converter.write_value(value)
        try:

            async def _put():
                _unilab_logger.debug("[UNILAB] CommandProxy._put() called")
    ...
    async def get_reading(self) -> Reading:
        _unilab_logger.debug("[UNILAB] CommandProxy.get_config() called")
    ...
    def set_polling(
        ...
        _unilab_logger.debug("[UNILAB] CommandProxy.set_polling() called")
        pass
