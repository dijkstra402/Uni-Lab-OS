...
class CommunityGithubAutomatedchemistryFlowchem(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/private/tmp/github_drivers_clone/automatedchemistry_flowchem', 'source_file': 'src/flowchem/devices/mettlertoledo/icir.py', 'class_name': 'IcIR', 'import_roots': [], 'candidate_methods': ['initialize', 'is_local', 'ensure_version_is_supported', 'is_iCIR_connected', 'probe_info', 'probe_status', 'last_sample_time', 'sample_count', 'is_template_name_valid', 'parse_probe_info', 'spectrum_from_node', 'last_spectrum_treated', 'last_spectrum_raw', 'last_spectrum_background', 'start_experiment', 'stop_experiment', 'wait_until_idle'], 'metadata': {'repo': 'automatedchemistry/flowchem', 'repo_url': 'https://github.com/automatedchemistry/flowchem', 'unit_id': 'gh_vapourtec_r2_uv150', 'source_file': 'src/flowchem/devices/mettlertoledo/icir.py', 'candidate_score': 104, 'manufacturer': 'Vapourtec', 'model_name': 'Vapourtec R2 UV150模块'}}
