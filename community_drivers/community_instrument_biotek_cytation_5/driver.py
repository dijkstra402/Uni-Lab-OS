...
class CommunityInstrumentBiotekCytation5(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/PyLabRobot__pylabrobot', 'source_file': 'pylabrobot/plate_reading/agilent/biotek_cytation_backend.py', 'class_name': 'Cytation5Backend', 'import_roots': [], 'candidate_methods': ['capture', 'close', 'get_current_temperature', 'get_firmware_version', 'get_serial_number', 'home', 'led_off', 'led_on', 'open', 'read_absorbance', 'read_fluorescence', 'read_luminescence', 'select', 'set_auto_exposure', 'set_exposure', 'set_focus', 'set_gain', 'set_imaging_mode', 'set_objective', 'set_plate', 'set_position', 'set_temperature', 'setup', 'shake', 'start_acquisition', 'stop', 'stop_acquisition', 'stop_heating_or_cooling', 'stop_shaking'], 'action_targets': {}, 'metadata': {'repo': 'PyLabRobot/pylabrobot', 'repo_url': 'https://github.com/PyLabRobot/pylabrobot', 'brand': 'Agilent (BioTek)', 'model': 'Cytation 5', 'device_type_cn': '酶标仪', 'device_type_en': 'Plate Reader', 'source_framework': 'PyLabRobot', 'source_file': 'pylabrobot/plate_reading/agilent/biotek_cytation_backend.py', 'class_name': 'Cytation5Backend', 'candidate_methods': ['capture', 'close', 'get_current_temperature', 'get_firmware_version', 'get_serial_number', 'home', 'led_off', 'led_on', 'open', 'read_absorbance', 'read_fluorescence', 'read_luminescence', 'select', 'set_auto_exposure', 'set_exposure', 'set_focus', 'set_gain', 'set_imaging_mode', 'set_objective', 'set_plate', 'set_position', 'set_temperature', 'setup', 'shake', 'start_acquisition', 'stop', 'stop_acquisition', 'stop_heating_or_cooling', 'stop_shaking']}}
