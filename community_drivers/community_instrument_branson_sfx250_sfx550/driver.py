...
class CommunityInstrumentBransonSfx250Sfx550(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/BAMresearch__MAPz_at_BAM', 'source_file': 'Minerva/Releases/Version_1.0.0/Hardware/OtherHardware/MolecularDevices.py', 'class_name': 'SpectraMaxM3', 'import_roots': [], 'candidate_methods': ['connect', 'disconnect', 'spectramax_error', 'spectramax_command_completed', 'spectramax_instrument_status_changed', 'close_document', 'close_all_documents', 'close_drawer', 'export_as', 'get_data_copy', 'get_drawer_status', 'get_temperature', 'get_version', 'new_document', 'new_experiment', 'new_notes', 'new_plate', 'open_drawer', 'open_file', 'quit', 'save_as', 'shake', 'shake_on', 'shake_off', 'set_temperature', 'start_read', 'stop_read', 'start_measurement', 'write_spr_file', 'parent_hardware', 'dump_configuration', 'post_load_from_config'], 'action_targets': {}, 'metadata': {'repo': 'BAMresearch/MAPz_at_BAM', 'repo_url': 'https://github.com/BAMresearch/MAPz_at_BAM', 'brand': 'Branson', 'model': 'SFX250/SFX550', 'device_type_cn': '超声波处理器', 'device_type_en': 'Ultrasonic Processor', 'source_framework': 'MAPz', 'tag_id': '4453', 'tag_name': '超声破碎仪', 'tag_name_en': 'Ultrasonic Homogenizer', 'candidate_score': 262, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
