...
class CommunityInstrumentCoolledPe4000(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/python-microscope__microscope', 'source_file': 'microscope/controllers/asi.py', 'class_name': 'ASIMS2000', 'import_roots': [], 'candidate_methods': ['devices', 'get_is_enabled', 'disable', 'enable', 'initialize', 'shutdown', 'add_setting', 'get_setting', 'get_all_settings', 'set_setting', 'describe_setting', 'describe_settings', 'update_settings'], 'action_targets': {}, 'metadata': {'repo': 'python-microscope/microscope', 'repo_url': 'https://github.com/python-microscope/microscope', 'brand': 'CoolLED', 'model': 'pE-4000', 'device_type_cn': 'LED光源', 'device_type_en': 'LED Light Source', 'source_framework': 'python-microscope', 'tag_id': '4447', 'tag_name': '荧光显微镜', 'tag_name_en': 'Fluorescence Microscope', 'candidate_score': 201, 'parse_status': 'class_reselected', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
