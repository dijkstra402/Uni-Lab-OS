...
class CommunityInstrumentHamiltonMl600(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/cambiegroup__flowchem', 'source_file': 'src/flowchem/devices/hamilton/ml600.py', 'class_name': 'ML600', 'import_roots': ['src'], 'candidate_methods': ['inspect_valve_argument', 'from_config', 'get_return_steps', 'set_return_steps', 'initialize', 'send_command_and_read_reply', 'initialize_valve', 'initialize_syringe', 'get_current_volume', 'set_to_volume', 'pause', 'resume', 'stop', 'get_pump_status', 'get_valve_status', 'system_status', 'general_status_info', 'wait_until_idle', 'is_idle', 'is_single_syringe', 'version', 'get_valve_angle', 'set_valve_angle', 'get_valve_position_by_name', 'set_valve_position_by_name', 'get_raw_position', 'set_raw_position', 'send_multiple_commands', 'set_to_volume_dual_syringes', 'repeated_task', 'get_device_info'], 'action_targets': {}, 'metadata': {'repo': 'cambiegroup/flowchem', 'repo_url': 'https://github.com/cambiegroup/flowchem', 'brand': 'Hamilton', 'model': 'ML600', 'device_type_cn': '注射泵', 'device_type_en': 'Syringe Pump', 'source_framework': 'flowchem', 'tag_id': '4413', 'tag_name': '注射泵', 'tag_name_en': 'Syringe Pump', 'candidate_score': 328, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
