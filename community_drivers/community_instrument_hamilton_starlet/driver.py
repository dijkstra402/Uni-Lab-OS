...
class CommunityInstrumentHamiltonStarlet(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/dgretton__pyhamilton', 'source_file': 'pyhamilton/interface.py', 'class_name': 'HamiltonInterface', 'import_roots': [], 'candidate_methods': ['start', 'stop', 'is_open', 'send_command', 'wait_on_response', 'parse_response', 'set_log_dir', 'log', 'log_and_raise', 'initialize', 'aspirate', 'dispense', 'tip_pick_up', 'tip_eject', 'tip_pick_up_96', 'tip_eject_96', 'aspirate_96', 'tip_pick_up_mph_columns', 'dispense_96', 'aspirate_384_quadrant', 'dispense_384_quadrant', 'set_labware_property', 'move_plate', 'move_by_seq', 'get_plate_gripper_seq', 'move_plate_gripper_seq', 'place_plate_gripper_seq', 'move_plate_gripper', 'move_sequence', 'load_carrier', 'unload_carrier'], 'action_targets': {}, 'metadata': {'repo': 'dgretton/pyhamilton', 'repo_url': 'https://github.com/dgretton/pyhamilton', 'brand': 'Hamilton', 'model': 'STARlet', 'device_type_cn': '移液工作站', 'device_type_en': 'Liquid Handling Workstation', 'source_framework': 'pyhamilton', 'tag_id': '4436', 'tag_name': '移液工作站', 'tag_name_en': 'Liquid Handling Workstation', 'candidate_score': 306, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
