...
class CommunityInstrumentIkaEurostar60100(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/numat__ika', 'source_file': 'ika/driver.py', 'class_name': 'Vacuum', 'import_roots': [], 'candidate_methods': ['get_pressure', 'get_pressure_setpoint', 'get_status', 'get_vac_mode', 'get', 'get_info', 'set', 'set_mode', 'set_name', 'control', 'query', 'command'], 'action_targets': {}, 'metadata': {'repo': 'numat/ika', 'repo_url': 'https://github.com/numat/ika', 'brand': 'IKA', 'model': 'Eurostar 60/100', 'device_type_cn': '顶置搅拌器', 'device_type_en': 'Overhead Stirrer', 'source_framework': 'numat', 'tag_id': '4401', 'tag_name': '机械搅拌反应釜', 'tag_name_en': 'Mechanical Stirring Reactor', 'candidate_score': 118, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
