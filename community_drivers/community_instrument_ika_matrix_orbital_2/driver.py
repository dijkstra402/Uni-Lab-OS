...
class CommunityInstrumentIkaMatrixOrbital2(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/numat__ika', 'source_file': 'ika/driver.py', 'class_name': 'Vacuum', 'import_roots': [], 'candidate_methods': ['get_pressure', 'get_pressure_setpoint', 'get_status', 'get_vac_mode', 'get', 'get_info', 'set', 'set_mode', 'set_name', 'control', 'query', 'command'], 'action_targets': {}, 'metadata': {'repo': 'numat/ika', 'repo_url': 'https://github.com/numat/ika', 'brand': 'IKA', 'model': 'MATRIX ORBITAL', 'device_type_cn': '振荡器（非恒温）', 'device_type_en': 'Oscillator (Non-Thermostatic)', 'source_framework': 'numat', 'tag_id': '4393', 'tag_name': '振荡器（非恒温）', 'tag_name_en': 'Oscillator (Non-Thermostatic)', 'candidate_score': 118, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
