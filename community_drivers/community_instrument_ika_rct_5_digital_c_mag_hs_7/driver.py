...
class CommunityInstrumentIkaRct5DigitalCMagHs7(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/numat__ika', 'source_file': 'ika/driver.py', 'class_name': 'Vacuum', 'import_roots': [], 'candidate_methods': ['get_pressure', 'get_pressure_setpoint', 'get_status', 'get_vac_mode', 'get', 'get_info', 'set', 'set_mode', 'set_name', 'control', 'query', 'command'], 'action_targets': {}, 'metadata': {'repo': 'numat/ika', 'repo_url': 'https://github.com/numat/ika', 'brand': 'IKA', 'model': 'RCT 5 digital / C-MAG HS 7', 'device_type_cn': '磁力搅拌加热板', 'device_type_en': 'Magnetic Stirrer Hot Plate', 'source_framework': '环境控制/传感器', 'tag_id': '4395', 'tag_name': '控温磁力搅拌器', 'tag_name_en': 'Temperature-Controlled Magnetic Stirrer', 'candidate_score': 118, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
