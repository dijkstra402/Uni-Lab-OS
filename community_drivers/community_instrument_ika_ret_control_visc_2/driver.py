...
class CommunityInstrumentIkaRetControlVisc2(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/alexrudd2__ika', 'source_file': 'ika/driver.py', 'class_name': 'Vacuum', 'import_roots': [], 'candidate_methods': ['get_pressure', 'get_pressure_setpoint', 'get_status', 'get_vac_mode', 'get', 'get_info', 'set', 'set_mode', 'set_name', 'control', 'query', 'command'], 'action_targets': {}, 'metadata': {'repo': 'alexrudd2/ika', 'repo_url': 'https://github.com/alexrudd2/ika', 'brand': 'IKA', 'model': 'RET Control-Visc', 'device_type_cn': '电热板', 'device_type_en': 'Hot Plate', 'source_framework': 'ika-control', 'tag_id': '4428', 'tag_name': '电热板', 'tag_name_en': 'Hot Plate', 'candidate_score': 118, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
