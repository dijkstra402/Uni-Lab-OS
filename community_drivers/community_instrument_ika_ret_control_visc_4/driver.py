...
class CommunityInstrumentIkaRetControlVisc4(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/croningp__ChemputerSoftware', 'source_file': 'platform_server/modules/serial_labware/IKA_RET_Stirrer/IKA_RET_Control_Visc.py', 'class_name': 'IKARETControlVisc', 'import_roots': [], 'candidate_methods': ['stir_rate_pv', 'stir_rate_sp', 'temperature_pv', 'temperature_sp', 'start_heater', 'stop_heater', 'start_stirrer', 'stop_stirrer', 'start_ph_meter', 'stop_ph_meter', 'start_weighing', 'stop_weighing', 'reset_hot_plate', 'name', 'software_version', 'set_watch_dog_temp', 'set_watch_dog_stir_rate', 'get_hot_plate_temp_current', 'temperature_heat_transfer_medium_sp', 'temperature_hot_plate_pv', 'temperature_hot_plate_sp', 'temperature_hot_plate_safety_pv', 'temperature_hot_plate_safety_sp', 'get_viscosity_trend', 'get_ph', 'get_weight', 'launch_command_handler', 'open_connection', 'close_connection', 'send_message', 'non_blocking_wait', 'keepalive'], 'action_targets': {}, 'metadata': {'repo': 'croningp/ChemputerSoftware', 'repo_url': 'https://github.com/croningp/ChemputerSoftware', 'brand': 'IKA', 'model': 'RET Control Visc', 'device_type_cn': '控温磁力搅拌器', 'device_type_en': 'Temperature-Controlled Magnetic Stirrer', 'source_framework': 'Chemputer', 'tag_id': '4395', 'tag_name': '控温磁力搅拌器', 'tag_name_en': 'Temperature-Controlled Magnetic Stirrer', 'candidate_score': 326, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
