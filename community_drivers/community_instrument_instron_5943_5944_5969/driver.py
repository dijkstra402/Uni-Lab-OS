...
class CommunityInstrumentInstron594359445969(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/private/tmp/github_drivers_clone/pymeasure_pymeasure', 'source_file': 'pymeasure/instruments/mksinst/mksinst.py', 'class_name': 'MKSInstrument', 'import_roots': [], 'candidate_methods': ['read', 'write', 'check_set_errors'], 'metadata': {'source_file': 'pymeasure/instruments/mksinst/mksinst.py', 'class_name': 'MKSInstrument', 'candidate_score': 0.571, 'fix_note': 'reselected from tests->instruments'}}
