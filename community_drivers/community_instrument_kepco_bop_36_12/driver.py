...
class CommunityInstrumentKepcoBop3612(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/private/tmp/github_drivers_clone/pymeasure_pymeasure', 'source_file': 'pymeasure/instruments/kepco/kepcobop.py', 'class_name': 'KepcoBOP3612', 'import_roots': [], 'candidate_methods': ['beep', 'wait_to_continue'], 'metadata': {'source_file': 'pymeasure/instruments/kepco/kepcobop.py', 'class_name': 'KepcoBOP3612', 'candidate_score': 0.862, 'fix_note': 'reselected from tests->instruments'}}
