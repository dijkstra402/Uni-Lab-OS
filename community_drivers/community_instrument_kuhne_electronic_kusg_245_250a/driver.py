...
class CommunityInstrumentKuhneElectronicKusg245250a(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/private/tmp/github_drivers_clone/pymeasure_pymeasure', 'source_file': 'pymeasure/instruments/andeenhagerling/ah2500a.py', 'class_name': 'AH2500A', 'import_roots': [], 'candidate_methods': ['trigger', 'triggered_caplossvolt'], 'metadata': {'source_file': 'pymeasure/instruments/andeenhagerling/ah2500a.py', 'class_name': 'AH2500A', 'candidate_score': 0.727, 'fix_note': 'reselected from tests->instruments'}}
