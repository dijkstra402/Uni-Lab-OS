...
class CommunityInstrumentMettlerToledoFlowir(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/cambiegroup__flowchem', 'source_file': 'src/flowchem/devices/knauer/azura_compact.py', 'class_name': 'AzuraCompact', 'import_roots': ['src'], 'candidate_methods': ['initialize', 'error_present', 'create_and_send_command', 'get_headtype', 'set_headtype', 'get_flow_rate', 'set_flow_rate', 'get_minimum_pressure', 'set_minimum_pressure', 'get_maximum_pressure', 'set_maximum_pressure', 'set_minimum_motor_current', 'is_start_in_required', 'require_start_in', 'is_autostart_enabled', 'enable_autostart', 'get_adjusting_factor', 'set_adjusting_factor', 'get_correction_factor', 'set_correction_factor', 'read_pressure', 'read_extflow', 'read_errors', 'read_motor_current', 'infuse', 'stop', 'is_running', 'set_local', 'remote_control', 'is_analog_control_enabled', 'enable_analog_control', 'repeated_task', 'get_device_info'], 'action_targets': {}, 'metadata': {'repo': 'cambiegroup/flowchem', 'repo_url': 'https://github.com/cambiegroup/flowchem', 'brand': 'Mettler Toledo', 'model': 'FlowIR (色谱联用)', 'device_type_cn': '红外检测器(色谱联用)', 'device_type_en': 'IR Detector (Chromatography)', 'source_framework': 'flowchem', 'tag_id': '4370', 'tag_name': '凝胶渗透色谱仪', 'tag_name_en': 'Gel Permeation Chromatograph', 'candidate_score': 286, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
