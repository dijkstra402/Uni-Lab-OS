...
class CommunityInstrumentMirMir100(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/dfki-ric__mir_robot', 'source_file': 'mir_driver/src/mir_driver/rosbridge.py', 'class_name': 'RosbridgeSetup', 'import_roots': [], 'candidate_methods': ['publish', 'subscribe', 'unhook', 'unsubscribe', 'callService', 'send', 'generate_id', 'addServiceCallback', 'addCallback', 'is_connected', 'is_errored', 'onMessageReceived'], 'action_targets': {}, 'metadata': {'repo': 'dfki-ric/mir_robot', 'repo_url': 'https://github.com/dfki-ric/mir_robot', 'brand': 'MiR', 'model': 'MiR100', 'device_type_cn': '自主移动机器人', 'device_type_en': 'AGV', 'source_framework': 'mir_robot', 'tag_id': '4360', 'tag_name': 'AGV', 'tag_name_en': 'AGV', 'candidate_score': 134, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
