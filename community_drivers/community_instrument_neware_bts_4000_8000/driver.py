...
class CommunityInstrumentNewareBts40008000(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/EmpaEconversion__aurora-neware', 'source_file': 'aurora_neware/neware.py', 'class_name': 'NewareAPI', 'import_roots': [], 'candidate_methods': ['connect', 'disconnect', 'get_pipeline', 'command', 'start', 'stop', 'getchlstatus', 'inquire', 'inquiredf', 'downloadlog', 'download', 'getdevinfo', 'light', 'clearflag', 'get_steps', 'get_testid'], 'action_targets': {}, 'metadata': {'repo': 'EmpaEconversion/aurora-neware', 'repo_url': 'https://github.com/EmpaEconversion/aurora-neware', 'brand': 'Neware', 'model': 'BTS 4000/8000', 'device_type_cn': '电池测试柜', 'device_type_en': 'Battery Test Cabinet', 'source_framework': 'Aurora', 'tag_id': '4427', 'tag_name': '电池测试柜', 'tag_name_en': 'Battery Test Cabinet', 'candidate_score': 186, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
