...
class CommunityInstrumentNovonixUltraHighPrecision(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/private/tmp/github_drivers_clone/pymeasure_pymeasure', 'source_file': 'pymeasure/instruments/bkprecision/bkprecision9130b.py', 'class_name': 'BKPrecision9130B', 'import_roots': [], 'candidate_methods': ['voltage', 'voltage'], 'metadata': {'source_file': 'pymeasure/instruments/bkprecision/bkprecision9130b.py', 'class_name': 'BKPrecision9130B', 'candidate_score': 0.792, 'fix_note': 'reselected from tests->instruments'}}
