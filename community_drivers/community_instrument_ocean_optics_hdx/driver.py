...
class CommunityInstrumentOceanOpticsHdx(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/ap--__python-seabreeze', 'source_file': 'src/seabreeze/spectrometers.py', 'class_name': 'Spectrometer', 'import_roots': ['src'], 'candidate_methods': ['from_first_available', 'from_serial_number', 'wavelengths', 'intensities', 'max_intensity', 'spectrum', 'integration_time_micros', 'integration_time_micros_limits', 'trigger_mode', 'serial_number', 'model', 'pixels', 'features', 'f', 'open', 'close'], 'action_targets': {}, 'metadata': {'repo': 'ap--/python-seabreeze', 'repo_url': 'https://github.com/ap--/python-seabreeze', 'brand': 'Ocean Optics', 'model': 'HDX', 'device_type_cn': '紫外-可见分光光谱仪', 'device_type_en': 'UV-Vis Spectrophotometer', 'source_framework': 'python-seabreeze', 'tag_id': '4439', 'tag_name': '紫外-可见分光光谱仪', 'tag_name_en': 'UV-Vis Spectrophotometer', 'candidate_score': 166, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
