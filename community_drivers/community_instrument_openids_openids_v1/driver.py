...
class CommunityInstrumentOpenidsOpenidsV1(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/regiregire__OpenIDS', 'source_file': 'OpenIDS_sys.py', 'class_name': 'System', 'import_roots': [], 'candidate_methods': ['connection', 'ink_manual_move', 'set_current_position', 'syringe_init', 'line', 'printing_Act', 'printing_T', 'printing_both', 'flush', 'pre_wet', 'printing_Test', 'x_init', 'moving', 'wait', 'blow', 'Sblow', 'Bulk_dT', 'wash', 'oxidation', 'wash_no_use', 'oxidation_no_use', 'detritylation', 'syringe_wait', 'linear_wait', 'load_sequence', 'load_protocol', 'save_protocol', 'check_point', 'get_humidity'], 'action_targets': {}, 'metadata': {'repo': 'regiregire/OpenIDS', 'repo_url': 'https://github.com/regiregire/OpenIDS', 'brand': 'OpenIDS', 'model': 'OpenIDS v1', 'device_type_cn': '核酸合成仪', 'device_type_en': 'Nucleic Acid Synthesizer', 'source_framework': '专用驱动', 'tag_id': '4405', 'tag_name': '核酸合成仪', 'tag_name_en': 'Nucleic Acid Synthesizer', 'candidate_score': 270, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
    ...
    def oxidation_no_use(self, **kwargs):
        return self.call('oxidation_no_use', kwargs=kwargs)

    def detritylation(self, **kwargs):
        return self.call('detritylation', kwargs=kwargs)

    def syringe_wait(self, **kwargs):
        return self.call('syringe_wait', kwargs=kwargs)

    def linear_wait(self, **kwargs):
        return self.call('linear_wait', kwargs=kwargs)

    def load_sequence(self, **kwargs):
        return self.call('load_sequence', kwargs=kwargs)

    def load_protocol(self, **kwargs):
        return self.call('load_protocol', kwargs=kwargs)

    def save_protocol(self, **kwargs):
        return self.call('save_protocol', kwargs=kwargs)

    def check_point(self, **kwargs):
        return self.call('check_point', kwargs=kwargs)

    def get_humidity(self, **kwargs):
        return self.call('get_humidity', kwargs=kwargs)
