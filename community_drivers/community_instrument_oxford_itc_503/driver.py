...
class CommunityInstrumentOxfordItc503(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/instrumentkit__InstrumentKit', 'source_file': 'src/instruments/newport/newportesp301.py', 'class_name': 'NewportESP301', 'import_roots': ['src'], 'candidate_methods': ['axis', 'search_for_home', 'reset', 'define_program', 'execute_bulk_command', 'run_program', 'sendcmd', 'query', 'read_raw', 'timeout', 'address', 'terminator', 'prompt', 'binblockread', 'open_from_uri', 'open_tcpip', 'open_serial', 'open_gpibusb', 'open_gpibethernet', 'open_visa', 'open_test', 'open_usbtmc', 'open_vxi11', 'open_usb', 'open_file'], 'action_targets': {}, 'metadata': {'repo': 'instrumentkit/InstrumentKit', 'repo_url': 'https://github.com/instrumentkit/InstrumentKit', 'brand': 'Oxford', 'model': 'ITC 503', 'device_type_cn': '温控器', 'device_type_en': 'Temperature Controller', 'source_framework': 'InstrumentKit', 'tag_id': '4369', 'tag_name': '冷热水机', 'tag_name_en': 'Chiller / Heater Unit', 'candidate_score': 391, 'parse_status': 'class_reselected', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
