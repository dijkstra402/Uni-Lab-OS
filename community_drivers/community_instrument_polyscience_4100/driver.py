...
class CommunityInstrumentPolyscience4100(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/numat__polyscience', 'source_file': 'polyscience/udp.py', 'class_name': 'CirculatingBath', 'import_roots': [], 'candidate_methods': ['turn_on', 'turn_off', 'check_fault', 'get', 'get_setpoint', 'get_temperature_units', 'get_internal_temperature', 'get_external_temperature', 'get_operating_status', 'get_pump_speed', 'set_setpoint', 'set_pump_speed', 'close'], 'action_targets': {}, 'metadata': {'repo': 'numat/polyscience', 'repo_url': 'https://github.com/numat/polyscience', 'brand': 'PolyScience', 'model': '4100', 'device_type_cn': '循环浴', 'device_type_en': 'Circulating Bath', 'source_framework': '环境控制/传感器', 'tag_id': '4369', 'tag_name': '冷热水机', 'tag_name_en': 'Chiller / Heater Unit', 'candidate_score': 166, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
