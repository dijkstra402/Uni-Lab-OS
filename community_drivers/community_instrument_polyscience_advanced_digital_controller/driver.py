...
class CommunityInstrumentPolyscienceAdvancedDigitalController(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/numat__polyscience', 'source_file': 'polyscience/udp.py', 'class_name': 'CirculatingBath', 'import_roots': [], 'candidate_methods': ['turn_on', 'turn_off', 'check_fault', 'get', 'get_setpoint', 'get_temperature_units', 'get_internal_temperature', 'get_external_temperature', 'get_operating_status', 'get_pump_speed', 'set_setpoint', 'set_pump_speed', 'close'], 'action_targets': {}, 'metadata': {'repo': 'numat/polyscience', 'repo_url': 'https://github.com/numat/polyscience', 'brand': 'PolyScience', 'model': 'Advanced Digital Controller', 'device_type_cn': '冷热水机', 'device_type_en': 'Chiller / Heater Unit', 'source_framework': 'numat', 'tag_id': '4369', 'tag_name': '冷热水机', 'tag_name_en': 'Chiller / Heater Unit', 'candidate_score': 142, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
