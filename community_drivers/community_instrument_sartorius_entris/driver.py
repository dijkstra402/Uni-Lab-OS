...
class CommunityInstrumentSartoriusEntris(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/private/tmp/github_drivers_clone/pymeasure_pymeasure', 'source_file': 'pymeasure/instruments/aculight/argos.py', 'class_name': 'State', 'import_roots': [], 'candidate_methods': ['wait_for', 'check_set_errors', 'state'], 'metadata': {'source_file': 'pymeasure/instruments/aculight/argos.py', 'class_name': 'State', 'candidate_score': 0.571, 'fix_note': 'reselected from tests->instruments'}}
