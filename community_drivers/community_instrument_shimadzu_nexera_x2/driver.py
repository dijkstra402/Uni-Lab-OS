...
class CommunityInstrumentShimadzuNexeraX2(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/RBCanty__MIT_AMD_Platform', 'source_file': 'Shell_AH/Evoware_API/evoware_api_support.py', 'class_name': 'EVO', 'import_roots': [], 'candidate_methods': ['cancel_process', 'execute_script_command', 'get_device', 'get_device_count', 'get_lc_count', 'get_lc_info', 'get_number_of_racks', 'get_process_status', 'get_process_status_ex', 'get_process_variable', 'get_rack', 'get_script_status', 'get_script_status_ex', 'get_script_variable', 'get_status', 'get_sub_lc_count', 'get_sub_lc_info', 'get_system_info', 'get_window_handle', 'hide_gui', 'initialize', 'logoff', 'logon', 'pause', 'prepare_process', 'prepare_script', 'read_liquid_classes', 'reset_stored_adh_info', 'resume', 'set_door_locks', 'set_lamp', 'set_process_variable', 'set_rack', 'set_remote_mode', 'set_script_variable', 'shutdown', 'start_adh', 'start_adh_load_process', 'start_adh_unload_process', 'start_script', 'stop', 'write_to_trace_file', 'error_event'], 'action_targets': {}, 'metadata': {'repo': 'RBCanty/MIT_AMD_Platform', 'repo_url': 'https://github.com/RBCanty/MIT_AMD_Platform', 'brand': 'Shimadzu', 'model': 'Nexera X2', 'device_type_cn': '液相色谱仪', 'device_type_en': 'HPLC', 'source_framework': 'MIT-AMD', 'tag_id': '4371', 'tag_name': '制备色谱仪', 'tag_name_en': 'Preparative Chromatograph', 'candidate_score': 374, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
