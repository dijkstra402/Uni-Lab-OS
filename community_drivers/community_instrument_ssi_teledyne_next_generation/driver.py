...
class CommunityInstrumentSsiTeledyneNextGeneration(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/pct-code__py-hplc', 'source_file': 'py_hplc/pump.py', 'class_name': 'NextGenPump', 'import_roots': [], 'candidate_methods': ['run', 'stop', 'keypad_enable', 'keypad_disable', 'clear_faults', 'reset', 'zero_seal', 'current_conditions', 'current_state', 'pump_info', 'read_faults', 'is_running', 'stroke_counter', 'flowrate_compensation', 'flowrate', 'pressure', 'upper_pressure_limit', 'lower_pressure_limit', 'leak_detected', 'set_leak_mode', 'solvent', 'identify', 'command', 'is_open'], 'action_targets': {}, 'metadata': {'repo': 'pct-code/py-hplc', 'repo_url': 'https://github.com/pct-code/py-hplc', 'brand': 'SSI-Teledyne', 'model': 'Next Generation', 'device_type_cn': 'HPLC泵', 'device_type_en': 'HPLC Pump', 'source_framework': '泵阀/液体处理', 'tag_id': '4403', 'tag_name': '柱塞泵', 'tag_name_en': 'Plunger Pump', 'candidate_score': 246, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
