...
class CommunityInstrumentTecanCavroXlpXcalibur(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/benpruitt__tecancavro', 'source_file': 'tecancavro/models.py', 'class_name': 'XCaliburD', 'import_roots': [], 'candidate_methods': ['initDebugLogging', 'logCall', 'logDebug', 'init', 'extractToWaste', 'primePort', 'executeChain', 'resetChain', 'updateSimState', 'cacheSimSpeeds', 'restoreSimSpeeds', 'execWrap', 'dispenseToWaste', 'extract', 'dispense', 'changePort', 'movePlungerAbs', 'movePlungerRel', 'setSpeed', 'setStartSpeed', 'setTopSpeed', 'setCutoffSpeed', 'setSlope', 'repeatCmdSeq', 'markRepeatStart', 'delayExec', 'haltExec', 'updateSpeeds', 'getPlungerPos', 'getStartSpeed', 'getTopSpeed', 'getCutoffSpeed', 'getEncoderPos', 'getCurPort', 'getBufferStatus', 'setMicrostep', 'terminateCmd', 'waitReady', 'sendRcv'], 'action_targets': {}, 'metadata': {'repo': 'benpruitt/tecancavro', 'repo_url': 'https://github.com/benpruitt/tecancavro', 'brand': 'Tecan', 'model': 'Cavro XLP/XCalibur', 'device_type_cn': '柱塞泵', 'device_type_en': 'Plunger Pump', 'source_framework': 'tecancavro', 'tag_id': '4403', 'tag_name': '柱塞泵', 'tag_name_en': 'Plunger Pump', 'candidate_score': 378, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
