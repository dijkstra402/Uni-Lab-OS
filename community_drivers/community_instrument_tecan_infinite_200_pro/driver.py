...
class CommunityInstrumentTecanInfinite200Pro(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/PyLabRobot__pylabrobot', 'source_file': 'pylabrobot/plate_reading/tecan/infinite_backend.py', 'class_name': 'ExperimentalTecanInfinite200ProBackend', 'import_roots': [], 'candidate_methods': ['close', 'open', 'read_absorbance', 'read_fluorescence', 'read_luminescence', 'setup', 'stop'], 'action_targets': {}, 'metadata': {'repo': 'PyLabRobot/pylabrobot', 'repo_url': 'https://github.com/PyLabRobot/pylabrobot', 'brand': 'Tecan', 'model': 'Infinite 200 PRO', 'device_type_cn': '酶标仪', 'device_type_en': 'Microplate Reader', 'source_framework': 'PyLabRobot', 'tag_id': '4457', 'tag_name': '酶标仪', 'tag_name_en': 'Microplate Reader', 'candidate_score': 2318, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}, 'source_file': 'pylabrobot/plate_reading/tecan/infinite_backend.py', 'class_name': 'ExperimentalTecanInfinite200ProBackend'}}
