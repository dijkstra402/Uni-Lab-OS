...
class CommunityInstrumentThermotron3800(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/private/tmp/github_drivers_clone/pymeasure_pymeasure', 'source_file': 'pymeasure/instruments/thermotron/thermotron3800.py', 'class_name': 'Thermotron3800', 'import_roots': [], 'candidate_methods': ['write', 'run', 'stop', 'initalize_oven'], 'metadata': {'source_file': 'pymeasure/instruments/thermotron/thermotron3800.py', 'class_name': 'Thermotron3800', 'candidate_score': 0.966, 'fix_note': 'reselected from tests->instruments'}}
