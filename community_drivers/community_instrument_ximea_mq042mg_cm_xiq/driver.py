...
class CommunityInstrumentXimeaMq042mgCmXiq(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/instrument_driver_repos/python-microscope__microscope', 'source_file': 'microscope/cameras/picamera.py', 'class_name': 'PiCamera', 'import_roots': [], 'candidate_methods': ['get_awb_mode', 'set_awb_mode', 'set_iso_mode', 'HW_trigger', 'initialize', 'make_safe', 'abort', 'set_trigger', 'trigger_mode', 'trigger_type', 'setLED', 'set_exposure_time', 'get_exposure_time', 'get_cycle_time', 'get_framerate', 'set_framerate', 'zoom', 'soft_trigger', 'shuttering_mode', 'get_transform', 'set_transform', 'get_sensor_shape', 'get_binning', 'set_binning', 'get_roi', 'set_roi', 'trigger', 'enable', 'disable', 'set_client', 'update_settings', 'receiveClient', 'grab_next_data', 'receiveData', 'get_is_enabled', 'shutdown', 'add_setting', 'get_setting', 'get_all_settings', 'set_setting', 'describe_setting', 'describe_settings'], 'action_targets': {}, 'metadata': {'repo': 'python-microscope/microscope', 'repo_url': 'https://github.com/python-microscope/microscope', 'brand': 'Ximea', 'model': 'MQ042MG-CM/xiQ', 'device_type_cn': '工业相机', 'device_type_en': 'Industrial Camera', 'source_framework': 'python-microscope', 'tag_id': '4400', 'tag_name': '普通光学显微镜', 'tag_name_en': 'Optical Microscope', 'candidate_score': 202, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
