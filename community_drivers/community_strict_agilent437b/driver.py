...
class CommunityStrictAgilent437b(CommunityRepoLoader):
    ...
    def get_channels_range_lower(self, **kwargs):
        return self.call('get_channels_range_lower', kwargs=kwargs)

    def set_channels_range_lower(self, **kwargs):
        return self.call('set_channels_range_lower', kwargs=kwargs)

    def get_channels_range_upper(self, **kwargs):
        return self.call('get_channels_range_upper', kwargs=kwargs)

    def set_channels_range_upper(self, **kwargs):
        return self.call('set_channels_range_upper', kwargs=kwargs)

    def channels_range_configure(self, **kwargs):
        return self.call('channels_range_configure', kwargs=kwargs)

    def get_channels_duty_cycle_enabled(self, **kwargs):
        return self.call('get_channels_duty_cycle_enabled', kwargs=kwargs)

    def set_channels_duty_cycle_enabled(self, **kwargs):
        return self.call('set_channels_duty_cycle_enabled', kwargs=kwargs)

    def get_channels_duty_cycle_value(self, **kwargs):
        return self.call('get_channels_duty_cycle_value', kwargs=kwargs)

    def set_channels_duty_cycle_value(self, **kwargs):
        return self.call('set_channels_duty_cycle_value', kwargs=kwargs)

    def channels_duty_cycle_configure(self, **kwargs):
        return self.call('channels_duty_cycle_configure', kwargs=kwargs)

    def get_channels_averaging_count(self, **kwargs):
        return self.call('get_channels_averaging_count', kwargs=kwargs)

    def set_channels_averaging_count(self, **kwargs):
        return self.call('set_channels_averaging_count', kwargs=kwargs)

    def zero_all_channels(self, **kwargs):
        return self.call('zero_all_channels', kwargs=kwargs)

    def get_channels_zero_state(self, **kwargs):
        return self.call('get_channels_zero_state', kwargs=kwargs)

    def channels_zero(self, **kwargs):
        return self.call('channels_zero', kwargs=kwargs)

    def get_channels_calibration_state(self, **kwargs):
        return self.call('get_channels_calibration_state', kwargs=kwargs)

    def channels_calibrate(self, **kwargs):
        return self.call('channels_calibrate', kwargs=kwargs)

    def get_reference_oscillator_enabled(self, **kwargs):
        return self.call('get_reference_oscillator_enabled', kwargs=kwargs)

    def set_reference_oscillator_enabled(self, **kwargs):
        return self.call('set_reference_oscillator_enabled', kwargs=kwargs)

    def get_reference_oscillator_frequency(self, **kwargs):
        return self.call('get_reference_oscillator_frequency', kwargs=kwargs)

    def set_reference_oscillator_frequency(self, **kwargs):
        return self.call('set_reference_oscillator_frequency', kwargs=kwargs)

    def get_reference_oscillator_level(self, **kwargs):
        return self.call('get_reference_oscillator_level', kwargs=kwargs)

    def set_reference_oscillator_level(self, **kwargs):
        return self.call('set_reference_oscillator_level', kwargs=kwargs)

    def reference_oscillator_configure(self, **kwargs):
        return self.call('reference_oscillator_configure', kwargs=kwargs)
