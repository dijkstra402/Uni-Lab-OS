...
class CommunityStrictAgilent8341a(CommunityRepoLoader):
    ...
    def get_sweep_frequency_sweep_center(self, **kwargs):
        return self.call('get_sweep_frequency_sweep_center', kwargs=kwargs)

    def set_sweep_frequency_sweep_center(self, **kwargs):
        return self.call('set_sweep_frequency_sweep_center', kwargs=kwargs)

    def get_sweep_frequency_sweep_span(self, **kwargs):
        return self.call('get_sweep_frequency_sweep_span', kwargs=kwargs)

    def set_sweep_frequency_sweep_span(self, **kwargs):
        return self.call('set_sweep_frequency_sweep_span', kwargs=kwargs)
