...
class CommunityStrictAgilent85645a(CommunityRepoLoader):
    ...
    def get_rf_output_coupling(self, **kwargs):
        return self.call('get_rf_output_coupling', kwargs=kwargs)

    def set_rf_output_coupling(self, **kwargs):
        return self.call('set_rf_output_coupling', kwargs=kwargs)

    def rf_ytm_peak(self, **kwargs):
        return self.call('rf_ytm_peak', kwargs=kwargs)
