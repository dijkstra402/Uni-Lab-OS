...
class CommunityStrictAgilent8642b(CommunityRepoLoader):
    ...
    def get_sweep_frequency_sweep_start(self, **kwargs):
        return self.call('get_sweep_frequency_sweep_start', kwargs=kwargs)

    def set_sweep_frequency_sweep_start(self, **kwargs):
        return self.call('set_sweep_frequency_sweep_start', kwargs=kwargs)

    def get_sweep_frequency_sweep_stop(self, **kwargs):
        return self.call('get_sweep_frequency_sweep_stop', kwargs=kwargs)

    def set_sweep_frequency_sweep_stop(self, **kwargs):
        return self.call('set_sweep_frequency_sweep_stop', kwargs=kwargs)

    def get_sweep_frequency_sweep_time(self, **kwargs):
        return self.call('get_sweep_frequency_sweep_time', kwargs=kwargs)

    def set_sweep_frequency_sweep_time(self, **kwargs):
        return self.call('set_sweep_frequency_sweep_time', kwargs=kwargs)

    def sweep_frequency_sweep_configure_start_stop(self, **kwargs):
        return self.call('sweep_frequency_sweep_configure_start_stop', kwargs=kwargs)

    def sweep_frequency_sweep_configure_center_span(self, **kwargs):
        return self.call('sweep_frequency_sweep_configure_center_span', kwargs=kwargs)

    def get_sweep_power_sweep_start(self, **kwargs):
        return self.call('get_sweep_power_sweep_start', kwargs=kwargs)

    def set_sweep_power_sweep_start(self, **kwargs):
        return self.call('set_sweep_power_sweep_start', kwargs=kwargs)

    def get_sweep_power_sweep_stop(self, **kwargs):
        return self.call('get_sweep_power_sweep_stop', kwargs=kwargs)

    def set_sweep_power_sweep_stop(self, **kwargs):
        return self.call('set_sweep_power_sweep_stop', kwargs=kwargs)

    def get_sweep_power_sweep_time(self, **kwargs):
        return self.call('get_sweep_power_sweep_time', kwargs=kwargs)

    def set_sweep_power_sweep_time(self, **kwargs):
        return self.call('set_sweep_power_sweep_time', kwargs=kwargs)

    def sweep_power_sweep_configure_start_stop(self, **kwargs):
        return self.call('sweep_power_sweep_configure_start_stop', kwargs=kwargs)
