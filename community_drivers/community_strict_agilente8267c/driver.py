...
class CommunityStrictAgilente8267c(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/strict_candidates_repos/QCoDeS__Qcodes', 'source_file': 'src/qcodes/instrument_drivers/agilent/Agilent_E8267C.py', 'class_name': 'AgilentE8267C', 'import_roots': ['src'], 'candidate_methods': ['deg_to_rad', 'rad_to_deg', 'get_frequency', 'set_frequency', 'get_freq_offset', 'set_freq_offset', 'get_freq_mode', 'set_freq_mode', 'get_pulse_width', 'set_pulse_width', 'get_phase', 'set_phase', 'get_power', 'set_power', 'get_power_offset', 'set_power_offset', 'get_output_rf', 'set_output_rf', 'get_modulation_rf', 'set_modulation_rf', 'address', 'resource_manager', 'visa_handle', 'visabackend', 'visalib', 'set_address', 'device_clear', 'set_terminator', 'close', 'write_raw', 'ask_raw', 'snapshot_base', 'get_timeout', 'set_timeout', 'get_idn', 'connect_message', 'close_all', 'record_instance', 'instances', 'remove_instance', 'find_instrument', 'exist', 'is_valid', 'label', 'add_parameter', 'remove_parameter', 'add_function', 'add_submodule', 'get_component', 'print_readable_snapshot', 'invalidate_cache', 'parent', 'ancestors', 'root_instrument', 'name_parts', 'full_name', 'name', 'short_name', 'set', 'get', 'call', 'validate_status', 'load_metadata', 'snapshot'], 'action_targets': {'get_frequency': '__qcodes_param_get__frequency', 'set_frequency': '__qcodes_param_set__frequency', 'get_freq_offset': '__qcodes_param_get__freq_offset', 'set_freq_offset': '__qcodes_param_set__freq_offset', 'get_freq_mode': '__qcodes_param_get__freq_mode', 'set_freq_mode': '__qcodes_param_set__freq_mode', 'get_pulse_width': '__qcodes_param_get__pulse_width', 'set_pulse_width': '__qcodes_param_set__pulse_width', 'get_phase': '__qcodes_param_get__phase', 'set_phase': '__qcodes_param_set__phase', 'get_power': '__qcodes_param_get__power', 'set_power': '__qcodes_param_set__power', 'get_power_offset': '__qcodes_param_get__power_offset', 'set_power_offset': '__qcodes_param_set__power_offset', 'get_output_rf': '__qcodes_param_get__output_rf', 'set_output_rf': '__qcodes_param_set__output_rf', 'get_modulation_rf': '__qcodes_param_get__modulation_rf', 'set_modulation_rf': '__qcodes_param_set__modulation_rf', 'get_timeout': '__qcodes_param_get__timeout', 'set_timeout': '__qcodes_param_set__timeout', 'get_idn': '__qcodes_param_get__idn'}, 'metadata': {'repo': 'QCoDeS/Qcodes', 'repo_url': 'https://github.com/QCoDeS/Qcodes', 'source_url': 'https://github.com/QCoDeS/Qcodes/blob/main/src/qcodes/instrument_drivers/agilent/Agilent_E8267C.py', 'confidence': 0.95, 'quality_score': 1.17, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {'get_frequency': '__qcodes_param_get__frequency', 'set_frequency': '__qcodes_param_set__frequency', 'get_freq_offset': '__qcodes_param_get__freq_offset', 'set_freq_offset': '__qcodes_param_set__freq_offset', 'get_freq_mode': '__qcodes_param_get__freq_mode', 'set_freq_mode': '__qcodes_param_set__freq_mode', 'get_pulse_width': '__qcodes_param_get__pulse_width', 'set_pulse_width': '__qcodes_param_set__pulse_width', 'get_phase': '__qcodes_param_get__phase', 'set_phase': '__qcodes_param_set__phase', 'get_power': '__qcodes_param_get__power', 'set_power': '__qcodes_param_set__power', 'get_power_offset': '__qcodes_param_get__power_offset', 'set_power_offset': '__qcodes_param_set__power_offset', 'get_output_rf': '__qcodes_param_get__output_rf', 'set_output_rf': '__qcodes_param_set__output_rf', 'get_modulation_rf': '__qcodes_param_get__modulation_rf', 'set_modulation_rf': '__qcodes_param_set__modulation_rf', 'get_timeout': '__qcodes_param_get__timeout', 'set_timeout': '__qcodes_param_set__timeout', 'get_idn': '__qcodes_param_get__idn'}}}
    ...
    def get_power_offset(self, **kwargs):
        return self.call('get_power_offset', kwargs=kwargs)

    def set_power_offset(self, **kwargs):
        return self.call('set_power_offset', kwargs=kwargs)
