...
class CommunityStrictAgilentu2723a(CommunityRepoLoader):
    ...
    def get_outputs_ocp_enabled(self, **kwargs):
        return self.call('get_outputs_ocp_enabled', kwargs=kwargs)

    def set_outputs_ocp_enabled(self, **kwargs):
        return self.call('set_outputs_ocp_enabled', kwargs=kwargs)

    def get_outputs_ocp_limit(self, **kwargs):
        return self.call('get_outputs_ocp_limit', kwargs=kwargs)

    def set_outputs_ocp_limit(self, **kwargs):
        return self.call('set_outputs_ocp_limit', kwargs=kwargs)
