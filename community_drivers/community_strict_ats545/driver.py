...
class CommunityStrictAts545(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/strict_candidates_repos/pymeasure__pymeasure', 'source_file': 'pymeasure/instruments/temptronic/temptronic_ats545.py', 'class_name': 'ATS545', 'import_roots': [], 'candidate_methods': ['next_setpoint', 'enter_cycle', 'enter_ramp', 'configure', 'set_temperature', 'wait_for_settling', 'start', 'error_status', 'cycling_stopped', 'end_of_all_cycles', 'end_of_one_cycle', 'end_of_test', 'not_at_temperature', 'at_temperature', 'check_errors', 'next_error', 'write_binary_values', 'read_binary_values'], 'action_targets': {}, 'metadata': {'repo': 'pymeasure/pymeasure', 'repo_url': 'https://github.com/pymeasure/pymeasure', 'source_url': 'https://github.com/pymeasure/pymeasure/blob/main/pymeasure/instruments/temptronic/temptronic_ats545.py', 'confidence': 0.95, 'quality_score': 1.17, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
