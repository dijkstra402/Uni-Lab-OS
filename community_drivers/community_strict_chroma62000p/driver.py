...
class CommunityStrictChroma62000p(CommunityRepoLoader):
    ...
    def get_outputs_slew_rate(self, **kwargs):
        return self.call('get_outputs_slew_rate', kwargs=kwargs)

    def set_outputs_slew_rate(self, **kwargs):
        return self.call('set_outputs_slew_rate', kwargs=kwargs)
