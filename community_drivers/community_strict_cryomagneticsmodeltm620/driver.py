...
class CommunityStrictCryomagneticsmodeltm620(CommunityRepoLoader):
    ...
    def get_shield(self, **kwargs):
        return self.call('get_shield', kwargs=kwargs)

    def get_magnet(self, **kwargs):
        return self.call('get_magnet', kwargs=kwargs)
