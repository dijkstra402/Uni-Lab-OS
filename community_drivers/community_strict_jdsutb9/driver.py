...
class CommunityStrictJdsutb9(CommunityRepoLoader):
    ...
    def get_driver_enable(self, **kwargs):
        return self.call('get_driver_enable', kwargs=kwargs)

    def set_driver_enable(self, **kwargs):
        return self.call('set_driver_enable', kwargs=kwargs)
