...
class CommunityStrictKeithley2614b(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/strict_candidates_repos/QCoDeS__Qcodes', 'source_file': 'src/qcodes/instrument_drivers/Keithley/Keithley_2614B.py', 'class_name': 'Keithley2614B', 'import_roots': ['src'], 'candidate_methods': ['get_idn', 'display_clear', 'display_normal', 'exit_key', 'get_display_settext', 'set_display_settext', 'address', 'resource_manager', 'visa_handle', 'visabackend', 'visalib', 'set_address', 'device_clear', 'set_terminator', 'close', 'write_raw', 'ask_raw', 'snapshot_base', 'get_timeout', 'set_timeout', 'connect_message', 'close_all', 'record_instance', 'instances', 'remove_instance', 'find_instrument', 'exist', 'is_valid', 'label', 'add_parameter', 'remove_parameter', 'add_function', 'add_submodule', 'get_component', 'print_readable_snapshot', 'invalidate_cache', 'parent', 'ancestors', 'root_instrument', 'name_parts', 'full_name', 'name', 'short_name', 'set', 'get', 'call', 'validate_status', 'load_metadata', 'snapshot'], 'action_targets': {'get_display_settext': '__qcodes_param_get__display_settext', 'set_display_settext': '__qcodes_param_set__display_settext', 'get_timeout': '__qcodes_param_get__timeout', 'set_timeout': '__qcodes_param_set__timeout'}, 'metadata': {'repo': 'QCoDeS/Qcodes', 'repo_url': 'https://github.com/QCoDeS/Qcodes', 'source_url': 'https://github.com/QCoDeS/Qcodes/blob/main/src/qcodes/instrument_drivers/Keithley/Keithley_2614B.py', 'confidence': 0.9, 'quality_score': 1.12, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {'get_display_settext': '__qcodes_param_get__display_settext', 'set_display_settext': '__qcodes_param_set__display_settext', 'get_timeout': '__qcodes_param_get__timeout', 'set_timeout': '__qcodes_param_set__timeout'}}}
    ...
    def display_normal(self, **kwargs):
        return self.call('display_normal', kwargs=kwargs)

    def exit_key(self, **kwargs):
        return self.call('exit_key', kwargs=kwargs)

    def get_display_settext(self, **kwargs):
        return self.call('get_display_settext', kwargs=kwargs)

    def set_display_settext(self, **kwargs):
        return self.call('set_display_settext', kwargs=kwargs)
