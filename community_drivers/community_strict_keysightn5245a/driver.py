...
class CommunityStrictKeysightn5245a(CommunityRepoLoader):
    ...
    def get_aux_frequency(self, **kwargs):
        return self.call('get_aux_frequency', kwargs=kwargs)

    def set_aux_frequency(self, **kwargs):
        return self.call('set_aux_frequency', kwargs=kwargs)
