...
class CommunityStrictLecroywr204mxia(CommunityRepoLoader):
    ...
    def get_channels_label_position(self, **kwargs):
        return self.call('get_channels_label_position', kwargs=kwargs)

    def set_channels_label_position(self, **kwargs):
        return self.call('set_channels_label_position', kwargs=kwargs)
    ...
    def get_display_grid(self, **kwargs):
        return self.call('get_display_grid', kwargs=kwargs)

    def set_display_grid(self, **kwargs):
        return self.call('set_display_grid', kwargs=kwargs)
