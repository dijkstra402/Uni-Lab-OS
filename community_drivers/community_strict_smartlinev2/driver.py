...
class CommunityStrictSmartlinev2(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/strict_candidates_repos/pymeasure__pymeasure', 'source_file': 'pymeasure/instruments/thyracont/smartline_v2.py', 'class_name': 'SmartlineV2', 'import_roots': [], 'candidate_methods': ['write', 'write_composition', 'ask', 'ask_manually', 'read', 'check_set_errors', 'set_high', 'set_low', 'get_sensor_transition', 'set_default_sensor_transition', 'set_continuous_sensor_transition', 'set_direct_sensor_transition', 'next_error', 'write_binary_values', 'read_binary_values', 'check_errors'], 'action_targets': {}, 'metadata': {'repo': 'pymeasure/pymeasure', 'repo_url': 'https://github.com/pymeasure/pymeasure', 'source_url': 'https://github.com/pymeasure/pymeasure/blob/main/pymeasure/instruments/thyracont/smartline_v2.py', 'confidence': 0.75, 'quality_score': 0.89, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
