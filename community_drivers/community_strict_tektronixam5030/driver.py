...
class CommunityStrictTektronixam5030(CommunityRepoLoader):
    ...
    def get_amps(self, **kwargs):
        return self.call('get_amps', kwargs=kwargs)

    def set_amps(self, **kwargs):
        return self.call('set_amps', kwargs=kwargs)

    def get_bw_limit(self, **kwargs):
        return self.call('get_bw_limit', kwargs=kwargs)

    def set_bw_limit(self, **kwargs):
        return self.call('set_bw_limit', kwargs=kwargs)
    ...
    def get_dc_level(self, **kwargs):
        return self.call('get_dc_level', kwargs=kwargs)

    def set_dc_level(self, **kwargs):
        return self.call('set_dc_level', kwargs=kwargs)

    def get_overload(self, **kwargs):
        return self.call('get_overload', kwargs=kwargs)

    def get_probe_open(self, **kwargs):
        return self.call('get_probe_open', kwargs=kwargs)

    def get_probe_trim(self, **kwargs):
        return self.call('get_probe_trim', kwargs=kwargs)

    def set_probe_trim(self, **kwargs):
        return self.call('set_probe_trim', kwargs=kwargs)

    def get_probe_type(self, **kwargs):
        return self.call('get_probe_type', kwargs=kwargs)

    def degauss(self, **kwargs):
        return self.call('degauss', kwargs=kwargs)
