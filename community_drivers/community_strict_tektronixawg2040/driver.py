...
class CommunityStrictTektronixawg2040(CommunityRepoLoader):
    ...
    def get_arbitrary_sequence_number_sequences_max(self, **kwargs):
        return self.call('get_arbitrary_sequence_number_sequences_max', kwargs=kwargs)

    def get_arbitrary_sequence_loop_count_max(self, **kwargs):
        return self.call('get_arbitrary_sequence_loop_count_max', kwargs=kwargs)

    def get_arbitrary_sequence_length_max(self, **kwargs):
        return self.call('get_arbitrary_sequence_length_max', kwargs=kwargs)

    def get_arbitrary_sequence_length_min(self, **kwargs):
        return self.call('get_arbitrary_sequence_length_min', kwargs=kwargs)

    def arbitrary_clear_memory(self, **kwargs):
        return self.call('arbitrary_clear_memory', kwargs=kwargs)

    def arbitrary_sequence_clear(self, **kwargs):
        return self.call('arbitrary_sequence_clear', kwargs=kwargs)

    def arbitrary_sequence_configure(self, **kwargs):
        return self.call('arbitrary_sequence_configure', kwargs=kwargs)

    def arbitrary_sequence_create(self, **kwargs):
        return self.call('arbitrary_sequence_create', kwargs=kwargs)

    def outputs_arbitrary_sequence_configure(self, **kwargs):
        return self.call('outputs_arbitrary_sequence_configure', kwargs=kwargs)

    def get_outputs_burst_count(self, **kwargs):
        return self.call('get_outputs_burst_count', kwargs=kwargs)

    def set_outputs_burst_count(self, **kwargs):
        return self.call('set_outputs_burst_count', kwargs=kwargs)
