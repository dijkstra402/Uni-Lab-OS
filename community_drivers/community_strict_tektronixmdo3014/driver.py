...
class CommunityStrictTektronixmdo3014(CommunityRepoLoader):
    ...
    def get_trigger_runt_threshold_high(self, **kwargs):
        return self.call('get_trigger_runt_threshold_high', kwargs=kwargs)

    def set_trigger_runt_threshold_high(self, **kwargs):
        return self.call('set_trigger_runt_threshold_high', kwargs=kwargs)

    def get_trigger_runt_threshold_low(self, **kwargs):
        return self.call('get_trigger_runt_threshold_low', kwargs=kwargs)

    def set_trigger_runt_threshold_low(self, **kwargs):
        return self.call('set_trigger_runt_threshold_low', kwargs=kwargs)

    def get_trigger_runt_polarity(self, **kwargs):
        return self.call('get_trigger_runt_polarity', kwargs=kwargs)

    def set_trigger_runt_polarity(self, **kwargs):
        return self.call('set_trigger_runt_polarity', kwargs=kwargs)

    def trigger_runt_configure(self, **kwargs):
        return self.call('trigger_runt_configure', kwargs=kwargs)
    ...
    def abort_generation(self, **kwargs):
        return self.call('abort_generation', kwargs=kwargs)

    def initiate_generation(self, **kwargs):
        return self.call('initiate_generation', kwargs=kwargs)

    def get_outputs_standard_waveform_pulse_width(self, **kwargs):
        return self.call('get_outputs_standard_waveform_pulse_width', kwargs=kwargs)

    def set_outputs_standard_waveform_pulse_width(self, **kwargs):
        return self.call('set_outputs_standard_waveform_pulse_width', kwargs=kwargs)

    def get_outputs_standard_waveform_symmetry(self, **kwargs):
        return self.call('get_outputs_standard_waveform_symmetry', kwargs=kwargs)

    def set_outputs_standard_waveform_symmetry(self, **kwargs):
        return self.call('set_outputs_standard_waveform_symmetry', kwargs=kwargs)

    def get_outputs_noise_enabled(self, **kwargs):
        return self.call('get_outputs_noise_enabled', kwargs=kwargs)

    def set_outputs_noise_enabled(self, **kwargs):
        return self.call('set_outputs_noise_enabled', kwargs=kwargs)

    def get_outputs_noise_percent(self, **kwargs):
        return self.call('get_outputs_noise_percent', kwargs=kwargs)

    def set_outputs_noise_percent(self, **kwargs):
        return self.call('set_outputs_noise_percent', kwargs=kwargs)

    def get_outputs_standard_waveform_amplitude(self, **kwargs):
        return self.call('get_outputs_standard_waveform_amplitude', kwargs=kwargs)

    def set_outputs_standard_waveform_amplitude(self, **kwargs):
        return self.call('set_outputs_standard_waveform_amplitude', kwargs=kwargs)

    def get_outputs_standard_waveform_dc_offset(self, **kwargs):
        return self.call('get_outputs_standard_waveform_dc_offset', kwargs=kwargs)

    def set_outputs_standard_waveform_dc_offset(self, **kwargs):
        return self.call('set_outputs_standard_waveform_dc_offset', kwargs=kwargs)

    def get_outputs_standard_waveform_duty_cycle_high(self, **kwargs):
        return self.call('get_outputs_standard_waveform_duty_cycle_high', kwargs=kwargs)

    def set_outputs_standard_waveform_duty_cycle_high(self, **kwargs):
        return self.call('set_outputs_standard_waveform_duty_cycle_high', kwargs=kwargs)

    def get_outputs_standard_waveform_start_phase(self, **kwargs):
        return self.call('get_outputs_standard_waveform_start_phase', kwargs=kwargs)

    def set_outputs_standard_waveform_start_phase(self, **kwargs):
        return self.call('set_outputs_standard_waveform_start_phase', kwargs=kwargs)

    def get_outputs_standard_waveform_frequency(self, **kwargs):
        return self.call('get_outputs_standard_waveform_frequency', kwargs=kwargs)

    def set_outputs_standard_waveform_frequency(self, **kwargs):
        return self.call('set_outputs_standard_waveform_frequency', kwargs=kwargs)

    def get_outputs_standard_waveform_waveform(self, **kwargs):
        return self.call('get_outputs_standard_waveform_waveform', kwargs=kwargs)

    def set_outputs_standard_waveform_waveform(self, **kwargs):
        return self.call('set_outputs_standard_waveform_waveform', kwargs=kwargs)

    def outputs_standard_waveform_configure(self, **kwargs):
        return self.call('outputs_standard_waveform_configure', kwargs=kwargs)

    def get_outputs_arbitrary_gain(self, **kwargs):
        return self.call('get_outputs_arbitrary_gain', kwargs=kwargs)

    def set_outputs_arbitrary_gain(self, **kwargs):
        return self.call('set_outputs_arbitrary_gain', kwargs=kwargs)

    def get_outputs_arbitrary_offset(self, **kwargs):
        return self.call('get_outputs_arbitrary_offset', kwargs=kwargs)

    def set_outputs_arbitrary_offset(self, **kwargs):
        return self.call('set_outputs_arbitrary_offset', kwargs=kwargs)

    def get_outputs_arbitrary_waveform(self, **kwargs):
        return self.call('get_outputs_arbitrary_waveform', kwargs=kwargs)

    def set_outputs_arbitrary_waveform(self, **kwargs):
        return self.call('set_outputs_arbitrary_waveform', kwargs=kwargs)

    def outputs_arbitrary_configure(self, **kwargs):
        return self.call('outputs_arbitrary_configure', kwargs=kwargs)

    def get_arbitrary_sample_rate(self, **kwargs):
        return self.call('get_arbitrary_sample_rate', kwargs=kwargs)

    def set_arbitrary_sample_rate(self, **kwargs):
        return self.call('set_arbitrary_sample_rate', kwargs=kwargs)

    def get_arbitrary_waveform_number_waveforms_max(self, **kwargs):
        return self.call('get_arbitrary_waveform_number_waveforms_max', kwargs=kwargs)

    def get_arbitrary_waveform_size_max(self, **kwargs):
        return self.call('get_arbitrary_waveform_size_max', kwargs=kwargs)

    def get_arbitrary_waveform_size_min(self, **kwargs):
        return self.call('get_arbitrary_waveform_size_min', kwargs=kwargs)

    def get_arbitrary_waveform_quantum(self, **kwargs):
        return self.call('get_arbitrary_waveform_quantum', kwargs=kwargs)

    def arbitrary_waveform_configure(self, **kwargs):
        return self.call('arbitrary_waveform_configure', kwargs=kwargs)

    def arbitrary_waveform_clear(self, **kwargs):
        return self.call('arbitrary_waveform_clear', kwargs=kwargs)

    def arbitrary_waveform_create(self, **kwargs):
        return self.call('arbitrary_waveform_create', kwargs=kwargs)

    def get_outputs_arbitrary_frequency(self, **kwargs):
        return self.call('get_outputs_arbitrary_frequency', kwargs=kwargs)

    def set_outputs_arbitrary_frequency(self, **kwargs):
        return self.call('set_outputs_arbitrary_frequency', kwargs=kwargs)

    def outputs_arbitrary_create_waveform(self, **kwargs):
        return self.call('outputs_arbitrary_create_waveform', kwargs=kwargs)

    def arbitrary_waveform_create_channel_waveform(self, **kwargs):
        return self.call('arbitrary_waveform_create_channel_waveform', kwargs=kwargs)
