...
class CommunityStrictTektronixoa5022(CommunityRepoLoader):
    ...
    def get_disable(self, **kwargs):
        return self.call('get_disable', kwargs=kwargs)

    def set_disable(self, **kwargs):
        return self.call('set_disable', kwargs=kwargs)
