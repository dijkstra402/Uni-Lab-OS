...
Original: packages/pymodaq/src/pymodaq/control_modules/utils.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ControlModule")
...
class ControlModule(QObject):
    ...
    def __init__(self):
        print("[UNILAB] ControlModule.__init__() called", flush=True)
        super().__init__()
        self._title = ""
        self.config = config
    ...
    def __repr__(self):
        _unilab_logger.debug("[UNILAB] ControlModule.__repr__() called")
        return f'{self.__class__.__name__}: {self.title}'

    def create_new_file(self, new_file: bool):
        _unilab_logger.debug("[UNILAB] ControlModule.create_new_file() called")
        if new_file:
            self.close_file()
    ...
    @property
    def h5saver(self):
        _unilab_logger.debug("[UNILAB] ControlModule.h5saver() called")
    ...
    def close_file(self):
        _unilab_logger.debug("[UNILAB] ControlModule.close_file() called")
        self.h5saver.close_file()

    @property
    def module_and_data_saver(self):
        _unilab_logger.debug("[UNILAB] ControlModule.module_and_data_saver() called")
    ...
    def custom_command(self, command: str, **kwargs):
        _unilab_logger.debug("[UNILAB] ControlModule.custom_command() called")
    ...
    def thread_status(self, status: ThreadCommand, control_module_type='detector'):
        _unilab_logger.debug("[UNILAB] ControlModule.thread_status() called")
    ...
    def module_type(self):
        _unilab_logger.debug("[UNILAB] ControlModule.module_type() called")
        """str: Get the module type, either DAQ_Move or DAQ_viewer"""
        return type(self).__name__

    @property
    def initialized_state(self):
        _unilab_logger.debug("[UNILAB] ControlModule.initialized_state() called")
        """bool: Check if the module is initialized"""
        return self._initialized_state

    @property
    def title(self):
        _unilab_logger.debug("[UNILAB] ControlModule.title() called")
        """str: get the title of the module"""
        return self._title

    def grab(self):
        _unilab_logger.debug("[UNILAB] ControlModule.grab() called")
        """Programmatic entry to grab data from detectors or current value from actuator"""
        raise NotImplementedError

    def stop_grab(self):
        _unilab_logger.debug("[UNILAB] ControlModule.stop_grab() called")
    ...
    def _add_data_to_saver(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] ControlModule._add_data_to_saver() called")
        raise NotImplementedError

    def append_data(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] ControlModule.append_data() called")
        raise NotImplementedError

    def insert_data(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] ControlModule.insert_data() called")
        raise NotImplementedError

    def quit_fun(self):
        _unilab_logger.debug("[UNILAB] ControlModule.quit_fun() called")
        """Programmatic entry to quit the control module"""
        raise NotImplementedError

    def init_hardware(self, do_init=True):
        _unilab_logger.debug("[UNILAB] ControlModule.init_hardware() called")
    ...
    def init_hardware_ui(self, do_init=True):
        _unilab_logger.debug("[UNILAB] ControlModule.init_hardware_ui() called")
    ...
    def show_log(self):
        _unilab_logger.debug("[UNILAB] ControlModule.show_log() called")
        """Open the log file in the default text editor"""
        import webbrowser
        webbrowser.open(get_base_logger(logger).handlers[0].baseFilename)

    def show_config(self, config: Config) -> Config:
        _unilab_logger.debug("[UNILAB] ControlModule.show_config() called")
    ...
    def update_status(self, txt: str, log=True):
        _unilab_logger.debug("[UNILAB] ControlModule.update_status() called")
    ...
    def manage_ui_actions(self, action_name: str, attribute: str, value):
        _unilab_logger.debug("[UNILAB] ControlModule.manage_ui_actions() called")
