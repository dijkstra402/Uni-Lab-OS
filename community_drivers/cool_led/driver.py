...
Original: microscope/controllers/coolled.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CoolLED")
...
class CoolLED(microscope.abc.Controller):
    ...
    * "unselected" and "on": this is not possible.  If an "unselected"
    ...
    def __init__(self, port: str, **kwargs) -> None:
        print("[UNILAB] CoolLED.__init__() called", flush=True)
        super().__init__(**kwargs)
    ...
    def devices(self) -> Dict[str, microscope.abc.Device]:
        _unilab_logger.debug("[UNILAB] CoolLED.devices() called")
