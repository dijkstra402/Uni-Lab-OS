...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CPUTemperature")
...
class CPUTemperature(PolledInternalDevice):
    ...
    def __repr__(self):
        print("[UNILAB] CPUTemperature.__init__() called", flush=True)
        try:
            self._check_open()
            return (
    ...
    def temperature(self):
        _unilab_logger.debug("[UNILAB] CPUTemperature.temperature() called")
        """
    ...
    @property
    def value(self):
        _unilab_logger.debug("[UNILAB] CPUTemperature.value() called")
        """
    ...
    @property
    def is_active(self):
        _unilab_logger.debug("[UNILAB] CPUTemperature.is_active() called")
        """
