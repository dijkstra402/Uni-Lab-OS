...
Original: donkeycar/management/joystick_creator.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CreateJoystick")
...
class CreateJoystick(object):
    ...
    def __init__(self):
        print("[UNILAB] CreateJoystick.__init__() called", flush=True)
    ...
    def poll(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.poll() called")
        while self.running:
    ...
    def get_button_press(self, duration=10.0):
        _unilab_logger.debug("[UNILAB] CreateJoystick.get_button_press() called")
        self.last_button = None
    ...
    def get_axis_move(self, duration=2.0):
        _unilab_logger.debug("[UNILAB] CreateJoystick.get_axis_move() called")
        self.last_axis = None
        axis_samples = {}
    ...
    def clear_scr(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.clear_scr() called")
        print(chr(27) + "[2J")

    def create_joystick(self, args):
        _unilab_logger.debug("[UNILAB] CreateJoystick.create_joystick() called")
    ...
    def init_js_device(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.init_js_device() called")
        from donkeycar.parts.controller import JoystickCreatorController
    ...
    def init_polling_js(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.init_polling_js() called")
        self.running = True
        import threading
    ...
    def find_gyro(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.find_gyro() called")
    ...
    def get_code_from_button(self, button):
        _unilab_logger.debug("[UNILAB] CreateJoystick.get_code_from_button() called")
        code = button
    ...
    def explain_config(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.explain_config() called")
    ...
    def name_buttons(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.name_buttons() called")
        done = False
    ...
    def print_config(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.print_config() called")
        pt = PrettyTable()
    ...
    def name_axes(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.name_axes() called")
        self.print_config()
        print()
    ...
    def write_python_class_file(self):
        _unilab_logger.debug("[UNILAB] CreateJoystick.write_python_class_file() called")
        pyth_filename = None
        outfile = None
