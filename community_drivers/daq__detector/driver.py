...
Original: packages/pymodaq/src/pymodaq/control_modules/daq_viewer.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DAQ_Detector")
...
class DAQ_Detector(QObject):
    ...
    def __init__(self, title, settings_parameter, detector_name):
        print("[UNILAB] DAQ_Detector.__init__() called", flush=True)
        super().__init__()
    ...
    @property
    def title(self):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.title() called")
        return self._title

    def update_settings(self, settings_parameter_dict):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.update_settings() called")
    ...
    def queue_command(self, command: ThreadCommand):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.queue_command() called")
    ...
    def ini_detector(self, params_state=None, controller=None):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.ini_detector() called")
    ...
    def emit_temp_data(self, data: DataToExport):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.emit_temp_data() called")
    ...
    def data_ready(self, data: DataToExport):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.data_ready() called")
    ...
    def single(self, Naverage=1, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.single() called")
    ...
    def grab_data(self, Naverage=1, live=True, **kwargs):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.grab_data() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] DAQ_Detector.close() called")
