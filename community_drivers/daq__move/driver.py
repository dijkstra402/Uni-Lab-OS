...
Original: packages/pymodaq/src/pymodaq/control_modules/daq_move.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DAQ_Move")
...
class DAQ_Move(ParameterControlModule):
    ...
    def __init__(
        ...
        print("[UNILAB] DAQ_Move.__init__() called", flush=True)
        """
    ...
    def process_ui_cmds(self, cmd: utils.ThreadCommand):
        _unilab_logger.debug("[UNILAB] DAQ_Move.process_ui_cmds() called")
    ...
    def master(self) -> bool:
        _unilab_logger.debug("[UNILAB] DAQ_Move.master() called")
    ...
    def append_data(
        ...
        _unilab_logger.debug("[UNILAB] DAQ_Move.append_data() called")
    ...
    def _add_data_to_saver(self, data: DataToExport, where=None, **kwargs):
        _unilab_logger.debug("[UNILAB] DAQ_Move._add_data_to_saver() called")
    ...
    def stop_motion(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.stop_motion() called")
        """Stop any motion"""
        try:
    ...
    def move(self, move_command: MoveCommand):
        _unilab_logger.debug("[UNILAB] DAQ_Move.move() called")
    ...
    def move_abs(self, value: Union[DataActuator, numbers.Number], send_to_tcpip=False):
        _unilab_logger.debug("[UNILAB] DAQ_Move.move_abs() called")
    ...
    def move_home(self, send_to_tcpip=False):
        _unilab_logger.debug("[UNILAB] DAQ_Move.move_home() called")
    ...
    def move_rel(
        ...
        _unilab_logger.debug("[UNILAB] DAQ_Move.move_rel() called")
    ...
    def move_rel_p(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.move_rel_p() called")
        self.move_rel(self._relative_value)

    def move_rel_m(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.move_rel_m() called")
        self.move_rel(-self._relative_value)

    def quit_fun(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.quit_fun() called")
    ...
    def init_hardware(self, do_init=True):
        _unilab_logger.debug("[UNILAB] DAQ_Move.init_hardware() called")
    ...
    def setup_continuous_saving(self, init: bool = True):
        _unilab_logger.debug("[UNILAB] DAQ_Move.setup_continuous_saving() called")
    ...
    def _init_continuous_save(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move._init_continuous_save() called")
    ...
    def param_deleted(self, param):
        _unilab_logger.debug("[UNILAB] DAQ_Move.param_deleted() called")
    ...
    def child_added(self, param, data):
        _unilab_logger.debug("[UNILAB] DAQ_Move.child_added() called")
    ...
    def raise_timeout(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.raise_timeout() called")
    ...
    def _check_data_type(
        ...
        _unilab_logger.debug("[UNILAB] DAQ_Move.thread_status() called")
    ...
    def get_actuator_value(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.get_actuator_value() called")
    ...
    def grab(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.grab() called")
        if self.ui is not None:
            self.manage_ui_actions("refresh_value", "setChecked", False)
        self.get_continuous_actuator_value(False)

    def stop_grab(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.stop_grab() called")
    ...
    def get_continuous_actuator_value(self, get_value=True):
        _unilab_logger.debug("[UNILAB] DAQ_Move.get_continuous_actuator_value() called")
    ...
    @property
    def actuator(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.actuator() called")
    ...
    def actuators(self) -> List[str]:
        _unilab_logger.debug("[UNILAB] DAQ_Move.actuators() called")
        """Get the list of possible actuators"""
        return ACTUATOR_TYPES

    def update_plugin_config(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.update_plugin_config() called")
    ...
    @property
    def units(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.units() called")
    ...
    def axis_names(self) -> Union[List, Dict]:
        _unilab_logger.debug("[UNILAB] DAQ_Move.axis_names() called")
        """ Get the names of all possible axis"""
        return self.settings.child('move_settings', 'multiaxes', 'axis').opts['limits']

    @property
    def axis_name(self) -> str:
        _unilab_logger.debug("[UNILAB] DAQ_Move.axis_name() called")
    ...
    def get_unit_to_display(unit: str) -> str:
        _unilab_logger.debug("[UNILAB] DAQ_Move.get_unit_to_display() called")
    ...
    def update_settings(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.update_settings() called")
    ...
    def connect_tcp_ip(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.connect_tcp_ip() called")
    ...
    def connect_leco(self, connect: bool) -> None:
        _unilab_logger.debug("[UNILAB] DAQ_Move.connect_leco() called")
        super().connect_leco(connect)

    @Slot(ThreadCommand)
    def process_tcpip_cmds(self, status: ThreadCommand) -> None:
        _unilab_logger.debug("[UNILAB] DAQ_Move.process_tcpip_cmds() called")
...
class DAQ_Move_Hardware(QObject):
    ...
    *motion_stoped*     boolean
    ...
    @property
    def title(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.title() called")
        return self._title

    def close(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.close() called")
        """
    ...
    def check_position(self):
        _unilab_logger.debug("[UNILAB] DAQ_Move.check_position() called")
    ...
    def ini_stage(self, params_state=None, controller: Optional[HardwareController] = None) -> edict:
        _unilab_logger.debug("[UNILAB] DAQ_Move.ini_stage() called")
        """
    ...
    def Move_Stoped(self, pos):
        _unilab_logger.debug("[UNILAB] DAQ_Move.Move_Stoped() called")
        """
    ...
    def move_done(self, pos: DataActuator):
        _unilab_logger.debug("[UNILAB] DAQ_Move.move_done() called")
    ...
    def queue_command(self, command: ThreadCommand):
        _unilab_logger.debug("[UNILAB] DAQ_Move.queue_command() called")
