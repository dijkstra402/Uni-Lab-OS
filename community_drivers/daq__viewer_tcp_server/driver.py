...
Original: packages/pymodaq/src/pymodaq/control_modules/viewer_utility_classes.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DAQ_Viewer_TCP_server")
...
class DAQ_Viewer_TCP_server(DAQ_Viewer_base, TCPServer):
    ...
    def __init__(self, parent=None, params_state=None, grabber_type='2D'):
        print("[UNILAB] DAQ_Viewer_TCP_server.__init__() called", flush=True)
        """
    ...
    def command_to_from_client(self, command: str):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.command_to_from_client() called")
        """Process the command"""
    ...
    def send_data(self, sock: Socket, data: DataToExport):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.send_data() called")
        """
    ...
    def read_data(self, sock: Socket) -> DataToExport:
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.read_data() called")
        """Read data from the socket
        """
        return DeSerializer(sock).dte_deserialization()

    def data_ready(self, data: DataToExport):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.data_ready() called")
        """
    ...
    def command_done(self, command_sock):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.command_done() called")
        try:
            sock = self.find_socket_within_connected_clients(self.client_type)
            if sock is not None:  # if client self.client_type is connected then send it the command
    ...
    def commit_settings(self, param):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.commit_settings() called")
    ...
    def ini_detector(self, controller=None):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.ini_detector() called")
        """
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.close() called")
        """
    ...
    def get_xaxis(self):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.get_xaxis() called")
        """
    ...
    def get_yaxis(self):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.get_yaxis() called")
        """
    ...
    def grab_data(self, Naverage=1, **kwargs):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.grab_data() called")
        """
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.stop() called")
        """
            not implemented.
        """
        pass
    ...
    def set_0D_Mock_data(self):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.set_0D_Mock_data() called")
    ...
    def set_1D_Mock_data(self):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.set_1D_Mock_data() called")
        x = np.linspace(0, 99, 100)
        data_tmp = 10 * gauss1D(x, 50, 10, 1) + 1 * np.random.rand((100))
        self.ind_data += 1
    ...
    def set_2D_Mock_data(self):
        _unilab_logger.debug("[UNILAB] DAQ_Viewer_TCP_server.set_2D_Mock_data() called")
