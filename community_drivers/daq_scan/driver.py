...
Original: packages/pymodaq/src/pymodaq/extensions/daq_scan.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DAQScan")
...
class DAQScan(QObject, ParameterManager):
    ...
    def __init__(self, dockarea: gutils.DockArea = None, dashboard: DashBoard = None):
        print("[UNILAB] DAQScan.__init__() called", flush=True)
        """
    ...
    def plot_from(self):
        _unilab_logger.debug("[UNILAB] DAQScan.plot_from() called")
    ...
    def setup_ui(self):
        _unilab_logger.debug("[UNILAB] DAQScan.setup_ui() called")
    ...
    def set_config(self):
        _unilab_logger.debug("[UNILAB] DAQScan.set_config() called")
    ...
    def process_ui_cmds(self, cmd: utils.ThreadCommand):
        _unilab_logger.debug("[UNILAB] DAQScan.process_ui_cmds() called")
    ...
    def show_log(self):
        _unilab_logger.debug("[UNILAB] DAQScan.show_log() called")
        """Open the log file in the default text editor"""
        import webbrowser
        webbrowser.open(logger.parent.handlers[0].baseFilename)

    def quit_fun(self):
        _unilab_logger.debug("[UNILAB] DAQScan.quit_fun() called")
        """
    ...
    def create_dataset_settings(self):
        _unilab_logger.debug("[UNILAB] DAQScan.create_dataset_settings() called")
    ...
    def show_batcher(self, menubar):
        _unilab_logger.debug("[UNILAB] DAQScan.show_batcher() called")
    ...
    def start_scan_batch(self):
        _unilab_logger.debug("[UNILAB] DAQScan.start_scan_batch() called")
        self.batch_started = True
        self.ind_batch = 0
        self.loop_scan_batch()

    def loop_scan_batch(self):
        _unilab_logger.debug("[UNILAB] DAQScan.loop_scan_batch() called")
    ...
    def set_scan_batch(self, actuators, detectors):
        _unilab_logger.debug("[UNILAB] DAQScan.set_scan_batch() called")
    ...
    def show_file_attributes(self, type_info='dataset'):
        _unilab_logger.debug("[UNILAB] DAQScan.show_file_attributes() called")
        """
    ...
    def show_file_content(self):
        _unilab_logger.debug("[UNILAB] DAQScan.show_file_content() called")
        try:
    ...
    def show_navigator(self):
        _unilab_logger.debug("[UNILAB] DAQScan.show_navigator() called")
    ...
    def show_scan_selector(self):
        _unilab_logger.debug("[UNILAB] DAQScan.show_scan_selector() called")
        viewer_items = []
    ...
    def load_file(self):
        _unilab_logger.debug("[UNILAB] DAQScan.load_file() called")
        self.h5saver.load_file(self.h5saver.h5_file_path)

    def save_file(self):
        _unilab_logger.debug("[UNILAB] DAQScan.save_file() called")
    ...
    def save_metadata(self, node, type_info='dataset_info'):
        _unilab_logger.debug("[UNILAB] DAQScan.save_metadata() called")
        """
    ...
    def create_new_file(self, new_file):
        _unilab_logger.debug("[UNILAB] DAQScan.create_new_file() called")
        if new_file:
            self._metada_dataset_set = False
            self.close_file()
    ...
    @property
    def h5saver(self):
        _unilab_logger.debug("[UNILAB] DAQScan.h5saver() called")
    ...
    def close_file(self):
        _unilab_logger.debug("[UNILAB] DAQScan.close_file() called")
        self.h5saver.close_file()

    @property
    def module_and_data_saver(self):
        _unilab_logger.debug("[UNILAB] DAQScan.module_and_data_saver() called")
    ...
    def update_file_settings(self):
        _unilab_logger.debug("[UNILAB] DAQScan.update_file_settings() called")
        try:
            res = True
    ...
    def update_scan_info(self):
        _unilab_logger.debug("[UNILAB] DAQScan.update_scan_info() called")
    ...
    def update_actuators(self, actuators: List[str]):
        _unilab_logger.debug("[UNILAB] DAQScan.update_actuators() called")
        self.scanner.actuators = self.modules_manager.actuators

    def move_to_crosshair(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] DAQScan.move_to_crosshair() called")
    ...
    def move_at(self, posx: float, posy: float = None):
        _unilab_logger.debug("[UNILAB] DAQScan.move_at() called")
    ...
    def value_changed(self, param):
        _unilab_logger.debug("[UNILAB] DAQScan.value_changed() called")
        """
    ...
    def clear_plot_from(self):
        _unilab_logger.debug("[UNILAB] DAQScan.clear_plot_from() called")
    ...
    def prepare_viewers(self):
        _unilab_logger.debug("[UNILAB] DAQScan.check_number_type_viewers() called")
        """ Assert from selected options the number and type of needed viewers for live plotting
    ...
    def update_status(self, txt: str, wait_time=0):
        _unilab_logger.debug("[UNILAB] DAQScan.update_status() called")
    ...
    def thread_status(self, status: utils.ThreadCommand):
        _unilab_logger.debug("[UNILAB] DAQScan.thread_status() called")
    ...
    def save_temp_live_data(self, scan_data: ScanDataTemp):
        _unilab_logger.debug("[UNILAB] DAQScan.save_temp_live_data() called")
    ...
    def update_live_plots(self):
        _unilab_logger.debug("[UNILAB] DAQScan.update_live_plots() called")
    ...
    def set_scan(self, scan=None) -> bool:
        _unilab_logger.debug("[UNILAB] DAQScan.set_scan() called")
        """
    ...
    def set_metadata_about_current_scan(self):
        _unilab_logger.debug("[UNILAB] DAQScan.set_metadata_about_current_scan() called")
        """
    ...
    def set_metadata_about_dataset(self):
        _unilab_logger.debug("[UNILAB] DAQScan.set_metadata_about_dataset() called")
        """
    ...
    def exit_runner_thread(self, duration : int = 5000):
        _unilab_logger.debug("[UNILAB] DAQScan.exit_runner_thread() called")
    ...
    def start_scan(self):
        _unilab_logger.debug("[UNILAB] DAQScan.start_scan() called")
        """
    ...
    def _init_live(self):
        _unilab_logger.debug("[UNILAB] DAQScan._init_live() called")
        Naverage = self.settings['scan_options', 'scan_average']
        if Naverage > 1:
            scan_shape = [Naverage]
            scan_shape.extend(self.scanner.get_scan_shape())
    ...
    def set_ini_positions(self):
        _unilab_logger.debug("[UNILAB] DAQScan.set_ini_positions() called")
        """
    ...
    def stop_scan(self):
        _unilab_logger.debug("[UNILAB] DAQScan.stop_scan() called")
        """
    ...
    def do_scan(self, start_scan=True):
        _unilab_logger.debug("[UNILAB] DAQScan.do_scan() called")
...
class DAQScanAcquisition(QObject):
    ...
    def start_acquisition(self):
        _unilab_logger.debug("[UNILAB] DAQScan.start_acquisition() called")
        try:
    ...
    def det_done(self, det_done_datas: data_mod.DataToExport, positions):
        _unilab_logger.debug("[UNILAB] DAQScan.det_done() called")
        """
    ...
    def timeout(self):
        _unilab_logger.debug("[UNILAB] DAQScan.timeout() called")
        """
