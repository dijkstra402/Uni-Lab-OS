...
Original: packages/pymodaq/src/pymodaq/dashboard.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DashBoard")
...
class DashBoard(CustomApp):
    ...
    def __init__(self, dockarea):
        print("[UNILAB] DashBoard.__init__() called", flush=True)
        """
    ...
    def splash_sc(self) -> QtWidgets.QSplashScreen:
        _unilab_logger.debug("[UNILAB] DashBoard.splash_sc() called")
    ...
    def set_preset_path(self, path):
        _unilab_logger.debug("[UNILAB] DashBoard.set_preset_path() called")
    ...
    def set_extra_preset_params(self, params, param_options=[]):
        _unilab_logger.debug("[UNILAB] DashBoard.set_extra_preset_params() called")
    ...
    def add_status(self, txt):
        _unilab_logger.debug("[UNILAB] DashBoard.add_status() called")
        """
    ...
    def remove_detectors(self, detector_modules: List[DAQ_Viewer] = None):
        _unilab_logger.debug("[UNILAB] DashBoard.remove_detectors() called")
        """
    ...
    def remove_actuators(self, actuator_modules: List[DAQ_Move] = None):
        _unilab_logger.debug("[UNILAB] DashBoard.remove_actuators() called")
        """
    ...
    def get_docks_from_modules(
        ...
        _unilab_logger.debug("[UNILAB] DashBoard.get_docks_from_modules() called")
        """
    ...
    def remove_modules(
        ...
        _unilab_logger.debug("[UNILAB] DashBoard.remove_modules() called")
        """
    ...
    def clear_move_det_controllers(self):
        _unilab_logger.debug("[UNILAB] DashBoard.clear_move_det_controllers() called")
        """
    ...
    def load_scan_module(self, win=None):
        _unilab_logger.debug("[UNILAB] DashBoard.load_scan_module() called")
        if win is None:
    ...
    def load_log_module(self, win=None):
        _unilab_logger.debug("[UNILAB] DashBoard.load_log_module() called")
        if win is None:
            win = QtWidgets.QMainWindow()
        area = DockArea()
        win.setWindowFlags(
    ...
    def load_pid_module(self, win=None):
        _unilab_logger.debug("[UNILAB] DashBoard.load_pid_module() called")
        if win is None:
    ...
    def load_console(self):
        _unilab_logger.debug("[UNILAB] DashBoard.load_console() called")
    ...
    def load_bayesian(self, win=None):
        _unilab_logger.debug("[UNILAB] DashBoard.load_bayesian() called")
        if win is None:
    ...
    def load_adaptive(self, win=None):
        _unilab_logger.debug("[UNILAB] DashBoard.load_adaptive() called")
        if win is None:
    ...
    def load_datamixer(self, win=None):
        _unilab_logger.debug("[UNILAB] DashBoard.load_datamixer() called")
        if win is None:
    ...
    def load_extension_from_name(self, name: str) -> dict:
        _unilab_logger.debug("[UNILAB] DashBoard.load_extension_from_name() called")
    ...
    def load_extensions_module(self, ext: dict):
        _unilab_logger.debug("[UNILAB] DashBoard.load_extensions_module() called")
    ...
    def setup_actions(self):
        _unilab_logger.debug("[UNILAB] DashBoard.setup_actions() called")
        self.add_action(
    ...
    def update_preset_action_list(self):
        _unilab_logger.debug("[UNILAB] DashBoard.update_preset_action_list() called")
        presets = []
    ...
    def update_preset_action(self, preset_name: str):
        _unilab_logger.debug("[UNILAB] DashBoard.update_preset_action() called")
        self.get_action("load_preset").setToolTip(
            f"Load the {preset_name}.xml preset file!"
        )

    def connect_things(self):
        _unilab_logger.debug("[UNILAB] DashBoard.connect_things() called")
    ...
    def setup_menu(self, menubar: QtWidgets.QMenuBar = None):
        _unilab_logger.debug("[UNILAB] DashBoard.setup_menu() called")
        """
    ...
    def start_plugin_manager(self):
        _unilab_logger.debug("[UNILAB] DashBoard.start_plugin_manager() called")
    ...
    def create_remote(self):
        _unilab_logger.debug("[UNILAB] DashBoard.create_remote() called")
        try:
            if self.preset_file is not None:
    ...
    def create_overshoot(self):
        _unilab_logger.debug("[UNILAB] DashBoard.create_overshoot() called")
        try:
            if self.preset_file is not None:
    ...
    def create_preset(self):
        _unilab_logger.debug("[UNILAB] DashBoard.create_preset() called")
        try:
    ...
    def get_action_from_file(file: Path, manager: ManagerEnums):
        _unilab_logger.debug("[UNILAB] DashBoard.get_action_from_file() called")
        return f"{file.stem}_{manager.name}"

    def modify_remote(self):
        _unilab_logger.debug("[UNILAB] DashBoard.modify_remote() called")
        try:
            path = select_file(
    ...
    def modify_overshoot(self):
        _unilab_logger.debug("[UNILAB] DashBoard.modify_overshoot() called")
        try:
            path = select_file(
    ...
    def modify_roi(self):
        _unilab_logger.debug("[UNILAB] DashBoard.modify_roi() called")
        try:
            path = select_file(
    ...
    def modify_preset(self):
        _unilab_logger.debug("[UNILAB] DashBoard.modify_preset() called")
        try:
    ...
    def remove_preset_related_files(self, name):
        _unilab_logger.debug("[UNILAB] DashBoard.remove_preset_related_files() called")
    ...
    def quit_fun(self):
        _unilab_logger.debug("[UNILAB] DashBoard.quit_fun() called")
        """
    ...
    def restart_fun(self, ask=False):
        _unilab_logger.debug("[UNILAB] DashBoard.restart_fun() called")
        ret = False
        mssg = QMessageBox()
        if ask:
            mssg.setText(
    ...
    def load_layout_state(self, file=None):
        _unilab_logger.debug("[UNILAB] DashBoard.load_layout_state() called")
        """
    ...
    def save_layout_state(self, file=None):
        _unilab_logger.debug("[UNILAB] DashBoard.save_layout_state() called")
        """
    ...
    def save_layout_state_auto(self):
        _unilab_logger.debug("[UNILAB] DashBoard.save_layout_state_auto() called")
        if self.preset_file is not None:
    ...
    def add_move(
        ...
        _unilab_logger.debug("[UNILAB] DashBoard.add_move() called")
    ...
    def add_move_from_extension(
        ...
        _unilab_logger.debug("[UNILAB] DashBoard.add_move_from_extension() called")
    ...
    def add_det(
        ...
        _unilab_logger.debug("[UNILAB] DashBoard.add_det() called")
    ...
    def override_det_from_extension(self, overriden_grabbers: Sequence[str] = None):
        _unilab_logger.debug("[UNILAB] DashBoard.override_det_from_extension() called")
    ...
    def add_det_from_extension(
        ...
        _unilab_logger.debug("[UNILAB] DashBoard.add_det_from_extension() called")
    ...
    def update_module_manager(self):
        _unilab_logger.debug("[UNILAB] DashBoard.update_module_manager() called")
    ...
    def set_file_preset(self, filename) -> Tuple[List[DAQ_Move], List[DAQ_Viewer]]:
        _unilab_logger.debug("[UNILAB] DashBoard.set_file_preset() called")
        """
    ...
    def poll_init(self, module):
        _unilab_logger.debug("[UNILAB] DashBoard.poll_init() called")
        is_init = False
        tstart = perf_counter()
        while not is_init:
            QThread.msleep(1000)
    ...
    def set_roi_configuration(self, filename):
        _unilab_logger.debug("[UNILAB] DashBoard.set_roi_configuration() called")
        if not isinstance(filename, Path):
            filename = Path(filename)
        try:
            if filename.suffix == ".xml":
    ...
    def set_remote_configuration(self, filename):
        _unilab_logger.debug("[UNILAB] DashBoard.set_remote_configuration() called")
        if not isinstance(filename, Path):
            filename = Path(filename)
        ext = filename.suffix
        if ext == ".xml":
    ...
    def activate_remote(self, remote_action, activate_all=False):
        _unilab_logger.debug("[UNILAB] DashBoard.activate_remote() called")
        """
    ...
    def init_pygame(self):
        _unilab_logger.debug("[UNILAB] DashBoard.init_pygame() called")
        try:
            import pygame
    ...
    def pygame_loop(self):
        _unilab_logger.debug("[UNILAB] DashBoard.pygame_loop() called")
        """
    ...
    def activate_shortcut(self, shortcut, action=None, activate=True):
        _unilab_logger.debug("[UNILAB] DashBoard.activate_shortcut() called")
        """
    ...
    def create_activated_shortcut(self, action):
        _unilab_logger.debug("[UNILAB] DashBoard.create_activated_shortcut() called")
        module = self.modules_manager.get_mod_from_name(
    ...
    def set_overshoot_configuration(self, filename):
        _unilab_logger.debug("[UNILAB] DashBoard.set_overshoot_configuration() called")
        try:
            if not isinstance(filename, Path):
                filename = Path(filename)
    ...
    def activate_overshoot(self, status: bool):
        _unilab_logger.debug("[UNILAB] DashBoard.activate_overshoot() called")
        try:
    ...
    def move_modules(self):
        _unilab_logger.debug("[UNILAB] DashBoard.move_modules() called")
        """
    ...
    def set_preset_mode(self, filename):
        _unilab_logger.debug("[UNILAB] DashBoard.set_preset_mode() called")
        """
    ...
    def update_init_tree(self):
        _unilab_logger.debug("[UNILAB] DashBoard.update_init_tree() called")
    ...
    def do_stuff_from_out_bounds(self, out_of_bounds: bool):
        _unilab_logger.debug("[UNILAB] DashBoard.do_stuff_from_out_bounds() called")
        if out_of_bounds:
    ...
    def stop_moves_from_overshoot(self, overshoot):
        _unilab_logger.debug("[UNILAB] DashBoard.stop_moves_from_overshoot() called")
        self.overshoot = overshoot
        self.stop_moves()

    def stop_moves(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] DashBoard.stop_moves() called")
        """
    ...
    def show_log(self):
        _unilab_logger.debug("[UNILAB] DashBoard.show_log() called")
        import webbrowser

        webbrowser.open(logging.getLogger("pymodaq").handlers[0].baseFilename)

    def show_config(self, config):
        _unilab_logger.debug("[UNILAB] DashBoard.show_config() called")
    ...
    def setup_docks(self):
        _unilab_logger.debug("[UNILAB] DashBoard.setup_docks() called")
        # %% create logger dock
    ...
    @property
    def menubar(self):
        _unilab_logger.debug("[UNILAB] DashBoard.menubar() called")
        return self._menubar

    def parameter_tree_changed(self, param, changes):
        _unilab_logger.debug("[UNILAB] DashBoard.parameter_tree_changed() called")
        """
    ...
    def show_about(self):
        _unilab_logger.debug("[UNILAB] DashBoard.show_about() called")
    ...
    def check_update(self, show=True):
        _unilab_logger.debug("[UNILAB] DashBoard.check_update() called")
        try:
    ...
    def show_file_attributes(self, type_info="dataset"):
        _unilab_logger.debug("[UNILAB] DashBoard.show_file_attributes() called")
        """
    ...
    def show_help(self):
        _unilab_logger.debug("[UNILAB] DashBoard.show_help() called")
        QtGui.QDesktopServices.openUrl(QtCore.QUrl("http://pymodaq.cnrs.fr"))

    def update_status(self, txt, wait_time=0, log_type=None):
        _unilab_logger.debug("[UNILAB] DashBoard.update_status() called")
        """
