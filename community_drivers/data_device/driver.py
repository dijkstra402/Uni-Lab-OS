...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DataDevice")
...
class DataDevice(Device, metaclass=abc.ABCMeta):
    ...
    * :meth:`_process_data` (optional)
    ...
    def __init__(self, buffer_length: int = 0, **kwargs) -> None:
        print("[UNILAB] DataDevice.__init__() called", flush=True)
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] DataDevice.__del__() called")
        self.disable()
        super().__del__()
    ...
    @abc.abstractmethod
    def abort(self) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice.abort() called")
        """Stop acquisition as soon as possible."""
        self._acquiring = False

    def enable(self) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice.enable() called")
    ...
    def disable(self) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice.disable() called")
    ...
    def _fetch_data(self) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice._fetch_data() called")
    ...
    def _process_data(self, data):
        _unilab_logger.debug("[UNILAB] DataDevice._process_data() called")
        """Do any data processing and return data."""
        return data

    def _send_data(self, client, data, timestamp):
        _unilab_logger.debug("[UNILAB] DataDevice._send_data() called")
    ...
    def _dispatch_loop(self) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice._dispatch_loop() called")
    ...
    def _fetch_loop(self) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice._fetch_loop() called")
    ...
    @property
    def _client(self):
        _unilab_logger.debug("[UNILAB] DataDevice._client() called")
    ...
    def _put(self, data, timestamp) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice._put() called")
    ...
    def set_client(self, new_client) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice.set_client() called")
    ...
    def update_settings(self, settings, init: bool = False) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice.update_settings() called")
    ...
    def receiveClient(self, client_uri: str) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice.receiveClient() called")
        """A passthrough for compatibility."""
        self.set_client(client_uri)

    def grab_next_data(self, soft_trigger: bool = True):
        _unilab_logger.debug("[UNILAB] DataDevice.grab_next_data() called")
    ...
    def receiveData(self, data, timestamp) -> None:
        _unilab_logger.debug("[UNILAB] DataDevice.receiveData() called")
