...
Original: deprecated/pycqed/instrument_drivers/physical_instruments/QuTech_DDM_module.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DDMq")
...
from deprecated.pycqed.instrument_drivers.physical_instruments.SCPI import SCPI
import numpy as np
import struct
import math
...
class DDMq(SCPI):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] DDMq.__init__() called", flush=True)
    ...
    def ask(self, data):
        _unilab_logger.debug("[UNILAB] DDMq.ask() called")
    ...
    def add_parameters(self):
        _unilab_logger.debug("[UNILAB] DDMq.add_parameter() called")
    ...
    def add_additional_parameters(self):
        _unilab_logger.debug("[UNILAB] DDMq.add_additional_parameters() called")
    ...
    def _ask(self, data):
        _unilab_logger.debug("[UNILAB] DDMq._ask() called")
    ...
    def _write(self, func, data):
        _unilab_logger.debug("[UNILAB] DDMq._write() called")
    ...
    def _setValidatorLimits(self, name, kwargs):
        _unilab_logger.debug("[UNILAB] DDMq._setValidatorLimits() called")
    ...
    def _updateValidatorLimits(self, name, kwargs):
        _unilab_logger.debug("[UNILAB] DDMq._updateValidatorLimits() called")
        try:
    ...
    def _getInputAverage(self, ch):
        _unilab_logger.debug("[UNILAB] DDMq._getInputAverage() called")
    ...
    def _getTVdata(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getTVdata() called")
        finished = '0'
        while (finished != '1'):
    ...
    def _getCorrelationData(self):
        _unilab_logger.debug("[UNILAB] DDMq._getCorrelationData() called")
        finished = '0'
        while (finished != '1'):
    ...
    def _sendWeightData(self, ch, wNr,  weight):
        _unilab_logger.debug("[UNILAB] DDMq._sendWeightData() called")
    ...
    def _getWeightData(self, ch, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getWeightData() called")
    ...
    def _getQstateCNT(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getQstateCNT() called")
        finished = '0'
        while (finished != '1'):
            finished = str(self._getTVFinished(ch_pair, wNr))
            if (finished == 'ffffffff'):
    ...
    def _getQstateAVG(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getQstateAVG() called")
        finished = '0'
        while (finished != '1'):
            finished = str(self._getTVFinished(ch_pair, wNr))
            if (finished == 'ffffffff'):
    ...
    def _getLoggingInt(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getLoggingInt() called")
        finished = '0'
        while (finished != '1'):
    ...
    def _getLoggingQstate(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getLoggingQstate() called")
        finished = '0'
        while (finished != '1'):
            finished = str(self._getLoggingFinished(ch_pair, wNr))
            if (finished == 'ffffffff'):
    ...
    def _getInAvgStatus(self, ch_pair):
        _unilab_logger.debug("[UNILAB] DDMq._getInAvgStatus() called")
        return self.ask('qutech:inputavg{:d}:status? '.format(ch_pair))

    def _getInAvgFinished(self, ch_pair):
        _unilab_logger.debug("[UNILAB] DDMq._getInAvgFinished() called")
    ...
    def _getInAvgBusy(self, ch_pair):
        _unilab_logger.debug("[UNILAB] DDMq._getInAvgBusy() called")
    ...
    def _getTVStatus(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getTVStatus() called")
        return self.ask('qutech:tvmode{:d}:status{:d}? '.format(ch_pair, wNr))

    def _getTVFinished(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getTVFinished() called")
        finished = self.ask(
    ...
    def _getTVBusy(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getTVBusy() called")
        return self.ask('qutech:tvmode{:d}:busy{:d}? '.format(ch_pair, wNr))

    def _getTVpercentage(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getTVpercentage() called")
    ...
    def _getLoggingFinished(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getLoggingFinished() called")
        finished = self.ask(
    ...
    def _getCorrelationStatus(self):
        _unilab_logger.debug("[UNILAB] DDMq._getCorrelationStatus() called")
        return self.ask('qutech:correlation:status? ')

    def _getCorrelationFinished(self):
        _unilab_logger.debug("[UNILAB] DDMq._getCorrelationFinished() called")
        finished = self.ask('qutech:correlation:finished? ')
        fmt_finished = format(int(float(finished)), 'x')
        return fmt_finished

    def _getCorrelationBusy(self):
        _unilab_logger.debug("[UNILAB] DDMq._getCorrelationBusy() called")
        return self.ask('qutech:correlation:busy? ')

    def _getCorrelationpercentage(self):
        _unilab_logger.debug("[UNILAB] DDMq._getCorrelationpercentage() called")
    ...
    def _sendErrFractSglQbitPatternAll(self, ch_pair, pattern):
        _unilab_logger.debug("[UNILAB] DDMq._sendErrFractSglQbitPatternAll() called")
    ...
    def _getErrFractSglQbitPatternAll(self, ch_pair):
        _unilab_logger.debug("[UNILAB] DDMq._getErrFractSglQbitPatternAll() called")
        pstring = self.ask(
    ...
    def _sendErrFractSglQbitPattern(self, ch_pair, wNr, pattern):
        _unilab_logger.debug("[UNILAB] DDMq._sendErrFractSglQbitPattern() called")
    ...
    def _getErrFractSglQbitPattern(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getErrFractSglQbitPattern() called")
        pstring = self.ask(
    ...
    def _getErrFractCnt(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getErrFractCnt() called")
        finished = '0'
        while (finished != '1'):
    ...
    def _getErrFractFinished(self, ch_pair, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._getErrFractFinished() called")
        finished = self.ask(
    ...
    def _send2BitPatternPattern(self, pattern):
        _unilab_logger.debug("[UNILAB] DDMq._send2BitPatternPattern() called")
        self.write('qutech:twoBitPattern:pattern {:d},{:d},{:d},{:d}'.format(
            pattern[0], pattern[1], pattern[2], pattern[3]))

    def _get2BitPatternPattern(self):
        _unilab_logger.debug("[UNILAB] DDMq._get2BitPatternPattern() called")
        pstring = self.ask(
    ...
    def _get2BitPatternCnt(self):
        _unilab_logger.debug("[UNILAB] DDMq._get2BitPatternCnt() called")
        finished = '0'
        while (finished != '1'):
    ...
    def _getTwoBitPatternFinished(self):
        _unilab_logger.debug("[UNILAB] DDMq._getTwoBitPatternFinished() called")
        finished = self.ask('qutech:twoBitPattern:finished? ')
        fmt_finished = format(int(float(finished)), 'x')
        return fmt_finished

    def _getTwoBitPatternBusy(self):
        _unilab_logger.debug("[UNILAB] DDMq._getTwoBitPatternBusy() called")
        return self.ask('qutech:twoBitPattern:busy? ')

    def _getTwoBitPatternPercentage(self):
        _unilab_logger.debug("[UNILAB] DDMq._getTwoBitPatternPercentage() called")
        return self.ask('qutech:twoBitPattern:percentage? ')

    def _getTwoBitPatternStatus(self):
        _unilab_logger.debug("[UNILAB] DDMq._getTwoBitPatternStatus() called")
        return self.ask('qutech:twoBitPattern:status? ')

    # Ask for DDM status
    def _getADCstatus(self, ch_pair):
        _unilab_logger.debug("[UNILAB] DDMq._getADCstatus() called")
        ...
        def _DI():
            _unilab_logger.debug("[UNILAB] DDMq._DI() called")
        ...
        def _DQ():
            _unilab_logger.debug("[UNILAB] DDMq._DQ() called")
        ...
        def _DCLK_PLL_LOCKED():
            _unilab_logger.debug("[UNILAB] DDMq._DCLK_PLL_LOCKED() called")
        ...
        def _CalRun():
            _unilab_logger.debug("[UNILAB] DDMq._CalRun() called")
        ...
        def _FalseTrig():
            _unilab_logger.debug("[UNILAB] DDMq._FalseTrig() called")
        ...
        def _Temperature():
            _unilab_logger.debug("[UNILAB] DDMq._Temperature() called")
    ...
    def _getTHL(self, ch_pair, weight_nr):
        _unilab_logger.debug("[UNILAB] DDMq._getTHL() called")
        ret = self.ask(
    ...
    def _gen_ch_get_func(self, fun, ch):
        _unilab_logger.debug("[UNILAB] DDMq._gen_ch_get_func() called")
        def get_func():
            _unilab_logger.debug("[UNILAB] DDMq.get_func() called")
            return fun(ch)
        return get_func

    # to be able to set ch/ch_pair  in setcmd
    def _gen_ch_set_func(self, fun, ch):
        _unilab_logger.debug("[UNILAB] DDMq._gen_ch_set_func() called")
        def set_func(val):
            _unilab_logger.debug("[UNILAB] DDMq.set_func() called")
            return fun(ch, val)
        return set_func

    # to be able to set ch/ch_pair and weight(qbit) number in getcmd
    def _gen_ch_weight_get_func(self, fun, ch, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._gen_ch_weight_get_func() called")
        def get_func():
            _unilab_logger.debug("[UNILAB] DDMq.get_func() called")
            return fun(ch, wNr)
        return get_func
    ...
    def _gen_ch_weight_set_func(self, fun, ch, wNr):
        _unilab_logger.debug("[UNILAB] DDMq._gen_ch_weight_set_func() called")
        def set_func(val):
            _unilab_logger.debug("[UNILAB] DDMq.set_func() called")
    ...
    def connect_message(self, idn_param='IDN', begin_time=None):
        _unilab_logger.debug("[UNILAB] DDMq.connect_message() called")
    ...
    def _read_parameter_limits(self):
        _unilab_logger.debug("[UNILAB] DDMq.prepare_SSB_weight_and_rotation() called")
    ...
    def _read_ddm_parameters(self):
        _unilab_logger.debug("[UNILAB] DDMq._read_ddm_parameters() called")
        path = os.path.abspath(__file__)
        dir_path = os.path.dirname(path)
        parameters_folder_path = os.path.join(dir_path,
                                              'QuTech_DDM_Parameter_Files')
    ...
    def _store_parameter_limits(self):
        _unilab_logger.debug("[UNILAB] DDMq._store_parameter_limits() called")
        path = os.path.abspath(__file__)
        dir_path = os.path.dirname(path)
        parameters_folder_path = os.path.join(dir_path,
                                              'QuTech_DDM_Parameter_Files')
    ...
    class Error(object):
        ...
        def __repr__(self):
            _unilab_logger.debug("[UNILAB] DDMq.__repr__() called")
            level = ""
        ...
        def log(self):
            _unilab_logger.debug("[UNILAB] DDMq.log() called")
            if (self.logLevel >= logging.CRITICAL):
                log.critical(self)
            elif (self.logLevel >= logging.ERROR):
                log.error(self)
    ...
    def _displayErrors(self, errors):
        _unilab_logger.debug("[UNILAB] DDMq._displayErrors() called")
    ...
    def _parseErrorList(self, acquisitionMode, errorList):
        _unilab_logger.debug("[UNILAB] DDMq._parseErrorList() called")
        results = []
    ...
    def _getInAvgErrors(self, acquisitionMode, ch):
        _unilab_logger.debug("[UNILAB] DDMq._getInAvgErrors() called")
    ...
    def _setWarningLevel(self, level):
        _unilab_logger.debug("[UNILAB] DDMq._setWarningLevel() called")
        self.exceptionLevel = level

    def _getWarningLevel(self):
        _unilab_logger.debug("[UNILAB] DDMq._getWarningLevel() called")
        level = 'notset'
    ...
    def _setDisplayProgressEnabled(self, val):
        _unilab_logger.debug("[UNILAB] DDMq._setDisplayProgressEnabled() called")
        self.printAcquisitionProgress = val

    def _getDisplayProgressEnabled(self):
        _unilab_logger.debug("[UNILAB] DDMq._getDisplayProgressEnabled() called")
