...
Original: src/qumada/instrument/custom_drivers/Harvard/Decadac.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Decadac")
...
class Decadac(VisaInstrument, DacReader):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Decadac.__init__() called", flush=True)
    ...
    def start_script(self):
        _unilab_logger.debug("[UNILAB] Decadac.start_script() called")
        self.ask_raw("{*1:")

    def end_script(self):
        _unilab_logger.debug("[UNILAB] Decadac.end_script() called")
        self.ask_raw("}")

    def run_script(self):
        _unilab_logger.debug("[UNILAB] Decadac.run_script() called")
        self.write_raw("X0;}X1;")
        sleep(1)
        self.device_clear()

    def trigger(self, trigger_setting: str):
        _unilab_logger.debug("[UNILAB] Decadac.trigger() called")
    ...
    def set_all(self, volt: float) -> None:
        _unilab_logger.debug("[UNILAB] Decadac.set_all() called")
        """
    ...
    def ramp_all(self, volt, ramp_rate):
        _unilab_logger.debug("[UNILAB] Decadac.ramp_all() called")
        """
    ...
    def get_idn(self):
        _unilab_logger.debug("[UNILAB] Decadac.get_idn() called")
        """
    ...
    def connect_message(self, idn_param="IDN", begin_time=None):
        _unilab_logger.debug("[UNILAB] Decadac.connect_message() called")
        """
    ...
    def __repr__(self):
        _unilab_logger.debug("[UNILAB] Decadac.__repr__() called")
        """Simplified repr giving just the class and name."""
        return f"<{type(self).__name__}: {self.name}>"

    def _feature_detect(self):
        _unilab_logger.debug("[UNILAB] Decadac._feature_detect() called")
        """
    ...
    def write(self, cmd):
        _unilab_logger.debug("[UNILAB] Decadac.write() called")
        """
        Since all commands are echoed back, we must keep track of responses
