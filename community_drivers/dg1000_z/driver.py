...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DG1000Z")
...
class DG1000Z(object):
    ...
    def __init__(self, inst):
        print("[UNILAB] DG1000Z.__init__() called", flush=True)
        """
    ...
    def _float_or_string(s):
        _unilab_logger.debug("[UNILAB] DG1000Z._float_or_string() called")
        try:
            return float(s)
        except ValueError:
            return s
    ...
    def set_channel_enabled(self, channel, enabled=True):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_channel_enabled() called")
        """
    ...
    def query_channel_enabled(self, channel):
        _unilab_logger.debug("[UNILAB] DG1000Z.query_channel_enabled() called")
        """
    ...
    def set_channel_waveform(self, channel, waveform: Literal['SIN','SQU','RAMP','PULSE','NOISE','DC','USER']):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_channel_waveform() called")
        """
    ...
    def query_waveform(self, channel=1):
        _unilab_logger.debug("[UNILAB] DG1000Z.query_waveform() called")
        """
    ...
    def set_pulse_width(self, channel, width="5us"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_pulse_width() called")
        """
    ...
    def set_pulse_period(self, channel, period="100ms"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_pulse_period() called")
        """
    ...
    def set_pulse_frequency(self, channel, frequency="10Hz"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_pulse_frequency() called")
        """
    ...
    def set_low_voltage_level(self, channel, voltage="0.0V"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_low_voltage_level() called")
        """
    ...
    def set_high_voltage_level(self, channel, voltage="1.0V"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_high_voltage_level() called")
        """
        Set the given channel's high voltage level.
        """
        self.inst.write(f":SOURCE{channel}:VOLT:HIGH {voltage}")
        
    def set_voltage_levels(self, channel, low="0.0V", high="1.0V"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_voltage_levels() called")
        """
    ...
    def set_channel_dc(self, channel, voltage="0.0V"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_channel_dc() called")
        """
    ...
    def set_volatile_waveform(self, channel, waveform: list[float]):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_volatile_waveform() called")
        """
    ...
    def set_channel_arbitrary(self, channel, samplerate="100MSa/s", high_voltage=5.0, low_voltage=0.0):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_channel_arbitrary() called")
        """
    ...
    def set_arb_mode(self, channel, mode: Literal['FREQ', 'SRATE']):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_arb_mode() called")
        """
    ...
    def set_burst_period(self, channel, period="100ms"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_burst_period() called")
        """
    ...
    def set_burst_mode(self, channel, mode: Literal['TRIGGERED', 'INFINITY', 'GATED']):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_burst_mode() called")
        """
    ...
    def set_burst_ncycles(self, channel, ncycles=1000):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_burst_ncycles() called")
        """
    ...
    def set_arb_samplerate(self, channel, samplerate="100MSa/s"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_arb_samplerate() called")
        """
    ...
    def set_burst_enabled(self, channel, enabled=True):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_burst_enabled() called")
        """
    ...
    def set_burst_delay(self, channel, delay="0s"):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_burst_delay() called")
        """
    ...
    def burst_trigger_now(self, channel):
        _unilab_logger.debug("[UNILAB] DG1000Z.burst_trigger_now() called")
        """
        Trigger a burst now
        """
    ...
    def set_burst_trigger_source(self, channel, source: Literal['INTERNAL', 'EXTERNAL', 'MANUAL']):
        _unilab_logger.debug("[UNILAB] DG1000Z.set_burst_trigger_source() called")
        """
