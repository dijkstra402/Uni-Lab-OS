...
Original: lantz/drivers/ni/daqmx/tasks.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DigitalInputTask")
...
from lantz.drivers.ni.daqmx.base import Task, Channel
from lantz.drivers.ni.daqmx.constants import Constants
...
class DigitalInputTask(DigitalTask):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] DigitalInputTask.__init__() called", flush=True)
