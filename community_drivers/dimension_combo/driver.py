...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DimensionCombo")
...
class DimensionCombo(QtWidgets.QComboBox):
    ...
    def connectNode(self, node: Optional[Node] = None) -> None:
        print("[UNILAB] DimensionCombo.__init__() called", flush=True)
    ...
    def setDimensions(self, dims: Sequence[str]) -> None:
        _unilab_logger.debug("[UNILAB] DimensionCombo.setDimensions() called")
    ...
    def signalDimensionSelection(self, val: str) -> str:
        _unilab_logger.debug("[UNILAB] DimensionCombo.signalDimensionSelection() called")
        return val
