...
Original: nion/swift/model/DisplayItem.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DisplayItem")
...
class DisplayItemSaveProperties:
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] DisplayItem.__init__() called")
...
class DisplayItem(Persistence.PersistentObject):
    ...
    def __init__(self, item_uuid: typing.Optional[uuid.UUID] = None, *, data_item: typing.Optional[DataItem.DataItem] = None) -> None:
        print("[UNILAB] DisplayItem.__init__() called", flush=True)
        super().__init__()
        if item_uuid:
            self.uuid = item_uuid
        ...
        def combine_only_one(*vs: typing.Optional[str]) -> str:
            _unilab_logger.debug("[UNILAB] DisplayItem.combine_only_one() called")
        ...
        def combine_display_title(specified_title: typing.Optional[str], data_item_title: typing.Optional[str]) -> str:
            _unilab_logger.debug("[UNILAB] DisplayItem.combine_display_title() called")
            if specified_title:
        ...
        def displayed_titled_changed(display_item: DisplayItem, displayed_title: typing.Optional[str]) -> None:
            _unilab_logger.debug("[UNILAB] DisplayItem.displayed_titled_changed() called")
        ...
        def graphic_selection_changed() -> None:
            _unilab_logger.debug("[UNILAB] DisplayItem.graphic_selection_changed() called")
            # relay the message
    ...
    def close(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.close() called")
    ...
    def __copy__(self) -> DisplayItem:
        _unilab_logger.debug("[UNILAB] DisplayItem.__copy__() called")
        assert False

    def __deepcopy__(self, memo: typing.Dict[typing.Any, typing.Any]) -> DisplayItem:
        _unilab_logger.debug("[UNILAB] DisplayItem.__deepcopy__() called")
    ...
    def update_uuids(self, uuid_map: dict[uuid.UUID, uuid.UUID]) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.update_uuids() called")
        assert not self.persistent_object_context
        for display_data_channel in self.display_data_channels:
    ...
    def created(self) -> datetime.datetime:
        _unilab_logger.debug("[UNILAB] DisplayItem.created() called")
    ...
    def project(self) -> Project.Project:
        _unilab_logger.debug("[UNILAB] DisplayItem.project() called")
        return typing.cast("Project.Project", self.container)

    @property
    def display_type(self) -> typing.Optional[str]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_type() called")
    ...
    def display_data_delta_stream(self) -> Stream.ValueStream[DisplayDataDelta]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_data_delta_stream() called")
        return self.__display_data_delta_stream

    @property
    def calibration_style_id(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.calibration_style_id() called")
    ...
    def intensity_calibration_style_id(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.intensity_calibration_style_id() called")
    ...
    @property
    def display_properties(self) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_properties() called")
    ...
    @property
    def graphics(self) -> typing.Sequence[Graphics.Graphic]:
        _unilab_logger.debug("[UNILAB] DisplayItem.graphics() called")
    ...
    def display_layers(self) -> typing.Sequence[DisplayLayer]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_layers() called")
    ...
    def display_data_channels(self) -> typing.Sequence[DisplayDataChannel]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_data_channels() called")
    ...
    def create_proxy(self) -> Persistence.PersistentObjectProxy[DisplayItem]:
        _unilab_logger.debug("[UNILAB] DisplayItem.create_proxy() called")
        return self.project.create_item_proxy(item=self)

    @property
    def item_specifier(self) -> Persistence.PersistentObjectSpecifier:
        _unilab_logger.debug("[UNILAB] DisplayItem.item_specifier() called")
        return Persistence.PersistentObjectSpecifier(self.uuid)
    ...
    def _notify_display_item_content_changed(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._notify_display_item_content_changed() called")
    ...
    def notify_property_changed(self, key: str) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.notify_property_changed() called")
    ...
    def __display_type_changed(self, name: str, value: str) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__display_type_changed() called")
        self.__property_changed(name, value)
    ...
    def __property_changed(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__property_changed() called")
    ...
    def __display_properties_changed(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__display_properties_changed() called")
        self.notify_property_changed(name)

    def clone(self) -> DisplayItem:
        _unilab_logger.debug("[UNILAB] DisplayItem.clone() called")
    ...
    def snapshot(self) -> DisplayItem:
        _unilab_logger.debug("[UNILAB] DisplayItem.snapshot() called")
    ...
    def set_storage_cache(self, storage_cache: typing.Optional[Cache.CacheLike]) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.set_storage_cache() called")
        if storage_cache:
    ...
    def _suspendable_storage_cache(self) -> typing.Optional[Cache.CacheLike]:
        _unilab_logger.debug("[UNILAB] DisplayItem._suspendable_storage_cache() called")
        return self.__suspendable_storage_cache

    @property
    def _display_cache(self) -> Cache.CacheLike:
        _unilab_logger.debug("[UNILAB] DisplayItem._display_cache() called")
        return self.__cache

    def read_from_dict(self, properties: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.read_from_dict() called")
    ...
    def properties(self) -> typing.Optional[Persistence.PersistentDictType]:
        _unilab_logger.debug("[UNILAB] DisplayItem.properties() called")
        """ Used for debugging. """
    ...
    def _transaction_state_exited(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._transaction_state_exited() called")
        self.__in_transaction_state = False
    ...
    def persistent_object_context_changed(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.persistent_object_context_changed() called")
    ...
    def get_display_property(self, property_name: str, default_value: typing.Any = None) -> typing.Any:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_display_property() called")
    ...
    def set_display_property(self, property_name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.set_display_property() called")
    ...
    def insert_display_layer(self, before_index: int, display_layer: DisplayLayer) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.insert_display_layer() called")
    ...
    def append_display_layer(self, display_layer: DisplayLayer) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.append_display_layer() called")
    ...
    def __insert_display_layer(self, name: str, before_index: int, display_layer: DisplayLayer) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__insert_display_layer() called")
    ...
    def __remove_display_layer(self, name: str, index: int, display_layer: DisplayLayer) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__remove_display_layer() called")
    ...
    def __display_layer_changed(self, name: str) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__display_layer_changed() called")
        self.display_changed_event.fire()

    @property
    def display_layer_info_list(self) -> list[DisplayLayerInfo]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_layer_info_list() called")
    ...
    def display_layers_list(self) -> list[DisplayLayer]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_layers_list() called")
    ...
    def get_display_layer_property(self, index: int, property_name: str, default_value: typing.Any = None) -> typing.Any:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_display_layer_property() called")
    ...
    def _set_display_layer_property(self, index: int, property_name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._set_display_layer_property() called")
    ...
    def _set_display_layer_properties(self, index: int, **kwargs: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._set_display_layer_properties() called")
    ...
    def remove_display_layer(self, index_or_display_layer: typing.Union[int, DisplayLayer], *, safe: bool = False) -> Changes.UndeleteLog:
        _unilab_logger.debug("[UNILAB] DisplayItem.remove_display_layer() called")
    ...
    def undelete_display_layer(self, before_index: int, display_layer: DisplayLayer) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.undelete_display_layer() called")
        self.insert_display_layer(before_index, display_layer)

    def move_display_layer_forward(self, index: int) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.move_display_layer_forward() called")
    ...
    def move_display_layer_backward(self, index: int) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.move_display_layer_backward() called")
        assert 0 <= index < len(self.display_layers)
    ...
    def move_display_layer_at_index_forward(self, index: int) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.move_display_layer_at_index_forward() called")
        self.move_display_layer_forward(index)

    def move_display_layer_at_index_backward(self, index: int) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.move_display_layer_at_index_backward() called")
    ...
    def _add_display_layer_for_data_item(self, data_item: DataItem.DataItem, **kwargs: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._add_display_layer_for_data_item() called")
    ...
    def get_display_layer_by_uuid(self, display_layer_uuid: uuid.UUID) -> typing.Optional[DisplayLayer]:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_display_layer_by_uuid() called")
        for display_layer in self.display_layers:
    ...
    def get_display_layer_display_data_channel(self, index: int) -> typing.Optional[DisplayDataChannel]:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_display_layer_display_data_channel() called")
        assert 0 <= index < len(self.display_layers)
    ...
    def set_display_layer_display_data_channel(self, index: int, display_data_channel: typing.Optional[DisplayDataChannel]) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.set_display_layer_display_data_channel() called")
        assert 0 <= index < len(self.display_layers)
    ...
    def insert_display_layer_for_display_data_channel(self, before_index: int, display_data_channel: DisplayDataChannel, **kwargs: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.insert_display_layer_for_display_data_channel() called")
    ...
    def add_display_layer_for_display_data_channel(self, display_data_channel: DisplayDataChannel, **kwargs: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.add_display_layer_for_display_data_channel() called")
    ...
    def get_display_layer_properties(self, index: int) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_display_layer_properties() called")
    ...
    def get_display_data_channel_layer_use_count(self, display_data_channel: DisplayDataChannel) -> int:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_display_data_channel_layer_use_count() called")
        count = 0
        for display_layer in self.display_layers:
    ...
    def display_layers_match(self, display_item: DisplayItem) -> bool:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_layers_match() called")
    ...
    def append_display_data_channel_for_data_item(self, data_item: DataItem.DataItem, display_layer_properties: typing.Optional[Persistence.PersistentDictType] = None) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.append_display_data_channel_for_data_item() called")
    ...
    def save_properties(self) -> DisplayItemSaveProperties:
        _unilab_logger.debug("[UNILAB] DisplayItem.save_properties() called")
    ...
    def restore_properties(self, properties: DisplayItemSaveProperties) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.restore_properties() called")
    ...
    class ContextManager:
        ...
        def __enter__(self) -> DisplayItem.ContextManager:
            _unilab_logger.debug("[UNILAB] DisplayItem.__enter__() called")
        ...
        def __exit__(self, exception_type: typing.Optional[typing.Type[BaseException]], value: typing.Optional[BaseException], traceback: typing.Optional[types.TracebackType]) -> typing.Optional[bool]:
            _unilab_logger.debug("[UNILAB] DisplayItem.__exit__() called")
    ...
    def display_item_changes(self) -> contextlib.AbstractContextManager[DisplayItem.ContextManager]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_item_changes() called")
    ...
    def _begin_display_item_changes(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._begin_display_item_changes() called")
        with self.__display_item_change_count_lock:
            self.__display_item_change_count += 1

    def _end_display_item_changes(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._end_display_item_changes() called")
        with self.__display_item_change_count_lock:
            self.__display_item_change_count -= 1
    ...
    def increment_display_ref_count(self, amount: int = 1) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.increment_display_ref_count() called")
        """Increment display reference count to indicate this library item is currently displayed."""
    ...
    def decrement_display_ref_count(self, amount: int = 1) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.decrement_display_ref_count() called")
        """Decrement display reference count to indicate this library item is no longer displayed."""
        assert not self._closed
        self.__display_ref_count -= amount
        for display_data_channel in self.display_data_channels:
    ...
    @property
    def _display_ref_count(self) -> int:
        _unilab_logger.debug("[UNILAB] DisplayItem._display_ref_count() called")
        return self.__display_ref_count

    def __data_item_will_change(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__data_item_will_change() called")
        self._begin_display_item_changes()

    def __data_item_did_change(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__data_item_did_change() called")
        self._end_display_item_changes()

    def __item_changed(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__item_changed() called")
    ...
    def __display_channel_property_changed(self, display_data_channel: DisplayDataChannel, name: str) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__display_channel_property_changed() called")
        data_item = display_data_channel.data_item
        if name == "data_item":
    ...
    def display_data_channel(self) -> typing.Optional[DisplayDataChannel]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_data_channel() called")
    ...
    def get_display_data_channel_for_data_item(self, data_item: DataItem.DataItem) -> typing.Optional[DisplayDataChannel]:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_display_data_channel_for_data_item() called")
        for display_data_channel in self.display_data_channels:
    ...
    def __update_displays(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__update_displays() called")
        for display_data_channel in self.display_data_channels:
    ...
    def _description_changed(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem._description_changed() called")
    ...
    def finish_project_read(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.finish_project_read() called")
    ...
    def __get_used_str_value(self, key: str, default_value: str) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.__get_used_str_value() called")
    ...
    def __set_cascaded_value(self, key: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__set_cascaded_value() called")
        if self.data_item:
    ...
    def text_for_filter(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.text_for_filter() called")
    ...
    def caption(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.caption() called")
    ...
    def description(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.description() called")
    ...
    def session_id(self) -> typing.Optional[str]:
        _unilab_logger.debug("[UNILAB] DisplayItem.session_id() called")
    ...
    def tool_tip_str(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.tool_tip_str() called")
    ...
    def list_tool_tip_str(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.list_tool_tip_str() called")
        return self.tool_tip_str

    @property
    def grid_tool_tip_str(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.grid_tool_tip_str() called")
        return self.tool_tip_str

    def __insert_display_data_channel(self, name: str, before_index: int, display_data_channel: DisplayDataChannel) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__insert_display_data_channel() called")
    ...
    def __remove_display_data_channel(self, name: str, index: int, display_data_channel: DisplayDataChannel) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__remove_display_data_channel() called")
    ...
    def __disconnect_display_data_channel(self, display_data_channel: DisplayDataChannel, index: int) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__disconnect_display_data_channel() called")
    ...
    def append_display_data_channel(self, display_data_channel: DisplayDataChannel, display_layer: typing.Optional[DisplayLayer] = None) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.append_display_data_channel() called")
    ...
    def get_unique_display_layer_color(self, preferred_color: typing.Optional[Color.Color] = None) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_unique_display_layer_color() called")
    ...
    def auto_display_legend(self) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.auto_display_legend() called")
    ...
    def __add_display_layer_auto(self, display_layer: DisplayLayer, display_data_channel: DisplayDataChannel, data_row: int = 0) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__add_display_layer_auto() called")
        display_layer.display_data_channel = display_data_channel
    ...
    def insert_display_data_channel(self, before_index: int, display_data_channel: DisplayDataChannel) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.insert_display_data_channel() called")
    ...
    def remove_display_data_channel(self, display_data_channel: DisplayDataChannel, *, safe: bool = False) -> Changes.UndeleteLog:
        _unilab_logger.debug("[UNILAB] DisplayItem.remove_display_data_channel() called")
    ...
    def undelete_display_data_channel(self, before_index: int, display_data_channel: DisplayDataChannel) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.undelete_display_data_channel() called")
    ...
    def data_items(self) -> typing.Sequence[DataItem.DataItem]:
        _unilab_logger.debug("[UNILAB] DisplayItem.data_items() called")
    ...
    def __insert_graphic(self, name: str, before_index: int, graphic: Graphics.Graphic) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__insert_graphic() called")
    ...
    def __remove_graphic(self, name: str, index: int, graphic: Graphics.Graphic) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__remove_graphic() called")
    ...
    def __disconnect_graphic(self, graphic: Graphics.Graphic, index: int) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__disconnect_graphic() called")
    ...
    def insert_graphic(self, before_index: int, graphic: Graphics.Graphic) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.insert_graphic() called")
    ...
    def add_graphic(self, graphic: Graphics.Graphic) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.add_graphic() called")
    ...
    def remove_graphic(self, graphic: Graphics.Graphic, *, safe: bool = False) -> Changes.UndeleteLog:
        _unilab_logger.debug("[UNILAB] DisplayItem.remove_graphic() called")
    ...
    def __graphic_changed(self, graphic: Graphics.Graphic) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.__graphic_changed() called")
        self.graphics_changed_event.fire(self.graphic_selection)

    @property
    def calibration_style(self) -> CalibrationStyle:
        _unilab_logger.debug("[UNILAB] DisplayItem.calibration_style() called")
        return self.__display_data_delta_stream.calibration_style

    @property
    def intensity_calibration_style(self) -> CalibrationStyle:
        _unilab_logger.debug("[UNILAB] DisplayItem.intensity_calibration_style() called")
        return self.__display_data_delta_stream.intensity_calibration_style

    @property
    def display_data_shape(self) -> typing.Optional[DataAndMetadata.ShapeType]:
        _unilab_logger.debug("[UNILAB] DisplayItem.display_data_shape() called")
        return self.__display_data_delta_stream.display_data_shape

    @property
    def displayed_display_data_calibrations(self) -> typing.Optional[typing.Sequence[Calibration.Calibration]]:
        _unilab_logger.debug("[UNILAB] DisplayItem.displayed_display_data_calibrations() called")
        return self.__display_data_delta_stream.displayed_display_data_calibrations

    @property
    def dimensional_shape(self) -> typing.Optional[DataAndMetadata.ShapeType]:
        _unilab_logger.debug("[UNILAB] DisplayItem.dimensional_shape() called")
    ...
    def displayed_dimensional_scales(self) -> typing.Optional[typing.Tuple[float, ...]]:
        _unilab_logger.debug("[UNILAB] DisplayItem.displayed_dimensional_scales() called")
    ...
    @property
    def datum_calibrations(self) -> typing.Sequence[Calibration.Calibration]:
        _unilab_logger.debug("[UNILAB] DisplayItem.datum_calibrations() called")
        """The calibrations for only datum dimensions."""
    ...
    def get_displayed_dimensional_calibrations_with_calibration_style(self, calibration_style: CalibrationStyle) -> typing.Sequence[Calibration.Calibration]:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_displayed_dimensional_calibrations_with_calibration_style() called")
    ...
    @property
    def displayed_dimensional_calibrations(self) -> typing.Sequence[Calibration.Calibration]:
        _unilab_logger.debug("[UNILAB] DisplayItem.displayed_dimensional_calibrations() called")
        """The calibrations for all data dimensions in the displayed calibration style."""
        return self.__display_data_delta_stream.displayed_dimensional_calibrations

    @property
    def calibrated_dimensional_calibrations(self) -> typing.Optional[typing.Sequence[Calibration.Calibration]]:
        _unilab_logger.debug("[UNILAB] DisplayItem.calibrated_dimensional_calibrations() called")
    ...
    def get_displayed_intensity_calibration_with_calibration_style(self, calibration_style: CalibrationStyle) -> Calibration.Calibration:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_displayed_intensity_calibration_with_calibration_style() called")
    ...
    @property
    def displayed_intensity_calibration(self) -> Calibration.Calibration:
        _unilab_logger.debug("[UNILAB] DisplayItem.displayed_intensity_calibration() called")
    ...
    def __get_calibration_style_for_id(self, calibration_style_id: str) -> typing.Optional[CalibrationStyle]:
        _unilab_logger.debug("[UNILAB] DisplayItem.__get_calibration_style_for_id() called")
    ...
    def __get_intensity_calibration_style_for_id(self, calibration_style_id: str) -> typing.Optional[CalibrationStyle]:
        _unilab_logger.debug("[UNILAB] DisplayItem.__get_intensity_calibration_style_for_id() called")
        return self.__display_data_delta_stream.get_intensity_calibration_style_for_id(calibration_style_id)

    @property
    def calibration_styles(self) -> typing.Sequence[CalibrationStyle]:
        _unilab_logger.debug("[UNILAB] DisplayItem.calibration_styles() called")
        return self.__display_data_delta_stream.calibration_styles

    @property
    def intensity_calibration_styles(self) -> typing.Sequence[CalibrationStyle]:
        _unilab_logger.debug("[UNILAB] DisplayItem.intensity_calibration_styles() called")
    ...
    def data_info(self) -> DisplayItem.DataInfo:
        _unilab_logger.debug("[UNILAB] DisplayItem.data_info() called")
        display_data_shape = self.display_data_shape
    ...
    def date_for_sorting_local_as_string(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.date_for_sorting_local_as_string() called")
        data_item = self.data_item
        if data_item:
    ...
    def created_local(self) -> datetime.datetime:
        _unilab_logger.debug("[UNILAB] DisplayItem.created_local() called")
    ...
    def created_local_as_string(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.created_local_as_string() called")
        return self.created_local.strftime("%c")

    @property
    def is_live(self) -> bool:
        _unilab_logger.debug("[UNILAB] DisplayItem.is_live() called")
        return any(data_item.is_live if data_item else False for data_item in self.data_items)

    @property
    def category(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.category() called")
    ...
    def status_str(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.status_str() called")
        data_item = self.data_item
    ...
    def project_str(self) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.project_str() called")
    ...
    def used_display_type(self) -> typing.Optional[str]:
        _unilab_logger.debug("[UNILAB] DisplayItem.used_display_type() called")
    ...
    def view_to_intervals(self, data_and_metadata: DataAndMetadata.DataAndMetadata, intervals: typing.List[typing.Tuple[float, float]]) -> None:
        _unilab_logger.debug("[UNILAB] DisplayItem.view_to_intervals() called")
    ...
    def __get_calibrated_value_text(self, value: float, intensity_calibration: Calibration.Calibration) -> str:
        _unilab_logger.debug("[UNILAB] DisplayItem.__get_calibrated_value_text() called")
        if value is not None:
    ...
    def get_value_and_position_text(self, pos: typing.Optional[typing.Tuple[int, ...]]) -> typing.Tuple[str, str]:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_value_and_position_text() called")
        display_data_channel = self.display_data_channel
    ...
    async def get_value_and_position_text_async(self, pos: typing.Optional[typing.Tuple[int, ...]]) -> typing.Tuple[str, str]:
        _unilab_logger.debug("[UNILAB] DisplayItem.get_value_and_position_text_async() called")
        def get_cursor_value(display_item: DisplayItem) -> typing.Tuple[str, str]:
            _unilab_logger.debug("[UNILAB] DisplayItem.get_cursor_value() called")
            try:
