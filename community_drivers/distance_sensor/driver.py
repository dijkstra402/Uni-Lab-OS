...
Original: gpiozero/input_devices.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DistanceSensor")
...
from gpiozero.devices import GPIODevice, CompositeDevice
from gpiozero.mixins import GPIOQueue, EventsMixin, HoldMixin, event
try:
...
class DistanceSensor(SmoothedInputDevice):
    ...
    def close(self):
        print("[UNILAB] DistanceSensor.__init__() called", flush=True)
        try:
            self._trigger.close()
        except AttributeError:
            pass
    ...
    def max_distance(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor.max_distance() called")
        """
    ...
    def threshold_distance(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor.threshold_distance() called")
        """
    ...
    @property
    def distance(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor.distance() called")
        """
    ...
    @property
    def value(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor.value() called")
        """
    ...
    @property
    def trigger(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor.trigger() called")
        """
    ...
    @property
    def echo(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor.echo() called")
        """
    ...
    def _echo_changed(self, ticks, level):
        _unilab_logger.debug("[UNILAB] DistanceSensor._echo_changed() called")
        if level:
    ...
    def _read(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor._read() called")
    ...
    @property
    def in_range(self):
        _unilab_logger.debug("[UNILAB] DistanceSensor.in_range() called")
        return not self.is_active
