...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Doppler")
...
class Doppler:
    ...
    def __init__(self):
        print("[UNILAB] Doppler.__init__() called", flush=True)
        """
        Configure the USB interface 
        """ 
    ...
    def initProbe(self):
        _unilab_logger.debug("[UNILAB] Doppler.initProbe() called")
    ...
    def stopAcq(self):
        _unilab_logger.debug("[UNILAB] Doppler.stopAcq() called")
    ...
    def startAcq(self):
        _unilab_logger.debug("[UNILAB] Doppler.startAcq() called")
        self.initProbe()


    def startDoppler(self):
        _unilab_logger.debug("[UNILAB] Doppler.startDoppler() called")
    ...
    def getImagesDoppler(self,n=1):
        _unilab_logger.debug("[UNILAB] Doppler.getImagesDoppler() called")
    ...
    def getImages(self,n=1):
        _unilab_logger.debug("[UNILAB] Doppler.getImages() called")
        nReads = (self.nL*self.nP)*(n+1) 
    ...
    def createLoopDoppler(self):
        _unilab_logger.debug("[UNILAB] Doppler.createLoopDoppler() called")
        lenImg    = self.nL*self.nP
    ...
    def createLoop(self):
        _unilab_logger.debug("[UNILAB] Doppler.createLoop() called")
        lenImg = self.nL*self.nP
        newLine = [x[0] for x in np.argwhere(self.raw == np.amax(self.raw))]
        cntFrame = []
        cntNewFrame = []
