...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DriverInterface")
...
class DriverInterface(ModelInterface):
    def __init__(self, *args, **kwargs):
        print("[UNILAB] DriverInterface.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    idle_measurement_interval = 10

    def DeviceFactory(self, key, **kwargs):
        _unilab_logger.debug("[UNILAB] DriverInterface.DeviceFactory() called")
