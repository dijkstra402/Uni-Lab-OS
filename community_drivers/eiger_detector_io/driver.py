...
Original: src/ophyd_async/fastcs/eiger/_eiger_io.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.EigerDetectorIO")
...
class EigerDetectorIO(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] EigerDetectorIO.__init__() called", flush=True)
