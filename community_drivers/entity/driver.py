...
Original: src/mjlab/entity/entity.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Entity")
...
class EntityIndexing:
  ...
  def root_body_id(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.root_body_id() called")
    return self.bodies[0].id


  def __init__(self, *args, **kwargs):
    print("[UNILAB] Entity.__init__() called")
...
class EntityCfg:
  ...
  def build(self) -> Entity:
    _unilab_logger.debug("[UNILAB] Entity.build() called")
...
class Entity:
  ...
  def __init__(self, cfg: EntityCfg) -> None:
    print("[UNILAB] Entity.__init__() called", flush=True)
    self.cfg = cfg
  ...
  def _build_spec(self) -> None:
    _unilab_logger.debug("[UNILAB] Entity._build_spec() called")
    self._spec = auto_wrap_fixed_base_mocap(self.cfg.spec_fn)()

  def _identify_joints(self) -> None:
    _unilab_logger.debug("[UNILAB] Entity._identify_joints() called")
  ...
  def _apply_spec_editors(self) -> None:
    _unilab_logger.debug("[UNILAB] Entity._apply_spec_editors() called")
    for cfg_list in [
      self.cfg.lights,
      self.cfg.cameras,
      self.cfg.textures,
  ...
  def _add_actuators(self) -> None:
    _unilab_logger.debug("[UNILAB] Entity._add_actuators() called")
  ...
  def _add_initial_state_keyframe(self) -> None:
    _unilab_logger.debug("[UNILAB] Entity._add_initial_state_keyframe() called")
  ...
  def has_site_actuators(self) -> bool:
    _unilab_logger.debug("[UNILAB] Entity.has_site_actuators() called")
  ...
  def is_mocap(self) -> bool:
    _unilab_logger.debug("[UNILAB] Entity.is_mocap() called")
  ...
  def spec(self) -> mujoco.MjSpec:
    _unilab_logger.debug("[UNILAB] Entity.spec() called")
    return self._spec

  @property
  def data(self) -> EntityData:
    _unilab_logger.debug("[UNILAB] Entity.data() called")
    return self._data

  @property
  def actuators(self) -> list[actuator.Actuator]:
    _unilab_logger.debug("[UNILAB] Entity.actuators() called")
    return self._actuators

  @property
  def all_joint_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.all_joint_names() called")
    return tuple(j.name.split("/")[-1] for j in self._all_joints)

  @property
  def joint_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.joint_names() called")
    return tuple(j.name.split("/")[-1] for j in self._non_free_joints)

  @property
  def body_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.body_names() called")
    return tuple(b.name.split("/")[-1] for b in self.spec.bodies[1:])

  @property
  def geom_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.geom_names() called")
    return tuple(g.name.split("/")[-1] for g in self.spec.geoms)

  @property
  def tendon_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.tendon_names() called")
    return tuple(t.name.split("/")[-1] for t in self._spec.tendons)

  @property
  def site_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.site_names() called")
    return tuple(s.name.split("/")[-1] for s in self.spec.sites)

  @property
  def actuator_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.actuator_names() called")
    return tuple(a.name.split("/")[-1] for a in self.spec.actuators)

  @property
  def num_joints(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_joints() called")
    return len(self.joint_names)

  @property
  def num_bodies(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_bodies() called")
    return len(self.body_names)

  @property
  def num_geoms(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_geoms() called")
    return len(self.geom_names)

  @property
  def num_sites(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_sites() called")
    return len(self.site_names)

  @property
  def num_actuators(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_actuators() called")
    return len(self.actuator_names)

  @property
  def num_tendons(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_tendons() called")
    return len(self.tendon_names)

  @property
  def camera_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.camera_names() called")
    return tuple(c.name.split("/")[-1] for c in self.spec.cameras)

  @property
  def light_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.light_names() called")
    return tuple(lt.name.split("/")[-1] for lt in self.spec.lights)

  @property
  def num_cameras(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_cameras() called")
    return len(self.camera_names)

  @property
  def num_lights(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_lights() called")
    return len(self.light_names)

  @property
  def material_names(self) -> tuple[str, ...]:
    _unilab_logger.debug("[UNILAB] Entity.material_names() called")
    return tuple(m.name.split("/")[-1] for m in self.spec.materials)

  @property
  def num_materials(self) -> int:
    _unilab_logger.debug("[UNILAB] Entity.num_materials() called")
    return len(self.material_names)

  @property
  def root_body(self) -> mujoco.MjsBody:
    _unilab_logger.debug("[UNILAB] Entity.root_body() called")
  ...
  def find_bodies(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_bodies() called")
  ...
  def find_joints(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_joints() called")
  ...
  def find_actuators(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_actuators() called")
  ...
  def find_tendons(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_tendons() called")
  ...
  def find_joints_by_actuator_names(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_joints_by_actuator_names() called")
  ...
  def find_geoms(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_geoms() called")
  ...
  def find_sites(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_sites() called")
  ...
  def find_cameras(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_cameras() called")
  ...
  def find_lights(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_lights() called")
  ...
  def find_materials(
    ...
    _unilab_logger.debug("[UNILAB] Entity.find_materials() called")
  ...
  def to_zip(self, path: Path) -> None:
    _unilab_logger.debug("[UNILAB] Entity.to_zip() called")
  ...
  def initialize(
    ...
    _unilab_logger.debug("[UNILAB] Entity.initialize() called")
  ...
  def update(self, dt: float) -> None:
    _unilab_logger.debug("[UNILAB] Entity.update() called")
    for act in self._actuators:
      act.update(dt)

  def reset(self, env_ids: torch.Tensor | slice | None = None) -> None:
    _unilab_logger.debug("[UNILAB] Entity.reset() called")
  ...
  def write_data_to_sim(self) -> None:
    _unilab_logger.debug("[UNILAB] Entity.write_data_to_sim() called")
    self._apply_actuator_controls()

  def clear_state(self, env_ids: torch.Tensor | slice | None = None) -> None:
    _unilab_logger.debug("[UNILAB] Entity.clear_state() called")
  ...
  def write_ctrl_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_ctrl_to_sim() called")
  ...
  def write_root_state_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_root_state_to_sim() called")
  ...
  def write_root_link_pose_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_root_link_pose_to_sim() called")
  ...
  def write_root_link_velocity_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_root_link_velocity_to_sim() called")
  ...
  def write_root_com_velocity_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_root_com_velocity_to_sim() called")
  ...
  def write_joint_state_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_joint_state_to_sim() called")
  ...
  def write_joint_position_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_joint_position_to_sim() called")
  ...
  def write_joint_velocity_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_joint_velocity_to_sim() called")
  ...
  def set_joint_position_target(
    ...
    _unilab_logger.debug("[UNILAB] Entity.set_joint_position_target() called")
  ...
  def set_joint_velocity_target(
    ...
    _unilab_logger.debug("[UNILAB] Entity.set_joint_velocity_target() called")
  ...
  def set_joint_effort_target(
    ...
    _unilab_logger.debug("[UNILAB] Entity.set_joint_effort_target() called")
  ...
  def set_tendon_len_target(
    ...
    _unilab_logger.debug("[UNILAB] Entity.set_tendon_len_target() called")
  ...
  def set_tendon_vel_target(
    ...
    _unilab_logger.debug("[UNILAB] Entity.set_tendon_vel_target() called")
  ...
  def set_tendon_effort_target(
    ...
    _unilab_logger.debug("[UNILAB] Entity.set_tendon_effort_target() called")
  ...
  def set_site_effort_target(
    ...
    _unilab_logger.debug("[UNILAB] Entity.set_site_effort_target() called")
  ...
  def write_external_wrench_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_external_wrench_to_sim() called")
  ...
  def write_mocap_pose_to_sim(
    ...
    _unilab_logger.debug("[UNILAB] Entity.write_mocap_pose_to_sim() called")
  ...
  def _compute_indexing(self, model: mujoco.MjModel, device: str) -> EntityIndexing:
    _unilab_logger.debug("[UNILAB] Entity._compute_indexing() called")
  ...
  def _apply_actuator_controls(self) -> None:
    _unilab_logger.debug("[UNILAB] Entity._apply_actuator_controls() called")
