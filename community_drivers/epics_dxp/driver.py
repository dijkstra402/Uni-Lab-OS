...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.EpicsDXP")
...
class EpicsDXP(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] EpicsDXP.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
...
class EpicsDXPLowLevel(Device):
    ...
    def get_low_level_parameter(self, index):
        _unilab_logger.debug("[UNILAB] EpicsDXP.get_low_level_parameter() called")
