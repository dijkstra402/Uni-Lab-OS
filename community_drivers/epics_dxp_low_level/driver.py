...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.EpicsDXPLowLevel")
...
class EpicsDXPLowLevelParameter(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] EpicsDXPLowLevel.__init__() called")
        super().__init__(*args, **kwargs)
class EpicsDXPLowLevel(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] EpicsDXPLowLevel.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
        self._parameter_cache = {}

    def get_low_level_parameter(self, index):
        _unilab_logger.debug("[UNILAB] EpicsDXPLowLevel.get_low_level_parameter() called")
