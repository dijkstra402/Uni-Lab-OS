...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.EpicsMCARecord")
...
class EpicsMCARecord(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] EpicsMCARecord.__init__() called", flush=True)
    ...
    def stop(self, *, success=False):
        _unilab_logger.debug("[UNILAB] EpicsMCARecord.stop() called")
