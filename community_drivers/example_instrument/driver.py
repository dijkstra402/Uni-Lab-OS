...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ExampleInstrument")
...
class ExampleInstrument(Instrument):
    ...
    def __init__(self, name =  None, settings = None):
        print("[UNILAB] ExampleInstrument.__init__() called", flush=True)
    ...
    def update(self, settings):
        _unilab_logger.debug("[UNILAB] ExampleInstrument.update() called")
        '''
    ...
    def read_probes(self, key):
        _unilab_logger.debug("[UNILAB] ExampleInstrument.read_probes() called")
        """
    ...
    def is_connected(self):
        _unilab_logger.debug("[UNILAB] ExampleInstrument.is_connected() called")
        '''
