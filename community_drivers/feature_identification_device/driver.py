...
Original: wasatch/FeatureIdentificationDevice.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FeatureIdentificationDevice")
...
class FeatureIdentificationDevice(InterfaceDevice):
    ...
    def __init__(self, device_id, message_queue=None, alert_queue=None):
        print("[UNILAB] FeatureIdentificationDevice.__init__() called", flush=True)
        """
    ...
    def handle_requests(self, requests: list[SpectrometerRequest]):
        _unilab_logger.debug("[UNILAB] FeatureIdentificationDevice.handle_requests() called")
        """
    ...
    def connect(self, retries=0):
        _unilab_logger.debug("[UNILAB] FeatureIdentificationDevice.connect() called")
        """
    ...
    def _post_connect(self):
        _unilab_logger.debug("[UNILAB] FeatureIdentificationDevice._post_connect() called")
        """
    ...
    def reset_area_scan_frame(self):
        _unilab_logger.debug("[UNILAB] FeatureIdentificationDevice.reset_area_scan_frame() called")
        self.area_scan_frame = [ [0] * self.settings.pixels() for line in range(self.settings.eeprom.actual_pixels_vertical) ]

    def disconnect(self):
        _unilab_logger.debug("[UNILAB] FeatureIdentificationDevice.disconnect() called")
    ...
    def _schedule_disconnect(self, exc):
        _unilab_logger.debug("[UNILAB] FeatureIdentificationDevice._schedule_disconnect() called")
        """
    ...
    def reset(self, *args):
        _unilab_logger.debug("[UNILAB] FeatureIdentificationDevice.reset() called")
...
__all__ = ["FeatureIdentificationDevice"]
