...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FilePersistentStorageSystem")
...
class FilePersistentStorageSystem(PersistentStorageSystem):
    ...
    def __init__(self, path: pathlib.Path) -> None:
        print("[UNILAB] FilePersistentStorageSystem.__init__() called", flush=True)
        self.__path = path
        super().__init__()

    def close(self) -> None:
        _unilab_logger.debug("[UNILAB] FilePersistentStorageSystem.close() called")
        pass

    @property
    def path(self) -> pathlib.Path:
        _unilab_logger.debug("[UNILAB] FilePersistentStorageSystem.path() called")
        return self.__path

    def _read_properties(self) -> PersistentDictType:
        _unilab_logger.debug("[UNILAB] FilePersistentStorageSystem._read_properties() called")
        properties = dict()
    ...
    def _write_properties(self) -> None:
        _unilab_logger.debug("[UNILAB] FilePersistentStorageSystem._write_properties() called")
        if self.__path:
...
__all__ = ["FilePersistentStorageSystem"]
