...
Original: esp32flashwriter_v4_2.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FlashFirmware")
...
class FlashFirmware(ttk.Labelframe):
    ...
    def __init__( self, master, device, style=None, fonts=None, *args, **kw ):
        print("[UNILAB] FlashFirmware.__init__() called", flush=True)
        super().__init__( master, *args, **kw )
        #Attributes
        self.master = master
    ...
    def _create_widgets( self ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._create_widgets() called")
        default = self.fonts['default']
    ...
    def _get_sources( self, event=None ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._get_sources() called")
    ...
    def _get_file_size( self, file ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._get_file_size() called")
        try:
    ...
    def _set_erase_all( self, event ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._set_erase_all() called")
    ...
    def _update_status( self, msg ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._update_status() called")
        self.status.set(msg)
        self.update_idletasks()
    ...
    def _write_flash( self ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._write_flash() called")
        #1.Setup widgets
        #self._status_color = 'blue'
    ...
    def _esptool_write_flash( self, esp, args ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._esptool_write_flash() called")
    ...
    def _create_args(self):
        _unilab_logger.debug("[UNILAB] FlashFirmware._create_args() called")
    ...
    def _set_args_flash_size( self ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._set_args_flash_size() called")
    ...
    def _set_args_addr_filename( self ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._set_args_addr_filename() called")
    ...
    def _set_args_erase_all( self ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._set_args_erase_all() called")
        if self._erase_all.get():
    ...
    def _post_write_flash_sop( self ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._post_write_flash_sop() called")
        self._writing = False
    ...
    def _change_baud( self, esp, baud ):
        _unilab_logger.debug("[UNILAB] FlashFirmware._change_baud() called")
        try:
