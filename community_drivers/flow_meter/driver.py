...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FlowMeter")
...
# Vendored repo packages: alicat, alicat
import sys as _sys
...
class FlowMeter:
    ...
    def __init__(self, address: str = '/dev/ttyUSB0', unit: str = 'A', **kwargs: Any) -> None:
        print("[UNILAB] FlowMeter.__init__() called", flush=True)
    ...
    async def __aenter__(self, *args: Any) -> FlowMeter:
        _unilab_logger.debug("[UNILAB] FlowMeter.__aenter__() called")
        """Provide async enter to context manager."""
        return self

    async def __aexit__(self, *args: Any) -> None:
        _unilab_logger.debug("[UNILAB] FlowMeter.__aexit__() called")
    ...
    async def is_connected(cls, port: str, unit: str = 'A') -> bool:
        _unilab_logger.debug("[UNILAB] FlowMeter.is_connected() called")
    ...
    def _test_controller_open(self) -> None:
        _unilab_logger.debug("[UNILAB] FlowMeter._test_controller_open() called")
    ...
    async def _write_and_read(self, command: str) -> str | None:
        _unilab_logger.debug("[UNILAB] FlowMeter._write_and_read() called")
    ...
    async def get(self) -> dict:
        _unilab_logger.debug("[UNILAB] FlowMeter.get() called")
    ...
    async def set_gas(self, gas: str | int) -> None:
        _unilab_logger.debug("[UNILAB] FlowMeter.set_gas() called")
        """Set the gas type.
    ...
    async def create_mix(self, mix_no: int, name: str, gases: dict) -> None:
        _unilab_logger.debug("[UNILAB] FlowMeter.create_mix() called")
        """Create a gas mix.
