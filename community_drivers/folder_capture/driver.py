...
Original: frame_source/folder_capture.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FolderCapture")
...
class FolderCapture(VideoCaptureBase):
    ...
    def __init__(self, source: str, sort_by: str = 'name', width: Optional[int] = None, height: Optional[int] = None, fps: float = 30.0, real_time: bool = True, loop: bool = False, watch_folder: bool = True, **kwargs):
        print("[UNILAB] FolderCapture.__init__() called", flush=True)
    ...
    def _start_folder_watching(self):
        _unilab_logger.debug("[UNILAB] FolderCapture._start_folder_watching() called")
        ...
        try:
            ...
            if WATCHDOG_AVAILABLE:
                ...
                class WatchdogHandler(FileSystemEventHandler):
                    ...
                    def on_created(self, event):
                        _unilab_logger.debug("[UNILAB] FolderCapture.on_created() called")
                        self.folder_handler.on_created(event)
                    
                    def on_deleted(self, event):
                        _unilab_logger.debug("[UNILAB] FolderCapture.on_deleted() called")
                        self.folder_handler.on_deleted(event)
                    
                    def on_moved(self, event):
                        _unilab_logger.debug("[UNILAB] FolderCapture.on_moved() called")
    ...
    def _stop_folder_watching(self):
        _unilab_logger.debug("[UNILAB] FolderCapture._stop_folder_watching() called")
    ...
    def _refresh_file_list_async(self):
        _unilab_logger.debug("[UNILAB] FolderCapture._refresh_file_list_async() called")
    ...
    def start_async(self):
        _unilab_logger.debug("[UNILAB] FolderCapture.start_async() called")
        """
        ...
        self._latest_success = False
        def _capture_loop():
            _unilab_logger.debug("[UNILAB] FolderCapture._capture_loop() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] FolderCapture.stop() called")
        """
    ...
    def _read_frame_for_thread(self):
        _unilab_logger.debug("[UNILAB] FolderCapture._read_frame_for_thread() called")
        """
    ...
    def get_latest_frame(self) -> Tuple[bool, Optional[np.ndarray]]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_latest_frame() called")
        """
    ...
    def connect(self) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.connect() called")
    ...
    def disconnect(self) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.disconnect() called")
    ...
    def _refresh_file_list(self) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture._refresh_file_list() called")
        """
    ...
    def _read_implementation(self) -> Tuple[bool, Optional[np.ndarray]]:
        _unilab_logger.debug("[UNILAB] FolderCapture._read_implementation() called")
    ...
    def _read_direct(self) -> Tuple[bool, Optional[np.ndarray]]:
        _unilab_logger.debug("[UNILAB] FolderCapture._read_direct() called")
    ...
    def set_exposure(self, value: float) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.set_exposure() called")
        logger.warning("Exposure control not applicable for folder capture.")
        return False

    def get_exposure(self) -> Optional[float]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_exposure() called")
        logger.warning("Exposure control not applicable for folder capture.")
        return None

    def set_gain(self, value: float) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.set_gain() called")
        logger.warning("Gain control not applicable for folder capture.")
        return False

    def get_gain(self) -> Optional[float]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_gain() called")
        logger.warning("Gain control not applicable for folder capture.")
        return None

    def enable_auto_exposure(self, enable: bool = True) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.enable_auto_exposure() called")
        logger.warning("Auto exposure control not applicable for folder capture.")
        return False

    def get_frame_size(self) -> Optional[Tuple[int, int]]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_frame_size() called")
    ...
    def set_frame_size(self, width: int, height: int) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.set_frame_size() called")
        self.width = width
        self.height = height
        return True

    def get_fps(self) -> Optional[float]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_fps() called")
        return self.fps

    def set_fps(self, fps: float) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.set_fps() called")
        self.fps = fps
        return True

    def get_current_file_path(self) -> Optional[str]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_current_file_path() called")
        """
    ...
    def get_current_file_info(self) -> Optional[dict]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_current_file_info() called")
        """
    ...
    def get_file_list(self) -> List[str]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_file_list() called")
        """
    ...
    def get_current_index(self) -> int:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_current_index() called")
        """
    ...
    def set_current_index(self, index: int) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.set_current_index() called")
        """
    ...
    def validate_file_list(self) -> int:
        _unilab_logger.debug("[UNILAB] FolderCapture.validate_file_list() called")
        """
    ...
    def get_missing_files(self) -> List[str]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_missing_files() called")
        """
    ...
    def enable_folder_watching(self, enable: bool = True) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.enable_folder_watching() called")
        """
    ...
    def is_folder_watching_enabled(self) -> bool:
        _unilab_logger.debug("[UNILAB] FolderCapture.is_folder_watching_enabled() called")
        """
    ...
    def get_folder_watching_status(self) -> dict:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_folder_watching_status() called")
        """
    ...
    def force_refresh(self) -> int:
        _unilab_logger.debug("[UNILAB] FolderCapture.force_refresh() called")
        """
    ...
    def discover(cls) -> list:
        _unilab_logger.debug("[UNILAB] FolderCapture.discover() called")
        """
    ...
    def get_config_schema(cls) -> Dict[str, Any]:
        _unilab_logger.debug("[UNILAB] FolderCapture.get_config_schema() called")
