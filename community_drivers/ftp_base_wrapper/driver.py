...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FTPBaseWrapper")
...
class FTPBaseWrapper(object):
    ...
    def close(self):
        print("[UNILAB] FTPBaseWrapper.__init__() called", flush=True)
        if self._conn is not None:
            self._conn.close()
        self._conn = None

    def cwd(self, remotedir):
        _unilab_logger.debug("[UNILAB] FTPBaseWrapper.cwd() called")
        self._conn.cwd(remotedir)

    def connect(self, host=None, username=None, password=None):
        _unilab_logger.debug("[UNILAB] FTPBaseWrapper.connect() called")
        raise NotImplementedError

    def save(self, remotefile, localfile):
        _unilab_logger.debug("[UNILAB] FTPBaseWrapper.save() called")
        "save remote file to local file"
        raise NotImplementedError

    def getlines(self, remotefile):
        _unilab_logger.debug("[UNILAB] FTPBaseWrapper.getlines() called")
        "read text of remote file"
        raise NotImplementedError

    def put(self, text, remotefile):
        _unilab_logger.debug("[UNILAB] FTPBaseWrapper.put() called")
