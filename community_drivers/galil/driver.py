...
Original: driver/galil_simulate.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.galil")
...
class galil:
    def __init__(self, config_dict):
        print("[UNILAB] galil.__init__() called", flush=True)
    ...
    def motor_move(self, x_mm, axis, speed, mode, stopping=True):
        _unilab_logger.debug("[UNILAB] galil.motor_move() called")
    ...
    def motor_move_live(self, x_mm, axis, speed, mode):
        _unilab_logger.debug("[UNILAB] galil.motor_move_live() called")
        # this function moves the motor by a set amount of millimeters
        # you have to specify the axis,
        # if no axis is specified this function throws an error
        # if no speed is specified we use the default slow speed
    ...
    def motor_disconnect(self):
        _unilab_logger.debug("[UNILAB] galil.motor_disconnect() called")
        # try:
    ...
    def query_all_axis_positions(self):
        _unilab_logger.debug("[UNILAB] galil.query_all_axis_positions() called")
    ...
    def query_axis(self, axis):
        _unilab_logger.debug("[UNILAB] galil.query_axis() called")
    ...
    def query_moving(self):
        _unilab_logger.debug("[UNILAB] galil.query_moving() called")
    ...
    def motor_off(self, axis):
        _unilab_logger.debug("[UNILAB] galil.motor_off() called")
    ...
    def motor_on(self, axis):
        _unilab_logger.debug("[UNILAB] galil.motor_on() called")
    ...
    def motor_stop(self):
        _unilab_logger.debug("[UNILAB] galil.motor_stop() called")
    ...
    def read_analog_in(self, port: int):
        _unilab_logger.debug("[UNILAB] galil.read_analog_in() called")
    ...
    def read_digital_in(self, port: int):
        _unilab_logger.debug("[UNILAB] galil.read_digital_in() called")
    ...
    def read_digital_out(self, port: int):
        _unilab_logger.debug("[UNILAB] galil.read_digital_out() called")
    ...
    def set_analog_out(self, handle: int, module: int, bitnum: int, value: float):
        _unilab_logger.debug("[UNILAB] galil.set_analog_out() called")
    ...
    def digital_out_on(self, port: int):
        _unilab_logger.debug("[UNILAB] galil.digital_out_on() called")
    ...
    def digital_out_off(self, port: int):
        _unilab_logger.debug("[UNILAB] galil.digital_out_off() called")
    ...
    def infinite_digital_cycles(self, on_time=0.2, off_time=0.2, port=0, init_time=0):
        _unilab_logger.debug("[UNILAB] galil.infinite_digital_cycles() called")
    ...
    def break_infinite_digital_cycles(
        ...
        _unilab_logger.debug("[UNILAB] galil.break_infinite_digital_cycles() called")
        self.cycle_lights = False

    def shutdown_event(self):
        _unilab_logger.debug("[UNILAB] galil.shutdown_event() called")
