...
Original: driver/gamry_simulate.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.gamry")
...
class gamry:
    def __init__(self, config_dict):
        print("[UNILAB] gamry.__init__() called", flush=True)
    ...
    def open_connection(self, force_err=False):
        _unilab_logger.debug("[UNILAB] gamry.open_connection() called")
    ...
    def close_connection(self, force_err=False):
        _unilab_logger.debug("[UNILAB] gamry.close_connection() called")
    ...
    def measurement_setup(self, gsetup="sweep"):
        _unilab_logger.debug("[UNILAB] gamry.measurement_setup() called")
        # sets dtaq mode
    ...
    async def measure(self, sigramp):
        _unilab_logger.debug("[UNILAB] gamry.measure() called")
        self.time_stamp = time.time()
    ...
    def status(self):
        _unilab_logger.debug("[UNILAB] gamry.status() called")
        try:
    ...
    def dump_data(self):
        _unilab_logger.debug("[UNILAB] gamry.dump_data() called")
        pickle.dump(
    ...
    async def potential_ramp(
        ...
        _unilab_logger.debug("[UNILAB] gamry.potential_ramp() called")
    ...
    async def potential_cycle(
        ...
        _unilab_logger.debug("[UNILAB] gamry.potential_cycle() called")
