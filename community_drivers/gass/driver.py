...
Original: py4syn/epics/GASSClass.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GASS")
...
class GASS():
    ...
    def set_element(self, element):
        print("[UNILAB] GASS.__init__() called", flush=True)
        self.element = element.title()

    def get_element(self):
        _unilab_logger.debug("[UNILAB] GASS.get_element() called")
        return self.element.title()

    def set_edge(self, edge):
        _unilab_logger.debug("[UNILAB] GASS.set_edge() called")
        self.edge = edge

    def get_edge(self):
        _unilab_logger.debug("[UNILAB] GASS.get_edge() called")
        return self.edge

    def set_pressure_vacuum(self, pressVacuum):
        _unilab_logger.debug("[UNILAB] GASS.set_pressure_vacuum() called")
        self.pressureVacuum = pressVacuum

    def get_pressure_vacuum(self):
        _unilab_logger.debug("[UNILAB] GASS.get_pressure_vacuum() called")
        return self.pressureVacuum

    def set_pressure_work(self, pressWork):
        _unilab_logger.debug("[UNILAB] GASS.set_pressure_work() called")
        self.pressureWork = pressWork

    def get_pressure_work(self):
        _unilab_logger.debug("[UNILAB] GASS.get_pressure_work() called")
        return self.pressureWork

    def set_extratime_manifold(self, extraTime):
        _unilab_logger.debug("[UNILAB] GASS.set_extratime_manifold() called")
        self.extraTimeManifold = extraTime

    def get_extratime_manifold(self):
        _unilab_logger.debug("[UNILAB] GASS.get_extratime_manifold() called")
        return self.extraTimeManifold

    def set_extratime_manifold_vacuum(self, extraTime):
        _unilab_logger.debug("[UNILAB] GASS.set_extratime_manifold_vacuum() called")
        self.extraTimeManifoldVacuum = extraTime

    def get_extratime_manifold_vacuum(self):
        _unilab_logger.debug("[UNILAB] GASS.get_extratime_manifold_vacuum() called")
        return self.extraTimeManifoldVacuum
    
    def set_gas_proportions(self, gas_proportions):
        _unilab_logger.debug("[UNILAB] GASS.set_gas_proportions() called")
        self.gas_proportions = gas_proportions

    def get_gas_proportions(self):
        _unilab_logger.debug("[UNILAB] GASS.get_gas_proportions() called")
    ...
    def open_valve(self, io_port):
        _unilab_logger.debug("[UNILAB] GASS.open_valve() called")
        try:
    ...
    def open_all_valves(self):
        _unilab_logger.debug("[UNILAB] GASS.open_all_valves() called")
        io_port = -1
    ...
    def open_all_chambers(self):
        _unilab_logger.debug("[UNILAB] GASS.open_all_chambers() called")
        io_port = -1
    ...
    def close_valve(self, io_port):
        _unilab_logger.debug("[UNILAB] GASS.close_valve() called")
        try:
    ...
    def close_all_valves(self):
        _unilab_logger.debug("[UNILAB] GASS.close_all_valves() called")
        io_port = -1
    ...
    def close_all_chambers(self):
        _unilab_logger.debug("[UNILAB] GASS.close_all_chambers() called")
        io_port = -1
    ...
    def do_vacuum_all_chambers(self):
        _unilab_logger.debug("[UNILAB] GASS.do_vacuum_all_chambers() called")
        try:
            # Close all valves
    ...
    def do_vacuum_manifold(self):
        _unilab_logger.debug("[UNILAB] GASS.do_vacuum_manifold() called")
        try:
            # Close all valves
            self.close_all_valves()
    ...
    def fill_all_chambers(self, purge=False):
        _unilab_logger.debug("[UNILAB] GASS.fill_all_chambers() called")
        # Close all valves
        self.close_all_valves()
    ...
    def fill_all_chambers_with_a_gas(self, enumGas, deltaPressures):
        _unilab_logger.debug("[UNILAB] GASS.fill_all_chambers_with_a_gas() called")
    ...
    def purge_all_chambers(self):
        _unilab_logger.debug("[UNILAB] GASS.purge_all_chambers() called")
    ...
    # -------------------------------------------------------------------------
    def start(self):
        _unilab_logger.debug("[UNILAB] GASS.start() called")
        """
    ...
    def __getChambersPressures(self):
        _unilab_logger.debug("[UNILAB] GASS.__getChambersPressures() called")
        #
        pressures = []
    ...
    def __getChamberPressure(self, chamberNumber):
        _unilab_logger.debug("[UNILAB] GASS.__getChamberPressure() called")
        pressure = None
    ...
    def __getTargetPressures(self, deltaPressures, indexGas):
        _unilab_logger.debug("[UNILAB] GASS.__getTargetPressures() called")
        #
        targetPressures = []
        updatedPressures = self.__getChambersPressures()
    ...
    def __waitAllChambersReachPressure(self, targetPressure, greaterThan=False):
        _unilab_logger.debug("[UNILAB] GASS.__waitAllChambersReachPressure() called")
        print("---------------------------")
    ...
    def __waitEachChamberReachPressure(self, targetPressures, greaterThan=False):
        _unilab_logger.debug("[UNILAB] GASS.__waitEachChamberReachPressure() called")
        # Wait until reach target vacuum pressure on all chambers
        for chamberNumber in range(3):
    ...
    def __waitChamberReachPressure(self, chamberNumber, targetPressure, greaterThan=False):
        _unilab_logger.debug("[UNILAB] GASS.__waitChamberReachPressure() called")
    ...
    def __toggleValve(self, valve, waitTime = 0.02):
        _unilab_logger.debug("[UNILAB] GASS.__toggleValve() called")
    ...
    def __getPortNumbers(self, port_sequences):
        _unilab_logger.debug("[UNILAB] GASS.__getPortNumbers() called")
        """
