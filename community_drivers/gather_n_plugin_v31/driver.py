...
Original: ophyd/areadetector/plugins.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GatherNPlugin_V31")
...
from ophyd.signal import ArrayAttributeSignal, EpicsSignal, EpicsSignalRO
from ophyd.utils import enum
from ophyd.utils.errors import DestroyedError, PluginMisconfigurationError, UnprimedPlugin
from ophyd.areadetector.base import ADBase
from ophyd.areadetector.base import ADComponent as Cpt
from ophyd.areadetector.base import DDC_EpicsSignal, DDC_EpicsSignalRO, DDC_SignalWithRBV
...
class GatherNPlugin_V31(GatherNPlugin, version=(3, 1), version_of=GatherNPlugin):
    def __init__(self, *args, **kwargs):
        print("[UNILAB] GatherNPlugin_V31.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
