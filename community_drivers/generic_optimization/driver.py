...
Original: packages/pymodaq/src/pymodaq/extensions/optimizers_base/optimizer.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GenericOptimization")
...
class GenericOptimization(CustomExt):
    ...
    def __init__(self, dockarea, dashboard):
        print("[UNILAB] GenericOptimization.__init__() called", flush=True)
    ...
    @property
    def title(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.title() called")
        return f'{self.__class__.__name__}'

    def ini_custom_attributes(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.ini_custom_attributes() called")
        """ Here you can reimplement specific attributes"""
        self._base_name: str = 'Optimizer'  # base name used for naming the hdf5 file

    @property
    def h5saver(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.h5saver() called")
    ...
    def module_and_data_saver(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.module_and_data_saver() called")
    ...
    def create_new_file(self, new_file):
        _unilab_logger.debug("[UNILAB] GenericOptimization.create_new_file() called")
        if new_file:
            self.close_file()
        self.module_and_data_saver.h5saver = self.h5saver  # force all control modules to update their h5saver

    def close_file(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.close_file() called")
        self.h5saver.close_file()

    def add_data(self, dta: DataToActuatorsOpti):
        _unilab_logger.debug("[UNILAB] GenericOptimization.add_data() called")
    ...
    def validate_config(self) -> bool:
        _unilab_logger.debug("[UNILAB] GenericOptimization.validate_config() called")
        pass

    @property
    def config_path(self) -> Path:
        _unilab_logger.debug("[UNILAB] GenericOptimization.config_path() called")
        return self.optimizer_config.config_path

    def setup_docks(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.setup_docks() called")
        """
    ...
    def populate_status_bar(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.populate_status_bar() called")
    ...
    def get_set_model_params(self, model_name):
        _unilab_logger.debug("[UNILAB] GenericOptimization.get_set_model_params() called")
    ...
    def setup_menu(self, menubar: QtWidgets.QMenuBar = None):
        _unilab_logger.debug("[UNILAB] GenericOptimization.setup_menu() called")
        '''
        to be subclassed
    ...
    def value_changed(self, param):
        _unilab_logger.debug("[UNILAB] GenericOptimization.value_changed() called")
    ...
    def update_prediction_function(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.update_prediction_function() called")
    ...
    def get_stopping_parameters(self) -> StoppingParameters:
        _unilab_logger.debug("[UNILAB] GenericOptimization.get_stopping_parameters() called")
    ...
    def update_stopping_criteria(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.update_stopping_criteria() called")
        self.command_runner.emit(
            utils.ThreadCommand(OptimizerToRunner.STOPPING, self.get_stopping_parameters()))

    def update_bounds(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.update_bounds() called")
        bounds = {}
    ...
    def setup_actions(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.setup_actions() called")
    ...
    def connect_things(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.connect_things() called")
    ...
    def update_model_settings_from_action(self, model: str):
        _unilab_logger.debug("[UNILAB] GenericOptimization.update_model_settings_from_action() called")
        self.settings.child('models', 'model_class').setValue(model)

    def go_to_best(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.go_to_best() called")
    ...
    def allow_go_to(self, enable=True):
        _unilab_logger.debug("[UNILAB] GenericOptimization.allow_go_to() called")
    ...
    def go_to(self, *positions):
        _unilab_logger.debug("[UNILAB] GenericOptimization.go_to() called")
        actuators = self.modules_manager.actuators
        dte_act = DataToActuators('best',
                                  data=[
                                      DataActuator(actuators[ind].title,
    ...
    def quit(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.quit() called")
        self.dockarea.parent().close()
        self.clean_h5_temp()

    def set_model(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.set_model() called")
    ...
    def ini_temp_file(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.ini_temp_file() called")
        self.clean_h5_temp()
    ...
    def ini_live_plot(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.ini_live_plot() called")
    ...
    def update_actuators(self, actuators: List[str]):
        _unilab_logger.debug("[UNILAB] GenericOptimization.update_actuators() called")
    ...
    def update_after_actuators_changed(self, actuators: list[str]):
        _unilab_logger.debug("[UNILAB] GenericOptimization.update_after_actuators_changed() called")
    ...
    def format_bounds(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.format_bounds() called")
    ...
    def set_algorithm(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.set_algorithm() called")
        self.algorithm = ...

    def ini_model(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.ini_model() called")
        try:
    ...
    def do_save(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.do_save() called")
    ...
    def ini_saver(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.ini_saver() called")
        if self.is_action_checked(OptimizerAction.SAVE):
    ...
    def recursive_enable(self, param: putils.Parameter, enable=True):
        _unilab_logger.debug("[UNILAB] GenericOptimization.recursive_enable() called")
        param.setOpts(enabled=enable)
        for child in param.children():
            self.recursive_enable(child, enable)

    def enable_settings_run(self, enable=True):
        _unilab_logger.debug("[UNILAB] GenericOptimization.enable_settings_run() called")
    ...
    def stop_algo(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.stop_algo() called")
        self.command_runner.emit(utils.ThreadCommand(OptimizerToRunner.STOP))

    def restart_algo(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.restart_algo() called")
    ...
    def check_create_save_node(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.check_create_save_node() called")
        node_is_empty = (
    ...
    def ini_optimization_runner(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.ini_optimization_runner() called")
    ...
    def clean_h5_temp(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.clean_h5_temp() called")
    ...
    def optimization_done(self, dte: DataToExport):
        _unilab_logger.debug("[UNILAB] GenericOptimization.optimization_done() called")
        self.go_to_best()
        self.get_action(OptimizerAction.RUN).trigger()
    ...
    def do_live_plot(self, dte_algo: DataToExport):
        _unilab_logger.debug("[UNILAB] GenericOptimization.do_live_plot() called")
        self.enl_index += 1
    ...
    def update_data_plot(self, target_at=None, crosshair_at=None):
        _unilab_logger.debug("[UNILAB] GenericOptimization.update_data_plot() called")
    ...
    def enable_controls_opti(self, enable: bool):
        _unilab_logger.debug("[UNILAB] GenericOptimization.enable_controls_opti() called")
        pass

    def run_optimization(self):
        _unilab_logger.debug("[UNILAB] GenericOptimization.run_optimization() called")
        if self.is_action_checked(OptimizerAction.RUN):
    ...
    def thread_status(self, status: utils.ThreadCommand):
        _unilab_logger.debug("[UNILAB] GenericOptimization.thread_status() called")
        """To reimplement if needed"""

__all__ = ["GenericOptimization"]
