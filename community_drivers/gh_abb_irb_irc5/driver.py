...
Original: https://github.com/rpiRobotics/abb_robot_client / src/abb_robot_client/robotraconteur/abb_robotraconteur_rws_driver.py
...
_unilab_logger = logging.getLogger("unilab.driver.ABBRWSRobotImpl")
