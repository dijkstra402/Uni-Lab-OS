...
Original: https://github.com/EspecNorthAmerica/ChamberConnectLibrary / chamberconnectlibrary/watlowf4.py
...
_unilab_logger = logging.getLogger("unilab.driver.WatlowF4")
