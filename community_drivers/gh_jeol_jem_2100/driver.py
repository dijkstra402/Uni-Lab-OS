...
Original: https://github.com/instamatic-dev/instamatic / src/instamatic/microscope/interface/jeol_microscope.py
...
_unilab_logger = logging.getLogger("unilab.driver.JeolMicroscope")
