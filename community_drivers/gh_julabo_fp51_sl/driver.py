...
Original: https://github.com/Dennis-van-Gils/python-dvg-devices / src/dvg_devices/Julabo_circulator_protocol_RS232.py
...
_unilab_logger = logging.getLogger("unilab.driver.Julabo_circulator")
