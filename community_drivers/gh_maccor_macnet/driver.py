...
Original: https://github.com/battery-data-alliance/pymacnet / pymacnet/maccorspoofer/MaccorSpoofer.py
...
_unilab_logger = logging.getLogger("unilab.driver.ChannelData")
    ...
    def __init__(self, num_channels):
        ...
        for i in range(0, self.num_channels):
            channel_status = copy.deepcopy(
                pymacnet.messages.rx_read_status_msg
            )
...
class MaccorSpoofer:
    ...
    def __init__(self, config: dict):
        ...
        self.__json_server_thread = threading.Thread(
        ...
        self.__tcp_server_thread = threading.Thread(
            target=self.__server_loop,
