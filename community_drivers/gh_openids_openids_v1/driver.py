...
Original: https://github.com/regiregire/OpenIDS / OpenIDS_main.py
...
_unilab_logger = logging.getLogger("unilab.driver.CameraTab")
...
system = OepnIDS_sys.System()
draw = OepnIDS_sys.Draw()
main_gui = OpenIDS()
