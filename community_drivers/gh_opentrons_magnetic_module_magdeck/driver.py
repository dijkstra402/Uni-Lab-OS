...
Original: https://github.com/Opentrons/opentrons / api/src/opentrons/hardware_control/modules/magdeck.py
...
_unilab_logger = logging.getLogger("unilab.driver.MagDeck")
