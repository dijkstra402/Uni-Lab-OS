...
Original: https://github.com/nanoporetech/minknow_api / python/minknow_api/protocol_service.py
...
_unilab_logger = logging.getLogger("unilab.driver.ProtocolService")
