...
Original: https://github.com/nanoporetech/minknow_api / python/minknow_api/promethion_device_service.py
...
_unilab_logger = logging.getLogger("unilab.driver.PromethionDeviceService")
