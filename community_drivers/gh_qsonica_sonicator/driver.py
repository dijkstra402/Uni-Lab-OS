...
Original: https://github.com/machineagency/science-jubilee / src/science_jubilee/tools/Pipette.py
...
_unilab_logger = logging.getLogger("unilab.driver.Pipette")
...
class Pipette(Tool):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            blowout_position=blowout_position,
            drop_tip_position=drop_tip_position,
            mm_to_ul=mm_to_ul,
        )
        self.has_tip = False
