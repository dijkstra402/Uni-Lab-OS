...
Original: https://github.com/Dennis-van-Gils/python-dvg-devices / src/dvg_devices/ThermoFlex_chiller_qdev.py
...
_unilab_logger = logging.getLogger("unilab.driver.ThermoFlex_chiller_qdev")
