...
Original: https://github.com/novonordisk-research/OptiHPLCHandler / src/OptiHPLCHandler/empower_handler.py
...
_unilab_logger = logging.getLogger("unilab.driver.EmpowerHandler")
