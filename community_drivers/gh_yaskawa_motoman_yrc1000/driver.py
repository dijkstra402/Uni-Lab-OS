...
Original: https://github.com/underautomation/Yaskawa.py / underautomation/yaskawa/high_speed_e_server/robot_posture.py
...
_unilab_logger = logging.getLogger("unilab.driver.RobotPosture")
