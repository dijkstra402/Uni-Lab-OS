...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GPIODevice")
...
class GPIODevice(Device):
    ...
    def __init__(self, pin=None, *, pin_factory=None):
        print("[UNILAB] GPIODevice.__init__() called", flush=True)
        super().__init__(pin_factory=pin_factory)
    ...
    def _state_to_value(self, state):
        _unilab_logger.debug("[UNILAB] GPIODevice._state_to_value() called")
        return int(state == self._active_state)

    def _read(self):
        _unilab_logger.debug("[UNILAB] GPIODevice._read() called")
        try:
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] GPIODevice.close() called")
        super().close()
    ...
    @property
    def closed(self):
        _unilab_logger.debug("[UNILAB] GPIODevice.closed() called")
        try:
    ...
    def _check_open(self):
        _unilab_logger.debug("[UNILAB] GPIODevice._check_open() called")
        try:
            super()._check_open()
    ...
    @property
    def pin(self):
        _unilab_logger.debug("[UNILAB] GPIODevice.pin() called")
        """
    ...
    @property
    def value(self):
        _unilab_logger.debug("[UNILAB] GPIODevice.value() called")
        return self._read()

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] GPIODevice.__repr__() called")
        try:
            return (
