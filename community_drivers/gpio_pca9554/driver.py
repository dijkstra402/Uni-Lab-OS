...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GpioPca9554")
...
class GpioPca9554(HardwareLayer):
    ...
    def __init__(self, intf, conf):
        print("[UNILAB] GpioPca9554.__init__() called", flush=True)
    ...
    def init(self):
        _unilab_logger.debug("[UNILAB] GpioPca9554.init() called")
    ...
    def _write_output_port_select(self, value):
        _unilab_logger.debug("[UNILAB] GpioPca9554._write_output_port_select() called")
    ...
    def _read_input_port(self):
        _unilab_logger.debug("[UNILAB] GpioPca9554._read_input_port() called")
    ...
    def _write_output_port(self, value):
        _unilab_logger.debug("[UNILAB] GpioPca9554._write_output_port() called")
        self._intf.write(self._base_addr + self.PCA9554_ADD,
                         array('B', pack('BB', self.PCA9554_OUT, value)))  # write output lines

    def _read_output_port(self):
        _unilab_logger.debug("[UNILAB] GpioPca9554._read_output_port() called")
    ...
    def _set_output_port(self, mask):
        _unilab_logger.debug("[UNILAB] GpioPca9554._set_output_port() called")
        self._write_output_port(mask | self._read_output_port())

    def _clear_output_port(self, mask):
        _unilab_logger.debug("[UNILAB] GpioPca9554._clear_output_port() called")
        self._write_output_port(~mask & self._read_output_port())

    def _get_input_port(self, mask):
        _unilab_logger.debug("[UNILAB] GpioPca9554._get_input_port() called")
