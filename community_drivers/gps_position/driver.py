...
Original: donkeycar/parts/gps.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GpsPosition")
...
class GpsPosition:
    ...
    def __init__(self, serial:SerialPort, debug = False) -> None:
        print("[UNILAB] GpsPosition.__init__() called", flush=True)
    ...
    def _start(self):
        _unilab_logger.debug("[UNILAB] GpsPosition._start() called")
    ...
    def run_once(self, lines):
        _unilab_logger.debug("[UNILAB] GpsPosition.run_once() called")
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] GpsPosition.run() called")
        lines = line_reader.run()
        return self.run_once(lines)

    def run_threaded(self):
        _unilab_logger.debug("[UNILAB] GpsPosition.run_threaded() called")
        lines = line_reader.run_threaded()
        return self.run_once(lines)

    def update(self):
        _unilab_logger.debug("[UNILAB] GpsPosition.update() called")
        self.line_reader.update()

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] GpsPosition.shutdown() called")
