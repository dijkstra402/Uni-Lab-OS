...
Original: PYTHON/OLD/grblboard.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.grblboard")
...
class grblboard:
    ...
    def close(self):
        print("[UNILAB] grblboard.__init__() called", flush=True)
        """ CLose Serial Connection"""
        self.serial_xyz.close()

    def initserial(self):
        _unilab_logger.debug("[UNILAB] grblboard.initserial() called")
    ...
    def zero_position(self):
        _unilab_logger.debug("[UNILAB] grblboard.zero_position() called")
        self.resethome()
        self.currentposition=self.getcurrentpos()

    def auto_detect_serial_unix(self, preferred_list=['*']):
        _unilab_logger.debug("[UNILAB] grblboard.auto_detect_serial_unix() called")
    ...
    def setideltime(self):
        _unilab_logger.debug("[UNILAB] grblboard.setideltime() called")
        self.sendgrbl('$1='+str(self.idletime)) # default: 314.961 #,x step/mm) 

    def setspeed(self):
        _unilab_logger.debug("[UNILAB] grblboard.setspeed() called")
    ...
    def setaccellaration(self):
        _unilab_logger.debug("[UNILAB] grblboard.setaccellaration() called")
    ...
    def setphysicalcoords(self):
        _unilab_logger.debug("[UNILAB] grblboard.setphysicalcoords() called")
    ...
    def resethome(self):
        _unilab_logger.debug("[UNILAB] grblboard.resethome() called")
        self.sendgrbl("G10 L20 P1 X0 Y0 Z0")
        self.sendgrbl("G10 P0 L20 X0 Y0 Z0")
        print('myhome is: '+str(self.getcurrentpos()))

    def getcurrentpos(self):
        _unilab_logger.debug("[UNILAB] grblboard.getcurrentpos() called")
    ...
    def sendgrbl(self, cmd="?"):
        _unilab_logger.debug("[UNILAB] grblboard.sendgrbl() called")
        #print(cmd)
    ...
    def go_to(self, pos_x=0, pos_y=0, pos_z=0, mode='abs'):
        _unilab_logger.debug("[UNILAB] grblboard.go_to() called")
 #       self.mystepstogo = (pos_x, pos_y)-self.currentposition        
    ...
    def set_laser_intensity(self, intensity):
        _unilab_logger.debug("[UNILAB] grblboard.set_laser_intensity() called")
    ...
    def set_led(self, state=1):
        _unilab_logger.debug("[UNILAB] grblboard.set_led() called")
