...
Original: robotiqcontrol/GripperController.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GripperController")
...
# Vendored repo packages: robotiqcontrol
import sys as _sys
...
class GripperController:
    def __init__(self, server_ip, port=502, unit_id=9, update_interval=0.1):
        print("[UNILAB] GripperController.__init__() called", flush=True)
    ...
    def _update_loop(self):
        _unilab_logger.debug("[UNILAB] GripperController._update_loop() called")
    ...
    def _update_status(self):
        _unilab_logger.debug("[UNILAB] GripperController._update_status() called")
    ...
    def add_leading_zeros(bin_num, total_length=16):
        _unilab_logger.debug("[UNILAB] GripperController.add_leading_zeros() called")
    ...
    def Byte_status(variable: int) -> str:
        _unilab_logger.debug("[UNILAB] GripperController.Byte_status() called")
    ...
    def stat(variable: int) -> str:
        _unilab_logger.debug("[UNILAB] GripperController.stat() called")
    ...
    def activate(self):
        _unilab_logger.debug("[UNILAB] GripperController.activate() called")
    ...
    def command_gripper(self, rPRA=[1, 1, 1], rSP=[250, 250, 250], rFR=[250, 250, 250], rMOD="Basic", rICF=False):
        _unilab_logger.debug("[UNILAB] GripperController.command_gripper() called")
    ...
    def status(self):
        _unilab_logger.debug("[UNILAB] GripperController.status() called")
        readData = self.client.read_input_registers(0,8)
        if readData:
            self.gSTA, self.gIMC, self.gGTO, self.gMOD, self.gACT, self.gDTS, self.gDTC, self.gDTB, self.gDTA = self.stat(self.add_leading_zeros(bin(readData[0])))
            self.FaultStatus, self.FingerA_PositionReqEcho = self.Byte_status(self.add_leading_zeros(bin(readData[1])))
    ...
    def _action_req_variable(self, rARD: int = 0, rATR: int = 0, rGTO: int = 0, rACT: int = 0, rMOD:int = 0, rICS:int = 0, rICF:int = 0 ) -> str:
        _unilab_logger.debug("[UNILAB] GripperController._action_req_variable() called")
    ...
    def _position_req_variable(self, rPR: int = 0) -> str:
        _unilab_logger.debug("[UNILAB] GripperController._position_req_variable() called")
    ...
    def _write_req_variable(self, X: int = 0, Y: int = 0) -> str:
        _unilab_logger.debug("[UNILAB] GripperController._write_req_variable() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] GripperController.close() called")
