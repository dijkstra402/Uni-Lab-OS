...
Original: packages/pymodaq_data/src/pymodaq_data/h5modules/backends.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.H5Backend")
...
class H5Backend:
    def __init__(self, backend='tables'):
        print("[UNILAB] H5Backend.__init__() called", flush=True)
    ...
    @property
    def h5file(self):
        _unilab_logger.debug("[UNILAB] H5Backend.h5file() called")
        return self._h5file
    ...
    @property
    def filename(self):
        _unilab_logger.debug("[UNILAB] H5Backend.filename() called")
        return self._h5file.filename

    def isopen(self):
        _unilab_logger.debug("[UNILAB] H5Backend.isopen() called")
    ...
    def close_file(self):
        _unilab_logger.debug("[UNILAB] H5Backend.close_file() called")
    ...
    def open_file(self, fullpathname, mode='r', title='PyMoDAQ file', **kwargs):
        _unilab_logger.debug("[UNILAB] H5Backend.open_file() called")
    ...
    def save_file_as(self, filenamepath='h5copy.txt'):
        _unilab_logger.debug("[UNILAB] H5Backend.save_file_as() called")
        if self.backend == 'tables':
    ...
    def root(self):
        _unilab_logger.debug("[UNILAB] H5Backend.root() called")
        if self.backend == 'tables':
    ...
    def get_set_group(self, where, name, title='', **kwargs):
        _unilab_logger.debug("[UNILAB] H5Backend.get_set_group() called")
    ...
    def get_group_by_title(self, where, title):
        _unilab_logger.debug("[UNILAB] H5Backend.get_group_by_title() called")
        if isinstance(where, Node):
            where = where.node
    ...
    def is_node_in_group(self, where, name):
        _unilab_logger.debug("[UNILAB] H5Backend.is_node_in_group() called")
        """
    ...
    def get_node(self, where, name=None) -> Node:
        _unilab_logger.debug("[UNILAB] H5Backend.get_node() called")
        if isinstance(where, Node):
            where = where.node
        try:
            if self.backend == 'tables':
    ...
    def get_node_name(self, node):
        _unilab_logger.debug("[UNILAB] H5Backend.get_node_name() called")
        """return node name
        Parameters
        ----------
        node (str or node instance), see h5py and pytables documentation on nodes
    ...
    def get_node_path(self, node):
        _unilab_logger.debug("[UNILAB] H5Backend.get_node_path() called")
        """return node path
        Parameters
        ----------
        node (str or node instance), see h5py and pytables documentation on nodes
    ...
    def get_parent_node(self, node):
        _unilab_logger.debug("[UNILAB] H5Backend.get_parent_node() called")
        if node == self.root():
            return None
        if isinstance(node, Node):
            node = node.node
    ...
    def get_children(self, where):
        _unilab_logger.debug("[UNILAB] H5Backend.get_children() called")
    ...
    def walk_nodes(self, where):
        _unilab_logger.debug("[UNILAB] H5Backend.walk_nodes() called")
        where = self.get_node(where)  # return a node object in case where is a string
        yield where
    ...
    def walk_groups(self, where):
        _unilab_logger.debug("[UNILAB] H5Backend.walk_groups() called")
        where = self.get_node(where)  # return a node object in case where is a string
    ...
    def read(self, array, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] H5Backend.read() called")
    ...
    def create_carray(self, where, name, obj=None, title=''):
        _unilab_logger.debug("[UNILAB] H5Backend.create_carray() called")
        if isinstance(where, Node):
            where = where.node
        if obj is None:
    ...
    def create_earray(self, where, name, dtype, data_shape=None, title=''):
        _unilab_logger.debug("[UNILAB] H5Backend.create_earray() called")
    ...
    def create_vlarray(self, where, name, dtype, title=''):
        _unilab_logger.debug("[UNILAB] H5Backend.create_vlarray() called")
    ...
    def add_group(self, group_name, group_type: Union[GroupType, str], where, title='', metadata=dict([])) -> GROUP:
        _unilab_logger.debug("[UNILAB] H5Backend.add_group() called")
        """
