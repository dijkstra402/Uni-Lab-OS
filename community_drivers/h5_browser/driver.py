...
Original: packages/pymodaq_gui/src/pymodaq_gui/h5modules/browsing.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.H5Browser")
...
class H5Browser(QObject, ActionManager):
    ...
    def __init__(self, parent: QtWidgets.QMainWindow, h5file=None, h5file_path=None, backend='tables'):
        print("[UNILAB] H5Browser.__init__() called", flush=True)
    ...
    def connect_things(self):
        _unilab_logger.debug("[UNILAB] H5Browser.connect_things() called")
    ...
    def get_node_and_plot(self, with_bkg, plot_all=False):
        _unilab_logger.debug("[UNILAB] H5Browser.get_node_and_plot() called")
        self.show_h5_data(item=None, with_bkg=with_bkg, plot_all=plot_all)

    def load_file(self, h5file=None, h5file_path=None):
        _unilab_logger.debug("[UNILAB] H5Browser.load_file() called")
        if h5file is None:
    ...
    def setup_menu(self):
        _unilab_logger.debug("[UNILAB] H5Browser.setup_menu() called")
    ...
    def setup_actions(self):
        _unilab_logger.debug("[UNILAB] H5Browser.setup_actions() called")
    ...
    def check_version(self):
        _unilab_logger.debug("[UNILAB] H5Browser.check_version() called")
    ...
    def add_comments(self, status: bool, comment=''):
        _unilab_logger.debug("[UNILAB] H5Browser.add_comments() called")
    ...
    def get_tree_node_path(self):
        _unilab_logger.debug("[UNILAB] H5Browser.get_tree_node_path() called")
        """Get the node path of the currently selected node in the UI"""
        return self.view.current_node_path()

    def export_data(self):
        _unilab_logger.debug("[UNILAB] H5Browser.export_data() called")
    ...
    def save_file(self, filename=None):
        _unilab_logger.debug("[UNILAB] H5Browser.save_file() called")
    ...
    def quit_fun(self):
        _unilab_logger.debug("[UNILAB] H5Browser.quit_fun() called")
        """
        """
        try:
            self.h5utils.close_file()
    ...
    def show_about(self):
        _unilab_logger.debug("[UNILAB] H5Browser.show_about() called")
    ...
    @staticmethod
    def show_log():
        _unilab_logger.debug("[UNILAB] H5Browser.show_log() called")
        webbrowser.open(logging.getLogger('pymodaq').handlers[0].baseFilename)

    @staticmethod
    def show_help():
        _unilab_logger.debug("[UNILAB] H5Browser.show_help() called")
        QtGui.QDesktopServices.openUrl(QtCore.QUrl("http://pymodaq.cnrs.fr"))

    @staticmethod
    def add_log(txt):
        _unilab_logger.debug("[UNILAB] H5Browser.add_log() called")
        logger.info(txt)

    def show_h5_attributes(self, item=None):
        _unilab_logger.debug("[UNILAB] H5Browser.show_h5_attributes() called")
        try:
            self.current_node_path = self.get_tree_node_path()
    ...
    def show_pixmaps(self, pixmaps=[]):
        _unilab_logger.debug("[UNILAB] H5Browser.show_pixmaps() called")
    ...
    def show_h5_data(self, item, with_bkg=False, plot_all=False):
        _unilab_logger.debug("[UNILAB] H5Browser.show_h5_data() called")
        """
    ...
    def populate_tree(self):
        _unilab_logger.debug("[UNILAB] H5Browser.populate_tree() called")
        """
