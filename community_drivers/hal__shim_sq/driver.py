...
Original: pycqed/instrument_drivers/meta_instrument/HAL/HAL_ShimSQ.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HAL_ShimSQ")
...
# Vendored repo packages: pycqed, pycqed, pycqed.instrument_drivers.physical_instruments.QuTech.CC
import sys as _sys
...
class HAL_ShimSQ(Qubit):
    def __init__(self, name, **kw):
        print("[UNILAB] HAL_ShimSQ.__init__() called", flush=True)
    ...
    def prepare_for_continuous_wave(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.prepare_for_continuous_wave() called")
    ...
    def prepare_readout(self, CW=False):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.prepare_readout() called")
        """
    ...
    def prepare_for_timedomain(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.prepare_for_timedomain() called")
    ...
    def prepare_for_fluxing(self, reset=True):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.prepare_for_fluxing() called")
        pass

    def prepare_characterizing(self, exceptions: list = [], verbose=True):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.prepare_characterizing() called")
    ...
    def hal_acq_spec_mode_on(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.hal_acq_spec_mode_on() called")
    ...
    def hal_acq_spec_mode_off(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.hal_acq_spec_mode_off() called")
    ...
    def hal_spec_source_on(self, power: float, pulsed: bool = False):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.hal_spec_source_on() called")
        """
    ...
    def hal_spec_source_off(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.hal_spec_source_off() called")
        spec_source = self.instr_spec_source.get_instr()
        spec_source.off()

    def hal_flux_get_parameters(self, flux_chan):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.hal_flux_get_parameters() called")
    ...
    def get_int_avg_det(self, **kw):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ.get_int_avg_det() called")
        """
    ...
    def _add_instrument_ref_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_instrument_ref_parameters() called")
        self.add_parameter(
            'instr_device',
    ...
    def _add_config_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_config_parameters() called")
        self.add_parameter(
            'cfg_qubit_nr',
            label='Qubit number',
            vals=vals.Ints(0, 20),
    ...
    def _add_mw_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_mw_parameters() called")
        self.add_parameter(
    ...
    def _add_mw_vsm_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_mw_vsm_parameters() called")
        self.add_parameter(
    ...
    def _add_spec_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_spec_parameters() called")
        self.add_parameter(
            'spec_pow',
            unit='dB',
    ...
    def _add_flux_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_flux_parameters() called")
        self.add_parameter(
            'fl_dc_ch',
    ...
    def _add_ro_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_ro_parameters() called")
        ################################
    ...
    def _add_prep_parameters(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._add_prep_parameters() called")
    ...
    def _set_mw_vsm_delay(self, val):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._set_mw_vsm_delay() called")
    ...
    def _get_mw_vsm_delay(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._get_mw_vsm_delay() called")
        return self._mw_vsm_delay

    def _set_mw_fine_delay(self, val):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._set_mw_fine_delay() called")
        if self.cfg_with_vsm():
    ...
    def _get_mw_fine_delay(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._get_mw_fine_delay() called")
        return self._mw_fine_delay

    def _set_flux_fine_delay(self, val):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._set_flux_fine_delay() called")
    ...
    def _get_flux_fine_delay(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._get_flux_fine_delay() called")
    ...
    def _using_QWG(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._using_QWG() called")
        """
    ...
    def _prep_cw_spec(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_cw_spec() called")
        if self.instr_spec_source() != None:
            self.instr_spec_source.get_instr().power(self.spec_pow())

    def _prep_cw_configure_VSM(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_cw_configure_VSM() called")
        # Configure VSM
    ...
    def _prep_deskewing_matrix(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_deskewing_matrix() called")
        UHFQC = self.instr_acquisition.get_instr()
    ...
    def _prep_ro_instantiate_detectors(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_ro_instantiate_detectors() called")
    ...
    def _prep_ro_sources(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_ro_sources() called")
    ...
    def _prep_ro_pulse(self, upload=True, CW=False):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_ro_pulse() called")
        """
    ...
    def _prep_ro_integration_weights(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_ro_integration_weights() called")
        """
    ...
    def _prep_td_sources(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_td_sources() called")
    ...
    def _prep_mw_pulses(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_mw_pulses() called")
    ...
    def _prep_td_configure_VSM(self):
        _unilab_logger.debug("[UNILAB] HAL_ShimSQ._prep_td_configure_VSM() called")
        # Configure VSM
        VSM = self.instr_VSM.get_instr()
