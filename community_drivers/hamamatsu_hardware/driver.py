...
Original: hardware/CameraHardware.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HamamatsuHardware")
...
# Vendored repo packages: hardware, devices.CameraDevice, hardware.CameraHardware
import sys as _sys
...
class HamamatsuHardware(HardwareComponent):
    def __init__(self, *args, **kwargs):
        print("[UNILAB] HamamatsuHardware.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    name = "HamamatsuHardware"

    def setup(self):
        _unilab_logger.debug("[UNILAB] HamamatsuHardware.setup() called")
    ...
    def connect(self):
        _unilab_logger.debug("[UNILAB] HamamatsuHardware.connect() called")
        """
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] HamamatsuHardware.disconnect() called")
    ...
    def readOnlyWhenOpt(self, value=None):
        _unilab_logger.debug("[UNILAB] HamamatsuHardware.readOnlyWhenOpt() called")
    ...
    def updateCameraSettings(self):
        _unilab_logger.debug("[UNILAB] HamamatsuHardware.updateCameraSettings() called")
