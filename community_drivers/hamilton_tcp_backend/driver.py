...
Original: pylabrobot/liquid_handling/backends/hamilton/tcp_backend.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HamiltonTCPBackend")
...
class HamiltonTCPBackend(LiquidHandlerBackend):
  ...
  def __init__(
    ...
    print("[UNILAB] HamiltonTCPBackend.__init__() called", flush=True)
  ...
  async def _ensure_connected(self):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._ensure_connected() called")
  ...
  async def _reconnect(self):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._reconnect() called")
  ...
  async def write(self, data: bytes, timeout: Optional[float] = None):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.write() called")
  ...
  async def read(self, num_bytes: int = 128, timeout: Optional[float] = None) -> bytes:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.read() called")
  ...
  async def read_exact(self, num_bytes: int, timeout: Optional[float] = None) -> bytes:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.read_exact() called")
  ...
  def is_connected(self) -> bool:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.is_connected() called")
    """Check if the connection is currently established."""
    return self._connected

  async def _read_one_message(self) -> Union[RegistrationResponse, CommandResponse]:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._read_one_message() called")
  ...
  async def setup(self):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.setup() called")
  ...
  async def _initialize_connection(self):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._initialize_connection() called")
  ...
  async def _register_client(self):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._register_client() called")
  ...
  async def _discover_root(self):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._discover_root() called")
  ...
  def _parse_registration_response(self, response: RegistrationResponse) -> list[Address]:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._parse_registration_response() called")
  ...
  def _allocate_sequence_number(self, dest_address: Address) -> int:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend._allocate_sequence_number() called")
  ...
  async def send_command(self, command: HamiltonCommand, timeout: float = 10.0) -> Optional[dict]:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.send_command() called")
  ...
  async def stop(self):
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.stop() called")
  ...
  def serialize(self) -> dict:
    _unilab_logger.debug("[UNILAB] HamiltonTCPBackend.serialize() called")
