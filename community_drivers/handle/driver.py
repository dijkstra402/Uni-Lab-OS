...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Handle")
...
# Vendored repo packages: ambit, ambit
import sys as _sys
...
class Handle:
    ...
    def __init__(self, layout):
        print("[UNILAB] Handle.__init__() called", flush=True)
    ...
    def _process_input(self, message, data):
        _unilab_logger.debug("[UNILAB] Handle._process_input() called")
    ...
    def _process_check(self, check):
        _unilab_logger.debug("[UNILAB] Handle._process_check() called")
        #print('[F] Processing check message')
        self._last_check = time.time()

    def _process_send_version(self):
        _unilab_logger.debug("[UNILAB] Handle._process_send_version() called")
        self.write_messages([{
    ...
    def _process_screen_write(self, index, image_bytes):
        _unilab_logger.debug("[UNILAB] Handle._process_screen_write() called")
        fd = io.BytesIO(image_bytes)
        self.screen_images[index] = image_bytes

    def _process_start(self, start):
        _unilab_logger.debug("[UNILAB] Handle._process_start() called")
    ...
    def _process_stop(self):
        _unilab_logger.debug("[UNILAB] Handle._process_stop() called")
        self._set_phase(Handle.PHASE_BULK)

    def _process_led(self, leds):
        _unilab_logger.debug("[UNILAB] Handle._process_led() called")
    ...
    def _write_layout(self):
        _unilab_logger.debug("[UNILAB] Handle._write_layout() called")
    ...
    def write_messages(self, messages):
        _unilab_logger.debug("[UNILAB] Handle.write_messages() called")
        data = ambit.message_encode(messages)
        self._write(data)

    def _write(self, data):
        _unilab_logger.debug("[UNILAB] Handle._write() called")
    ...
    def _set_phase(self, phase):
        _unilab_logger.debug("[UNILAB] Handle._set_phase() called")
        if phase == self.phase:
            return
        self.phase = phase
    ...
    def bulkWrite(self, ep, data, size, timeout=0):
        _unilab_logger.debug("[UNILAB] Handle.bulkWrite() called")
    ...
    def bulkRead(self, ep, size, timeout=0):
        _unilab_logger.debug("[UNILAB] Handle.bulkRead() called")
    ...
    def controlMsg(self, ep, ctrl, size):
        _unilab_logger.debug("[UNILAB] Handle.controlMsg() called")
        if ambit.FLAGS.debug:
    ...
    def reset(self):
        _unilab_logger.debug("[UNILAB] Handle.reset() called")
        if ambit.FLAGS.verbose:
            print('[F] Handle.reset()')

    def releaseInterface(self):
        _unilab_logger.debug("[UNILAB] Handle.releaseInterface() called")
        if ambit.FLAGS.verbose:
