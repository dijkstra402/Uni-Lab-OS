...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HDAWG")
...
class HDAWG(ZIBaseInstrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] HDAWG.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def _init_additional_nodes(self):
        _unilab_logger.debug("[UNILAB] HDAWG._init_additional_nodes() called")
    ...
    def enable_qccs_mode(self) -> None:
        _unilab_logger.debug("[UNILAB] HDAWG.enable_qccs_mode() called")
