...
Original: lantz/drivers/legacy/kentech/hri.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HRI")
...
class HRI(SerialDriver):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] HRI.__init__() called", flush=True)
    ...
    def query(self, command, *, send_args=(None, None), recv_args=(None, None)):
        _unilab_logger.debug("[UNILAB] HRI.query() called")
    ...
    def query_expect(self, command, recv_termination=None, expected='ok'):
        _unilab_logger.debug("[UNILAB] HRI.query_expect() called")
    ...
    @Action()
    def clear(self):
        _unilab_logger.debug("[UNILAB] HRI.clear() called")
        """Clear the buffer.
        """
        self.send('\r\r')
    ...
    def remote(self, value):
        _unilab_logger.debug("[UNILAB] HRI.remote() called")
        """Remote or local.
        """
        if value:
    ...
    @Feat(read_once=True)
    def revision(self):
        _unilab_logger.debug("[UNILAB] HRI.revision() called")
        """Revision.
        """
    ...
    def trigger_logic(self, value):
        _unilab_logger.debug("[UNILAB] HRI.trigger_logic() called")
        """Trigger logic.
        """
    ...
    def trigger_ttl_termination(self, value):
        _unilab_logger.debug("[UNILAB] HRI.trigger_ttl_termination() called")
    ...
    def trigger_edge(self, value):
        _unilab_logger.debug("[UNILAB] HRI.trigger_edge() called")
    ...
    def trigger_ecl_mode(self, value):
        _unilab_logger.debug("[UNILAB] HRI.trigger_ecl_mode() called")
    ...
    def trigger_ecl_level(self):
        _unilab_logger.debug("[UNILAB] HRI.trigger_ecl_level() called")
    ...
    def clamp_voltage(self):
        _unilab_logger.debug("[UNILAB] HRI.clamp_voltage() called")
    ...
    def average_voltage(self):
        _unilab_logger.debug("[UNILAB] HRI.average_voltage() called")
    ...
    @Feat()
    def status(self):
        _unilab_logger.debug("[UNILAB] HRI.status() called")
        """Get status.
        """
    ...
    def mcp(self, value):
        _unilab_logger.debug("[UNILAB] HRI.mcp() called")
        """MCP Voltage.
        """
        if self.revision >= '2.0':
    ...
    def mode(self, mode):
        _unilab_logger.debug("[UNILAB] HRI.mode() called")
    ...
    def rfgain(self, value):
        _unilab_logger.debug("[UNILAB] HRI.rfgain() called")
        """RF Gain.
        """
    ...
    def temperature(self):
        _unilab_logger.debug("[UNILAB] HRI.temperature() called")
        """Temperature.
        """
        if self.revision == 2.0:
    ...
    def enabled(self, value):
        _unilab_logger.debug("[UNILAB] HRI.enabled() called")
        """MCP Enabled
        """
        if self.revision < 2:
            if value:
