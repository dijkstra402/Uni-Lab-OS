...
Original: PYME/cluster/HTTPRulePusher.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HTTPRulePusher")
...
class HTTPRulePusher(object):
    def __init__(self, dataSourceID, metadata, resultsFilename, queueName = None, startAt = 10, dataSourceModule=None, serverfilter=clusterIO.local_serverfilter):
        print("[UNILAB] HTTPRulePusher.__init__() called", flush=True)
        """
    ...
    def _taskTemplate(self):
        _unilab_logger.debug("[UNILAB] HTTPRulePusher._taskTemplate() called")
    ...
    def post_rule(self):
        _unilab_logger.debug("[UNILAB] HTTPRulePusher.post_rule() called")
    ...
    def fileTasksForFrames(self):
        _unilab_logger.debug("[UNILAB] HTTPRulePusher.fileTasksForFrames() called")
    ...
    def _updatePoll(self):
        _unilab_logger.debug("[UNILAB] HTTPRulePusher._updatePoll() called")
    ...
    def cleanup(self):
        _unilab_logger.debug("[UNILAB] HTTPRulePusher.cleanup() called")
        self.doPoll = False
