...
Original: microscope/controllers/toptica.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.iChromeMLE")
...
class iChromeMLE(microscope.abc.Controller):
    ...
    def __init__(self, port: str, **kwargs) -> None:
        print("[UNILAB] iChromeMLE.__init__() called", flush=True)
    ...
    def devices(self) -> Dict[str, _iChromeLaser]:
        _unilab_logger.debug("[UNILAB] iChromeMLE.devices() called")
        return self._lasers
