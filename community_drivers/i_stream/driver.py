...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.IStream")
...
class IStream(object):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] IStream.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def read(self, size):
        _unilab_logger.debug("[UNILAB] IStream.read() called")
        """ Read an array of byte integers of the given size from the stream. """
        pass

    def write(self, data):
        _unilab_logger.debug("[UNILAB] IStream.write() called")
        """ Write the given packed data to the stream. """
        pass

    def close(self):
        _unilab_logger.debug("[UNILAB] IStream.close() called")
