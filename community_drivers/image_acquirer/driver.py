...
Original: src/harvesters/core.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ImageAcquirer")
...
# Vendored repo packages: harvesters, harvesters
import sys as _sys
...
class ImageAcquirer:
    ...
    def _create_acquisition_thread(self) -> _ImageAcquisitionThread:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._create_acquisition_thread() called")
    ...
    def __init__(self, *, parent: Harvester, device_proxy=None, config: Optional[ParameterSet] = None, profiler=None, file_dict=None):
        print("[UNILAB] ImageAcquirer.__init__() called", flush=True)
        """
    ...
    def is_valid(self) -> bool:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.is_valid() called")
        """
    ...
    def _emit_callbacks(self, event: Events) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._emit_callbacks() called")
        global _logger
    ...
    def _check_validity(self, event: Events):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._emit_callback() called")
        if event not in self._supported_events:
            raise ValueError

    def add_callback(self, event: Events, callback: Callback):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.add_callback() called")
        self._check_validity(event)
        assert callback
        self._callback_dict[event] = callback

    def remove_callback(self, event: Events):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.remove_callback() called")
        self._check_validity(event)
        self._callback_dict[event] = None

    def remove_callbacks(self):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.remove_callbacks() called")
        for event in self._supported_events:
            self._callback_dict[event] = None

    @property
    def supported_events(self):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.supported_events() called")
        return self._supported_events

    @staticmethod
    def _get_chunk_adapter(*, tl_type: str, node_map: NodeMap):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._get_chunk_adapter() called")
        if tl_type == 'U3V':
    ...
    def _get_event_adapter(*, tl_type: str, node_map: NodeMap):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._get_event_adapter() called")
        if tl_type == 'U3V':
    ...
    def __enter__(self):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.__enter__() called")
        return self

    def __exit__(self, exc_type, exc_val, exc_tb):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.__exit__() called")
        self._finalizer()

    def _release_remote_device(self):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._release_remote_device() called")
    ...
    def destroy(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.destroy() called")
        """
    ...
    def num_buffers(self) -> int:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.num_buffers() called")
        """
    ...
    def min_num_buffers(self) -> int:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.min_num_buffers() called")
        """
    ...
    def num_filled_buffers_to_hold(self) -> int:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.num_filled_buffers_to_hold() called")
        """
    ...
    def num_holding_filled_buffers(self) -> int:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.num_holding_filled_buffers() called")
        """
    ...
    def data_streams(self) -> List[DataStream]:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.data_streams() called")
        """
    ...
    def remote_device(self) -> RemoteDevice:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.remote_device() called")
        """
    ...
    def device(self) -> Device:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.device() called")
        """
    ...
    def interface(self) -> Interface:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.interface() called")
        """
    ...
    def system(self) -> System:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.system() called")
        """
    ...
    def is_acquiring_images(self):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.is_acquiring_images() called")
        """
        Attention
        ---------
            It has been deprecated at 1.3.7 and will be removed in 2.0.0.
    ...
    def is_acquiring(self) -> bool:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.is_acquiring() called")
        """
    ...
    def is_armed(self) -> bool:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.is_armed() called")
        """
    ...
    def timeout_on_client_fetch_call(self) -> float:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.timeout_on_client_fetch_call() called")
        """
        Attention
        ---------
    ...
    def timeout_period_on_client_fetch_call(self) -> float:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.timeout_period_on_client_fetch_call() called")
        """
    ...
    def timeout_period_on_update_event_data_call(self) -> int:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.timeout_period_on_update_event_data_call() called")
        """
    ...
    def timeout_for_image_acquisition(self) -> int:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.timeout_for_image_acquisition() called")
        """
        Attention
        ---------
            It has been deprecated at 1.3.6 and will be removed in 2.0.0.
    ...
    def thread_image_acquisition(self) -> ThreadAdapter:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.thread_image_acquisition() called")
        """
        Attention
        ---------
            It has been deprecated at 1.3.6 and will be removed in 2.0.0.
    ...
    def statistics(self) -> Statistics:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.statistics() called")
        """
    ...
    def _setup_data_streams(self, file_dict: Dict[str, bytes] = None):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._setup_data_streams() called")
        global _logger
    ...
    def start_image_acquisition(self, run_in_background=False):
        _unilab_logger.debug("[UNILAB] ImageAcquirer.start_image_acquisition() called")
        """
        Attention
        ---------
    ...
    def start_acquisition(self, run_in_background: bool = False) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.start_acquisition() called")
        """
        Attention
        ---------
    ...
    def start(self, *, run_as_thread: bool = False) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.start() called")
        """
    ...
    def _worker_module_event(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._worker_module_event() called")
        """
    ...
    def _worker_event_new_buffer(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._worker_event_new_buffer() called")
        """
        The worker method of the image acquisition task.
    ...
    def _update_chunk_data(self, *, buffer: _Buffer, is_manual: bool):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._update_chunk_data() called")
        global _logger
    ...
    def _update_num_images_to_acquire(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.try_fetch() called")
    ...
    def _update_statistics(self, buffer) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._update_statistics() called")
        assert buffer
    ...
    def _create_buffer_tokens(raw_buffers: List[bytes] = None):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._create_raw_buffers() called")
        assert raw_buffers
    ...
    def stop_image_acquisition(self):
        _unilab_logger.debug("[UNILAB] ImageAcquirer._announce_buffers() called")
        """
        Attention
        ---------
            It has been deprecated at 1.3.7 and will be removed at 2.0.0.
    ...
    def stop_acquisition(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.stop_acquisition() called")
        """
        Attention
        ---------
            It has been deprecated at 1.3.7 and will be removed at 2.0.0.
    ...
    def stop(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer.stop() called")
        """
    ...
    def _flush_buffers(self, data_stream: DataStream) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._flush_buffers() called")
    ...
    def _release_data_streams(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._release_data_streams() called")
        global _logger
    ...
    def _release_buffers(self) -> None:
        _unilab_logger.debug("[UNILAB] ImageAcquirer._release_buffers() called")
        global _logger
