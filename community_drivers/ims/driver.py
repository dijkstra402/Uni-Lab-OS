...
Original: pcdsdevices/epics_motor.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.IMS")
...
from pcdsdevices.eps import EPS
from pcdsdevices.interface import FltMvInterface
from pcdsdevices.pseudopos import OffsetMotorBase, delay_class_factory
from pcdsdevices.registry import device_registry
from pcdsdevices.signal import EpicsSignalEditMD, EpicsSignalROEditMD, PytmcSignal
from pcdsdevices.utils import get_status_float, get_status_value
...
class IMS(PCDSMotorBase):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] IMS.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    ...
    def stage(self):
        _unilab_logger.debug("[UNILAB] IMS.stage() called")
        """
        Stage the IMS motor.
    ...
    def auto_setup(self):
        _unilab_logger.debug("[UNILAB] IMS.auto_setup() called")
        """
    ...
    @property
    def msta(self):
        _unilab_logger.debug("[UNILAB] IMS.reinitialize() called")
        """
        Returns the msta fields as a dictionary.
        """
        # the MSTA field is a float for some reason...
    ...
    def clear_all_flags(self):
        _unilab_logger.debug("[UNILAB] IMS.clear_all_flags() called")
    ...
    def _clear_flag(self, flag, wait=False, timeout=10):
        ...
        def flag_is_cleared(value=None, **kwargs):
            _unilab_logger.debug("[UNILAB] IMS.flag_is_cleared() called")
    ...
    @property
    def md(self):
        _unilab_logger.debug("[UNILAB] IMS.md() called")
        if self._md is None:
    ...
    def configure(self, cfgname=None):
        _unilab_logger.debug("[UNILAB] IMS.configure() called")
        """
    ...
    def get_configuration(self):
        _unilab_logger.debug("[UNILAB] IMS.get_configuration() called")
        """
    ...
    def get_configuration_values(self, cfgname=None):
        _unilab_logger.debug("[UNILAB] IMS.get_configuration_values() called")
        """
    ...
    def get_current_values(self, pv=None):
        _unilab_logger.debug("[UNILAB] IMS.get_current_values() called")
        """
    ...
    def find_configuration(pattern, case_insensitive=True, display=30):
        _unilab_logger.debug("[UNILAB] IMS.find_configuration() called")
        """
    ...
    def diff_configuration(self, cfgname=None):
        _unilab_logger.debug("[UNILAB] IMS.diff_configuration() called")
        """
    ...
    @staticmethod
    def setup_pmgr():
        _unilab_logger.debug("[UNILAB] IMS.setup_pmgr() called")
        try:
    ...
    def _setup_pmgr_if_needed():
        _unilab_logger.debug("[UNILAB] IMS._setup_pmgr_if_needed() called")
        if IMS._pm is None and not IMS._pm_init_error:
            IMS.setup_pmgr()

    @staticmethod
    def check_pmgr():
        _unilab_logger.debug("[UNILAB] IMS.check_pmgr() called")
        if IMS._pm is None:
    ...
    def _setup_and_check_pmgr():
        _unilab_logger.debug("[UNILAB] IMS._setup_and_check_pmgr() called")
