...
Original: pylabrobot/storage/inheco/incubator_shaker_backend.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.InhecoIncubatorShakerStackBackend")
...
class InhecoIncubatorShakerStackBackend(MachineBackend):
  ...
  def __init__(
    ...
    print("[UNILAB] InhecoIncubatorShakerStackBackend.__init__() called", flush=True)
    super().__init__()
  ...
  def number_of_connected_units(self) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.number_of_connected_units() called")
    """Return the number of connected units in the stack."""
    return len(self.unit_composition)

  def __repr__(self):
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.__repr__() called")
    return (
  ...
  async def setup(self, port: Optional[str] = None):
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.setup() called")
    """
  ...
  async def stop(self):
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.stop() called")
  ...
  async def _read_full_response(self, timeout: float) -> bytes:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._read_full_response() called")
    ...
    def has_complete_tail(b: bytearray) -> bool:
      _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.has_complete_tail() called")
  ...
  def _crc8_legacy(self, data: bytearray) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._crc8_legacy() called")
  ...
  def _build_message(self, command: str, stack_index: int = 0) -> bytes:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._build_message() called")
  ...
  def _is_report_command(self, command: str) -> bool:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._is_report_command() called")
  ...
  def _parse_response_binary_safe(self, resp: bytes) -> dict:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._parse_response_binary_safe() called")
  ...
  def _is_error_tail(self, resp: bytes) -> bool:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._is_error_tail() called")
  ...
  async def send_command(
    ...
    *,
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.send_command() called")
  ...
  async def request_firmware_version(self, stack_index: int) -> str:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_firmware_version() called")
  ...
  async def request_serial_number(self, stack_index: int) -> str:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_serial_number() called")
  ...
  async def request_last_calibration_date(self, stack_index: int) -> str:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_last_calibration_date() called")
    """EEPROM request"""
  ...
  async def request_machine_allocation(self, layer: int = 0, stack_index: int = 0) -> dict:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_machine_allocation() called")
    """
  ...
  async def request_number_of_connected_machines(self, layer: int = 0, stack_index: int = 0) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_number_of_connected_machines() called")
    """
  ...
  async def request_labware_detection_threshold(self, stack_index: int) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_labware_detection_threshold() called")
    """EEPROM request"""
  ...
  async def request_incubator_type(self, stack_index: int) -> InhecoIncubatorUnitType:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_incubator_type() called")
  ...
  async def request_plate_in_incubator(self, stack_index: int) -> bool:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_plate_in_incubator() called")
    """Sensor command:"""
  ...
  async def request_operation_time_in_hours(self, stack_index: int) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_operation_time_in_hours() called")
    """EEPROM request"""
  ...
  async def request_drawer_cycles_performed(self, stack_index: int) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_drawer_cycles_performed() called")
    """EEPROM request"""
    resp = await self.send_command("RDC2", stack_index=stack_index)
    return int(resp)

  async def request_is_initialized(self, stack_index: int) -> bool:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_is_initialized() called")
    """EEPROM request"""
    resp = await self.send_command("REE", stack_index=stack_index)
    return resp in {"0", "2"}

  async def request_plate_status_known(self, stack_index: int) -> bool:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_plate_status_known() called")
    """EEPROM request"""
    resp = await self.send_command("REE", stack_index=stack_index)
    return resp in {"0", "1"}

  async def request_thermal_calibration_date(self, stack_index: int) -> str:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_thermal_calibration_date() called")
  ...
  async def request_calibration_low(self, sensor: int, format: int) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_calibration_low() called")
  ...
  async def request_calibration_high(self, sensor: int, format: int) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_calibration_high() called")
  ...
  async def request_whole_calibration_data(self, key: str) -> bytes:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_whole_calibration_data() called")
  ...
  async def request_proportionality_factor(self) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_proportionality_factor() called")
  ...
  async def set_max_allowed_device_temperature(self, key: str, temperature: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_max_allowed_device_temperature() called")
  ...
  async def set_pid_proportional_gain(self, key: str, value: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_pid_proportional_gain() called")
  ...
  async def set_pid_integration_value(self, key: str, value: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_pid_integration_value() called")
  ...
  async def delete_counter(self, key: str, selector: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.delete_counter() called")
    raise NotImplementedError("SDC (Set Delete Counter) not implemented yet.")

  async def set_boost_offset(self, offset: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_boost_offset() called")
    raise NotImplementedError("SBO (Set Boost Offset) not implemented yet.")

  async def set_boost_time(self, time_s: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_boost_time() called")
    raise NotImplementedError("SBT (Set Boost Time) not implemented yet.")

  async def set_cooldown_time_factor(self, value: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_cooldown_time_factor() called")
  ...
  async def set_heatup_time_factor(self, value: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_heatup_time_factor() called")
  ...
  async def set_heatup_offset(self, offset: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_heatup_offset() called")
  ...
  async def set_calibration_low(self, key: str, sensor1: int, sensor2: int, sensor3: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_calibration_low() called")
  ...
  async def set_calibration_high(
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_calibration_high() called")
  ...
  async def reset_calibration_data(self, key: str) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.reset_calibration_data() called")
  ...
  async def set_proportionality_factor(self, value: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_proportionality_factor() called")
  ...
  async def initialize(self, stack_index: int) -> str:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.initialize() called")
  ...
  async def open(self, stack_index: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.open() called")
  ...
  async def close(self, stack_index: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.close() called")
  ...
  async def request_drawer_status(self, stack_index: int) -> DrawerStatus:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_drawer_status() called")
  ...
  async def request_motor_power_clockwise(self) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_motor_power_clockwise() called")
  ...
  async def request_motor_power_anticlockwise(self) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_motor_power_anticlockwise() called")
  ...
  async def request_motor_current_limit_clockwise(self) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_motor_current_limit_clockwise() called")
  ...
  async def request_motor_current_limit_anticlockwise(self) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_motor_current_limit_anticlockwise() called")
  ...
  async def set_motor_power_clockwise(self, key: str, power: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_motor_power_clockwise() called")
  ...
  async def set_motor_power_anticlockwise(self, key: str, power: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_motor_power_anticlockwise() called")
  ...
  async def set_motor_current_limit_clockwise(self, key: str, current: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_motor_current_limit_clockwise() called")
  ...
  async def set_motor_current_limit_anticlockwise(self, key: str, current: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_motor_current_limit_anticlockwise() called")
  ...
  async def start_temperature_control(self, temperature: float, stack_index: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.start_temperature_control() called")
  ...
  async def stop_temperature_control(self, stack_index: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.stop_temperature_control() called")
  ...
  async def get_temperature(
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.get_temperature() called")
  ...
  async def request_target_temperature(self, stack_index: int) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_target_temperature() called")
  ...
  async def is_temperature_control_enabled(self, stack_index: int) -> bool:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.is_temperature_control_enabled() called")
    """
  ...
  async def request_pid_controller_coefficients(self, stack_index: int) -> tuple[float, float]:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_pid_controller_coefficients() called")
    """
  ...
  async def request_maximum_allowed_temperature(
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_maximum_allowed_temperature() called")
    """
  ...
  async def request_delta_temperature(self, stack_index: int) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_delta_temperature() called")
    """
  ...
  async def wait_for_temperature(
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.wait_for_temperature() called")
    """
  ...
  async def request_shaker_frequency_x(self, stack_index: int, selector: int = 0) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_shaker_frequency_x() called")
  ...
  async def request_shaker_frequency_y(self, stack_index: int, selector: int = 0) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_shaker_frequency_y() called")
  ...
  async def request_shaker_amplitude_x(self, stack_index: int, selector: int = 0) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_shaker_amplitude_x() called")
  ...
  async def request_shaker_amplitude_y(self, stack_index: int, selector: int = 0) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_shaker_amplitude_y() called")
  ...
  async def is_shaking_enabled(self, stack_index: int) -> bool:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.is_shaking_enabled() called")
  ...
  async def set_shaker_parameters(
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_shaker_parameters() called")
  ...
  def _mm_to_fw(self, mm: float) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._mm_to_fw() called")
  ...
  def _rpm_to_fw_hz10(self, rpm: float) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._rpm_to_fw_hz10() called")
  ...
  def _hz_to_fw_hz10(self, hz: float) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._hz_to_fw_hz10() called")
  ...
  def _validate_hz_or_rpm(self, frequency_hz: Optional[float], rpm: Optional[float]) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._validate_hz_or_rpm() called")
  ...
  def _phase_or_default(self, phase_deg: Optional[float], default: int) -> int:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._phase_or_default() called")
  ...
  def _fw_freq_pair(self, frequency_hz: Optional[float], rpm: Optional[float]) -> tuple[int, int]:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._fw_freq_pair() called")
  ...
  def _fw_amp_pair_linear_x(self, ax_mm: float) -> tuple[int, int]:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._fw_amp_pair_linear_x() called")
    return (self._mm_to_fw(ax_mm), 0)

  def _fw_amp_pair_linear_y(self, ay_mm: float) -> tuple[int, int]:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._fw_amp_pair_linear_y() called")
    return (0, self._mm_to_fw(ay_mm))

  def _fw_amp_pair_xy(self, ax_mm: float, ay_mm: float) -> tuple[int, int]:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend._fw_amp_pair_xy() called")
  ...
  async def set_shaker_pattern(
    ...
    *,
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_shaker_pattern() called")
  ...
  async def set_shaker_status(self, enabled: bool, stack_index: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_shaker_status() called")
  ...
  async def shake(
    ...
    *,
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.shake() called")
    """
  ...
  async def stop_shaking(self, stack_index: int) -> None:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.stop_shaking() called")
    """Stop shaker (ASE0)."""
  ...
  async def request_shaker_phase_shift(self, stack_index: int, selector: int = 0) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_shaker_phase_shift() called")
  ...
  async def request_shaker_calibration_value(self, position: int, selector: int = 0) -> float:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.request_shaker_calibration_value() called")
  ...
  async def read_whole_shaker_calibration_data(self, key: str) -> str:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.read_whole_shaker_calibration_data() called")
  ...
  async def set_shaker_calibration_value(
    ...
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.set_shaker_calibration_value() called")
  ...
  async def perform_self_test(self, stack_index: int, read_timeout: int = 500) -> Dict[str, bool]:
    _unilab_logger.debug("[UNILAB] InhecoIncubatorShakerStackBackend.perform_self_test() called")
