...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.IntegerIDRule")
...
class IntegerIDRule(Rule):
    ...
    *Rule Chaining*
    ...
    def mark_release_complete(self, n_tasks=None):
        print("[UNILAB] IntegerIDRule.__init__() called", flush=True)
        """
    ...
    def _update_nums(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule._update_nums() called")
    ...
    def _update_cost(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule._update_cost() called")
    ...
    def make_range_available(self, start, end):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.make_range_available() called")
        """
    ...
    def bid(self, bid):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.bid() called")
    ...
    def mark_complete(self, info):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.mark_complete() called")
        """
    ...
    @property
    def advert(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.advert() called")
    ...
    @property
    def expired(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.expired() called")
    ...
    @property
    def finished(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.finished() called")
        """ 
    ...
    def inactivate(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.inactivate() called")
        """
    ...
    def info(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.info() called")
        """
    ...
    def poll_timeouts(self):
        _unilab_logger.debug("[UNILAB] IntegerIDRule.poll_timeouts() called")
        t = time.time()
