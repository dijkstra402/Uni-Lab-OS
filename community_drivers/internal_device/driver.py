...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.InternalDevice")
...
class InternalDevice(EventsMixin, Device):
    ...
    def __init__(self, *, pin_factory=None):
        print("[UNILAB] InternalDevice.__init__() called", flush=True)
        self._closed = False
        super().__init__(pin_factory=pin_factory)

    def close(self):
        _unilab_logger.debug("[UNILAB] InternalDevice.close() called")
        self._closed = True
        super().close()

    @property
    def closed(self):
        _unilab_logger.debug("[UNILAB] InternalDevice.closed() called")
        return self._closed

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] InternalDevice.__repr__() called")
        try:
            self._check_open()
