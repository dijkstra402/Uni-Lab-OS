...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.IntervalGraphic")
...
class IntervalGraphic(Graphic):
    ...
    def __init__(self) -> None:
        print("[UNILAB] IntervalGraphic.__init__() called", flush=True)
        ...
        def read_interval(persistent_property: Persistence.PersistentProperty, properties: Persistence.PersistentDictType) -> typing.Any:
            _unilab_logger.debug("[UNILAB] IntervalGraphic.read_interval() called")
        ...
        def write_interval(persistent_property: Persistence.PersistentProperty, properties: Persistence.PersistentDictType, value: typing.Any) -> None:
            _unilab_logger.debug("[UNILAB] IntervalGraphic.write_interval() called")
        ...
        def validate_interval(interval: typing.Any) -> typing.Tuple[float, float]:
            _unilab_logger.debug("[UNILAB] IntervalGraphic.validate_interval() called")
    ...
    def interval(self) -> typing.Tuple[float, float]:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.interval() called")
    ...
    def reset_position(self) -> None:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.reset_position() called")
        offset = -(self.interval[0] + self.interval[1]) / 2 + 0.5
        self.interval = self.interval[0] + offset, self.interval[1] + offset

    def mime_data_dict(self) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.mime_data_dict() called")
        d = super().mime_data_dict()
        d["interval"] = self.interval
        return d

    def read_from_mime_data(self, graphic_dict: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.read_from_mime_data() called")
        super().read_from_mime_data(graphic_dict)
        self.interval = graphic_dict.get("interval", self.interval)

    def read_properties_from_dict(self, d: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.read_properties_from_dict() called")
        super().read_from_mime_data(d)
    ...
    def get_attributes(self) -> set[GraphicAttributeEnum]:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.get_attributes() called")
        return {GraphicAttributeEnum.ONE_DIMENSIONAL}

    @property
    def start(self) -> float:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.start() called")
    ...
    @property
    def end(self) -> float:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.end() called")
    ...
    def __interval_changed(self, name: str, value: float) -> None:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.__interval_changed() called")
        self._property_changed(name, value)
        self.notify_property_changed("start")
        self.notify_property_changed("end")

    def get_region(self) -> IntervalRegion:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.get_region() called")
        return IntervalRegion(self.start, self.end)

    # test is required for Graphic interface
    def test(self, mapping: CoordinateMappingLike, ui_settings: UISettings.UISettings, p: Geometry.FloatPoint, move_only: bool) -> typing.Tuple[typing.Optional[str], bool]:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.test() called")
        # first convert to widget coordinates since test distances
        # are specified in widget coordinates
    ...
    def begin_drag(self) -> DragPartData:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.begin_drag() called")
        return (self.start, self.end)

    def end_drag(self, part_data: DragPartData) -> None:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.end_drag() called")
        if self.end < self.start:
            self.start, self.end = self.end, self.start

    def adjust_part(self, mapping: CoordinateMappingLike, original: Geometry.FloatPoint, current: Geometry.FloatPoint, part: DragPartDataPlus, modifiers: ModifiersLike) -> None:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.adjust_part() called")
    ...
    def nudge(self, mapping: CoordinateMappingLike, delta: Geometry.FloatSize) -> None:
        _unilab_logger.debug("[UNILAB] IntervalGraphic.nudge() called")
