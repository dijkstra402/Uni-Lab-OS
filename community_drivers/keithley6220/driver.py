...
Original: src/instruments/keithley/keithley6220.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Keithley6220")
...
class Keithley6220(SCPIInstrument, PowerSupply):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Keithley6220.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    @property
    def channel(self):
        _unilab_logger.debug("[UNILAB] Keithley6220.channel() called")
        """
    ...
    @property
    def voltage(self):
        _unilab_logger.debug("[UNILAB] Keithley6220.voltage() called")
        """
    ...
    def disable(self):
        _unilab_logger.debug("[UNILAB] Keithley6220.disable() called")
        """
