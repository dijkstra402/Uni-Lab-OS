...
Original: EGGS_labrad/servers/oscilloscopes/KeysightDSOX2024A.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.KeysightDSOX2024AWrapper")
...
class KeysightDSOX2024AWrapper(GPIBDeviceWrapper):
    def __init__(self, guid, name):
        print("[UNILAB] KeysightDSOX2024AWrapper.__init__() called", flush=True)
    ...
    @inlineCallbacks
    def reset(self):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.reset() called")
        yield self.write('*RST')

    @inlineCallbacks
    def clear_buffers(self):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.clear_buffers() called")
        yield self.write('*CLS')

    @inlineCallbacks
    def autoscale(self):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.autoscale() called")
        yield self.write(':AUT')

    # CHANNEL
    @inlineCallbacks
    def channel_info(self, channel):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_info() called")
    ...
    def channel_coupling(self, channel, coupling=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_coupling() called")
    ...
    def channel_scale(self, channel, scale=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_scale() called")
    ...
    def channel_probe(self, channel, atten=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_probe() called")
    ...
    def channel_toggle(self, channel, state=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_toggle() called")
    ...
    def channel_invert(self, channel, invert=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_invert() called")
    ...
    def channel_offset(self, channel, offset=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_offset() called")
        # value is in volts
    ...
    def channel_position(self, channel, position=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.channel_position() called")
    ...
    def trigger_channel(self, channel=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.trigger_channel() called")
    ...
    def trigger_slope(self, slope=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.trigger_slope() called")
    ...
    def trigger_level(self, channel, level=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.trigger_level() called")
    ...
    def trigger_mode(self, mode=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.trigger_mode() called")
        chString = ':TRIG:SWE'
        if mode is not None:
    ...
    def horizontal_offset(self, offset=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.horizontal_offset() called")
        chString = 'TIM:POS'
        if offset is not None:
    ...
    def horizontal_scale(self, scale=None):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.horizontal_scale() called")
        chString = ':TIM:SCAL'
        if scale is not None:
    ...
    def trace(self, channel, points=1250000):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.trace() called")
        """
    ...
    def measure_setup(self, slot, channel, param):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.measure_setup() called")
    ...
    def measure(self, slot):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper.measure() called")
        valid_measurement_parameters = {
            "FREQ": "FREQ", "AMP": "VAMP", "MEAN": "VAV", "MAX": "VMAX", "MIN": "VMIN", "P2P": "VPP"
        }
    ...
    def _parsePreamble(preamble):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper._parsePreamble() called")
        """
    ...
    def _parseByteData(data):
        _unilab_logger.debug("[UNILAB] KeysightDSOX2024AWrapper._parseByteData() called")
        """
        Parse byte data.
        """
