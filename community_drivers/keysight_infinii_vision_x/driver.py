...
Original: src/labtoolkit/Oscilloscope/KeysightInfiniiVisionX.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.KeysightInfiniiVisionX")
...
class KeysightInfiniiVisionX(IEEE488, SCPI):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] KeysightInfiniiVisionX.__init__() called", flush=True)
