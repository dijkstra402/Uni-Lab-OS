...
Original: packages/pymodaq/src/pymodaq/post_treatment/load_and_plot.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LoaderPlotter")
...
class LoaderPlotter:
    ...
    def __init__(self, dockarea):
        print("[UNILAB] LoaderPlotter.__init__() called", flush=True)
    ...
    def viewers(self) -> List[ViewerBase]:
        _unilab_logger.debug("[UNILAB] LoaderPlotter.viewers() called")
        return self.dispatcher.viewers

    def connect_double_clicked(self, slot: Callable):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.connect_double_clicked() called")
        for viewer in self.viewers:
            viewer.sig_double_clicked.connect(slot)

    def disconnect(self, slot: Callable):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.disconnect() called")
        for viewer in self.viewers:
            viewer.sig_double_clicked.disconnect(slot)

    def clear_viewers(self):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.clear_viewers() called")
        self.dispatcher.remove_viewers(0)

    @property
    def h5saver(self):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.h5saver() called")
    ...
    def data(self) -> DataToExport:
        _unilab_logger.debug("[UNILAB] LoaderPlotter.data() called")
        return self._data
    ...
    def remove_navigation_axes(self):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.load_data() called")
    ...
    def group_0D_data(self, separate_average=False):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.group_0D_data() called")
    ...
    def load_plot_data(self, **kwargs):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.load_plot_data() called")
    ...
    def show_data(self, **kwargs):
        _unilab_logger.debug("[UNILAB] LoaderPlotter.show_data() called")
    ...
    def _init_show_data(self, data: DataToExport):
        _unilab_logger.debug("[UNILAB] LoaderPlotter._init_show_data() called")
