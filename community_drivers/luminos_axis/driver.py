...
Original: drivers/stages/luminos_stage/luminos_stage.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LuminosAxis")
...
from drivers.stages.luminos_stage.zaber import serial as zs
from drivers.stages.luminos_stage import tla_constants as tla
...
class LuminosAxis(st.Axis, zs.BinaryDevice):
    ...
    def move_rel(self):
        print("[UNILAB] LuminosAxis.__init__() called", flush=True)
        raise AttributeError('Don\'t call this function.')

    def move_abs(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis.move_abs() called")
        raise AttributeError('Don\'t call this function.')

    def _binary_command(self, command_name, command_data):
        _unilab_logger.debug("[UNILAB] LuminosAxis._binary_command() called")
        bc = tla.binary_command(self.device_index, command_name, command_data)
        return bc

    def _send_command(self, command_name, command_data=None):
        _unilab_logger.debug("[UNILAB] LuminosAxis._send_command() called")
        tla.send_command(self._port, self.device_index, command_name, command_data)
        r = self._port.read()
        return r

    def _move_abs_steps(self, steps):
        _unilab_logger.debug("[UNILAB] LuminosAxis._move_abs_steps() called")
        r = self._send_command('Move Absolute', steps)
        return r

    def _get_device_mode(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis._get_device_mode() called")
        device_mode = self._send_command('Return Setting', 40).data
        return device_mode

    def _set_device_mode(self, device_mode):
        _unilab_logger.debug("[UNILAB] LuminosAxis._set_device_mode() called")
    ...
    def _set_device_mode_bit(self, bit_number):
        _unilab_logger.debug("[UNILAB] LuminosAxis._set_device_mode_bit() called")
    ...
    def _unset_device_mode_bit(self, bit_number):
        _unilab_logger.debug("[UNILAB] LuminosAxis._unset_device_mode_bit() called")
        dm = self._get_device_mode()
        dm &= 0 << bit_number
        self._set_device_mode(dm)
        return dm
    ...
    def get_device_mode_bit_status(self, bit_number):
        _unilab_logger.debug("[UNILAB] LuminosAxis.get_device_mode_bit_status() called")
        dm = self._get_device_mode()
        b = True if dm & 1 << bit_number else False
        return b

    def turn_leds_off(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis.turn_leds_off() called")
        dm1 = self._set_device_mode_bit(14) # 14 -> Power LED
        dm2 = self._set_device_mode_bit(15) # 15 -> Serial LED
        return dm2

    def turn_leds_on(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis.turn_leds_on() called")
...
class LuminosAxisLinear(LuminosAxis, st.AxisLinear):
    ...
    def _move_abs_nm(self, distance_from_home_nm):
        _unilab_logger.debug("[UNILAB] LuminosAxis._move_abs_nm() called")
    ...
    def _get_current_position_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis._get_current_position_nm() called")
    ...
    def _set_maximum_position_nm(self, distance_from_home_nm):
        _unilab_logger.debug("[UNILAB] LuminosAxis._set_maximum_position_nm() called")
    ...
    def _set_maximum_position_um(self, distance_from_home_um):
        _unilab_logger.debug("[UNILAB] LuminosAxis._set_maximum_position_um() called")
...
class LuminosAxisRotate(LuminosAxis, st.AxisRotate):
    ...
    def _move_abs_arc_second(self, angle_from_home_arc_second):
        _unilab_logger.debug("[UNILAB] LuminosAxis._move_abs_arc_second() called")
    ...
    def _get_current_position_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis._get_current_position_arc_second() called")
        pos_abs_steps = self._send_command('Return Current Position').data
    ...
    def _set_maximum_position_arc_second(self, angle_from_home_arc_second):
        _unilab_logger.debug("[UNILAB] LuminosAxis._set_maximum_position_arc_second() called")
    ...
    def _set_maximum_position_degree(self, angle_from_home_degree):
        _unilab_logger.debug("[UNILAB] LuminosAxis._set_maximum_position_degree() called")
...
class LuminosAxisX(LuminosAxisLinear, st.AxisX):
    ...
    def _position_absolute_min_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis._position_absolute_min_nm() called")
        return 0.

    @property
    def _position_absolute_max_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis._position_absolute_max_nm() called")
        return 524.288e3
...
class LuminosAxisRoll(LuminosAxisRotate, st.AxisRoll):
    ...
    def _position_absolute_min_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis._position_absolute_min_arc_second() called")
        return 0.

    @property
    def _position_absolute_max_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxis._position_absolute_max_arc_second() called")
        return 3.9*3600.
