...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LuminosAxisRotate")
...
class LuminosAxisRotate(LuminosAxis, st.AxisRotate):
    ...
    def arc_second_per_step(self):
        print("[UNILAB] LuminosAxisRotate.__init__() called", flush=True)
        pass

    def _move_abs_arc_second(self, angle_from_home_arc_second):
        _unilab_logger.debug("[UNILAB] LuminosAxisRotate._move_abs_arc_second() called")
    ...
    def _get_current_position_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisRotate._get_current_position_arc_second() called")
        pos_abs_steps = self._send_command('Return Current Position').data
    ...
    def _set_maximum_position_arc_second(self, angle_from_home_arc_second):
        _unilab_logger.debug("[UNILAB] LuminosAxisRotate._set_maximum_position_arc_second() called")
    ...
    def _set_maximum_position_degree(self, angle_from_home_degree):
        _unilab_logger.debug("[UNILAB] LuminosAxisRotate._set_maximum_position_degree() called")
