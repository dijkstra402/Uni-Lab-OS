...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LuminosAxisX")
...
class LuminosAxisX(LuminosAxisLinear, st.AxisX):
    ...
    @property
    def nm_per_step(self):
        print("[UNILAB] LuminosAxisX.__init__() called", flush=True)
        return 4.

    @property
    def _position_absolute_min_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisX._position_absolute_min_nm() called")
        return 0.

    @property
    def _position_absolute_max_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisX._position_absolute_max_nm() called")
        return 524.288e3
