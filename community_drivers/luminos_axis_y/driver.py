...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LuminosAxisY")
...
class LuminosAxisY(LuminosAxisLinear, st.AxisY):
    ...
    @property
    def nm_per_step(self):
        print("[UNILAB] LuminosAxisY.__init__() called", flush=True)
        return 4.

    @property
    def _position_absolute_min_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisY._position_absolute_min_nm() called")
        return 0.

    @property
    def _position_absolute_max_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisY._position_absolute_max_nm() called")
        return 524.288e3
...
class LuminosAxisYaw(LuminosAxisRotate, st.AxisYaw):
    ...
    @property
    def _position_absolute_min_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisY._position_absolute_min_arc_second() called")
        return 0.

    @property
    def _position_absolute_max_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisY._position_absolute_max_arc_second() called")
        return 3.9*3600.
