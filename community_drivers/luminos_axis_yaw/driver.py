...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LuminosAxisYaw")
...
class LuminosAxisYaw(LuminosAxisRotate, st.AxisYaw):
    ...
    @property
    def arc_second_per_step(self):
        print("[UNILAB] LuminosAxisYaw.__init__() called", flush=True)
        return 0.2

    @property
    def _position_absolute_min_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisYaw._position_absolute_min_arc_second() called")
        return 0.

    @property
    def _position_absolute_max_arc_second(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisYaw._position_absolute_max_arc_second() called")
        return 3.9*3600.
