...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LuminosAxisZ")
...
class LuminosAxisZ(LuminosAxisLinear, st.AxisZ):
    ...
    @property
    def nm_per_step(self):
        print("[UNILAB] LuminosAxisZ.__init__() called", flush=True)
        return 100.

    @property
    def _position_absolute_min_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisZ._position_absolute_min_nm() called")
        return 0.

    @property
    def _position_absolute_max_nm(self):
        _unilab_logger.debug("[UNILAB] LuminosAxisZ._position_absolute_max_nm() called")
        return 16000.e3
