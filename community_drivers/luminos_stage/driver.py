...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LuminosStage")
...
class LuminosStages(st.Stages3):
    ...
    def home(self):
        print("[UNILAB] LuminosStage.__init__() called", flush=True)
...
class LuminosStage(st.Stage):
    ...
    def _set_serial_connection(self, com_port_number):
        _unilab_logger.debug("[UNILAB] LuminosStage._set_serial_connection() called")
        try:
            int(com_port_number)
    ...
    def set_default_settings(self):
        _unilab_logger.debug("[UNILAB] LuminosStage.set_default_settings() called")
        return self._send_command('Restore Settings', 0)

    def set_manual_mode(self):
        _unilab_logger.debug("[UNILAB] LuminosStage.set_manual_mode() called")
        del self._port
        self._port = None
        return self._port

    def set_computer_mode(self):
        _unilab_logger.debug("[UNILAB] LuminosStage.set_computer_mode() called")
    ...
    def _binary_command(self, command_name, command_data=None):
        _unilab_logger.debug("[UNILAB] LuminosStage._binary_command() called")
        bc = tla.binary_command(0, command_name, command_data)
        return bc

    def _write_data_to_non_volatile(self, byte_offset, byte_data, device_index):
        _unilab_logger.debug("[UNILAB] LuminosStage._write_data_to_non_volatile() called")
    ...
    def _read_data_from_non_volatile(self, byte_offset, device_index):
        _unilab_logger.debug("[UNILAB] LuminosStage._read_data_from_non_volatile() called")
        assert 0 <= byte_offset <= 127, 'Address to read must be from 0 to 127.'
        cd = byte_offset
        tla.send_command(self._port, device_index, 'Read Or Write Memory', cd)
        if device_index == 0:
    ...
    def _send_command(self, command_name, command_data=None):
        _unilab_logger.debug("[UNILAB] LuminosStage._send_command() called")
        tla.send_command(self._port, 0, command_name, command_data)
        r = [eval(self._port.read().__str__()) for _ in self.axes_physical]
        return r

    def home(self):
        _unilab_logger.debug("[UNILAB] LuminosStage.home() called")
    ...
    def flash_leds(self, num_flashes=5, delay_flashes_sec=1.):
        _unilab_logger.debug("[UNILAB] LuminosStage.flash_leds() called")
        on = True
