...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LusiSlits")
...
from pcdsdevices.epics_motor import (BeckhoffAxis, BeckhoffAxisNoOffset, EpicsMotor,
                          PCDSMotorBase)
...
from pcdsdevices.sensors import RTD, TwinCATTempSensor
from pcdsdevices.signal import PytmcSignal
from pcdsdevices.sim import FastMotor
from pcdsdevices.utils import get_status_float, get_status_value, schedule_task
...
class LusiSlits(SlitsBase):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] LusiSlits.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    ...
    def open(self):
        _unilab_logger.debug("[UNILAB] LusiSlits.open() called")
        """Uses the built-in 'OPEN' record to move open the aperture."""
        self.open_cmd.put(1)

    def close(self):
        _unilab_logger.debug("[UNILAB] LusiSlits.close() called")
        """Close the slits to have an aperture of 0mm on each side."""
        self.close_cmd.put(1)

    def block(self):
        _unilab_logger.debug("[UNILAB] LusiSlits.block() called")
    ...
    def calc_lightpath_state(
        ...
        _unilab_logger.debug("[UNILAB] LusiSlits.calc_lightpath_state() called")
