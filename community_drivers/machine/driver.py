...
Original: src/science_jubilee/Machine.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Machine")
...
# Vendored repo packages: science_jubilee, science_jubilee
import sys as _sys
...
class MachineConfigurationError(Exception):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Machine.__init__() called")
...
class Machine:
    ...
    def __init__(
        ...
        print("[UNILAB] Machine.__init__() called", flush=True)
    ...
    def connect(self):
        _unilab_logger.debug("[UNILAB] Machine.connect() called")
    ...
    def configured_axes(self):
        _unilab_logger.debug("[UNILAB] Machine.configured_axes() called")
    ...
    def configured_tools(self):
        _unilab_logger.debug("[UNILAB] Machine.configured_tools() called")
    ...
    def active_tool_index(self):
        _unilab_logger.debug("[UNILAB] Machine.active_tool_index() called")
    ...
    def tool_z_offsets(self):
        _unilab_logger.debug("[UNILAB] Machine.tool_z_offsets() called")
    ...
    def axis_limits(self):
        _unilab_logger.debug("[UNILAB] Machine.axis_limits() called")
    ...
    @property
    def position(self):
        _unilab_logger.debug("[UNILAB] Machine.position() called")
    ...
    def load_deck(
        ...
        _unilab_logger.debug("[UNILAB] Machine.load_deck() called")
    ...
    def split_response_objects(self, s):
        _unilab_logger.debug("[UNILAB] Machine.split_response_objects() called")
        """
    ...
    def gcode(self, cmd: str = "", timeout=None, response_wait: float = 60):
        _unilab_logger.debug("[UNILAB] Machine.gcode() called")
    ...
    def delay_time(self, n):
        _unilab_logger.debug("[UNILAB] Machine.delay_time() called")
        """
    ...
    def reset(self):
        _unilab_logger.debug("[UNILAB] Machine.reset() called")
    ...
    def home_all(self):
        _unilab_logger.debug("[UNILAB] Machine.home_all() called")
        """Home all axes."""
    ...
    def home_xyu(self):
        _unilab_logger.debug("[UNILAB] Machine.home_xyu() called")
    ...
    def home_x(self):
        _unilab_logger.debug("[UNILAB] Machine.home_x() called")
        """Home the X axis"""
        cmd = "G28 X"
        self.gcode(cmd)

    def home_y(self):
        _unilab_logger.debug("[UNILAB] Machine.home_y() called")
        """Home the Y axis"""
        cmd = "G28 Y"
        self.gcode(cmd)

    def home_u(self):
        _unilab_logger.debug("[UNILAB] Machine.home_u() called")
        """Home the U (tool) axis"""
        cmd = "G28 U"
        self.gcode(cmd)

    def home_v(self):
        _unilab_logger.debug("[UNILAB] Machine.home_v() called")
        """Home the V axis"""
        cmd = "G28 V"
        self.gcode(cmd)

    def home_z(self):
        _unilab_logger.debug("[UNILAB] Machine.home_z() called")
        """Home the Z axis.
    ...
    def home_e(self):
        _unilab_logger.debug("[UNILAB] Machine.home_e() called")
        """
    ...
    def home_in_place(self, *args: str):
        _unilab_logger.debug("[UNILAB] Machine.home_in_place() called")
    ...
    def set_tool_offset(self, tool_idx=None, x=None, y=None, z=None):
        _unilab_logger.debug("[UNILAB] Machine.set_tool_offset() called")
        if tool_idx is None:
    ...
    def _move_xyzev(
        ...
        _unilab_logger.debug("[UNILAB] Machine._move_xyzev() called")
    ...
    def move_to(
        ...
        _unilab_logger.debug("[UNILAB] Machine.move_to() called")
    ...
    def move(
        ...
        _unilab_logger.debug("[UNILAB] Machine.move() called")
    ...
    def dwell(self, t: float, millis: bool = True):
        _unilab_logger.debug("[UNILAB] Machine.dwell() called")
    ...
    def safe_z_movement(self):
        _unilab_logger.debug("[UNILAB] Machine.safe_z_movement() called")
    ...
    def _get_tool_index(self, tool_item: Union[int, Tool, str]):
        _unilab_logger.debug("[UNILAB] Machine._get_tool_index() called")
    ...
    def load_tool(self, tool: Tool = None):
        _unilab_logger.debug("[UNILAB] Machine.load_tool() called")
    ...
    def reload_tool(self, tool: Tool = None):
        _unilab_logger.debug("[UNILAB] Machine.reload_tool() called")
    ...
    def pickup_tool(self, tool_id: Union[int, str, Tool]):
        _unilab_logger.debug("[UNILAB] Machine.pickup_tool() called")
    ...
    @requires_safe_z
    def park_tool(self):
        _unilab_logger.debug("[UNILAB] Machine.park_tool() called")
    ...
    def get_position(self):
        _unilab_logger.debug("[UNILAB] Machine.get_position() called")
    ...
    def load_labware(
        ...
        _unilab_logger.debug("[UNILAB] Machine.load_labware() called")
    ...
    # ***************MACROS***************
    def tool_lock(self):
        _unilab_logger.debug("[UNILAB] Machine.tool_lock() called")
        """Runs Jubilee tool lock macro. Assumes tool_lock.g macro exists."""
        cmd = 'M98 P"0:/macros/tool_lock.g"'
        self.gcode(cmd)

    def tool_unlock(self):
        _unilab_logger.debug("[UNILAB] Machine.tool_unlock() called")
        """Runs Jubilee tool unlock macro. Assumes tool_unlock.g macro exists."""
        cmd = 'M98 P"0:/macros/tool_unlock.g"'
        self.gcode(cmd)

    def disconnect(self):
        _unilab_logger.debug("[UNILAB] Machine.disconnect() called")
        """Close the connection."""
        # Nothing to do?
        pass

    def __enter__(self):
        _unilab_logger.debug("[UNILAB] Machine.__enter__() called")
        return self

    def __exit__(self, *args):
        _unilab_logger.debug("[UNILAB] Machine.__exit__() called")
        self.disconnect()
