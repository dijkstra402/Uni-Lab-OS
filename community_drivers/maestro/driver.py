...
Original: donkeycar/parts/actuator.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Maestro")
...
class Maestro:
    ...
    def __init__(self, channel, frequency = 60):
        print("[UNILAB] Maestro.__init__() called", flush=True)
        import serial
    ...
    def set_pulse(self, pulse):
        _unilab_logger.debug("[UNILAB] Maestro.set_pulse() called")
    ...
    def set_turn_left(self, v):
        _unilab_logger.debug("[UNILAB] Maestro.set_turn_left() called")
        if self.lturn != v:
            self.lturn = v
    ...
    def set_turn_right(self, v):
        _unilab_logger.debug("[UNILAB] Maestro.set_turn_right() called")
        if self.rturn != v:
            self.rturn = v
    ...
    def set_headlight(self, v):
        _unilab_logger.debug("[UNILAB] Maestro.set_headlight() called")
    ...
    def set_brake(self, v):
        _unilab_logger.debug("[UNILAB] Maestro.set_brake() called")
    ...
    def readline(self):
        _unilab_logger.debug("[UNILAB] Maestro.readline() called")
        ret = None
        with Maestro.astar_lock:
