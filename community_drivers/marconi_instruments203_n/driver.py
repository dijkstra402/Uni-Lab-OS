...
Original: src/labtoolkit/SignalGenerator/MarconiInstruments203N.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MarconiInstruments203N")
...
class MarconiInstruments203N(IEEE488):
    ...
    def __init__(self, inst):
        print("[UNILAB] MarconiInstruments203N.__init__() called", flush=True)
        super().__init__(inst)
    ...
    @property
    def frequency(self):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.frequency() called")
        """."""
    ...
    @property
    def amplitude(self):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.amplitude() called")
        """."""
    ...
    @property
    def output(self):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.output() called")
        """."""
    ...
    def modulation_disable(self, modulation):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.modulation_disable() called")
        bool_state = False
        state = 'ON' if bool_state else 'OFF'
        return self.write(f'{modulation}:{state}')

    def modulation_enable(self, modulation):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.modulation_enable() called")
        bool_state = True
        state = 'ON' if bool_state else 'OFF'
        return self.write(f'{modulation}:{state}')
    ...
    def modulation_output(self):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.modulation_output() called")
  ...
  *OPT?    0
  ...
  INTF4?   :INTF4:FREQ 1000.0;INC 1000.0;SIN
    ...
    @property
    def modulation(self):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.modulation() called")
        pass
        # TODO
    ...
    def SystemErrorQueue(self):
        _unilab_logger.debug("[UNILAB] MarconiInstruments203N.SystemErrorQueue() called")
