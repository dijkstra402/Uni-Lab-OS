...
Original: masterflexserial/masterflexserial.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MasterflexSerial")
...
# Vendored repo packages: masterflexserial, masterflexserial
import sys as _sys
...
class MasterflexSerial:
    ...
    def __init__(self, port: str, _addr: str = '1', baud: float = 115200):
        print("[UNILAB] MasterflexSerial.__init__() called", flush=True)
    ...
    async def connect(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial.connect() called")
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial.disconnect() called")
    ...
    def _connection_lost(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial._connection_lost() called")
    ...
    def _protocol_factory(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial._connection_made() called")
    ...
    @property
    def connected(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial.connected() called")
    ...
    @property
    def protocol(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial.protocol() called")
        """Return serial protocol."""
        return self._protocol

    @property
    def addr(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial.addr() called")
        """Get serial address."""
        return self._addr

    async def _send_message(self, msg: SentMessage, payload: str, addr: str = 1):
        _unilab_logger.debug("[UNILAB] MasterflexSerial._send_message() called")
    ...
    def _received_response_message(self, recv_msg: ReceivedMessage):
        _unilab_logger.debug("[UNILAB] MasterflexSerial._received_response_message() called")
    ...
    async def enable(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.enable() called")
    ...
    async def disable(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.disable() called")
    ...
    async def status(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.status() called")
        """Get the pump status.
    ...
    async def start(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.start() called")
        """Start the pump.
    ...
    async def stop(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.stop() called")
        """Stop the pump.
    ...
    async def speed_percent(self, speed: float = None) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.speed_percent() called")
    ...
    async def set_dir(self, dir: None) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.set_dir() called")
        """Set pumps direction.
    ...
    async def reset_cumulative(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.reset_cumulative() called")
    ...
    async def set_addr(self, pump_addr) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.set_addr() called")
        """Set pump address.
    ...
    async def speed_rpm(self, speed: float = None) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.speed_rpm() called")
    ...
    async def volume(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.volume() called")
    ...
    async def volume_rev(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.volume_rev() called")
    ...
    async def unit_index(self, index: int = None) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.unit_index() called")
    ...
    async def on_time_full(self, time: str = None) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.on_time_full() called")
    ...
    async def set_panel_active(self, enable: bool) -> dict:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.set_panel_active() called")
        """
    ...
    async def set_dispense_mode(self, mode: str) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.set_dispense_mode() called")
    ...
    async def get_software_version(self):
        _unilab_logger.debug("[UNILAB] MasterflexSerial.get_software_version() called")
    ...
    async def on_time_min(self, minutes: int) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.on_time_min() called")
    ...
    async def on_time_hr(self, hours: int) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.on_time_hr() called")
    ...
    async def get_version__model(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.get_version__model() called")
    ...
    async def store_configs(self) -> dict:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.store_configs() called")
    ...
    async def restore_configs(self) -> dict:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.restore_configs() called")
        """
    ...
    async def reset_batch(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.reset_batch() called")
    ...
    async def dispense_status(self) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.dispense_status() called")
    ...
    async def off_time_full(self, time: str = None) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.off_time_full() called")
    ...
    async def on_time_decisecond(self, deciseconds: int = None) -> json:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.on_time_decisecond() called")
    ...
    async def batch_count(self, batch_count: int = None) -> dict:
        _unilab_logger.debug("[UNILAB] MasterflexSerial.batch_count() called")
        ...
        def is_valid_integer(value: str) -> bool:
            _unilab_logger.debug("[UNILAB] MasterflexSerial.is_valid_integer() called")
