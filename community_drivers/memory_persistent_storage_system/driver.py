...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MemoryPersistentStorageSystem")
...
class MemoryPersistentStorageSystem(PersistentStorageSystem):
    ...
    def __init__(self, *, library_properties: typing.Optional[PersistentDictType] = None) -> None:
        print("[UNILAB] MemoryPersistentStorageSystem.__init__() called", flush=True)
        self.__library_properties = library_properties if library_properties is not None else dict()
        super().__init__()

    def close(self) -> None:
        _unilab_logger.debug("[UNILAB] MemoryPersistentStorageSystem.close() called")
        pass

    def _read_properties(self) -> PersistentDictType:
        _unilab_logger.debug("[UNILAB] MemoryPersistentStorageSystem._read_properties() called")
        return copy.deepcopy(self.__library_properties)

    def _write_properties(self) -> None:
        _unilab_logger.debug("[UNILAB] MemoryPersistentStorageSystem._write_properties() called")
    ...
    def set_library_properties(self, library_properties: PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] MemoryPersistentStorageSystem.set_library_properties() called")
        self.__library_properties.clear()
...
__all__ = ["MemoryPersistentStorageSystem"]
