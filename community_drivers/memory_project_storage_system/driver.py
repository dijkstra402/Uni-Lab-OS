...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MemoryProjectStorageSystem")
...
class MemoryProjectStorageSystem(ProjectStorageSystem):
    ...
    def _read_properties(self) -> PersistentDictType:
        print("[UNILAB] MemoryProjectStorageSystem.__init__() called", flush=True)
        return copy.deepcopy(self.__library_properties)

    def _write_properties(self) -> None:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._write_properties() called")
        self._write_count += 1
        self.__library_properties.clear()
        self.__library_properties.update(Model.transform_backward(copy.deepcopy(self.get_storage_properties())))

    def get_identifier(self) -> str:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem.get_identifier() called")
        return "memory"

    def _get_storage_handler_factory(self, storage_handler_attributes: StorageHandler.StorageHandlerAttributes) -> StorageHandler.StorageHandlerFactoryLike:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._get_storage_handler_factory() called")
        return MemoryStorageHandlerFactory()
    ...
    def _make_storage_handler(self, storage_handler_attributes: StorageHandler.StorageHandlerAttributes, file_handler: typing.Optional[StorageHandler.StorageHandlerFactoryLike] = None) -> MemoryStorageHandler:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._make_storage_handler() called")
    ...
    def _find_storage_handlers(self) -> typing.Sequence[StorageHandler.StorageHandler]:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._find_storage_handlers() called")
        storage_handlers = list()
    ...
    def _is_storage_handler_large_format(self, storage_handler: StorageHandler.StorageHandler) -> bool:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._is_storage_handler_large_format() called")
        return False

    def _remove_storage_handler(self, storage_handler: StorageHandler.StorageHandler, *, safe: bool = False) -> None:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._remove_storage_handler() called")
    ...
    def _replace_storage_handler(self, storage_handler: StorageHandler.StorageHandler, storage_handler_attributes: StorageHandler.StorageHandlerAttributes) -> StorageHandler.StorageHandler:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._replace_storage_handler() called")
        new_storage_handler = self._make_storage_handler(storage_handler_attributes)
        # do not call _remove_storage_handler since everything has already been updated via side effects. sigh.
        return new_storage_handler

    def _restore_item(self, data_item_uuid: uuid.UUID) -> typing.Optional[PersistentDictType]:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._restore_item() called")
        data_item_uuid_str = str(data_item_uuid)
    ...
    def _prune(self) -> None:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._prune() called")
        pass  # disabled for testing self.__trash_map = dict()

    def _migrate_data_item(self, reader_info: ReaderInfo, index: int, count: int) -> typing.Optional[ReaderInfo]:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._migrate_data_item() called")
        storage_handler = reader_info.storage_handler
        properties = reader_info.properties
        properties = Utility.clean_dict(copy.deepcopy(properties) if properties else dict())
    ...
    def _migrate_library_properties(self, library_properties: PersistentDictType, reader_info_list: typing.List[ReaderInfo]) -> None:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._migrate_library_properties() called")
        self.__library_properties.clear()
        self.__library_properties.update(library_properties)
        ...
        def data_item_created(data_item_properties: typing.Tuple[str, PersistentDictType]) -> str:
            _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem.data_item_created() called")
            # created is a utc timestamp
            earliest_datetime = datetime.datetime.fromtimestamp(0, tz=datetime.timezone.utc).isoformat()
    ...
    def _get_migration_stages(self) -> typing.Sequence[ProjectStorageSystemMigrationStage]:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._get_migration_stages() called")
        return [ProjectStorageSystemMigrationStage()]

    def _read_library_properties(self, migration_stage: ProjectStorageSystemMigrationStage) -> PersistentDictType:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._read_library_properties() called")
        return copy.deepcopy(self.__library_properties)

    def _find_data_items(self, migration_stage: ProjectStorageSystemMigrationStage) -> typing.Sequence[StorageHandler.StorageHandler]:
        _unilab_logger.debug("[UNILAB] MemoryProjectStorageSystem._find_data_items() called")
        return self._find_storage_handlers()
...
__all__ = ["MemoryProjectStorageSystem"]
