...
Original: PYME/Acquire/Hardware/Mercury/mercuryStepperGCS.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.mercuryStepper")
...
class mercuryStepper(base_piezo.PiezoBase):
    ...
    def __init__(self, comPort='COM4', baud=115200, axes=['X', 'Y'], steppers=['M-229.25S', 'M-229.25S']):
        print("[UNILAB] mercuryStepper.__init__() called", flush=True)
        self.axes = axes
    ...
    def _get_status(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper._get_status() called")
        with self.lock:
    ...
    def _strip_response_address(self, resp):
        _unilab_logger.debug("[UNILAB] mercuryStepper._strip_response_address() called")
    ...
    def run_cmd(self, command, controllerID, query=False):
        _unilab_logger.debug("[UNILAB] mercuryStepper.run_cmd() called")
    ...
    def query(self, command, axis, extra_params=[]):
        _unilab_logger.debug("[UNILAB] mercuryStepper.query() called")
    ...
    def set(self, command, axis, value=None, extra_params=[], omit_axis=False):
        _unilab_logger.debug("[UNILAB] mercuryStepper.set() called")
        controller = self.axes.index(axis) + 1
        if omit_axis:
    ...
    def SetSoftLimits(self, axis, lims):
        _unilab_logger.debug("[UNILAB] mercuryStepper.SetSoftLimits() called")
        with self.lock:
            self.set('SPA', self.axes[axis], lims[0], ['0x30',] )
            self.set('SPA', self.axes[axis], lims[1], ['0x15', ])

    def ReInit(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper.ReInit() called")
        pass 
        
    def MoveTo(self, iChan, fPos, timeout=False):
        _unilab_logger.debug("[UNILAB] mercuryStepper.MoveTo() called")
        with self.lock:
    ...
    def GetPos(self, iChan=0):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetPos() called")
        # self.lock.acquire()
    ...
    def IsMoving(self, iChan=0):
        _unilab_logger.debug("[UNILAB] mercuryStepper.IsMoving() called")
        return self.moving

    def IsOnTarget(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper.IsOnTarget() called")
        return self.onTarget

    def RefreshPos(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper.RefreshPos() called")
        self.lock.acquire()
        self.last_poss=[float(self.query('POS?', a)) for a in self.axes]
        self.lock.release()

    def GetLastPos(self, iChan=0):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetLastPos() called")
        return self.last_poss[iChan]

    def _pause_joystick(self, on=False, chans=[0,1]):
        _unilab_logger.debug("[UNILAB] mercuryStepper._pause_joystick() called")
        if self.joystickOn:
            if on:
    ...
    def SetJoystick(self, on=True, chans=[0,1]):
        _unilab_logger.debug("[UNILAB] mercuryStepper.SetJoystick() called")
        with self.lock:
    ...
    def GetVelocity(self, iChan=0):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetVelocity() called")
        with self.lock:
    ...
    def SetVelocity(self, iChan, velocity):
        _unilab_logger.debug("[UNILAB] mercuryStepper.SetVelocity() called")
        with self.lock:
            self.set('VEL', self.axes[iChan], '%3.4f' % velocity)
        return ret

    def GetControlReady(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetControlReady() called")
        return True
    def GetChannelObject(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetChannelObject() called")
        return 0
    def GetChannelPhase(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetChannelPhase() called")
        return 1
    def GetMin(self,iChan=0):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetMin() called")
        return self.minTravel[iChan]
    def GetMax(self, iChan=0):
        _unilab_logger.debug("[UNILAB] mercuryStepper.GetMax() called")
        return self.maxTravel[iChan]

    def Cleanup(self):
        _unilab_logger.debug("[UNILAB] mercuryStepper.Cleanup() called")
        self.poll.kill = True
