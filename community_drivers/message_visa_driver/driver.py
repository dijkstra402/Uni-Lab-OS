...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MessageVisaDriver")
...
class MessageVisaDriver(TextualMixin, Driver):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] MessageVisaDriver.__init__() called", flush=True)
    ...
    def raw_send(self, data):
        _unilab_logger.debug("[UNILAB] MessageVisaDriver.raw_send() called")
    ...
    def initialize(self):
        _unilab_logger.debug("[UNILAB] MessageVisaDriver.initialize() called")
        """Open port
        """
        if not self.is_open():
    ...
    def finalize(self):
        _unilab_logger.debug("[UNILAB] MessageVisaDriver.finalize() called")
        """Close port
        """
    ...
    def is_open(self):
        _unilab_logger.debug("[UNILAB] MessageVisaDriver.is_open() called")
