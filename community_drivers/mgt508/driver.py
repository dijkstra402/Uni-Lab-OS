...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Mgt508")
...
class Mgt508Ports:
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Mgt508.__init__() called")
...
class Mgt508(Acq400):
    ...
    def __init__(self, uut):
        print("[UNILAB] Mgt508.__init__() called", flush=True)
    ...
    def pull(self, verbose=False):
        _unilab_logger.debug("[UNILAB] Mgt508.pull() called")
    ...
    def set_capture_length(self, mb):
        _unilab_logger.debug("[UNILAB] Mgt508.set_capture_length() called")
