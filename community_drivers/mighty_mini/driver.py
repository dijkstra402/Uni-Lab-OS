...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MightyMini")
...
class MightyMini():
    def __init__(self, chain, name='Mighty Mini'):
        print("[UNILAB] MightyMini.__init__() called", flush=True)
        self.name = name
        self.serialcon = chain.serialcon
        logging.info('%s: created on %s',self.name,self.serialcon.port)

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] MightyMini.__repr__() called")
        string = ''
        for attr in self.__dict__:
            string += '%s: %s\n' % (attr,self.__dict__[attr]) 
        return string
    ...
    def setflowrate(self, flowrate):
        _unilab_logger.debug("[UNILAB] MightyMini.setflowrate() called")
    ...
    def infuse(self):
        _unilab_logger.debug("[UNILAB] MightyMini.infuse() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] MightyMini.stop() called")
