...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Minitel")
...
# Vendored repo packages: minitel, minitel
import sys as _sys
...
class Minitel:
    ...
    def __init__(self, peripherique = '/dev/ttyUSB0'):
        print("[UNILAB] Minitel.__init__() called", flush=True)
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] Minitel.close() called")
    ...
    def _gestion_entree(self):
        _unilab_logger.debug("[UNILAB] Minitel._gestion_entree() called")
    ...
    def _gestion_sortie(self):
        _unilab_logger.debug("[UNILAB] Minitel._gestion_sortie() called")
    ...
    def envoyer(self, contenu):
        _unilab_logger.debug("[UNILAB] Minitel.envoyer() called")
    ...
    def recevoir(self, bloque = False, attente = None):
        _unilab_logger.debug("[UNILAB] Minitel.recevoir() called")
    ...
    def recevoir_sequence(self,bloque = True, attente=None):
        _unilab_logger.debug("[UNILAB] Minitel.recevoir_sequence() called")
    ...
    def appeler(self, contenu, attente):
        _unilab_logger.debug("[UNILAB] Minitel.appeler() called")
    ...
    def definir_mode(self, mode = 'VIDEOTEX'):
        _unilab_logger.debug("[UNILAB] Minitel.definir_mode() called")
    ...
    def identifier(self):
        _unilab_logger.debug("[UNILAB] Minitel.identifier() called")
    ...
    def deviner_vitesse(self):
        _unilab_logger.debug("[UNILAB] Minitel.deviner_vitesse() called")
    ...
    def definir_vitesse(self, vitesse):
        _unilab_logger.debug("[UNILAB] Minitel.definir_vitesse() called")
    ...
    def couleur(self, caractere = None, fond = None):
        _unilab_logger.debug("[UNILAB] Minitel.configurer_clavier() called")
    ...
    def position(self, colonne, ligne, relatif = False):
        _unilab_logger.debug("[UNILAB] Minitel.position() called")
    ...
    def taille(self, largeur = 1, hauteur = 1):
        _unilab_logger.debug("[UNILAB] Minitel.taille() called")
    ...
    def effet(self, soulignement = None, clignotement = None, inversion = None):
        _unilab_logger.debug("[UNILAB] Minitel.effet() called")
    ...
    def curseur(self, visible):
        _unilab_logger.debug("[UNILAB] Minitel.curseur() called")
    ...
    def echo(self, actif):
        _unilab_logger.debug("[UNILAB] Minitel.echo() called")
    ...
    def efface(self, portee = 'tout'):
        _unilab_logger.debug("[UNILAB] Minitel.efface() called")
    ...
    def repeter(self, caractere, longueur):
        _unilab_logger.debug("[UNILAB] Minitel.repeter() called")
    ...
    def bip(self):
        _unilab_logger.debug("[UNILAB] Minitel.bip() called")
        """Émet un bip
    ...
    def debut_ligne(self):
        _unilab_logger.debug("[UNILAB] Minitel.debut_ligne() called")
    ...
    def supprime(self, nb_colonne = None, nb_ligne = None):
        _unilab_logger.debug("[UNILAB] Minitel.supprime() called")
    ...
    def insere(self, nb_colonne = None, nb_ligne = None):
        _unilab_logger.debug("[UNILAB] Minitel.insere() called")
    ...
    def semigraphique(self, actif = True):
        _unilab_logger.debug("[UNILAB] Minitel.semigraphique() called")
    ...
    def redefinir(self, depuis, dessins, jeu = 'G0'):
        _unilab_logger.debug("[UNILAB] Minitel.redefinir() called")
