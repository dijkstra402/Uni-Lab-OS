...
Original: pyModbusTCP/client.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ModbusClient")
...
# Vendored repo packages: pyModbusTCP, pyModbusTCP
import sys as _sys
...
from pyModbusTCP.constants import (ENCAPSULATED_INTERFACE_TRANSPORT, EXP_DETAILS,
...
from pyModbusTCP.utils import byte_length, set_bit, valid_host
...
class ModbusClient:
    ...
    class _NetworkError(_InternalError):
        def __init__(self, code, message):
            print("[UNILAB] ModbusClient.__init__() called", flush=True)
            self.code = code
    ...
    def __repr__(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.__repr__() called")
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.__del__() called")
        self.close()

    @property
    def version(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.version() called")
        """Return the current package version as a str."""
        return self._version

    @property
    def last_error(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.last_error() called")
        """Last error code."""
        return self._last_error

    @property
    def last_error_as_txt(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.last_error_as_txt() called")
        """Human-readable text that describe last error."""
        return MB_ERR_TXT.get(self._last_error, 'unknown error')

    @property
    def last_except(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.last_except() called")
        """Return the last modbus exception code."""
        return self._last_except

    @property
    def last_except_as_txt(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.last_except_as_txt() called")
    ...
    def last_except_as_full_txt(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.last_except_as_full_txt() called")
    ...
    @property
    def host(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.host() called")
    ...
    @property
    def port(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.port() called")
    ...
    @property
    def unit_id(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.unit_id() called")
    ...
    @property
    def timeout(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.timeout() called")
    ...
    @property
    def auto_open(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.auto_open() called")
    ...
    @property
    def auto_close(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.auto_close() called")
    ...
    @property
    def is_open(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.is_open() called")
        """Get current status of the TCP connection (True = open)."""
        return self._sock.fileno() > 0

    def open(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.open() called")
    ...
    def _open(self):
        _unilab_logger.debug("[UNILAB] ModbusClient._open() called")
        """Connect to modbus server (open TCP connection)."""
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] ModbusClient.close() called")
        """Close current TCP connection."""
        self._sock.close()

    def custom_request(self, pdu):
        _unilab_logger.debug("[UNILAB] ModbusClient.custom_request() called")
    ...
    def read_coils(self, bit_addr, bit_nb=1):
        _unilab_logger.debug("[UNILAB] ModbusClient.read_coils() called")
    ...
    def read_discrete_inputs(self, bit_addr, bit_nb=1):
        _unilab_logger.debug("[UNILAB] ModbusClient.read_discrete_inputs() called")
    ...
    def read_holding_registers(self, reg_addr, reg_nb=1):
        _unilab_logger.debug("[UNILAB] ModbusClient.read_holding_registers() called")
    ...
    def read_input_registers(self, reg_addr, reg_nb=1):
        _unilab_logger.debug("[UNILAB] ModbusClient.read_input_registers() called")
    ...
    def read_device_identification(self, read_code=1, object_id=0):
        _unilab_logger.debug("[UNILAB] ModbusClient.read_device_identification() called")
    ...
    def write_single_coil(self, bit_addr, bit_value):
        _unilab_logger.debug("[UNILAB] ModbusClient.write_single_coil() called")
    ...
    def write_single_register(self, reg_addr, reg_value):
        _unilab_logger.debug("[UNILAB] ModbusClient.write_single_register() called")
    ...
    def write_multiple_coils(self, bits_addr, bits_value):
        _unilab_logger.debug("[UNILAB] ModbusClient.write_multiple_coils() called")
    ...
    def write_multiple_registers(self, regs_addr, regs_value):
        _unilab_logger.debug("[UNILAB] ModbusClient.write_multiple_registers() called")
    ...
    def write_read_multiple_registers(self, write_addr, write_values, read_addr, read_nb=1):
        _unilab_logger.debug("[UNILAB] ModbusClient.write_read_multiple_registers() called")
    ...
    def _send(self, frame):
        _unilab_logger.debug("[UNILAB] ModbusClient._send() called")
    ...
    def _send_pdu(self, pdu):
        _unilab_logger.debug("[UNILAB] ModbusClient._send_pdu() called")
    ...
    def _recv(self, size):
        _unilab_logger.debug("[UNILAB] ModbusClient._recv() called")
    ...
    def _recv_all(self, size):
        _unilab_logger.debug("[UNILAB] ModbusClient._recv_all() called")
    ...
    def _recv_pdu(self, min_len=2):
        _unilab_logger.debug("[UNILAB] ModbusClient._recv_pdu() called")
    ...
    def _add_mbap(self, pdu):
        _unilab_logger.debug("[UNILAB] ModbusClient._add_mbap() called")
    ...
    def _req_pdu(self, tx_pdu, rx_min_len=2):
        _unilab_logger.debug("[UNILAB] ModbusClient._req_pdu() called")
    ...
    def _req_init(self):
        _unilab_logger.debug("[UNILAB] ModbusClient._req_init() called")
        """Reset request status flags."""
        self._last_error = MB_NO_ERR
        self._last_except = EXP_NONE

    def _req_except_handler(self, _except):
        _unilab_logger.debug("[UNILAB] ModbusClient._req_except_handler() called")
    ...
    def _debug_msg(self, msg: str):
        _unilab_logger.debug("[UNILAB] ModbusClient._debug_msg() called")
        logger.debug(f'({self.host}:{self.port}:{self.unit_id}) {msg}')

    def _on_tx_rx(self, frame: bytes, is_tx: bool):
        _unilab_logger.debug("[UNILAB] ModbusClient._on_tx_rx() called")
    ...
    def on_tx_rx(self, frame: bytes, is_tx: bool):
        _unilab_logger.debug("[UNILAB] ModbusClient.on_tx_rx() called")
