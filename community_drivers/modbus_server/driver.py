...
Original: pyModbusTCP/server.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ModbusServer")
...
from pyModbusTCP.utils import set_bit, test_bit
...
class ModbusServer:
    ...
    class ClientInfo:
        ...
        def __init__(self, address='', port=0):
            print("[UNILAB] ModbusServer.__init__() called", flush=True)
            self.address = address
            self.port = port

        def __repr__(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.__repr__() called")
    ...
    class SessionData:
        ...
        @property
        def srv_info(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.srv_info() called")
        ...
        def new_request(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.new_request() called")
            self.request = ModbusServer.Frame()
            self.response = ModbusServer.Frame()

        def set_response_mbap(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.set_response_mbap() called")
    ...
    class Frame:
        ...
        @property
        def raw(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.raw() called")
    ...
    class PDU:
        ...
        def __len__(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.__len__() called")
            return len(self.raw)

        @property
        def func_code(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.func_code() called")
            return self.raw[0]

        @property
        def except_code(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.except_code() called")
            return self.raw[1]

        @property
        def is_except(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.is_except() called")
            return self.func_code > 0x7F

        @property
        def is_valid(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.is_valid() called")
            # PDU min length is 2 bytes
            return self.__len__() < 2

        def clear(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.clear() called")
            self.raw = b''

        def build_except(self, func_code, exp_status):
            _unilab_logger.debug("[UNILAB] ModbusServer.build_except() called")
            self.clear()
            self.add_pack('BB', func_code + 0x80, exp_status)
            return self

        def add_pack(self, fmt, *args):
            _unilab_logger.debug("[UNILAB] ModbusServer.add_pack() called")
            try:
        ...
        def unpack(self, fmt, from_byte=None, to_byte=None):
            _unilab_logger.debug("[UNILAB] ModbusServer.unpack() called")
    ...
    class ModbusService(BaseRequestHandler):
        ...
        def server_running(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.server_running() called")
            return self.server.evt_running.is_set()

        def _send_all(self, data):
            _unilab_logger.debug("[UNILAB] ModbusServer._send_all() called")
            try:
        ...
        def _recv_all(self, size):
            _unilab_logger.debug("[UNILAB] ModbusServer._recv_all() called")
            data = b''
            while len(data) < size:
                try:
        ...
        def setup(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.setup() called")
        ...
        def handle(self):
            _unilab_logger.debug("[UNILAB] ModbusServer.handle() called")
    ...
    def _engine(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._engine() called")
    ...
    def _internal_engine(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._internal_engine() called")
    ...
    def _read_bits(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._read_bits() called")
        """
    ...
    def _read_words(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._read_words() called")
        """
    ...
    def _write_single_coil(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._write_single_coil() called")
        """
    ...
    def _write_single_register(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._write_single_register() called")
        """
    ...
    def _write_multiple_coils(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._write_multiple_coils() called")
        """
    ...
    def _write_multiple_registers(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._write_multiple_registers() called")
        """
    ...
    def _write_read_multiple_registers(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._write_read_multiple_registers() called")
        """
    ...
    def _encapsulated_interface_transport(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusServer._encapsulated_interface_transport() called")
        """
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] ModbusServer.start() called")
        """Start the server.
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] ModbusServer.stop() called")
        """Stop the server."""
        if self.is_run:
    ...
    @property
    def is_run(self):
        _unilab_logger.debug("[UNILAB] ModbusServer.is_run() called")
    ...
    def _serve(self):
        _unilab_logger.debug("[UNILAB] ModbusServer._serve() called")
        try:
