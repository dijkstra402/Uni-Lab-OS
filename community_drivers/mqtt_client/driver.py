...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MQTTClient")
...
class MQTTClient (mqtt.Client):
    ...
    def __init__(self, cfg, ClientID,HostTpID):
        print("[UNILAB] MQTTClient.__init__() called", flush=True)
    ...
    def _setupSubscribeTopics(self, clientTps:dict) -> dict:
        _unilab_logger.debug("[UNILAB] MQTTClient._setupSubscribeTopics() called")
        """
    ...
    def setupDevice(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.setupDevice() called")
        """
    ...
    def setupInitValues(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.setupInitValues() called")
        """
    ...
    def setupClientTopics(self) -> dict:
        _unilab_logger.debug("[UNILAB] MQTTClient.setupClientTopics() called")
        """
    ...
    def setupHassDiscoveryConfigs(self) -> dict:
        _unilab_logger.debug("[UNILAB] MQTTClient.setupHassDiscoveryConfigs() called")
        """
    ...
    def setupSubscribeTopics(self) -> dict:
        _unilab_logger.debug("[UNILAB] MQTTClient.setupSubscribeTopics() called")
        """
        get a dict() which defines the required subscribe topics
        to be implemented by derived class
        """
    ...
    def getRefreshRate(self) -> int:
        _unilab_logger.debug("[UNILAB] MQTTClient.getRefreshRate() called")
        """
    ...
    def poll(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.poll() called")
        """
    ...
    def _setupHassTopics(self, devId:dict):
        _unilab_logger.debug("[UNILAB] MQTTClient._setupHassTopics() called")
        """
    ...
    def _setupTopics(self, topics: dict, subscribeTps:dict):
        _unilab_logger.debug("[UNILAB] MQTTClient._setupTopics() called")
        """
    ...
    def _setupTopic(self, tp:str , deviceclass:str, subcmd=None):
        _unilab_logger.debug("[UNILAB] MQTTClient._setupTopic() called")
    ...
    def _getHostTopicId(self,HostTopicID):
        _unilab_logger.debug("[UNILAB] MQTTClient._getHostTopicId() called")
        """
    ...
    def daemon_kill(self, *_args):
        _unilab_logger.debug("[UNILAB] MQTTClient.daemon_kill() called")
        """
    ...
    def on_connect(self, _client, _userdata, _flags, rc):
        _unilab_logger.debug("[UNILAB] MQTTClient.on_connect() called")
        """
    ...
    def subsribe_topics(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.subsribe_topics() called")
    ...
    def publish_avail_topics(self, avail=True):
        _unilab_logger.debug("[UNILAB] MQTTClient.publish_avail_topics() called")
    ...
    def publish_state_topics(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.publish_state_topics() called")
    ...
    def on_message(self, _client, _userdata, message):
        _unilab_logger.debug("[UNILAB] MQTTClient.on_message() called")
        """
    ...
    def on_disconnect(self, _client, _userdata, rc=0):
        _unilab_logger.debug("[UNILAB] MQTTClient.on_disconnect() called")
        """
    ...
    def client_down(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.client_down() called")
        """
    ...
    def publish_avail(self, topic, avail=True):
        _unilab_logger.debug("[UNILAB] MQTTClient.publish_avail() called")
    ...
    def publish_state(self, topicId:str, payload=None):
        _unilab_logger.debug("[UNILAB] MQTTClient.publish_state() called")
        """ publish state topic """
        tp=topicId
    ...
    def publish_hass(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.publish_hass() called")
        """ 
    ...
    def startup_client(self):
        _unilab_logger.debug("[UNILAB] MQTTClient.startup_client() called")
        """
    ...
    def clientLoop (self):
        _unilab_logger.debug("[UNILAB] MQTTClient.clientLoop() called")
        """
