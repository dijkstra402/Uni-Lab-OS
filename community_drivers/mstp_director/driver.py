...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MSTPDirector")
...
class MSTPDirector(asyncore.dispatcher, Server, ServiceAccessPoint):
    ...
    def __init__(
        ...
        print("[UNILAB] MSTPDirector.__init__() called", flush=True)
        if _debug:
            MSTPDirector._debug(
    ...
    @atexit.register
    def atexit_handler():
        _unilab_logger.debug("[UNILAB] MSTPDirector.atexit_handler() called")
    ...
    def add_actor(self, actor):
        _unilab_logger.debug("[UNILAB] MSTPDirector.add_actor() called")
    ...
    def del_actor(self, actor):
        _unilab_logger.debug("[UNILAB] MSTPDirector.del_actor() called")
    ...
    def actor_error(self, actor, error):
        _unilab_logger.debug("[UNILAB] MSTPDirector.actor_error() called")
    ...
    def get_actor(self, address):
        _unilab_logger.debug("[UNILAB] MSTPDirector.get_actor() called")
        return self.peers.get(address, None)

    def handle_connect(self):
        _unilab_logger.debug("[UNILAB] MSTPDirector.handle_connect() called")
        if _debug: MSTPDirector._debug("handle_connect")

    def readable(self):
        _unilab_logger.debug("[UNILAB] MSTPDirector.readable() called")
        return 1

    def handle_read(self):
        _unilab_logger.debug("[UNILAB] MSTPDirector.handle_read() called")
    ...
    def writable(self):
        _unilab_logger.debug("[UNILAB] MSTPDirector.writable() called")
        """Return true iff there is a request pending."""
        return (not self.request.empty())

    def handle_write(self):
        _unilab_logger.debug("[UNILAB] MSTPDirector.handle_write() called")
    ...
    def close_socket(self):
        _unilab_logger.debug("[UNILAB] MSTPDirector.close_socket() called")
        """Close the socket."""
    ...
    def handle_close(self):
        _unilab_logger.debug("[UNILAB] MSTPDirector.handle_close() called")
    ...
    def handle_error(self, error=None):
        _unilab_logger.debug("[UNILAB] MSTPDirector.handle_error() called")
        """Handle an error..."""
        if _debug: MSTPDirector._debug("handle_error %r", error)

    def indication(self, pdu):
        _unilab_logger.debug("[UNILAB] MSTPDirector.indication() called")
    ...
    def _response(self, pdu):
        _unilab_logger.debug("[UNILAB] MSTPDirector._response() called")
