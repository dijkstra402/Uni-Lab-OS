...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MSTPMultiplexer")
...
class MSTPMultiplexer:
    ...
    def __init__(self, localDevice, addr=None, noBroadcast=False):
        print("[UNILAB] MSTPMultiplexer.__init__() called", flush=True)
    ...
    def close_socket(self):
        _unilab_logger.debug("[UNILAB] MSTPMultiplexer.close_socket() called")
    ...
    def indication(self, server, pdu):
        _unilab_logger.debug("[UNILAB] MSTPMultiplexer.indication() called")
    ...
    def confirmation(self, client, pdu):
        _unilab_logger.debug("[UNILAB] MSTPMultiplexer.confirmation() called")
