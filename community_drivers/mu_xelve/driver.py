...
Original: pycrofluidics/elvemux.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MUXelve")
...
class MUXelve:
    ...
    def close(self):
        print("[UNILAB] MUXelve.__init__() called", flush=True)
    ...
    def home( self, start_channel:int = 1 ):
        _unilab_logger.debug("[UNILAB] MUXelve.home() called")
        """
    ...
    def get_valve(self) -> int:
        _unilab_logger.debug("[UNILAB] MUXelve.set_valve() called")
        """
    ...
    def wait_for_valve_movement(self, timeout: float = 5):
        _unilab_logger.debug("[UNILAB] MUXelve.wait_for_valve_movement() called")
    ...
    def loadDLL(self):
        _unilab_logger.debug("[UNILAB] MUXelve.loadDLL() called")
        """
    ...
    def __exit__(self, exception_type, exception_value, exception_traceback):
        _unilab_logger.debug("[UNILAB] MUXelve.__enter__() called")
