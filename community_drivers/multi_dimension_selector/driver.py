...
Original: plottr/gui/widgets.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MultiDimensionSelector")
...
# Vendored repo packages: plottr, plottr
import sys as _sys
...
from plottr.gui.tools import dictToTreeWidgetItems, dpiScalingFactor
...
from plottr.plot import PlotNode, PlotWidgetContainer, PlotWidget
...
class MultiDimensionSelector(QtWidgets.QListWidget):
    ...
    def setDimensions(self, dimensions: List[str]) -> None:
        print("[UNILAB] MultiDimensionSelector.__init__() called", flush=True)
    ...
    def getSelected(self) -> List[str]:
        _unilab_logger.debug("[UNILAB] MultiDimensionSelector.getSelected() called")
    ...
    def setSelected(self, selected: List[str]) -> None:
        _unilab_logger.debug("[UNILAB] MultiDimensionSelector.setSelected() called")
    ...
    def emitSelection(self) -> None:
        _unilab_logger.debug("[UNILAB] MultiDimensionSelector.emitSelection() called")
        self.dimensionSelectionMade.emit(self.getSelected())

    def connectNode(self, node: Optional[Node] = None) -> None:
        _unilab_logger.debug("[UNILAB] MultiDimensionSelector.connectNode() called")
...
__all__ = ["MultiDimensionSelector"]
