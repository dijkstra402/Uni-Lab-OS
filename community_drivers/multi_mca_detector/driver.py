...
Original: epicsscan/detectors/mca.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MultiMcaDetector")
...
from epicsscan.detectors.areadetector import ADFileMixin

from epicsscan.detectors.base import DetectorMixin, SCALER_MODE, NDARRAY_MODE, ROI_MODE
from epicsscan.detectors.counter import DeviceCounter
from epicsscan.detectors.trigger import Trigger
...
class MultiMcaDetector(DetectorMixin):
    ...
    def connect_counters(self):
        print("[UNILAB] MultiMcaDetector.__init__() called", flush=True)
    ...
    def config_filesaver(self, **kws):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.config_filesaver() called")
        self._med.config_filesaver(**kws)

    def save_calibration(self, filename, **kws):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.save_calibration() called")
    ...
    def post_scan(self, **kws):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.post_scan() called")
        "run just after scan"
        self.ContinuousMode()

    def ContinuousMode(self, dwelltime=0.0, numframes=0):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.ContinuousMode() called")
    ...
    def ScalerMode(self, dwelltime=None, numframes=1):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.ScalerMode() called")
    ...
    def ROIMode(self, dwelltime=None, numframes=None):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.ROIMode() called")
    ...
    def NDArrayMode(self, dwelltime=None, numframes=None):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.NDArrayMode() called")
    ...
    def set_dwelltime(self, dwelltime):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.set_dwelltime() called")
    ...
    def get_next_filename(self):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.get_next_filename() called")
        return self._med.getNextFileName()

    def arm(self, mode=None, fnum=None, wait=False, numframes=None):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.arm() called")
        if mode is not None:
            self.mode = mode
    ...
    def disarm(self, mode=None, wait=False):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.disarm() called")
        if mode is not None:
            self.mode = mode
        time.sleep(.05)
        self._med.FileCaptureOff()
    ...
    def start(self, mode=None, arm=False, wait=False):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.start() called")
        if mode is not None:
            self.mode = mode
        if arm:
            self.arm()
    ...
    def stop(self, mode=None, disarm=False, wait=False):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.stop() called")
        self._med.put('StopAll', 0, wait=wait)
        if disarm:
            self.disarm()

    def save_arraydata(self, filename=None):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.save_arraydata() called")
        pass

    def file_write_complete(self):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.file_write_complete() called")
        time.sleep(0.25)
        return self._med.FileWriteComplete()

    def get_numcaptured(self):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.get_numcaptured() called")
        return self._med.getCurrentPixel()

    def finish_capture(self):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.finish_capture() called")
        self._med.finish_pixels()

    def pre_scan(self, mode=None, npulses=None, dwelltime=None, **kws):
        _unilab_logger.debug("[UNILAB] MultiMcaDetector.pre_scan() called")
