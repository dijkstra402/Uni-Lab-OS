...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MX_valve")
...
class MX_valve():
    ...
    **No error handeling**
    ...
    def __init__(self, address, ports = 10, name = '', verbose = False,  baudrate = 19200):
        print("[UNILAB] MX_valve.__init__() called", flush=True)
        '''
        Input:
    ...
    def stripped_hex(self, target):
        _unilab_logger.debug("[UNILAB] MX_valve.stripped_hex() called")
        """
    ...
    def wait_ready(self):
        _unilab_logger.debug("[UNILAB] MX_valve.wait_ready() called")
        """
    ...
    def message_builder (self, objective, port = 1):
        _unilab_logger.debug("[UNILAB] MX_valve.message_builder() called")
        """
    ...
    def read_message(self):
        _unilab_logger.debug("[UNILAB] MX_valve.read_message() called")
        """
    ...
    def write_message(self, message):
        _unilab_logger.debug("[UNILAB] MX_valve.write_message() called")
        """
    ...
    def response_interpret(self, response):
        _unilab_logger.debug("[UNILAB] MX_valve.response_interpret() called")
        '''
    ...
    def get_port(self):
        _unilab_logger.debug("[UNILAB] MX_valve.get_port() called")
        """
    ...
    def change_port(self, port):
        _unilab_logger.debug("[UNILAB] MX_valve.change_port() called")
        """
