...
Original: gpiozero/pins/native.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.NativePin")
...
from gpiozero.pins.local import LocalPiPin, LocalPiFactory
...
class NativePin(LocalPiPin):
    ...
    def __init__(self, factory, info):
        print("[UNILAB] NativePin.__init__() called", flush=True)
    ...
    def _reg_init(self, factory, number):
        _unilab_logger.debug("[UNILAB] NativePin._reg_init() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] NativePin.close() called")
        self.edges = 'none'
        self.frequency = None
    ...
    def _get_function(self):
        _unilab_logger.debug("[UNILAB] NativePin._get_function() called")
        return self.GPIO_FUNCTION_NAMES[(self.factory.mem[self._func_offset] >> self._func_shift) & 7]

    def _set_function(self, value):
        _unilab_logger.debug("[UNILAB] NativePin._set_function() called")
        try:
    ...
    def _get_state(self):
        _unilab_logger.debug("[UNILAB] NativePin._get_state() called")
        return bool(self.factory.mem[self._level_offset] & (1 << self._level_shift))

    def _set_state(self, value):
        _unilab_logger.debug("[UNILAB] NativePin._set_state() called")
    ...
    def _get_pull(self):
        _unilab_logger.debug("[UNILAB] NativePin._get_pull() called")
        raise NotImplementedError

    def _set_pull(self, value):
        _unilab_logger.debug("[UNILAB] NativePin._set_pull() called")
        raise NotImplementedError

    def _get_bounce(self):
        _unilab_logger.debug("[UNILAB] NativePin._get_bounce() called")
        return self._bounce

    def _set_bounce(self, value):
        _unilab_logger.debug("[UNILAB] NativePin._set_bounce() called")
        self._bounce = None if value is None else float(value)

    def _get_edges(self):
        _unilab_logger.debug("[UNILAB] NativePin._get_edges() called")
        try:
    ...
    def _set_edges(self, value):
        _unilab_logger.debug("[UNILAB] NativePin._set_edges() called")
        if value != 'none':
    ...
    def _enable_event_detect(self):
        _unilab_logger.debug("[UNILAB] NativePin._enable_event_detect() called")
        self.factory.fs.watch(self._number)
        self._last_call = None

    def _disable_event_detect(self):
        _unilab_logger.debug("[UNILAB] NativePin._disable_event_detect() called")
