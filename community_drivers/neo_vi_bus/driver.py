...
Original: can/interfaces/ics_neovi/neovi_bus.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.NeoViBus")
...
class NeoViBus(BusABC):
    ...
    def __init__(self, channel, can_filters=None, **kwargs):
        print("[UNILAB] NeoViBus.__init__() called", flush=True)
        """
        :param channel:
    ...
    def channel_to_netid(channel_name_or_id):
        _unilab_logger.debug("[UNILAB] NeoViBus.channel_to_netid() called")
        try:
    ...
    def get_serial_number(device):
        _unilab_logger.debug("[UNILAB] NeoViBus.get_serial_number() called")
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] NeoViBus.shutdown() called")
        super().shutdown()
        ics.close_device(self.dev)

    @staticmethod
    def _detect_available_configs():
        _unilab_logger.debug("[UNILAB] NeoViBus._detect_available_configs() called")
    ...
    def _find_device(self, type_filter=None, serial=None):
        _unilab_logger.debug("[UNILAB] NeoViBus._find_device() called")
    ...
    def _process_msg_queue(self, timeout=0.1):
        _unilab_logger.debug("[UNILAB] NeoViBus._process_msg_queue() called")
        try:
    ...
    def _get_timestamp_for_msg(self, ics_msg):
        _unilab_logger.debug("[UNILAB] NeoViBus._get_timestamp_for_msg() called")
    ...
    def _ics_msg_to_message(self, ics_msg):
        _unilab_logger.debug("[UNILAB] NeoViBus._ics_msg_to_message() called")
    ...
    def _recv_internal(self, timeout=0.1):
        _unilab_logger.debug("[UNILAB] NeoViBus._recv_internal() called")
    ...
    def send(self, msg, timeout=0):
        _unilab_logger.debug("[UNILAB] NeoViBus.send() called")
