...
Original: newportxps/newportxps.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.NewportXPS")
...
from newportxps.debugtime import debugtime
from newportxps.utils import clean_text
from newportxps.XPS_C8_drivers import XPS, XPSException
from newportxps.ftp_wrapper import SFTPWrapper, FTPWrapper
...
class NewportXPS:
    ...
    def __repr__(self):
        print("[UNILAB] NewportXPS.__init__() called", flush=True)
        return f"NewportXPS(host='{self.host}', port={self.port})"

    @withConnectedXPS
    def status_report(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.status_report() called")
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.disconnect() called")
        self.ftpconn.close()
    ...
    def connect(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.connect() called")
    ...
    def clean_folders(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.clean_folders() called")
    ...
    def check_error(self, err, msg='', with_raise=True):
        _unilab_logger.debug("[UNILAB] NewportXPS.check_error() called")
        if err != 0:
            err = f"{err}"
    ...
    def save_systemini(self, fname='system.ini'):
        _unilab_logger.debug("[UNILAB] NewportXPS.save_systemini() called")
        """
    ...
    def save_stagesini(self, fname='stages.ini'):
        _unilab_logger.debug("[UNILAB] NewportXPS.save_stagesini() called")
    ...
    def read_systemini(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.read_systemini() called")
    ...
    def download_trajectory(self, filename):
        _unilab_logger.debug("[UNILAB] NewportXPS.download_trajectory() called")
    ...
    def upload_trajectory(self, filename,  text):
        _unilab_logger.debug("[UNILAB] NewportXPS.upload_trajectory() called")
    ...
    def list_scripts(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.list_scripts() called")
    ...
    def read_script(self, filename):
        _unilab_logger.debug("[UNILAB] NewportXPS.read_script() called")
        """read script content
    ...
    def download_script(self, filename):
        _unilab_logger.debug("[UNILAB] NewportXPS.download_script() called")
    ...
    def upload_script(self, filename, text):
        _unilab_logger.debug("[UNILAB] NewportXPS.upload_script() called")
        """upload script file
    ...
    def delete_script(self, filename):
        _unilab_logger.debug("[UNILAB] NewportXPS.delete_script() called")
        """delete script file
    ...
    def upload_systemini(self, text):
        _unilab_logger.debug("[UNILAB] NewportXPS.upload_systemini() called")
    ...
    def upload_stagesini(self, text):
        _unilab_logger.debug("[UNILAB] NewportXPS.upload_stagesini() called")
    ...
    def get_tuning(self, stage):
        _unilab_logger.debug("[UNILAB] NewportXPS.set_tuning() called")
    ...
    def set_trajectory_group(self, group, reenable=False):
        _unilab_logger.debug("[UNILAB] NewportXPS.set_trajectory_group() called")
    ...
    def kill_group(self, group=None):
        _unilab_logger.debug("[UNILAB] NewportXPS._group_act() called")
        """
    ...
    def initialize_allgroups(self, with_encoder=True, home=False):
        _unilab_logger.debug("[UNILAB] NewportXPS.initialize_allgroups() called")
        """
    ...
    def home_allgroups(self, with_encoder=True, home=False):
        _unilab_logger.debug("[UNILAB] NewportXPS.home_allgroups() called")
        """
        home all groups
        """
        for g in self.groups:
    ...
    def home_group(self, group=None, with_raise=True):
        _unilab_logger.debug("[UNILAB] NewportXPS.initialize_group() called")
        """
        home group
    ...
    def enable_group(self, group=None):
        _unilab_logger.debug("[UNILAB] NewportXPS.enable_group() called")
        """enable group
    ...
    def disable_group(self, group=None):
        _unilab_logger.debug("[UNILAB] NewportXPS.disable_group() called")
        """disable group
    ...
    def get_group_status(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.get_group_status() called")
        """
    ...
    def get_hardware_status(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.get_hardware_status() called")
        """
    ...
    def get_positioner_errors(self):
        _unilab_logger.debug("[UNILAB] NewportXPS.get_positioner_errors() called")
        """
    ...
    def abort_group(self, group=None):
        _unilab_logger.debug("[UNILAB] NewportXPS.set_velocity() called")
        """abort group move"""
    ...
    def move_group(self, group=None, **kws):
        _unilab_logger.debug("[UNILAB] NewportXPS.move_group() called")
    ...
    def execute_script(self, script, task, arguments):
        _unilab_logger.debug("[UNILAB] NewportXPS.execute_script() called")
        """
    ...
    def move_stage(self, stage, value, relative=False):
        _unilab_logger.debug("[UNILAB] NewportXPS.move_stage() called")
        """
    ...
    def get_stage_position(self, stage):
        _unilab_logger.debug("[UNILAB] NewportXPS.get_stage_position() called")
        """
    ...
    def reboot(self, reconnect=True, timeout=120.0):
        _unilab_logger.debug("[UNILAB] NewportXPS.reboot() called")
        """
    ...
    def get_trajectory(self, name, verify_group=True):
        _unilab_logger.debug("[UNILAB] NewportXPS.define_line_trajectories() called")
    ...
    def move_to_trajectory_start(self, name, group=None):
        _unilab_logger.debug("[UNILAB] NewportXPS.move_to_trajectory_start() called")
        """
    ...
    def arm_trajectory(self, name, verbose=False, move_to_start=True, group=None):
        _unilab_logger.debug("[UNILAB] NewportXPS.arm_trajectory() called")
        """
    ...
    def read_and_save(self, output_file, verbose=False):
        _unilab_logger.debug("[UNILAB] NewportXPS.run_trajectory() called")
    ...
    def save_gathering_file(self, fname, buff, verbose=False, set_idle_when_done=True):
        _unilab_logger.debug("[UNILAB] NewportXPS.read_gathering() called")
