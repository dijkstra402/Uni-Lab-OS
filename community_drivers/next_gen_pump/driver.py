...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.NextGenPump")
...
# Vendored repo packages: py_hplc, py_hplc
import sys as _sys
...
class NextGenPump(NextGenPumpBase):
    ...
    def __init__(self, device: Union[SerialBase, str], logger: Logger = None) -> None:
        print("[UNILAB] NextGenPump.__init__() called", flush=True)
    ...
    def run(self) -> str:
        _unilab_logger.debug("[UNILAB] NextGenPump.run() called")
        """Runs the pump."""
        return self.command("ru")

    def stop(self) -> str:
        _unilab_logger.debug("[UNILAB] NextGenPump.stop() called")
        """Stops the pump."""
        return self.command("st")

    def keypad_enable(self) -> str:
        _unilab_logger.debug("[UNILAB] NextGenPump.keypad_enable() called")
        """Enables the pump's keypad."""
        return self.command("ke")

    def keypad_disable(self) -> str:
        _unilab_logger.debug("[UNILAB] NextGenPump.keypad_disable() called")
        """Disables the pump's keypad."""
        return self.command("kd")

    def clear_faults(self) -> str:
        _unilab_logger.debug("[UNILAB] NextGenPump.clear_faults() called")
        """Clears the pump's faults."""
        return self.command("cf")

    def reset(self) -> str:
        _unilab_logger.debug("[UNILAB] NextGenPump.reset() called")
        """Resets the pump's user-adjustable values to factory defaults."""
        return self.command("re")

    def zero_seal(self) -> str:
        _unilab_logger.debug("[UNILAB] NextGenPump.zero_seal() called")
    ...
    def current_conditions(self) -> CurrentConditions:
        _unilab_logger.debug("[UNILAB] NextGenPump.current_conditions() called")
    ...
    def current_state(self) -> CurrentState:
        _unilab_logger.debug("[UNILAB] NextGenPump.current_state() called")
    ...
    def pump_info(self) -> PumpInfo:
        _unilab_logger.debug("[UNILAB] NextGenPump.pump_info() called")
    ...
    def read_faults(self) -> Faults:
        _unilab_logger.debug("[UNILAB] NextGenPump.read_faults() called")
    ...
    def flowrate_compensation(self) -> float:
        _unilab_logger.debug("[UNILAB] NextGenPump.flowrate_compensation() called")
    ...
    def flowrate(self) -> float:
        _unilab_logger.debug("[UNILAB] NextGenPump.flowrate() called")
    ...
    def pressure(self) -> Union[float, int]:
        _unilab_logger.debug("[UNILAB] NextGenPump.pressure() called")
    ...
    def upper_pressure_limit(self) -> float:
        _unilab_logger.debug("[UNILAB] NextGenPump.upper_pressure_limit() called")
    ...
    def lower_pressure_limit(self) -> float:
        _unilab_logger.debug("[UNILAB] NextGenPump.lower_pressure_limit() called")
    ...
    def leak_detected(self) -> bool:
        _unilab_logger.debug("[UNILAB] NextGenPump.leak_detected() called")
    ...
    def set_leak_mode(self, mode: int) -> int:
        _unilab_logger.debug("[UNILAB] NextGenPump.set_leak_mode() called")
    ...
    def solvent(self) -> int:
        _unilab_logger.debug("[UNILAB] NextGenPump.solvent() called")
