...
Original: can/interfaces/nixnet.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.NiXNETcanBus")
...
class NiXNETcanBus(BusABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("[UNILAB] NiXNETcanBus.__init__() called", flush=True)
        """
        :param str channel:
    ...
    @property
    def fd(self) -> bool:
        _unilab_logger.debug("[UNILAB] NiXNETcanBus.fd() called")
    ...
    def _recv_internal(self, timeout: float | None) -> tuple[Message | None, bool]:
        _unilab_logger.debug("[UNILAB] NiXNETcanBus._recv_internal() called")
    ...
    def send(self, msg: Message, timeout: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] NiXNETcanBus.send() called")
        """
    ...
    def reset(self) -> None:
        _unilab_logger.debug("[UNILAB] NiXNETcanBus.reset() called")
        """
    ...
    def shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] NiXNETcanBus.shutdown() called")
        """Close object."""
        super().shutdown()
    ...
    def _detect_available_configs() -> list[can.typechecking.AutoDetectedConfig]:
        _unilab_logger.debug("[UNILAB] NiXNETcanBus._detect_available_configs() called")
        configs = []
