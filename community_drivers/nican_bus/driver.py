...
Original: can/interfaces/nican.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.NicanBus")
...
class NicanBus(BusABC):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("[UNILAB] NicanBus.__init__() called", flush=True)
        """
        :param channel:
    ...
    def _recv_internal(self, timeout: float | None) -> tuple[Message | None, bool]:
        _unilab_logger.debug("[UNILAB] NicanBus._recv_internal() called")
        """
    ...
    def send(self, msg: Message, timeout: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] NicanBus.send() called")
        """
    ...
    def reset(self) -> None:
        _unilab_logger.debug("[UNILAB] NicanBus.reset() called")
        """
    ...
    def shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] NicanBus.shutdown() called")
        """Close object."""
        super().shutdown()
