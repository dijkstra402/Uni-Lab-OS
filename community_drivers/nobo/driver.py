...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.nobo")
...
class nobo:
    ...
    class API:
        ...
        def is_valid_datetime(timestamp: str):
            _unilab_logger.debug("[UNILAB] nobo.is_valid_datetime() called")
            if len(timestamp) != 12:
        ...
        def time_is_quarter(minutes: str):
            _unilab_logger.debug("[UNILAB] nobo.time_is_quarter() called")
            return int(minutes) % 15 == 0

        def validate_temperature(temperature: Union[int, str]):
            _unilab_logger.debug("[UNILAB] nobo.validate_temperature() called")
        ...
        def validate_week_profile(profile):
            _unilab_logger.debug("[UNILAB] nobo.validate_week_profile() called")
    ...
    class Model:
        ...
        def has_temp_sensor(self) -> bool:
            _unilab_logger.debug("[UNILAB] nobo.has_temp_sensor() called")
    ...
    class DiscoveryProtocol(asyncio.DatagramProtocol):
        ...
        def connection_made(self, transport: asyncio.transports.DatagramTransport):
            _unilab_logger.debug("[UNILAB] nobo.connection_made() called")
            self.transport = transport

        def datagram_received(self, data: bytes, addr):
            _unilab_logger.debug("[UNILAB] nobo.datagram_received() called")
    ...
    def register_callback(self, callback=lambda *args, **kwargs: None):
        _unilab_logger.debug("[UNILAB] nobo.register_callback() called")
        """
    ...
    def deregister_callback(self, callback=lambda *args, **kwargs: None):
        _unilab_logger.debug("[UNILAB] nobo.deregister_callback() called")
        """
    ...
    async def connect(self):
        _unilab_logger.debug("[UNILAB] nobo.connect() called")
    ...
    async def start(self):
        _unilab_logger.debug("[UNILAB] nobo.start() called")
    ...
    async def stop(self):
        _unilab_logger.debug("[UNILAB] nobo.stop() called")
    ...
    async def close(self):
        _unilab_logger.debug("[UNILAB] nobo.close() called")
    ...
    def connect_hub(self, ip, serial):
        _unilab_logger.debug("[UNILAB] nobo.connect_hub() called")
        try:
            loop = asyncio.get_running_loop()
        except RuntimeError:
            loop = asyncio.new_event_loop()
    ...
    async def async_connect_hub(self, ip, serial):
        _unilab_logger.debug("[UNILAB] nobo.async_connect_hub() called")
        """
    ...
    async def reconnect_hub(self):
        _unilab_logger.debug("[UNILAB] nobo.reconnect_hub() called")
    ...
    def discover_hubs(serial="", ip=None, autodiscover_wait=3.0, loop=None):
        _unilab_logger.debug("[UNILAB] nobo.discover_hubs() called")
        if loop is not None:
    ...
    async def async_discover_hubs(serial="", ip=None, autodiscover_wait=3.0, loop=None, rediscover=False):
        _unilab_logger.debug("[UNILAB] nobo.async_discover_hubs() called")
        """
    ...
    def _reuse_port() -> bool:
        _unilab_logger.debug("[UNILAB] nobo._reuse_port() called")
        """
    ...
    async def keep_alive(self, interval = 14):
        _unilab_logger.debug("[UNILAB] nobo.keep_alive() called")
        """
    ...
    def _create_task(self, target):
        _unilab_logger.debug("[UNILAB] nobo._create_task() called")
        try:
            loop = asyncio.get_running_loop()
        except RuntimeError:
            loop = asyncio.new_event_loop()
    ...
    def send_command(self, commands):
        _unilab_logger.debug("[UNILAB] nobo.send_command() called")
        self._create_task(self.async_send_command(commands))

    async def async_send_command(self, commands):
        _unilab_logger.debug("[UNILAB] nobo.async_send_command() called")
        """
    ...
    async def _get_initial_data(self):
        _unilab_logger.debug("[UNILAB] nobo._get_initial_data() called")
        self._received_all_info = False
    ...
    async def get_response(self):
        _unilab_logger.debug("[UNILAB] nobo.get_response() called")
        """
    ...
    async def socket_receive(self):
        _unilab_logger.debug("[UNILAB] nobo.socket_receive() called")
        try:
            while True:
                try:
    ...
    def response_handler(self, response):
        _unilab_logger.debug("[UNILAB] nobo.response_handler() called")
        """
    ...
    def create_override(self, mode, type, target_type, target_id='-1', end_time='-1', start_time='-1'):
        _unilab_logger.debug("[UNILAB] nobo.create_override() called")
    ...
    async def async_create_override(self, mode, type, target_type, target_id='-1', end_time='-1', start_time='-1'):
        _unilab_logger.debug("[UNILAB] nobo.async_create_override() called")
        """
    ...
    def update_zone(self, zone_id, name=None, week_profile_id=None, temp_comfort_c=None, temp_eco_c=None, override_allowed=None):
        _unilab_logger.debug("[UNILAB] nobo.update_zone() called")
    ...
    async def async_update_zone(self, zone_id, name=None, week_profile_id=None, temp_comfort_c=None, temp_eco_c=None, override_allowed=None):
        _unilab_logger.debug("[UNILAB] nobo.async_update_zone() called")
        """
    ...
    async def async_add_week_profile(self, name, profile=None):
        _unilab_logger.debug("[UNILAB] nobo.async_add_week_profile() called")
        """
    ...
    async def async_update_week_profile(self, week_profile_id: str, name=None, profile=None):
        _unilab_logger.debug("[UNILAB] nobo.async_update_week_profile() called")
        """
    ...
    async def async_remove_week_profile(self, week_profile_id: str):
        _unilab_logger.debug("[UNILAB] nobo.async_remove_week_profile() called")
        """
    ...
    def get_week_profile_status(self, week_profile_id, dt: datetime.datetime=None):
        _unilab_logger.debug("[UNILAB] nobo.get_week_profile_status() called")
        """
    ...
    def get_zone_override_mode(self, zone_id):
        _unilab_logger.debug("[UNILAB] nobo.get_zone_override_mode() called")
        """
    ...
    def get_current_zone_mode(self, zone_id, now: datetime.datetime=None):
        _unilab_logger.debug("[UNILAB] nobo.get_current_zone_mode() called")
        """
    ...
    def get_current_component_temperature(self, serial):
        _unilab_logger.debug("[UNILAB] nobo.get_current_component_temperature() called")
        """
    ...
    def get_current_zone_temperature(self, zone_id):
        _unilab_logger.debug("[UNILAB] nobo.get_current_zone_temperature() called")
        """
