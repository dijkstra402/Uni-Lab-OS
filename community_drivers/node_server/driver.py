...
Original: PYME/cluster/rulenodeserver.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.NodeServer")
...
class NodeServer(object):
    def __init__(self, distributor_or_ns, ip_address, port, nodeID=computerName.GetComputerName()):
        print("[UNILAB] NodeServer.__init__() called", flush=True)
    ...
    def distributor_url(self):
        _unilab_logger.debug("[UNILAB] NodeServer.distributor_url() called")
    ...
    def num_tasks_to_request(self):
        _unilab_logger.debug("[UNILAB] NodeServer.num_tasks_to_request() called")
    ...
    def _update_tasks(self):
        _unilab_logger.debug("[UNILAB] NodeServer._update_tasks() called")
    ...
    def _do_handins(self):
        _unilab_logger.debug("[UNILAB] NodeServer._do_handins() called")
    ...
    def _poll(self):
        _unilab_logger.debug("[UNILAB] NodeServer._poll() called")
        while self._do_poll:
    ...
    def _poll_tasks(self):
        _unilab_logger.debug("[UNILAB] NodeServer._poll_tasks() called")
        while self._do_poll:
            if self._distributor_url is not None:
                self._update_tasks()
            time.sleep(1.0)
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] NodeServer.stop() called")
        self._do_poll = False


    @webframework.register_endpoint('/node/tasks')
    def _get_tasks(self, workerID, numWant=50):
        _unilab_logger.debug("[UNILAB] NodeServer._get_tasks() called")
    ...
    def _handin(self, taskID, status):
        _unilab_logger.debug("[UNILAB] NodeServer._handin() called")
        self._handins.put({'id': taskID, 'status':status})
        return json.dumps({'ok' : True})

    @webframework.register_endpoint('/node/status')
    def _status(self):
        _unilab_logger.debug("[UNILAB] NodeServer._status() called")
