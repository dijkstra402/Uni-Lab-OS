...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Notifier")
...
class Notifier(AbstractContextManager["Notifier"]):
    ...
    def __init__(
        ...
        print("[UNILAB] Notifier.__init__() called", flush=True)
    ...
    def bus(self) -> BusABC | tuple["BusABC", ...]:
        _unilab_logger.debug("[UNILAB] Notifier.bus() called")
    ...
    def add_bus(self, bus: BusABC) -> None:
        _unilab_logger.debug("[UNILAB] Notifier.add_bus() called")
    ...
    def stop(self, timeout: float = 5.0) -> None:
        _unilab_logger.debug("[UNILAB] Notifier.stop() called")
    ...
    def _rx_thread(self, bus: BusABC) -> None:
        _unilab_logger.debug("[UNILAB] Notifier._rx_thread() called")
    ...
    def _on_message_available(self, bus: BusABC) -> None:
        _unilab_logger.debug("[UNILAB] Notifier._on_message_available() called")
        if msg := bus.recv(0):
            self._on_message_received(msg)

    def _on_message_received(self, msg: Message) -> None:
        _unilab_logger.debug("[UNILAB] Notifier._on_message_received() called")
    ...
    def _on_error(self, exc: Exception) -> bool:
        _unilab_logger.debug("[UNILAB] Notifier._on_error() called")
    ...
    def add_listener(self, listener: MessageRecipient) -> None:
        _unilab_logger.debug("[UNILAB] Notifier.add_listener() called")
    ...
    def remove_listener(self, listener: MessageRecipient) -> None:
        _unilab_logger.debug("[UNILAB] Notifier.remove_listener() called")
    ...
    def stopped(self) -> bool:
        _unilab_logger.debug("[UNILAB] Notifier.stopped() called")
    ...
    def find_instances(bus: BusABC) -> tuple["Notifier", ...]:
        _unilab_logger.debug("[UNILAB] Notifier.find_instances() called")
    ...
    def __exit__(
        ...
        _unilab_logger.debug("[UNILAB] Notifier.__exit__() called")
