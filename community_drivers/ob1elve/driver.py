...
Original: pycrofluidics/elveob.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.OB1elve")
...
# Vendored repo packages: pycrofluidics, pycrofluidics
import sys as _sys
...
class OB1elve:
    ...
    def open(self):
        print("[UNILAB] OB1elve.__init__() called", flush=True)
        """
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] OB1elve.close() called")
        """
    ...
    def loadDLL(self):
        _unilab_logger.debug("[UNILAB] OB1elve.loadDLL() called")
        """
    ...
    def loadCallibration(self, path:str = None):
        _unilab_logger.debug("[UNILAB] OB1elve.loadCallibration() called")
        """
    ...
    def performCallibration(self, path:str = None):
        _unilab_logger.debug("[UNILAB] OB1elve.performCallibration() called")
        """
    ...
    def getPressure(self, channel:int) -> float:
        _unilab_logger.debug("[UNILAB] OB1elve.setPressure() called")
        """
    ...
    def addSensor(self, channel:int, sensorType:int, resolution:int = 7, sensorDig:int = 1,sensorIPACalib:int = 0, sensorCustVolt:float = 5.01):
        _unilab_logger.debug("[UNILAB] OB1elve.addSensor() called")
        """
    ...
    def getSensorData(self, channel:int) -> float:
        _unilab_logger.debug("[UNILAB] OB1elve.getSensorData() called")
        """
    ...
    def startRemote(self):
        _unilab_logger.debug("[UNILAB] OB1elve.startRemote() called")
        """
    ...
    def stopRemote(self):
        _unilab_logger.debug("[UNILAB] OB1elve.stopRemote() called")
        """
    ...
    def remoteGetData(self,channel : int) -> tuple[float,float]:
        _unilab_logger.debug("[UNILAB] OB1elve.remoteGetData() called")
        """
    ...
    def remoteSetTarget(self, channel: int, target: float):
        _unilab_logger.debug("[UNILAB] OB1elve.remoteSetTarget() called")
        """
    ...
    def remoteAddPID(self, channelP: int, channelS:int, P:float, I:float, run:bool = True):
        _unilab_logger.debug("[UNILAB] OB1elve.remoteAddPID() called")
        """
    ...
    def remotePausePID(self, channel:int):
        _unilab_logger.debug("[UNILAB] OB1elve.remotePausePID() called")
    ...
    def remoteStartPID(self, channel:int):
        _unilab_logger.debug("[UNILAB] OB1elve.remoteStartPID() called")
    ...
    def _remoteStartstopPID(self, channel:int, run:bool):
        _unilab_logger.debug("[UNILAB] OB1elve._remoteStartstopPID() called")
    ...
    def remoteResetPID(self, channel: int):
        _unilab_logger.debug("[UNILAB] OB1elve.remoteResetPID() called")
    ...
    def remoteChangePID(self, channel:int, P:float, I:float, reset:bool = True):
        _unilab_logger.debug("[UNILAB] OB1elve.remoteChangePID() called")
        """
    ...
    def _channelCheck(self, channel:int) -> c_int32:
        _unilab_logger.debug("[UNILAB] OB1elve._channelCheck() called")
    ...
    def getPressureUniversal(self, channel:int) -> float:
        _unilab_logger.debug("[UNILAB] OB1elve.getPressureUniversal() called")
    ...
    def getFlowUniversal(self, channel:int) -> float:
        _unilab_logger.debug("[UNILAB] OB1elve.getFlowUniversal() called")
    ...
    def __enter__(self):
        _unilab_logger.debug("[UNILAB] OB1elve.__enter__() called")
        self.open()
        return self

    def __exit__(self, exception_type, exception_value, exception_traceback):
        _unilab_logger.debug("[UNILAB] OB1elve.__exit__() called")
