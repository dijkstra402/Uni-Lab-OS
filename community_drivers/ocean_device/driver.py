...
Original: wasatch/OceanDevice.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.OceanDevice")
...
class OceanDevice(InterfaceDevice):
    ...
    def __init__(self, device_id, message_queue=None, alert_queue=None):
        print("[UNILAB] OceanDevice.__init__() called", flush=True)
        super().__init__()
    ...
    def acquire_data(self):
        _unilab_logger.debug("[UNILAB] OceanDevice._init_process_funcs() called")
