...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Odin")
...
class OdinNode(Device):
    def __init__(self, prefix: str, name: str = "") -> None:
        print("[UNILAB] Odin.__init__() called", flush=True)
...
class OdinWriter(DetectorWriter):
    ...
    async def open(self, name: str, exposures_per_event: int = 1) -> dict[str, DataKey]:
        _unilab_logger.debug("[UNILAB] Odin.open() called")
    ...
    async def _describe(self) -> dict[str, DataKey]:
        _unilab_logger.debug("[UNILAB] Odin._describe() called")
    ...
    async def observe_indices_written(
        ...
        _unilab_logger.debug("[UNILAB] Odin.observe_indices_written() called")
