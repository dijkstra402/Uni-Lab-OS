...
Original: src/ophyd_async/epics/odin/_odin_io.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.OdinWriter")
...
class OdinWriter(DetectorWriter):
    def __init__(
        ...
        print("[UNILAB] OdinWriter.__init__() called", flush=True)
    ...
    async def open(self, name: str, exposures_per_event: int = 1) -> dict[str, DataKey]:
        _unilab_logger.debug("[UNILAB] OdinWriter.open() called")
    ...
    async def _describe(self) -> dict[str, DataKey]:
        _unilab_logger.debug("[UNILAB] OdinWriter._describe() called")
    ...
    async def observe_indices_written(
        ...
        _unilab_logger.debug("[UNILAB] OdinWriter.observe_indices_written() called")
