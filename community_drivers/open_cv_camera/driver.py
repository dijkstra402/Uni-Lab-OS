...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.OpenCVCamera")
...
class OpenCVCamera(CameraDevice):
    ...
    def __init__(self, serialNumber:str = None, idProduct:int = None, idVendor:int = None):
        print("[UNILAB] OpenCVCamera.__init__() called", flush=True)
        super().__init__(serialNumber, idProduct, idVendor)
        self.version = ""
    ...
    def openCVProperties(self):
        _unilab_logger.debug("[UNILAB] OpenCVCamera.openCVProperties() called")
        properties = {}
    ...
    def isCompatibleWith(cls, serialNumber, idProduct, idVendor):
        _unilab_logger.debug("[UNILAB] OpenCVCamera.isCompatibleWith() called")
        return False
    ...
    def doInitializeDevice(self):
        _unilab_logger.debug("[UNILAB] OpenCVCamera.doInitializeDevice() called")
    ...
    def doShutdownDevice(self):
        _unilab_logger.debug("[UNILAB] OpenCVCamera.doShutdownDevice() called")
    ...
    def doCaptureFrame(self):
        _unilab_logger.debug("[UNILAB] OpenCVCamera.doCaptureFrame() called")
        with self.lock:
    ...
    def availableCameras(cls):
        _unilab_logger.debug("[UNILAB] OpenCVCamera.availableCameras() called")
        return 0
