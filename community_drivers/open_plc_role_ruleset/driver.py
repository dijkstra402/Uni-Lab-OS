...
Original: core/src/drivers/plugins/python/opcua/opcua_security.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.OpenPLCRoleRuleset")
...
class OpenPLCRoleRuleset(PermissionRuleset):
    ...
    def __init__(self):
        print("[UNILAB] OpenPLCRoleRuleset.__init__() called", flush=True)
    ...
    def check_validity(self, user, action_type_id, body):
        _unilab_logger.debug("[UNILAB] OpenPLCRoleRuleset.check_validity() called")
        """
