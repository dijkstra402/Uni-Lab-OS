...
Original: driver/owis_driver.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.owis")
...
class owis:
    def __init__(self,conf):
        print("[UNILAB] owis.__init__() called", flush=True)
...
#EDIT: use the ComPortMan software to control com port assignments
    ...
    def activate(self,motor:int=0):
        _unilab_logger.debug("[UNILAB] owis.activate() called")
        time.sleep(.1)
    ...
    def configure(self,motor:int=0,ref:int=6):
        _unilab_logger.debug("[UNILAB] owis.configure() called")
        time.sleep(.1)
    ...
    def move(self,count:int,motor:int=0,absol=True):
        _unilab_logger.debug("[UNILAB] owis.move() called")
        time.sleep(.1)
        if absol:
    ...
    def isMoving(self,motor:int=0):
        _unilab_logger.debug("[UNILAB] owis.isMoving() called")
        moving = True
        while moving:
            time.sleep(.1)
            self.sers[motor].write(bytes("?ASTAT\r",'utf-8'))
    ...
    def getPos(self):
        _unilab_logger.debug("[UNILAB] owis.getPos() called")
        time.sleep(.1)
        ret = []
    ...
    def setCurrents(self,dri:int,hol:int,amp:int,motor:int=0):
        _unilab_logger.debug("[UNILAB] owis.setCurrents() called")
        time.sleep(.1)
