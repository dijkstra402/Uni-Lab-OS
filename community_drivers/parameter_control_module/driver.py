...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ParameterControlModule")
...
class ParameterControlModule(ParameterManager, ControlModule):
    ...
    def __init__(self, **kwargs):
        print("[UNILAB] ParameterControlModule.__init__() called", flush=True)
        ParameterManager.__init__(self, action_list=('save', 'update'))
        ControlModule.__init__(self)

    def value_changed(self, param: Parameter) -> Optional[Parameter]:
        _unilab_logger.debug("[UNILAB] ParameterControlModule.value_changed() called")
    ...
    def _update_settings(self, param: Parameter):
        _unilab_logger.debug("[UNILAB] ParameterControlModule._update_settings() called")
    ...
    def connect_tcp_ip(self, params_state=None, client_type: str = "GRABBER") -> None:
        _unilab_logger.debug("[UNILAB] ParameterControlModule.connect_tcp_ip() called")
    ...
    def get_leco_name(self) -> str:
        _unilab_logger.debug("[UNILAB] ParameterControlModule.get_leco_name() called")
    ...
    def get_leco_host_port(self) -> tuple:
        _unilab_logger.debug("[UNILAB] ParameterControlModule.get_leco_host_port() called")
    ...
    def connect_leco(self, connect: bool) -> None:
        _unilab_logger.debug("[UNILAB] ParameterControlModule.connect_leco() called")
        if connect:
    ...
    def process_tcpip_cmds(self, status: ThreadCommand) -> Optional[ThreadCommand]:
        _unilab_logger.debug("[UNILAB] ParameterControlModule.process_tcpip_cmds() called")
...
__all__ = ["ParameterControlModule"]
