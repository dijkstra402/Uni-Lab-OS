...
Original: can/interfaces/pcan/basic.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PCANBasic")
...
class PCANBasic:
    ...
    def __init__(self):
        print("[UNILAB] PCANBasic.__init__() called", flush=True)
    ...
    def Initialize(
        ...
        _unilab_logger.debug("[UNILAB] PCANBasic.Initialize() called")
        """Initializes a PCAN Channel
    ...
    def InitializeFD(self, Channel, BitrateFD):
        _unilab_logger.debug("[UNILAB] PCANBasic.InitializeFD() called")
        """Initializes a FD capable PCAN Channel
    ...
    def Uninitialize(self, Channel):
        _unilab_logger.debug("[UNILAB] PCANBasic.Uninitialize() called")
        """Uninitializes one or all PCAN Channels initialized by CAN_Initialize
    ...
    def Reset(self, Channel):
        _unilab_logger.debug("[UNILAB] PCANBasic.Reset() called")
        """Resets the receive and transmit queues of the PCAN Channel
    ...
    def GetStatus(self, Channel):
        _unilab_logger.debug("[UNILAB] PCANBasic.GetStatus() called")
        """Gets the current status of a PCAN Channel
    ...
    def Read(self, Channel):
        _unilab_logger.debug("[UNILAB] PCANBasic.Read() called")
        """Reads a CAN message from the receive queue of a PCAN Channel
    ...
    def ReadFD(self, Channel):
        _unilab_logger.debug("[UNILAB] PCANBasic.ReadFD() called")
        """Reads a CAN message from the receive queue of a FD capable PCAN Channel
    ...
    def Write(self, Channel, MessageBuffer):
        _unilab_logger.debug("[UNILAB] PCANBasic.Write() called")
        """Transmits a CAN message
    ...
    def WriteFD(self, Channel, MessageBuffer):
        _unilab_logger.debug("[UNILAB] PCANBasic.WriteFD() called")
        """Transmits a CAN message over a FD capable PCAN Channel
    ...
    def FilterMessages(self, Channel, FromID, ToID, Mode):
        _unilab_logger.debug("[UNILAB] PCANBasic.FilterMessages() called")
        """Configures the reception filter
    ...
    def GetValue(self, Channel, Parameter):
        _unilab_logger.debug("[UNILAB] PCANBasic.GetValue() called")
        """Retrieves a PCAN Channel value
    ...
    def SetValue(self, Channel, Parameter, Buffer):
        _unilab_logger.debug("[UNILAB] PCANBasic.SetValue() called")
    ...
    def GetErrorText(self, Error, Language=0):
        _unilab_logger.debug("[UNILAB] PCANBasic.GetErrorText() called")
    ...
    def LookUpChannel(self, Parameters):
        _unilab_logger.debug("[UNILAB] PCANBasic.LookUpChannel() called")
