...
Original: can/interfaces/pcan/pcan.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PcanBus")
...
class PcanBus(BusABC):
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("[UNILAB] PcanBus.__init__() called", flush=True)
    ...
    def _find_channel_by_dev_id(self, device_id):
        _unilab_logger.debug("[UNILAB] PcanBus._find_channel_by_dev_id() called")
        """
    ...
    def _get_formatted_error(self, error):
        _unilab_logger.debug("[UNILAB] PcanBus._get_formatted_error() called")
        """
        ...
        def bits(n):
            _unilab_logger.debug("[UNILAB] PcanBus.bits() called")
            """
    ...
    def get_api_version(self):
        _unilab_logger.debug("[UNILAB] PcanBus.get_api_version() called")
    ...
    def check_api_version(self):
        _unilab_logger.debug("[UNILAB] PcanBus.check_api_version() called")
    ...
    def status(self):
        _unilab_logger.debug("[UNILAB] PcanBus.status() called")
        """
    ...
    def status_is_ok(self):
        _unilab_logger.debug("[UNILAB] PcanBus.status_is_ok() called")
        """
    ...
    def reset(self):
        _unilab_logger.debug("[UNILAB] PcanBus.reset() called")
        """
    ...
    def get_device_number(self):
        _unilab_logger.debug("[UNILAB] PcanBus.get_device_number() called")
        """
    ...
    def set_device_number(self, device_number):
        _unilab_logger.debug("[UNILAB] PcanBus.set_device_number() called")
        """
    ...
    def _recv_internal(self, timeout: float | None) -> tuple[Message | None, bool]:
        _unilab_logger.debug("[UNILAB] PcanBus._recv_internal() called")
    ...
    def send(self, msg, timeout=None):
        _unilab_logger.debug("[UNILAB] PcanBus.send() called")
        msgType = (
    ...
    def flash(self, flash):
        _unilab_logger.debug("[UNILAB] PcanBus.flash() called")
        """
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] PcanBus.shutdown() called")
        super().shutdown()
    ...
    @property
    def fd(self) -> bool:
        _unilab_logger.debug("[UNILAB] PcanBus.fd() called")
    ...
    @property
    def state(self):
        _unilab_logger.debug("[UNILAB] PcanBus.state() called")
        return self._state
    ...
    def _detect_available_configs():
        _unilab_logger.debug("[UNILAB] PcanBus._detect_available_configs() called")
        channels = []
        try:
    ...
    def status_string(self) -> str | None:
        _unilab_logger.debug("[UNILAB] PcanBus.status_string() called")
        """
        Query the PCAN bus status.
