...
Original: ophyd/areadetector/cam.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PerkinElmerDetectorCam")
...
class PerkinElmerDetectorCam(CamBase):
    def __init__(self, *args, **kwargs):
        print("[UNILAB] PerkinElmerDetectorCam.__init__() called", flush=True)
