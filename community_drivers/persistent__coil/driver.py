...
Original: pycqed/instrument_drivers/meta_instrument/Persistent_Coil.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Persistent_Coil")
...
class Persistent_Coil(Instrument):
    ...
    def get_all(self):
        print("[UNILAB] Persistent_Coil.__init__() called", flush=True)
    ...
    def check_for_quench(self):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.check_for_quench() called")
        '''
    ...
    def get_source_current(self):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.get_source_current() called")
        return self.i_magnet.measurei()

    def set_source_current(self,current):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.set_source_current() called")
        self.i_magnet.seti(current)
        return self.name+' current set to '+str(current)+' A'

    def get_heater_current(self):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.get_heater_current() called")
        return self.i_heater.I()

    def set_heater_current(self,value):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.set_heater_current() called")
    ...
    def get_switch_state(self):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.get_switch_state() called")
    ...
    def set_switch_state(self,desired_state):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.set_switch_state() called")
    ...
    def set_field(self,field):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.set_field() called")
    ...
    def get_field(self):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.get_field() called")
    ...
    def measure_field(self):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.measure_field() called")
    ...
    def step_field_to_value(self,field):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.step_field_to_value() called")
    ...
    def field_to_curr(self,field):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.field_to_curr() called")
        return field/self.field_to_current

    def curr_to_field(self,current):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.curr_to_field() called")
        return self.field_to_current*current

    def fake_folder(self,folder_name):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.fake_folder() called")
        '''
    ...
    def compensate_for_drift(self, compensation_factor=1.05):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.compensate_for_drift() called")
        '''
    ...
    def bring_source_to_field(self):
        _unilab_logger.debug("[UNILAB] Persistent_Coil.bring_source_to_field() called")
        '''
