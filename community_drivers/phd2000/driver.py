...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PHD2000")
...
class PHD2000(Pump):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] PHD2000.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def stop(self):
        _unilab_logger.debug("[UNILAB] PHD2000.stop() called")
        """Stop pump."""
        self.write('STP')
        resp = self.read(5)
    ...
    def settargetvolume(self, targetvolume):
        _unilab_logger.debug("[UNILAB] PHD2000.settargetvolume() called")
        """Set the target volume to infuse or withdraw (microlitres)."""
