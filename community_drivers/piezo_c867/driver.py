...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.piezo_c867")
...
class piezo_c867(PiezoBase):
    ...
    def __init__(self, portname='COM1', maxtravel = 25.00, hasTrigger=False, reference=True):
        print("[UNILAB] piezo_c867.__init__() called", flush=True)
    ...
    def SetServo(self, state=1):
        _unilab_logger.debug("[UNILAB] piezo_c867.SetServo() called")
        self.ser_port.write(b'SVO 1 %d\n' % state)
        self.ser_port.write(b'SVO 2 %d\n' % state)

    def ReInit(self, reference=True):
        _unilab_logger.debug("[UNILAB] piezo_c867.ReInit() called")
    ...
    def SetVelocity(self, chan, vel):
        _unilab_logger.debug("[UNILAB] piezo_c867.SetVelocity() called")
        self.ser_port.write(b'VEL %d %3.4f\n' % (chan, vel))
        #self.ser_port.write(b'VEL 2 %3.4f\n' % vel)
        
    def GetVelocity(self, chan):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetVelocity() called")
    ...
    def MoveTo(self, iChannel, fPos, bTimeOut=True):
        _unilab_logger.debug("[UNILAB] piezo_c867.MoveTo() called")
        if (fPos >= 0):
    ...
    def MoveRel(self, iChannel, incr, bTimeOut=True):
        _unilab_logger.debug("[UNILAB] piezo_c867.MoveRel() called")
        self.ser_port.write(b'MVR %d %3.6f\n' % (iChannel, incr))
            
            
    def MoveToXY(self, xPos, yPos, bTimeOut=True):
        _unilab_logger.debug("[UNILAB] piezo_c867.MoveToXY() called")
    ...
    def GetPos(self, iChannel=0):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetPos() called")
        #self.ser_port.flush()
        #time.sleep(0.005)
    ...
    def GetPosXY(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetPosXY() called")
        self.ser_port.flushInput()
        self.ser_port.flushOutput()
        #time.sleep(0.005)
    ...
    def GetControlReady(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetControlReady() called")
        return True
    def GetChannelObject(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetChannelObject() called")
        return 1
    def GetChannelPhase(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetChannelPhase() called")
        return 2
    def GetMin(self,iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetMin() called")
        return 0
    def GetMax(self, iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetMax() called")
        return self.max_travel
        
    def GetFirmwareVersion(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.GetFirmwareVersion() called")
        import re
...
class piezo_c867T(PiezoBase):
    ...
    def _log_error(self, errCode):
        _unilab_logger.debug("[UNILAB] piezo_c867._log_error() called")
        if _has_gcserr:
    ...
    def _Loop(self):
        _unilab_logger.debug("[UNILAB] piezo_c867._Loop() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.close() called")
...
#            self.lock.release()
    ...
    def MoveInDir(self, dx, dy, th=.0000):
        _unilab_logger.debug("[UNILAB] piezo_c867.MoveInDir() called")
    ...
    def StopMove(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.StopMove() called")
        self.stopMove = True
    ...
    def OnTarget(self):
        _unilab_logger.debug("[UNILAB] piezo_c867.OnTarget() called")
