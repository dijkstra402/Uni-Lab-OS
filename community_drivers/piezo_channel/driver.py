...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PiezoChannel")
...
class APTPiezoInertiaActuator(APTPiezoDevice):
    ...
    class PiezoChannel(APTPiezoDevice.PiezoDeviceChannel):
        ...
        def __init__(self, *args, **kwargs):
            print("[UNILAB] PiezoChannel.__init__() called", flush=True)
            super().__init__(*args, **kwargs)
        @property
        def drive_op_parameters(self):
            _unilab_logger.debug("[UNILAB] PiezoChannel.drive_op_parameters() called")
        ...
        def enabled_single(self):
            _unilab_logger.debug("[UNILAB] PiezoChannel.enabled_single() called")
        ...
        def jog_parameters(self):
            _unilab_logger.debug("[UNILAB] PiezoChannel.jog_parameters() called")
        ...
        def position_count(self):
            _unilab_logger.debug("[UNILAB] PiezoChannel.position_count() called")
        ...
        def move_abs(self, pos):
            _unilab_logger.debug("[UNILAB] PiezoChannel.move_abs() called")
            """
        ...
        def move_jog(self, direction="fwd"):
            _unilab_logger.debug("[UNILAB] PiezoChannel.move_jog() called")
            """
        ...
        def move_jog_stop(self):
            _unilab_logger.debug("[UNILAB] PiezoChannel.move_jog_stop() called")
...
class APTPiezoStage(APTPiezoDevice):
    ...
    class PiezoChannel(APTPiezoDevice.PiezoDeviceChannel):
        ...
        def position_control_closed(self):
            _unilab_logger.debug("[UNILAB] PiezoChannel.position_control_closed() called")
            """
        ...
        def change_position_control_mode(self, closed, smooth=True):
            _unilab_logger.debug("[UNILAB] PiezoChannel.change_position_control_mode() called")
            """
        ...
        def output_position(self):
            _unilab_logger.debug("[UNILAB] PiezoChannel.output_position() called")
            """
