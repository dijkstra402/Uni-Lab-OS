...
Original: PYME/Acquire/Hardware/Piezos/piezo_e709.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.piezo_e709T")
...
class piezo_e709T(PiezoBase):
    def __init__(self, portname='COM1', maxtravel = 400., Osen=None, hasTrigger=False):
        print("[UNILAB] piezo_e709T.__init__() called", flush=True)
        self.max_travel = maxtravel
    ...
    def _Loop(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T._Loop() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.close() called")
    ...
    def SetServo(self, state=1):
        _unilab_logger.debug("[UNILAB] piezo_e709T.SetServo() called")
        self.lock.acquire()
        try:
            self.ser_port.write(b'SVO Z %d\n' % state)
...
#            self.lock.release()
    ...
    def ReInit(self, reference=True):
        _unilab_logger.debug("[UNILAB] piezo_e709T.ReInit() called")
        #self.ser_port.write(b'WTO A0\n')
        self.lock.acquire()
        try:
            self.ser_port.write(b'RBT\n')
...
#        return self.velocity[chan-1]
    ...
    def MoveTo(self, iChannel, fPos, bTimeOut=True, vel=None):
        _unilab_logger.debug("[UNILAB] piezo_e709T.MoveTo() called")
        chan = iChannel - 1
        #if vel == None:
    ...
    def MoveRel(self, iChannel, incr, bTimeOut=True):
        _unilab_logger.debug("[UNILAB] piezo_e709T.MoveRel() called")
...
#        self.targetVelocity[:] = vel 
    ...
    def OnTarget(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.OnTarget() called")
        return self.onTarget
            

    def GetPos(self, iChannel=0):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetPos() called")
        #self.ser_port.flush()
        #time.sleep(0.005)
    ...
    def GetPosXY(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetPosXY() called")
        return self.position
        
    def GetTargetPos(self,iChannel=0):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetTargetPos() called")
        return self.targetPosition[iChannel]

    def MoveInDir(self, dx, dy, th=.0000):
        _unilab_logger.debug("[UNILAB] piezo_e709T.MoveInDir() called")
    ...
    def StopMove(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.StopMove() called")
        self.stopMove = True
    
    def GetControlReady(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetControlReady() called")
        return True
    def GetChannelObject(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetChannelObject() called")
        return 1
    def GetChannelPhase(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetChannelPhase() called")
        return 2
    def GetMin(self,iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetMin() called")
        return 0
    def GetMax(self, iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetMax() called")
        return self.max_travel
        
    def GetFirmwareVersion(self):
        _unilab_logger.debug("[UNILAB] piezo_e709T.GetFirmwareVersion() called")
        import re
        self.ser_port.write(b'*IDN?\n')
        self.ser_port.flush()
