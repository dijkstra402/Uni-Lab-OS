...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PIM")
...
from pcdsdevices.areadetector.detectors import (PCDSAreaDetectorEmbedded,
...
from pcdsdevices.digital_signals import J120K
from pcdsdevices.epics_motor import IMS, BeckhoffAxisNoOffset
from pcdsdevices.inout import InOutRecordPositioner
from pcdsdevices.interface import BaseInterface, LightpathInOutCptMixin
from pcdsdevices.keithley import IM3L0_K2700
from pcdsdevices.pmps import TwinCATStatePMPS
from pcdsdevices.sensors import TwinCATThermocouple
from pcdsdevices.signal import PytmcSignal, UnitConversionDerivedSignal
from pcdsdevices.state import StatePositioner
from pcdsdevices.utils import get_status_float, get_status_value, reorder_components
...
class PIMY(InOutRecordPositioner, BaseInterface):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] PIM.__init__() called", flush=True)
    ...
    def stage(self) -> list[OphydObject]:
        _unilab_logger.debug("[UNILAB] PIM.stage() called")
    ...
    def unstage(self) -> list[OphydObject]:
        _unilab_logger.debug("[UNILAB] PIM.unstage() called")
...
class PIM(BaseInterface, GroupDevice, LightpathInOutCptMixin):
    ...
    def infer_prefix(self, prefix):
        _unilab_logger.debug("[UNILAB] PIM.infer_prefix() called")
    ...
    def format_status_info(self, status_info):
        _unilab_logger.debug("[UNILAB] PIM.format_status_info() called")
        """
