...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Plant")
...
class Plant(Instrument, QThread):
    ...
    def __init__(self, name =  None, settings = None):
        print("[UNILAB] Plant.__init__() called", flush=True)
    ...
    def start(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] Plant.start() called")
        """
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] Plant.quit() called")
        """
    ...
    def read_probes(self, key):
        _unilab_logger.debug("[UNILAB] Plant.read_probes() called")
        """
        requestes value from the instrument and returns it
        Args:
            key: name of requested value
    ...
    @property
    def is_connected(self):
        _unilab_logger.debug("[UNILAB] Plant.is_connected() called")
        '''
        check if instrument is active and connected and return True in that case
        :return: bool
        '''
