...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PLC")
...
class PLC(object):
    ...
    def __init__(self, ip_address="", slot=0, timeout=5.0, Micro800=False, port=44818):
        print("[UNILAB] PLC.__init__() called", flush=True)
        """
    ...
    def ConnectionSize(self):
        _unilab_logger.debug("[UNILAB] PLC.ConnectionSize() called")
    ...
    def __enter__(self):
        _unilab_logger.debug("[UNILAB] PLC.__enter__() called")
        return self

    def __exit__(self, exc_type, exc_val, exc_tb):
        _unilab_logger.debug("[UNILAB] PLC.__exit__() called")
        """
        Clean up on exit
        """
        self.conn.close()
    ...
    def Read(self, tag, count=1, datatype=None):
        _unilab_logger.debug("[UNILAB] PLC.Read() called")
        """
    ...
    def Write(self, tag, value=None, datatype=None):
        _unilab_logger.debug("[UNILAB] PLC.Write() called")
        """
    ...
    def GetPLCTime(self, raw=False):
        _unilab_logger.debug("[UNILAB] PLC.GetPLCTime() called")
        """
    ...
    def SetPLCTime(self, dst=None):
        _unilab_logger.debug("[UNILAB] PLC.SetPLCTime() called")
        """
    ...
    def GetTagList(self, allTags=True):
        _unilab_logger.debug("[UNILAB] PLC.GetTagList() called")
        """
    ...
    def GetProgramTagList(self, programName):
        _unilab_logger.debug("[UNILAB] PLC.GetProgramTagList() called")
        """
    ...
    def GetProgramsList(self):
        _unilab_logger.debug("[UNILAB] PLC.GetProgramsList() called")
        """
    ...
    def Discover(self):
        _unilab_logger.debug("[UNILAB] PLC.Discover() called")
        """
    ...
    def GetModuleProperties(self, slot):
        _unilab_logger.debug("[UNILAB] PLC.GetModuleProperties() called")
        """
    ...
    def GetDeviceProperties(self):
        _unilab_logger.debug("[UNILAB] PLC.GetDeviceProperties() called")
        """
    ...
    def Message(self, cip_service, cip_class, cip_instance, cip_attribute=None, data=b''):
        _unilab_logger.debug("[UNILAB] PLC.Message() called")
        """
    ...
    def ReceiveMessage(self, ip_address, callback, port=44818):
        _unilab_logger.debug("[UNILAB] PLC.ReceiveMessage() called")

        self.callback = callback
        return self._receive_message(ip_address, port)

    def Close(self):
        _unilab_logger.debug("[UNILAB] PLC.Close() called")
        """
    ...
    def _read_tag(self, tag_name, elements=1, data_type=None):
        _unilab_logger.debug("[UNILAB] PLC._read_tag() called")
        """
    ...
    def _batch_read(self, tags):
        _unilab_logger.debug("[UNILAB] PLC._batch_read() called")
        """
    ...
    def _multi_read(self, tags):
        _unilab_logger.debug("[UNILAB] PLC._multi_read() called")
        """
        Read tags using multi-service messaging
        """
    ...
    def _generate_read_service_list(self, tags):
        _unilab_logger.debug("[UNILAB] PLC._generate_read_service_list() called")
        """
    ...
    def _batch_write(self, tags):
        _unilab_logger.debug("[UNILAB] PLC._batch_write() called")
        """
    ...
    def _write_tag(self, tag_name, value, data_type=None):
        _unilab_logger.debug("[UNILAB] PLC._write_tag() called")
        """
    ...
    def _multi_write(self, write_data):
        _unilab_logger.debug("[UNILAB] PLC._multi_write() called")
        """
    ...
    def _get_plc_time(self, raw=False):
        _unilab_logger.debug("[UNILAB] PLC._get_plc_time() called")
        """
    ...
    def _set_plc_time(self, dst):
        _unilab_logger.debug("[UNILAB] PLC._set_plc_time() called")
        """
        Requests the PLC clock time
        """
        conn = self.conn.connect()
    ...
    def _get_tag_list(self, all_tags):
        _unilab_logger.debug("[UNILAB] PLC._get_tag_list() called")
        """
    ...
    def _get_program_tag_list(self, program_name):
        _unilab_logger.debug("[UNILAB] PLC._get_program_tag_list() called")
        """
    ...
    def _get_udt(self, tag_list):
        _unilab_logger.debug("[UNILAB] PLC._get_udt() called")
        """
    ...
    def _get_template_attribute(self, instance):
        _unilab_logger.debug("[UNILAB] PLC._get_template_attribute() called")
        """
    ...
    def _get_template(self, instance, data_len):
        _unilab_logger.debug("[UNILAB] PLC._get_template() called")
        """
    ...
    def _read_template_service(self, instance, data_len, offset=0):
        _unilab_logger.debug("[UNILAB] PLC._read_template_service() called")
        """
    ...
    def _get_module_properties(self, slot):
        _unilab_logger.debug("[UNILAB] PLC._get_module_properties() called")
        """
    ...
    def _get_device_properties(self):
        _unilab_logger.debug("[UNILAB] PLC._get_device_properties() called")
        """
    ...
    def _message(self, cip_service, cip_class, cip_instance, cip_attribute, data):
        _unilab_logger.debug("[UNILAB] PLC._message() called")
        conn = self.conn.connect(False)
        if not conn[0]:
            return Response(None, None, conn[1])
    ...
    def _cip_message(self, cip_service, cip_class, cip_instance, cip_attribute=None, data=b''):
        _unilab_logger.debug("[UNILAB] PLC._cip_message() called")
        """
    ...
    def _receive_message(self, ip_address, port):
        _unilab_logger.debug("[UNILAB] PLC._receive_message() called")
    ...
    def _receive_message_response(self, data, status):
        _unilab_logger.debug("[UNILAB] PLC._receive_message_response() called")
    ...
    def _build_ioi(self, tag_name, data_type):
        _unilab_logger.debug("[UNILAB] PLC._build_ioi() called")
    ...
    def _decode_ioi(self, data):
        _unilab_logger.debug("[UNILAB] PLC._decode_ioi() called")
    ...
    def _add_read_service(self, ioi, elements):
        _unilab_logger.debug("[UNILAB] PLC._add_read_service() called")
        """
    ...
    def _add_partial_read_service(self, ioi, elements):
        _unilab_logger.debug("[UNILAB] PLC._add_partial_read_service() called")
        """
    ...
    def _add_write_service(self, ioi, write_data, data_type):
        _unilab_logger.debug("[UNILAB] PLC._add_write_service() called")
        """
    ...
    def _add_mod_write_service(self, ioi, data_type, mask_high, mask_low):
        _unilab_logger.debug("[UNILAB] PLC._add_mod_write_service() called")
        """
    ...
    def _add_frag_write_service(self, count, ioi, write_data, data_type):
        _unilab_logger.debug("[UNILAB] PLC._add_frag_write_service() called")
        """
    ...
    def _build_multi_service_header(self):
        _unilab_logger.debug("[UNILAB] PLC._build_multi_service_header() called")
        """
    ...
    def _build_tag_list_request(self, program_name):
        _unilab_logger.debug("[UNILAB] PLC._build_tag_list_request() called")
        """
    ...
    def _parse_reply(self, tag_name, elements, data):
        _unilab_logger.debug("[UNILAB] PLC._parse_reply() called")
        """
    ...
    def _get_values(self, tag_name, data):
        _unilab_logger.debug("[UNILAB] PLC._get_values() called")
        """
    ...
    def _get_unknown_types(self, tags):
        _unilab_logger.debug("[UNILAB] PLC._get_unknown_types() called")
        """
    ...
    def _initial_read(self, tag, base_tag, data_type):
        _unilab_logger.debug("[UNILAB] PLC._initial_read() called")
        """
    ...
    def _convert_write_data(self, tag, data_type, write_values):
        _unilab_logger.debug("[UNILAB] PLC._convert_write_data() called")
        """
    ...
    def _words_to_bits(self, tag_name, value, count=0):
        _unilab_logger.debug("[UNILAB] PLC._words_to_bits() called")
        """
    ...
    def _parse_multi_read_response(self, data, tags):
        _unilab_logger.debug("[UNILAB] PLC._parse_multi_read_response() called")
        """
    ...
    def _parse_multi_write(self, write_data, data):
        _unilab_logger.debug("[UNILAB] PLC._parse_multi_write() called")
    ...
    def _parse_packet(self, data, program_name):
        _unilab_logger.debug("[UNILAB] PLC._parse_packet() called")
    ...
    def _make_standard_string(self, string):
        _unilab_logger.debug("[UNILAB] PLC._make_standard_string() called")
        """
    ...
    def _make_special_string(self, string):
        _unilab_logger.debug("[UNILAB] PLC._make_special_string() called")
        """
    ...
    def _is_not_used(self):
        _unilab_logger.debug("[UNILAB] PLC._is_not_used() called")
        pass
