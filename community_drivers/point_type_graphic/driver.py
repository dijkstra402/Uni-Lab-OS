...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PointTypeGraphic")
...
class PointTypeGraphic(Graphic):
    ...
    def __init__(self, type: str, title: typing.Optional[str]) -> None:
        print("[UNILAB] PointTypeGraphic.__init__() called", flush=True)
        super().__init__(type)
        self.title = title
    ...
    def position(self) -> Geometry.FloatPoint:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.position() called")
    ...
    def reset_position(self) -> None:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.reset_position() called")
        self.position = Geometry.FloatPoint(0.5, 0.5)

    def mime_data_dict(self) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.mime_data_dict() called")
        d = super().mime_data_dict()
        d["position"] = self.position.as_tuple()
        return d

    def read_from_mime_data(self, graphic_dict: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.read_from_mime_data() called")
        super().read_from_mime_data(graphic_dict)
        self.position = graphic_dict.get("position", self.position)

    def get_attributes(self) -> set[GraphicAttributeEnum]:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.get_attributes() called")
        return {GraphicAttributeEnum.TWO_DIMENSIONAL}

    def get_mask_item(self) -> MaskItem:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.get_mask_item() called")
        return PointMaskItem(self.position)

    # test is required for Graphic interface
    def test(self, mapping: CoordinateMappingLike, ui_settings: UISettings.UISettings, p: Geometry.FloatPoint, move_only: bool) -> typing.Tuple[typing.Optional[str], bool]:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.test() called")
        # first convert to widget coordinates since test distances
        # are specified in widget coordinates
        cross_hair_size = 12
    ...
    def begin_drag(self) -> DragPartData:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.begin_drag() called")
        return (self.position,)

    def end_drag(self, part_data: DragPartData) -> None:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.end_drag() called")
        pass

    def adjust_part(self, mapping: CoordinateMappingLike, original: Geometry.FloatPoint, current: Geometry.FloatPoint, part: DragPartDataPlus, modifiers: ModifiersLike) -> None:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.adjust_part() called")
    ...
    def nudge(self, mapping: CoordinateMappingLike, delta: Geometry.FloatSize) -> None:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic.nudge() called")
    ...
    def _draw(self, ctx: DrawingContextLike, ui_settings: UISettings.UISettings, mapping: CoordinateMappingLike, is_selected: bool, is_focused: bool) -> None:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic._draw() called")
        raise NotImplementedError()

    @property
    def _position(self) -> Geometry.FloatPoint:
        _unilab_logger.debug("[UNILAB] PointTypeGraphic._position() called")
        return self.position
