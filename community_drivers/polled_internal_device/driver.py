...
Original: gpiozero/internal_devices.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PolledInternalDevice")
...
from gpiozero.mixins import EventsMixin, event
from gpiozero.threads import GPIOThread
from gpiozero.exc import ThresholdOutOfRange, DeviceClosed
...
class PolledInternalDevice(InternalDevice):
    ...
    def __init__(self, *, event_delay=1.0, pin_factory=None):
        print("[UNILAB] PolledInternalDevice.__init__() called", flush=True)
        self._event_thread = None
        self._event_delay = event_delay
        super().__init__(pin_factory=pin_factory)

    def close(self):
        _unilab_logger.debug("[UNILAB] PolledInternalDevice.close() called")
        try:
    ...
    def event_delay(self):
        _unilab_logger.debug("[UNILAB] PolledInternalDevice.event_delay() called")
        """
    ...
    def wait_for_active(self, timeout=None):
        _unilab_logger.debug("[UNILAB] PolledInternalDevice.wait_for_active() called")
    ...
    def wait_for_inactive(self, timeout=None):
        _unilab_logger.debug("[UNILAB] PolledInternalDevice.wait_for_inactive() called")
        self._start_stop_events(True)
        try:
    ...
    def _watch_value(self):
        _unilab_logger.debug("[UNILAB] PolledInternalDevice._watch_value() called")
        while not self._event_thread.stopping.wait(self._event_delay):
            self._fire_events(self.pin_factory.ticks(), self.is_active)

    def _start_stop_events(self, enabled):
        _unilab_logger.debug("[UNILAB] PolledInternalDevice._start_stop_events() called")
