...
Original: mir100_client/models/post_wifi_connections.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PostWifiConnections")
...
class PostWifiConnections(object):
    ...
    @property
    def address(self):
        print("[UNILAB] PostWifiConnections.__init__() called", flush=True)
    ...
    def address(self, address):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.address() called")
    ...
    @property
    def device(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.device() called")
    ...
    @property
    def dns(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.dns() called")
    ...
    @property
    def gateway(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.gateway() called")
    ...
    @property
    def netmask(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.netmask() called")
    ...
    @property
    def security(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.security() called")
    ...
    @property
    def ssid(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.ssid() called")
    ...
    def to_dict(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.to_dict() called")
    ...
    def to_str(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.to_str() called")
        """Returns the string representation of the model"""
        return pprint.pformat(self.to_dict())

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.__repr__() called")
        """For `print` and `pprint`"""
        return self.to_str()

    def __eq__(self, other):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.__eq__() called")
    ...
    def __ne__(self, other):
        _unilab_logger.debug("[UNILAB] PostWifiConnections.__ne__() called")
        """Returns true if both objects are not equal"""
        return not self == other

__all__ = ["PostWifiConnections"]
