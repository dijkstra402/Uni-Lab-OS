...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.pressure_trans")
...
class pressure_trans:
    ...
    '''
    def __init__(self,address) -> None:
        print("[UNILAB] pressure_trans.__init__() called", flush=True)
        import serial
        self.ser = serial.Serial(port='/dev/ttyUSB0',baudrate=115200,timeout=3)
        self.address = str(address)

    def QueryPressure(self):
        _unilab_logger.debug("[UNILAB] pressure_trans.QueryPressure() called")
        '''
    ...
    def ReportStatus(self):
        _unilab_logger.debug("[UNILAB] pressure_trans.ReportStatus() called")
        '''
    ...
    def __SendCommand(self,command):
        _unilab_logger.debug("[UNILAB] pressure_trans.__SendCommand() called")
        '''
    ...
    def __ValidateResponse(self,response):
        _unilab_logger.debug("[UNILAB] pressure_trans.__ValidateResponse() called")
        '''
    ...
    def __ParsePressure(self,response):
        _unilab_logger.debug("[UNILAB] pressure_trans.__ParsePressure() called")
        '''
