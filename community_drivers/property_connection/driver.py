...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PropertyConnection")
...
class PropertyConnection(Connection):
    ...
    def close(self) -> None:
        print("[UNILAB] PropertyConnection.__init__() called", flush=True)
        if self.__binding:
            self.__binding.close()
            self.__binding = None
        if self.__target_property_changed_listener:
    ...
    def source_specifier(self) -> typing.Optional[Persistence._SpecifierType]:
        _unilab_logger.debug("[UNILAB] PropertyConnection.source_specifier() called")
    ...
    def target_specifier(self) -> typing.Optional[Persistence._SpecifierType]:
        _unilab_logger.debug("[UNILAB] PropertyConnection.target_specifier() called")
    ...
    def source_property(self) -> typing.Any:
        _unilab_logger.debug("[UNILAB] PropertyConnection.source_property() called")
    ...
    def target_property(self) -> typing.Any:
        _unilab_logger.debug("[UNILAB] PropertyConnection.target_property() called")
    ...
    def connected_items(self) -> typing.List[typing.Optional[Persistence.PersistentObject]]:
        _unilab_logger.debug("[UNILAB] PropertyConnection.connected_items() called")
    ...
    def _source(self) -> typing.Optional[Persistence.PersistentObject]:
        _unilab_logger.debug("[UNILAB] PropertyConnection._source() called")
        return self.__source_reference.item

    @property
    def _target(self) -> typing.Optional[Persistence.PersistentObject]:
        _unilab_logger.debug("[UNILAB] PropertyConnection._target() called")
    ...
    def source(self) -> typing.Optional[Persistence.PersistentObject]:
        _unilab_logger.debug("[UNILAB] PropertyConnection.source() called")
        return self._source

    @property
    def target(self) -> typing.Optional[Persistence.PersistentObject]:
        _unilab_logger.debug("[UNILAB] PropertyConnection.target() called")
        return self._target

    def __source_specifier_changed(self, name: str, d: _SpecifierType) -> None:
        _unilab_logger.debug("[UNILAB] PropertyConnection.__source_specifier_changed() called")
    ...
    def __target_specifier_changed(self, name: str, d: _SpecifierType) -> None:
        _unilab_logger.debug("[UNILAB] PropertyConnection.__target_specifier_changed() called")
    ...
    def __set_target_from_source(self, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PropertyConnection.__set_target_from_source() called")
    ...
    def __set_source_from_target(self, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PropertyConnection.__set_source_from_target() called")
        assert not self._closed
        if not self.__suppress:
            self.__suppress = True
            if self.__binding:
