...
Original: pycqed/measurement/waveform_control/pulsar.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Pulsar")
...
class Pulsar(Instrument):
    ...
    def __init__(self, name='Pulsar', default_AWG=None, master_AWG=None):
        print("[UNILAB] Pulsar.__init__() called", flush=True)
        super().__init__(name)
    ...
    def AWG_obj(self, **kw):
        _unilab_logger.debug("[UNILAB] Pulsar.define_channel() called")
        """
    ...
    def clock(self, channel):
        _unilab_logger.debug("[UNILAB] Pulsar.clock() called")
        """
    ...
    def channel_opt(self, name, option, value=None):
        _unilab_logger.debug("[UNILAB] Pulsar.channel_opt() called")
        """
    ...
    def used_AWGs(self):
        _unilab_logger.debug("[UNILAB] Pulsar.used_AWGs() called")
        """
        Returns:
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] Pulsar.start() called")
        """
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] Pulsar.stop() called")
        """
