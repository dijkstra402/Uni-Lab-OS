...
Original: epicsapps/pvlogger/logfile.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PVLogFolder")
...
from epicsapps.utils.textfile import read_textfile

from epicsapps.pvlogger.pvlogger import TIMESTAMP_FILE, motor_fields
...
class PVLogFolder:
    ...
    def __init__(self, folder, datadir='', **kws):
        print("[UNILAB] PVLogFolder.__init__() called", flush=True)
    ...
    def __repr__(self):
        _unilab_logger.debug("[UNILAB] PVLogFolder.__repr__() called")
        return f"PVLogFolder('{self.fullpath}')"

    def read_folder(self):
        _unilab_logger.debug("[UNILAB] PVLogFolder.read_folder() called")
    ...
    def _logfiles_sizeorder(self, reverse=False):
        _unilab_logger.debug("[UNILAB] PVLogFolder._logfiles_sizeorder() called")
    ...
    def read_all_logs_text(self, verbose=False):
        _unilab_logger.debug("[UNILAB] PVLogFolder.read_all_logs_text() called")
    ...
    def parse_logfiles(self, nproc=4, nmax=None, verbose=False):
        _unilab_logger.debug("[UNILAB] PVLogFolder.parse_logfiles() called")
        ...
        def start_next_process(pvlist):
            _unilab_logger.debug("[UNILAB] PVLogFolder.start_next_process() called")
    ...
    def reset_new_logfiles(self, parse_data=False):
        _unilab_logger.debug("[UNILAB] PVLogFolder.reset_new_logfiles() called")
    ...
    def read_logfile(self, pvname):
        _unilab_logger.debug("[UNILAB] PVLogFolder.read_logfile() called")
    ...
    def read_motor_events(self, motorname):
        _unilab_logger.debug("[UNILAB] PVLogFolder.read_motor_events() called")
