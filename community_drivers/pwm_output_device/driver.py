...
Original: gpiozero/output_devices.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PWMOutputDevice")
...
class PWMOutputDevice(OutputDevice):
    ...
    def close(self):
        print("[UNILAB] PWMOutputDevice.__init__() called", flush=True)
        try:
            self._stop_blink()
        except AttributeError:
            pass
    ...
    def _state_to_value(self, state):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice._state_to_value() called")
        return float(state if self.active_high else 1 - state)

    def _value_to_state(self, value):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice._value_to_state() called")
        return float(value if self.active_high else 1 - value)

    def _write(self, value):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice._write() called")
        if not 0 <= value <= 1:
    ...
    @property
    def value(self):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice.value() called")
        """
    ...
    def on(self):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice.on() called")
        self._stop_blink()
        self._write(1)

    def off(self):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice.off() called")
        self._stop_blink()
        self._write(0)

    def toggle(self):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice.toggle() called")
        """
    ...
    @property
    def is_active(self):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice.is_active() called")
        """
    ...
    @property
    def frequency(self):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice.frequency() called")
        """
    ...
    def pulse(self, fade_in_time=1, fade_out_time=1, n=None, background=True):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice.blink() called")
        """
    ...
    def _stop_blink(self):
        _unilab_logger.debug("[UNILAB] PWMOutputDevice._stop_blink() called")
        if self._controller:
            self._controller._stop_blink(self)
            self._controller = None
