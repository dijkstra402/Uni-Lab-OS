...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PWMSteering")
...
class PWMSteering:
    ...
    def __init__(self, controller, left_pulse, right_pulse):
        print("[UNILAB] PWMSteering.__init__() called", flush=True)
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] PWMSteering.update() called")
        while self.running:
            self.controller.set_pulse(self.pulse)

    def run_threaded(self, angle):
        _unilab_logger.debug("[UNILAB] PWMSteering.run_threaded() called")
    ...
    def run(self, angle):
        _unilab_logger.debug("[UNILAB] PWMSteering.run() called")
        self.run_threaded(angle)
        self.controller.set_pulse(self.pulse)

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] PWMSteering.shutdown() called")
