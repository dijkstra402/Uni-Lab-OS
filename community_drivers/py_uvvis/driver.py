...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.pyUVVIS")
...
class pyUVVIS(wx.Frame):
    ...
    def __init__(self, parent, title):
        print("[UNILAB] pyUVVIS.__init__() called", flush=True)
    ...
    # GUI creation stuff
    def createUI(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.createUI() called")
        self.createTB()
        self.createPlotWnd()
        self.Fit()

    def createTB(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.createTB() called")
        # create toolbar
    ...
    def createPlotWnd(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.createPlotWnd() called")
    ...
    def connectCamera(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.connectCamera() called")
    ...
    def connectUC480(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.connectUC480() called")
        self.cam = cam.uc480()
        self.cam.connect()
    ...
    def connectOO(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.connectOO() called")
    ...
    def camClose(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.camClose() called")
    ...
    def readCamera(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.readCamera() called")
        if self.activeCam == 'uc480':
    ...
    def camSupportsGain(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.camSupportsGain() called")
        if self.activeCam == 'uc480':
            return True
        return False

    def camSupportsExp(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.camSupportsExp() called")
        if self.activeCam in ['uc480', 'OO']:
            return True
        return False

    def camSetGain(self, g):
        _unilab_logger.debug("[UNILAB] pyUVVIS.camSetGain() called")
        if self.activeCam == 'uc480':
            self.cam.set_gain(g)

    def camSetExp(self, e):
        _unilab_logger.debug("[UNILAB] pyUVVIS.camSetExp() called")
        if self.activeCam == 'uc480':
    ...
    def getWlAxis(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.getWlAxis() called")
        # get wavelength axis
    ...
    def addLine(self, x, y, id=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.addLine() called")
    ...
    def refreshPlot(self):
        _unilab_logger.debug("[UNILAB] pyUVVIS.refreshPlot() called")
        if self.modeUVVIS:
    ...
    def OnQuit(self, event):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnQuit() called")
        self.updThread.Stop()
        time.sleep(0.5)
        self.camClose()
        self.Destroy()
    ...
    def OnTBSave(self, event):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBSave() called")
    ...
    def OnTBLoad(self, event):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBLoad() called")
        if self.running:
            rng = True
            self.OnTBStart()
        else:
    ...
    def OnTBDelete(self, event):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBDelete() called")
    ...
    def OnTBAvgInc(self, event=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBAvgInc() called")
    ...
    def OnTBAvgDec(self, event=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBAvgDec() called")
        if self.avg - self.avginc >= self.avgmin:
            self.avg = self.avg - self.avginc
            self.tbavg.SetLabel(str(self.avg))

    def OnTBGainInc(self, event=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBGainInc() called")
    ...
    def OnTBGainDec(self, event=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBGainDec() called")
        self.gain = max(self.gainmin, self.gain - self.gaininc)
        self.tbgain.SetLabel(str(self.gain))
        self.camSetGain(self.gain)

    def OnTBExpInc(self, event=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBExpInc() called")
    ...
    def OnTBRecord(self, event=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBRecord() called")
        if self.running:
            self.OnTBStart()
        self.recording = True
        self.OnTBStart()
    ...
    def OnTBMode(self, event):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBMode() called")
        if self.modeUVVIS:
    ...
    def OnTBAuto(self, event):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBAuto() called")
        if self.cam is None:
            return
    ...
    def OnTBDark(self, event):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnTBDark() called")
    ...
    def OnUpdate(self, event=None):
        _unilab_logger.debug("[UNILAB] pyUVVIS.OnUpdate() called")
