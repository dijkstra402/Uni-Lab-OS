...
Original: pylontech/pylontech_base.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PylontechRS485")
...
class PylontechRS485:
    ...
    def __init__(self, device='/dev/ttyUSB0', baud=9600):
        print("[UNILAB] PylontechRS485.__init__() called", flush=True)
    ...
    def verbose(self, level=0):
        _unilab_logger.debug("[UNILAB] PylontechRS485.verbose() called")
        self.verbose = level
        if level > 10:
    ...
    def receive(self, timeout=1):
        _unilab_logger.debug("[UNILAB] PylontechRS485.receive() called")
        """
    ...
    def get_chk_sum(data, size):
        _unilab_logger.debug("[UNILAB] PylontechRS485.get_chk_sum() called")
        sum = 0
    ...
    def send(self, data):
        _unilab_logger.debug("[UNILAB] PylontechRS485.send() called")
        """
    ...
    def clear_rx_buffer(self):
        _unilab_logger.debug("[UNILAB] PylontechRS485.clear_rx_buffer() called")
        """ clear pending characters from serial buffer. especially important for network adapters"""
        self.rs485.clear_rx_buffer()

    def reconnect(self):
        _unilab_logger.debug("[UNILAB] PylontechRS485.reconnect() called")
        """ force reconnect to serial port"""
        self.rs485.reconnect()

    def close(self):
        _unilab_logger.debug("[UNILAB] PylontechRS485.close() called")
        """ force close serial connection"""
        self.rs485.close()
