...
Original: pymepix/pymepix_connection.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PymepixConnection")
...
from pymepix.TPX4.tpx4controller import Timepix4Controller
...
from pymepix.timepix4device import Timepix4Device
...
class PymepixConnection(Logger):
    ...
    def data_thread(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.data_thread() called")
    ...
    def biasVoltage(self):
        print("[UNILAB] PymepixConnection.__init__() called", flush=True)
        """Bias voltage in volts"""
        return self._bias_voltage

    @biasVoltage.setter
    def biasVoltage(self, value):
        _unilab_logger.debug("[UNILAB] PymepixConnection.biasVoltage() called")
        self._bias_voltage = value
        self._controller.biasVoltage = value

    def poll(self, block=False):
        _unilab_logger.debug("[UNILAB] PymepixConnection.poll() called")
    ...
    def pollBufferLength(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.pollBufferLength() called")
    ...
    def dataCallback(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.dataCallback() called")
    ...
    def enablePolling(self, maxlen=100):
        _unilab_logger.debug("[UNILAB] PymepixConnection.enablePolling() called")
    ...
    def _pollCallback(self, data_type, data):
        _unilab_logger.debug("[UNILAB] PymepixConnection._pollCallback() called")
        self._poll_buffer.append((data_type, data))

    def _createTimepix(self, pipeline_class=PixelPipeline):
        _unilab_logger.debug("[UNILAB] PymepixConnection._createTimepix() called")
    ...
    def start_recording(self, path):
        _unilab_logger.debug("[UNILAB] PymepixConnection.start_recording() called")
    ...
    def stop_recording(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.stop_recording() called")
        self._timepix_devices[0].stop_recording()
        self._channel.send(ChannelDataType.COMMAND, Commands.STOP_RECORD)

    def start(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.start() called")
        """Starts acquisition"""
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.stop() called")
        """Stops acquisition"""
    ...
    def isAcquiring(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.isAcquiring() called")
        return self._running

    @property
    def numDevices(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.numDevices() called")
        return self._num_timepix

    @property
    def chanAddress(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.chanAddress() called")
    ...
    def __getitem__(self, key) -> TimepixDevice:
        _unilab_logger.debug("[UNILAB] PymepixConnection.__getitem__() called")
        return self._timepix_devices[key]

    def __len__(self):
        _unilab_logger.debug("[UNILAB] PymepixConnection.__len__() called")
        return len(self._timepix_devices)

    def getDevice(self, num) -> TimepixDevice:
        _unilab_logger.debug("[UNILAB] PymepixConnection.getDevice() called")
        return self._timepix_devices[num]

    def _timepix_device_class_factory(self, camera_generation):
        _unilab_logger.debug("[UNILAB] PymepixConnection._timepix_device_class_factory() called")
    ...
    def _timepix_controller_class_factory(self, camera_generation):
        _unilab_logger.debug("[UNILAB] PymepixConnection._timepix_controller_class_factory() called")
