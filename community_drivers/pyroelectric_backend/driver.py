...
Original: pica/keithley/k6517b/Pyroelectricity/Pyroelectric_K6517B_L350_GUI.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PyroelectricBackend")
...
class PyroelectricBackend:
    ...
    def __init__(self):
        print("[UNILAB] PyroelectricBackend.__init__() called", flush=True)
        self.params = {}
        self.keithley = None
        self.lakeshore = None
        if PYVISA_AVAILABLE:
    ...
    def initialize_instruments(self, parameters):
        _unilab_logger.debug("[UNILAB] PyroelectricBackend.initialize_instruments() called")
    ...
    def start_stabilization(self):
        _unilab_logger.debug("[UNILAB] PyroelectricBackend.start_stabilization() called")
    ...
    def start_ramp(self):
        _unilab_logger.debug("[UNILAB] PyroelectricBackend.start_ramp() called")
    ...
    def get_measurement(self):
        _unilab_logger.debug("[UNILAB] PyroelectricBackend.get_measurement() called")
    ...
    def close_instruments(self):
        _unilab_logger.debug("[UNILAB] PyroelectricBackend.close_instruments() called")
