...
Original: deprecated/pycqed/instrument_drivers/physical_instruments/QuTech_ControlBoxdriver.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.QuTech_ControlBox")
...
from deprecated.pycqed.instrument_drivers.physical_instruments._controlbox import defHeaders  # File containing bytestring commands
from deprecated.pycqed.instrument_drivers.physical_instruments._controlbox import codec as c  # must be below pyximport.install
...
class QuTech_ControlBox(VisaInstrument):
    ...
    def __init__(self, name, address, reset=False, run_tests=False, **kw):
        print("[UNILAB] QuTech_ControlBox.__init__() called", flush=True)
        t0 = time.time()
    ...
    def add_params(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.add_params() called")
    ...
    def init_params(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.init_params() called")
        self.add_params()
    ...
    def run_test_suite(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.run_test_suite() called")
        from importlib import reload  # Useful for testing
        from deprecated.pycqed.instrument_drivers.physical_instruments._controlbox import test_suite
        reload(test_suite)
    ...
    def get_all(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_all() called")
        for par in self.parameters:
            self[par].get()
        return self.snapshot()

    def upload_standard_weights(self, IF):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.upload_standard_weights() called")
        trace_length = 512
    ...
    def _do_set_measurement_timeout(self, val):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_measurement_timeout() called")
        '''
    ...
    def _do_get_measurement_timeout(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_measurement_timeout() called")
        return self._timeout

    def _do_get_firmware_version(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_firmware_version() called")
    ...
    def _do_get_sequencer_counters(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_sequencer_counters() called")
        '''
    ...
    def get_input_avg_results(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.decode_message() called")
        '''
    ...
    def get_integrated_avg_results(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_integrated_avg_results() called")
        '''
    ...
    def get_integration_log_results(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_integration_log_results() called")
        '''
        read the log of the master
    ...
    def get_qubit_state_log_results(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_qubit_state_log_results() called")
        '''
    ...
    def get_qubit_state_log_counters(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_qubit_state_log_counters() called")
        '''
    ...
    def send_stop_streaming(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.send_stop_streaming() called")
    ...
    def get_streaming_results(self, nr_samples=10000):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_streaming_results() called")
        succes = False
        t0 = time.time()
    ...
    def _get_awg_tape(self, awg_nr):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_awg_lookuptable() called")
        '''
    ...
    def _set_awg_tape(self, awg_nr, tape):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._set_awg_tape() called")
        '''
    ...
    def restart_awg_tape(self, awg_nr):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.restart_awg_tape() called")
        '''
    ...
    def enable_dac(self, awg_nr, dac_ch, enable):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.enable_dac() called")
        '''
    ...
    def set_dac_offset(self, awg_nr, dac_ch, offset):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_dac_offset() called")
        '''
    ...
    def get_dac_offset(self, awg_nr, dac_ch):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_dac_offset() called")
        '''
    ...
    def set_ecc_truthtable():
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_ecc_truthtable() called")
        '''
    ...
    def set_averaging_parameters(self, nr_samples, avg_size):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_averaging_parameters() called")
        '''
    ...
    def _do_set_nr_samples(self, nr_samples):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_nr_samples() called")
    ...
    def _do_get_nr_samples(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_nr_samples() called")
        return self._nr_samples

    def _do_get_nr_averages(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_nr_averages() called")
        return self._nr_averages

    def _do_set_nr_averages(self, nr_averages):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_nr_averages() called")
    ...
    def _set_lin_trans_coeffs(self, coefficients):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._set_lin_trans_coeffs() called")
        '''
    ...
    def _get_lin_trans_coeffs(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._get_lin_trans_coeffs() called")
        return self._lin_trans_coeffs

    def _do_set_log_length(self, length):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_log_length() called")
        '''
    ...
    def _do_get_log_length(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_log_length() called")
        return self._log_length

    def _do_set_demodulation_mode(self, demodulation_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_demodulation_mode() called")
    ...
    def _do_get_demodulation_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_demodulation_mode() called")
        return self._demodulation_mode[3:]

    def _do_set_acquisition_mode(self, acquisition_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_acquisition_mode() called")
    ...
    def _do_get_acquisition_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._set_master_controller_working_state() called")
        return self._acquisition_mode

    def _do_set_run_mode(self, run_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_run_mode() called")
        '''
    ...
    def _do_get_run_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_run_mode() called")
        return self._run_mode

    def _gen_awg_mode_set_func(self, awg_nr):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_awg_mode_set_func() called")
        def set_awg_mode_i(threshold):
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_awg_mode_i() called")
            return self._set_awg_mode(awg_nr, threshold)
        return set_awg_mode_i

    def _gen_awg_mode_get_func(self, awg_nr):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_awg_mode_get_func() called")
        def get_awg_mode_i():
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_awg_mode_i() called")
            return self._get_awg_mode(awg_nr)
        return get_awg_mode_i

    def _set_awg_mode(self, awg_nr, awg_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._set_awg_mode() called")
        '''
    ...
    def _get_awg_mode(self, awg_nr):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._get_awg_mode() called")
        return self._awg_mode[awg_nr][3:]

    def _do_set_adc_offset(self, adc_offset):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_adc_offset() called")
        '''
    ...
    def _do_get_adc_offset(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_adc_offset() called")
        return self._adc_offset

    def _do_set_signal_delay(self, delay):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_signal_delay() called")
        '''
    ...
    def _do_get_signal_delay(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_signal_delay() called")
        return self._signal_delay

    def _do_set_integration_length(self, length):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_integration_length() called")
        '''
    ...
    def _do_get_integration_length(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_integration_length() called")
        return self._integration_length

    def _gen_signal_threshold_set_func(self, line):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_signal_threshold_set_func() called")
        def set_sig_threshold_i(threshold):
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_sig_threshold_i() called")
            return self._set_signal_threshold(line, threshold)
        return set_sig_threshold_i

    def _gen_signal_threshold_get_func(self, line):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_signal_threshold_get_func() called")
        def get_sig_threshold_i():
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_sig_threshold_i() called")
            return self._get_signal_threshold(line)
        return get_sig_threshold_i

    def _set_signal_threshold(self, line, threshold):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._set_signal_threshold() called")
        '''
    ...
    def _get_signal_threshold(self, line):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._get_signal_threshold() called")
        return self._sig_thres[line]

    def _set_int_weights(self, line, weights):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._set_int_weights() called")
        '''
    ...
    def _get_int_weights(self, line):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._get_int_weights() called")
    ...
    def _read_raw(self, size):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._read_raw() called")
        '''
    ...
    def serial_read(self, timeout=5, read_all=False, read_N=0):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.serial_read() called")
        '''
    ...
    def serial_write(self, command, verify_execution=True):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.serial_write() called")
        '''
    ...
    def _wrap_ch_set_fun(self, function, channel):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._wrap_ch_set_fun() called")
        def channel_specific_function(value):
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.channel_specific_function() called")
            return function(channel, value)
        return channel_specific_function

    def _wrap_ch_get_fun(self, function, channel):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._wrap_ch_get_fun() called")
    ...
    def _print_waiting_char(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._print_waiting_char() called")
    ...
    def _do_set_tng_heartbeat_interval(self, tng_heartbeat_interval):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_heartbeat_interval() called")
        '''
    ...
    def _do_get_tng_heartbeat_interval(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_heartbeat_interval() called")
        return self.tng_heartbeat_interval

    def _do_set_tng_burst_heartbeat_interval(self, tng_burst_heartbeat_interval):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_burst_heartbeat_interval() called")
        '''
    ...
    def _do_get_tng_burst_heartbeat_interval(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_burst_heartbeat_interval() called")
        return self.tng_burst_heartbeat_interval

    def _do_set_tng_burst_heartbeat_n(self, tng_burst_heartbeat_n):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_burst_heartbeat_n() called")
        '''
    ...
    def _do_get_tng_burst_heartbeat_n(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_burst_heartbeat_n() called")
        return self.tng_burst_heartbeat_n

    def _do_set_tng_readout_delay(self, tng_readout_delay):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_readout_delay() called")
        '''
    ...
    def _do_get_tng_readout_delay(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_readout_delay() called")
    ...
    def _do_get_tng_second_pre_rotation_delay(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_second_pre_rotation_delay() called")
        return self.tng_second_pre_rotation_delay

    def _do_set_tng_calibration_mode(self, tng_calibration_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_calibration_mode() called")
        '''
    ...
    def _do_get_tng_calibration_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_calibration_mode() called")
        return self.tng_calibration_mode

    def _do_set_tng_awg_mask(self, tng_awg_mask):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_awg_mask() called")
        '''
    ...
    def _do_get_tng_awg_mask(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_awg_mask() called")
        return self.tng_awg_mask

    def _do_set_tng_readout_pulse_length(self, tng_readout_pulse_length):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_readout_pulse_length() called")
        '''
    ...
    def _do_get_tng_readout_pulse_length(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_readout_pulse_length() called")
        return self.tng_readout_pulse_length

    def _do_set_tng_readout_wave_interval(self, tng_readout_wave_interval):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_readout_wave_interval() called")
        '''
    ...
    def _do_get_tng_readout_wave_interval(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_readout_wave_interval() called")
        return self.tng_readout_wave_interval

    def _do_set_tng_output_trigger_delay(self, tng_output_trigger_delay):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_output_trigger_delay() called")
        '''
    ...
    def _do_get_tng_output_trigger_delay(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_output_trigger_delay() called")
        return self.tng_output_trigger_delay

    def _do_set_tng_trigger_state(self, tng_trigger_state):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_trigger_state() called")
        '''
    ...
    def _do_get_tng_trigger_state(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_trigger_state() called")
        return self.tng_trigger_state

    def _do_set_tng_feedback_mode(self, tng_feedback_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_feedback_mode() called")
        '''
    ...
    def _do_get_tng_feedback_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_feedback_mode() called")
        return self.tng_feedback_mode

    def _do_set_tng_feedback_code(self, tng_feedback_code):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_feedback_code() called")
        '''
    ...
    def _do_get_tng_feedback_code(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_feedback_code() called")
        return self.tng_feedback_code

    def _do_set_tng_logging_mode(self, tng_logging_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_set_tng_logging_mode() called")
        '''
    ...
    def _do_get_tng_logging_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._do_get_tng_logging_mode() called")
        return self.tng_logging_mode

    def _set_touch_n_go_parameters(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._set_touch_n_go_parameters() called")
        '''
    ...
    def _gen_ch_set_func(self, fun, ch):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_ch_set_func() called")
        def set_func(val):
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_func() called")
            return fun(ch, val)
        return set_func

    def _gen_ch_get_func(self, fun, ch):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_ch_get_func() called")
        def get_func():
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_func() called")
            return fun(ch)
        return get_func

    #  Required because set and get funcs don't currently allow optional args
    def _gen_sub_ch_set_func(self, fun, ch, sub_ch):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_sub_ch_set_func() called")
        def set_func(val):
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_func() called")
    ...
    def _gen_sub_ch_get_func(self, fun, ch, sub_ch):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox._gen_sub_ch_get_func() called")
        def get_func():
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.get_func() called")
    ...
    def set_conditional_tape(self, awg_nr, tape_nr, tape):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_conditional_tape() called")
        '''
    ...
    def set_segmented_tape(self, awg_nr, tape):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.set_segmented_tape() called")
        '''
    ...
    def convert_to_signed(self, unsigned_number, bit_width):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.create_timing_tape_entry() called")
        '''
        ...
        '''
        def is_number(s):
            _unilab_logger.debug("[UNILAB] QuTech_ControlBox.is_number() called")
            try:
                float(s)
                return True
            except ValueError:
    ...
    def convert_arrary_to_signed(self, unsigned_array, bit_width):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox.convert_arrary_to_signed() called")
        '''
