...
Original: deprecated/pycqed/instrument_drivers/physical_instruments/QuTech_ControlBox_v3.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.QuTech_ControlBox_v3")
...
from deprecated.pycqed.instrument_drivers.physical_instruments._controlbox import Assembler
from deprecated.pycqed.instrument_drivers.physical_instruments import QuTech_ControlBoxdriver as qcb
from deprecated.pycqed.instrument_drivers.physical_instruments._controlbox import defHeaders_CBox_v3 as defHeaders
...
from deprecated.pycqed.instrument_drivers.physical_instruments._controlbox import codec as c
...
class QuTech_ControlBox_v3(qcb.QuTech_ControlBox):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] QuTech_ControlBox_v3.__init__() called", flush=True)
        super(QuTech_ControlBox_v3, self).__init__(*args, **kwargs)

    def add_params(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3.add_params() called")
    ...
    def init_params(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3.init_params() called")
        self.add_params()
    ...
    def run_test_suite(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3.run_test_suite() called")
        from importlib import reload  # Useful for testing
        from deprecated.pycqed.instrument_drivers.physical_instruments._controlbox import test_suite_v3 as test_suite
        reload(test_suite)
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3.start() called")
        self.core_state('active')
        self.run_mode('run')

    def stop(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3.stop() called")
        self.run_mode('idle')
        self.core_state('idle')

    def _do_get_firmware_version(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_firmware_version() called")
        v = self.get_master_controller_params()
        return v

    def _do_get_pulse_queue_state(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_pulse_queue_state() called")
        self.get_master_controller_params()
        return self._pulse_queue_state

    def _do_get_max_instruction_address(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_max_instruction_address() called")
        self.get_master_controller_params()
        return self._max_instruction_address

    def _do_get_uploaded_program_length(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_uploaded_program_length() called")
        return self._uploaded_program_length

    def get_master_controller_params(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3.get_master_controller_params() called")
    ...
    def _do_set_core_state(self, core_state):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_set_core_state() called")
    ...
    def _do_set_acquisition_mode(self, acquisition_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_set_acquisition_mode() called")
    ...
    def _do_set_trigger_source(self, trigger_source):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_set_trigger_source() called")
    ...
    def _do_set_demodulation_mode(self, demodulation_mode):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_set_demodulation_mode() called")
    ...
    def _get_instr_mem_size(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._get_instr_mem_size() called")
        return self._instr_mem_size

    def _do_get_core_state(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_core_state() called")
        return self._core_state[3:]

    def _do_get_trigger_source(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_trigger_source() called")
        return self._trigger_source[3:]

    def _do_get_acquisition_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_acquisition_mode() called")
        return self._acquisition_mode[3:]

    def _do_get_demodulation_mode(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._do_get_demodulation_mode() called")
        return self._demodulation_mode[3:]

    def _set_touch_n_go_parameters(self):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._set_touch_n_go_parameters() called")
        '''
    ...
    def load_instructions(self, asm_filename, PrintHex=False):
        _unilab_logger.debug("[UNILAB] QuTech_ControlBox_v3._set_master_controller_working_state() called")
        '''
