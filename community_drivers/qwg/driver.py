...
Original: pycqed/instrument_drivers/physical_instruments/QuTech/QWG.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.QWG")
...
# Vendored repo packages: pycqed, pycqed.instrument_drivers.library.Transport, pycqed.instrument_drivers.library.DIO
import sys as _sys
...
#        self.connect_message()
    ...
    def _add_awg_parameters(self):
        print("[UNILAB] QWG.__init__() called", flush=True)
    ...
    def _add_parameters(self):
        _unilab_logger.debug("[UNILAB] QWG._add_parameters() called")
    ...
    def _add_codeword_parameters(self, add_extra: bool = True):
        _unilab_logger.debug("[UNILAB] QWG._add_codeword_parameters() called")
        self.add_parameter(
...
#                    snapshot_exclude=True,
    ...
    def _add_dio_parameters(self):
        _unilab_logger.debug("[UNILAB] QWG._add_dio_parameters() called")
        self.add_parameter(
            'dio_mode',
            unit='',
    ...
    def _set_cw_waveform(self, ch: int, cw: int, waveform):
        _unilab_logger.debug("[UNILAB] QWG._set_cw_waveform() called")
    ...
    def _get_cw_waveform(self, ch: int, cw: int):
        _unilab_logger.debug("[UNILAB] QWG._get_cw_waveform() called")
        wf_name = 'wave_ch{}_cw{:03}'.format(ch, cw)
        return self.get_waveform_data_float(wf_name)

    def _set_matrix(self, chPair, mat):
        _unilab_logger.debug("[UNILAB] QWG._set_matrix() called")
        """
        Args:
    ...
    def _get_matrix(self, chPair):
        _unilab_logger.debug("[UNILAB] QWG._get_matrix() called")
        # function used internally for the parameters because of formatting
    ...
    def _set_codeword_protocol(self, protocol_name):
        _unilab_logger.debug("[UNILAB] QWG._set_codeword_protocol() called")
        """
        Args:
    ...
    def _get_codeword_protocol(self):
        _unilab_logger.debug("[UNILAB] QWG._get_codeword_protocol() called")
        channels_bit_maps = []
    ...
    def _set_bit_map(self, ch: int, bit_map: List[int]):
        _unilab_logger.debug("[UNILAB] QWG._set_bit_map() called")
        """
...
class QWGMultiDevices(DIO.CalInterface):
    ...
    def dio_calibration(cc, qwgs: List[QWG], verbose: bool = False):
        _unilab_logger.debug("[UNILAB] QWG.dio_calibration() called")
    ...
    def calibrate_dio_protocol(self, dio_mask: int, expected_sequence: List, port: int=0):
        _unilab_logger.debug("[UNILAB] QWG.calibrate_dio_protocol() called")
        """
    ...
    def output_dio_calibration_data(self, dio_mode: str, port: int=0) -> Tuple[int, List]:
        _unilab_logger.debug("[UNILAB] QWG.output_dio_calibration_data() called")
