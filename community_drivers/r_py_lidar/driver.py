...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RPyLIDAR")
...
class RPyLIDAR:
    ...
    def __init__(self, port, baudrate, timeout, screenSize, drawRaysDefault, DEBUG):
        print("[UNILAB] RPyLIDAR.__init__() called", flush=True)
    ...
    #command to establish a connection between the RPyLIDAR sensor and the computer
    def connect(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.connect() called")
    ...
    #command to disconnect the RPyLIDAR sensor from the computer
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.disconnect() called")
        self.COM.close()
        pygame.quit()
    ...
    def add_checksum(self, the_bytes):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.add_checksum() called")
        checksum = 0
        newCommand = ''
    ...
    def drawPoints(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.drawPoints() called")
    ...
    def getControlInputs(self, stopper):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.getControlInputs() called")
        funcStopper = stopper
    ...
    def get_device_info(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.get_device_info() called")
    ...
    def get_device_health(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.get_device_health() called")
        #self.COM.reset_input_buffer()
    ...
    def get_sample_rate(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.get_sample_rate() called")
        #self.COM.reset_input_buffer()
    ...
    def start_standard_scan(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.start_standard_scan() called")
    ...
    def calcAndAddPoints(self,dist1,dist2,delta1,delta2,previousAngle,refAngle,txtOutput):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.calcAndAddPoints() called")
    ...
    def readCabin1or3(self, data):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.readCabin1or3() called")
        distP2 = (data >> 2)
        deltaP1 = ((data & 1) << 4)
    ...
    def readCabin2or4(self, data):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.readCabin2or4() called")
        distP1 = (data << 6)   
        return distP1
    
    def readCabin5(self, data):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.readCabin5() called")
        delta2P2 = (data >> 4)
        delta1P2 = (data & 15)
        return delta1P2, delta2P2
    
    def calcDist(self, distP1, distP2):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.calcDist() called")
        return (float(distP1 + distP2) / 1000.0)    #distance in meters
        
    def calcDelta(self, deltaP1, deltaP2, deltaSign):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.calcDelta() called")
    ...
    def start_express_scan(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.start_express_scan() called")
        self.startTime = time.time()
        self.lastLeftClickTime = self.startTime
        self.lastRightClickTime = self.startTime
        self.lastMidClickTime = self.startTime
    ...
    def start_motor_max(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.start_motor_max() called")
    ...
    def start_motor_34(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.start_motor_34() called")
    ...
    def start_motor_half(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.start_motor_half() called")
    ...
    def start_motor_14(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.start_motor_14() called")
    ...
    def start_motor_slow(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.start_motor_slow() called")
    ...
    def stop_motor(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.stop_motor() called")
    ...
    def stop_scan(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.stop_scan() called")
    ...
    def reset(self):
        _unilab_logger.debug("[UNILAB] RPyLIDAR.reset() called")
...
# Example program using RPyLIDAR class object
if __name__ == "__main__":
    try:
                           #Serial Port  , Baud Rate, Timeout, Screen Size, Draw Rays, Debug Mode                           
        #sensor = RPyLIDAR('/dev/ttyUSB0',    256000,       1,         700,      True,       True)   # LINUX
        #sensor = RPyLIDAR('/dev/cu.SLAB_USBtoUART',    256000,       1,         700,      True,       True)   # MAC
        sensor = RPyLIDAR('COM2',    256000,       1,         700,      True,       True)   # WINDOWS
        sensor.connect()
        sensor.stop_scan()
        sensor.stop_motor()
