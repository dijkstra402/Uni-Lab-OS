...
Original: pymepix/processing/rawtodisk.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Raw2Disk")
...
class Raw2Disk(ProcessLogger):
    ...
    def __init__(self, context=None):
        print("[UNILAB] Raw2Disk.__init__() called", flush=True)
    ...
    def _run_filewriter_thr(self, sock_addr, context=None):
        _unilab_logger.debug("[UNILAB] Raw2Disk._run_filewriter_thr() called")
        """
    ...
    def open_file(self, socket, filename):
        _unilab_logger.debug("[UNILAB] Raw2Disk.open_file() called")
        """
    ...
    def close(self, socket):
        _unilab_logger.debug("[UNILAB] Raw2Disk.close() called")
        """
    ...
    def write(self, data):
        _unilab_logger.debug("[UNILAB] Raw2Disk.write() called")
        """
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] Raw2Disk.__del__() called")
