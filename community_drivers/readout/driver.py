...
Original: src/zhinst/qcodes/driver/devices/shfqa.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Readout")
...
class Readout(ZINode):
    ...
    def __init__(self, parent, tk_object, snapshot_cache=None, zi_node=None):
        print("[UNILAB] Readout.__init__() called", flush=True)
        ZINode.__init__(
    ...
    def configure_result_logger(
        ...
        *,
        ...
        _unilab_logger.debug("[UNILAB] Readout.configure_result_logger() called")
    ...
    def wait_done(self, *, timeout: float = 10, sleep_time: float = 0.05) -> None:
        _unilab_logger.debug("[UNILAB] Readout.wait_done() called")
    ...
    def read(self, *, timeout: float = 10) -> np.array:
        _unilab_logger.debug("[UNILAB] Readout.read() called")
    ...
    def write_integration_weights(
        ...
        *,
        ...
        _unilab_logger.debug("[UNILAB] Readout.write_integration_weights() called")
    ...
    def read_integration_weights(self, slots: List[int] = None) -> Waveforms:
        _unilab_logger.debug("[UNILAB] Readout.read_integration_weights() called")
