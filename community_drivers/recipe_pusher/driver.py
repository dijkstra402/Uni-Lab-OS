...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RecipePusher")
...
class RecipePusher(object):
    def __init__(self, recipe=None, recipeURI=None, output_dir = None):
        print("[UNILAB] RecipePusher.__init__() called", flush=True)
    ...
    @property
    def _taskTemplate(self):
        _unilab_logger.debug("[UNILAB] RecipePusher._taskTemplate() called")
    ...
    def fileTasksForInputs(self, **kwargs):
        _unilab_logger.debug("[UNILAB] RecipePusher.fileTasksForInputs() called")
        from PYME.IO import clusterIO
