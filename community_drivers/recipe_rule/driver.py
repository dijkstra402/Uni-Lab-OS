...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RecipeRule")
...
class RecipeRule(Rule):
    def __init__(self, recipe=None, recipeURI=None, output_dir=None, **kwargs):
        print("[UNILAB] RecipeRule.__init__() called", flush=True)
        """
    ...
    def _populate_rule(self, context, on_completion=None):
        _unilab_logger.debug("[UNILAB] RecipeRule._populate_rule() called")
        ...
        if not inputs:
            ...
            def _to_input_list(v):
                _unilab_logger.debug("[UNILAB] RecipeRule._to_input_list() called")
    ...
    def prepare(self):
        _unilab_logger.debug("[UNILAB] RecipeRule.prepare() called")
        return dict(max_tasks=self._num_recipe_tasks, release_start=0, release_end=self._num_recipe_tasks)
    
    def _task_template(self, context):
        _unilab_logger.debug("[UNILAB] RecipeRule._task_template() called")
