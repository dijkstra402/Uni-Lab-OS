...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RectangleTypeGraphic")
...
class RectangleTypeGraphic(Graphic):
    ...
    def __init__(self, type: str, title: typing.Optional[str]) -> None:
        print("[UNILAB] RectangleTypeGraphic.__init__() called", flush=True)
        super().__init__(type)
        self.title = title
    ...
    def bounds(self) -> Geometry.FloatRect:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.bounds() called")
    ...
    def rotation(self) -> float:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.rotation() called")
    ...
    def reset_position(self) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.reset_position() called")
        self.center = Geometry.FloatPoint(0.5, 0.5)

    def mime_data_dict(self) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.mime_data_dict() called")
    ...
    def read_from_mime_data(self, graphic_dict: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.read_from_mime_data() called")
    ...
    def __validate_bounds(self, value: Geometry.RectFloatTuple) -> Geometry.RectFloatTuple:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.__validate_bounds() called")
        # normalize
    ...
    def __bounds_changed(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.__bounds_changed() called")
    ...
    def center(self) -> Geometry.FloatPoint:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.center() called")
    ...
    def center_x(self) -> float:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.center_x() called")
    ...
    def center_y(self) -> float:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.center_y() called")
    ...
    def size(self) -> Geometry.FloatSize:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.size() called")
    ...
    def width(self) -> float:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.width() called")
    ...
    def height(self) -> float:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.height() called")
    ...
    def rotation_deg(self) -> float:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.rotation_deg() called")
    ...
    def _bounds(self, bounds: Geometry.FloatRectTuple) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic._bounds() called")
    ...
    def get_attributes(self) -> set[GraphicAttributeEnum]:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic._rotated_top_left() called")
        return {GraphicAttributeEnum.TWO_DIMENSIONAL}

    def get_mask_item(self) -> MaskItem:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.get_mask_item() called")
        return RectangleMaskItem(self.bounds, self.rotation)

    # test point hit
    def test(self, mapping: CoordinateMappingLike, ui_settings: UISettings.UISettings, p: Geometry.FloatPoint, move_only: bool) -> typing.Tuple[typing.Optional[str], bool]:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.test() called")
    ...
    def begin_drag(self) -> DragPartData:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.begin_drag() called")
        return (self.bounds, self.rotation)

    def end_drag(self, part_data: DragPartData) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.end_drag() called")
        pass

    # rectangle
    def adjust_part(self, mapping: CoordinateMappingLike, original: Geometry.FloatPoint, current: Geometry.FloatPoint, part: DragPartDataPlus, modifiers: ModifiersLike) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.adjust_part() called")
        raise NotImplementedError()

    def nudge(self, mapping: CoordinateMappingLike, delta: Geometry.FloatSize) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic.nudge() called")
    ...
    def _draw(self, ctx: DrawingContextLike, ui_settings: UISettings.UISettings, mapping: CoordinateMappingLike, is_selected: bool, is_focused: bool) -> None:
        _unilab_logger.debug("[UNILAB] RectangleTypeGraphic._draw() called")
        raise NotImplementedError()
