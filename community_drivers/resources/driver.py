...
Original: src/pyvenus/resources.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Resources")
...
# Vendored repo packages: pyvenus
import sys as _sys
...
class Resources:
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Resources.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    @classmethod
    def read_layout(cls, layout: str) -> None:
        _unilab_logger.debug("[UNILAB] Resources.read_layout() called")
    ...
    def read_submethods(cls, directory: str = "") -> None:
        _unilab_logger.debug("[UNILAB] Resources.read_liquid_classes() called")
    ...
    def __parse_hxcfg(cls, file):
        _unilab_logger.debug("[UNILAB] Resources.__parse_hxcfg() called")
        # read file content
        with open(file, 'r',) as f:
            content = f.read()
    ...
    def __get_comments(smt_definition, submethod):
        _unilab_logger.debug("[UNILAB] Resources.__get_comments() called")
    ...
    @staticmethod
    def __generate_init():
        _unilab_logger.debug("[UNILAB] Resources.__generate_init() called")
        # get output directory for resources
        output_directory = os.path.join(sys.path[0], "venus_resources")
    ...
    def __hex_converter(match):
        _unilab_logger.debug("[UNILAB] Resources.__hex_converter() called")
        return chr(int(match.group(1), 16))

    @staticmethod
    def __gen_valid_identifier(seq):
        _unilab_logger.debug("[UNILAB] Resources.__gen_valid_identifier() called")
        # get an iterator
        itr = iter(seq)
    ...
    def __sanitize_identifier(cls, name):
        _unilab_logger.debug("[UNILAB] Resources.__sanitize_identifier() called")
        return ''.join(cls.__gen_valid_identifier(name))

    
    @staticmethod
    def __convert_to_ascii(file):
        _unilab_logger.debug("[UNILAB] Resources.__convert_to_ascii() called")
