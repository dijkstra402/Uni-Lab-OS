...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RGBLED")
...
class RGBLED(SourceMixin, Device):
    ...
    def close(self):
        print("[UNILAB] RGBLED.__init__() called", flush=True)
    ...
    @property
    def closed(self):
        _unilab_logger.debug("[UNILAB] RGBLED.closed() called")
        return len(self._leds) == 0

    @property
    def value(self):
        _unilab_logger.debug("[UNILAB] RGBLED.value() called")
        """
    ...
    @property
    def is_active(self):
        _unilab_logger.debug("[UNILAB] RGBLED.is_active() called")
        """
    ...
    @property
    def color(self):
        _unilab_logger.debug("[UNILAB] RGBLED.color() called")
        """
    ...
    @property
    def red(self):
        _unilab_logger.debug("[UNILAB] RGBLED.red() called")
        """
    ...
    @property
    def green(self):
        _unilab_logger.debug("[UNILAB] RGBLED.green() called")
        """
    ...
    @property
    def blue(self):
        _unilab_logger.debug("[UNILAB] RGBLED.blue() called")
        """
    ...
    def on(self):
        _unilab_logger.debug("[UNILAB] RGBLED.on() called")
        """
    ...
    def off(self):
        _unilab_logger.debug("[UNILAB] RGBLED.off() called")
        """
    ...
    def toggle(self):
        _unilab_logger.debug("[UNILAB] RGBLED.toggle() called")
        """
        Toggle the state of the device. If the device is currently off
    ...
    def _stop_blink(self, led=None):
        _unilab_logger.debug("[UNILAB] RGBLED.blink() called")
