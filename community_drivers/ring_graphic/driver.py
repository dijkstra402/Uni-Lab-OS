...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RingGraphic")
...
class RingGraphic(Graphic):
    ...
    def __init__(self) -> None:
        print("[UNILAB] RingGraphic.__init__() called", flush=True)
        super().__init__("ring-graphic")
        self.title = _("Band-Pass Graphic")

        def validate_angles(value: float) -> float:
            _unilab_logger.debug("[UNILAB] RingGraphic.validate_angles() called")
    ...
    def radius_1(self) -> float:
        _unilab_logger.debug("[UNILAB] RingGraphic.radius_1() called")
    ...
    def radius_2(self) -> float:
        _unilab_logger.debug("[UNILAB] RingGraphic.radius_2() called")
    ...
    @property
    def mode(self) -> str:
        _unilab_logger.debug("[UNILAB] RingGraphic.mode() called")
    ...
    def mime_data_dict(self) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] RingGraphic.mime_data_dict() called")
        d = super().mime_data_dict()
    ...
    def read_from_mime_data(self, graphic_dict: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] RingGraphic.read_from_mime_data() called")
        super().read_from_mime_data(graphic_dict)
    ...
    def get_attributes(self) -> set[GraphicAttributeEnum]:
        _unilab_logger.debug("[UNILAB] RingGraphic.get_attributes() called")
        return {GraphicAttributeEnum.TWO_DIMENSIONAL, GraphicAttributeEnum.FOURIER_MASK}

    @property
    def used_role(self) -> typing.Optional[str]:
        _unilab_logger.debug("[UNILAB] RingGraphic.used_role() called")
        return "fourier_mask"

    # test is required for Graphic interface
    def test(self, mapping: CoordinateMappingLike, ui_settings: UISettings.UISettings, p: Geometry.FloatPoint, move_only: bool) -> typing.Tuple[typing.Optional[str], bool]:
        _unilab_logger.debug("[UNILAB] RingGraphic.test() called")
        # first convert to widget coordinates since test distances
        # are specified in widget coordinates
    ...
    def begin_drag(self) -> DragPartData:
        _unilab_logger.debug("[UNILAB] RingGraphic.begin_drag() called")
        return self.radius_1, self.radius_2

    def end_drag(self, part_data: DragPartData) -> None:
        _unilab_logger.debug("[UNILAB] RingGraphic.end_drag() called")
        pass

    def adjust_part(self, mapping: CoordinateMappingLike, original: Geometry.FloatPoint, current: Geometry.FloatPoint, part: DragPartDataPlus, modifiers: ModifiersLike) -> None:
        _unilab_logger.debug("[UNILAB] RingGraphic.adjust_part() called")
        if self.is_shape_locked:
            return
    ...
    def get_region(self) -> RingRegion:
        _unilab_logger.debug("[UNILAB] RingGraphic.get_region() called")
        return RingRegion(self.mode, self.radius_1, self.radius_2)

    def get_mask_item(self) -> MaskItem:
        _unilab_logger.debug("[UNILAB] RingGraphic.get_mask_item() called")
        return RingMaskItem(self.mode, self.radius_1, self.radius_2)

    def _draw(self, ctx: DrawingContextLike, ui_settings: UISettings.UISettings, mapping: CoordinateMappingLike, is_selected: bool, is_focused: bool) -> None:
        _unilab_logger.debug("[UNILAB] RingGraphic._draw() called")
        # origin is top left
        center = mapping.calibrated_origin_widget
    ...
    def label_position(self, mapping: CoordinateMappingLike, font_metrics: UISettings.FontMetrics, padding: float) -> typing.Optional[Geometry.FloatPoint]:
        _unilab_logger.debug("[UNILAB] RingGraphic.label_position() called")
        p1 = mapping.calibrated_origin_widget
        return Geometry.FloatPoint(y=p1.y, x=p1.x)
