...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RoboHATDriver")
...
class RoboHATDriver:
    ...
    def __init__(self, cfg, serial_port=None, debug=False):
        print("[UNILAB] RoboHATDriver.__init__() called", flush=True)
    ...
    def trim_out_of_bound_value(self, value):
        _unilab_logger.debug("[UNILAB] RoboHATDriver.trim_out_of_bound_value() called")
        if value > 1:
    ...
    def set_pulse(self, steering, throttle):
        _unilab_logger.debug("[UNILAB] RoboHATDriver.set_pulse() called")
        try:
    ...
    def is_valid_pwm_value(self, value):
        _unilab_logger.debug("[UNILAB] RoboHATDriver.is_valid_pwm_value() called")
        if 1000 <= value <= 2000:
            return True
        else:
            return False
    ...
    def write_pwm(self, steering, throttle):
        _unilab_logger.debug("[UNILAB] RoboHATDriver.write_pwm() called")
        self.pwm.write(b"%d, %d\r" % (steering, throttle))

    def run(self, steering, throttle):
        _unilab_logger.debug("[UNILAB] RoboHATDriver.run() called")
        self.set_pulse(steering, throttle)

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] RoboHATDriver.shutdown() called")
        try:
            self.serial.close()
        except:
            pass
