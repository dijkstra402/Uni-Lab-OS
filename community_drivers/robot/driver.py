...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Robot")
...
from mecademicpy._robot_base import _Robot, disconnect_on_exception_decorator, mecascript_global_function_decorator
...
class Robot(_Robot):
    ...
    def __init__(self):
        print("[UNILAB] Robot.__init__() called", flush=True)
        super().__init__()
    ...
    def RegisterCallbacks(self, callbacks: RobotCallbacks, run_callbacks_in_separate_thread: bool):
        _unilab_logger.debug("[UNILAB] Robot.RegisterCallbacks() called")
        """
    ...
    def RegisterCallback(self, callback_name: str, callback_method: Callable[[], None]):
        _unilab_logger.debug("[UNILAB] Robot.RegisterCallback() called")
        """
    ...
    def UnregisterCallbacks(self):
        _unilab_logger.debug("[UNILAB] Robot.UnregisterCallbacks() called")
        """
    ...
    def UnregisterCallback(self, callback_name: str):
        _unilab_logger.debug("[UNILAB] Robot.UnregisterCallback() called")
        """
    ...
    def RunCallbacks(self):
        _unilab_logger.debug("[UNILAB] Robot.RunCallbacks() called")
        """
    ...
    def Disconnect(self):
        _unilab_logger.debug("[UNILAB] Robot.Connect() called")
        """
    ...
    def IsConnected(self) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.IsConnected() called")
        """
    ...
    def IsControlling(self) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.IsControlling() called")
        """
    ...
    def IsSynchronousMode(self) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.IsSynchronousMode() called")
        """
    ...
    def IsAllowedToMove(self) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.IsAllowedToMove() called")
        """
    ...
    def SetSynchronousMode(self, sync_mode: bool = True):
        _unilab_logger.debug("[UNILAB] Robot.SetSynchronousMode() called")
        """
    ...
    def Sync(self):
        _unilab_logger.debug("[UNILAB] Robot.Sync() called")
        """ Deprecated, use ``SyncCmdQueue`` instead """
        self._send_sync_command(command=None)

    @mecascript_global_function_decorator
    def SyncCmdQueue(self):
        _unilab_logger.debug("[UNILAB] Robot.SyncCmdQueue() called")
        """
    ...
    def ConnectionWatchdog(self, timeout: float, message: Optional[str] = None):
        _unilab_logger.debug("[UNILAB] Robot.ConnectionWatchdog() called")
        """
    ...
    def AutoConnectionWatchdog(self, enable: bool, timeout: float = 0, message: Optional[str] = None):
        _unilab_logger.debug("[UNILAB] Robot.AutoConnectionWatchdog() called")
        """
    ...
    def ActivateRobot(self):
        _unilab_logger.debug("[UNILAB] Robot.ActivateRobot() called")
        """
        Activate the robot.
    ...
    def DeactivateRobot(self):
        _unilab_logger.debug("[UNILAB] Robot.DeactivateRobot() called")
        """
    ...
    def RebootRobot(self):
        _unilab_logger.debug("[UNILAB] Robot.RebootRobot() called")
        """
        Reboot the robot.
    ...
    @disconnect_on_exception_decorator
    def Home(self):
        _unilab_logger.debug("[UNILAB] Robot.Home() called")
        """
        Home the robot.
    ...
    def ActivateAndHome(self):
        _unilab_logger.debug("[UNILAB] Robot.ActivateAndHome() called")
    ...
    def PauseMotion(self):
        _unilab_logger.debug("[UNILAB] Robot.PauseMotion() called")
        """
    ...
    def ResumeMotion(self):
        _unilab_logger.debug("[UNILAB] Robot.ResumeMotion() called")
        """
    ...
    def ClearMotion(self):
        _unilab_logger.debug("[UNILAB] Robot.ClearMotion() called")
        """
    ...
    def MoveJoints(self, joints: List[float]):
        _unilab_logger.debug("[UNILAB] Robot.MoveJoints() called")
        ...
    ...
    def MoveJointsRel(self, joints: List[float]):
        _unilab_logger.debug("[UNILAB] Robot.MoveJointsRel() called")
        ...
    ...
    def MoveJointsVel(self, joints: List[float]):
        _unilab_logger.debug("[UNILAB] Robot.MoveJointsVel() called")
        ...
    ...
    def MovePose(self, x: float, y: float, z: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.MovePose() called")
        ...
    ...
    def MoveJump(self, x: float, y: float, z: float, alpha: float, beta: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.MoveJump() called")
        ...
    ...
    def MoveLin(self, x: float, y: float, z: float, alpha: float, beta: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.MoveLin() called")
        ...
    ...
    def MoveLinRelTrf(self, x: float, y: float, z: float, alpha: float, beta: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.MoveLinRelTrf() called")
        ...
    ...
    def MoveLinRelWrf(self, x: float, y: float, z: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.MoveLinRelWrf() called")
        ...
    ...
    def MoveLinVelTrf(self, v_x: float, v_y: float, v_z: float, omega_x: float, omega_y: float, omega_z: float):
        _unilab_logger.debug("[UNILAB] Robot.MoveLinVelTrf() called")
        ...
    ...
    def MoveLinVelWrf(self, v_x: float, v_y: float, v_z: float, omega_x: float, omega_y: float, omega_z: float):
        _unilab_logger.debug("[UNILAB] Robot.MoveLinVelWrf() called")
        ...
    ...
    def SetConf(self, shoulder: int = None, elbow: int = None, wrist: int = None):
        _unilab_logger.debug("[UNILAB] Robot.SetConf() called")
        """
    ...
    def SetAutoConf(self, e: Union[int, bool]):
        _unilab_logger.debug("[UNILAB] Robot.SetAutoConf() called")
        """
    ...
    def SetConfTurn(self, n: int):
        _unilab_logger.debug("[UNILAB] Robot.SetConfTurn() called")
        """
    ...
    def SetAutoConfTurn(self, e: Union[int, bool]):
        _unilab_logger.debug("[UNILAB] Robot.SetAutoConfTurn() called")
        """
    ...
    def SetBlending(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetBlending() called")
        """
    ...
    def SetCartAcc(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetCartAcc() called")
        """
    ...
    def SetCartAngVel(self, w: float):
        _unilab_logger.debug("[UNILAB] Robot.SetCartAngVel() called")
        """
    ...
    def SetCartLinVel(self, v: float):
        _unilab_logger.debug("[UNILAB] Robot.SetCartLinVel() called")
        """
    ...
    def SetJointAcc(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetJointAcc() called")
        """
    ...
    def SetJointVel(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetJointVel() called")
        """
    ...
    def SetJointVelLimit(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetJointVelLimit() called")
        """
    ...
    def SetMoveMode(self, mode: MxMoveMode):
        _unilab_logger.debug("[UNILAB] Robot.SetMoveMode() called")
        """
    ...
    def SetMoveDurationCfg(self, severity: MxEventSeverity):
        _unilab_logger.debug("[UNILAB] Robot.SetMoveDurationCfg() called")
        ...
    ...
    def SetMoveDuration(self, t: float):
        _unilab_logger.debug("[UNILAB] Robot.SetMoveDuration() called")
        """
    ...
    def SetTrf(self, x: float, y: float, z: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.SetMoveJumpHeight() called")
        ...

    @mecascript_global_function_decorator
    @overload
    def SetTrf(self, x: float, y: float, z: float, alpha: float, beta: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.SetTrf() called")
        ...
    ...
    def SetWrf(self, x: float, y: float, z: float, alpha: float, beta: float, gamma: float):
        _unilab_logger.debug("[UNILAB] Robot.SetWrf() called")
        ...
    ...
    def ExpectExternalCheckpoint(self, n: int) -> InterruptableEvent:
        _unilab_logger.debug("[UNILAB] Robot.ExpectExternalCheckpoint() called")
        """
    ...
    def WaitGripperMoveCompletion(self, timeout: Optional[float] = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitGripperMoveCompletion() called")
        """
    ...
    def GripperOpen(self):
        _unilab_logger.debug("[UNILAB] Robot.GripperOpen() called")
        """
        Opens the gripper.
    ...
    def GripperClose(self):
        _unilab_logger.debug("[UNILAB] Robot.GripperClose() called")
        """
        Closes the gripper.
    ...
    def MoveGripper(self, target: Union[bool, float]):
        _unilab_logger.debug("[UNILAB] Robot.MoveGripper() called")
        """
    ...
    def SetGripperForce(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetGripperForce() called")
        """
    ...
    def SetGripperVel(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetGripperVel() called")
        """
    ...
    def SetGripperRange(self, gripper_range: List[float]):
        _unilab_logger.debug("[UNILAB] Robot.SetGripperRange() called")
        ...
    ...
    def SetValveState(self, state_list: List[Union[int, str, MxCmdValveState]]):
        _unilab_logger.debug("[UNILAB] Robot.SetValveState() called")
        ...
    ...
    @disconnect_on_exception_decorator
    def VacuumGrip(self):
        _unilab_logger.debug("[UNILAB] Robot.VacuumGrip() called")
        """
    ...
    def VacuumGrip_Immediate(self):
        _unilab_logger.debug("[UNILAB] Robot.VacuumGrip_Immediate() called")
        """
    ...
    def VacuumRelease(self):
        _unilab_logger.debug("[UNILAB] Robot.VacuumRelease() called")
        """
    ...
    def VacuumRelease_Immediate(self):
        _unilab_logger.debug("[UNILAB] Robot.VacuumRelease_Immediate() called")
        """
    ...
    def WaitHoldingPart(self, timeout: Optional[float] = None):
        _unilab_logger.debug("[UNILAB] Robot.VacuumPurge() called")
        """
    ...
    def WaitReleasedPart(self, timeout: Optional[float] = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitReleasedPart() called")
        """
        Waits for the gripper (``GripperOpen``, ``GripperClose``, ``MoveGripper``) or the suction cup
    ...
    def WaitPurgeDone(self, timeout: Optional[float] = None, wait_purge_started=True):
        _unilab_logger.debug("[UNILAB] Robot.WaitPurgeDone() called")
        """
    ...
    def SetVacuumThreshold(self, hold_threshold: float, release_threshold: float):
        _unilab_logger.debug("[UNILAB] Robot.SetVacuumThreshold() called")
        ...
    ...
    def SetVacuumThreshold_Immediate(self, hold_threshold: float, release_threshold: float):
        _unilab_logger.debug("[UNILAB] Robot.SetVacuumThreshold_Immediate() called")
        """
    ...
    def SetVacuumPurgeDuration(self, duration: float):
        _unilab_logger.debug("[UNILAB] Robot.SetVacuumPurgeDuration() called")
        """
    ...
    def SetVacuumPurgeDuration_Immediate(self, duration: float = MX_ROBOT_CFG_DEFAULT_VACUUM_PURGE_DURATION):
        _unilab_logger.debug("[UNILAB] Robot.SetVacuumPurgeDuration_Immediate() called")
        """
    ...
    def SetOutputState(self, bank_id: MxIoBankId, output_states: List[Union[int, str, MxDigitalIoState]]):
        _unilab_logger.debug("[UNILAB] Robot.SetOutputState() called")
        ...
    ...
    def SetOutputState_Immediate(self, bank_id: MxIoBankId, output_states: List[Union[int, str, MxDigitalIoState]]):
        _unilab_logger.debug("[UNILAB] Robot.SetOutputState_Immediate() called")
        ...
    ...
    def WaitForAnyCheckpoint(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitForAnyCheckpoint() called")
        """
    ...
    def WaitConnected(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitConnected() called")
        """
    ...
    def WaitDisconnected(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitDisconnected() called")
        """
    ...
    def WaitActivated(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitActivated() called")
        """
    ...
    def WaitDeactivated(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitDeactivated() called")
        """
    ...
    def WaitHomed(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitHomed() called")
        """
    ...
    def WaitSimActivated(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitSimActivated() called")
        """
    ...
    def WaitSimDeactivated(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitSimDeactivated() called")
        """
    ...
    def WaitExtToolSimActivated(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitExtToolSimActivated() called")
        """
    ...
    def WaitExtToolSimDeactivated(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitExtToolSimDeactivated() called")
        """
    ...
    def WaitIoSimEnabled(self, bank_id: MxIoBankId = MxIoBankId.MX_IO_BANK_ID_IO_MODULE, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitIoSimEnabled() called")
        """
    ...
    def WaitIoSimDisabled(self, bank_id: MxIoBankId = MxIoBankId.MX_IO_BANK_ID_IO_MODULE, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitIoSimDisabled() called")
        """
        Pauses program execution until the simulation mode for the MVK01 vacuum and I/O module is
        disabled.
    ...
    def IsDesiredOutputState(self, bank_id: MxIoBankId, *expected_states: Union[MxDigitalIoState, int, str]) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.IsDesiredOutputState() called")
        """
    ...
    def IsDesiredInputState(self, bank_id: MxIoBankId, *expected_states: Union[MxDigitalIoState, int, str]) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.WaitOutputState() called")
        """
    ...
    def WaitRecoveryMode(self, activated: bool, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitInputState() called")
        """
    ...
    def WaitForError(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitForError() called")
        """
    ...
    def WaitErrorReset(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitErrorReset() called")
        """
    ...
    def WaitPStop2Reset(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitPStop2Reset() called")
    ...
    def WaitPStop2Resettable(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitPStop2Resettable() called")
    ...
    def WaitEStopReset(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitEStopReset() called")
        """Deprecated, use ``WaitSafetyStopReset`` instead."""
    ...
    def WaitEStopResettable(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitEStopResettable() called")
        """Deprecated, use ``WaitSafetyStopResettable`` instead."""
    ...
    def WaitSafetyStopReset(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitSafetyStopReset() called")
        """
    ...
    def WaitSafetyStopResettable(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitSafetyStopResettable() called")
        """
    ...
    def WaitSafetyStopStateChange(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitSafetyStopStateChange() called")
        """
    ...
    def WaitMotionResumed(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitMotionResumed() called")
        """
    ...
    def WaitMotionPaused(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitMotionPaused() called")
        """
    ...
    def WaitMotionCleared(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitMotionCleared() called")
        """
    ...
    def WaitEndOfCycle(self, timeout: float = None, *, force_cycle: bool = False):
        _unilab_logger.debug("[UNILAB] Robot.WaitEndOfCycle() called")
        """
    ...
    def WaitIdle(self, timeout: float = None, wait_rt_data: bool = False):
        _unilab_logger.debug("[UNILAB] Robot.WaitIdle() called")
        """
    ...
    @disconnect_on_exception_decorator
    def ResetError(self):
        _unilab_logger.debug("[UNILAB] Robot.ResetError() called")
        """
    ...
    def ResetPStop(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.ResetPStop() called")
        """
    ...
    def ResetPStop2(self, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.ResetPStop2() called")
        """
    ...
    def Delay(self, t: float):
        _unilab_logger.debug("[UNILAB] Robot.Delay() called")
        """
    ...
    def sleep(self, duration: float):
        _unilab_logger.debug("[UNILAB] Robot.sleep() called")
        """
    ...
    def StartProgram(self, name: int | str, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.SendCustomCommand() called")
        """
        Starts a program.
    ...
    def StartOfflineProgram(self, n: int | str, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.StartOfflineProgram() called")
    ...
    def StopProgram(self):
        _unilab_logger.debug("[UNILAB] Robot.StopProgram() called")
        """
    ...
    def ListFiles(self, timeout: float = None, as_dict: bool = False) -> Union[RobotFileList, dict]:
        _unilab_logger.debug("[UNILAB] Robot.ListFiles() called")
        """
    ...
    def ListPrograms(self, timeout: float = None) -> dict:
        _unilab_logger.debug("[UNILAB] Robot.ListPrograms() called")
    ...
    def LoadFile(self, name: str, timeout: float = None, as_dict: bool = False) -> Union[RobotFile, dict]:
        _unilab_logger.debug("[UNILAB] Robot.LoadFile() called")
        """
    ...
    def LoadProgram(self, name: str, timeout: float = None) -> dict:
        _unilab_logger.debug("[UNILAB] Robot.LoadProgram() called")
    ...
    def SaveProgram(self, name: str, program: str, timeout: float = None, allow_invalid=False, overwrite=False):
        _unilab_logger.debug("[UNILAB] Robot.SaveFile() called")
        """
    ...
    def DeleteFile(self, name: str, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.DeleteFile() called")
        """
    ...
    def DeleteProgram(self, name: str, timeout: float = None):
        _unilab_logger.debug("[UNILAB] Robot.DeleteProgram() called")
    ...
    def WaitMecaScriptEngineReady(self, *, expected_ready: bool = True, timeout: Optional[float] = None):
        _unilab_logger.debug("[UNILAB] Robot.SetLoadedPrograms() called")
        """
    ...
    def GetNetworkCfg(self, synchronous_update: bool = True, timeout: float = None) -> NetworkConfig:
        _unilab_logger.debug("[UNILAB] Robot.GetNetworkCfg() called")
        """
    ...
    def GetNetworkConfig(self, synchronous_update: bool = True, timeout: float = None) -> NetworkConfig:
        _unilab_logger.debug("[UNILAB] Robot.GetNetworkConfig() called")
    ...
    def SetNetworkOptions(self, n: Union[int, NetworkOptions]):
        _unilab_logger.debug("[UNILAB] Robot.SetNetworkOptions() called")
        """
    ...
    def GetNetworkOptions(self, *, timeout: float = None) -> NetworkOptions:
        _unilab_logger.debug("[UNILAB] Robot.GetNetworkOptions() called")
        """
    ...
    def GetRobotRtData(self, synchronous_update: bool = False, timeout: float = None) -> RobotRtData:
        _unilab_logger.debug("[UNILAB] Robot.GetRobotRtData() called")
        """
    ...
    def GetRtOutputState(
        ...
        _unilab_logger.debug("[UNILAB] Robot.GetRtAccelerometer() called")
        """
    ...
    def GetJoints(self, synchronous_update: bool = False, timeout: float = None) -> List[float]:
        _unilab_logger.debug("[UNILAB] Robot.GetRtInputState() called")
    ...
    def GetPose(self, synchronous_update: bool = False, timeout: float = None) -> List[float]:
        _unilab_logger.debug("[UNILAB] Robot.GetRtJointPos() called")
    ...
    def SetEob(self, e: Union[int, bool]):
        _unilab_logger.debug("[UNILAB] Robot.GetRtCartPos() called")
        """
    ...
    def SetEom(self, e: Union[int, bool]):
        _unilab_logger.debug("[UNILAB] Robot.SetEom() called")
        """
        Note: This command is legacy. It should normally not be necessary to use it.
    ...
    def SetMonitoringInterval(self, t: float):
        _unilab_logger.debug("[UNILAB] Robot.SetMonitoringInterval() called")
        """
    ...
    def SetRealTimeMonitoring(self, events: List[MxRobotStatusCode]) -> None:
        _unilab_logger.debug("[UNILAB] Robot.SetRealTimeMonitoring() called")
        ...
    ...
    def ForceRealTimeMonitoring(self):
        _unilab_logger.debug("[UNILAB] Robot.ForceRealTimeMonitoring() called")
        """
    ...
    def SetRtc(self, t: int):
        _unilab_logger.debug("[UNILAB] Robot.SetRtc() called")
        """
    ...
    def ActivateSim(self, mode: Optional[MxRobotSimulationMode] = None):
        _unilab_logger.debug("[UNILAB] Robot.ActivateSim() called")
        """
    ...
    def DeactivateSim(self):
        _unilab_logger.debug("[UNILAB] Robot.DeactivateSim() called")
        """
    ...
    def SetExtToolSim(self, sim_ext_tool_type: MxExtToolType):
        _unilab_logger.debug("[UNILAB] Robot.SetExtToolSim() called")
        """
    ...
    def SetIoSim(self, bank_id: MxIoBankId = MxIoBankId.MX_IO_BANK_ID_IO_MODULE, enable: bool = True):
        _unilab_logger.debug("[UNILAB] Robot.SetIoSim() called")
        """
    ...
    def SetRecoveryMode(self, activated: bool = True):
        _unilab_logger.debug("[UNILAB] Robot.SetRecoveryMode() called")
        """
    ...
    def SetTimeScaling(self, p: float):
        _unilab_logger.debug("[UNILAB] Robot.SetTimeScaling() called")
        """
    ...
    def SetJointLimitsCfg(self, e: bool = True):
        _unilab_logger.debug("[UNILAB] Robot.SetJointLimitsCfg() called")
        ...
    ...
    def SetJointLimits(self, n: int, lower_limit: float, upper_limit: float):
        _unilab_logger.debug("[UNILAB] Robot.SetJointLimits() called")
        """
    ...
    def SetWorkZoneLimits(self, x_min: float, y_min: float, z_min: float, x_max: float, y_max: float, z_max: float):
        _unilab_logger.debug("[UNILAB] Robot.SetWorkZoneCfg() called")
        ...
    ...
    def SetCollisionCfg(self, severity: MxEventSeverity = MxEventSeverity.MX_EVENT_SEVERITY_ERROR):
        _unilab_logger.debug("[UNILAB] Robot.SetWorkZoneLimits() called")
        ...
    ...
    def SetCollisionCfg(self, severity: Union[MxEventSeverity, CollisionCfg] = MxEventSeverity.MX_EVENT_SEVERITY_ERROR):
        _unilab_logger.debug("[UNILAB] Robot.SetCollisionCfg() called")
        """
    ...
    def SetToolSphere(self, x: float, y: float, z: float, r: float):
        _unilab_logger.debug("[UNILAB] Robot.SetToolSphere() called")
        ...
    ...
    def SetTorqueLimits(self, tau: List[float]):
        _unilab_logger.debug("[UNILAB] Robot.SetTorqueLimitsCfg() called")
        ...
    ...
    def SetTorqueLimits(self, *args: Union[List[float], float]):
        _unilab_logger.debug("[UNILAB] Robot.SetTorqueLimits() called")
        """
    ...
    def SetPayload(self, mass: float, x: float, y: float, z: float):
        _unilab_logger.debug("[UNILAB] Robot.SetPayload() called")
        ...
    ...
    def SetCalibrationCfg(self, *, enable: bool):
        _unilab_logger.debug("[UNILAB] Robot.SetCalibrationCfg() called")
        ...
    ...
    def SetPStop2Cfg(self, severity: MxEventSeverity = MxEventSeverity.MX_EVENT_SEVERITY_CLEAR_MOTION):
        _unilab_logger.debug("[UNILAB] Robot.SetPStop2Cfg() called")
        ...
    ...
    def SetMecaScriptCfg(self, cfg: MecaScriptCfg):
        _unilab_logger.debug("[UNILAB] Robot.SetSimModeCfg() called")
        """
    ...
    def SetRobotName(self, name: str):
        _unilab_logger.debug("[UNILAB] Robot.SetRobotName() called")
        """
    ...
    def ActivateBrakes(self, activated: bool = True):
        _unilab_logger.debug("[UNILAB] Robot.ActivateBrakes() called")
        """
    ...
    @disconnect_on_exception_decorator
    def BrakesOn(self):
        _unilab_logger.debug("[UNILAB] Robot.BrakesOn() called")
    ...
    @disconnect_on_exception_decorator
    def BrakesOff(self):
        _unilab_logger.debug("[UNILAB] Robot.BrakesOff() called")
    ...
    def WaitProgramDone(self, *, timeout: Optional[float] = None):
        _unilab_logger.debug("[UNILAB] Robot.WaitProgramDone() called")
        """
    ...
    def GetPowerSupplyInputs(self, synchronous_update: bool = False, timeout: float = None) -> RobotPowerSupplyInputs:
        _unilab_logger.debug("[UNILAB] Robot.GetPowerSupplyInputs() called")
        """
    ...
    def GetAutoConf(self, *, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetAutoConf() called")
        """
    ...
    def GetAutoConfTurn(self, *, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetAutoConfTurn() called")
        """
    ...
    def GetBlending(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetBlending() called")
        """
    ...
    def GetBrakesState(self, *, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetBrakesState() called")
        """
    ...
    def GetCalibrationCfg(self, *, timeout: float = None) -> CalibrationCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetCalibrationCfg() called")
        """
    ...
    def GetCartAcc(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetCartAcc() called")
        """
    ...
    def GetCartAngVel(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetCartAngVel() called")
        """
    ...
    def GetCartLinVel(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetCartLinVel() called")
        """
    ...
    def GetCheckpoint(self, *, timeout: float = None) -> int:
        _unilab_logger.debug("[UNILAB] Robot.GetCheckpoint() called")
        """
    ...
    def GetCheckpointDiscarded(self, *, timeout: float = None) -> int:
        _unilab_logger.debug("[UNILAB] Robot.GetCheckpointDiscarded() called")
        """
    ...
    def GetCmdPendingCount(self, *, timeout: float = None) -> int:
        _unilab_logger.debug("[UNILAB] Robot.GetCmdPendingCount() called")
        """
    ...
    def GetCollisionCfg(self, *, timeout: float = None) -> CollisionCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetCollisionCfg() called")
        """
    ...
    def GetCollisionStatus(self, *, synchronous_update: bool = False, timeout: float = None) -> SelfCollisionStatus:
        _unilab_logger.debug("[UNILAB] Robot.GetCollisionStatus() called")
        """
    ...
    def GetConf(self, *, timeout: float = None) -> Optional[List[int]]:
        _unilab_logger.debug("[UNILAB] Robot.GetConf() called")
        """
    ...
    def GetConfTurn(self, *, timeout: float = None) -> Optional[int]:
        _unilab_logger.debug("[UNILAB] Robot.GetConfTurn() called")
        """
    ...
    def GetEtherNetIpEnabled(self, *, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetEtherNetIpEnabled() called")
        """
    ...
    def GetExtToolFwVersion(self, *, timeout: float = None) -> RobotVersion:
        _unilab_logger.debug("[UNILAB] Robot.GetExtToolFwVersion() called")
        """
    ...
    def GetExtToolSim(self, *, timeout: float = None) -> MxExtToolType:
        _unilab_logger.debug("[UNILAB] Robot.GetExtToolSim() called")
        """
    ...
    def GetFwVersion(self, *, timeout: float = None) -> RobotVersion:
        _unilab_logger.debug("[UNILAB] Robot.GetFwVersion() called")
        """
    ...
    def GetGripperForce(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetGripperForce() called")
        """
    ...
    def GetGripperRange(self, *, timeout: float = None) -> Tuple[float, float]:
        _unilab_logger.debug("[UNILAB] Robot.GetGripperRange() called")
        """
    ...
    def GetGripperVel(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetGripperVel() called")
        """
    ...
    def GetIoSim(self, *, bank_id: MxIoBankId = MxIoBankId.MX_IO_BANK_ID_IO_MODULE, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetIoSim() called")
        """
    ...
    def GetJointAcc(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetJointAcc() called")
        """
    ...
    def GetJointLimits(self, n: int, *, effective: bool = True, timeout: float = None) -> Tuple[float, float]:
        _unilab_logger.debug("[UNILAB] Robot.GetJointLimits() called")
        """
    ...
    def GetJointLimitsCfg(self, *, timeout: float = None) -> JointLimitsCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetJointLimitsCfg() called")
        """
    ...
    def GetJointVel(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetJointVel() called")
        """
    ...
    def GetJointVelLimit(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetJointVelLimit() called")
        """
    ...
    def GetModelJointLimits(self, n: int, *, timeout: float = None) -> Tuple[float, float]:
        _unilab_logger.debug("[UNILAB] Robot.GetModelJointLimits() called")
        """
    ...
    def GetMonitoringInterval(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetMonitoringInterval() called")
        """
    ...
    def GetMoveDuration(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetMoveDuration() called")
        """
    ...
    def GetMoveDurationCfg(self, *, timeout: float = None) -> MoveDurationCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetMoveDurationCfg() called")
        """
    ...
    def GetMoveJumpApproachVel(self, *, timeout: float = None) -> MoveJumpApproachVel:
        _unilab_logger.debug("[UNILAB] Robot.GetMoveJumpApproachVel() called")
        """
    ...
    def GetMoveJumpHeight(self, *, timeout: float = None) -> MoveJumpHeight:
        _unilab_logger.debug("[UNILAB] Robot.GetMoveJumpHeight() called")
        """
    ...
    def GetMoveMode(self, *, timeout: float = None) -> MxMoveMode:
        _unilab_logger.debug("[UNILAB] Robot.GetMoveMode() called")
        """
    ...
    def GetOperationMode(self, *, timeout: float = None) -> MxRobotOperationMode:
        _unilab_logger.debug("[UNILAB] Robot.GetOperationMode() called")
        """
    ...
    def GetPStop2Cfg(self, *, timeout: float = None) -> Pstop2Cfg:
        _unilab_logger.debug("[UNILAB] Robot.GetPStop2Cfg() called")
        """
    ...
    def GetPayload(self, *, timeout: float = None) -> RobotPayload:
        _unilab_logger.debug("[UNILAB] Robot.GetPayload() called")
        """
    ...
    def GetProductType(self, *, timeout: float = None) -> str:
        _unilab_logger.debug("[UNILAB] Robot.GetProductType() called")
        """
    ...
    def GetProfinetEnabled(self, *, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetProfinetEnabled() called")
        """
    ...
    def GetRealTimeMonitoring(self, *, timeout: float = None) -> list[MxRobotStatusCode]:
        _unilab_logger.debug("[UNILAB] Robot.GetRealTimeMonitoring() called")
        """
    ...
    def GetRecoveryMode(self, *, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetRecoveryMode() called")
        """
    ...
    def GetRobotCalibrated(self, *, timeout: float = None) -> bool:
        _unilab_logger.debug("[UNILAB] Robot.GetRobotCalibrated() called")
        """
    ...
    def GetRobotInfo(self) -> RobotInfo:
        _unilab_logger.debug("[UNILAB] Robot.GetRobotInfo() called")
        """
    ...
    def GetRobotName(self, *, timeout: float = None) -> str:
        _unilab_logger.debug("[UNILAB] Robot.GetRobotName() called")
        """
    ...
    def GetRobotSerial(self, *, timeout: float = None) -> str:
        _unilab_logger.debug("[UNILAB] Robot.GetRobotSerial() called")
        """
    ...
    def GetRtc(self, *, timeout: float = None) -> int:
        _unilab_logger.debug("[UNILAB] Robot.GetRtc() called")
        """
    ...
    def GetStatusRobot(self, synchronous_update: bool = False, timeout: float = None) -> RobotStatus:
        _unilab_logger.debug("[UNILAB] Robot.GetStatusRobot() called")
        """
    ...
    def GetSafetyStatus(self, synchronous_update: bool = False, timeout: float = None) -> RobotSafetyStatus:
        _unilab_logger.debug("[UNILAB] Robot.GetSafetyStatus() called")
        """
    ...
    def GetLoadedPrograms(self, *, timeout: Optional[float] = None) -> LoadedPrograms:
        _unilab_logger.debug("[UNILAB] Robot.GetSafetyStopStatus() called")
        """
    ...
    def GetSimModeCfg(self, *, timeout: float = None) -> SimModeCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetProgramExecutionStatus() called")
        """
    ...
    def GetMecaScriptCfg(self, *, timeout: float = None) -> MecaScriptCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetMecaScriptCfg() called")
        """
    ...
    def GetTimeScaling(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetTimeScaling() called")
        """
    ...
    def GetToolSphere(self, *, timeout: float = None) -> ToolSphere:
        _unilab_logger.debug("[UNILAB] Robot.GetToolSphere() called")
        """
    ...
    def GetTorqueLimits(self, *, timeout: float = None) -> List[float]:
        _unilab_logger.debug("[UNILAB] Robot.GetTorqueLimits() called")
        """
    ...
    def GetTorqueLimitsCfg(self, *, timeout: float = None) -> TorqueLimitsCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetTorqueLimitsCfg() called")
        """
    ...
    def GetTorqueLimitsStatus(self, *, synchronous_update: bool = False, timeout: float = None) -> TorqueLimitsStatus:
        _unilab_logger.debug("[UNILAB] Robot.GetTorqueLimitsStatus() called")
        """
    ...
    def GetVacuumPurgeDuration(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetVacuumPurgeDuration() called")
        """
    ...
    def GetVacuumThreshold(self, *, timeout: float = None) -> VacuumThreshold:
        _unilab_logger.debug("[UNILAB] Robot.GetVacuumThreshold() called")
        """
    ...
    def GetVelTimeout(self, *, timeout: float = None) -> float:
        _unilab_logger.debug("[UNILAB] Robot.GetVelTimeout() called")
        """
    ...
    def GetWorkZoneCfg(self, *, timeout: float = None) -> WorkZoneCfg:
        _unilab_logger.debug("[UNILAB] Robot.GetWorkZoneCfg() called")
        """
    ...
    def GetWorkZoneLimits(self, *, timeout: float = None) -> WorkZoneLimits:
        _unilab_logger.debug("[UNILAB] Robot.GetWorkZoneLimits() called")
        """
    ...
    def GetWorkZoneStatus(self, *, synchronous_update: bool = False, timeout: float = None) -> WorkZoneStatus:
        _unilab_logger.debug("[UNILAB] Robot.GetWorkZoneStatus() called")
        """
    ...
    def LogTrace(self, trace: str, level: Optional[int] = None):
        _unilab_logger.debug("[UNILAB] Robot.LogTrace() called")
        """
    ...
    def LogUserCommands(self, enable: bool, *, show_motion_queue_progress: bool = False):
        _unilab_logger.debug("[UNILAB] Robot.LogUserCommands() called")
        """
    ...
    def SetSilentApiMode(self, enable: bool):
        _unilab_logger.debug("[UNILAB] Robot.SetSilentApiMode() called")
        """
    ...
    def EndLogging(self, keep_captured_trajectory: bool = False) -> str:
        _unilab_logger.debug("[UNILAB] Robot.StartLogging() called")
        """
    ...
    def GetCapturedTrajectory(self) -> Optional[RobotTrajectories]:
        _unilab_logger.debug("[UNILAB] Robot.GetCapturedTrajectory() called")
        """
    ...
    def GetCapturedTrajectoryPath(self) -> Optional[str]:
        _unilab_logger.debug("[UNILAB] Robot.GetCapturedTrajectoryPath() called")
        """
    ...
    def TcpDump(self, *, duration: float):
        _unilab_logger.debug("[UNILAB] Robot.FileLogger() called")
        """
    ...
    def TcpDumpStop(self):
        _unilab_logger.debug("[UNILAB] Robot.TcpDumpStop() called")
        """
    ...
    def UpdateRobot(self, firmware: Union[str, pathlib.Path], timeout: float = UPDATE_TIMEOUT):
        _unilab_logger.debug("[UNILAB] Robot.UpdateRobot() called")
        """
    ...
    def DeleteVariable(self, name: str, timeout: Optional[float] = None):
        _unilab_logger.debug("[UNILAB] Robot.CreateVariable() called")
        """
    ...
    def SetVariable(self, name: str, value: any, timeout: Optional[float] = 10):
        _unilab_logger.debug("[UNILAB] Robot.SetVariable() called")
        """
    ...
    def GetVariable(self, name: str) -> Optional[mecascript.RegisteredVariable]:
        _unilab_logger.debug("[UNILAB] Robot.GetVariable() called")
        """
    ...
    def GetVariableByCyclicId(self, cyclic_id: int) -> Optional[mecascript.RegisteredVariable]:
        _unilab_logger.debug("[UNILAB] Robot.GetVariableByCyclicId() called")
        """
    ...
    def ListVariables(self) -> List[str]:
        _unilab_logger.debug("[UNILAB] Robot.ListVariables() called")
        """
    ...
    def EnableEtherNetIp(self, enable: bool = True):
        _unilab_logger.debug("[UNILAB] Robot.EnableEtherNetIp() called")
        """
    ...
    def EnableProfinet(self, enable: bool = True):
        _unilab_logger.debug("[UNILAB] Robot.EnableProfinet() called")
        """
    ...
    def SwitchToEtherCAT(self, *, station_alias: Optional[int] = None):
        _unilab_logger.debug("[UNILAB] Robot.SwitchToEtherCAT() called")
        """
    ...
    def _get_registered_attr(self, attr_name: str) -> any:
        _unilab_logger.debug("[UNILAB] Robot._get_registered_attr() called")
        """
    ...
    def _set_registered_attr(self, attr_name: str, attr_val: any):
        _unilab_logger.debug("[UNILAB] Robot._set_registered_attr() called")
    ...
    def _del_registered_attr(self, attr_name: str):
        _unilab_logger.debug("[UNILAB] Robot._del_registered_attr() called")
...
class RobotSilentApiMode:
    ...
    def __enter__(self):
        _unilab_logger.debug("[UNILAB] Robot.__enter__() called")
        self._robot.SetSilentApiMode(True)
        return self._robot  # Optional: allows `as` usage if needed

    def __exit__(self, exc_type, exc_val, exc_tb):
        _unilab_logger.debug("[UNILAB] Robot.__exit__() called")
