...
Original: mecademicpy/robot_initializer.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RobotWithTools")
...
class RobotWithTools(Robot):
    ...
    def __init__(self):
        print("[UNILAB] RobotWithTools.__init__() called", flush=True)
        super().__init__()
    ...
    def HasIoModule(self):
        _unilab_logger.debug("[UNILAB] RobotWithTools.HasIoModule() called")
        """ Tells if the IO module is connected/detected """
        return self._io_module_status.present

    def ActivateRobot(self):
        _unilab_logger.debug("[UNILAB] RobotWithTools.ActivateRobot() called")
    ...
    def DeactivateRobot(self):
        _unilab_logger.debug("[UNILAB] RobotWithTools.DeactivateRobot() called")
    ...
    def _set_activated(self, activated: bool):
        _unilab_logger.debug("[UNILAB] RobotWithTools._set_activated() called")
    ...
    def ActivateAndHome(self):
        _unilab_logger.debug("[UNILAB] RobotWithTools.ActivateAndHome() called")
    ...
    def Disconnect(self):
        _unilab_logger.debug("[UNILAB] RobotWithTools.Disconnect() called")
    ...
    def _send_command(self, command: str, args: Optional[Union[str, list, tuple]] = None):
        _unilab_logger.debug("[UNILAB] RobotWithTools._send_command() called")
    ...
    def _set_robot_operation_mode(self, robot_operation_mode: MxRobotOperationMode):
        _unilab_logger.debug("[UNILAB] RobotWithTools._set_robot_operation_mode() called")
    ...
    def set_dirty_if_params_changed(self, motion_queue_params: MotionQueueParams):
        _unilab_logger.debug("[UNILAB] RobotWithTools.set_dirty_if_params_changed() called")
    ...
    def clear_dirty_flags(self, motion_queue_params: Optional[MotionQueueParams] = None) -> bool:
        _unilab_logger.debug("[UNILAB] RobotWithTools.clear_dirty_flags() called")
    ...
    def is_cmd_dirty(self, cmd_name: str) -> bool:
        _unilab_logger.debug("[UNILAB] RobotWithTools.is_cmd_dirty() called")
    ...
    def set_if_dirty(self, cmd_name: str, *args: Tuple[any]):
        _unilab_logger.debug("[UNILAB] RobotWithTools.set_if_dirty() called")
