...
Original: can/interfaces/robotell.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.robotellBus")
...
from can.exceptions import CanInterfaceNotImplementedError, CanOperationError
...
class robotellBus(BusABC):
    ...
    def __init__(
        ...
        print("[UNILAB] robotellBus.__init__() called", flush=True)
        """
        :param str channel:
    ...
    def set_bitrate(self, bitrate):
        _unilab_logger.debug("[UNILAB] robotellBus.set_bitrate() called")
        """
    ...
    def set_auto_retransmit(self, retrans_flag):
        _unilab_logger.debug("[UNILAB] robotellBus.set_auto_retransmit() called")
        """
    ...
    def set_auto_bus_management(self, auto_man):
        _unilab_logger.debug("[UNILAB] robotellBus.set_auto_bus_management() called")
        """
        :param bool auto_man:
    ...
    def set_serial_rate(self, serial_bps):
        _unilab_logger.debug("[UNILAB] robotellBus.set_serial_rate() called")
        """
    ...
    def set_hw_filter(self, filterid, enabled, msgid_value, msgid_mask, extended_msg):
        _unilab_logger.debug("[UNILAB] robotellBus.set_hw_filter() called")
        """
    ...
    def _getconfigsize(self, configid):
        _unilab_logger.debug("[UNILAB] robotellBus._getconfigsize() called")
    ...
    def _readconfig(self, configid, timeout):
        _unilab_logger.debug("[UNILAB] robotellBus._readconfig() called")
        self._writemessage(
            msgid=configid,
            msgdata=bytearray(8),
    ...
    def _writeconfig(self, configid, value, value2=0):
        _unilab_logger.debug("[UNILAB] robotellBus._writeconfig() called")
    ...
    def _readmessage(self, flushold, cfgchannel, timeout):
        _unilab_logger.debug("[UNILAB] robotellBus._readmessage() called")
    ...
    def _writemessage(self, msgid, msgdata, datalen, msgchan, msgformat, msgtype):
        _unilab_logger.debug("[UNILAB] robotellBus._writemessage() called")
    ...
    def flush(self):
        _unilab_logger.debug("[UNILAB] robotellBus.flush() called")
        del self._rxbuffer[:]
        del self._rxmsg[:]
        del self._configmsg[:]
        while self.serialPortOrig.in_waiting:
    ...
    def _recv_internal(self, timeout):
        _unilab_logger.debug("[UNILAB] robotellBus._recv_internal() called")
    ...
    def send(self, msg, timeout=None):
        _unilab_logger.debug("[UNILAB] robotellBus.send() called")
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] robotellBus.shutdown() called")
        super().shutdown()
        self.serialPortOrig.close()

    def fileno(self):
        _unilab_logger.debug("[UNILAB] robotellBus.fileno() called")
        try:
    ...
    def get_serial_number(self, timeout: int | None) -> str | None:
        _unilab_logger.debug("[UNILAB] robotellBus.get_serial_number() called")
