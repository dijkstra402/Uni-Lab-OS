...
Original: pica/keithley/k2400/RT_K2400_L350_T_Control_GUI.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RT_Backend_Active")
...
class RT_Backend_Active:
    ...
    def __init__(self):
        print("[UNILAB] RT_Backend_Active.__init__() called", flush=True)
    ...
    def connect(self, k2400_visa, ls_visa):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.connect() called")
        if not self.rm:
    ...
    def configure_instruments(self, current_ma, compliance_v):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.configure_instruments() called")
        # Lakeshore setup
    ...
    def get_temperature(self):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.get_temperature() called")
        if not self.lakeshore:
            return 0.0
        return float(self.lakeshore.query('KRDG? A').strip())

    def set_heater_range(self, output, heater_range):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.set_heater_range() called")
    ...
    def set_setpoint(self, output, temperature_k):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.set_setpoint() called")
        self.lakeshore.write(f'SETP {output},{temperature_k}')

    def start_ramp(self, end_temp, rate_k_min):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.start_ramp() called")
    ...
    def get_measurement(self):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.get_measurement() called")
        voltage = self.k2400.voltage
        temperature = float(self.lakeshore.query('KRDG? A').strip())
        return temperature, voltage

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] RT_Backend_Active.shutdown() called")
        if self.k2400:
            try:
                self.k2400.shutdown()
