...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RTOScope")
...
class RTOScope(RSScope):
    def __init__(self, host):
        print("[UNILAB] RTOScope.__init__() called", flush=True)
        super().__init__(host)

    def get_channel_data(self, chans):
        _unilab_logger.debug("[UNILAB] RTOScope.get_channel_data() called")
        self.instr.write('FORM:DATA ASCII')
