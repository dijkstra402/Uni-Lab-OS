...
Original: PYME/cluster/ruleserver.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RuleServer")
...
class RuleServer(object):
    ...
    def __init__(self):
        print("[UNILAB] RuleServer.__init__() called", flush=True)
    ...
    def _poll(self):
        _unilab_logger.debug("[UNILAB] RuleServer._poll() called")
        while self._do_poll:
            time.sleep(1)
    
    def _poll_rules(self):
        _unilab_logger.debug("[UNILAB] RuleServer._poll_rules() called")
        while self._do_poll:
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] RuleServer.stop() called")
        self._do_poll = False
    ...
    def task_advertisements(self):
        _unilab_logger.debug("[UNILAB] RuleServer.task_advertisements() called")
        """
    ...
    def bid_on_tasks(self, body=''):
        _unilab_logger.debug("[UNILAB] RuleServer.bid_on_tasks() called")
        """
    ...
    def add_integer_id_rule(self, max_tasks= 1e6, release_start=None, release_end = None, ruleID = None, timeout=3600, body=''):
        _unilab_logger.debug("[UNILAB] RuleServer.add_integer_id_rule() called")
        """
    ...
    def release_rule_tasks(self, ruleID, release_start, release_end, body=''):
        _unilab_logger.debug("[UNILAB] RuleServer.release_rule_tasks() called")
        """
    ...
    def inactivate_rule(self, ruleID):
        _unilab_logger.debug("[UNILAB] RuleServer.inactivate_rule() called")
        with self._rule_lock:
            # take out the lock in case the rule is still being added in another
    ...
    def handin(self, body):
        _unilab_logger.debug("[UNILAB] RuleServer.handin() called")
        """
    ...
    def mark_release_complete(self, ruleID, n_tasks=None):
        _unilab_logger.debug("[UNILAB] RuleServer.mark_release_complete() called")
        """
    ...
    def get_queues(self):
        _unilab_logger.debug("[UNILAB] RuleServer.get_queues() called")
        """
    ...
    def get_queue_info(self):
        _unilab_logger.debug("[UNILAB] RuleServer.get_queue_info() called")
        """
    ...
    def status(self):
        _unilab_logger.debug("[UNILAB] RuleServer.status() called")
