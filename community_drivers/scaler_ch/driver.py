...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ScalerCH")
...
class ScalerCH(Device):
    ...
    # The data
    def __init__(self, *args, **kwargs):
        print("[UNILAB] ScalerCH.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    ...
    def match_names(self):
        _unilab_logger.debug("[UNILAB] ScalerCH.match_names() called")
        for s in self.channels.component_names:
            getattr(self.channels, s).match_name()

    def select_channels(self, chan_names=None):
        _unilab_logger.debug("[UNILAB] ScalerCH.select_channels() called")
