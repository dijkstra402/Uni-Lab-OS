...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ScalerChannel")
...
class ScalerChannel(Device):
    ...
    def __init__(self, prefix, ch_num, **kwargs):
        print("[UNILAB] ScalerChannel.__init__() called", flush=True)
        self._ch_num = ch_num
    ...
    def match_name(self):
        _unilab_logger.debug("[UNILAB] ScalerChannel.match_name() called")
