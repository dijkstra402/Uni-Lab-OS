...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SDKWrapper")
...
# Vendored repo packages: pylinkam, pylinkam
import sys as _sys
...
class SDKWrapper:
    ...
    class Connection:
        ...
        def __init__(self, parent: SDKWrapper, handle: interface.CommsHandle):
            print("[UNILAB] SDKWrapper.__init__() called", flush=True)
        ...
        def __del__(self) -> None:
            _unilab_logger.debug("[UNILAB] SDKWrapper.__del__() called")
            self.close()

        def close(self) -> None:
            _unilab_logger.debug("[UNILAB] SDKWrapper.close() called")
        ...
        def enable_heater(self, enabled: bool) -> None:
            _unilab_logger.debug("[UNILAB] SDKWrapper.enable_heater() called")
        ...
        def enable_humidity(self, enabled: bool) -> None:
            _unilab_logger.debug("[UNILAB] SDKWrapper.enable_humidity() called")
        ...
        def get_controller_config(self) -> interface.ControllerConfig:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_controller_config() called")
        ...
        def get_controller_firmware_version(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_controller_firmware_version() called")
        ...
        def get_controller_hardware_version(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_controller_hardware_version() called")
        ...
        def get_controller_name(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_controller_name() called")
            """ Get controller hardware version.
        ...
        def get_controller_serial(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_controller_serial() called")
        ...
        def get_heater_details(self, channel: int = 0) -> interface.HeaterDetails:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_heater_details() called")
        ...
        def get_humidity_controller_sensor_name(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_humidity_controller_sensor_name() called")
        ...
        def get_humidity_controller_sensor_serial(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_humidity_controller_sensor_serial() called")
        ...
        def get_humidity_controller_sensor_hardware_version(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_humidity_controller_sensor_hardware_version() called")
        ...
        def get_humidity_details(self) -> interface.RHUnit:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_humidity_details() called")
        ...
        def get_program_state(self) -> interface.Running:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_program_state() called")
        ...
        def get_stage_firmware_version(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_stage_firmware_version() called")
        ...
        def get_stage_hardware_version(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_stage_hardware_version() called")
        ...
        def get_stage_name(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_stage_name() called")
            """ Get stage name.
        ...
        def get_stage_serial(self) -> str:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_stage_serial() called")
        ...
        def get_status(self) -> interface.ControllerStatus:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_status() called")
        ...
        def get_stage_config(self) -> interface.StageConfig:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_stage_config() called")
        ...
        def _get_value_msg(self, message: interface.Message, value_type: interface.StageValueType) -> typing.Any:
            _unilab_logger.debug("[UNILAB] SDKWrapper._get_value_msg() called")
        ...
        def get_value(self, value_type: interface.StageValueType) -> typing.Any:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_value() called")
        ...
        def get_value_range(self, value_type: interface.StageValueType) -> typing.Tuple[typing.Any, typing.Any]:
            _unilab_logger.debug("[UNILAB] SDKWrapper.get_value_range() called")
        ...
        def set_value(self, value_type: interface.StageValueType, n: typing.Any) -> bool:
            _unilab_logger.debug("[UNILAB] SDKWrapper.set_value() called")
            """
    ...
    def open(self) -> None:
        _unilab_logger.debug("[UNILAB] SDKWrapper.open() called")
    ...
    def sdk(self) -> ctypes.CDLL:
        _unilab_logger.debug("[UNILAB] SDKWrapper.sdk() called")
    ...
    def sdk_bin_name(self) -> str:
        _unilab_logger.debug("[UNILAB] SDKWrapper.sdk_bin_name() called")
        return self._sdk_bin_name

    @property
    def sdk_license_path(self) -> str:
        _unilab_logger.debug("[UNILAB] SDKWrapper.sdk_license_path() called")
        return self._sdk_license_path

    @property
    def sdk_log_path(self) -> str:
        _unilab_logger.debug("[UNILAB] SDKWrapper.sdk_log_path() called")
        return self._sdk_log_path

    @property
    def sdk_root_path(self) -> str:
        _unilab_logger.debug("[UNILAB] SDKWrapper.sdk_root_path() called")
    ...
    def set_logging_level(self, level: interface.LoggingLevel) -> None:
        _unilab_logger.debug("[UNILAB] SDKWrapper.process_message() called")
    ...
    def get_version(self) -> str:
        _unilab_logger.debug("[UNILAB] SDKWrapper.get_version() called")
        """ Get SDK version.
    ...
    def _connect_common(self, comm_info: interface.CommsInfo) -> Connection:
        _unilab_logger.debug("[UNILAB] SDKWrapper._connect_common() called")
    ...
    def connect_serial(self, port: str) -> Connection:
        _unilab_logger.debug("[UNILAB] SDKWrapper.connect_serial() called")
    ...
    def connect_usb(self, serial_number: typing.Optional[str] = None) -> Connection:
        _unilab_logger.debug("[UNILAB] SDKWrapper.connect_usb() called")
    ...
    def connect(self, *args, use_serial: bool = False, **kwargs) -> typing.Generator[Connection, None, None]:
        _unilab_logger.debug("[UNILAB] SDKWrapper.connect() called")
        if use_serial:
    ...
    def __enter__(self) -> SDKWrapper:
        _unilab_logger.debug("[UNILAB] SDKWrapper.__enter__() called")
        # Initialise SDK
        _ = self.sdk
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        _unilab_logger.debug("[UNILAB] SDKWrapper.__exit__() called")
        # Cleanup SDK
        self.close()
