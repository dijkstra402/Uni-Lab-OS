...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SDM630")
...
# Vendored repo packages: pv, grugbus, config, misc
import sys as _sys
...
class SDM630( grugbus.SlaveDevice ):
    def __init__( self, modbus, modbus_addr, key, name, mqtt, mqtt_topic ):
        print("[UNILAB] SDM630.__init__() called", flush=True)
    ...
    async def read_coroutine( self ):
        _unilab_logger.debug("[UNILAB] SDM630.read_coroutine() called")
        mqtt  = self.mqtt
