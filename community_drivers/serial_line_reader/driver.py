...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SerialLineReader")
...
class SerialLineReader:
    ...
    def __init__(self, serial:SerialPort, max_lines:int = 0, debug:bool = False):
        print("[UNILAB] SerialLineReader.__init__() called", flush=True)
        self.serial = serial
    ...
    def _open(self):
        _unilab_logger.debug("[UNILAB] SerialLineReader._open() called")
        with self.lock:
            self.serial.start().clear()

    def _close(self):
        _unilab_logger.debug("[UNILAB] SerialLineReader._close() called")
        with self.lock:
            self.serial.stop()

    def clear(self):
        _unilab_logger.debug("[UNILAB] SerialLineReader.clear() called")
        """
    ...
    def _readline(self) -> str:
        _unilab_logger.debug("[UNILAB] SerialLineReader._readline() called")
        """
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] SerialLineReader.run() called")
        if self.running:
            #
    ...
    def run_threaded(self):
        _unilab_logger.debug("[UNILAB] SerialLineReader.run_threaded() called")
        if not self.running:
            return []
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] SerialLineReader.update() called")
        #
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] SerialLineReader.shutdown() called")
        self.running = False
        self._close()
