...
Original: donkeycar/parts/serial_port.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SerialPort")
...
class SerialPort:
    ...
    def __init__(self, port:str='/dev/ttyACM0', baudrate:int=115200, bits:int=8, parity:str='N', stop_bits:int=1, charset:str='ascii', timeout:float=0.1):
        print("[UNILAB] SerialPort.__init__() called", flush=True)
        self.port = port
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] SerialPort.start() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] SerialPort.stop() called")
    ...
    def buffered(self) -> int:
        _unilab_logger.debug("[UNILAB] SerialPort.buffered() called")
        """
    ...
    def clear(self):
        _unilab_logger.debug("[UNILAB] SerialPort.clear() called")
        """
    ...
    def readBytes(self, count:int=0) -> Tuple[bool, bytes]:
        _unilab_logger.debug("[UNILAB] SerialPort.readBytes() called")
        """
    ...
    def read(self, count:int=0) -> Tuple[bool, str]:
        _unilab_logger.debug("[UNILAB] SerialPort.read() called")
        """
        if there are characters waiting, 
        then read them from the serial port
        bytes: number of bytes to read 
    ...
    def readln(self) -> Tuple[bool, str]:
        _unilab_logger.debug("[UNILAB] SerialPort.readln() called")
        """
        if there are characters waiting, 
    ...
    def writeBytes(self, value:bytes):
        _unilab_logger.debug("[UNILAB] SerialPort.writeBytes() called")
        """
    ...
    def write(self, value:str):
        _unilab_logger.debug("[UNILAB] SerialPort.write() called")
        """
    ...
    def writeln(self, value:str):
        _unilab_logger.debug("[UNILAB] SerialPort.writeln() called")
        """
