...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SHFScope")
...
class SHFScope(ZINode):
    ...
    def __init__(self, parent, tk_object, index, snapshot_cache=None, zi_node=None):
        print("[UNILAB] SHFScope.__init__() called", flush=True)
        ZINode.__init__(
            self,
            parent,
            f"shfscope_{index}",
    ...
    def run(
        ...
        _unilab_logger.debug("[UNILAB] SHFScope.run() called")
    ...
    def stop(self, *, timeout: float = 10, sleep_time: float = 0.005) -> None:
        _unilab_logger.debug("[UNILAB] SHFScope.stop() called")
    ...
    def wait_done(self, *, timeout: float = 10, sleep_time: float = 0.005) -> None:
        _unilab_logger.debug("[UNILAB] SHFScope.wait_done() called")
    ...
    def configure(
        ...
        *,
        ...
        _unilab_logger.debug("[UNILAB] SHFScope.configure() called")
    ...
    def read(self, *, timeout: float = 10) -> tuple:
        _unilab_logger.debug("[UNILAB] SHFScope.read() called")
    ...
    def available_trigger_inputs(self) -> List:
        _unilab_logger.debug("[UNILAB] SHFScope.available_trigger_inputs() called")
    ...
    def available_inputs(self) -> List:
        _unilab_logger.debug("[UNILAB] SHFScope.available_inputs() called")
