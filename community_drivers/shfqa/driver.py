...
Original: pycqed/instrument_drivers/physical_instruments/ZurichInstruments/shfqa.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SHFQA")
...
# Vendored repo packages: pycqed, pycqed, pycqed.instrument_drivers.library.DIO
import sys as _sys
...
class SHFQA(ZI_base_instrument, CalInterface):
    ...
    def __init__(
        ...
        **kw,
        ...
        print("[UNILAB] SHFQA.__init__() called", flush=True)
        t0 = time.time()
    ...
    def start(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.start() called")
        """
    ...
    def stop(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.stop() called")
        """
    ...
    def load_default_settings(self, upload_sequence: bool = True) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.load_default_settings() called")
        """
    ...
    def configure_awg_from_string(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.configure_awg_from_string() called")
        """
    ...
    def assure_ext_clock(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.assure_ext_clock() called")
        """
    ...
    def clock_freq(self) -> float:
        _unilab_logger.debug("[UNILAB] SHFQA.clock_freq() called")
        """
    ...
    def plot_dio_snapshot(self, bits=range(32)) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.plot_dio_snapshot() called")
    ...
    def acquisition(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.acquisition() called")
        """
    ...
    def acquisition_initialize(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.acquisition_initialize() called")
        """
    ...
    def acquisition_arm(self, single=True) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.acquisition_arm() called")
        """
    ...
    def acquisition_poll(self, samples, arm=True, acquisition_time=0.010) -> dict:
        _unilab_logger.debug("[UNILAB] SHFQA.acquisition_poll() called")
        """
    ...
    def acquisition_get(self, samples, arm=True, acquisition_time=0.010) -> dict:
        _unilab_logger.debug("[UNILAB] SHFQA.acquisition_get() called")
        """
    ...
    def acquisition_finalize(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.acquisition_finalize() called")
        """
    ...
    def _add_codeword_waveform_parameters(self, num_codewords) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._add_codeword_waveform_parameters() called")
        """
    ...
    def _csv_filename(self, codeword):
        _unilab_logger.debug("[UNILAB] SHFQA._csv_filename() called")
        return os.path.join(
    ...
    def _write_csv(self, codeword, waveform) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._write_csv() called")
    ...
    def _read_csv(self, codeword):
        _unilab_logger.debug("[UNILAB] SHFQA._read_csv() called")
    ...
    def _write_waveform(self, codeword: int) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._write_waveform() called")
        """
        ...
        def write_func(waveform):
            _unilab_logger.debug("[UNILAB] SHFQA.write_func() called")
    ...
    def _read_waveform(self, codeword):
        _unilab_logger.debug("[UNILAB] SHFQA._read_waveform() called")
        """
        ...
        def read_func():
            _unilab_logger.debug("[UNILAB] SHFQA.read_func() called")
    ...
    def _generator_slot(self, codeword: int) -> tuple:
        _unilab_logger.debug("[UNILAB] SHFQA._generator_slot() called")
        """
    ...
    def _add_extra_parameters(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._add_extra_parameters() called")
        """
    ...
    def _set_wait_dly(self, value: float) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_wait_dly() called")
        """
    ...
    def _get_wait_dly(self) -> float:
        _unilab_logger.debug("[UNILAB] SHFQA._get_wait_dly() called")
        """
    ...
    def _set_codewords(self, value) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_codewords() called")
        """
    ...
    def _get_codewords(self) -> list:
        _unilab_logger.debug("[UNILAB] SHFQA._get_codewords() called")
        """
    ...
    def _set_dio_calibration_delay(self, value) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_dio_calibration_delay() called")
        """
    ...
    def _get_dio_calibration_delay(self) -> float:
        _unilab_logger.debug("[UNILAB] SHFQA._get_dio_calibration_delay() called")
        """
    ...
    def _set_rx_delay(self, add_rx_delay) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_rx_delay() called")
        """
    ...
    def _get_rx_delay(self) -> int:
        _unilab_logger.debug("[UNILAB] SHFQA._get_rx_delay() called")
        """
    ...
    def _set_result_mode(self, value: str) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_result_mode() called")
        """
    ...
    def _get_result_mode(self) -> float:
        _unilab_logger.debug("[UNILAB] SHFQA._get_result_mode() called")
        """
    ...
    def _set_result_source(self, value: str) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_result_source() called")
        """
    ...
    def _get_result_source(self) -> float:
        _unilab_logger.debug("[UNILAB] SHFQA._get_result_source() called")
        """
    ...
    def _set_acquisition_time(self, value: float) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_acquisition_time() called")
        """
    ...
    def _get_acquisition_time(self) -> float:
        _unilab_logger.debug("[UNILAB] SHFQA._get_acquisition_time() called")
        """
    ...
    def _set_samples(self, value: int) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_samples() called")
        """
    ...
    def _get_samples(self) -> int:
        _unilab_logger.debug("[UNILAB] SHFQA._get_samples() called")
        """
    ...
    def _set_averages(self, value: int) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_averages() called")
        """
    ...
    def _get_averages(self) -> int:
        _unilab_logger.debug("[UNILAB] SHFQA._get_averages() called")
        """
    ...
    def _set_averaging_mode(self, value: int) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._set_averaging_mode() called")
        """
    ...
    def _get_averaging_mode(self) -> str:
        _unilab_logger.debug("[UNILAB] SHFQA._get_averaging_mode() called")
        """
    ...
    def snapshot_base(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.snapshot_base() called")
        """
    ...
    def awg_sequence_acquisition_and_DIO_triggered_pulse(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.awg_sequence_acquisition_and_DIO_triggered_pulse() called")
        """
    ...
    def awg_sequence_acquisition_and_pulse(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.awg_sequence_acquisition_and_pulse() called")
        """
    ...
    def awg_sequence_acquisition(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.awg_sequence_acquisition() called")
        """
    ...
    def awg_sequence_acquisition_and_pulse_SSB(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.awg_sequence_acquisition_and_pulse_SSB() called")
        """
    ...
    def configure_spectroscopy(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.configure_spectroscopy() called")
        """
    ...
    def awg_sequence_acquisition_and_DIO_RED_test(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.awg_sequence_acquisition_and_DIO_RED_test() called")
        raise NotImplementedError

    def awg_sequence_test_pattern(self, dio_out_vect=None) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.awg_sequence_test_pattern() called")
        raise NotImplementedError

    def spec_mode_on(
        self, acq_length=1 / 1500, IF=20e6, ro_amp=0.1, wint_length=2 ** 14
    ) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.spec_mode_on() called")
        raise NotImplementedError(
    ...
    def prepare_SSB_weight_and_rotation(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.prepare_SSB_weight_and_rotation() called")
        """
    ...
    def prepare_DSB_weight_and_rotation(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.prepare_DSB_weight_and_rotation() called")
        raise NotImplementedError
    ...
    def output_dio_calibration_data(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.output_dio_calibration_data() called")
    ...
    def calibrate_dio_protocol(
        ...
        _unilab_logger.debug("[UNILAB] SHFQA.calibrate_dio_protocol() called")
    ...
    def _check_devtype(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._check_devtype() called")
    ...
    def _check_options(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._check_options() called")
        pass

    def _check_versions(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._check_versions() called")
    ...
    def _check_awg_nr(self, awg_nr: int) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._check_awg_nr() called")
        if awg_nr > self._num_channels():
            raise ziValueError(f"Invalid AWG index of {awg_nr} detected!")

    def _num_channels(self) -> int:
        _unilab_logger.debug("[UNILAB] SHFQA._num_channels() called")
        if self.devtype == "SHFQA4":
            return 4
        return 2

    def _num_awgs(self) -> int:
        _unilab_logger.debug("[UNILAB] SHFQA._num_awgs() called")
    ...
    def active_slots(self) -> dict:
        _unilab_logger.debug("[UNILAB] SHFQA.active_slots() called")
        """
    ...
    def active_channels(self) -> tuple:
        _unilab_logger.debug("[UNILAB] SHFQA.active_channels() called")
        """
    ...
    def validate_config(self):
        _unilab_logger.debug("[UNILAB] SHFQA.validate_config() called")
        """
    ...
    def _push_sequencer_programs(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._push_sequencer_programs() called")
        """
    ...
    def _push_waveforms(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._push_waveforms() called")
        """
    ...
    def _push_hold_off_delay(self):
        _unilab_logger.debug("[UNILAB] SHFQA._push_hold_off_delay() called")
        for ch in self.active_channels:
    ...
    def _push_loop_config(self):
        _unilab_logger.debug("[UNILAB] SHFQA._push_loop_config() called")
    ...
    def push_to_device(self):
        _unilab_logger.debug("[UNILAB] SHFQA.push_to_device() called")
        """
    ...
    def _enable_channels(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._enable_channels() called")
        """
    ...
    def _start_sequencers(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._start_sequencers() called")
        """
    ...
    def _wait_sequencers_finished(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._wait_sequencers_finished() called")
        """
    ...
    def _subscribe_to_result_nodes(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._subscribe_to_result_nodes() called")
        """
    ...
    def _configure_codeword_protocol(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA._configure_codeword_protocol() called")
        """
    ...
    def _loop_sizes(self) -> SeqC.LoopSizes:
        _unilab_logger.debug("[UNILAB] SHFQA._loop_sizes() called")
    ...
    def reset_acquisition_params(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.reset_acquisition_params() called")
        self.reset_user_registers()
        self.reset_crosstalk_matrix()
        self.reset_correlation_params()

    def reset_user_registers(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.reset_user_registers() called")
        default_value = 0
    ...
    def reset_crosstalk_matrix(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.reset_crosstalk_matrix() called")
        raise NotImplementedError("Crosstalk suppression is not available on SHFQA.")

    def reset_correlation_params(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.reset_correlation_params() called")
        default_value = 0
    ...
    def reset_rotation_params(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.reset_rotation_params() called")
        raise NotImplementedError(
    ...
    def upload_crosstalk_matrix(self, matrix) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.upload_crosstalk_matrix() called")
        raise NotImplementedError("Crosstalk suppression is not available on SHFQA.")

    def download_crosstalk_matrix(self, nr_rows=10, nr_cols=10) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.download_crosstalk_matrix() called")
        raise NotImplementedError("Crosstalk suppression is not available on SHFQA.")
    ...
    def print_correlation_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_correlation_overview() called")
        raise NotImplementedError("Crosstalk suppression is not available on SHFQA.")

    def print_deskew_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_deskew_overview() called")
        raise NotImplementedError(
    ...
    def print_crosstalk_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_crosstalk_overview() called")
        raise NotImplementedError("Crosstalk suppression is not available on SHFQA.")

    def print_integration_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_integration_overview() called")
        raise NotImplementedError

    def print_rotations_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_rotations_overview() called")
        raise NotImplementedError(
            "Rotation of the integration weights is not supported by the SHFQA. Please include such corrections in the weights uploaded to the instrument."
        )

    def print_thresholds_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_thresholds_overview() called")
    ...
    def print_user_regs_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_user_regs_overview() called")
    ...
    def print_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] SHFQA.print_overview() called")
