...
Original: src/zhinst/qcodes/driver/devices/shfqc.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SHFQC")
...
class SHFQC(ZIBaseInstrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] SHFQC.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def _init_additional_nodes(self):
        _unilab_logger.debug("[UNILAB] SHFQC._init_additional_nodes() called")
    ...
    def factory_reset(self, *, deep: bool = True) -> None:
        _unilab_logger.debug("[UNILAB] SHFQC.factory_reset() called")
    ...
    def start_continuous_sw_trigger(
        ...
        _unilab_logger.debug("[UNILAB] SHFQC.start_continuous_sw_trigger() called")
    ...
    def max_qubits_per_channel(self) -> int:
        _unilab_logger.debug("[UNILAB] SHFQC.max_qubits_per_channel() called")
