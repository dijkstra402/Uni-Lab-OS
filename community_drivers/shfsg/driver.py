...
Original: src/zhinst/qcodes/driver/devices/shfsg.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SHFSG")
...
class SHFSG(ZIBaseInstrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] SHFSG.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def _init_additional_nodes(self):
        _unilab_logger.debug("[UNILAB] SHFSG._init_additional_nodes() called")
    ...
    def factory_reset(self, *, deep: bool = True) -> None:
        _unilab_logger.debug("[UNILAB] SHFSG.factory_reset() called")
