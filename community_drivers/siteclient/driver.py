...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Siteclient")
...
class Siteclient(Netclient):
    def synchronized(f):
        _unilab_logger.debug("[UNILAB] Siteclient.synchronized() called")
        def _synchronized(self, *args, **kwargs):
            _unilab_logger.debug("[UNILAB] Siteclient._synchronized() called")
            self.lock.acquire()
            try:
    ...
    @synchronized
    def sr(self, message):
        _unilab_logger.debug("[UNILAB] Siteclient.sr() called")
    ...
    def build_knobs(self, knobstr):
        _unilab_logger.debug("[UNILAB] Siteclient.build_knobs() called")
# http://stackoverflow.com/questions/10967551/how-do-i-dynamically-create-properties-in-python
    ...
    def help(self, regex = ".*"):
        _unilab_logger.debug("[UNILAB] Siteclient.help() called")
    ...
    def __getattr__(self, name):
        _unilab_logger.debug("[UNILAB] Siteclient.__getattr__() called")
        if self.knobs == None:
    ...
    def __setattr__(self, name, value):
        _unilab_logger.debug("[UNILAB] Siteclient.__setattr__() called")
        if self.knobs == None:
    ...
    def get_knob(self, name):
        _unilab_logger.debug("[UNILAB] Siteclient.get_knob() called")
        return self.__getattr__(name)
    def set_knob(self, name, value):
        _unilab_logger.debug("[UNILAB] Siteclient.set_knob() called")
        return self.__setattr__(name, value)
    def __repr__(self):
        _unilab_logger.debug("[UNILAB] Siteclient.__repr__() called")
        return 'Siteclient(%s, %d)' % (self.addr(), self.port())

    trace = int(os.getenv("SITECLIENT_TRACE", "0"))

    def __init__(self, addr, port):
        print("[UNILAB] Siteclient.__init__() called", flush=True)
