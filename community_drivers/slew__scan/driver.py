...
Original: epicsscan/slew_scan.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Slew_Scan")
...
from epicsscan.file_utils import fix_varname, fix_filename, increment_filename
...
class Slew_Scan(StepScan):
    ...
    def prepare_scan(self):
        print("[UNILAB] Slew_Scan.__init__() called", flush=True)
        """prepare slew scan"""
    ...
    def post_slew_scan(self, **kws):
        _unilab_logger.debug("[UNILAB] Slew_Scan.post_slew_scan() called")
        for det in self.detectors:
            if isinstance(det, AreaDetector):
                self.set_info('xrd_1dint_status', 'finishing')

    def write_master(self, text):
        _unilab_logger.debug("[UNILAB] Slew_Scan.write_master() called")
    ...
    def save_mcs_data(self, filename='mcsdata.001', npts=1):
        _unilab_logger.debug("[UNILAB] Slew_Scan.save_mcs_data() called")
    ...
    def save_extra_data(self, xrfdet=None, xrddet=None):
        _unilab_logger.debug("[UNILAB] Slew_Scan.save_extra_data() called")
        t0 = time.time()
    ...
    def run(self, filename='map.001', comments=None, debug=False, npts=None):
        _unilab_logger.debug("[UNILAB] Slew_Scan.run() called")
        """
        run a slew scan
        """
    ...
    def check_beam_ok(self):
        _unilab_logger.debug("[UNILAB] Slew_Scan.check_beam_ok() called")
        return True

    def save_envdata(self,filename='Environ.dat'):
        _unilab_logger.debug("[UNILAB] Slew_Scan.save_envdata() called")
        buff = []
