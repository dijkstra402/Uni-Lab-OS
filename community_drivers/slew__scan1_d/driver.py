...
Original: epicsscan/slew_scan1d.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Slew_Scan1D")
...
from epicsscan.scan import StepScan
from epicsscan.positioner import Positioner
from epicsscan.saveable import Saveable

from epicsscan.detectors import Struck, TetrAMM, Xspress3
from epicsscan.detectors import (Counter, Trigger, AreaDetector, write_poni)
from epicsscan.file_utils import fix_varname, fix_filename, increment_filename, new_filename
from epicsscan.detectors.counter import ROISumCounter, EVAL4PLOT

from epicsscan.xafs_scan import create_xps_abort
...
class Slew_Scan1D(StepScan):
    ...
    def prepare_scan(self):
        print("[UNILAB] Slew_Scan1D.__init__() called", flush=True)
        """prepare slew scan"""
    ...
    def post_scan(self):
        _unilab_logger.debug("[UNILAB] Slew_Scan1D.post_scan() called")
    ...
    def run(self, filename=None, comments=None, debug=False, npts=None):
        _unilab_logger.debug("[UNILAB] Slew_Scan1D.run() called")
        """
        run a 1D slew scan
        """
        dtimer = debugtimer()
    ...
    def gathering2xvals(self, text):
        _unilab_logger.debug("[UNILAB] Slew_Scan1D.gathering2xvals() called")
    ...
    def check_beam_ok(self):
        _unilab_logger.debug("[UNILAB] Slew_Scan1D.check_beam_ok() called")
        return True

    def save_envdata(self,filename='Environ.dat'):
        _unilab_logger.debug("[UNILAB] Slew_Scan1D.save_envdata() called")
        buff = []
