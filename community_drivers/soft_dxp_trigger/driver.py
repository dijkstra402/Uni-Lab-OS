...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SoftDXPTrigger")
...
class SoftDXPTrigger(Device):
    ...
    def __init__(
        ...
        **kwargs
        ...
        print("[UNILAB] SoftDXPTrigger.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
        self._status = None
    ...
    def stage(self):
        _unilab_logger.debug("[UNILAB] SoftDXPTrigger.stage() called")
