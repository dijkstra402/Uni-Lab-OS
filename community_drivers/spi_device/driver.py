...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SPIDevice")
...
class SPIDevice(InterfaceDevice):
    ...
    def __init__(self, device_id, message_queue=None, alert_queue=None):
        print("[UNILAB] SPIDevice.__init__() called", flush=True)
        super().__init__()
    ...
    def change_setting(self,setting,value):
        _unilab_logger.debug("[UNILAB] SPIDevice.connect() called")
    ...
    def to_hex(self, values):
        _unilab_logger.debug("[UNILAB] SPIDevice._init_process_funcs() called")
    ...
    def check_crc(self, crc_received, data):
        _unilab_logger.debug("[UNILAB] SPIDevice.check_crc() called")
    ...
    def compute_crc(self, data):
        _unilab_logger.debug("[UNILAB] SPIDevice.compute_crc() called")
    ...
    def fix_crc(self, cmd):
        _unilab_logger.debug("[UNILAB] SPIDevice.fix_crc() called")
    ...
    def buffer_bytearray(self, orig, size):
        _unilab_logger.debug("[UNILAB] SPIDevice.errorcode_to_string() called")
        new = bytearray(size)
        new[:len(orig)] = orig[:]
        return new
    ...
    def decode_read_response(self, unbuffered_cmd, buffered_response, name=None, missing_echo_len=0):
        _unilab_logger.debug("[UNILAB] SPIDevice.decode_read_response() called")
    ...
    def send_command(self, cmd: CommandTuple):
        _unilab_logger.debug("[UNILAB] SPIDevice.send_command() called")
        txData = []
    ...
    def wait_for_data_ready(self):
        _unilab_logger.debug("[UNILAB] SPIDevice.flush_input_buffer() called")
    ...
    def gain_to_ff(self, gain):
        _unilab_logger.debug("[UNILAB] SPIDevice.gain_to_ff() called")
