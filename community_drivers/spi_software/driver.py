...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SPISoftware")
...
class SPISoftware(SPI):
    ...
    def _conflicts_with(self, other):
        print("[UNILAB] SPISoftware.__init__() called", flush=True)
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] SPISoftware.close() called")
        if self._select:
            self._select.close()
        self._select = None
    ...
    @property
    def closed(self):
        _unilab_logger.debug("[UNILAB] SPISoftware.closed() called")
        return self._bus is None

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] SPISoftware.__repr__() called")
        try:
            self._check_open()
            return (
    ...
    def transfer(self, data):
        _unilab_logger.debug("[UNILAB] SPISoftware.transfer() called")
        with self._bus.lock:
            self._select.on()
            try:
    ...
    def _get_clock_mode(self):
        _unilab_logger.debug("[UNILAB] SPISoftware._get_clock_mode() called")
        with self._bus.lock:
            return (not self._bus.clock.active_high) << 1 | self._clock_phase

    def _set_clock_mode(self, value):
        _unilab_logger.debug("[UNILAB] SPISoftware._set_clock_mode() called")
        if not (0 <= value < 4):
    ...
    def _get_lsb_first(self):
        _unilab_logger.debug("[UNILAB] SPISoftware._get_lsb_first() called")
        return self._lsb_first

    def _set_lsb_first(self, value):
        _unilab_logger.debug("[UNILAB] SPISoftware._set_lsb_first() called")
        self._lsb_first = bool(value)

    def _get_bits_per_word(self):
        _unilab_logger.debug("[UNILAB] SPISoftware._get_bits_per_word() called")
        return self._bits_per_word

    def _set_bits_per_word(self, value):
        _unilab_logger.debug("[UNILAB] SPISoftware._set_bits_per_word() called")
        if value < 1:
            raise ValueError('bits_per_word must be positive')
        self._bits_per_word = int(value)

    def _get_select_high(self):
        _unilab_logger.debug("[UNILAB] SPISoftware._get_select_high() called")
        return self._select.active_high

    def _set_select_high(self, value):
        _unilab_logger.debug("[UNILAB] SPISoftware._set_select_high() called")
        with self._bus.lock:
...
class SPISoftwareBus(SharedMixin, Device):
    ...
    def _shared_key(cls, clock_pin, mosi_pin, miso_pin, *, pin_factory=None):
        _unilab_logger.debug("[UNILAB] SPISoftware._shared_key() called")
