...
Original: pymepix/SPIDR/spidrcontroller.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SPIDRController")
...
class SPIDRController(Logger):
    ...
    def __init__(self, dst_ip_port, pc_ip, udp_ip_port):
        print("[UNILAB] SPIDRController.__init__() called", flush=True)
    ...
    def __getitem__(self, key):
        _unilab_logger.debug("[UNILAB] SPIDRController.__getitem__() called")
        return self._devices[key]

    def __len__(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.__len__() called")
        return len(self._devices)

    def _initDevices(self):
        _unilab_logger.debug("[UNILAB] SPIDRController._initDevices() called")
    ...
    def prepare(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.prepare() called")
    ...
    def resetModule(self, readout_speed):
        _unilab_logger.debug("[UNILAB] SPIDRController.resetModule() called")
    ...
    @property
    def CpuToTpx(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.CpuToTpx() called")
    ...
    def ShutterTriggerCtrl(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.ShutterTriggerCtrl() called")
    ...
    def ShutterTriggerMode(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.ShutterTriggerMode() called")
    ...
    def ShutterTriggerCount(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.ShutterTriggerCount() called")
    ...
    def ShutterTriggerFreq(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.ShutterTriggerFreq() called")
    ...
    def ShutterTriggerLength(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.ShutterTriggerLength() called")
    ...
    def ShutterTriggerDelay(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.ShutterTriggerDelay() called")
    ...
    def DeviceAndPorts(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.DeviceAndPorts() called")
        return self.getSpidrReg(SpidrRegs.SPIDR_DEVICES_AND_PORTS_I)

    @property
    def TdcTriggerCounter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.TdcTriggerCounter() called")
    ...
    def UdpPacketCounter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.UdpPacketCounter() called")
    ...
    def UdpMonPacketCounter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.UdpMonPacketCounter() called")
        return self.getSpidrReg(SpidrRegs.SPIDR_UDPMON_PKTCOUNTER_I)

    @property
    def UdpPausePacketCounter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.UdpPausePacketCounter() called")
    ...
    def softwareVersion(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.softwareVersion() called")
        """Software version
    ...
    def firmwareVersion(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.firmwareVersion() called")
        """Firmware version
    ...
    def localTemperature(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.localTemperature() called")
    ...
    def remoteTemperature(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.remoteTemperature() called")
    ...
    def fpgaTemperature(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.fpgaTemperature() called")
    ...
    @property
    def humidity(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.humidity() called")
    ...
    @property
    def pressure(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.pressure() called")
    ...
    @property
    def deviceIds(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.deviceIds() called")
    ...
    @property
    def linkCounts(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.linkCounts() called")
    ...
    def chipboardId(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.chipboardId() called")
        return self.requestGetInt(SpidrCmds.CMD_GET_CHIPBOARDID, 0)

    def setBusy(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.setBusy() called")
        return self.requestSetInt(SpidrCmds.CMD_SET_BUSY, 0, 0)

    def clearBusy(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.clearBusy() called")
        return self.requestSetInt(SpidrCmds.CMD_CLEAR_BUSY, 0, 0)

    def resetDevices(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.resetDevices() called")
        """ Resets all devices"""
        self.requestSetInt(SpidrCmds.CMD_RESET_DEVICES, 0, 0)

    def reinitDevices(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.reinitDevices() called")
    ...
    def setPowerPulseEnable(self, enable):
        _unilab_logger.debug("[UNILAB] SPIDRController.setPowerPulseEnable() called")
        self.requestSetInt(SpidrCmds.CMD_PWRPULSE_ENA, 0, int(enable))

    def setTpxPowerPulseEnable(self, enable):
        _unilab_logger.debug("[UNILAB] SPIDRController.setTpxPowerPulseEnable() called")
        self.requestSetInt(SpidrCmds.CMD_TPX_POWER_ENA, 0, int(enable))

    def setBiasSupplyEnable(self, enable):
        _unilab_logger.debug("[UNILAB] SPIDRController.setBiasSupplyEnable() called")
    ...
    def biasVoltage(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.biasVoltage() called")
        """Bias voltage
    ...
    def enableDecoders(self, enable):
        _unilab_logger.debug("[UNILAB] SPIDRController.enableDecoders() called")
    ...
    def enablePeriphClk80Mhz(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.enablePeriphClk80Mhz() called")
        self.CpuToTpx |= 1 << 24

    def disablePeriphClk80Mhz(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.disablePeriphClk80Mhz() called")
        self.CpuToTpx &= ~(1 << 24)

    def enableExternalRefClock(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.enableExternalRefClock() called")
    ...
    def disableExternalRefClock(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.disableExternalRefClock() called")
    ...
    def sequentialReadout(self, tokens, now):
        _unilab_logger.debug("[UNILAB] SPIDRController.sequentialReadout() called")
    ...
    def datadrivenReadout(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.datadrivenReadout() called")
    ...
    def pauseReadout(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.pauseReadout() called")
    ...
    def setShutterTriggerConfig(self, mode, length_us, freq_hz, count, delay_ns=0):
        _unilab_logger.debug("[UNILAB] SPIDRController.setShutterTriggerConfig() called")
    ...
    def shutterTriggerConfig(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.shutterTriggerConfig() called")
        config = self.requestGetInts(SpidrCmds.CMD_GET_TRIGCONFIG, 0, 5)

        return tuple(config)

    def startAutoTrigger(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.startAutoTrigger() called")
    ...
    def stopAutoTrigger(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.stopAutoTrigger() called")
    ...
    def openShutter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.openShutter() called")
    ...
    def closeShutter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.closeShutter() called")
    ...
    def externalShutterCounter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.externalShutterCounter() called")
        return self.requestGetInt(SpidrCmds.CMD_GET_EXTSHUTTERCNTR, 0)

    @property
    def shutterCounter(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.shutterCounter() called")

        return self.requestGetInt(SpidrCmds.CMD_GET_SHUTTERCNTR, 0)

    def restartTimers(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.restartTimers() called")
    ...
    def resetCounters(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.resetCounters() called")
        self.requestSetInt(SpidrCmds.CMD_RESET_COUNTERS, 0, 0)

    def resetTimers(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.resetTimers() called")
    ...
    def getAdc(self, channel, nr_of_samples):
        _unilab_logger.debug("[UNILAB] SPIDRController.getAdc() called")
    ...
    def resetPacketCounters(self):
        _unilab_logger.debug("[UNILAB] SPIDRController.resetPacketCounters() called")
    ...
    def getSpidrReg(self, addr):
        _unilab_logger.debug("[UNILAB] SPIDRController.getSpidrReg() called")
    ...
    def setSpidrReg(self, addr, value):
        _unilab_logger.debug("[UNILAB] SPIDRController.setSpidrReg() called")
        self.requestSetInts(SpidrCmds.CMD_SET_SPIDRREG, 0, [addr, value])

    def request(self, cmd, dev_nr, message_length, expected_bytes=0):
        _unilab_logger.debug("[UNILAB] SPIDRController.request() called")
    ...
    def convertNtohl(self, x):
        _unilab_logger.debug("[UNILAB] SPIDRController.convertNtohl() called")
        return socket.ntohl(int(x))

    def convertHtonl(self, x):
        _unilab_logger.debug("[UNILAB] SPIDRController.convertHtonl() called")
        return socket.htonl(int(x))

    def requestGetInt(self, cmd, dev_nr, arg=0):
        _unilab_logger.debug("[UNILAB] SPIDRController.requestGetInt() called")
        msg_length = 20
    ...
    def requestGetInts(self, cmd, dev_nr, num_ints, args=0):
        _unilab_logger.debug("[UNILAB] SPIDRController.requestGetInts() called")
        msg_length = 20
    ...
    def requestGetBytes(self, cmd, dev_nr, expected_bytes, args=0):
        _unilab_logger.debug("[UNILAB] SPIDRController.requestGetBytes() called")
        msg_length = (4 + 1) * 4
    ...
    def requestGetIntBytes(self, cmd, dev_nr, expected_bytes, args=0):
        _unilab_logger.debug("[UNILAB] SPIDRController.requestGetIntBytes() called")
        msg_length = (4 + 1) * 4
        self._req_buffer[4] = socket.htonl(args)
    ...
    def requestSetInt(self, cmd, dev_nr, value):
        _unilab_logger.debug("[UNILAB] SPIDRController.requestSetInt() called")
        msg_length = (4 + 1) * 4
    ...
    def requestSetInts(self, cmd, dev_nr, value):
        _unilab_logger.debug("[UNILAB] SPIDRController.requestSetInts() called")
        num_ints = len(value)
    ...
    def requestSetIntBytes(self, cmd, dev_nr, value_int, value_bytes):
        _unilab_logger.debug("[UNILAB] SPIDRController.requestSetIntBytes() called")
