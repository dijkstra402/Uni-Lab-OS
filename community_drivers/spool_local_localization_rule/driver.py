...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SpoolLocalLocalizationRule")
...
class SpoolLocalLocalizationRule(LocalisationRule):
    def __init__(self, spooler, seriesName, analysisMetadata, resultsFilename=None, startAt=0, serverfilter=clusterIO.local_serverfilter, **kwargs):
        print("[UNILAB] SpoolLocalLocalizationRule.__init__() called", flush=True)
    ...
    @property
    def total_frames(self):
        _unilab_logger.debug("[UNILAB] SpoolLocalLocalizationRule.total_frames() called")
        return self.spooler.get_n_frames()

    @property
    def data_complete(self):
        _unilab_logger.debug("[UNILAB] SpoolLocalLocalizationRule.data_complete() called")
        try:
    ...
    def on_data_complete(self):
        _unilab_logger.debug("[UNILAB] SpoolLocalLocalizationRule.on_data_complete() called")
...
__all__ = ["SpoolLocalLocalizationRule"]
