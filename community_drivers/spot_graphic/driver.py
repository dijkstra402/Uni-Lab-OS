...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SpotGraphic")
...
class SpotGraphic(Graphic):
    ...
    def __init__(self) -> None:
        print("[UNILAB] SpotGraphic.__init__() called", flush=True)
    ...
    @property
    def bounds(self) -> Geometry.FloatRect:
        _unilab_logger.debug("[UNILAB] SpotGraphic.bounds() called")
        return Geometry.FloatRect.make(typing.cast(Geometry.RectFloatTuple, self._get_persistent_property_value("bounds")))
    ...
    @property
    def rotation(self) -> float:
        _unilab_logger.debug("[UNILAB] SpotGraphic.rotation() called")
        return typing.cast(float, self._get_persistent_property_value("rotation"))
    ...
    def mime_data_dict(self) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] SpotGraphic.mime_data_dict() called")
        d = super().mime_data_dict()
        d["bounds"] = self.bounds.as_tuple()
        d["rotation"] = self.rotation
        return d
    ...
    def read_from_mime_data(self, graphic_dict: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] SpotGraphic.read_from_mime_data() called")
        super().read_from_mime_data(graphic_dict)
        self.bounds = graphic_dict.get("bounds", self.bounds)
        self.rotation = graphic_dict.get("rotation", self.rotation)

    def get_attributes(self) -> set[GraphicAttributeEnum]:
        _unilab_logger.debug("[UNILAB] SpotGraphic.get_attributes() called")
        return {GraphicAttributeEnum.TWO_DIMENSIONAL, GraphicAttributeEnum.FOURIER_MASK}

    @property
    def used_role(self) -> typing.Optional[str]:
        _unilab_logger.debug("[UNILAB] SpotGraphic.used_role() called")
        return "fourier_mask"

    # accessors

    def __validate_bounds(self, value: Geometry.RectFloatTuple) -> Geometry.RectFloatTuple:
        _unilab_logger.debug("[UNILAB] SpotGraphic.__validate_bounds() called")
        # normalize
        if value[1][0] < 0:  # height is negative
            value = ((value[0][0] + value[1][0], value[0][1]), (-value[1][0], value[1][1]))
        if value[1][1] < 0:  # width is negative
    ...
    def __bounds_changed(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] SpotGraphic.__bounds_changed() called")
        self._property_changed(name, value)
        self._property_changed("center", self.center)
        self._property_changed("size", self.size)
    ...
    @property
    def center(self) -> Geometry.FloatPoint:
        _unilab_logger.debug("[UNILAB] SpotGraphic.center() called")
        return self.bounds.center
    ...
    @property
    def size(self) -> Geometry.FloatSize:
        _unilab_logger.debug("[UNILAB] SpotGraphic.size() called")
        return self.bounds.size
    ...
    @_bounds.setter
    def _bounds(self, bounds: Geometry.FloatRectTuple) -> None:
        _unilab_logger.debug("[UNILAB] SpotGraphic._bounds() called")
        self.bounds = Geometry.FloatRect.make(bounds)

    def get_region(self) -> SpotRegion:
        _unilab_logger.debug("[UNILAB] SpotGraphic.get_region() called")
        return SpotRegion(self.bounds, self.rotation)

    def get_mask_item(self) -> MaskItem:
        _unilab_logger.debug("[UNILAB] SpotGraphic.get_mask_item() called")
        return SpotMaskItem(self.bounds, self.rotation)

    # test point hit
    def test(self, mapping: CoordinateMappingLike, ui_settings: UISettings.UISettings, p: Geometry.FloatPoint, move_only: bool) -> typing.Tuple[typing.Optional[str], bool]:
        _unilab_logger.debug("[UNILAB] SpotGraphic.test() called")
        # first convert to widget coordinates since test distances
        # are specified in widget coordinates
        rotation = self.rotation
        bounds = Geometry.FloatRect.make(self.bounds)
    ...
    def begin_drag(self) -> DragPartData:
        _unilab_logger.debug("[UNILAB] SpotGraphic.begin_drag() called")
        return (self.bounds, self.rotation)

    def end_drag(self, part_data: DragPartData) -> None:
        _unilab_logger.debug("[UNILAB] SpotGraphic.end_drag() called")
        pass

    # rectangle
    def adjust_part(self, mapping: CoordinateMappingLike, original: Geometry.FloatPoint, current: Geometry.FloatPoint, part: DragPartDataPlus, modifiers: ModifiersLike) -> None:
        _unilab_logger.debug("[UNILAB] SpotGraphic.adjust_part() called")
        constraints = self._constraints
        part_name = part[0]
    ...
    def nudge(self, mapping: CoordinateMappingLike, delta: Geometry.FloatSize) -> None:
        _unilab_logger.debug("[UNILAB] SpotGraphic.nudge() called")
    ...
    def _draw(self, ctx: DrawingContextLike, ui_settings: UISettings.UISettings, mapping: CoordinateMappingLike, is_selected: bool, is_focused: bool) -> None:
        _unilab_logger.debug("[UNILAB] SpotGraphic._draw() called")
        # origin is top left
    ...
    def label_position(self, mapping: CoordinateMappingLike, font_metrics: UISettings.FontMetrics, padding: float) -> typing.Optional[Geometry.FloatPoint]:
        _unilab_logger.debug("[UNILAB] SpotGraphic.label_position() called")
