...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SqliteReader")
...
class SqliteReader(MessageReader):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("[UNILAB] SqliteReader.__init__() called", flush=True)
        """
    ...
    def __iter__(self) -> Generator[Message, None, None]:
        _unilab_logger.debug("[UNILAB] SqliteReader.__iter__() called")
    ...
    def _assemble_message(frame_data: _MessageTuple) -> Message:
        _unilab_logger.debug("[UNILAB] SqliteReader._assemble_message() called")
    ...
    def __len__(self) -> int:
        _unilab_logger.debug("[UNILAB] SqliteReader.__len__() called")
    ...
    def read_all(self) -> Iterator[Message]:
        _unilab_logger.debug("[UNILAB] SqliteReader.read_all() called")
    ...
    def stop(self) -> None:
        _unilab_logger.debug("[UNILAB] SqliteReader.stop() called")
