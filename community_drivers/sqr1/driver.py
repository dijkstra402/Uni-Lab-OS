...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SQR1")
...
class SQR1Axis(FltMvInterface, PVPositionerIsClose):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("[UNILAB] SQR1.__init__() called", flush=True)
    ...
    def move(
        ...
        _unilab_logger.debug("[UNILAB] SQR1.move() called")
        """
    ...
    def set(
        ...
        *,
        ...
        _unilab_logger.debug("[UNILAB] SQR1.set() called")
        """
...
class SQR1(Device):
    ...
    def sync_setpoints(self):
        _unilab_logger.debug("[UNILAB] SQR1.sync_setpoints() called")
        """
    ...
    def multi_axis_move(
        ...
        _unilab_logger.debug("[UNILAB] SQR1.multi_axis_move() called")
        """
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] SQR1.stop() called")
        """stop command for all axes."""
        self.stop_signal.put(self.stop_value)

    def preset_list(self):
        _unilab_logger.debug("[UNILAB] SQR1.preset_list() called")
