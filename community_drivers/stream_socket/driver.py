...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.StreamSocket")
...
class StreamSocket(IStream):
    ...
    def __init__(self, hostname, port):
        print("[UNILAB] StreamSocket.__init__() called", flush=True)
        # Open socket
        self.sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        self.sock.connect((hostname, port))

    def write(self, data):
        _unilab_logger.debug("[UNILAB] StreamSocket.write() called")
        self.sock.send(data)
        if CONFIG.DEBUG_STREAM_TX:
            CONFIG.LOGGER.debug("TX Raw: " +
                                binascii.hexlify(data).decode('utf-8'))
    ...
    def read(self, size=1):
        _unilab_logger.debug("[UNILAB] StreamSocket.read() called")
