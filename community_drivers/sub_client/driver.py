...
Original: instrumentserver/client/proxy.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SubClient")
...
from instrumentserver.client.core import sendRequest, BaseClient
...
class SubClient(QtCore.QObject):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] SubClient.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    ...
    @QtCore.Slot()
    def connect(self):
        _unilab_logger.debug("[UNILAB] SubClient.connect() called")
        """
    ...
    @QtCore.Slot()
    def stop(self):
        _unilab_logger.debug("[UNILAB] SubClient.stop() called")
        """
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] SubClient.disconnect() called")
        """
