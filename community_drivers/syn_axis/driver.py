...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SynAxis")
...
from ophyd.status import DeviceStatus, MoveStatus, StatusBase
...
class SynAxis(Device):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("[UNILAB] SynAxis.__init__() called", flush=True)
        if readback_func is None:

            def readback_func(x):
                _unilab_logger.debug("[UNILAB] SynAxis.readback_func() called")
                return x
    ...
    def _make_status(self, target: float):
        _unilab_logger.debug("[UNILAB] SynAxis._make_status() called")
        return MoveStatus(positioner=self, target=target)

    def set(self, value: float) -> MoveStatus:
        _unilab_logger.debug("[UNILAB] SynAxis.set() called")
        ...
        def update_state(position: float) -> None:
            _unilab_logger.debug("[UNILAB] SynAxis.update_state() called")
        ...
        def sleep_and_finish():
            _unilab_logger.debug("[UNILAB] SynAxis.sleep_and_finish() called")
    ...
    @property
    def position(self):
        _unilab_logger.debug("[UNILAB] SynAxis.position() called")
...
class SynAxisEmptyHints(SynAxis):
    @property
    def hints(self):
        _unilab_logger.debug("[UNILAB] SynAxis.hints() called")
        return {}


    def __init__(self, *args, **kwargs):
        print("[UNILAB] SynAxis.__init__() called")
        super().__init__(*args, **kwargs)
