...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TangoDevice")
...
class TangoDevice(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] TangoDevice.__init__() called", flush=True)
...
class TangoDeviceConnector(DeviceConnector):
    ...
    def set_trl(self, trl: str):
        _unilab_logger.debug("[UNILAB] TangoDevice.set_trl() called")
        self.trl = trl

    def create_children_from_annotations(self, device: Device):
        _unilab_logger.debug("[UNILAB] TangoDevice.create_children_from_annotations() called")
    ...
    async def connect_mock(self, device: Device, mock: LazyMock):
        _unilab_logger.debug("[UNILAB] TangoDevice.connect_mock() called")
    ...
    async def connect_real(self, device: Device, timeout: float, force_reconnect: bool):
        _unilab_logger.debug("[UNILAB] TangoDevice.connect_real() called")
        if not self.trl:
