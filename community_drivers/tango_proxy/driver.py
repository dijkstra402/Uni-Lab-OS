...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TangoProxy")
...
class TangoProxy:
    def __init__(self, *args, **kwargs):
        print("[UNILAB] TangoProxy.__init__() called", flush=True)
    ...
    async def connect(self) -> None:
        _unilab_logger.debug("[UNILAB] TangoProxy.connect() called")
    ...
    async def get(self) -> object:
        _unilab_logger.debug("[UNILAB] TangoProxy.get() called")
        """Get value from TRL."""

    @abstractmethod
    async def get_w_value(self) -> object:
        _unilab_logger.debug("[UNILAB] TangoProxy.get_w_value() called")
    ...
    async def put(
        ...
        _unilab_logger.debug("[UNILAB] TangoProxy.put() called")
        """Put value to TRL."""

    @abstractmethod
    async def get_config(self) -> AttributeInfoEx | CommandInfo:
        _unilab_logger.debug("[UNILAB] TangoProxy.get_config() called")
        """Get TRL config async."""

    @abstractmethod
    async def get_reading(self) -> Reading:
        _unilab_logger.debug("[UNILAB] TangoProxy.get_reading() called")
        """Get reading from TRL."""

    @abstractmethod
    def has_subscription(self) -> bool:
        _unilab_logger.debug("[UNILAB] TangoProxy.has_subscription() called")
        """Indicate that this trl already subscribed."""

    @abstractmethod
    def subscribe_callback(self, callback: Callback | None):
        _unilab_logger.debug("[UNILAB] TangoProxy.subscribe_callback() called")
        """Subscribe tango CHANGE event to callback."""

    @abstractmethod
    def unsubscribe_callback(self):
        _unilab_logger.debug("[UNILAB] TangoProxy.unsubscribe_callback() called")
    ...
    def set_polling(
        ...
        _unilab_logger.debug("[UNILAB] TangoProxy.set_polling() called")
        """Set polling parameters."""

    def set_converter(self, converter: "TangoConverter"):
        _unilab_logger.debug("[UNILAB] TangoProxy.set_converter() called")
