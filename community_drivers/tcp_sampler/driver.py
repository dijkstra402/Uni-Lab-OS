...
Original: pymepix/util/tcpsampler.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TcpSampler")
...
class TcpSampler(multiprocessing.Process, ProcessLogger):
    ...
    def __init__(
        ...
        print("[UNILAB] TcpSampler.__init__() called", flush=True)
        name = "TcpSampler"
    ...
    def init_new_process(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.init_new_process() called")
        try:
    ...
    def createConnection(self, address):
        _unilab_logger.debug("[UNILAB] TcpSampler.createConnection() called")
    ...
    def get_useful_packets(self, packet):
        _unilab_logger.debug("[UNILAB] TcpSampler.get_useful_packets() called")
        # Get the header
    ...
    @property
    def enable(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.enable() called")
        """Enables processing
    ...
    @property
    def record(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.record() called")
    ...
    @property
    def close_file(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.close_file() called")
    ...
    def outfile_name(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.outfile_name() called")
    ...
    def pre_run(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.pre_run() called")
    ...
    def post_run(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.post_run() called")
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.run() called")
        self.pre_run()
        enabled = True
        start = time.time()
    ...
    def stopRaw2Disk(self):
        _unilab_logger.debug("[UNILAB] TcpSampler.stopRaw2Disk() called")
