...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TCPServeValue")
...
class TCPServeValue(object):
    ...
    def __init__(self, name, port = 3233):
        print("[UNILAB] TCPServeValue.__init__() called", flush=True)
        self.name = name
        self.port = port
    ...
    def send(self, sock, msg):
        _unilab_logger.debug("[UNILAB] TCPServeValue.send() called")
        try:
            sock.sendall(msg)
    ...
    def run(self, values):
        _unilab_logger.debug("[UNILAB] TCPServeValue.run() called")
        timeout = 0.05
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] TCPServeValue.shutdown() called")
        self.sock.close()
