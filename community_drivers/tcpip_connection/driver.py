...
Original: PyLabware/connections.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TCPIPConnection")
...
from PyLabware.exceptions import PLConnectionError, PLConnectionProtocolError, PLConnectionTimeoutError
from PyLabware.models import LabDeviceReply, ConnectionParameters
...
class TCPIPConnection(AbstractConnection):
    ...
    def __init__(self, connection_parameters: ConnectionParameters):
        print("[UNILAB] TCPIPConnection.__init__() called", flush=True)
        """Default constructor.
    ...
    def open_connection(self):
        _unilab_logger.debug("[UNILAB] TCPIPConnection.open_connection() called")
    ...
    def connection_listener(self):
        _unilab_logger.debug("[UNILAB] TCPIPConnection.connection_listener() called")
        """Periodically checks for new data on the connection,
    ...
    def close_connection(self):
        _unilab_logger.debug("[UNILAB] TCPIPConnection.close_connection() called")
        """Closes connection.
        """
    ...
    def is_connection_open(self):
        _unilab_logger.debug("[UNILAB] TCPIPConnection.is_connection_open() called")
    ...
    def transmit(self, msg: str):
        _unilab_logger.debug("[UNILAB] TCPIPConnection.transmit() called")
    ...
    def receive(self, retries: int = 3):
        _unilab_logger.debug("[UNILAB] TCPIPConnection.receive() called")
        """Gets the data from receive buffer, clears the data ready flag
        and passes the data back.
