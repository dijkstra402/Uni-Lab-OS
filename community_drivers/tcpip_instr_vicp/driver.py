...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TCPIPInstrVicp")
...
# Vendored repo packages: pyvisa_py
import sys as _sys
...
from pyvisa_py.common import LOGGER, int_to_byte
from pyvisa_py.protocols import hislip, rpc, vxi11
from pyvisa_py.sessions import OpenError, Session, UnknownAttribute, VISARMSession
...
class TCPIPInstrVicp(Session):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] TCPIPInstrVicp.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    parsed: rname.VICPInstr

    @staticmethod
    def list_resources(wait_time=1.0) -> List[str]:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.list_resources() called")
        resources = []
        try:
    ...
    def after_parsing(self) -> None:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.after_parsing() called")
        # TODO: board_number not handled
        if pyvicp is None:
            raise NotImplementedError(
    ...
    def get_keepalive(self, attribute: ResourceAttribute) -> Tuple[bool, StatusCode]:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.get_keepalive() called")
        """Is TCP keepalive enabled for the resource."""
        return self.interface.keepalive, StatusCode.success
    ...
    def set_keepalive(
        ...
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.set_keepalive() called")
        """Turns TCP keepalive on/off for this connection."""
        self.interface.keepalive = keepalive
        return StatusCode.success

    def close(self) -> StatusCode:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.close() called")
        self.interface.close()
        self.interface = None
        return StatusCode.success

    def read(self, count: int) -> Tuple[bytes, StatusCode]:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.read() called")
        """Reads data from device or interface synchronously.
    ...
    def write(self, data: bytes) -> Tuple[int, StatusCode]:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.write() called")
        """Writes data to device or interface synchronously.
    ...
    def clear(self) -> StatusCode:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp.clear() called")
        """Clears a device.
    ...
    def _set_timeout(self, attribute: ResourceAttribute, value: int) -> StatusCode:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp._set_timeout() called")
        status = super()._set_timeout(attribute, value)
        if hasattr(self.interface, "timeout"):
            self.interface.timeout = 1e-3 * value
    ...
    def _get_attribute(self, attribute: ResourceAttribute) -> Tuple[Any, StatusCode]:
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp._get_attribute() called")
        """Get the value for a given VISA attribute for this session.
    ...
    def _set_attribute(
        ...
        _unilab_logger.debug("[UNILAB] TCPIPInstrVicp._set_attribute() called")
        """Sets the state of an attribute.
