...
Original: src/instruments/tektronix/tekdpo70000.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TekDPO70000")
...
class TekDPO70000(SCPIInstrument, Oscilloscope):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] TekDPO70000.__init__() called", flush=True)
    ...
    def _dtype(binary_format, byte_order, n_bytes):
        _unilab_logger.debug("[UNILAB] TekDPO70000._dtype() called")
        return "{}{}{}".format(
            {
    ...
    class DataSource(Oscilloscope.DataSource):
        ...
        @property
        def name(self):
            _unilab_logger.debug("[UNILAB] TekDPO70000.name() called")
            return self._name

        @abc.abstractmethod
        def _scale_raw_data(self, data):
            _unilab_logger.debug("[UNILAB] TekDPO70000._scale_raw_data() called")
            """
        ...
        def read_waveform(self, bin_format=True):
            _unilab_logger.debug("[UNILAB] TekDPO70000.read_waveform() called")
        ...
        def __enter__(self):
            _unilab_logger.debug("[UNILAB] TekDPO70000.__enter__() called")
        ...
        def __exit__(self, type, value, traceback):
            _unilab_logger.debug("[UNILAB] TekDPO70000.__exit__() called")
    ...
    class Math(DataSource):
        ...
        def sendcmd(self, cmd):
            _unilab_logger.debug("[UNILAB] TekDPO70000.sendcmd() called")
            """
        ...
        def query(self, cmd, size=-1):
            _unilab_logger.debug("[UNILAB] TekDPO70000.query() called")
            """
    ...
    @property
    def channel(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.channel() called")
        return ProxyList(self, self.Channel, range(4))

    @property
    def math(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.math() called")
        return ProxyList(self, self.Math, range(4))

    @property
    def ref(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.ref() called")
    ...
    def data_source(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.data_source() called")
        """
    ...
    def select_fastest_encoding(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.select_fastest_encoding() called")
        """
    ...
    def force_trigger(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.force_trigger() called")
        """
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.run() called")
        """
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] TekDPO70000.stop() called")
        """
