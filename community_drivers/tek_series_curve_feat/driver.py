...
Original: curvequery/_tek_series_mso_curve_feat.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TekSeriesCurveFeat")
...
# Vendored repo packages: curvequery
import sys as _sys
...
from curvequery.api_types import XScale
from curvequery.api_types import YScale
from curvequery.api_types import WaveformCollection
from curvequery.api_types import Waveform
from curvequery._tek_series_mso import WaveType
from curvequery._tek_series_mso import JobParameters
from curvequery._tek_series_mso import get_event_queue
from curvequery._pyvisa_tqdm_patch import _read_raw_progress_bar
from curvequery._pyvisa_tqdm_patch import read_binary_values_progress_bar
from curvequery._pyvisa_tqdm_patch import read_bytes_progress_bar


class TekSeriesCurveFeat(base.FeatureBase):
    def __init__(self, *args, **kwargs):
        print("[UNILAB] TekSeriesCurveFeat.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def feature(self, *, use_pbar=True, decompose_dch=True, verbose=False):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat.feature() called")
        """
    ...
    def _classify_waveform(source):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._classify_waveform() called")
        if source[0:4] == "MATH":
    ...
    def _has_data_available(instr, source):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._has_data_available() called")
    ...
    def _get_xscale(instr):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._get_xscale() called")
    ...
    def _get_yscale(instr, source):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._get_yscale() called")
    ...
    def _list_sources(self, instr):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._list_sources() called")
    ...
    def _make_jobs(self, instr, sources):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._make_jobs() called")
    ...
    def _setup_curve_query(instr, source, parameters: dict[str, JobParameters]):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._setup_curve_query() called")
    ...
    def _post_process_analog(self, instr, source, source_data, x_scale):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._post_process_analog() called")
    ...
    def _post_process_digital_bits(sources, source, source_data, x_scale, bit):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._post_process_digital_bits() called")
    ...
    def _post_process_digital_byte(source, source_data, x_scale):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._post_process_digital_byte() called")
    ...
    def _get_data(self, instr, sources, use_pbar, decompose_dch):
        _unilab_logger.debug("[UNILAB] TekSeriesCurveFeat._get_data() called")
