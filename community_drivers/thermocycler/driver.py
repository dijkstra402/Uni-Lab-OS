...
Original: pylabrobot/thermocycling/thermocycler.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Thermocycler")
...
class Thermocycler(ResourceHolder, Machine):
  ...
  def __init__(
    ...
    print("[UNILAB] Thermocycler.__init__() called", flush=True)
  ...
  async def open_lid(self, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.open_lid() called")
    return await self.backend.open_lid(**backend_kwargs)

  async def close_lid(self, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.close_lid() called")
  ...
  async def set_block_temperature(self, temperature: List[float], **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.set_block_temperature() called")
  ...
  async def set_lid_temperature(self, temperature: List[float], **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.set_lid_temperature() called")
  ...
  async def deactivate_block(self, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.deactivate_block() called")
  ...
  async def deactivate_lid(self, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.deactivate_lid() called")
  ...
  async def run_protocol(self, protocol: Protocol, block_max_volume: float, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.run_protocol() called")
  ...
  async def run_pcr_profile(
    ...
    **backend_kwargs,
    ...
    _unilab_logger.debug("[UNILAB] Thermocycler.run_pcr_profile() called")
  ...
  async def get_block_current_temperature(self, **backend_kwargs) -> List[float]:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_block_current_temperature() called")
  ...
  async def get_block_target_temperature(self, **backend_kwargs) -> List[float]:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_block_target_temperature() called")
  ...
  async def get_lid_current_temperature(self, **backend_kwargs) -> List[float]:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_lid_current_temperature() called")
  ...
  async def get_lid_target_temperature(self, **backend_kwargs) -> List[float]:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_lid_target_temperature() called")
  ...
  async def get_lid_open(self, **backend_kwargs) -> bool:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_lid_open() called")
  ...
  async def get_lid_status(self, **backend_kwargs) -> LidStatus:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_lid_status() called")
  ...
  async def get_block_status(self, **backend_kwargs) -> BlockStatus:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_block_status() called")
    """Get the block status."""
    return await self.backend.get_block_status(**backend_kwargs)

  async def get_hold_time(self, **backend_kwargs) -> float:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_hold_time() called")
  ...
  async def get_current_cycle_index(self, **backend_kwargs) -> int:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_current_cycle_index() called")
  ...
  async def get_total_cycle_count(self, **backend_kwargs) -> int:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_total_cycle_count() called")
  ...
  async def get_current_step_index(self, **backend_kwargs) -> int:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_current_step_index() called")
  ...
  async def get_total_step_count(self, **backend_kwargs) -> int:
    _unilab_logger.debug("[UNILAB] Thermocycler.get_total_step_count() called")
  ...
  async def wait_for_block(self, timeout: float = 600, tolerance: float = 0.5, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.wait_for_block() called")
  ...
  async def wait_for_lid(self, timeout: float = 1200, tolerance: float = 0.5, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.wait_for_lid() called")
  ...
  async def is_profile_running(self, **backend_kwargs) -> bool:
    _unilab_logger.debug("[UNILAB] Thermocycler.is_profile_running() called")
  ...
  async def wait_for_profile_completion(self, poll_interval: float = 60.0, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] Thermocycler.wait_for_profile_completion() called")
  ...
  def serialize(self) -> dict:
    _unilab_logger.debug("[UNILAB] Thermocycler.serialize() called")
