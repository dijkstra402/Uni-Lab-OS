...
Original: microscope/filterwheels/thorlabs.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ThorlabsFilterWheel")
...
class ThorlabsFilterWheel(microscope.abc.FilterWheel):
    ...
    def __init__(self, com, baud=115200, timeout=2.0, **kwargs):
        print("[UNILAB] ThorlabsFilterWheel.__init__() called", flush=True)
    ...
    def _do_shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] ThorlabsFilterWheel._do_shutdown() called")
        pass

    def _do_set_position(self, new_position: int) -> None:
        _unilab_logger.debug("[UNILAB] ThorlabsFilterWheel._do_set_position() called")
        # Thorlabs positions start at 1, hence the +1
        self._send_command("pos=%d" % (new_position + 1))

    def _do_get_position(self):
        _unilab_logger.debug("[UNILAB] ThorlabsFilterWheel._do_get_position() called")
        # Thorlabs positions start at 1, hence the -1
        try:
    ...
    def _readline(self):
        _unilab_logger.debug("[UNILAB] ThorlabsFilterWheel._readline() called")
    ...
    def _send_command(self, command):
        _unilab_logger.debug("[UNILAB] ThorlabsFilterWheel._send_command() called")
