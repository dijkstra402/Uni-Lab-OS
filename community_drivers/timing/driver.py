...
Original: generated/nidaqmx/task/_timing.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Timing")
...
class Timing:
    ...
    def __init__(self, task_handle, interpreter, active_devs: str | Device | None = None):
        print("[UNILAB] Timing.__init__() called", flush=True)
    ...
    def __getitem__(self, dev: str | Device) -> Timing:
        _unilab_logger.debug("[UNILAB] Timing.__getitem__() called")
    ...
    def _raise_device_context_not_supported_error(self) -> NoReturn:
        _unilab_logger.debug("[UNILAB] Timing._raise_device_context_not_supported_error() called")
        raise DaqError(
    ...
    def ai_conv_active_edge(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_active_edge() called")
        """
    ...
    def ai_conv_dig_fltr_enable(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_dig_fltr_enable() called")
        """
    ...
    def ai_conv_dig_fltr_min_pulse_width(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_dig_fltr_min_pulse_width() called")
        """
    ...
    def ai_conv_dig_fltr_timebase_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_dig_fltr_timebase_rate() called")
        """
    ...
    def ai_conv_dig_fltr_timebase_src(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_dig_fltr_timebase_src() called")
        """
    ...
    def ai_conv_dig_sync_enable(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_dig_sync_enable() called")
        """
    ...
    def ai_conv_max_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_max_rate() called")
        """
    ...
    def ai_conv_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_rate() called")
        """
    ...
    def ai_conv_src(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_src() called")
        """
    ...
    def ai_conv_timebase_div(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_timebase_div() called")
        """
    ...
    def ai_conv_timebase_src(self):
        _unilab_logger.debug("[UNILAB] Timing.ai_conv_timebase_src() called")
        """
    ...
    def change_detect_di_falling_edge_physical_chans(self):
        _unilab_logger.debug("[UNILAB] Timing.change_detect_di_falling_edge_physical_chans() called")
        """
    ...
    def change_detect_di_rising_edge_physical_chans(self):
        _unilab_logger.debug("[UNILAB] Timing.change_detect_di_rising_edge_physical_chans() called")
        """
        :class:`nidaqmx.system.physical_channel.PhysicalChannel`:
            Specifies the names of the digital lines or ports on which
    ...
    def change_detect_di_tristate(self):
        _unilab_logger.debug("[UNILAB] Timing.change_detect_di_tristate() called")
        """
    ...
    def delay_from_samp_clk_delay(self):
        _unilab_logger.debug("[UNILAB] Timing.delay_from_samp_clk_delay() called")
        """
    ...
    def delay_from_samp_clk_delay_units(self):
        _unilab_logger.debug("[UNILAB] Timing.delay_from_samp_clk_delay_units() called")
        """
    ...
    def first_samp_clk_offset(self):
        _unilab_logger.debug("[UNILAB] Timing.first_samp_clk_offset() called")
        """
    ...
    def first_samp_clk_timescale(self):
        _unilab_logger.debug("[UNILAB] Timing.first_samp_clk_timescale() called")
        """
    ...
    def first_samp_clk_when(self):
        _unilab_logger.debug("[UNILAB] Timing.first_samp_clk_when() called")
        """
    ...
    def first_samp_timestamp_enable(self):
        _unilab_logger.debug("[UNILAB] Timing.first_samp_timestamp_enable() called")
        """
    ...
    def first_samp_timestamp_timescale(self):
        _unilab_logger.debug("[UNILAB] Timing.first_samp_timestamp_timescale() called")
        """
        :class:`nidaqmx.constants.Timescale`: Specifies the timescale to
    ...
    def first_samp_timestamp_val(self):
        _unilab_logger.debug("[UNILAB] Timing.first_samp_timestamp_val() called")
        """
    ...
    def hshk_delay_after_xfer(self):
        _unilab_logger.debug("[UNILAB] Timing.hshk_delay_after_xfer() called")
        """
    ...
    def hshk_sample_input_data_when(self):
        _unilab_logger.debug("[UNILAB] Timing.hshk_sample_input_data_when() called")
        """
    ...
    def hshk_start_cond(self):
        _unilab_logger.debug("[UNILAB] Timing.hshk_start_cond() called")
        """
    ...
    def implicit_underflow_behavior(self):
        _unilab_logger.debug("[UNILAB] Timing.implicit_underflow_behavior() called")
        """
    ...
    def master_timebase_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.master_timebase_rate() called")
        """
    ...
    def master_timebase_src(self):
        _unilab_logger.debug("[UNILAB] Timing.master_timebase_src() called")
        """
    ...
    def ref_clk_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.ref_clk_rate() called")
        """
    ...
    def ref_clk_src(self):
        _unilab_logger.debug("[UNILAB] Timing.ref_clk_src() called")
        """
    ...
    def samp_clk_active_edge(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_active_edge() called")
        """
    ...
    def samp_clk_dig_fltr_enable(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_dig_fltr_enable() called")
        """
    ...
    def samp_clk_dig_fltr_min_pulse_width(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_dig_fltr_min_pulse_width() called")
        """
        float: Specifies in seconds the minimum pulse width the filter
            recognizes.
        """
    ...
    def samp_clk_dig_fltr_timebase_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_dig_fltr_timebase_rate() called")
        """
    ...
    def samp_clk_dig_fltr_timebase_src(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_dig_fltr_timebase_src() called")
        """
    ...
    def samp_clk_dig_sync_enable(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_dig_sync_enable() called")
        """
        bool: Specifies whether to synchronize recognition of
            transitions in the signal to the internal timebase of the
            device.
    ...
    def samp_clk_max_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_max_rate() called")
        """
    ...
    def samp_clk_overrun_behavior(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_overrun_behavior() called")
        """
    ...
    def samp_clk_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_rate() called")
        """
    ...
    def samp_clk_src(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_src() called")
        """
    ...
    def samp_clk_term(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_term() called")
        """
    ...
    def samp_clk_timebase_active_edge(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_timebase_active_edge() called")
        """
    ...
    def samp_clk_timebase_div(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_timebase_div() called")
        """
    ...
    def samp_clk_timebase_master_timebase_div(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_timebase_master_timebase_div() called")
        """
    ...
    def samp_clk_timebase_rate(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_timebase_rate() called")
        """
    ...
    def samp_clk_timebase_src(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_timebase_src() called")
        """
        str: Specifies the terminal of the signal to use as the Sample
            Clock Timebase.
        """
    ...
    def samp_clk_timebase_term(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_timebase_term() called")
        """
    ...
    def samp_clk_underflow_behavior(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_underflow_behavior() called")
        """
        :class:`nidaqmx.constants.UnderflowBehavior`: Specifies the
            action to take when the onboard memory of the device becomes
    ...
    def samp_clk_write_wfm_use_initial_wfm_dt(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_clk_write_wfm_use_initial_wfm_dt() called")
        """
    ...
    def samp_quant_samp_mode(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_quant_samp_mode() called")
        """
    ...
    def samp_quant_samp_per_chan(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_quant_samp_per_chan() called")
        """
    ...
    def samp_timing_engine(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_timing_engine() called")
        """
    ...
    def samp_timing_type(self):
        _unilab_logger.debug("[UNILAB] Timing.samp_timing_type() called")
        """
    ...
    def simultaneous_ao_enable(self):
        _unilab_logger.debug("[UNILAB] Timing.simultaneous_ao_enable() called")
        """
    ...
    def sync_clk_interval(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_clk_interval() called")
        """
    ...
    def sync_pulse_min_delay_to_start(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_min_delay_to_start() called")
        """
    ...
    def sync_pulse_reset_delay(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_reset_delay() called")
        """
    ...
    def sync_pulse_reset_time(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_reset_time() called")
        """
    ...
    def sync_pulse_src(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_src() called")
        """
        str: Specifies the terminal of the signal to use as the
    ...
    def sync_pulse_sync_time(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_sync_time() called")
        """
    ...
    def sync_pulse_term(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_term() called")
        """
    ...
    def sync_pulse_time_timescale(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_time_timescale() called")
        """
        :class:`nidaqmx.constants.Timescale`: Specifies the timescale to
    ...
    def sync_pulse_time_when(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_time_when() called")
        """
    ...
    def sync_pulse_type(self):
        _unilab_logger.debug("[UNILAB] Timing.sync_pulse_type() called")
        """
