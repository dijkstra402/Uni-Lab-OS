...
Original: donkeycar/parts/datastore.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Tub")
...
class Tub(object):
    ...
    def __init__(self, path, inputs=None, types=None, user_meta=[]):
        print("[UNILAB] Tub.__init__() called", flush=True)
    ...
    def get_last_ix(self):
        _unilab_logger.debug("[UNILAB] Tub.get_last_ix() called")
        index = self.get_index()           
        return max(index)

    def update_df(self):
        _unilab_logger.debug("[UNILAB] Tub.update_df() called")
        import pandas as pd
    ...
    def get_df(self):
        _unilab_logger.debug("[UNILAB] Tub.get_df() called")
        if self.df is None:
            self.update_df()
        return self.df

    def get_index(self, shuffled=True):
        _unilab_logger.debug("[UNILAB] Tub.get_index() called")
        files = next(os.walk(self.path))[2]
        record_files = [f for f in files if f[:6] == 'record']

        def get_file_ix(file_name):
            _unilab_logger.debug("[UNILAB] Tub.get_file_ix() called")
            try:
    ...
    @property
    def inputs(self):
        _unilab_logger.debug("[UNILAB] Tub.inputs() called")
        return list(self.meta['inputs'])

    @property
    def types(self):
        _unilab_logger.debug("[UNILAB] Tub.types() called")
        return list(self.meta['types'])

    def get_input_type(self, key):
        _unilab_logger.debug("[UNILAB] Tub.get_input_type() called")
        input_types = dict(zip(self.inputs, self.types))
        return input_types.get(key)

    def write_json_record(self, json_data):
        _unilab_logger.debug("[UNILAB] Tub.write_json_record() called")
    ...
    def get_num_records(self):
        _unilab_logger.debug("[UNILAB] Tub.get_num_records() called")
        import glob
        files = glob.glob(os.path.join(self.path, 'record_*.json'))
        return len(files)

    def make_record_paths_absolute(self, record_dict):
        _unilab_logger.debug("[UNILAB] Tub.make_record_paths_absolute() called")
        # make paths absolute
        d = {}
    ...
    def check(self, fix=False):
        _unilab_logger.debug("[UNILAB] Tub.check() called")
        """
    ...
    def remove_record(self, ix):
        _unilab_logger.debug("[UNILAB] Tub.remove_record() called")
        '''
    ...
    def put_record(self, data):
        _unilab_logger.debug("[UNILAB] Tub.put_record() called")
        """
    ...
    def erase_last_n_records(self, num_erase):
        _unilab_logger.debug("[UNILAB] Tub.erase_last_n_records() called")
        """
    ...
    def erase_record(self, i):
        _unilab_logger.debug("[UNILAB] Tub.erase_record() called")
    ...
    def get_json_record_path(self, ix):
        _unilab_logger.debug("[UNILAB] Tub.get_json_record_path() called")
        return os.path.join(self.path, 'record_' + str(ix) + '.json')

    def get_json_record(self, ix):
        _unilab_logger.debug("[UNILAB] Tub.get_json_record() called")
    ...
    def get_record(self, ix):
        _unilab_logger.debug("[UNILAB] Tub.get_record() called")
        json_data = self.get_json_record(ix)
        data = self.read_record(json_data)
        return data

    def read_record(self, record_dict):
        _unilab_logger.debug("[UNILAB] Tub.read_record() called")
        data = {}
    ...
    def gather_records(self):
        _unilab_logger.debug("[UNILAB] Tub.gather_records() called")
    ...
    def make_file_name(self, key, ext='.png', ix=None):
        _unilab_logger.debug("[UNILAB] Tub.make_file_name() called")
        this_ix = ix
        if this_ix is None:
    ...
    def delete(self):
        _unilab_logger.debug("[UNILAB] Tub.delete() called")
        """ Delete the folder and files for this tub. """
        import shutil
        shutil.rmtree(self.path)

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] Tub.shutdown() called")
        pass

    def excluded(self, index):
        _unilab_logger.debug("[UNILAB] Tub.excluded() called")
        return index in self.exclude

    def exclude_index(self, index):
        _unilab_logger.debug("[UNILAB] Tub.exclude_index() called")
        self.exclude.add(index)

    def include_index(self, index):
        _unilab_logger.debug("[UNILAB] Tub.include_index() called")
        try:
    ...
    def write_exclude(self):
        _unilab_logger.debug("[UNILAB] Tub.write_exclude() called")
...
class TubWriter(Tub):
    ...
    def run(self, *args):
        _unilab_logger.debug("[UNILAB] Tub.run() called")
        """
...
class TubHandler:
    ...
    def get_tub_list(self, path):
        _unilab_logger.debug("[UNILAB] Tub.get_tub_list() called")
        folders = next(os.walk(path))[1]
        return folders

    def next_tub_number(self, path):
        _unilab_logger.debug("[UNILAB] Tub.next_tub_number() called")
        def get_tub_num(tub_name):
            _unilab_logger.debug("[UNILAB] Tub.get_tub_num() called")
            try:
    ...
    def create_tub_path(self):
        _unilab_logger.debug("[UNILAB] Tub.create_tub_path() called")
    ...
    def new_tub_writer(self, inputs, types, user_meta=[]):
        _unilab_logger.debug("[UNILAB] Tub.new_tub_writer() called")
...
class TubImageStacker(Tub):
    ...
    def rgb2gray(self, rgb):
        _unilab_logger.debug("[UNILAB] Tub.rgb2gray() called")
        '''
    ...
    def stack3Images(self, img_a, img_b, img_c):
        _unilab_logger.debug("[UNILAB] Tub.stack3Images() called")
        '''
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Tub.__init__() called")
...
class TubGroup(Tub):
    ...
    def find_tub_paths(self, path):
        _unilab_logger.debug("[UNILAB] Tub.find_tub_paths() called")
        matches = []
    ...
    def resolve_tub_paths(self, path_list):
        _unilab_logger.debug("[UNILAB] Tub.resolve_tub_paths() called")
