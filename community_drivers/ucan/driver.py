...
Original: can/interfaces/systec/ucanbus.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Ucan")
...
from can.interfaces.systec.exceptions import UcanException
from can.interfaces.systec.structures import *
from can.interfaces.systec.ucan import UcanServer
...
class Ucan(UcanServer):
    ...
    def __init__(self):
        print("[UNILAB] Ucan.__init__() called", flush=True)
        super().__init__()
        self._msg_received_event = Event()

    def can_msg_received_event(self, channel):
        _unilab_logger.debug("[UNILAB] Ucan.can_msg_received_event() called")
        self._msg_received_event.set()

    def read_can_msg(self, channel, count, timeout):
        _unilab_logger.debug("[UNILAB] Ucan.read_can_msg() called")
...
class UcanBus(BusABC):
    ...
    def _recv_internal(self, timeout):
        _unilab_logger.debug("[UNILAB] Ucan._recv_internal() called")
        try:
    ...
    def send(self, msg, timeout=None):
        _unilab_logger.debug("[UNILAB] Ucan.send() called")
        """
    ...
    def _detect_available_configs():
        _unilab_logger.debug("[UNILAB] Ucan._detect_available_configs() called")
        configs = []
        try:
    ...
    def _apply_filters(self, filters):
        _unilab_logger.debug("[UNILAB] Ucan._apply_filters() called")
        try:
    ...
    def flush_tx_buffer(self):
        _unilab_logger.debug("[UNILAB] Ucan.flush_tx_buffer() called")
        """
    ...
    def create_filter(extended, from_id, to_id, rtr_only, rtr_too):
        _unilab_logger.debug("[UNILAB] Ucan.create_filter() called")
        """
    ...
    @property
    def state(self):
        _unilab_logger.debug("[UNILAB] Ucan.state() called")
        return self._state
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] Ucan.shutdown() called")
        """
