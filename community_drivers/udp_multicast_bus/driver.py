...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UdpMulticastBus")
...
class UdpMulticastBus(BusABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("[UNILAB] UdpMulticastBus.__init__() called", flush=True)
    ...
    @property
    def is_fd(self) -> bool:
        _unilab_logger.debug("[UNILAB] UdpMulticastBus.is_fd() called")
    ...
    def _recv_internal(self, timeout: float | None) -> tuple[Message | None, bool]:
        _unilab_logger.debug("[UNILAB] UdpMulticastBus._recv_internal() called")
    ...
    def send(self, msg: can.Message, timeout: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] UdpMulticastBus.send() called")
    ...
    def fileno(self) -> int:
        _unilab_logger.debug("[UNILAB] UdpMulticastBus.fileno() called")
        """Provides the internally used file descriptor of the socket or `-1` if not available."""
        return self._multicast.fileno()

    def shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] UdpMulticastBus.shutdown() called")
    ...
    def _detect_available_configs() -> list[AutoDetectedConfig]:
        _unilab_logger.debug("[UNILAB] UdpMulticastBus._detect_available_configs() called")
