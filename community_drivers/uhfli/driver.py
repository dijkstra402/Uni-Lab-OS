...
Original: src/zhinst/qcodes/driver/devices/uhfli.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UHFLI")
...
class UHFLI(ZIBaseInstrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] UHFLI.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def _init_additional_nodes(self):
        _unilab_logger.debug("[UNILAB] UHFLI._init_additional_nodes() called")
