...
Original: src/zhinst/qcodes/driver/devices/uhfqa.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UHFQA")
...
class UHFQA(ZIBaseInstrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] UHFQA.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def _init_additional_nodes(self):
        _unilab_logger.debug("[UNILAB] UHFQA._init_additional_nodes() called")
    ...
    def enable_qccs_mode(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA.enable_qccs_mode() called")
