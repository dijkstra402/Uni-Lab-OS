...
Original: pycqed/instrument_drivers/physical_instruments/ZurichInstruments/UHFQA_core.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UHFQA_core")
...
class UHFQA_core(zibase.ZI_base_instrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] UHFQA_core.__init__() called", flush=True)
    ...
    def _check_options(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core._check_options() called")
        """
    ...
    def _check_versions(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core._check_versions() called")
        """
    ...
    def _check_awg_nr(self, awg_nr) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core._check_awg_nr() called")
        """
    ...
    def _num_channels(self) -> int:
        _unilab_logger.debug("[UNILAB] UHFQA_core._num_channels() called")
        return 2

    def _add_extra_parameters(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core._add_extra_parameters() called")
        """
    ...
    def assure_ext_clock(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.assure_ext_clock() called")
        """
    ...
    def clear_errors(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.clear_errors() called")
        super().clear_errors()
        self.qas_0_result_reset(1)
        self.qas_0_monitor_reset(1)

    def load_default_settings(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.load_default_settings() called")
    ...
    def clock_freq(self):
        _unilab_logger.debug("[UNILAB] UHFQA_core.clock_freq() called")
        return 1.8e9
    ...
    def reset_acquisition_params(self):
        _unilab_logger.debug("[UNILAB] UHFQA_core.reset_acquisition_params() called")
    ...
    def reset_crosstalk_matrix(self):
        _unilab_logger.debug("[UNILAB] UHFQA_core.reset_crosstalk_matrix() called")
        self.upload_crosstalk_matrix(np.eye(self._nr_integration_channels))

    def reset_correlation_params(self):
        _unilab_logger.debug("[UNILAB] UHFQA_core.reset_correlation_params() called")
        for i in range(self._nr_integration_channels):
    ...
    def reset_rotation_params(self):
        _unilab_logger.debug("[UNILAB] UHFQA_core.reset_rotation_params() called")
        for i in range(self._nr_integration_channels):
            self.set('qas_0_rotations_{}'.format(i), 1+1j)

    def upload_crosstalk_matrix(self, matrix) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.upload_crosstalk_matrix() called")
        """
    ...
    def download_crosstalk_matrix(self, nr_rows=10, nr_cols=10):
        _unilab_logger.debug("[UNILAB] UHFQA_core.download_crosstalk_matrix() called")
        """
        Upload parameters for the 10*10 crosstalk suppression matrix.
    ...
    def print_correlation_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_correlation_overview() called")
    ...
    def print_deskew_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_deskew_overview() called")
        msg = '\tDeskew overview \n'
    ...
    def print_crosstalk_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_crosstalk_overview() called")
    ...
    def print_integration_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_integration_overview() called")
    ...
    def print_rotations_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_rotations_overview() called")
    ...
    def print_thresholds_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_thresholds_overview() called")
    ...
    def print_user_regs_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_user_regs_overview() called")
    ...
    def print_overview(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.print_overview() called")
        """
    ...
    def acquisition_arm(self, single=True) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.acquisition() called")
        # time.sleep(0.01)
    ...
    def acquisition_finalize(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core.acquisition_poll() called")
        self.stop()
        self.unsubs()
    ...
    def _reset_awg_program_features(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core._reset_awg_program_features() called")
        """
    ...
    def _get_minimum_holdoff(self):
        _unilab_logger.debug("[UNILAB] UHFQA_core._get_minimum_holdoff() called")
    ...
    def _set_wait_dly(self, value) -> None:
        _unilab_logger.debug("[UNILAB] UHFQA_core._set_wait_dly() called")
        self.set('awgs_0_userregs_{}'.format(UHFQA_core.USER_REG_WAIT_DLY), value)

    def _get_wait_dly(self):
        _unilab_logger.debug("[UNILAB] UHFQA_core._get_wait_dly() called")
