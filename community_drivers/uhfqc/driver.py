...
Original: pycqed/instrument_drivers/physical_instruments/ZurichInstruments/UHFQuantumController.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UHFQC")
...
class UHFQC(uhf.UHFQA_core, DIO.CalInterface):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] UHFQC.__init__() called", flush=True)
    ...
    def load_awg_program_from_file(self, filename) -> None:
        _unilab_logger.debug("[UNILAB] UHFQC.load_awg_program_from_file() called")
        """
    ...
    def plot_dio(self, bits=range(32), line_length=64) -> None:
        _unilab_logger.debug("[UNILAB] UHFQC.plot_dio() called")
    ...
    def prepare_SSB_weight_and_rotation(
        ...
        _unilab_logger.debug("[UNILAB] UHFQC.prepare_SSB_weight_and_rotation() called")
        """
    ...
    def prepare_DSB_weight_and_rotation(
        ...
        _unilab_logger.debug("[UNILAB] UHFQC.prepare_DSB_weight_and_rotation() called")
        trace_length = 4096
        tbase = np.arange(0, trace_length/1.8e9, 1/1.8e9)
    ...
    def _add_extra_parameters(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQC._add_extra_parameters() called")
        """
    ...
    def _codeword_table_preamble(self, awg_nr) -> str:
        _unilab_logger.debug("[UNILAB] UHFQC._codeword_table_preamble() called")
        """
    ...
    def plot_dio_snapshot(self, bits=range(32)):
        _unilab_logger.debug("[UNILAB] UHFQC.plot_dio_snapshot() called")
    ...
    def _reset_awg_program_features(self) -> None:
        _unilab_logger.debug("[UNILAB] UHFQC.snapshot_base() called")
        """
    ...
    def _set_dio_calibration_delay(self, value) -> None:
        _unilab_logger.debug("[UNILAB] UHFQC._set_dio_calibration_delay() called")
