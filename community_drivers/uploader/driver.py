...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Uploader")
...
class Uploader(wx.Frame):
    ...
    def __init__(self, parent, boards, title, cfg, cwd, conn):
        print("[UNILAB] Uploader.__init__() called", flush=True)
    ...
    def init_ui(self):
        _unilab_logger.debug("[UNILAB] Uploader.init_ui() called")
        menubar = wx.MenuBar()
        menu = wx.Menu()
    ...
    def hide_ioconfig(self, s):
        _unilab_logger.debug("[UNILAB] Uploader.hide_ioconfig() called")
        if s:
    ...
    def on_timer(self, e):
        _unilab_logger.debug("[UNILAB] Uploader.on_timer() called")
    ...
    def on_port(self, e):
        _unilab_logger.debug("[UNILAB] Uploader.on_port() called")
    ...
    def on_config_change(self, msg):
        _unilab_logger.debug("[UNILAB] Uploader.on_config_change() called")
    ...
    def get_config(self):
        _unilab_logger.debug("[UNILAB] Uploader.get_config() called")
        return {
            'id': self.board_id,
    ...
    def load_config(self):
        _unilab_logger.debug("[UNILAB] Uploader.load_config() called")
        try:
    ...
    def save_config(self):
        _unilab_logger.debug("[UNILAB] Uploader.save_config() called")
        s = self.get_config()
        with open(self.cfg, 'wb') as h:
            pickle.dump(s, h, protocol=pickle.HIGHEST_PROTOCOL)

    def on_upload(self, e):
        _unilab_logger.debug("[UNILAB] Uploader.on_upload() called")
        s = self.get_config()
        if not self.worker:
            self.cb_boot_en.Enable(False)
            self.bt_3.Enable(False)
    ...
    def on_close(self, e):
        _unilab_logger.debug("[UNILAB] Uploader.on_close() called")

        def kill_after(tries):
            _unilab_logger.debug("[UNILAB] Uploader.kill_after() called")
    ...
    def on_result(self, e):
        _unilab_logger.debug("[UNILAB] Uploader.on_result() called")
        if not e['busy']:
            self.worker = None
            self.cb_boot_en.Enable(self.bootloader_en)
    ...
    def on_combo(self, e):
        _unilab_logger.debug("[UNILAB] Uploader.on_combo() called")
    ...
    def on_update(self, e):
        _unilab_logger.debug("[UNILAB] Uploader.on_update() called")
        global exit_code
