...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.USBtin")
...
# Vendored repo packages: pyusbtin, pyusbtin
import sys as _sys
...
class USBtin(object):
    ...
    def __init__(self):
        print("[UNILAB] USBtin.__init__() called", flush=True)
        """ initialiser """
        self.id = 0
    ...
    def get_firmware_version(self):
        _unilab_logger.debug("[UNILAB] USBtin.get_firmware_version() called")
        """ get firmware version that was acquired during connect() """
        return self.firmware_version

    def get_hardware_version(self):
        _unilab_logger.debug("[UNILAB] USBtin.get_hardware_version() called")
        """ get hardware version that was acquired during connect() """
        return self.hardware_version

    def get_serial_number(self):
        _unilab_logger.debug("[UNILAB] USBtin.get_serial_number() called")
        """ get serial number that was acquired during connect()"""
        return self.serial_number

    def connect(self, port):
        _unilab_logger.debug("[UNILAB] USBtin.connect() called")
    ...
    def transmit(self, cmd):
        _unilab_logger.debug("[UNILAB] USBtin.transmit() called")
    ...
    def read_response(self):
        _unilab_logger.debug("[UNILAB] USBtin.read_response() called")
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] USBtin.disconnect() called")
    ...
    def open_can_channel(self, baudrate, mode):
        _unilab_logger.debug("[UNILAB] USBtin.open_can_channel() called")
        """Open CAN channel.
    ...
    def start_rx_thread(self):
        _unilab_logger.debug("[UNILAB] USBtin.start_rx_thread() called")
    ...
    def stop_rx_thread(self):
        _unilab_logger.debug("[UNILAB] USBtin.stop_rx_thread() called")
    ...
    def rx_thread(self):
        _unilab_logger.debug("[UNILAB] USBtin.rx_thread() called")
    ...
    def close_can_channel(self):
        _unilab_logger.debug("[UNILAB] USBtin.close_can_channel() called")
        """Close CAN channel."""
        try:
            self.stop_rx_thread()
            self.serial_port.write("C\r".encode('ascii'))
    ...
    def add_message_listener(self, func):
        _unilab_logger.debug("[UNILAB] USBtin.add_message_listener() called")
        """ add a message listener (callback)"""
        self.listeners.append(func)

    def remove_message_listener(self, func):
        _unilab_logger.debug("[UNILAB] USBtin.remove_message_listener() called")
    ...
    def send_first_tx_fifo_message(self):
        _unilab_logger.debug("[UNILAB] USBtin.send_first_tx_fifo_message() called")
    ...
    def send(self, canmsg):
        _unilab_logger.debug("[UNILAB] USBtin.send() called")
    ...
    def write_mcp_register(self, register, value):
        _unilab_logger.debug("[UNILAB] USBtin.write_mcp_register() called")
    ...
    def write_mcp_filter_mask_registers(self, maskid, registers):
        _unilab_logger.debug("[UNILAB] USBtin.write_mcp_filter_mask_registers() called")
    ...
    def write_mcp_filter_registers(self, filterid, registers):
        _unilab_logger.debug("[UNILAB] USBtin.write_mcp_filter_registers() called")
    ...
    def set_filter(self, fc):
        _unilab_logger.debug("[UNILAB] USBtin.set_filter() called")
