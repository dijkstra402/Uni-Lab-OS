...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.USB2FIR")
...
# Vendored repo packages: pyusb2fir
import sys as _sys
...
class USB2FIR(object):
    def __init__(self, i2caddress=0x33, refreshRate=3):
        print("[UNILAB] USB2FIR.__init__() called", flush=True)
        """
    ...
    def echo_test(self, echovalue):
        _unilab_logger.debug("[UNILAB] USB2FIR.echo_test() called")
        """
    ...
    def get_capability(self):
        _unilab_logger.debug("[UNILAB] USB2FIR.get_capability() called")
        """
    ...
    def get_status(self):
        _unilab_logger.debug("[UNILAB] USB2FIR.get_status() called")
        """
    ...
    def start_bootloader(self):
        _unilab_logger.debug("[UNILAB] USB2FIR.start_bootloader() called")
        """
        Jump to bootloader.
        """
    ...
    def read_memory(self, startaddress, length):
        _unilab_logger.debug("[UNILAB] USB2FIR.read_memory() called")
        """
    ...
    def write_memory(self, startaddress, data):
        _unilab_logger.debug("[UNILAB] USB2FIR.write_memory() called")
        """
