...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.VCN")
...
from pcdsdevices.stopper import PPSStopper, Stopper  # noqa import PPS for backcompat
...
class VCN(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] VCN.__init__() called", flush=True)
