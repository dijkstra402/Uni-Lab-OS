...
Original: packages/pymodaq_gui/src/pymodaq_gui/plotting/data_viewers/viewer2D.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.View2D")
...
class View2D(ActionManager, QtCore.QObject):
    ...
    def __init__(self, parent_widget=None):
        print("[UNILAB] View2D.__init__() called", flush=True)
    ...
    def clear_plot_item(self):
        _unilab_logger.debug("[UNILAB] View2D.clear_plot_item() called")
    ...
    def set_image_displayer(self, data_distribution: DataDistribution):
        _unilab_logger.debug("[UNILAB] View2D.set_image_displayer() called")
    ...
    def show_roi_target(self, show=True):
        _unilab_logger.debug("[UNILAB] View2D.show_roi_target() called")
        self.roi_target.setVisible(show)

    def move_scale_roi_target(self, pos=None, size=None):
        _unilab_logger.debug("[UNILAB] View2D.move_scale_roi_target() called")
        """
    ...
    def setup_widgets(self):
        _unilab_logger.debug("[UNILAB] View2D.setup_widgets() called")
    ...
    def setup_graphs(self, graphs_layout):
        _unilab_logger.debug("[UNILAB] View2D.setup_graphs() called")
    ...
    def setup_actions(self):
        _unilab_logger.debug("[UNILAB] View2D.setup_actions() called")
    ...
    def update_colors(self, colors: list):
        _unilab_logger.debug("[UNILAB] View2D.update_colors() called")
    ...
    def connect_things(self):
        _unilab_logger.debug("[UNILAB] View2D.connect_things() called")
    ...
    def show_legend(self, show=True):
        _unilab_logger.debug("[UNILAB] View2D.show_legend() called")
        self.data_displayer.show_legend(show)

    @Slot(str)
    def add_roi_displayer(self, roi_name=''):
        _unilab_logger.debug("[UNILAB] View2D.add_roi_displayer() called")
    ...
    def remove_roi_displayer(self, roi_name=''):
        _unilab_logger.debug("[UNILAB] View2D.remove_roi_displayer() called")
    ...
    def update_roi_channels(self, roi_name):
        _unilab_logger.debug("[UNILAB] View2D.update_roi_channels() called")
    ...
    def prepare_ui(self):
        _unilab_logger.debug("[UNILAB] View2D.prepare_ui() called")
    ...
    def display_images(self, datas):
        _unilab_logger.debug("[UNILAB] View2D.display_images() called")
    ...
    def display_roi_lineouts(self, roi_dte: DataToExport):
        _unilab_logger.debug("[UNILAB] View2D.display_roi_lineouts() called")
        if len(roi_dte) > 0:
    ...
    def display_crosshair_lineouts(self, crosshair_dte: DataToExport):
        _unilab_logger.debug("[UNILAB] View2D.display_crosshair_lineouts() called")
        for lineout_type in self.lineout_types:
    ...
    def show_lineout_widgets(self):
        _unilab_logger.debug("[UNILAB] View2D.show_lineout_widgets() called")
    ...
    def roi_clicked(self, isroichecked=True):
        _unilab_logger.debug("[UNILAB] View2D.roi_clicked() called")
    ...
    def get_visible_images(self):
        _unilab_logger.debug("[UNILAB] View2D.get_visible_images() called")
        are_items_visible = []
        for key in IMAGE_TYPES:
    ...
    def notify_visibility_data_displayer(self):
        _unilab_logger.debug("[UNILAB] View2D.notify_visibility_data_displayer() called")
    ...
    def show_hide_histogram(self, show=True):
        _unilab_logger.debug("[UNILAB] View2D.show_hide_histogram() called")
        are_items_visible = self.get_visible_images()
        self.histogrammer.show_hide_histogram(show, are_items_visible)

    def prepare_image_widget_for_lineouts(self, ratio=0.7):
        _unilab_logger.debug("[UNILAB] View2D.prepare_image_widget_for_lineouts() called")
    ...
    def collapse_lineout_widgets(self):
        _unilab_logger.debug("[UNILAB] View2D.collapse_lineout_widgets() called")
        self.prepare_image_widget_for_lineouts(ratio=1)

    def get_view_range(self):
        _unilab_logger.debug("[UNILAB] View2D.get_view_range() called")
        return self.image_widget.view.viewRange()

    def get_data_at(self, name='red', xy=(0, 0)):
        _unilab_logger.debug("[UNILAB] View2D.get_data_at() called")
        return self.data_displayer.get_image(name).get_val_at(xy)

    def lock_aspect_ratio(self):
        _unilab_logger.debug("[UNILAB] View2D.lock_aspect_ratio() called")
    ...
    def move_left_splitter(self, pos, index):
        _unilab_logger.debug("[UNILAB] View2D.move_left_splitter() called")
    ...
    def move_right_splitter(self, pos, index):
        _unilab_logger.debug("[UNILAB] View2D.move_right_splitter() called")
    ...
    def get_double_clicked(self):
        _unilab_logger.debug("[UNILAB] View2D.get_double_clicked() called")
        return self.image_widget.view.sig_double_clicked

    def get_axis(self, position='left') -> AxisItem_Scaled:
        _unilab_logger.debug("[UNILAB] View2D.get_axis() called")
    ...
    def show_ROI_select(self):
        _unilab_logger.debug("[UNILAB] View2D.show_ROI_select() called")
    ...
    def set_image_labels(self, labels: List[str]):
        _unilab_logger.debug("[UNILAB] View2D.set_image_labels() called")
    ...
    def set_axis_label(self, position, label='', units=''):
        _unilab_logger.debug("[UNILAB] View2D.set_axis_label() called")
        """
    ...
    def get_axis_label(self, position):
        _unilab_logger.debug("[UNILAB] View2D.get_axis_label() called")
        axis = self.get_axis(position)
        return axis.axis_label, axis.axis_units

    def set_axis_scaling(self, position='top', scaling=1, offset=0, label='', units='Pxls'):
        _unilab_logger.debug("[UNILAB] View2D.set_axis_scaling() called")
        """
    ...
    def scale_axis(self, xaxis, yaxis):
        _unilab_logger.debug("[UNILAB] View2D.scale_axis() called")
    ...
    def unscale_axis(self, xaxis, yaxis):
        _unilab_logger.debug("[UNILAB] View2D.unscale_axis() called")
    ...
    def _get_axis_scaling_offset(self):
        _unilab_logger.debug("[UNILAB] View2D._get_axis_scaling_offset() called")
