...
Original: packages/pymodaq_gui/src/pymodaq_gui/plotting/data_viewers/viewer1D.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Viewer1D")
...
class Viewer1D(ViewerBase):
    ...
    def update_colors(self, colors: List, displayer=None):
        print("[UNILAB] Viewer1D.__init__() called", flush=True)
        if displayer is None:
    ...
    def process_roi_lineouts(self, roi_dte: DataToExport):
        _unilab_logger.debug("[UNILAB] Viewer1D.process_roi_lineouts() called")
    ...
    def prepare_connect_ui(self):
        _unilab_logger.debug("[UNILAB] Viewer1D.prepare_connect_ui() called")
    ...
    def selected_region_changed(self):
        _unilab_logger.debug("[UNILAB] Viewer1D.selected_region_changed() called")
    ...
    def double_clicked(self, posx, posy=0):
        _unilab_logger.debug("[UNILAB] Viewer1D.double_clicked() called")
    ...
    def get_axis_from_view(self, data: DataWithAxes):
        _unilab_logger.debug("[UNILAB] Viewer1D._show_data() called")
    ...
    def update_status(self, txt):
        _unilab_logger.debug("[UNILAB] Viewer1D.update_status() called")
        logger.info(txt)
