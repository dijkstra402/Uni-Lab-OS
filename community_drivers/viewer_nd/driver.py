...
Original: packages/pymodaq_gui/src/pymodaq_gui/plotting/data_viewers/viewerND.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ViewerND")
...
class ViewerND(ParameterManager, ActionManager, ViewerBase):
    ...
    def __init__(self, parent: QtWidgets.QWidget = None, title=''):
        print("[UNILAB] ViewerND.__init__() called", flush=True)
    ...
    def update_data_displayer(self, distribution: DataDistribution):
        _unilab_logger.debug("[UNILAB] ViewerND.update_data_displayer() called")
    ...
    def _show_data(self, data: DataRaw, **kwargs):
        _unilab_logger.debug("[UNILAB] ViewerND._show_data() called")
        force_update = False
    ...
    def set_data_test(self, data_shape='3D'):
        _unilab_logger.debug("[UNILAB] ViewerND.set_data_test() called")
    ...
    def update_filters(self, processor: DataProcessorFactory):
        _unilab_logger.debug("[UNILAB] ViewerND.update_widget_visibility() called")
    ...
    def show_settings(self, show: bool = True):
        _unilab_logger.debug("[UNILAB] ViewerND.show_settings() called")
        if show:
    ...
    def prepare_ui(self):
        _unilab_logger.debug("[UNILAB] ViewerND.prepare_ui() called")
    ...
    def setup_actions(self):
        _unilab_logger.debug("[UNILAB] ViewerND.setup_actions() called")
    ...
    def reshape_data(self):
        _unilab_logger.debug("[UNILAB] ViewerND.reshape_data() called")
    ...
    def connect_things(self):
        _unilab_logger.debug("[UNILAB] ViewerND.connect_things() called")
    ...
    def setup_widgets(self):
        _unilab_logger.debug("[UNILAB] ViewerND.setup_widgets() called")
    ...
    def update_data_dim(self, dim: str):
        _unilab_logger.debug("[UNILAB] ViewerND.update_data_dim() called")
