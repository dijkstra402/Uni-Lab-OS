...
Original: can/interfaces/virtual.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.VirtualBus")
...
class VirtualBus(BusABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("[UNILAB] VirtualBus.__init__() called", flush=True)
        """
    ...
    def _check_if_open(self) -> None:
        _unilab_logger.debug("[UNILAB] VirtualBus._check_if_open() called")
    ...
    def _recv_internal(self, timeout: float | None) -> tuple[Message | None, bool]:
        _unilab_logger.debug("[UNILAB] VirtualBus._recv_internal() called")
        self._check_if_open()
        try:
    ...
    def send(self, msg: Message, timeout: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] VirtualBus.send() called")
        self._check_if_open()
    ...
    def shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] VirtualBus.shutdown() called")
        super().shutdown()
        if self._open:
            self._open = False
    ...
    def _detect_available_configs() -> list[AutoDetectedConfig]:
        _unilab_logger.debug("[UNILAB] VirtualBus._detect_available_configs() called")
        """
        ...
        def get_extra() -> str:
            _unilab_logger.debug("[UNILAB] VirtualBus.get_extra() called")
