...
Original: src/labtoolkit/PowerAnalyser/VoltechPM1000P.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.VoltechPM1000P")
...
class VoltechPM1000P(IEEE488):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] VoltechPM1000P.__init__() called", flush=True)
