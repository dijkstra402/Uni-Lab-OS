...
Original: pica/keithley/k2400_2182/RT_K2400_K2182_L350_T_Sensing_GUI.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.VT_Backend_Passive")
...
class VT_Backend_Passive:
    ...
    def __init__(self):
        print("[UNILAB] VT_Backend_Passive.__init__() called", flush=True)
    ...
    def connect(self, k2400_visa, k2182_visa, ls_visa):
        _unilab_logger.debug("[UNILAB] VT_Backend_Passive.connect() called")
        if not self.rm:
    ...
    def configure_instruments(self, current_ma, compliance_v):
        _unilab_logger.debug("[UNILAB] VT_Backend_Passive.configure_instruments() called")
    ...
    def get_measurement(self):
        _unilab_logger.debug("[UNILAB] VT_Backend_Passive.get_measurement() called")
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] VT_Backend_Passive.shutdown() called")
        if self.k2400:
            try:
                self.k2400.shutdown()
