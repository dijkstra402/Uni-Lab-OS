...
Original: imswitch/imcontrol/model/managers/NidaqManager.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.WaitThread")
...
class WaitThread(Thread):
    ...
    def __init__(self, *args, **lowLevelManagers):
        print("[UNILAB] WaitThread.__init__() called", flush=True)
        super().__init__(*args, **lowLevelManagers)
        self.task = None
        self.running = False

    def connect(self, task):
        _unilab_logger.debug("[UNILAB] WaitThread.connect() called")
        self.task = task
        self.running = True

    def run(self):
        _unilab_logger.debug("[UNILAB] WaitThread.run() called")
        if self.running:
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] WaitThread.close() called")
        self.running = False
