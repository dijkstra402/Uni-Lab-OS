...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.WasatchDemo")
...
# Vendored repo packages: wasatch
import sys as _sys
...
class WasatchDemo:
    ...
    def __init__(self):
        print("[UNILAB] WasatchDemo.__init__() called", flush=True)
    ...
    def parse_args(self):
        _unilab_logger.debug("[UNILAB] WasatchDemo.parse_args() called")
    ...
    def connect(self):
        _unilab_logger.debug("[UNILAB] WasatchDemo.connect() called")
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] WasatchDemo.run() called")
