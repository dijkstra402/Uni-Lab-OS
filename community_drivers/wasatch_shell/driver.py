...
Original: WasatchShell/wasatch-shell.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.WasatchShell")
...
# Vendored repo packages: WasatchShell, wasatch
import sys as _sys
...
class WasatchShell:
    ...
    def __init__(self):
        print("[UNILAB] WasatchShell.__init__() called", flush=True)
    ...
    def usage(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.usage() called")
    ...
    def disconnected(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.disconnected() called")
    ...
    def get_line(self, prompt="args> "):
        _unilab_logger.debug("[UNILAB] WasatchShell.get_line() called")
        return input(prompt).strip()

    def has_input(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.has_input() called")
        return self.input_tokens is not None and len(self.input_tokens) > 0

    def get_next_token(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.get_next_token() called")
    ...
    def read_bool(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.read_bool() called")
        s = self.get_next_token()
        return re.match("1|true|yes|on", s.lower()) is not None

    def read_int(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.read_int() called")
        return int(self.get_next_token())

    def read_float(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.read_float() called")
        return float(self.get_next_token())

    def read_str(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.read_str() called")
        return self.get_next_token()

    def display(self, msg):
        _unilab_logger.debug("[UNILAB] WasatchShell.display() called")
        log.info(">> %s", msg)
        print(msg)
        sys.stdout.flush()

    def configure_logging(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.configure_logging() called")
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.run() called")
        self.display("-" * 80)
    ...
    def open(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.open() called")
    ...
    def run_gettor(self, command):
        _unilab_logger.debug("[UNILAB] WasatchShell.run_gettor() called")
    ...
    def get_dark(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.get_dark() called")
        spectrum = self.get_spectrum(quiet=True)
        self.dark_spectra = spectrum

    def clear_dark(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.clear_dark() called")
        self.dark_spectra = None
    ...
    def get_spectrum(self, quiet=True):
        _unilab_logger.debug("[UNILAB] WasatchShell.set_raman_intensity_correction_enable() called")
    ...
    def get_spectrum_save(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.get_spectrum_save() called")
    ...
    def get_spectrum_pretty(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.get_spectrum_pretty() called")
        spectrum = self.get_spectrum()
        if spectrum is None:
            return 
    ...
    def set_laser_enable(self, flag, quiet=False):
        _unilab_logger.debug("[UNILAB] WasatchShell.set_laser_enable() called")
    ...
    def generate_interpolated_x_axis(self, start, end, incr):
        _unilab_logger.debug("[UNILAB] WasatchShell.generate_interpolated_x_axis() called")
    ...
    def set_interpolated_x_axis_cm(self, start, end, incr):
        _unilab_logger.debug("[UNILAB] WasatchShell.set_interpolated_x_axis_cm() called")
    ...
    def set_interpolated_x_axis_nm(self, start, end, incr):
        _unilab_logger.debug("[UNILAB] WasatchShell.set_interpolated_x_axis_nm() called")
        self.interpolated_x_axis_nm = self.generate_interpolated_x_axis(start, end, incr)
        self.display(1)

    def clear(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.clear() called")
    ...
    def balance_acquisition(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.balance_acquisition() called")
    ...
    def get_all(self):
        _unilab_logger.debug("[UNILAB] WasatchShell.get_all() called")
