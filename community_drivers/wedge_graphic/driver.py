...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.WedgeGraphic")
...
class WedgeGraphic(Graphic):
    ...
    def __init__(self) -> None:
        print("[UNILAB] WedgeGraphic.__init__() called", flush=True)
        ...
        def validate_angles(value: typing.Tuple[float, float]) -> typing.Tuple[float, float]:
            _unilab_logger.debug("[UNILAB] WedgeGraphic.validate_angles() called")
    ...
    def angle_interval(self) -> typing.Tuple[float, float]:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.angle_interval() called")
    ...
    def mime_data_dict(self) -> Persistence.PersistentDictType:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.mime_data_dict() called")
        d = super().mime_data_dict()
        d["angle_interval"] = self.angle_interval
        return d

    def read_from_mime_data(self, graphic_dict: Persistence.PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.read_from_mime_data() called")
        super().read_from_mime_data(graphic_dict)
        self.angle_interval = graphic_dict.get("angle_interval", self.angle_interval)

    def get_attributes(self) -> set[GraphicAttributeEnum]:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.get_attributes() called")
        return {GraphicAttributeEnum.TWO_DIMENSIONAL, GraphicAttributeEnum.FOURIER_MASK}

    @property
    def used_role(self) -> typing.Optional[str]:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.used_role() called")
        return "fourier_mask"

    @property
    def start_angle(self) -> float:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.start_angle() called")
    ...
    def end_angle(self) -> float:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.end_angle() called")
    ...
    def __start_angle_internal(self) -> float:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.__start_angle_internal() called")
    ...
    def __end_angle_internal(self) -> float:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.__end_angle_internal() called")
    ...
    # test is required for Graphic interface
    def test(self, mapping: CoordinateMappingLike, ui_settings: UISettings.UISettings, p: Geometry.FloatPoint, move_only: bool) -> typing.Tuple[typing.Optional[str], bool]:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.test() called")
        # first convert to widget coordinates since test distances
        # are specified in widget coordinates
    ...
    def begin_drag(self) -> DragPartData:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.begin_drag() called")
        return self.__start_angle_internal, self.__end_angle_internal

    def end_drag(self, part_data: DragPartData) -> None:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.end_drag() called")
        self.__first_drag = False

    def adjust_part(self, mapping: CoordinateMappingLike, original: Geometry.FloatPoint, current: Geometry.FloatPoint, part: DragPartDataPlus, modifiers: ModifiersLike) -> None:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.adjust_part() called")
    ...
    def get_region(self) -> WedgeRegion:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.get_region() called")
        return WedgeRegion(self.start_angle, self.end_angle)

    def get_mask_item(self) -> MaskItem:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.get_mask_item() called")
        return WedgeMaskItem(self.start_angle, self.end_angle)

    def _draw(self, ctx: DrawingContextLike, ui_settings: UISettings.UISettings, mapping: CoordinateMappingLike, is_selected: bool, is_focused: bool) -> None:
        _unilab_logger.debug("[UNILAB] WedgeGraphic._draw() called")
        center = mapping.calibrated_origin_widget
        ...
        def draw_mask(sign: float) -> None:
            _unilab_logger.debug("[UNILAB] WedgeGraphic.draw_mask() called")
    ...
    def label_position(self, mapping: CoordinateMappingLike, font_metrics: UISettings.FontMetrics, padding: float) -> typing.Optional[Geometry.FloatPoint]:
        _unilab_logger.debug("[UNILAB] WedgeGraphic.label_position() called")
