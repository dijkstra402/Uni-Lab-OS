...
Original: src/labtoolkit/NetworkAnalyser/Wiltron360.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Wiltron360")
...
class Wiltron360(Instrument):
    ...
    def __init__(self, inst):
        print("[UNILAB] Wiltron360.__init__() called", flush=True)
        super().__init__(inst)
        self.inst = inst
    ...
    def xaxis(self):
        _unilab_logger.debug("[UNILAB] Wiltron360.xaxis() called")
        return np.array(self.query('FMA OFV').replace(' ', '').strip().split('\n'), dtype=np.float64)

    def yaxis(self):
        _unilab_logger.debug("[UNILAB] Wiltron360.yaxis() called")
    ...
    def trace(self, trace=None):
        _unilab_logger.debug("[UNILAB] Wiltron360.trace() called")
        # x = self.xaxis()
        if trace:
            self.select(trace)
        # print(np.column_stack((x, y.real, y.imag)))
    ...
    def traces(self):
        _unilab_logger.debug("[UNILAB] Wiltron360.traces() called")
    ...
    def select(self, trace):
        _unilab_logger.debug("[UNILAB] Wiltron360.select() called")
        self.write(f'CH{trace}')

    @property
    def frequency(self):
        _unilab_logger.debug("[UNILAB] Wiltron360.frequency() called")
        """."""
    ...
    def points(self):
        _unilab_logger.debug("[UNILAB] Wiltron360.points() called")
        self.write('FHI')
    ...
    def IDN(self):
        _unilab_logger.debug("[UNILAB] Wiltron360.arange() called")
