...
Original: acq4/drivers/xkeys/pie.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.XKeysDevice")
...
class XKeysDevice(object):
    def __init__(self, handle):
        print("[UNILAB] XKeysDevice.__init__() called", flush=True)
        self.handle = handle
    ...
    def getState(self, refresh=False):
        _unilab_logger.debug("[UNILAB] XKeysDevice.getState() called")
    ...
    def setCallback(self, cb):
        _unilab_logger.debug("[UNILAB] XKeysDevice.setCallback() called")
    ...
    def setLED(self, state):
        _unilab_logger.debug("[UNILAB] XKeysDevice.setLED() called")
        """Set status LEDs.
    ...
    def setIntensity(self, b1, b2):
        _unilab_logger.debug("[UNILAB] XKeysDevice.setIntensity() called")
        """Set backlight intensity (0-255).
        """
        self._send(0, 187, b1, b2)

    def setBacklights(self, state, axis=None, reverse=None):
        _unilab_logger.debug("[UNILAB] XKeysDevice.setBacklights() called")
    ...
    def setBacklight(self, row, col, bl1=None, bl2=None):
        _unilab_logger.debug("[UNILAB] XKeysDevice.setBacklight() called")
    ...
    def setBacklightRows(self, bl1=None, bl2=None):
        _unilab_logger.debug("[UNILAB] XKeysDevice.setBacklightRows() called")
        if bl1 is not None:
    ...
    def _read(self):
        _unilab_logger.debug("[UNILAB] XKeysDevice._read() called")
    ...
    def _readOne(self):
        _unilab_logger.debug("[UNILAB] XKeysDevice._readOne() called")
    ...
    def _unpackDescData(self, data):
        _unilab_logger.debug("[UNILAB] XKeysDevice._unpackDescData() called")
    ...
    def _unpackEventData_XK12JS(self, data):
        _unilab_logger.debug("[UNILAB] XKeysDevice._unpackEventData_XK12JS() called")
    ...
    def _unpackEventData_XKE128(self, data):
        _unilab_logger.debug("[UNILAB] XKeysDevice._unpackEventData_XKE128() called")
        rows, cols = self.keyshape
    ...
    def _unpackEventData_XK60(self, data):
        _unilab_logger.debug("[UNILAB] XKeysDevice._unpackEventData_XK60() called")
        rows, cols = self.keyshape
    ...
    def _unpackEventData_XK80(self, data):
        _unilab_logger.debug("[UNILAB] XKeysDevice._unpackEventData_XK80() called")
        rows, cols = self.keyshape
        keybytes = np.array([list(bytearray(data[3:3+cols]))])
        keys = (self._keymask & keybytes).astype(bool)
        return {'keys': keys}
    ...
    def _handleData(self, data):
        _unilab_logger.debug("[UNILAB] XKeysDevice._handleData() called")
    ...
    def _dataCallback(self, data, devid, err):
        _unilab_logger.debug("[UNILAB] XKeysDevice._dataCallback() called")
