...
Original: epics/devices/xspress3.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Xspress3")
...
class Xspress3BaseMixin(object):
    ...
    def useExternalTrigger(self):
        _unilab_logger.debug("[UNILAB] Xspress3.useExternalTrigger() called")
        self.TriggerMode = 3

    def useInternalTrigger(self):
        _unilab_logger.debug("[UNILAB] Xspress3.useInternalTrigger() called")
        self.TriggerMode = 1

    def setTriggerMode(self, mode):
        _unilab_logger.debug("[UNILAB] Xspress3.setTriggerMode() called")
        self.TriggerMode = mode

    def start(self, capture=True):
        _unilab_logger.debug("[UNILAB] Xspress3.start() called")
        time.sleep(.05)
        if capture:
            self.FileCaptureOn()
        self.Acquire = 1
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] Xspress3.stop() called")
        self.Acquire = 0
        self.FileCaptureOff()

    def get_rois(self):
        _unilab_logger.debug("[UNILAB] Xspress3.get_rois() called")
        return [m.get_rois() for m in self.mcas]

    def __init__(self, *args, **kwargs):
        print("[UNILAB] Xspress3.__init__() called")
...
class Xspress3(Device, ADFileMixin, Xspress3BaseMixin):
    ...
    def TimeSeriesCaptureOn(self, npts=None):
        print("[UNILAB] Xspress3.__init__() called", flush=True)
    ...
    def TimeSeriesCaptureOff(self):
        _unilab_logger.debug("[UNILAB] Xspress3.TimeSeriesCaptureOff() called")
    ...
    def roi_calib_info(self):
        _unilab_logger.debug("[UNILAB] Xspress3.roi_calib_info() called")
        buff = ['[rois]']
        add = buff.append
    ...
    def restore_rois(self, roifile):
        _unilab_logger.debug("[UNILAB] Xspress3.restore_rois() called")
