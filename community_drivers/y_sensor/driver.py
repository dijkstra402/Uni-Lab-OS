...
Original: src/Switch-Yoctopuce_Yocto-Relay/libs/yoctopuce/yocto_api.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.YSensor")
...
class YSensor(YFunction):
    ...
    def __init__(self, func):
        print("[UNILAB] YSensor.__init__() called", flush=True)
    ...
    def _parseAttr(self, json_val):
        _unilab_logger.debug("[UNILAB] YSensor._parseAttr() called")
    ...
    def get_unit(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_unit() called")
        """
    ...
    def get_currentValue(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_currentValue() called")
        """
    ...
    def set_lowestValue(self, newval):
        _unilab_logger.debug("[UNILAB] YSensor.set_lowestValue() called")
        """
    ...
    def get_lowestValue(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_lowestValue() called")
        """
    ...
    def set_highestValue(self, newval):
        _unilab_logger.debug("[UNILAB] YSensor.set_highestValue() called")
        """
    ...
    def get_highestValue(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_highestValue() called")
        """
    ...
    def get_currentRawValue(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_currentRawValue() called")
        """
    ...
    def get_logFrequency(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_logFrequency() called")
        """
    ...
    def set_logFrequency(self, newval):
        _unilab_logger.debug("[UNILAB] YSensor.set_logFrequency() called")
        """
    ...
    def get_reportFrequency(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_reportFrequency() called")
        """
    ...
    def set_reportFrequency(self, newval):
        _unilab_logger.debug("[UNILAB] YSensor.set_reportFrequency() called")
        """
    ...
    def get_advMode(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_advMode() called")
        """
    ...
    def set_advMode(self, newval):
        _unilab_logger.debug("[UNILAB] YSensor.set_advMode() called")
        """
    ...
    def get_calibrationParam(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_calibrationParam() called")
        # res
        if self._cacheExpiration <= YAPI.GetTickCount():
            if self.load(YAPI._yapiContext.GetCacheValidity()) != YAPI.SUCCESS:
    ...
    def set_calibrationParam(self, newval):
        _unilab_logger.debug("[UNILAB] YSensor.set_calibrationParam() called")
        rest_val = newval
        return self._setAttr("calibrationParam", rest_val)

    def set_resolution(self, newval):
        _unilab_logger.debug("[UNILAB] YSensor.set_resolution() called")
        """
    ...
    def get_resolution(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_resolution() called")
        """
    ...
    def get_sensorState(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_sensorState() called")
        """
    ...
    @staticmethod
    def FindSensor(func):
        _unilab_logger.debug("[UNILAB] YSensor.FindSensor() called")
        """
    ...
    def _parserHelper(self):
        _unilab_logger.debug("[UNILAB] YSensor._parserHelper() called")
        # position
        # maxpos
        iCalib = []
        # iRaw
    ...
    def isSensorReady(self):
        _unilab_logger.debug("[UNILAB] YSensor.isSensorReady() called")
        """
    ...
    def get_dataLogger(self):
        _unilab_logger.debug("[UNILAB] YSensor.get_dataLogger() called")
        """
    ...
    def startDataLogger(self):
        _unilab_logger.debug("[UNILAB] YSensor.startDataLogger() called")
        """
    ...
    def stopDataLogger(self):
        _unilab_logger.debug("[UNILAB] YSensor.stopDataLogger() called")
        """
    ...
    def get_recordedData(self, startTime, endTime):
        _unilab_logger.debug("[UNILAB] YSensor.get_recordedData() called")
        """
    ...
    def registerTimedReportCallback(self, callback):
        _unilab_logger.debug("[UNILAB] YSensor.registerTimedReportCallback() called")
        """
    ...
    def _invokeTimedReportCallback(self, value):
        _unilab_logger.debug("[UNILAB] YSensor._invokeTimedReportCallback() called")
    ...
    def calibrateFromPoints(self, rawValues, refValues):
        _unilab_logger.debug("[UNILAB] YSensor.calibrateFromPoints() called")
        """
    ...
    def loadCalibrationPoints(self, rawValues, refValues):
        _unilab_logger.debug("[UNILAB] YSensor.loadCalibrationPoints() called")
        """
    ...
    def _encodeCalibrationPoints(self, rawValues, refValues):
        _unilab_logger.debug("[UNILAB] YSensor._encodeCalibrationPoints() called")
        # res
        # npt
        # idx
        npt = len(rawValues)
    ...
    def _applyCalibration(self, rawValue):
        _unilab_logger.debug("[UNILAB] YSensor._applyCalibration() called")
    ...
    def _decodeTimedReport(self, timestamp, duration, report):
        _unilab_logger.debug("[UNILAB] YSensor._decodeTimedReport() called")
        # i
        # byteVal
        # poww
        # minRaw
    ...
    def _decodeVal(self, w):
        _unilab_logger.debug("[UNILAB] YSensor._decodeVal() called")
        # val
        val = w if w <= 0x7fffffff else -0x100000000 + w
        if self._caltyp != 0:
            if self._calhdl is not None:
    ...
    def _decodeAvg(self, dw):
        _unilab_logger.debug("[UNILAB] YSensor._decodeAvg() called")
        # val
        val = dw if dw <= 0x7fffffff else -0x100000000 + dw
        if self._caltyp != 0:
            if self._calhdl is not None:
    ...
    def nextSensor(self):
        _unilab_logger.debug("[UNILAB] YSensor.nextSensor() called")
        """
...
#--- (end of generated code: YSensor implementation)
    ...
    @staticmethod
    def FirstSensor():
        _unilab_logger.debug("[UNILAB] YSensor.FirstSensor() called")
        """
