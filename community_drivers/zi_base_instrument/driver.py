...
Original: pycqed/instrument_drivers/physical_instruments/ZurichInstruments/ZI_base_instrument.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ZI_base_instrument")
...
class ZI_base_instrument(Instrument):
    ...
    def _check_devtype(self):
        print("[UNILAB] ZI_base_instrument.__init__() called", flush=True)
        """
    ...
    def _check_options(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._check_options() called")
        """
    ...
    def _check_versions(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._check_versions() called")
        """
    ...
    def _check_awg_nr(self, awg_nr):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._check_awg_nr() called")
        """
    ...
    def _update_num_channels(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._update_num_channels() called")
        raise NotImplementedError('Virtual method with no implementation!')

    def _update_awg_waveforms(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._update_awg_waveforms() called")
        raise NotImplementedError('Virtual method with no implementation!')

    def _num_channels(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._num_channels() called")
        raise NotImplementedError('Virtual method with no implementation!')

    def _num_awgs(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._num_awgs() called")
        return self._num_channels()//2

    def _get_waveform_table(self, awg_nr: int) -> list:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._get_waveform_table() called")
        return dict()

    def _add_extra_parameters(self) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._add_extra_parameters() called")
        """
    ...
    def _add_codeword_waveform_parameters(self, num_codewords) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._add_codeword_waveform_parameters() called")
        """
    ...
    def _load_parameter_file(self, filename: str):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._load_parameter_file() called")
        """
    ...
    def _create_parameter_file(self, filename: str):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._create_parameter_file() called")
        """
    ...
    def _is_device_connected(self, device):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._is_device_connected() called")
        """
    ...
    def _get_full_path(self, paths):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._get_full_path() called")
        """
    ...
    def _get_awg_directory(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._get_awg_directory() called")
        """
    ...
    def _initialize_waveform_to_zeros(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._initialize_waveform_to_zeros() called")
        """
    ...
    def _gen_write_waveform(self, ch, cw):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._gen_write_waveform() called")
        def write_func(waveform):
            _unilab_logger.debug("[UNILAB] ZI_base_instrument.write_func() called")
    ...
    def _write_csv_waveform(self, ch: int, cw: int, wf_name: str, waveform) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._write_csv_waveform() called")
    ...
    def _gen_read_waveform(self, ch, cw):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._gen_read_waveform() called")
        def read_func():
            _unilab_logger.debug("[UNILAB] ZI_base_instrument.read_func() called")
            # AWG
            awg_nr = ch//2
    ...
    def _read_csv_waveform(self, ch: int, cw: int, wf_name: str):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._read_csv_waveform() called")
        filename = os.path.join(
            self._get_awg_directory(), 'waves',
            self.devname + '_' + wf_name + '.csv')
        try:
    ...
    def _length_match_waveforms(self, awg_nr):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._length_match_waveforms() called")
        """
    ...
    def _clear_dirty_waveforms(self, awg_nr):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._clear_dirty_waveforms() called")
        """
        Adjust the length of a codeword waveform such that each individual
        waveform of the pair has the same length
        """
    ...
    def _clear_readonly_waveforms(self, awg_nr):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._clear_readonly_waveforms() called")
        """
    ...
    def _set_readonly_waveform(self, ch: int, cw: int):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._set_readonly_waveform() called")
        """
    ...
    def _upload_updated_waveforms(self, awg_nr):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._upload_updated_waveforms() called")
        """
    ...
    def _codeword_table_preamble(self, awg_nr):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._codeword_table_preamble() called")
        """
    ...
    def _configure_awg_from_variable(self, awg_nr):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._configure_awg_from_variable() called")
        """
    ...
    def _write_cmd_to_logfile(self, cmd):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._write_cmd_to_logfile() called")
    ...
    def _flush_logfile(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument._flush_logfile() called")
        if self._logfile is not None:
            self._logfile.flush()
    ...
    def getv(self, path):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.getv() called")
    ...
    def getdeep(self, path, timeout=5.0):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.getdeep() called")
        path = self._get_full_path(path)
    ...
    def subs(self, path:str) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.subs() called")
    ...
    def unsubs(self, path:str=None) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.unsubs() called")
        if path is None:
    ...
    def poll(self, poll_time=0.1):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.poll() called")
        return self.daq.poll(poll_time, 500, 4, True)

    def sync(self) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.sync() called")
        self.daq.sync()
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.start() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.stop() called")
    ...
    def FIXMEclose(self) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.FIXMEclose() called")
        try:
    ...
    def check_errors(self, errors_to_ignore=None):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.check_errors() called")
    ...
    def clear_errors(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.clear_errors() called")
        self.seti('raw/error/clear', 1)

    def demote_error(self, code: str):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.demote_error() called")
        """
    ...
    def reset_waveforms_zeros(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.reset_waveforms_zeros() called")
        """
    ...
    def plot_dio_snapshot(self, bits=range(32)):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.configure_awg_from_string() called")
        raise NotImplementedError('Virtual method with no implementation!')

    def plot_awg_codewords(self, awg_nr=0, range=None):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.plot_awg_codewords() called")
        raise NotImplementedError('Virtual method with no implementation!')

    def get_idn(self) -> dict:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.get_idn() called")
        idn_dict = {}
    ...
    def load_default_settings(self):
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.load_default_settings() called")
        raise NotImplementedError('Virtual method with no implementation!')

    def assure_ext_clock(self) -> None:
        _unilab_logger.debug("[UNILAB] ZI_base_instrument.assure_ext_clock() called")
        raise NotImplementedError('Virtual method with no implementation!')
