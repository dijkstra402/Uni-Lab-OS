...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ZMQValueSub")
...
class ZMQValueSub(object):
    ...
    def __init__(self, name, ip, port = 5556, hwm=10, return_last=True):
        print("[UNILAB] ZMQValueSub.__init__() called", flush=True)
        context = zmq.Context()
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] ZMQValueSub.run() called")
        '''
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] ZMQValueSub.shutdown() called")
        self.socket.close()
        context = zmq.Context()
        context.destroy()
