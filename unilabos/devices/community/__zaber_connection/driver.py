...
Original: microscope/controllers/zaber.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver._ZaberConnection")
...
class _ZaberConnection:
    ...
    def __init__(self, port: str, baudrate: int, timeout: float) -> None:
        print("[UNILAB] _ZaberConnection.__init__() called", flush=True)
    ...
    def lock(self) -> threading.RLock:
        _unilab_logger.debug("[UNILAB] _ZaberConnection.lock() called")
        return self._lock

    def write(self, data: bytes) -> int:
        _unilab_logger.debug("[UNILAB] _ZaberConnection.write() called")
        with self.lock:
            return self._serial.write(data)

    def readline(self, size: int = -1) -> bytes:
        _unilab_logger.debug("[UNILAB] _ZaberConnection.readline() called")
        with self.lock:
