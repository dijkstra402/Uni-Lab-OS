...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver._ZaberLEDController")
...
class _ZaberLEDController(microscope.abc.Controller):
    ...
    def __init__(
        ...
        print("[UNILAB] _ZaberLEDController.__init__() called", flush=True)
        super().__init__(**kwargs)
        self._dev_conn = _ZaberDeviceConnection(conn, device_address)
    ...
    def devices(self) -> Dict[str, _ZaberLED]:
        _unilab_logger.debug("[UNILAB] _ZaberLEDController.devices() called")
        return self._leds
