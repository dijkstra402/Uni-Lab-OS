...
Original: microscope/lights/toptica.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver._iBeamConnection")
...
class _iBeamConnection:
    ...
    def __init__(self, port: str):
        print("[UNILAB] _iBeamConnection.__init__() called", flush=True)
    ...
    def command(self, command: bytes) -> bytes:
        _unilab_logger.debug("[UNILAB] _iBeamConnection.command() called")
    ...
    def laser_on(self) -> None:
        _unilab_logger.debug("[UNILAB] _iBeamConnection.laser_on() called")
        """Activate LD driver."""
        self.command(b"laser on")

    def laser_off(self) -> None:
        _unilab_logger.debug("[UNILAB] _iBeamConnection.laser_off() called")
        """Deactivate LD driver."""
        self.command(b"laser off")

    def set_normal_channel_power(self, power: float) -> None:
        _unilab_logger.debug("[UNILAB] _iBeamConnection.set_normal_channel_power() called")
    ...
    def show_power_uW(self) -> float:
        _unilab_logger.debug("[UNILAB] _iBeamConnection.show_power_uW() called")
    ...
    def status_laser(self) -> bytes:
        _unilab_logger.debug("[UNILAB] _iBeamConnection.status_laser() called")
        """Returns actual status of the LD driver (ON or OFF)."""
        return self.command(b"status laser")

    def show_max_power(self) -> float:
        _unilab_logger.debug("[UNILAB] _iBeamConnection.show_max_power() called")
