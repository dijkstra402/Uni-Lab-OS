...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AgilentSerial")
...
from pcdsdevices.doc_stubs import IonPump_base
...
class AgilentSerial(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] AgilentSerial.__init__() called", flush=True)
