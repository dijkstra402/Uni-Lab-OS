...
Original: hics/hardware/specimAisaKestrel10/camera.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AisaKestrelCamera")
...
class AisaKestrelCamera:
    ...
    def __init__(self, system):
        print("[UNILAB] AisaKestrelCamera.__init__() called", flush=True)
        self._system = system
    ...
    def _switch_to_ascii_mode(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._switch_to_ascii_mode() called")
    ...
    def _read_addr(self, addr):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._read_addr() called")
        c_buf=(ctypes.c_char * 20)(0)
    ...
    def _write_addr(self, addr, data):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._write_addr() called")
    ...
    def _read_addr_float(self, addr):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._read_addr_float() called")
        return struct.unpack('>f', self._read_addr(addr))[0]
        
    def _write_addr_float(self, addr, data):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._write_addr_float() called")
        return self._write_addr(addr, struct.pack('>f', data))
        
    def _read_addr_int(self, addr):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._read_addr_int() called")
        return struct.unpack('>I', self._read_addr(addr))[0]
        
    def _write_addr_int(self, addr, data):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._write_addr_int() called")
        return self._write_addr(addr, struct.pack('>I', data))
        
    @property
    def _redis(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._redis() called")
        return self._system._redis
    
    @property
    def _epix(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._epix() called")
        return self._system._epix
    
    @property
    def frame_rate(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.frame_rate() called")
    ...
    def frame_rate_min(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.frame_rate_min() called")
        return 1
    
    @property
    def frame_rate_max(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.frame_rate_max() called")
        return int(self._read_addr_float(446))
        
    @property
    def shutter_open(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.shutter_open() called")
    ...
    def shutter_latency(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.shutter_latency() called")
        return self._shutter_latency
        
    @property
    def integration_time(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.integration_time() called")
    ...
    def integration_time_min(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.integration_time_min() called")
        return 1
    
    @property
    def integration_time_max(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.integration_time_max() called")
        return 1000000
        
    @property
    def nuc(self):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.nuc() called")
        return 0
    ...
    def _to_bool(self, v):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera._to_bool() called")
        if type(v) == bytes:
            return v == b'1'
        elif type(v) == str:
            return v == '1'
    ...
    def notify(self, prop):
        _unilab_logger.debug("[UNILAB] AisaKestrelCamera.notify() called")
        return
