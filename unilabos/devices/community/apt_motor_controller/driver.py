...
Original: src/instruments/thorlabs/thorlabsapt.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.APTMotorController")
...
class APTMotorController(ThorLabsAPT):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] APTMotorController.__init__() called", flush=True)
    ...
    class MotorChannel(ThorLabsAPT.APTChannel):
        ...
        def motion_timeout(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.motion_timeout() called")
            """
        ...
        def _set_scale(self, motor_model):
            _unilab_logger.debug("[UNILAB] APTMotorController._set_scale() called")
            """
        ...
        def set_scale(self, motor_model):
            _unilab_logger.debug("[UNILAB] APTMotorController.set_scale() called")
            warnings.warn(
        ...
        def motor_model(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.motor_model() called")
            """
        ...
        def backlash_correction(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.backlash_correction() called")
        ...
        def home_parameters(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.home_parameters() called")
        ...
        def status_bits(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.status_bits() called")
            """
        ...
        @property
        def position(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.position() called")
            """
        ...
        def position_encoder(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.position_encoder() called")
            """
        ...
        def go_home(self):
            _unilab_logger.debug("[UNILAB] APTMotorController.go_home() called")
            """
        ...
        def move(self, pos, absolute=True):
            _unilab_logger.debug("[UNILAB] APTMotorController.move() called")
            """
