...
Original: pyctiarbin/arbinspoofer/arbin_spoofer.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ArbinSpoofer")
...
class ArbinSpoofer:
    ...
    def __init__(self, config: dict):
        print("[UNILAB] ArbinSpoofer.__init__() called", flush=True)
        """
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] ArbinSpoofer.start() called")
        """
    ...
    def update_channel_status(self, channel, updated_readings):
        _unilab_logger.debug("[UNILAB] ArbinSpoofer.update_channel_status() called")
        """
    ...
    def __server_loop(self, sock_config: dict, Worker: SocketWorker):
        _unilab_logger.debug("[UNILAB] ArbinSpoofer.__server_loop() called")
        """
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] ArbinSpoofer.stop() called")
        """
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] ArbinSpoofer.__del__() called")
        self.stop()

__all__ = ["ArbinSpoofer"]
