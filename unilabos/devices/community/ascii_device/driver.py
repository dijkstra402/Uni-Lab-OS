...
Original: drivers/stages/luminos_stage/zaber/serial/ascii.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.AsciiDevice")
...
class AsciiDevice(object):
    ...
    def __init__(self, port, address):
        print("[UNILAB] AsciiDevice.__init__() called", flush=True)
        """
        Args:
    ...
    def axis(self, number):
        _unilab_logger.debug("[UNILAB] AsciiDevice.axis() called")
    ...
    def send(self, message):
        _unilab_logger.debug("[UNILAB] AsciiDevice.send() called")
    ...
    def poll_until_idle(self, axis_number = 0):
        _unilab_logger.debug("[UNILAB] AsciiDevice.poll_until_idle() called")
    ...
    def home(self):
        _unilab_logger.debug("[UNILAB] AsciiDevice.home() called")
    ...
    def move_abs(self, position, blocking = True):
        _unilab_logger.debug("[UNILAB] AsciiDevice.move_abs() called")
    ...
    def move_rel(self, distance, blocking = True):
        _unilab_logger.debug("[UNILAB] AsciiDevice.move_rel() called")
    ...
    def move_vel(self, speed, blocking = False):
        _unilab_logger.debug("[UNILAB] AsciiDevice.move_vel() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] AsciiDevice.stop() called")
    ...
    def get_status(self):
        _unilab_logger.debug("[UNILAB] AsciiDevice.get_status() called")
