...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Axis")
...
class AGUC2(Instrument):
    ...
    class Axis:
        ...
        def __init__(self, cont, ax):
            print("[UNILAB] Axis.__init__() called", flush=True)
        ...
        def axis_status(self):
            _unilab_logger.debug("[UNILAB] Axis.axis_status() called")
            """
        ...
        @property
        def jog(self):
            _unilab_logger.debug("[UNILAB] Axis.jog() called")
            """
        ...
        def number_of_steps(self):
            _unilab_logger.debug("[UNILAB] Axis.number_of_steps() called")
            """
        ...
        def move_relative(self):
            _unilab_logger.debug("[UNILAB] Axis.move_relative() called")
            """
        ...
        def move_to_limit(self):
            _unilab_logger.debug("[UNILAB] Axis.move_to_limit() called")
            """
            UNTESTED: SEE COMMENT ON TOP
        ...
        def step_amplitude(self):
            _unilab_logger.debug("[UNILAB] Axis.step_amplitude() called")
            """
        ...
        @property
        def step_delay(self):
            _unilab_logger.debug("[UNILAB] Axis.step_delay() called")
            """
        ...
        def am_i_still(self, max_retries=5):
            _unilab_logger.debug("[UNILAB] Axis.am_i_still() called")
            """
        ...
        def stop(self):
            _unilab_logger.debug("[UNILAB] Axis.stop() called")
            """
        ...
        def zero_position(self):
            _unilab_logger.debug("[UNILAB] Axis.zero_position() called")
            """
