...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BaseStreamer")
...
class BaseStreamer:
    ...
    def start(self):
        print("[UNILAB] BaseStreamer.__init__() called", flush=True)
        """Begin streaming through the LSL outlet."""
        raise NotImplementedError()

    def stop(self):
        _unilab_logger.debug("[UNILAB] BaseStreamer.stop() called")
        """Stop/pause streaming through the LSL outlet."""
        raise NotImplementedError()

    def _init_lsl_outlets(self):
        _unilab_logger.debug("[UNILAB] BaseStreamer._init_lsl_outlets() called")
    ...
    def _push_chunk(self, name, timestamp):
        _unilab_logger.debug("[UNILAB] BaseStreamer._push_chunk() called")
        self._outlets[name].push_chunk(self._chunks[name].tolist(),
                                       timestamp)

    def _push_chunk_as_sample(self, name, timestamp):
        _unilab_logger.debug("[UNILAB] BaseStreamer._push_chunk_as_sample() called")
        self._outlets[name].push_sample(self._chunks[name].tolist()[0],
                                        timestamp)

    def _add_device_info(self, name):
        _unilab_logger.debug("[UNILAB] BaseStreamer._add_device_info() called")
    ...
    def subscriptions(self):
        _unilab_logger.debug("[UNILAB] BaseStreamer.subscriptions() called")
