...
Original: openflexure_stage/basic_serial_instrument.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BasicSerialInstrument")
...
# Vendored repo packages: openflexure_stage
import sys as _sys
...
class BasicSerialInstrument(object):
    ...
    **Threading Notes**
    ...
    def __init__(self, port=None, **kwargs):
        print("[UNILAB] BasicSerialInstrument.__init__() called", flush=True)
        """
    ...
    def open(self, port=None, quiet=True):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.open() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.close() called")
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.__del__() called")
    ...
    def __enter__(self):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.__enter__() called")
        """When we use this in a with statement, it should be opened already"""
        self._position_on_enter = self.position
        return self

    def __exit__(self, type, value, traceback):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.__exit__() called")
    ...
    def write(self,query_string):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.write() called")
...
#                if self._ser.out_waiting>0: self._ser.flushOutput() #ensure there's nothing waiting
    ...
    def flush_input_buffer(self):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.flush_input_buffer() called")
    ...
    def readline(self, timeout=None):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.readline() called")
    ...
    def communications_lock(self):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.communications_lock() called")
...
#            raise NotImplementedError("Subclasses of MessageBusInstrument must override the readline method!")
    ...
    def read_multiline(self, termination_line=None, timeout=None):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.read_multiline() called")
        """Read one line from the underlying bus.  Must be overriden.
    ...
    def query(self,queryString,multiline=False,termination_line=None,timeout=None):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.query() called")
        """
    ...
    def parsed_query(self, query_string, response_string=r"%d", re_flags=0, parse_function=None, **kwargs):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.parsed_query() called")
        """
    ...
    def int_query(self, query_string, **kwargs):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.int_query() called")
    ...
    def float_query(self, query_string, **kwargs):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.float_query() called")
    ...
    def test_communications(self):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.test_communications() called")
    ...
    def find_port(self):
        _unilab_logger.debug("[UNILAB] BasicSerialInstrument.find_port() called")
