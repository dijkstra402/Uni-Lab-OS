...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.BLFWriter")
...
from can.io.generic import BinaryIOMessageReader, BinaryIOMessageWriter
...
class BLFWriter(BinaryIOMessageWriter):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("[UNILAB] BLFWriter.__init__() called", flush=True)
        """
    ...
    def _write_header(self, filesize: int) -> None:
        _unilab_logger.debug("[UNILAB] BLFWriter._write_header() called")
    ...
    def on_message_received(self, msg: Message) -> None:
        _unilab_logger.debug("[UNILAB] BLFWriter.on_message_received() called")
    ...
    def log_event(self, text: str, timestamp: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] BLFWriter.log_event() called")
    ...
    def _add_object(
        ...
        _unilab_logger.debug("[UNILAB] BLFWriter._add_object() called")
    ...
    def _flush(self) -> None:
        _unilab_logger.debug("[UNILAB] BLFWriter._flush() called")
    ...
    def file_size(self) -> int:
        _unilab_logger.debug("[UNILAB] BLFWriter.file_size() called")
        """Return an estimate of the current file size in bytes."""
        return self.file.tell() + self._buffer_size

    def stop(self) -> None:
        _unilab_logger.debug("[UNILAB] BLFWriter.stop() called")
