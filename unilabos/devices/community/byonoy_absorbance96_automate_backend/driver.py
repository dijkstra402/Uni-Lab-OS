...
Original: pylabrobot/plate_reading/byonoy/byonoy_backend.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ByonoyAbsorbance96AutomateBackend")
...
class ByonoyAbsorbance96AutomateBackend(_ByonoyBase):
  def __init__(self) -> None:
    print("[UNILAB] ByonoyAbsorbance96AutomateBackend.__init__() called", flush=True)
    super().__init__(pid=0x1199, device_type=_ByonoyDevice.ABSORBANCE_96)

  async def setup(self, verbose: bool = False, **backend_kwargs):
    _unilab_logger.debug("[UNILAB] ByonoyAbsorbance96AutomateBackend.setup() called")
    """Set up the plate reader. This should be called before any other methods."""
  ...
  async def get_available_absorbance_wavelengths(self) -> List[float]:
    _unilab_logger.debug("[UNILAB] ByonoyAbsorbance96AutomateBackend.get_available_absorbance_wavelengths() called")
  ...
  async def _run_abs_measurement(self, signal_wl: int, reference_wl: int, is_reference: bool):
    _unilab_logger.debug("[UNILAB] ByonoyAbsorbance96AutomateBackend._run_abs_measurement() called")
  ...
  async def initialize_measurements(self):
    _unilab_logger.debug("[UNILAB] ByonoyAbsorbance96AutomateBackend.initialize_measurements() called")
  ...
  async def read_absorbance(
    ...
    _unilab_logger.debug("[UNILAB] ByonoyAbsorbance96AutomateBackend.read_absorbance() called")
    """
  ...
  async def read_luminescence(
    ...
    _unilab_logger.debug("[UNILAB] ByonoyAbsorbance96AutomateBackend.read_luminescence() called")
  ...
  async def read_fluorescence(
    ...
    _unilab_logger.debug("[UNILAB] ByonoyAbsorbance96AutomateBackend.read_fluorescence() called")
