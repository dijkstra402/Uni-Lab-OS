...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Catalog")
...
class Catalog(object):
    ...
    def __init__(self, path, read_only=False, start_index=0):
        print("[UNILAB] Catalog.__init__() called", flush=True)
    ...
    def _exit_handler(self):
        _unilab_logger.debug("[UNILAB] Catalog._exit_handler() called")
        self.close()

    def write_record(self, record):
        _unilab_logger.debug("[UNILAB] Catalog.write_record() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] Catalog.close() called")
        self.manifest.close()
        self.seekable.close()
...
class CatalogMetadata(object):
    ...
    def update_line_lengths(self, new_lengths):
        _unilab_logger.debug("[UNILAB] Catalog.update_line_lengths() called")
        self.contents['line_lengths'] = new_lengths
        self._update()

    def line_lengths(self):
        _unilab_logger.debug("[UNILAB] Catalog.line_lengths() called")
        return self.contents['line_lengths']

    def start_index(self):
        _unilab_logger.debug("[UNILAB] Catalog.start_index() called")
        return self.contents['start_index']

    def _update(self):
        _unilab_logger.debug("[UNILAB] Catalog._update() called")
