...
Original: pycqed/instrument_drivers/physical_instruments/QuTech/CC.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CC")
...
class CC(CCCore, Instrument, DIO.CalInterface):
    ...
    def _add_parameters(self, num_ccio: int) -> None:
        print("[UNILAB] CC.__init__() called", flush=True)
        """
    ...
    def _add_compatibility_parameters(self, num_ccio: int) -> None:
        _unilab_logger.debug("[UNILAB] CC._add_compatibility_parameters() called")
        """
...
#                get_cmd=_gen_get_func_1par(self._get_vsm_channel_delay, vsm_ch),
    ...
    def _eqasm_program(self, file_name: str) -> None:
        _unilab_logger.debug("[UNILAB] CC._eqasm_program() called")
    ...
    def _set_vsm_channel_delay(self, bit: int, cnt_in_2ns5_steps: int) -> None:
        _unilab_logger.debug("[UNILAB] CC._set_vsm_channel_delay() called")
    ...
    def _set_dio_delay(self, ccio: int, cnt_in_20ns_steps: int) -> None:
        _unilab_logger.debug("[UNILAB] CC._set_dio_delay() called")
    ...
    def calibrate_dio_protocol(self, dio_mask: int, expected_sequence: List, port: int=0):
        _unilab_logger.debug("[UNILAB] CC.calibrate_dio_protocol() called")
    ...
    def output_dio_calibration_data(self, dio_mode: str, port: int=0) -> Tuple[int, List]:
        _unilab_logger.debug("[UNILAB] CC.output_dio_calibration_data() called")
