...
Original: src/instruments/comet/cito_plus_1310.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CitoPlus1310")
...
class CitoPlus1310(Instrument):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] CitoPlus1310.__init__() called", flush=True)
    ...
    @property
    def name(self) -> str:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.name() called")
    ...
    def forward_power(self) -> u.Quantity:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.forward_power() called")
    ...
    def load_power(self) -> u.Quantity:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.load_power() called")
    ...
    def output_power(self) -> u.Quantity:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.output_power() called")
    ...
    def reflected_power(self) -> u.Quantity:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.reflected_power() called")
    ...
    def regulation_mode(self) -> RegulationMode:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.regulation_mode() called")
    ...
    @property
    def rf(self) -> bool:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.rf() called")
    ...
    def sendcmd(self, pkg: bytes) -> None:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.sendcmd() called")
    ...
    def query(self, pkg: bytes, write_cmd=False) -> Union[None, bytes]:
        _unilab_logger.debug("[UNILAB] CitoPlus1310.query() called")
        """Query instrument.
    ...
    def _check_exception(self, fn_code: int, exc_code: int) -> None:
        _unilab_logger.debug("[UNILAB] CitoPlus1310._check_exception() called")
    ...
    def _make_hdr(self, fn_code: int) -> bytes:
        _unilab_logger.debug("[UNILAB] CitoPlus1310._make_hdr() called")
    ...
    def _make_pkg(self, cmd_code, data=None, data_length=4):
        _unilab_logger.debug("[UNILAB] CitoPlus1310._make_pkg() called")
