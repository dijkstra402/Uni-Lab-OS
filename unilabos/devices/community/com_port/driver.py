...
Original: tools/vcp_terminal.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ComPort")
...
class ComPort(object):
    ...
    def __init__(self, usb_device, start=True):
        print("[UNILAB] ComPort.__init__() called", flush=True)
    ...
    def _startRx(self):
        _unilab_logger.debug("[UNILAB] ComPort._startRx() called")
    ...
    def _endRx(self):
        _unilab_logger.debug("[UNILAB] ComPort._endRx() called")
        self._rxactive = False

    def _read(self):
        _unilab_logger.debug("[UNILAB] ComPort._read() called")
    ...
    def _getRxLen(self):
        _unilab_logger.debug("[UNILAB] ComPort._getRxLen() called")
        return self._rxqueue.qsize()
    rxlen = property(fget=_getRxLen)

    def readBytes(self):
        _unilab_logger.debug("[UNILAB] ComPort.readBytes() called")
        rx = []
    ...
    def readText(self):
        _unilab_logger.debug("[UNILAB] ComPort.readText() called")
        return "".join(chr(c) for c in self.readBytes())

    def write(self, data):
        _unilab_logger.debug("[UNILAB] ComPort.write() called")
        try:
    ...
    def setControlLineState(self, RTS=None, DTR=None):
        _unilab_logger.debug("[UNILAB] ComPort.setControlLineState() called")
    ...
    def _setBaudFTDI(self, baudrate):
        _unilab_logger.debug("[UNILAB] ComPort.setLineCoding() called")
        if not self._isFTDI:
            return
    ...
    def _setLineCodeFTDI(self, bits, stopbits, parity, breaktype=0):
        _unilab_logger.debug("[UNILAB] ComPort._setLineCodeFTDI() called")
        if not self._isFTDI:
            return
        value = bits
        value += parity << 8
    ...
    def _resetFTDI(self):
        _unilab_logger.debug("[UNILAB] ComPort._resetFTDI() called")
    ...
    def _flushFTDI(self, rx=True, tx=True):
        _unilab_logger.debug("[UNILAB] ComPort._flushFTDI() called")
    ...
    def getLineCoding(self):
        _unilab_logger.debug("[UNILAB] ComPort.getLineCoding() called")
        if self._isFTDI:
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] ComPort.disconnect() called")
        self._endRx()
