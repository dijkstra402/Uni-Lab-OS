...
class CommunityStrictPicowattavs47(CommunityRepoLoader):
    DEFAULT_CONFIG = {'repo_root': '/Users/sml/work/Uni-Lab-OS/new/strict_candidates_repos/instrumentkit__InstrumentKit', 'source_file': 'src/instruments/picowatt/picowattavs47.py', 'class_name': 'PicowattAVS47', 'import_roots': ['src'], 'candidate_methods': ['sensor', 'name', 'scpi_version', 'op_complete', 'power_on_status', 'self_test_ok', 'trigger', 'wait_to_continue', 'line_frequency', 'check_error_queue', 'display_brightness', 'display_contrast', 'sendcmd', 'query', 'read_raw', 'timeout', 'address', 'terminator', 'prompt', 'binblockread', 'open_from_uri', 'open_tcpip', 'open_serial', 'open_gpibusb', 'open_gpibethernet', 'open_visa', 'open_test', 'open_usbtmc', 'open_vxi11', 'open_usb', 'open_file'], 'action_targets': {}, 'metadata': {'repo': 'instrumentkit/InstrumentKit', 'repo_url': 'https://github.com/instrumentkit/InstrumentKit', 'source_url': 'https://github.com/instrumentkit/InstrumentKit/blob/main/src/instruments/picowatt/picowattavs47.py', 'confidence': 0.8, 'quality_score': 0.94, 'parse_status': 'ok', 'quality_status': 'usable', 'quality_reasons': [], 'action_targets': {}}}
    ...
    def sensor(self, **kwargs):
        return self.call('sensor', kwargs=kwargs)
