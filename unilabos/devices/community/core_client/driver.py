...
Original: lantz/drivers/legacy/vxi11.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CoreClient")
...
class CoreClient(rpc.TCPClient):
    ...
    def __init__(self, host):
        print("[UNILAB] CoreClient.__init__() called", flush=True)
    ...
    def connect(self):
        _unilab_logger.debug("[UNILAB] CoreClient.connect() called")
    ...
    def create_link(self, id, lock_device, lock_timeout, name):
        _unilab_logger.debug("[UNILAB] CoreClient.create_link() called")
    ...
    def device_write(self, link, io_timeout, lock_timeout, flags, data):
        _unilab_logger.debug("[UNILAB] CoreClient.device_write() called")
    ...
    def device_read(self, link, request_size, io_timeout, lock_timeout, flags, term_char):
        _unilab_logger.debug("[UNILAB] CoreClient.device_read() called")
    ...
    def device_read_stb(self, link, flags, lock_timeout, io_timeout):
        _unilab_logger.debug("[UNILAB] CoreClient.device_read_stb() called")
    ...
    def device_trigger(self, link, flags, lock_timeout, io_timeout):
        _unilab_logger.debug("[UNILAB] CoreClient.device_trigger() called")
        params = (link, flags, lock_timeout, io_timeout)
    ...
    def device_clear(self, link, flags, lock_timeout, io_timeout):
        _unilab_logger.debug("[UNILAB] CoreClient.device_clear() called")
        params = (link, flags, lock_timeout, io_timeout)
    ...
    def device_remote(self, link, flags, lock_timeout, io_timeout):
        _unilab_logger.debug("[UNILAB] CoreClient.device_remote() called")
        params = (link, flags, lock_timeout, io_timeout)
    ...
    def device_local(self, link, flags, lock_timeout, io_timeout):
        _unilab_logger.debug("[UNILAB] CoreClient.device_local() called")
        params = (link, flags, lock_timeout, io_timeout)
    ...
    def device_lock(self, link, flags, lock_timeout):
        _unilab_logger.debug("[UNILAB] CoreClient.device_lock() called")
    ...
    def device_unlock(self, link):
        _unilab_logger.debug("[UNILAB] CoreClient.device_unlock() called")
        return self.make_call(DEVICE_UNLOCK, link,
                              self.packer.pack_device_link,
                              self.unpacker.unpack_device_error)

    def device_enable_srq(self, link, enable, handle):
        _unilab_logger.debug("[UNILAB] CoreClient.device_enable_srq() called")
    ...
    def device_docmd(self, link, flags, io_timeout, lock_timeout, cmd, network_order, datasize, data_in):
        _unilab_logger.debug("[UNILAB] CoreClient.device_docmd() called")
    ...
    def destroy_link(self, link):
        _unilab_logger.debug("[UNILAB] CoreClient.destroy_link() called")
        return self.make_call(DESTROY_LINK, link,
                              self.packer.pack_device_link,
                              self.unpacker.unpack_device_error)
    
    def create_intr_chan(self, host_addr, host_port, prog_num, prog_vers, prog_family):
        _unilab_logger.debug("[UNILAB] CoreClient.create_intr_chan() called")
    ...
    def destroy_intr_chan(self):
        _unilab_logger.debug("[UNILAB] CoreClient.destroy_intr_chan() called")
