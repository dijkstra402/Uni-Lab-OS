...
Original: pylabrobot/plate_reading/agilent/biotek_cytation_backend.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.CytationBackend")
...
class CytationBackend(BioTekPlateReaderBackend, ImagerBackend):
  ...
  def __init__(
    ...
    print("[UNILAB] CytationBackend.__init__() called", flush=True)
  ...
  async def setup(self, use_cam: bool = False) -> None:
    _unilab_logger.debug("[UNILAB] CytationBackend.setup() called")
  ...
  async def stop(self):
    _unilab_logger.debug("[UNILAB] CytationBackend.stop() called")
    await super().stop()
  ...
  def supports_heating(self):
    _unilab_logger.debug("[UNILAB] CytationBackend.supports_heating() called")
    return True

  @property
  def supports_cooling(self):
    _unilab_logger.debug("[UNILAB] CytationBackend.supports_cooling() called")
    return True

  async def _set_up_camera(self) -> None:
    _unilab_logger.debug("[UNILAB] CytationBackend._set_up_camera() called")
  ...
  def objectives(self) -> List[Optional[Objective]]:
    _unilab_logger.debug("[UNILAB] CytationBackend.objectives() called")
    if self._objectives is None:
  ...
  def filters(self) -> List[Optional[ImagingMode]]:
    _unilab_logger.debug("[UNILAB] CytationBackend.filters() called")
    if self._filters is None:
      raise RuntimeError(f"{self.__class__.__name__}: Filters are not set")
    return self._filters

  async def _load_filters(self):
    _unilab_logger.debug("[UNILAB] CytationBackend._load_filters() called")
    self._filters = []
  ...
  async def _load_objectives(self):
    _unilab_logger.debug("[UNILAB] CytationBackend._load_objectives() called")
    self._objectives = []
  ...
  def _stop_camera(self) -> None:
    _unilab_logger.debug("[UNILAB] CytationBackend._stop_camera() called")
  ...
  def _reset_trigger(self):
    _unilab_logger.debug("[UNILAB] CytationBackend._reset_trigger() called")
    if self._cam is None:
      return
  ...
  def _get_device_info(self, cam):
    _unilab_logger.debug("[UNILAB] CytationBackend._get_device_info() called")
  ...
  def start_acquisition(self):
    _unilab_logger.debug("[UNILAB] CytationBackend.start_acquisition() called")
    if self._cam is None:
  ...
  def stop_acquisition(self):
    _unilab_logger.debug("[UNILAB] CytationBackend.stop_acquisition() called")
    if self._cam is None:
      raise RuntimeError(f"{self.__class__.__name__}: Camera is not initialized.")
  ...
  async def led_on(self, intensity: int = 10):
    _unilab_logger.debug("[UNILAB] CytationBackend.led_on() called")
  ...
  async def led_off(self):
    _unilab_logger.debug("[UNILAB] CytationBackend.led_off() called")
    await self.send_command("i", "L0001")

  async def set_focus(self, focal_position: FocalPosition):
    _unilab_logger.debug("[UNILAB] CytationBackend.set_focus() called")
  ...
  async def set_position(self, x: float, y: float):
    _unilab_logger.debug("[UNILAB] CytationBackend.set_position() called")
    """
    Args:
  ...
  async def set_auto_exposure(self, auto_exposure: Literal["off", "once", "continuous"]):
    _unilab_logger.debug("[UNILAB] CytationBackend.set_auto_exposure() called")
    if self._cam is None:
  ...
  async def set_exposure(self, exposure: Exposure):
    _unilab_logger.debug("[UNILAB] CytationBackend.set_exposure() called")
  ...
  async def select(self, row: int, column: int):
    _unilab_logger.debug("[UNILAB] CytationBackend.select() called")
  ...
  async def set_gain(self, gain: Gain):
    _unilab_logger.debug("[UNILAB] CytationBackend.set_gain() called")
  ...
  def _imaging_mode_code(self, mode: ImagingMode) -> int:
    _unilab_logger.debug("[UNILAB] CytationBackend._imaging_mode_code() called")
  ...
  def _objective_code(self, objective: Objective) -> int:
    _unilab_logger.debug("[UNILAB] CytationBackend._objective_code() called")
    return self.objectives.index(objective) + 1

  async def set_objective(self, objective: Objective):
    _unilab_logger.debug("[UNILAB] CytationBackend.set_objective() called")
  ...
  async def set_imaging_mode(self, mode: ImagingMode, led_intensity: int):
    _unilab_logger.debug("[UNILAB] CytationBackend.set_imaging_mode() called")
    if self._cam is None:
      raise ValueError("Camera not initialized. Run setup(use_cam=True) first.")
  ...
  async def _acquire_image(
    ...
    _unilab_logger.debug("[UNILAB] CytationBackend._acquire_image() called")
  ...
  async def capture(
    ...
    _unilab_logger.debug("[UNILAB] CytationBackend.capture() called")
    ...
    try:
      ...
      def image_size(magnification: float) -> Tuple[float, float]:
        _unilab_logger.debug("[UNILAB] CytationBackend.image_size() called")
