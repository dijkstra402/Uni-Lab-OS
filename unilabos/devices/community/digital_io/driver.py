...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DigitalIO")
...
class DigitalIO(DataDevice, metaclass=abc.ABCMeta):
    ...
    def __init__(self, numLines: int, **kwargs) -> None:
        print("[UNILAB] DigitalIO.__init__() called", flush=True)
        super().__init__(**kwargs)
        if numLines < 1:
            raise ValueError(
    ...
    def get_num_lines(self):
        _unilab_logger.debug("[UNILAB] DigitalIO.get_num_lines() called")
        """Returns the number of IO lines present in this device."""
        return self._numLines

    @abc.abstractmethod
    def set_IO_state(self, line: int, state: bool):
        _unilab_logger.debug("[UNILAB] DigitalIO.set_IO_state() called")
    ...
    def get_IO_state(self, line):
        _unilab_logger.debug("[UNILAB] DigitalIO.get_IO_state() called")
    ...
    def set_all_IO_state(self, stateArray):
        _unilab_logger.debug("[UNILAB] DigitalIO.set_all_IO_state() called")
    ...
    def get_all_IO_state(self):
        _unilab_logger.debug("[UNILAB] DigitalIO.get_all_IO_state() called")
    ...
    def write_line(self, line, ouput):
        _unilab_logger.debug("[UNILAB] DigitalIO.write_line() called")
    ...
    def write_all_lines(self, ouput_array):
        _unilab_logger.debug("[UNILAB] DigitalIO.write_all_lines() called")
    ...
    def read_line(self, line):
        _unilab_logger.debug("[UNILAB] DigitalIO.read_line() called")
    ...
    def read_all_lines(self):
        _unilab_logger.debug("[UNILAB] DigitalIO.read_all_lines() called")
