...
Original: PYME/cluster/webdav.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.DirCollection")
...
class DirCollection(FileMember, Collection):
    ...
    def __init__(self, fsdir, virdir, parent=None):
        print("[UNILAB] DirCollection.__init__() called", flush=True)
    ...
    def getProperties(self):
        _unilab_logger.debug("[UNILAB] DirCollection.getProperties() called")
    ...
    def getMembers(self):
        _unilab_logger.debug("[UNILAB] DirCollection.getMembers() called")
    ...
    def rootdir(self):
        _unilab_logger.debug("[UNILAB] DirCollection.rootdir() called")
        return self.fsname
        
    def findMember(self, name):
        _unilab_logger.debug("[UNILAB] DirCollection.findMember() called")
    ...
    def sendData(self, wfile):
        _unilab_logger.debug("[UNILAB] DirCollection.sendData() called")
    ...
    def recvMember(self, rfile, name, size, req):
        _unilab_logger.debug("[UNILAB] DirCollection.recvMember() called")
