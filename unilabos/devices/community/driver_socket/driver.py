...
Original: autolab/core/server.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Driver_SOCKET")
...
# Vendored repo packages: autolab, autolab
import sys as _sys
...
from autolab.core.config import get_server_config
from autolab.core.devices import get_devices_status, get_device


class Driver_SOCKET():

    def __init__(self, *args, **kwargs):
        print("[UNILAB] Driver_SOCKET.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    prefix = b'<AUTOLAB_START>'
    suffix = b'<AUTOLAB_END>'

    def read(self, length=4096):
        _unilab_logger.debug("[UNILAB] Driver_SOCKET.read() called")
    ...
    def write(self, object):
        _unilab_logger.debug("[UNILAB] Driver_SOCKET.write() called")
