...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.EEPROM")
...
class EEPROM:
    ...
    def __init__(self):
        print("[UNILAB] EEPROM.__init__() called", flush=True)
    ...
    def init_fields(self):
        _unilab_logger.debug("[UNILAB] EEPROM.init_fields() called")
    ...
    def update_editable(self, new_eeprom):
        _unilab_logger.debug("[UNILAB] EEPROM.is_editable() called")
        for field in self.editable:
    ...
    def parse(self, buffers):
        _unilab_logger.debug("[UNILAB] EEPROM.parse() called")
    ...
    def read_eeprom(self):
        _unilab_logger.debug("[UNILAB] EEPROM.read_eeprom() called")
    ...
    def generate_feature_mask(self):
        _unilab_logger.debug("[UNILAB] EEPROM.generate_feature_mask() called")
        mask = 0
    ...
    def generate_write_buffers(self):
        _unilab_logger.debug("[UNILAB] EEPROM.generate_write_buffers() called")
    ...
    def printable(self, buf):
        _unilab_logger.debug("[UNILAB] EEPROM.printable() called")
        s = ""
        for c in buf:
            if 31 < c < 127:
                s += chr(c)
    ...
    def set(self, name, value):
        _unilab_logger.debug("[UNILAB] EEPROM.set() called")
    ...
    def float_to_uint16(self, gain):
        _unilab_logger.debug("[UNILAB] EEPROM.float_to_uint16() called")
    ...
    def unpack_field(self, name, quiet=False):
        _unilab_logger.debug("[UNILAB] EEPROM.unpack_field() called")
    ...
    def unpack(self, address, data_type, label=None, quiet=False):
        _unilab_logger.debug("[UNILAB] EEPROM.unpack() called")
        page       = address[0]
    ...
    def pack_field(self, name, quiet=False):
        _unilab_logger.debug("[UNILAB] EEPROM.pack_field() called")
        if name not in self.fields:
    ...
    def pack(self, address, data_type, value, label=None, quiet=False):
        _unilab_logger.debug("[UNILAB] EEPROM.pack() called")
        page       = address[0]
        start_byte = address[1]
        length     = address[2]
        end_byte   = start_byte + length
    ...
    def generate_digest(self, regenerate=False):
        _unilab_logger.debug("[UNILAB] EEPROM.generate_digest() called")
    ...
    def to_dict(self):
        _unilab_logger.debug("[UNILAB] EEPROM.to_dict() called")
        d = {}
    ...
    def json(self, allow_nan=True):
        _unilab_logger.debug("[UNILAB] EEPROM.json() called")
    ...
    ## log this object
    def dump(self):
        _unilab_logger.debug("[UNILAB] EEPROM.dump() called")
    ...
    def latest_rev(self):
        _unilab_logger.debug("[UNILAB] EEPROM.latest_rev() called")
        return EEPROM.LATEST_REV

    def get_horizontal_roi(self):
        _unilab_logger.debug("[UNILAB] EEPROM.get_horizontal_roi() called")
    ...
    def has_raman_intensity_calibration(self):
        _unilab_logger.debug("[UNILAB] EEPROM.has_horizontal_roi() called")
        if self.format < 6:
    ...
    def has_sml(self):
        _unilab_logger.debug("[UNILAB] EEPROM.has_sml() called")
        """ @todo include light_source_type """
        return self.has_laser and self.max_laser_power_mW < 150

    def has_mml(self):
        _unilab_logger.debug("[UNILAB] EEPROM.has_mml() called")
        """ @todo include light_source_type """
        return self.has_laser and self.max_laser_power_mW >= 150
    ...
    def laser_power_mW_to_percent(self, mW):
        _unilab_logger.debug("[UNILAB] EEPROM.laser_power_mW_to_percent() called")
    ...
    def is_valid_serial_number(self):
        _unilab_logger.debug("[UNILAB] EEPROM.is_valid_serial_number() called")
    ...
    def init_raman_intensity_calibration(self):
        _unilab_logger.debug("[UNILAB] EEPROM.init_raman_intensity_calibration() called")
        self.raman_intensity_calibration_order = 5
        self.raman_intensity_coeffs = []

    def read_raman_intensity_calibration(self):
        _unilab_logger.debug("[UNILAB] EEPROM.read_raman_intensity_calibration() called")
        self.raman_intensity_coeffs = []
    ...
    def write_raman_intensity_calibration(self):
        _unilab_logger.debug("[UNILAB] EEPROM.write_raman_intensity_calibration() called")
    ...
    def dump_raman_intensity_calibration(self):
        _unilab_logger.debug("[UNILAB] EEPROM.dump_raman_intensity_calibration() called")
    ...
    def init_spline(self):
        _unilab_logger.debug("[UNILAB] EEPROM.init_spline() called")
    ...
    def read_spline(self):
        _unilab_logger.debug("[UNILAB] EEPROM.read_spline() called")
        self.spline_wavelengths = []
        self.spline_y = []
        self.splint_y2 = []
    ...
    def write_spline(self):
        _unilab_logger.debug("[UNILAB] EEPROM.write_spline() called")
        log.error("EEPROM.write_spline not implemented")

    def dump_spline(self):
        _unilab_logger.debug("[UNILAB] EEPROM.dump_spline() called")
    ...
    def init_untethered(self):
        _unilab_logger.debug("[UNILAB] EEPROM.init_untethered() called")
    ...
    def read_untethered(self):
        _unilab_logger.debug("[UNILAB] EEPROM.read_untethered() called")
    ...
    def write_untethered(self):
        _unilab_logger.debug("[UNILAB] EEPROM.write_untethered() called")
    ...
    def dump_untethered(self):
        _unilab_logger.debug("[UNILAB] EEPROM.dump_untethered() called")
...
class EEPROMField:
    ...
    def __repr__(self): 
        _unilab_logger.debug("[UNILAB] EEPROM.__repr__() called")
        return str(self.__dict__)
    
    def toJSON(self): 
        _unilab_logger.debug("[UNILAB] EEPROM.toJSON() called")
        return str(self.__dict__)
