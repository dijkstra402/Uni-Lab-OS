...
Original: src/labtoolkit/__init__.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Enumerate")
...
# Vendored repo packages: labtoolkit
import sys as _sys
...
class Enumerate(metaclass=abc.ABCMeta):
    ...
    def __init__(self, *, resourcemanager, resources): # , ignores, additives, appendix):
        print("[UNILAB] Enumerate.__init__() called", flush=True)
        """."""
    ...
    def __post__(self):
        _unilab_logger.debug("[UNILAB] Enumerate.__post__() called")
        """."""
        pass

    def df(self):
        _unilab_logger.debug("[UNILAB] Enumerate.df() called")
        """."""
        return self.enumeration

    def select(self, index):
        _unilab_logger.debug("[UNILAB] Enumerate.select() called")
        """."""
        return self.enumeration.iloc[index].inst
    
    def show(self):
        _unilab_logger.debug("[UNILAB] Enumerate.show() called")
        """."""
    ...
    def driver_load(self):
        _unilab_logger.debug("[UNILAB] Enumerate.driver_load() called")
        """."""
    ...
    def enumerate_resources(self):
        _unilab_logger.debug("[UNILAB] Enumerate.enumerate_resources() called")
        """."""
    ...
    def IDN_fallback(self, inst, resource, mapping, number):
        _unilab_logger.debug("[UNILAB] Enumerate.IDN_fallback() called")
    ...
    def IDN_for_NRVS(self, inst, resource, mapping, number):
        _unilab_logger.debug("[UNILAB] Enumerate.IDN_for_NRVS() called")
        # sleep(.25)
    ...
    def IDN_for_HP(self, inst, resource, mapping, number):
        _unilab_logger.debug("[UNILAB] Enumerate.IDN_for_HP() called")
    ...
    def IDN_for_HP8903(self, inst, resource, mapping, number):
        _unilab_logger.debug("[UNILAB] Enumerate.IDN_for_HP8903() called")
    ...
    def driver_map(self):
        _unilab_logger.debug("[UNILAB] Enumerate.driver_map() called")
        """."""
    ...
    def drivers_sorted(self):
        _unilab_logger.debug("[UNILAB] Enumerate.drivers_sorted() called")
        """."""
    ...
    def driver_load_all(self):
        _unilab_logger.debug("[UNILAB] Enumerate.driver_load_all() called")
        """."""
