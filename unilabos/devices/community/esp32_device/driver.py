...
Original: esp32flashwriter_v4_0.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ESP32Device")
...
class ESP32Device(ttk.Labelframe):
    ...
    def __init__( self, master=None, style=None, fonts=None, *args, **kw ):
        print("[UNILAB] ESP32Device.__init__() called", flush=True)
    ...
    def _create_widgets( self ):
        _unilab_logger.debug("[UNILAB] ESP32Device._create_widgets() called")
    ...
    def _list_ports( self ):
        _unilab_logger.debug("[UNILAB] ESP32Device._list_ports() called")
    ...
    def _invoke_ports( self, event ):
        _unilab_logger.debug("[UNILAB] ESP32Device._invoke_ports() called")
        self._list_ports()
        self.ports.event_generate('<Down>')
        
        
    def _invoke_bauds( self, event ):
        _unilab_logger.debug("[UNILAB] ESP32Device._invoke_bauds() called")
        self.bauds.event_generate('<Down>')
        
        
    def _reset_baud( self, event=None ):
        _unilab_logger.debug("[UNILAB] ESP32Device._reset_baud() called")
        self.baud.set( esptool.ESPLoader.ESP_ROM_BAUD )


    def _format_baud( self, event=None ):
        _unilab_logger.debug("[UNILAB] ESP32Device._format_baud() called")
        print( '\ndef _format_baud( self, event=None ):' )
        self.bauds.selection_clear()

        
    def _connect_esp( self, event=None):
        _unilab_logger.debug("[UNILAB] ESP32Device._connect_esp() called")
    ...
    def _sop_for_not_connected( self ):
        _unilab_logger.debug("[UNILAB] ESP32Device._sop_for_not_connected() called")
        self.esp = None
        self.connecting = False
    ...
    def _sop_for_connecting( self ):
        _unilab_logger.debug("[UNILAB] ESP32Device._sop_for_connecting() called")
    ...
    def _port_is_busy( self, port):
        _unilab_logger.debug("[UNILAB] ESP32Device._port_is_busy() called")
    ...
    def _create_esp_connection( self ):
        _unilab_logger.debug("[UNILAB] ESP32Device._create_esp_connection() called")
    ...
    def _monitor_esp_connection(self):
        _unilab_logger.debug("[UNILAB] ESP32Device._monitor_esp_connection() called")
        ...
        def get_info():
            _unilab_logger.debug("[UNILAB] ESP32Device.get_info() called")
    ...
    def _check_connection( self ):
        _unilab_logger.debug("[UNILAB] ESP32Device._check_connection() called")
    ...
    def _validate_baud( self, S ):
        _unilab_logger.debug("[UNILAB] ESP32Device._validate_baud() called")
    ...
    def shutdown( self ):
        _unilab_logger.debug("[UNILAB] ESP32Device.shutdown() called")
