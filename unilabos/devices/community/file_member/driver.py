...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FileMember")
...
class FileMember(Member):
    def __init__(self, name, parent):
        print("[UNILAB] FileMember.__init__() called", flush=True)
        self.name = name
        self.parent = parent
        self.name = name
    ...
    def __str__(self):
        _unilab_logger.debug("[UNILAB] FileMember.__str__() called")
        return "%s -> %s" % (self.virname, self.fsname)

    def getProperties(self):
        _unilab_logger.debug("[UNILAB] FileMember.getProperties() called")
    ...
    def sendData(self, wfile,bpoint=0,epoint=0):
        _unilab_logger.debug("[UNILAB] FileMember.sendData() called")
