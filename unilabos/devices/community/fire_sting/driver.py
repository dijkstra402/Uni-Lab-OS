...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.FireSting")
...
class FireSting:
    def __init__(self, port, baud=None):
        print("[UNILAB] FireSting.__init__() called", flush=True)
    ...
    @property
    def settings(self):
        _unilab_logger.debug("[UNILAB] FireSting.measure() called")
        """ Fet the settings of all channels"""
        return {k: c.settings for k, c in self.channels.items()}

    @property
    def led_intensity(self):
        _unilab_logger.debug("[UNILAB] FireSting.led_intensity() called")
    ...
    @property
    def measure_time(self):
        _unilab_logger.debug("[UNILAB] FireSting.measure_time() called")
    ...
    @property
    def amplification(self):
        _unilab_logger.debug("[UNILAB] FireSting.amplification() called")
    ...
    @property
    def frequency(self):
        _unilab_logger.debug("[UNILAB] FireSting.frequency() called")
    ...
    @property
    def temperature(self):
        _unilab_logger.debug("[UNILAB] FireSting.temperature() called")
    ...
    @property
    def salinity(self):
        _unilab_logger.debug("[UNILAB] FireSting.salinity() called")
    ...
    @property
    def pressure(self):
        _unilab_logger.debug("[UNILAB] FireSting.pressure() called")
    ...
    def blink(self):
        _unilab_logger.debug("[UNILAB] FireSting.blink() called")
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] FireSting.disconnect() called")
