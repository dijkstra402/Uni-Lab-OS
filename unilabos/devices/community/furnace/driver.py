...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.furnace")
...
class furnace:
    ...
    def __init__(self,address) -> None:
        print("[UNILAB] furnace.__init__() called", flush=True)
    ...
    def SetTemp(self,setpoint):
        _unilab_logger.debug("[UNILAB] furnace.SetTemp() called")
        '''
    ...
    def QueryTemp(self):
        _unilab_logger.debug("[UNILAB] furnace.QueryTemp() called")
        '''
    ...
    def ChangeAddress(self,new_address):
        _unilab_logger.debug("[UNILAB] furnace.ChangeAddress() called")
        pass

    def ReportStatus(self):
        _unilab_logger.debug("[UNILAB] furnace.ReportStatus() called")
        function_code = '07'
        response_length = 5
    ...
    def __SendCommand(self,command,response_length,function_code):
        _unilab_logger.debug("[UNILAB] furnace.__SendCommand() called")
        '''
    ...
    def __ReceiveResponse(self,response_length,function_code):
        _unilab_logger.debug("[UNILAB] furnace.__ReceiveResponse() called")
        '''
    ...
    def __CRC(self,msg):
        _unilab_logger.debug("[UNILAB] furnace.__CRC() called")
        '''
