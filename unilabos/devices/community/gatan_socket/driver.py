...
Original: src/instamatic/camera/gatansocket3.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GatanSocket")
...
# Vendored repo packages: instamatic
import sys as _sys
...
class GatanSocket:
    def __init__(self, host='', port=None):
        print("[UNILAB] GatanSocket.__init__() called", flush=True)
        self.host = host
        if port is not None:
            self.port = port
    ...
    def hasScriptFunction(self, name):
        _unilab_logger.debug("[UNILAB] GatanSocket.hasScriptFunction() called")
        script = f'if ( DoesFunctionExist("{name}") ) {{ Exit(1.0); }} else {{ Exit(-1.0); }}'
        result = self.ExecuteGetDoubleScript(script)
        return result > 0.0

    def connect(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.connect() called")
        # recommended by Gatan to use localhost IP to avoid using tcp
        self.sock = socket.create_connection(('127.0.0.1', self.port))

    def disconnect(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.disconnect() called")
        self.sock.shutdown(socket.SHUT_RDWR)
        self.sock.close()

    def reconnect(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.reconnect() called")
        self.disconnect()
        self.connect()

    @logwrap
    def send_data(self, data):
        _unilab_logger.debug("[UNILAB] GatanSocket.send_data() called")
        return self.sock.sendall(data)

    @logwrap
    def recv_data(self, n):
        _unilab_logger.debug("[UNILAB] GatanSocket.recv_data() called")
        return self.sock.recv(n)

    def ExchangeMessages(self, message_send, message_recv=None):
        _unilab_logger.debug("[UNILAB] GatanSocket.ExchangeMessages() called")
    ...
    def GetLong(self, funcName):
        _unilab_logger.debug("[UNILAB] GatanSocket.GetLong() called")
    ...
    def SendLongGetLong(self, funcName, longarg):
        _unilab_logger.debug("[UNILAB] GatanSocket.SendLongGetLong() called")
    ...
    def GetDMVersion(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.GetDMVersion() called")
        return self.GetLong('GS_GetDMVersion')

    def GetNumberOfCameras(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.GetNumberOfCameras() called")
        return self.GetLong('GS_GetNumberOfCameras')

    def GetPluginVersion(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.GetPluginVersion() called")
        return self.GetLong('GS_GetPluginVersion')

    def IsCameraInserted(self, camera):
        _unilab_logger.debug("[UNILAB] GatanSocket.IsCameraInserted() called")
    ...
    def InsertCamera(self, camera, state):
        _unilab_logger.debug("[UNILAB] GatanSocket.InsertCamera() called")
    ...
    def SetReadMode(self, mode, scaling=1.0):
        _unilab_logger.debug("[UNILAB] GatanSocket.SetReadMode() called")
    ...
    def SetShutterNormallyClosed(self, camera, shutter):
        _unilab_logger.debug("[UNILAB] GatanSocket.SetShutterNormallyClosed() called")
    ...
    def SetK2Parameters(
        ...
        _unilab_logger.debug("[UNILAB] GatanSocket.SetK2Parameters() called")
    ...
    def setNumGrabSum(self, earlyReturnFrameCount, earlyReturnRamGrabs):
        _unilab_logger.debug("[UNILAB] GatanSocket.setNumGrabSum() called")
    ...
    def getNumGrabSum(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.getNumGrabSum() called")
    ...
    def SetupFileSaving(
        ...
        _unilab_logger.debug("[UNILAB] GatanSocket.SetupFileSaving() called")
        pixelSize = 1.0
    ...
    def SelectCamera(self, cameraid):
        _unilab_logger.debug("[UNILAB] GatanSocket.SelectCamera() called")
    ...
    def UpdateK2HardwareDarkReference(self, cameraid):
        _unilab_logger.debug("[UNILAB] GatanSocket.UpdateK2HardwareDarkReference() called")
    ...
    def GetEnergyFilter(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.GetEnergyFilter() called")
    ...
    def SetEnergyFilter(self, value):
        _unilab_logger.debug("[UNILAB] GatanSocket.SetEnergyFilter() called")
    ...
    def GetEnergyFilterWidth(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.GetEnergyFilterWidth() called")
    ...
    def SetEnergyFilterWidth(self, value):
        _unilab_logger.debug("[UNILAB] GatanSocket.SetEnergyFilterWidth() called")
    ...
    def GetEnergyFilterOffset(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.GetEnergyFilterOffset() called")
    ...
    def SetEnergyFilterOffset(self, value):
        _unilab_logger.debug("[UNILAB] GatanSocket.SetEnergyFilterOffset() called")
    ...
    def AlignEnergyFilterZeroLossPeak(self):
        _unilab_logger.debug("[UNILAB] GatanSocket.AlignEnergyFilterZeroLossPeak() called")
    ...
    def GetImage(
        ...
        _unilab_logger.debug("[UNILAB] GatanSocket.GetImage() called")
        """
        processing : str
    ...
    def ExecuteSendCameraObjectionFunction(self, function_name, camera_id=0):
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteSendCameraObjectionFunction() called")
    ...
    def ExecuteGetLongCameraObjectFunction(self, function_name, camera_id=0):
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteGetLongCameraObjectFunction() called")
    ...
    def ExecuteGetDoubleCameraObjectFunction(self, function_name, camera_id=0):
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteGetDoubleCameraObjectFunction() called")
        """Execute DM script function that requires camera object as input and
    ...
    def ExecuteCameraObjectFunction(
        ...
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteCameraObjectFunction() called")
    ...
    def ExecuteSendScript(self, command_line, select_camera=0):
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteSendScript() called")
        recv_longargs_init = (0,)
    ...
    def ExecuteGetLongScript(self, command_line, select_camera=0):
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteGetLongScript() called")
    ...
    def ExecuteGetDoubleScript(self, command_line, select_camera=0):
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteGetDoubleScript() called")
    ...
    def ExecuteScript(
        ...
        _unilab_logger.debug("[UNILAB] GatanSocket.ExecuteScript() called")
    ...
    def RunScript(self, fn: str, background: bool = False):
        _unilab_logger.debug("[UNILAB] GatanSocket.RunScript() called")
        """Run a DM script.
