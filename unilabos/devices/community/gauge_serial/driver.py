...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GaugeSerial")
...
from pcdsdevices.doc_stubs import GaugeSet_base
...
class GaugeSerial(Device):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] GaugeSerial.__init__() called", flush=True)
