...
Original: can/interfaces/udp_multicast/bus.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GeneralPurposeUdpMulticastBus")
...
from can.interfaces.udp_multicast.utils import is_msgpack_installed, pack_message, unpack_message
...
class GeneralPurposeUdpMulticastBus:
    ...
    def __init__(
        ...
        print("[UNILAB] GeneralPurposeUdpMulticastBus.__init__() called", flush=True)
        self.group = group
        self.port = port
    ...
    def _create_socket(self, address_family: socket.AddressFamily) -> socket.socket:
        _unilab_logger.debug("[UNILAB] GeneralPurposeUdpMulticastBus._create_socket() called")
    ...
    def send(self, data: bytes, timeout: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] GeneralPurposeUdpMulticastBus.send() called")
    ...
    def recv(
        ...
        _unilab_logger.debug("[UNILAB] GeneralPurposeUdpMulticastBus.recv() called")
        """
    ...
    def fileno(self) -> int:
        _unilab_logger.debug("[UNILAB] GeneralPurposeUdpMulticastBus.fileno() called")
        """Provides the internally used file descriptor of the socket or `-1` if not available."""
        return self._socket.fileno()

    def shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] GeneralPurposeUdpMulticastBus.shutdown() called")
        """Close all sockets and free up any resources.
...
__all__ = ["GeneralPurposeUdpMulticastBus"]
