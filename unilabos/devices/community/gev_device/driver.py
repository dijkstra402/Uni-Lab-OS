...
Original: imswitch/imcontrol/model/interfaces/gxipy/gxiapi.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GEVDevice")
...
class GEVDevice(Device):
    def __init__(self, handle):
        print("[UNILAB] GEVDevice.__init__() called", flush=True)
        self.__dev_handle = handle
