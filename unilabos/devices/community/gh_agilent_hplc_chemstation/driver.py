...
Original: https://github.com/croningp/analyticallabware / AnalyticalLabware/devices/Agilent/hplc.py
...
_unilab_logger = logging.getLogger("unilab.driver.HPLCController")
