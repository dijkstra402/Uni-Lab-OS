...
Original: https://github.com/hailegroup/nupylab / nupylab/drivers/eurotherm3216.py
...
_unilab_logger = logging.getLogger("unilab.driver.Eurotherm3216")
...
"""Driver for Eurotherm 3216 built on minimalmodbus.

Eurotherm 3216 only supports RTU MODBUS mode. Transmission format:
    * 1 start bit
    * 8 data bits
...
class Eurotherm3216(minimalmodbus.Instrument):
    ...
    Attributes:
        ...
        segments: program segments, accessible as segments[0], segments[1], etc.
    """
    ...
    class Segment:
        ...
        def __init__(self, segment_num: int, eurotherm: Eurotherm3216) -> None:
            ...
            self.eurotherm: Eurotherm3216 = eurotherm
