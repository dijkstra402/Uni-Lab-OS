...
Original: https://github.com/iorodeo/potentiostat / software/python/potentiostat/potentiostat/potentiostat.py
...
_unilab_logger = logging.getLogger("unilab.driver.Potentiostat")
