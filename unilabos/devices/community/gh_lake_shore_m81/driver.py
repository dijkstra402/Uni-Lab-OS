...
Original: https://github.com/QCoDeS/Qcodes_contrib_drivers / src/qcodes_contrib_drivers/drivers/Lakeshore/modules/senseBase.py
...
_unilab_logger = logging.getLogger("unilab.driver.senseBase")
