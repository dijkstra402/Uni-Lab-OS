...
Original: https://github.com/microsoft/Qcodes / src/qcodes/instrument_drivers/QuantumDesign/DynaCoolPPMS/DynaCool.py
...
_unilab_logger = logging.getLogger("unilab.driver.DynaCool")
