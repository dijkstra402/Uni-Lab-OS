...
Original: https://github.com/paulscherrerinstitute/shimadzu_pump / shimadzu_pump/shimadzu_driver.py
...
_unilab_logger = logging.getLogger("unilab.driver.ShimadzuCbm20")
