...
Original: https://github.com/QCoDeS/Qcodes_contrib_drivers / src/qcodes_contrib_drivers/drivers/Thermotek/Thermotek_T255p.py
...
_unilab_logger = logging.getLogger("unilab.driver.ThermotekT255p")
