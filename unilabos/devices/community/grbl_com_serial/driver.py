...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.grblComSerial")
...
# Vendored repo packages: grblComStack, cn5X_config
import sys as _sys
...
class grblComSerial(QObject):
  ...
  def __init__(self, decodeur, comPort: str, baudRate: int, pooling: bool):
    print("[UNILAB] grblComSerial.__init__() called", flush=True)
    super().__init__()
  ...
  def startPooling(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.startPooling() called")
    self.__pooling = True


  @pyqtSlot()
  def stopPooling(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.stopPooling() called")
    self.__pooling = False


  @pyqtSlot()
  def abort(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.abort() called")
  ...
  @pyqtSlot()
  def clearCom(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.clearCom() called")
  ...
  def realTimePush(self, buff: str, flag = COM_FLAG_NO_FLAG):
    _unilab_logger.debug("[UNILAB] grblComSerial.realTimePush() called")
  ...
  def gcodePush(self, buff: str, flag = COM_FLAG_NO_FLAG):
    _unilab_logger.debug("[UNILAB] grblComSerial.gcodePush() called")
  ...
  def resetSerial(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.resetSerial() called")
  ...
  def gcodeInsert(self, buff: str, flag = COM_FLAG_NO_FLAG):
    _unilab_logger.debug("[UNILAB] grblComSerial.gcodeInsert() called")
  ...
  def __sendData(self, buff: str):
    _unilab_logger.debug("[UNILAB] grblComSerial.__sendData() called")
  ...
  def __traileLaLigne(self, l, flag = COM_FLAG_NO_FLAG):
    _unilab_logger.debug("[UNILAB] grblComSerial.__traileLaLigne() called")
  ...
  def __openComPort(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.__openComPort() called")
  ...
  def __mainLoop(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.__mainLoop() called")
  ...
  @pyqtSlot()
  def run(self):
    _unilab_logger.debug("[UNILAB] grblComSerial.run() called")
