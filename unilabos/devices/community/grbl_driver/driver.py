...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.GrblDriver")
...
class GrblDriver:
    ...
    def __init__(self, address='/dev/ttyACM0'):
        print("[UNILAB] GrblDriver.__init__() called", flush=True)
    ...
    def _update_writesettings(self):
        _unilab_logger.debug("[UNILAB] GrblDriver._update_writesettings() called")
        self.xwritesettings={
    ...
    def write_global_config(self, wait=0.02):
        _unilab_logger.debug("[UNILAB] GrblDriver.write_global_config() called")
    ...
    def _write_settings(self, settings, settingsmap, wait=0.5):
        _unilab_logger.debug("[UNILAB] GrblDriver._write_settings() called")
    ...
    def write_all_settings(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.write_all_settings() called")
    ...
    def verify_settings(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.verify_settings() called")
    ...
    def _write(self, command, flush=False):
        _unilab_logger.debug("[UNILAB] GrblDriver._write() called")
    ...
    def _read_buffer(self, maxreads = 100):
        _unilab_logger.debug("[UNILAB] GrblDriver._read_buffer() called")
    ...
    def _move(self, axis, steps, config, blocking = True, pingwait = 0.25):
        _unilab_logger.debug("[UNILAB] GrblDriver._move() called")
    ...
    def shake_plate(self, d_shift=100, time_shake = 30):
        _unilab_logger.debug("[UNILAB] GrblDriver.shake_plate() called")
        """let the plate shake"""
    ...
    def move_rel(self, position_rel=(0,0,0), blocking = True, pingwait = 0.25):
        _unilab_logger.debug("[UNILAB] GrblDriver.move_rel() called")
    ...
    def move_abs(self, position_rel=(0,0,0), blocking = True, pingwait = 0.25):
        _unilab_logger.debug("[UNILAB] GrblDriver.move_abs() called")
    ...
    def move_xyz(self, position=(0,0,0), blocking = True, pingwait = 0.25, config="abs"):
        _unilab_logger.debug("[UNILAB] GrblDriver.move_xyz() called")
        """Move axis with optional blocking"""
        self.get_positions()
        if config == "abs":
            to_go = position
        elif config == "rel":
            to_go = (position[0]+self.positions[0],
    ...
    def xmove(self, steps, blocking = True):
        _unilab_logger.debug("[UNILAB] GrblDriver.xmove() called")
    ...
    def ymove(self, steps, blocking = True):
        _unilab_logger.debug("[UNILAB] GrblDriver.ymove() called")
    ...
    def zmove(self, steps, blocking = True):
        _unilab_logger.debug("[UNILAB] GrblDriver.zmove() called")
    ...
    def home(self, offset=(0,0,0), blocking=True, pingwait=0.01, zhome=False):
        _unilab_logger.debug("[UNILAB] GrblDriver.home() called")
    ...
    def zhome(self, steps=20000):
        _unilab_logger.debug("[UNILAB] GrblDriver.zhome() called")
    ...
    def get_status_report(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.get_status_report() called")
    ...
    def check_alarm(self, bufferoutput):
        _unilab_logger.debug("[UNILAB] GrblDriver.check_alarm() called")
    ...
    def reset_stage(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.reset_stage() called")
        self._write('$G')
        self._write('$X')
        self._write('?')
    ...
    def current_position(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.current_position() called")
        """get current positoins but as a list"""
        return self.positions

    def get_positions(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.get_positions() called")
    ...
    def zero_position(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.zero_position() called")
    ...
    def _human_readable_settings(self):
        _unilab_logger.debug("[UNILAB] GrblDriver._human_readable_settings() called")
    ...
    def set_laser_intensity(self, intensity):
        _unilab_logger.debug("[UNILAB] GrblDriver.set_laser_intensity() called")
        ...
        cmd =  prefix+" S"+str(self.laser_intensity)
        return self._write(cmd)

    def set_led(self, state=1):
        _unilab_logger.debug("[UNILAB] GrblDriver.set_led() called")
    ...
    def soft_reset(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.soft_reset() called")
    ...
    def controlled_stop(self, pingwait=0.25):
        _unilab_logger.debug("[UNILAB] GrblDriver.controlled_stop() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.stop() called")
        """Emergency stop that stops all motion. Loses motor positioning."""
        self.soft_reset()

    def alarm_reset(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.alarm_reset() called")
        """Reset 'alarm' status, usually after emergency stop or hard limit."""
        self._write('$X')

    def close(self):
        _unilab_logger.debug("[UNILAB] GrblDriver.close() called")
