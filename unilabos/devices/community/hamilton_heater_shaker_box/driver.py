...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HamiltonHeaterShakerBox")
...
class HamiltonHeaterShakerBox(HamiltonHeaterShakerInterface):
  def __init__(
    ...
    print("[UNILAB] HamiltonHeaterShakerBox.__init__() called", flush=True)
    self.io = USB(
      id_vendor=id_vendor,
  ...
  def _generate_id(self) -> int:
    _unilab_logger.debug("[UNILAB] HamiltonHeaterShakerBox._generate_id() called")
    """continuously generate unique ids 0 <= x < 10000."""
    self._id += 1
    return self._id % 10000

  async def setup(self):
    _unilab_logger.debug("[UNILAB] HamiltonHeaterShakerBox.setup() called")
    """
  ...
  async def stop(self):
    _unilab_logger.debug("[UNILAB] HamiltonHeaterShakerBox.stop() called")
    await self.io.stop()

  async def send_hhs_command(self, index: int, command: str, **kwargs) -> str:
    _unilab_logger.debug("[UNILAB] HamiltonHeaterShakerBox.send_hhs_command() called")
