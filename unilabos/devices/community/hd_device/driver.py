...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HDDevice")
...
class HDDevice(ziShellDevice):
    def __init__(self, *args, **kwargs):
        print("[UNILAB] HDDevice.__init__() called", flush=True)
    ...
    def connect_device(self, device, interface='1GbE'):
        _unilab_logger.debug("[UNILAB] HDDevice.connect_device() called")
        super().connect_device(device, interface)
    ...
    def configure_awg_file(self, filename, awg=0):
        _unilab_logger.debug("[UNILAB] HDDevice.configure_awg_file() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def configure_awg_string(self, string, awg):
        _unilab_logger.debug("[UNILAB] HDDevice.configure_awg_string() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def on(self, outputs):
        _unilab_logger.debug("[UNILAB] HDDevice.on() called")
    ...
    def off(self, outputs):
        _unilab_logger.debug("[UNILAB] HDDevice.off() called")
        if isinstance(outputs, str):
    ...
    def extclk(self, on):
        _unilab_logger.debug("[UNILAB] HDDevice.extclk() called")
        if on:
    ...
    def sampleclk(self, rate):
        _unilab_logger.debug("[UNILAB] HDDevice.sampleclk() called")
        self.seti('awgs/*/enable', 0)
        self.setd('system/sampleclk', rate)

    def mode(self, outputs, amp):
        _unilab_logger.debug("[UNILAB] HDDevice.mode() called")
        if isinstance(outputs, str):
    ...
    def direct(self, outputs, dir):
        _unilab_logger.debug("[UNILAB] HDDevice.direct() called")
        if isinstance(outputs, str):
    ...
    def calibrate_dio_protocol(self, awgs):
        _unilab_logger.debug("[UNILAB] HDDevice.calibrate_dio_protocol() called")
        pass

    def dio_snapshot(self, bits=range(32), line_width=64, dump=False):
        _unilab_logger.debug("[UNILAB] HDDevice.dio_snapshot() called")
    ...
    def awg_dio_snapshot(self, awg, bits=range(32), line_width=64, dump=False):
        _unilab_logger.debug("[UNILAB] HDDevice.awg_dio_snapshot() called")
    ...
    def dio_testmode(self, on, mode=0):
        _unilab_logger.debug("[UNILAB] HDDevice.dio_testmode() called")
