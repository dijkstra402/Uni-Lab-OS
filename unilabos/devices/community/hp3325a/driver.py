...
Original: src/instruments/hp/hp3325a.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HP3325a")
...
class HP3325a(FunctionGenerator):
    ...
    def __init__(self, filelike):
        print("[UNILAB] HP3325a.__init__() called", flush=True)
        """
    ...
    def query(self, cmd, size=-1):
        _unilab_logger.debug("[UNILAB] HP3325a.query() called")
        """
    ...
    def amplitude_calibration(self):
        _unilab_logger.debug("[UNILAB] HP3325a.amplitude_calibration() called")
        self.sendcmd("AC")

    def assign_zero_phase(self):
        _unilab_logger.debug("[UNILAB] HP3325a.assign_zero_phase() called")
        self.sendcmd("AP")
    ...
    def query_error(self) -> int:
        _unilab_logger.debug("[UNILAB] HP3325a.query_error() called")
