...
Original: src/labtoolkit/NetworkAnalyser/HP4395A.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HP4395A")
...
class HP4395A(IEEE488):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] HP4395A.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    @property
    def trace(self):
        _unilab_logger.debug("[UNILAB] HP4395A.trace() called")
    ...
    @property
    def points(self):
        _unilab_logger.debug("[UNILAB] HP4395A.points() called")
    ...
    @property
    def bandwidth(self):
        _unilab_logger.debug("[UNILAB] HP4395A.bandwidth() called")
        """IF Bandwidth.
    ...
    @property
    def form(self):
        _unilab_logger.debug("[UNILAB] HP4395A.form() called")
        """Format.
    ...
    def sweepformat(self):
        _unilab_logger.debug("[UNILAB] HP4395A.sweepformat() called")
        """Format.
    ...
    @property
    def paramater(self):
        _unilab_logger.debug("[UNILAB] HP4395A.paramater() called")
        """Measure paramater.
    ...
    def attenuationr(self):
        _unilab_logger.debug("[UNILAB] HP4395A.attenuationr() called")
    ...
    def attenuationa(self):
        _unilab_logger.debug("[UNILAB] HP4395A.attenuationa() called")
    ...
    def attenuationb(self):
        _unilab_logger.debug("[UNILAB] HP4395A.attenuationb() called")
    ...
    def sourcepower(self):
        _unilab_logger.debug("[UNILAB] HP4395A.sourcepower() called")
        """Source power dBm."""
    ...
    @property
    def start(self):
        _unilab_logger.debug("[UNILAB] HP4395A.start() called")
        """Start frequency."""
    ...
    @property
    def stop(self):
        _unilab_logger.debug("[UNILAB] HP4395A.stop() called")
        """Stop frequency."""
