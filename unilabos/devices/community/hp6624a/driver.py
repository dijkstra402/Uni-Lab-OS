...
Original: src/instruments/hp/hp6624a.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HP6624a")
...
class HP6624a(PowerSupply):
    ...
    def __init__(self, filelike):
        print("[UNILAB] HP6624a.__init__() called", flush=True)
    ...
    class Channel(PowerSupply.Channel):
        ...
        def _format_cmd(self, cmd):
            _unilab_logger.debug("[UNILAB] HP6624a._format_cmd() called")
            cmd = cmd.split(" ")
            if len(cmd) == 1:
        ...
        def sendcmd(self, cmd):
            _unilab_logger.debug("[UNILAB] HP6624a.sendcmd() called")
            """
        ...
        def query(self, cmd):
            _unilab_logger.debug("[UNILAB] HP6624a.query() called")
            """
            Function used to send a command to the instrument while wrapping
            the command with the neccessary identifier for the channel.
        ...
        @property
        def mode(self):
            _unilab_logger.debug("[UNILAB] HP6624a.mode() called")
            """
        ...
        def reset(self):
            _unilab_logger.debug("[UNILAB] HP6624a.reset() called")
            """
    ...
    @property
    def channel(self):
        _unilab_logger.debug("[UNILAB] HP6624a.channel() called")
        """
    ...
    @property
    def voltage(self):
        _unilab_logger.debug("[UNILAB] HP6624a.voltage() called")
        """
    ...
    @property
    def current(self):
        _unilab_logger.debug("[UNILAB] HP6624a.current() called")
        """
    ...
    def voltage_sense(self):
        _unilab_logger.debug("[UNILAB] HP6624a.voltage_sense() called")
        """
    ...
    def current_sense(self):
        _unilab_logger.debug("[UNILAB] HP6624a.current_sense() called")
        """
    ...
    def channel_count(self):
        _unilab_logger.debug("[UNILAB] HP6624a.channel_count() called")
        """
    ...
    def clear(self):
        _unilab_logger.debug("[UNILAB] HP6624a.clear() called")
        """
