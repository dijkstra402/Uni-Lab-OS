...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.HTTPConnection")
...
class HTTPConnection(AbstractConnection):
    ...
    def __init__(self, connection_parameters: ConnectionParameters):
        print("[UNILAB] HTTPConnection.__init__() called", flush=True)
        """
        Args:
    ...
    def open_connection(self):
        _unilab_logger.debug("[UNILAB] HTTPConnection.open_connection() called")
    ...
    def close_connection(self):
        _unilab_logger.debug("[UNILAB] HTTPConnection.close_connection() called")
        """Closes connection.
        """
    ...
    def receive(self):
        _unilab_logger.debug("[UNILAB] HTTPConnection.transmit() called")
    ...
    def is_connection_open(self):
        _unilab_logger.debug("[UNILAB] HTTPConnection.is_connection_open() called")
