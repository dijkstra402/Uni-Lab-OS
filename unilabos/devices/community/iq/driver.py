...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.IQ")
...
class IQ(object):
    ...
    def __init__(self):
        print("[UNILAB] IQ.__init__() called", flush=True)
    ...
    def __iqiq2complex__(self, iqiq):
        _unilab_logger.debug("[UNILAB] IQ.__iqiq2complex__() called")
    ...
    def __iiqq2complex__(self, iiqq):
        _unilab_logger.debug("[UNILAB] IQ.__iiqq2complex__() called")
    ...
    def __complex2iqiq__(self):
        _unilab_logger.debug("[UNILAB] IQ.__complex2iqiq__() called")
    ...
    def writeIqw(self, FileName):                                               # Verified 2020.0115
        ...
        try:
            ...
            print(f"File ({FileName}) write error!")
            return 0
    ...
    def readIqw(self, FileName, iqiq=True):                                     # Verified 2020.0115
        ...
        try:
            ...
            print(f"File open error ({FileName})!")
    ...
    def readWv(self, FileName):                                                          # Verified 2020.0115
        ...
        try:
            ...
            print(f"File open ({FileName}) error!")
            return
    ...
    def writeIqTar(self, FileName):                                                 # Verified 2020.0115  # pylint: disable=R1710
        ...
        try:
            ...
            print(f"IqTar ({FileName}) write error!")
            return 0
    ...
    def readIqTar(self, FileName):               # Verified 2020.0115
        ...
        try:
            ...
            print(f"IqTar ({FileName}) read error!")
