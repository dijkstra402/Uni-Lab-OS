...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.IXBX")
...
class IXBX(SerialDriver):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] IXBX.__init__() called", flush=True)
    ...
    @Feat(read_once=True)
    def idn(self):
        _unilab_logger.debug("[UNILAB] IXBX.idn() called")
    ...
    def lamp_status(self):
        _unilab_logger.debug("[UNILAB] IXBX.lamp_status() called")
        #LMPSTS OK, X
        pass
    ...
    def soft_limits(self):
        _unilab_logger.debug("[UNILAB] IXBX.soft_limits() called")
    ...
    def movement_status(self):
        _unilab_logger.debug("[UNILAB] IXBX.movement_status() called")
        return self.query('ZDRV?')

    @Action(units=ZSTEP)
    def move_relative(self, distance):
        _unilab_logger.debug("[UNILAB] IXBX.move_relative() called")
        if distance == 0:
            return
        elif distance < 0:
            distance = -distance
    ...
    @Feat(units=ZSTEP)
    def z(self):
        _unilab_logger.debug("[UNILAB] IXBX.z() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] IXBX.stop() called")
    ...
    def init_origin(self):
        _unilab_logger.debug("[UNILAB] IXBX.init_origin() called")
        """Init origin
        """
        #INITORG
        pass
