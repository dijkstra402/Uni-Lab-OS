...
Original: can/interfaces/kvaser/canlib.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.KvaserBus")
...
from can.interfaces.kvaser import structures
...
class KvaserBus(BusABC):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("[UNILAB] KvaserBus.__init__() called", flush=True)
        """
        :param int channel:
    ...
    def _update_timestamp_offset(self) -> float:
        _unilab_logger.debug("[UNILAB] KvaserBus._update_timestamp_offset() called")
    ...
    def _apply_filters(self, filters):
        _unilab_logger.debug("[UNILAB] KvaserBus._apply_filters() called")
    ...
    def flush_tx_buffer(self):
        _unilab_logger.debug("[UNILAB] KvaserBus.flush_tx_buffer() called")
        """Wipeout the transmit buffer on the Kvaser."""
        canIoCtl(self._write_handle, canstat.canIOCTL_FLUSH_TX_BUFFER, 0, 0)

    def _recv_internal(self, timeout=None):
        _unilab_logger.debug("[UNILAB] KvaserBus._recv_internal() called")
        """
    ...
    def send(self, msg, timeout=None):
        _unilab_logger.debug("[UNILAB] KvaserBus.send() called")
    ...
    def flash(self, flash=True):
        _unilab_logger.debug("[UNILAB] KvaserBus.flash() called")
        """
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] KvaserBus.shutdown() called")
        super().shutdown()
    ...
    def get_stats(self) -> structures.BusStatistics:
        _unilab_logger.debug("[UNILAB] KvaserBus.get_stats() called")
    ...
    def _detect_available_configs():
        _unilab_logger.debug("[UNILAB] KvaserBus._detect_available_configs() called")
        config_list = []
