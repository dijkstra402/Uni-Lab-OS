...
Original: pica/keysight/CV_KE4980A_GUI.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LCR_Backend")
...
class LCR_Backend:
    ...
    def __init__(self):
        print("[UNILAB] LCR_Backend.__init__() called", flush=True)
    ...
    def initialize_instrument(self, parameters):
        _unilab_logger.debug("[UNILAB] LCR_Backend.initialize_instrument() called")
    ...
    def perform_measurement(self, voltage):
        _unilab_logger.debug("[UNILAB] LCR_Backend.perform_measurement() called")
    ...
    def close_instrument(self):
        _unilab_logger.debug("[UNILAB] LCR_Backend.close_instrument() called")
