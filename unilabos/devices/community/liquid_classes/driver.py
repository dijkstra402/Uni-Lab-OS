...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LiquidClasses")
...
class LiquidClasses:
    ...
    def __init__(self, database:Path):
        print("[UNILAB] LiquidClasses.__init__() called", flush=True)
    ...
    def _read_cus_liq_class_xml_file(self, custom_file):
        _unilab_logger.debug("[UNILAB] LiquidClasses._read_cus_liq_class_xml_file() called")
    ...
    def _read_cus_liq_class_txt_file(self, custom_file):
        _unilab_logger.debug("[UNILAB] LiquidClasses._read_cus_liq_class_txt_file() called")
    ...
    def _read_def_liq_class_xml_file(self, default_file):
        _unilab_logger.debug("[UNILAB] LiquidClasses._read_def_liq_class_xml_file() called")
    ...
    def _read_def_liq_class_txt_file(self, default_file):
        _unilab_logger.debug("[UNILAB] LiquidClasses._read_def_liq_class_txt_file() called")
