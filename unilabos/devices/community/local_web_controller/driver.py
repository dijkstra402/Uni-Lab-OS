...
Original: donkeycar/parts/web_controller/web.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LocalWebController")
...
class LocalWebController(tornado.web.Application):
    ...
    def __init__(self, port=8887, mode='user'):
        print("[UNILAB] LocalWebController.__init__() called", flush=True)
        """
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] LocalWebController.update() called")
    ...
    def update_wsclients(self, data):
        _unilab_logger.debug("[UNILAB] LocalWebController.update_wsclients() called")
        if data:
    ...
    def run_threaded(self, img_arr=None, num_records=0, mode=None, recording=None):
        _unilab_logger.debug("[UNILAB] LocalWebController.run_threaded() called")
        """
    ...
    def run(self, img_arr=None, num_records=0, mode=None, recording=None):
        _unilab_logger.debug("[UNILAB] LocalWebController.run() called")
        return self.run_threaded(img_arr, num_records, mode, recording)

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] LocalWebController.shutdown() called")
        pass
