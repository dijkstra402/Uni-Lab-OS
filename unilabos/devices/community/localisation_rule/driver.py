...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.LocalisationRule")
...
class LocalisationRule(Rule):
    def __init__(self, seriesName, analysisMetadata, resultsFilename=None, startAt=0, dataSourceModule=None, serverfilter=clusterIO.local_serverfilter, **kwargs):
        print("[UNILAB] LocalisationRule.__init__() called", flush=True)
    ...
    def _output_files(self):
        _unilab_logger.debug("[UNILAB] LocalisationRule._output_files() called")
    ...
    def _setup(self, dataSourceID, metadata, resultsFilename, startAt=0, dataSourceModule=None, serverfilter=clusterIO.local_serverfilter):
        _unilab_logger.debug("[UNILAB] LocalisationRule._setup() called")
    ...
    def _task_template(self, context):
        _unilab_logger.debug("[UNILAB] LocalisationRule._task_template() called")
        tt = {'id': '{{ruleID}}~{{taskID}}',
              'type': 'localization',
    ...
    def prepare(self):
        _unilab_logger.debug("[UNILAB] LocalisationRule.prepare() called")
        """
        Do any setup work - e.g. uploading metadata required before the rule is triggered
    ...
    def total_frames(self):
        _unilab_logger.debug("[UNILAB] LocalisationRule.total_frames() called")
        return self.ds.getNumSlices()

    @property
    def data_complete(self):
        _unilab_logger.debug("[UNILAB] LocalisationRule.data_complete() called")
        return self.ds.is_complete
    
    @property
    def complete(self):
        _unilab_logger.debug("[UNILAB] LocalisationRule.complete() called")
        """
        Is this rule complete, or do we need to poll for more input?
    ...
    def on_data_complete(self):
        _unilab_logger.debug("[UNILAB] LocalisationRule.on_data_complete() called")
        logger.debug('Data complete, copying events to output file')
        clusterResults.fileResults(self.worker_resultsURI + '/Events', self.ds.getEvents())

    def get_new_tasks(self):
        _unilab_logger.debug("[UNILAB] LocalisationRule.get_new_tasks() called")
        """
