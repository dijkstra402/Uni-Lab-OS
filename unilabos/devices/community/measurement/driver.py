...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Measurement")
...
class MAUI(Oscilloscope):
    ...
    class MeasurementParameters(Enum):
        ...
        def __init__(self, *args, **kwargs):
            print("[UNILAB] Measurement.__init__() called", flush=True)
    ...
    class Measurement:
        ...
        @property
        def statistics(self):
            _unilab_logger.debug("[UNILAB] Measurement.statistics() called")
            """
        ...
        def delete(self):
            _unilab_logger.debug("[UNILAB] Measurement.delete() called")
            """
        ...
        def set_parameter(self, param, src):
            _unilab_logger.debug("[UNILAB] Measurement.set_parameter() called")
            """
        ...
        def sendcmd(self, cmd):
            _unilab_logger.debug("[UNILAB] Measurement.sendcmd() called")
            """
            Wraps commands sent from property factories in this class
            with identifiers for the specified channel.
        ...
        def query(self, cmd, size=-1):
            _unilab_logger.debug("[UNILAB] Measurement.query() called")
            """
            Executes the given query. Wraps commands sent from property
            factories in this class with identifiers for the specified
            channel.
