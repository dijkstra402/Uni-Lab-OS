...
Original: lantz/messagebased.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MessageBasedDriver")
...
from lantz.errors import NotSupportedError
...
class MessageBasedDriver(Driver):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] MessageBasedDriver.__init__() called", flush=True)
    ...
    def _get_defaults_kwargs(cls, instrument_type, resource_type, **user_kwargs):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver._get_defaults_kwargs() called")
    ...
    def via_usb_raw(cls, serial_number=None, manufacturer_id=None, model_code=None, name=None, board=0, **kwargs):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver._via_usb() called")
    ...
    def via_serial(cls, port, name=None, **kwargs):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.via_serial() called")
    ...
    def via_tcpip(cls, hostname, port, name=None, **kwargs):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.via_tcpip() called")
    ...
    def via_tcpip_socket(cls, hostname, port, name=None, **kwargs):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.via_tcpip_socket() called")
    ...
    def via_gpib(cls, address, name=None, **kwargs):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.via_gpib() called")
    ...
    def initialize(self):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.initialize() called")
        super().initialize()
    ...
    def finalize(self):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.finalize() called")
        self.log_debug('Closing resource {}', self.resource_name)
        self.resource.close()
        super().finalize()

    def query(self, command, *, send_args=(None, None), recv_args=(None, None)):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.query() called")
    ...
    def write(self, command, termination=None, encoding=None):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.parse_query() called")
    ...
    def read(self, termination=None, encoding=None):
        _unilab_logger.debug("[UNILAB] MessageBasedDriver.read() called")
