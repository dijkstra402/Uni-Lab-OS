...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MFC")
...
class MFC:
    ...
    def ChangeAddress(self,new_address):
        _unilab_logger.debug("[UNILAB] MFC.ChangeAddress() called")
        '''
    ...
    def QueryFlow(self):
        _unilab_logger.debug("[UNILAB] MFC.QueryFlow() called")
        '''
    ...
    def QueryOpMode(self):
        _unilab_logger.debug("[UNILAB] MFC.QueryOpMode() called")
        '''
    ...
    def __SendCommand(self,command_text,command_value=''):
        _unilab_logger.debug("[UNILAB] MFC.__SendCommand() called")
        '''
    ...
    def __BuildCommand(self,command_text,command_value):
        _unilab_logger.debug("[UNILAB] MFC.__BuildCommand() called")
        '''
    ...
    def __ValidateResponse(self,response):
        _unilab_logger.debug("[UNILAB] MFC.__ValidateResponse() called")
        '''
    ...
    def __CommandChecksum(self,command):
        _unilab_logger.debug("[UNILAB] MFC.__CommandChecksum() called")
        '''
    ...
    def __ResponseChecksum(self,response):
        _unilab_logger.debug("[UNILAB] MFC.__ResponseChecksum() called")
        '''
