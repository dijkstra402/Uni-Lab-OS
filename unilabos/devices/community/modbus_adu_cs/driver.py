...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Modbus_ADU_CS")
...
class Modbus_ADU_CS(Modbus_ADU):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Modbus_ADU_CS.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def parse(self):
        _unilab_logger.debug("[UNILAB] Modbus_ADU_CS.parse() called")
        '''Select which specific Modbus function we should parse.'''
        data = self.data
    ...
    def parse_read_data_command(self):
        _unilab_logger.debug("[UNILAB] Modbus_ADU_CS.parse_read_data_command() called")
    ...
    def parse_single_byte_request(self):
        _unilab_logger.debug("[UNILAB] Modbus_ADU_CS.parse_single_byte_request() called")
    ...
    def parse_write_multiple(self):
        _unilab_logger.debug("[UNILAB] Modbus_ADU_CS.parse_write_multiple() called")
        '''Function 15 and 16 are almost the same, so we can parse them both
        using one function.'''
    ...
    def parse_read_file_record(self):
        _unilab_logger.debug("[UNILAB] Modbus_ADU_CS.parse_read_file_record() called")
    ...
    def parse_read_write_registers(self):
        _unilab_logger.debug("[UNILAB] Modbus_ADU_CS.parse_read_write_registers() called")
