...
Original: examples/server_serial_gw.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ModbusSerialWorker")
...
class ModbusSerialWorker:
    ...
    def __init__(self, port, timeout=1.0, end_of_frame=0.05):
        print("[UNILAB] ModbusSerialWorker.__init__() called", flush=True)
        # public
    ...
    def loop(self):
        _unilab_logger.debug("[UNILAB] ModbusSerialWorker.loop() called")
    ...
    def srv_engine_entry(self, session_data):
        _unilab_logger.debug("[UNILAB] ModbusSerialWorker.srv_engine_entry() called")
