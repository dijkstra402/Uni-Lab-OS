...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MultiRateCyclicSendTask")
...
class MultiRateCyclicSendTask(CyclicSendTask):
    ...
    def __init__(
        ...
        print("[UNILAB] MultiRateCyclicSendTask.__init__() called", flush=True)
...
__all__ = ["MultiRateCyclicSendTask"]
