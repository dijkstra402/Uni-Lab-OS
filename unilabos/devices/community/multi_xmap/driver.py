...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.MultiXMAP")
...
# Vendored repo packages: epics, epics
import sys as _sys
...
from epics import Device, get_pv, poll, caput, caget
...
class MultiXMAP(Device):
    ...
    def __init__(self, prefix, filesaver='netCDF1:',nmca=4):
        print("[UNILAB] MultiXMAP.__init__() called", flush=True)
    ...
    def get_calib(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.get_calib() called")
        return [m.get_calib() for m in self.mcas]

    def get_rois(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.get_rois() called")
        return [m.get_rois() for m in self.mcas]

    def roi_calib_info(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.roi_calib_info() called")
        buff = ['[rois]']
        add = buff.append
        rois = self.get_rois()
    ...
    def restore_rois(self, roifile):
        _unilab_logger.debug("[UNILAB] MultiXMAP.restore_rois() called")
    ...
    def Write_CurrentConfig(self, filename=None):
        _unilab_logger.debug("[UNILAB] MultiXMAP.Write_CurrentConfig() called")
        buff = []
        add = buff.append
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.start() called")
        "Start Struck"
        self.EraseStart = 1
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.stop() called")
        "Stop Struck Collection"
        self.StopAll = 1
        return self.StopAll

    def next_pixel(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.next_pixel() called")
        "Advance to Next Pixel:"
        self.NextPixel = 1
        return self.NextPixel

    def finish_pixels(self, timeout=2):
        _unilab_logger.debug("[UNILAB] MultiXMAP.finish_pixels() called")
    ...
    def readmca(self,n=1):
        _unilab_logger.debug("[UNILAB] MultiXMAP.readmca() called")
        "Read a Struck MCA"
        return self.get('mca%i' % n)

    def SCAMode(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.SCAMode() called")
        "put XMAP in SCA mapping mode"
        self.CollectMode = 2

    def SpectraMode(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.SpectraMode() called")
    ...
    def MCAMode(self, filename=None, filenumber=None, npulses=11):
        _unilab_logger.debug("[UNILAB] MultiXMAP.MCAMode() called")
    ...
    def filePut(self,attr, value, **kw):
        _unilab_logger.debug("[UNILAB] MultiXMAP.filePut() called")
        return self.put("%s%s" % (self.filesaver, attr), value, **kw)

    def fileGet(self, attr, **kw):
        _unilab_logger.debug("[UNILAB] MultiXMAP.fileGet() called")
        return self.get("%s%s" % (self.filesaver, attr), **kw)

    def setFilePath(self, pathname):
        _unilab_logger.debug("[UNILAB] MultiXMAP.setFilePath() called")
        return self.filePut('FilePath', pathname)

    def setFileTemplate(self, fmt):
        _unilab_logger.debug("[UNILAB] MultiXMAP.setFileTemplate() called")
        return self.filePut('FileTemplate', fmt)

    def setFileWriteMode(self, mode):
        _unilab_logger.debug("[UNILAB] MultiXMAP.setFileWriteMode() called")
        return self.filePut('FileWriteMode', mode)

    def setFileName(self, fname):
        _unilab_logger.debug("[UNILAB] MultiXMAP.setFileName() called")
        return self.filePut('FileName', fname)

    def nextFileNumber(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.nextFileNumber() called")
        self.setFileNumber(1+self.fileGet('FileNumber'))

    def setFileNumber(self, fnum=None):
        _unilab_logger.debug("[UNILAB] MultiXMAP.setFileNumber() called")
        if fnum is None:
    ...
    def getLastFileName(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.getLastFileName() called")
        return self.fileGet('FullFileName_RBV',as_string=True)

    def FileCaptureOn(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.FileCaptureOn() called")
        return self.filePut('Capture', 1)

    def FileCaptureOff(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.FileCaptureOff() called")
        return self.filePut('Capture', 0)

    def setFileNumCapture(self,n):
        _unilab_logger.debug("[UNILAB] MultiXMAP.setFileNumCapture() called")
        return self.filePut('NumCapture', n)

    def FileWriteComplete(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.FileWriteComplete() called")
        return (0==self.fileGet('WriteFile_RBV') )

    def getFileTemplate(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.getFileTemplate() called")
        return self.fileGet('FileTemplate_RBV',as_string=True)

    def getFileName(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.getFileName() called")
        return self.fileGet('FileName_RBV',as_string=True)

    def getFileNumber(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.getFileNumber() called")
        return self.fileGet('FileNumber_RBV')

    def getFilePath(self):
        _unilab_logger.debug("[UNILAB] MultiXMAP.getFilePath() called")
        return self.fileGet('FilePath_RBV',as_string=True)

    def getFileNameByIndex(self,index):
        _unilab_logger.debug("[UNILAB] MultiXMAP.getFileNameByIndex() called")
