...
from pymodaq_plugins_keithley.hardware.keithley27XX.keithley2700_VISADriver import Keithley2700VISADriver as Keithley
from pymodaq.utils.logger import set_logger, get_module_name

logger = set_logger(get_module_name(__file__))


class DAQ_0DViewer_Keithley2700(DAQ_0DViewer_Keithley27XX):
    """ Keithley viewer class for Keithley 2700 Multimeter/Switch System.
    """
    model = "2700"
    resources_list = []
