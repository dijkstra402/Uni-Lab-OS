...
from pymodaq_plugins_keithley.hardware.keithley27XX.keithley2750_VISADriver import Keithley2750VISADriver as Keithley
from pymodaq.utils.logger import set_logger, get_module_name

logger = set_logger(get_module_name(__file__))


class DAQ_0DViewer_Keithley2750(DAQ_0DViewer_Keithley27XX):
    """ Keithley viewer class for Keithley 2750 Multimeter/Switch System.
    """
    model = "2750"
    resources_list = []
