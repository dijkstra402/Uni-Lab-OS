...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.OpenBCIBoard")
...
class OpenBCIBoard(object):
  ...
  def __init__(self, port=None, baud=115200, filter_data=True,
    scaled_output=True, daisy=None, log=True, timeout=None, print_enable=True):
    ...
    self.print_incoming_text(print_enable) #print board identification text. Daisy detection occurs in this method.
  ...
  def getSampleRate(self):
    print("[UNILAB] OpenBCIBoard.__init__() called", flush=True)
    if self.daisy:
  ...
  def getNbEEGChannels(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.getNbEEGChannels() called")
    if self.daisy:
  ...
  def getNbAUXChannels(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.getNbAUXChannels() called")
    return  self.aux_channels_per_sample

  def run(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.run() called")
    self.start_streaming()

  def start_streaming(self,callback,lapse=-1):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.start_streaming() called")
    """
  ...
  def _read_serial_binary(self, max_bytes_to_skip=3000):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard._read_serial_binary() called")
    def read(n):
      _unilab_logger.debug("[UNILAB] OpenBCIBoard.read() called")
      b = self.ser.read(n)
      if not b:
  ...
  """
  def stop(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.stop() called")
    self.streaming = False
    self.ser.write(b's')

  def disconnect(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.disconnect() called")
  ...
  """
  def warn(self, text):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.warn() called")
    if self.log:
  ...
  def print_incoming_text(self,print_enable):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.print_incoming_text() called")
    """
  ...
  def openbci_id(self, serial):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.openbci_id() called")
    """
  ...
  def print_register_settings(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.print_register_settings() called")
    self.ser.write(b'?')
    time.sleep(0.5)
    self.print_incoming_text(True);
  #DEBBUGING: Prints individual incoming bytes
  def print_bytes_in(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.print_bytes_in() called")
    if not self.streaming:
      self.ser.write(b'b')
      self.streaming = True
    while self.streaming:
  ...
  def print_packets_in(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.print_packets_in() called")
    while self.streaming:
  ...
  def check_connection(self, interval = 2, max_packets_to_skip=10):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.check_connection() called")
  ...
  def reconnect(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.reconnect() called")
    self.packets_dropped = 0
    self.warn('Reconnecting')
    self.stop()
    time.sleep(0.5)
  ...
  def enable_filters(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.enable_filters() called")
    self.ser.write(b'f')
    self.filtering_data = True;

  def disable_filters(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.disable_filters() called")
    self.ser.write(b'g')
    self.filtering_data = False;

  def test_signal(self, signal):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.test_signal() called")
    if signal == 0:
      self.ser.write(b'0')
  ...
  def set_channel(self, channel, toggle_position):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.set_channel() called")
  ...
  def find_port(self):
    _unilab_logger.debug("[UNILAB] OpenBCIBoard.find_port() called")
    try:
