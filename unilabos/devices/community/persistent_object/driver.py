...
Original: nion/swift/model/Persistence.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PersistentObject")
...
class PersistentObjectContext:
    ...
    def __init__(self) -> None:
        print("[UNILAB] PersistentObject.__init__() called", flush=True)
    ...
    def unregister_registration_changed_fn(self, uuid_: uuid.UUID, key: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.unregister_registration_changed_fn() called")
    ...
    def register_registration_changed_fn(self, uuid_: uuid.UUID, key: typing.Any, registration_changed_fn: typing.Callable[[typing.Optional[PersistentObject], typing.Optional[PersistentObject]], None]) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.register_registration_changed_fn() called")
    ...
    def register(self, object: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.register() called")
    ...
    def unregister(self, object: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.unregister() called")
    ...
    def get_registered_object(self, item_specifier: PersistentObjectSpecifier) -> typing.Optional[PersistentObject]:
        _unilab_logger.debug("[UNILAB] PersistentObject.get_registered_object() called")
    ...
    def create_item_reference(self, item_uuid: typing.Optional[uuid.UUID] = None, item: typing.Optional[PersistentObject] = None) -> PersistentObjectReference:
        _unilab_logger.debug("[UNILAB] PersistentObject.create_item_reference() called")
...
class PersistentObjectSpecifiable(typing.Protocol):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] PersistentObject.__init__() called")
        super().__init__(*args, **kwargs)
class PersistentObjectSpecifier:

    def __init__(self, item_uuid_x: typing.Optional[uuid.UUID]) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.uuid() called")
        self.__item_uuid = item_uuid_x

    def __hash__(self) -> typing.Any:
        _unilab_logger.debug("[UNILAB] PersistentObject.__hash__() called")
        return hash(self.__item_uuid)

    def __eq__(self, other: typing.Any) -> bool:
        _unilab_logger.debug("[UNILAB] PersistentObject.__eq__() called")
    ...
    def item_uuid(self) -> typing.Optional[uuid.UUID]:
        _unilab_logger.debug("[UNILAB] PersistentObject.item_uuid() called")
        return self.__item_uuid

    def write(self) -> _SpecifierDictType:
        _unilab_logger.debug("[UNILAB] PersistentObject.write() called")
...
class PersistentObjectProxy(typing.Generic[PO]):
    ...
    def close(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.close() called")
    ...
    def item(self) -> typing.Optional[PO]:
        _unilab_logger.debug("[UNILAB] PersistentObject.item() called")
    ...
    def item_specifier(self) -> typing.Optional[PersistentObjectSpecifier]:
        _unilab_logger.debug("[UNILAB] PersistentObject.item_specifier() called")
    ...
    def __update_persistent_object_context(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.__update_persistent_object_context() called")
    ...
    def __change_registration(self, registered_object: typing.Optional[PersistentObject], unregistered_object: typing.Optional[PersistentObject]) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.__change_registration() called")
    ...
    def __persistent_object_context_changed(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.__persistent_object_context_changed() called")
        if self.__persistent_object.persistent_object_context:
...
class PersistentObjectReference:
    ...
    def set_persistent_object_context(self, persistent_object_context: typing.Optional[PersistentObjectContext]) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.set_persistent_object_context() called")
        if self.__persistent_object_context:
...
class PersistentObjectParent:
    ...
    def parent(self) -> typing.Optional[PersistentObject]:
        _unilab_logger.debug("[UNILAB] PersistentObject.parent() called")
...
class PersistentObject(Observable.Observable):
    ...
    def __deepcopy__(self, memo: typing.Dict[typing.Any, typing.Any]) -> PersistentObject:
        _unilab_logger.debug("[UNILAB] PersistentObject.__deepcopy__() called")
    ...
    def deepcopy_from(self, item: PersistentObject, memo: typing.Dict[typing.Any, typing.Any]) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.deepcopy_from() called")
    ...
    def _copy_property(self, item: PersistentObject, key: str) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject._copy_property() called")
    ...
    def container(self) -> typing.Optional[PersistentObject]:
        _unilab_logger.debug("[UNILAB] PersistentObject.container() called")
    ...
    def insert_model_item(self, container: PersistentContainerType, name: str, before_index: int, item: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.insert_model_item() called")
    ...
    def remove_model_item(self, container: PersistentContainerType, name: str, item: PersistentObject, *, safe: bool = False) -> Changes.UndeleteLog:
        _unilab_logger.debug("[UNILAB] PersistentObject.remove_model_item() called")
    ...
    def about_to_be_inserted(self, container: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.about_to_be_inserted() called")
    ...
    def about_to_be_removed(self, container: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.about_to_be_removed() called")
    ...
    def define_root_context(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.define_root_context() called")
    ...
    def set_storage_system(self, storage_system: PersistentStorageInterface) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.set_storage_system() called")
        """Set the storage system for this item."""
        storage_system.set_root_item(self)

    def update_storage_system(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.update_storage_system() called")
    ...
    def update_item_context(self, item: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.update_item_context() called")
    ...
    def persistent_object_context_changed(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.persistent_object_context_changed() called")
    ...
    def persistent_object_context(self) -> PersistentObjectContext | None:
        _unilab_logger.debug("[UNILAB] PersistentObject.persistent_object_context() called")
    ...
    def persistent_storage(self) -> typing.Optional[PersistentStorageInterface]:
        _unilab_logger.debug("[UNILAB] PersistentObject.persistent_storage() called")
    ...
    def define_type(self, type: str) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.define_type() called")
        self.__type = type
    ...
    def close_items(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.define_property() called")
        for item in self.__items.values():
            if item.value:
    ...
    def close_relationships(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.close_relationships() called")
        for relationship in self.__relationships.values():
    ...
    def undefine_properties(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.undefine_properties() called")
        for property in self.__properties.values():
            property.close()
        self.__properties.clear()

    def undefine_items(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.undefine_items() called")
        for item in self.__items.values():
            item.close()
        self.__items.clear()

    def undefine_relationships(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.undefine_relationships() called")
        for relationship in self.__relationships.values():
            relationship.close()
        self.__relationships.clear()

    def get_storage_properties(self) -> typing.Optional[PersistentDictType]:
        _unilab_logger.debug("[UNILAB] PersistentObject.get_storage_properties() called")
    ...
    def property_names(self) -> typing.Sequence[str]:
        _unilab_logger.debug("[UNILAB] PersistentObject.property_names() called")
        return list(self.__properties.keys())

    @property
    def key_names(self) -> typing.Sequence[str]:
        _unilab_logger.debug("[UNILAB] PersistentObject.key_names() called")
        return [property.key for property in self.__properties.values()]

    @property
    def type(self) -> str:
        _unilab_logger.debug("[UNILAB] PersistentObject.type() called")
        return self.__type or str()

    @property
    def modified(self) -> datetime.datetime:
        _unilab_logger.debug("[UNILAB] PersistentObject.modified() called")
        return self.__modified

    @property
    def modified_count(self) -> int:
        _unilab_logger.debug("[UNILAB] PersistentObject.modified_count() called")
        return self.__modified_count

    def _set_modified(self, modified: datetime.datetime) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject._set_modified() called")
        # for testing
    ...
    def _get_persistence_write_count(self) -> typing.Optional[int]:
        _unilab_logger.debug("[UNILAB] PersistentObject._get_persistence_write_count() called")
    ...
    def item_names(self) -> typing.Sequence[str]:
        _unilab_logger.debug("[UNILAB] PersistentObject.item_names() called")
        return list(self.__items.keys())

    @property
    def relationship_names(self) -> typing.Sequence[str]:
        _unilab_logger.debug("[UNILAB] PersistentObject.relationship_names() called")
        return list(self.__relationships.keys())

    def begin_reading(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.begin_reading() called")
        self._is_reading = True

    def read_from_dict(self, properties: PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.read_from_dict() called")
        """ Read from a dict. """
        ...
        for key in self.__items.keys():
            ...
            if item_dict:
                ...
                def lookup_id(name: str, default: typing.Optional[str] = None) -> str:
                    _unilab_logger.debug("[UNILAB] PersistentObject.lookup_id() called")
    ...
    def finish_reading(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.finish_reading() called")
        for key in self.__items.keys():
    ...
    def write_to_dict(self) -> PersistentDictType:
        _unilab_logger.debug("[UNILAB] PersistentObject.write_to_dict() called")
    ...
    def _update_persistent_object_context_property(self, name: str) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject._update_persistent_object_context_property() called")
    ...
    def __update_modified(self, modified: datetime.datetime) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.__update_modified() called")
    ...
    def _modified_changed(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject._modified_changed() called")
    ...
    def _get_persistent_property(self, name: str) -> PersistentProperty:
        _unilab_logger.debug("[UNILAB] PersistentObject._get_persistent_property() called")
    ...
    def _get_persistent_property_value(self, name: str, default: typing.Any = None) -> typing.Any:
        _unilab_logger.debug("[UNILAB] PersistentObject._get_persistent_property_value() called")
    ...
    def _set_persistent_property_value(self, name: str, value: typing.Any, force_update: bool = False, validate: bool = True) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject._set_persistent_property_value() called")
    ...
    def _update_persistent_property(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject._update_persistent_property() called")
    ...
    def _get_relationship_values(self, name: str) -> typing.Sequence[typing.Any]:
        _unilab_logger.debug("[UNILAB] PersistentObject._get_relationship_values() called")
        return copy.copy(self.__relationships[name].values)

    def _is_persistent_property_recordable(self, name: str) -> bool:
        _unilab_logger.debug("[UNILAB] PersistentObject._is_persistent_property_recordable() called")
        property = self.__properties.get(name)
    ...
    def __set_item(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.__set_item() called")
    ...
    def get_item(self, name: str) -> typing.Any:
        _unilab_logger.debug("[UNILAB] PersistentObject.get_item() called")
        """ Get item from persistent storage. """
        item = self.__items[name]
        return item.value

    def set_item(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.set_item() called")
    ...
    def load_item(self, name: str, before_index: int, item: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.load_item() called")
    ...
    def unload_item(self, name: str, index: int) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.unload_item() called")
    ...
    def insert_item(self, name: str, before_index: int, item: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.insert_item() called")
    ...
    def append_item(self, name: str, item: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.append_item() called")
        """ Append item and append to persistent storage. """
        self.insert_item(name, len(self.__relationships[name].values), item)

    def remove_item(self, name: str, item: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.remove_item() called")
    ...
    def extend_items(self, name: str, items: typing.Sequence[PersistentObject]) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.extend_items() called")
        """ Append multiple items and add to persistent storage. """
        for item in items:
            self.append_item(name, item)

    def item_count(self, name: str) -> int:
        _unilab_logger.debug("[UNILAB] PersistentObject.item_count() called")
    ...
    def item_index(self, name: str, item: PersistentObject) -> int:
        _unilab_logger.debug("[UNILAB] PersistentObject.item_index() called")
    ...
    def get_item_by_uuid(self, name: str, uuid: uuid.UUID) -> typing.Optional[PersistentObject]:
        _unilab_logger.debug("[UNILAB] PersistentObject.get_item_by_uuid() called")
    ...
    def change_relationship_item_uuid(self, name: str, old_uuid: uuid.UUID, new_uuid: uuid.UUID) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.change_relationship_item_uuid() called")
    ...
    def get_relationship_items(self, name: str) -> typing.List[PersistentObject]:
        _unilab_logger.debug("[UNILAB] PersistentObject.get_relationship_items() called")
    ...
    def item_set(self, name: str, item: PersistentObject) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.item_set() called")
    ...
    def property_changed(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.property_changed() called")
    ...
    def clear_property(self, name: str) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.clear_property() called")
    ...
    def read_external_data(self, name: str) -> typing.Any:
        _unilab_logger.debug("[UNILAB] PersistentObject.read_external_data() called")
    ...
    def write_external_data(self, name: str, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.write_external_data() called")
    ...
    def reserve_external_data(self, name: str, data_shape: typing.Tuple[int, ...], data_dtype: numpy.typing.DTypeLike, data_descriptor: tuple[bool, int, int]) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.reserve_external_data() called")
    ...
    def enter_write_delay(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.enter_write_delay() called")
    ...
    def exit_write_delay(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.exit_write_delay() called")
    ...
    def is_write_delayed(self) -> bool:
        _unilab_logger.debug("[UNILAB] PersistentObject.is_write_delayed() called")
        assert self.persistent_storage
        return self.persistent_storage.is_write_delayed(self)

    def rewrite(self) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.rewrite() called")
    ...
    def create_item_proxy(self, *, item_uuid: typing.Optional[uuid.UUID] = None, item_specifier: typing.Optional[PersistentObjectSpecifier] = None, item: typing.Optional[PersistentObject] = None) -> PersistentObjectProxy[typing.Any]:
        _unilab_logger.debug("[UNILAB] PersistentObject.create_item_proxy() called")
    ...
    def destroy_item_reference(self, item_reference: PersistentObjectReference) -> None:
        _unilab_logger.debug("[UNILAB] PersistentObject.destroy_item_reference() called")
    ...
    def resolve_item_specifier(self, item_specifier: PersistentObjectSpecifier) -> typing.Optional[PersistentObject]:
        _unilab_logger.debug("[UNILAB] PersistentObject.resolve_item_specifier() called")
