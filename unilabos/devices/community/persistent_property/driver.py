...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PersistentProperty")
...
class PersistentProperty:
    ...
    def close(self) -> None:
        print("[UNILAB] PersistentProperty.__init__() called", flush=True)
        self.make = None
        self.validate = None
        self.converter = None
        self.reader = None
    ...
    def _set_value(self, value: typing.Any, validate: bool) -> tuple[bool, typing.Any]:
        _unilab_logger.debug("[UNILAB] PersistentProperty._set_value() called")
    ...
    def _set_value_call_changed(self, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentProperty._set_value_call_changed() called")
        if callable(self.changed):
            self.changed(self.name, value)

    def set_value(self, value: typing.Any) -> bool:
        _unilab_logger.debug("[UNILAB] PersistentProperty.set_value() called")
        # return whether the value changed
    ...
    def json_value(self) -> Utility.CleanValue:
        _unilab_logger.debug("[UNILAB] PersistentProperty.json_value() called")
    ...
    def read_from_dict(self, properties: PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] PersistentProperty.read_from_dict() called")
        if self.reader:
    ...
    def __write_to_dict(self, properties: PersistentDictType, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentProperty.__write_to_dict() called")
        if self.writer:
    ...
    def write_to_dict(self, properties: PersistentDictType) -> None:
        _unilab_logger.debug("[UNILAB] PersistentProperty.write_to_dict() called")
...
class PersistentPropertySpecial(PersistentProperty):
    ...
    def value(self, value: typing.Any) -> None:
        _unilab_logger.debug("[UNILAB] PersistentProperty.value() called")
        self.__value = value
