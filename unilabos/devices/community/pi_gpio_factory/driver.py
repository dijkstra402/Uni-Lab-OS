...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PiGPIOFactory")
...
class PiGPIOFactory(PiFactory):
    ...
    * Your script itself doesn't require root privileges; it just needs to
    ...
    def __init__(self, host=None, port=None):
        print("[UNILAB] PiGPIOFactory.__init__() called", flush=True)
        super().__init__()
        if host is None:
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory.close() called")
        super().close()
    ...
    @property
    def connection(self):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory.connection() called")
    ...
    @property
    def host(self):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory.host() called")
        return self._host

    @property
    def port(self):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory.port() called")
        return self._port

    def _get_revision(self):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory._get_revision() called")
        return self.connection.get_hardware_revision()

    def _get_spi_class(self, shared, hardware):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory._get_spi_class() called")
        return {
    ...
    def spi(self, **spi_args):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory.spi() called")
        intf = super().spi(**spi_args)
        self._spis.append(intf)
        return intf

    def ticks(self):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory.ticks() called")
        return self._connection.get_current_tick()

    @staticmethod
    def ticks_diff(later, earlier):
        _unilab_logger.debug("[UNILAB] PiGPIOFactory.ticks_diff() called")
