...
Original: gpiozero/pins/pigpio.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PiGPIOHardwareSPI")
...
from gpiozero.pins.pi import PiPin, PiFactory, spi_port_device
...
class PiGPIOHardwareSPI(SPI):
    ...
    def __init__(self, clock_pin, mosi_pin, miso_pin, select_pin, pin_factory):
        print("[UNILAB] PiGPIOHardwareSPI.__init__() called", flush=True)
    ...
    def _conflicts_with(self, other):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._conflicts_with() called")
        return not (
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI.close() called")
        try:
    ...
    @property
    def closed(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI.closed() called")
        return self._handle is None or self.pin_factory.connection is None

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI.__repr__() called")
        try:
            self._check_open()
    ...
    def _get_clock_mode(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._get_clock_mode() called")
        return self._spi_flags & 0x3

    def _set_clock_mode(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._set_clock_mode() called")
        self._check_open()
        if not 0 <= value < 4:
    ...
    def _get_select_high(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._get_select_high() called")
        return bool((self._spi_flags >> (2 + self._device)) & 0x1)

    def _set_select_high(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._set_select_high() called")
        self._check_open()
        self.pin_factory.connection.spi_close(self._handle)
    ...
    def _get_bits_per_word(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._get_bits_per_word() called")
        return (self._spi_flags >> 16) & 0x3f

    def _set_bits_per_word(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._set_bits_per_word() called")
        self._check_open()
        self.pin_factory.connection.spi_close(self._handle)
    ...
    def _get_rate(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._get_rate() called")
        return self._baud

    def _set_rate(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._set_rate() called")
        self._check_open()
        value = int(value)
        self.pin_factory.connection.spi_close(self._handle)
        self._baud = value
    ...
    def _get_lsb_first(self):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._get_lsb_first() called")
        return bool((self._spi_flags >> 14) & 0x1) if self._port else False

    def _set_lsb_first(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._set_lsb_first() called")
        if self._port:
            self._check_open()
            self.pin_factory.connection.spi_close(self._handle)
            self._spi_flags = (
    ...
    def transfer(self, data):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI.transfer() called")
        self._check_open()
...
class PiGPIOHardwareSPIShared(SharedMixin, PiGPIOHardwareSPI):
    ...
    def _shared_key(cls, clock_pin, mosi_pin, miso_pin, select_pin, pin_factory):
        _unilab_logger.debug("[UNILAB] PiGPIOHardwareSPI._shared_key() called")
        return (pin_factory.host, clock_pin, select_pin)


    def __init__(self, *args, **kwargs):
        print("[UNILAB] PiGPIOHardwareSPI.__init__() called")
