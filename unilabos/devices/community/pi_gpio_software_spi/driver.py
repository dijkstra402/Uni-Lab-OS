...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PiGPIOSoftwareSPI")
...
class PiGPIOSoftwareSPI(SPI):
    ...
    """
    def __init__(self, clock_pin, mosi_pin, miso_pin, select_pin, pin_factory):
        print("[UNILAB] PiGPIOSoftwareSPI.__init__() called", flush=True)
        self._closed = True
    ...
    def _conflicts_with(self, other):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._conflicts_with() called")
        return not (
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI.close() called")
        try:
            self.pin_factory._spis.remove(self)
        except (ReferenceError, ValueError):
            # If the factory has died already or we're not present in its
    ...
    @property
    def closed(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI.closed() called")
        return self._closed

    def __repr__(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI.__repr__() called")
        try:
            self._check_open()
            return (
    ...
    def _spi_flags(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._spi_flags() called")
        return (
            self._mode          << 0  |
            self._select_high   << 2  |
            self._lsb_first     << 14 |
    ...
    def _get_clock_mode(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._get_clock_mode() called")
        return self._spi_flags & 0x3

    def _set_clock_mode(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._set_clock_mode() called")
        self._check_open()
        if not 0 <= value < 4:
            raise SPIInvalidClockMode(f"{value} is not a valid SPI clock mode")
        self.pin_factory.connection.bb_spi_close(self._select_pin)
    ...
    def _get_select_high(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._get_select_high() called")
        return bool(self._spi_flags & 0x4)

    def _set_select_high(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._set_select_high() called")
        self._check_open()
        self.pin_factory.connection.bb_spi_close(self._select_pin)
    ...
    def _get_lsb_first(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._get_lsb_first() called")
        return bool(self._spi_flags & 0xc000)

    def _set_lsb_first(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._set_lsb_first() called")
        self._check_open()
        self.pin_factory.connection.bb_spi_close(self._select_pin)
        self._spi_flags = (
            (self._spi_flags & ~0xc000)
    ...
    def _get_rate(self):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._get_rate() called")
        return self._baud

    def _set_rate(self, value):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._set_rate() called")
        self._check_open()
        value = int(value)
        self.pin_factory.connection.bb_spi_close(self._select_pin)
        self._baud = value
    ...
    def transfer(self, data):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI.transfer() called")
        self._check_open()
...
class PiGPIOSoftwareSPIShared(SharedMixin, PiGPIOSoftwareSPI):
    @classmethod
    def _shared_key(cls, clock_pin, mosi_pin, miso_pin, select_pin, pin_factory):
        _unilab_logger.debug("[UNILAB] PiGPIOSoftwareSPI._shared_key() called")
        return (pin_factory.host, clock_pin, select_pin)
