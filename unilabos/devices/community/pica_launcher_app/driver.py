...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PICALauncherApp")
...
# Vendored repo packages: pica, pica
import sys as _sys
...
class PICALauncherApp:
    ...
    def __init__(self, root):
        print("[UNILAB] PICALauncherApp.__init__() called", flush=True)
    ...
    def setup_styles(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.setup_styles() called")
    ...
    def create_widgets(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.create_widgets() called")
    ...
    def create_resource_panel(self, parent):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.create_resource_panel() called")
    ...
    def _load_logo(self, canvas):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._load_logo() called")
    ...
    def _create_launch_button(self, parent, text, script_key):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._create_launch_button() called")
        return ttk.Button(
            parent,
            text=text,
            style='App.TButton',
    ...
    def create_launcher_panel(self, parent):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.create_launcher_panel() called")
        ...
        def _on_mousewheel_windows(event):
            _unilab_logger.debug("[UNILAB] PICALauncherApp._on_mousewheel_windows() called")
            canvas.yview_scroll(int(-1 * (event.delta / 120)), "units")

        def _on_mousewheel_linux_macos(event):
            _unilab_logger.debug("[UNILAB] PICALauncherApp._on_mousewheel_linux_macos() called")
        ...
        def _configure_scrollable_frame(event):
            _unilab_logger.debug("[UNILAB] PICALauncherApp._configure_scrollable_frame() called")
    ...
    def log(self, message):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._create_suite_frame() called")
    ...
    def _open_path(self, path):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._open_path() called")
    ...
    def _parse_markdown(self, content):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._parse_markdown() called")
        """
    ...
    def _show_file_in_window(self, file_path, title):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._show_file_in_window() called")
    ...
    def open_script_folder(self, script_key):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.open_script_folder() called")
    ...
    def open_readme(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.open_readme() called")
        self._show_file_in_window(self.README_FILE, "README")

    def open_updates(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.open_updates() called")
        self._show_file_in_window(self.UPDATES_FILE, "Change Log")

    def open_manual_file(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.open_manual_file() called")
        self._show_file_in_window(self.MANUAL_FILE, "User Manual")

    def open_license(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.open_license() called")
        self._show_file_in_window(self.LICENSE_FILE, "MIT License")

    def open_repo(self, event=None):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.open_repo() called")
        import webbrowser
        webbrowser.open(self.REPO_URL)

    def launch_script(self, script_path):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.launch_script() called")
    ...
    def run_gpib_test(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp.run_gpib_test() called")
    ...
    def _pre_cache_markdown_files(self):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._pre_cache_markdown_files() called")
        """
    ...
    def _get_file_content_for_display(self, file_path):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._get_file_content_for_display() called")
    ...
    def _create_display_window(self, title):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._create_display_window() called")
    ...
    def _configure_text_area(self, win):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._configure_text_area() called")
    ...
    def _render_markdown_content(self, text_area, lines):
        _unilab_logger.debug("[UNILAB] PICALauncherApp._render_markdown_content() called")
        for line in lines:
            stripped = line.strip()
