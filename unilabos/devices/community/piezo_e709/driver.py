...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.piezo_e709")
...
class piezo_e709(PiezoBase):
    def __init__(self, portname='COM1', maxtravel = 400.00, Osen=None, hasTrigger=False):
        print("[UNILAB] piezo_e709.__init__() called", flush=True)
...
#        self.ser_port.write(b'WTO A0\n')
    ...
    def ReInit(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.ReInit() called")
#        self.ser_port.write(b'WTO A0\n')
        self.ser_port.write(b'SVO Z 1\n')
        self.lastPos = self.GetPos()
        
    def SetServo(self,val = 1):
        _unilab_logger.debug("[UNILAB] piezo_e709.SetServo() called")
        self.ser_port.write(b'SVO Z %d\n' % val)
        
    def MoveTo(self, iChannel, fPos, bTimeOut=True):
        _unilab_logger.debug("[UNILAB] piezo_e709.MoveTo() called")
        if (fPos >= 0):
    ...
    def MoveRel(self, iChannel, incr, bTimeOut=True):
        _unilab_logger.debug("[UNILAB] piezo_e709.MoveRel() called")
        self.ser_port.write(b'MVR Z %3.4f\n' % incr)

    def GetPos(self, iChannel=0):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetPos() called")
        self.ser_port.flush()
        time.sleep(0.005)
...
#        self.ser_port.flushOutput()
    ...
    def GetControlReady(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetControlReady() called")
        return True
    def GetChannelObject(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetChannelObject() called")
        return 1
    def GetChannelPhase(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetChannelPhase() called")
        return 1
    def GetMin(self,iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetMin() called")
        return 0
    def GetMax(self, iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetMax() called")
        return self.max_travel
        
    def GetFirmwareVersion(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetFirmwareVersion() called")
        import re
...
class piezo_e709T(PiezoBase):
    ...
    def _Loop(self):
        _unilab_logger.debug("[UNILAB] piezo_e709._Loop() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.close() called")
...
#        self.targetVelocity[:] = vel 
    ...
    def OnTarget(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.OnTarget() called")
    ...
    def GetPosXY(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetPosXY() called")
        return self.position
        
    def GetTargetPos(self,iChannel=0):
        _unilab_logger.debug("[UNILAB] piezo_e709.GetTargetPos() called")
        return self.targetPosition[iChannel]

    def MoveInDir(self, dx, dy, th=.0000):
        _unilab_logger.debug("[UNILAB] piezo_e709.MoveInDir() called")
    ...
    def StopMove(self):
        _unilab_logger.debug("[UNILAB] piezo_e709.StopMove() called")
        self.stopMove = True
