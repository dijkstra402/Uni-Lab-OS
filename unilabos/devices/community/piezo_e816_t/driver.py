...
Original: PYME/Acquire/Hardware/Piezos/piezo_e816.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.piezo_e816T")
...
class piezo_e816T(PiezoBase):
    def __init__(self, portname='COM1', maxtravel=12.00, Osen=None, hasTrigger=False, targetTolerance=0.002):
        print("[UNILAB] piezo_e816T.__init__() called", flush=True)
        self.max_travel = maxtravel
        #self.waveData = None
        #self.numWavePoints = 0
        self.units = 'um'
    ...
    def _Loop(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T._Loop() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.close() called")
    ...
    def ReInit(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.ReInit() called")
        with self.lock:
            self.ser_port.write(b'WTO A0\n')
            self.ser_port.write(b'SVO A1\n')
            time.sleep(1)
    ...
    def OnTarget(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.OnTarget() called")
        return self.onTarget

    def GetPos(self, iChannel=0):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetPos() called")
        # self.ser_port.flush()
        # time.sleep(0.005)
    ...
    def GetPosXY(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetPosXY() called")
        return self.position

    def GetTargetPos(self, iChannel=0):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetTargetPos() called")
        return self.targetPosition[iChannel]

    def MoveTo(self, iChannel, fPos, bTimeOut=True, vel=None):
        _unilab_logger.debug("[UNILAB] piezo_e816T.MoveTo() called")
        chan = iChannel - 1
        # if vel == None:
    ...
    def MoveRel(self, iChannel, incr, bTimeOut=True):
        _unilab_logger.debug("[UNILAB] piezo_e816T.MoveRel() called")
        self.targetPosition[iChannel] += incr
        self.onTarget = False

    def MoveInDir(self, dx, dy, th=.0000):
        _unilab_logger.debug("[UNILAB] piezo_e816T.MoveInDir() called")
    ...
    def SetDriftCompensation(self, dc=True):
        _unilab_logger.debug("[UNILAB] piezo_e816T.SetDriftCompensation() called")
        with self.lock:
            if dc:
                self.ser_port.write(b'DCO A1\n')
                self.ser_port.flushOutput()
    ...
    def GetControlReady(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetControlReady() called")
        return True

    def GetChannelObject(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetChannelObject() called")
        return 1

    def GetChannelPhase(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetChannelPhase() called")
        return 1

    def GetMin(self, iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetMin() called")
        return 0

    def GetMax(self, iChan=1):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetMax() called")
        return self.max_travel

    def GetFirmwareVersion(self):
        _unilab_logger.debug("[UNILAB] piezo_e816T.GetFirmwareVersion() called")
        import re
        with self.lock:
            self.ser_port.write(b'*IDN?\n')
            self.ser_port.flush()
