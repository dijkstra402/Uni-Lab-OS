...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ProScanIII")
...
class ProScanIII(microscope.abc.Controller):
    ...
    def __init__(
        ...
        print("[UNILAB] ProScanIII.__init__() called", flush=True)
    ...
    def devices(self) -> Mapping[str, microscope.abc.Device]:
        _unilab_logger.debug("[UNILAB] ProScanIII.devices() called")
