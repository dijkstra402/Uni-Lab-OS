...
Original: src/instruments/delta_elektronika/psc_eth.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PscEth")
...
class PscEth(Instrument):
    ...
    def __init__(self, filelike):
        print("[UNILAB] PscEth.__init__() called", flush=True)
    ...
    @property
    def name(self) -> str:
        _unilab_logger.debug("[UNILAB] PscEth.name() called")
        return self.query("*IDN?")

    @property
    def current_limit(self) -> tuple["PscEth.LimitStatus", u.Quantity]:
        _unilab_logger.debug("[UNILAB] PscEth.current_limit() called")
    ...
    def voltage_limit(self) -> tuple["PscEth.LimitStatus", u.Quantity]:
        _unilab_logger.debug("[UNILAB] PscEth.voltage_limit() called")
    ...
    def recall(self) -> None:
        _unilab_logger.debug("[UNILAB] PscEth.recall() called")
        """Recall the settings from non-volatile memory."""
        self.sendcmd("*RCL")

    def reset(self) -> None:
        _unilab_logger.debug("[UNILAB] PscEth.reset() called")
        """Reset the instrument to default settings."""
        self.sendcmd("*RST")

    def save(self) -> None:
        _unilab_logger.debug("[UNILAB] PscEth.save() called")
    ...
    def set_current_limit(
        ...
        _unilab_logger.debug("[UNILAB] PscEth.set_current_limit() called")
    ...
    def set_voltage_limit(
        ...
        _unilab_logger.debug("[UNILAB] PscEth.set_voltage_limit() called")
