...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Pseudoclock")
...
# Vendored repo packages: labscript, labscript
import sys as _sys
...
from labscript.utils import LabscriptError, fastflatten, set_passed_properties
...
class Pseudoclock(Device):
    ...
    def __init__(self, name, pseudoclock_device, connection, **kwargs):
        print("[UNILAB] Pseudoclock.__init__() called", flush=True)
    ...
    def add_device(self, device):
        _unilab_logger.debug("[UNILAB] Pseudoclock.add_device() called")
        Device.add_device(self, device)
    ...
    def collect_change_times(self, all_outputs, outputs_by_clockline):
        _unilab_logger.debug("[UNILAB] Pseudoclock.collect_change_times() called")
    ...
    def expand_change_times(self, all_change_times, change_times, outputs_by_clockline):
        _unilab_logger.debug("[UNILAB] Pseudoclock.expand_change_times() called")
    ...
    def get_outputs_by_clockline(self):
        _unilab_logger.debug("[UNILAB] Pseudoclock.get_outputs_by_clockline() called")
    ...
    def generate_clock(self):
        _unilab_logger.debug("[UNILAB] Pseudoclock.generate_clock() called")
    ...
    def generate_code(self, hdf5_file):
        _unilab_logger.debug("[UNILAB] Pseudoclock.generate_code() called")
        self.generate_clock()
...
class TriggerableDevice(Device):
    ...
    def __init__(self, name, parent_device, connection, parentless=False, **kwargs):
        ...
        """
        from labscript.labscript import Trigger 
...
class PseudoclockDevice(TriggerableDevice):
    ...
    def is_master_pseudoclock(self):
        _unilab_logger.debug("[UNILAB] Pseudoclock.is_master_pseudoclock() called")
        """bool: Whether this device is the master pseudoclock."""
        return self.parent_device is None

    def set_initial_trigger_time(self, t):
        _unilab_logger.debug("[UNILAB] Pseudoclock.set_initial_trigger_time() called")
    ...
    def trigger(self, t, duration, wait_delay = 0):
        _unilab_logger.debug("[UNILAB] Pseudoclock.trigger() called")
    ...
    def do_checks(self, outputs):
        _unilab_logger.debug("[UNILAB] Pseudoclock.do_checks() called")
    ...
    def offset_instructions_from_trigger(self, outputs):
        _unilab_logger.debug("[UNILAB] Pseudoclock.offset_instructions_from_trigger() called")
