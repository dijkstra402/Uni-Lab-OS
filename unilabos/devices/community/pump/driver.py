...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Pump")
...
class Pump:
    ...
    def __init__(self, chain, address=0, name='Pump 11'):
        print("[UNILAB] Pump.__init__() called", flush=True)
        self.name = name
    ...
    def __repr__(self):
        _unilab_logger.debug("[UNILAB] Pump.__repr__() called")
        string = ''
    ...
    def write(self,command):
        _unilab_logger.debug("[UNILAB] Pump.write() called")
        self.serialcon.write(self.address + command + '\r')

    def read(self,bytes=5):
        _unilab_logger.debug("[UNILAB] Pump.read() called")
    ...
    def setdiameter(self, diameter):
        _unilab_logger.debug("[UNILAB] Pump.setdiameter() called")
    ...
    def setflowrate(self, flowrate):
        _unilab_logger.debug("[UNILAB] Pump.setflowrate() called")
    ...
    def infuse(self):
        _unilab_logger.debug("[UNILAB] Pump.infuse() called")
        """Start infusing pump."""
        self.write('RUN')
        resp = self.read(5)
        while resp[-1] != '>':
    ...
    def withdraw(self):
        _unilab_logger.debug("[UNILAB] Pump.withdraw() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] Pump.stop() called")
        """Stop pump."""
        self.write('STP')
        resp = self.read(5)
    ...
    def settargetvolume(self, targetvolume):
        _unilab_logger.debug("[UNILAB] Pump.settargetvolume() called")
    ...
    def waituntiltarget(self):
        _unilab_logger.debug("[UNILAB] Pump.waituntiltarget() called")
...
# Run with -h flag to see help
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] Pump.__init__() called")
