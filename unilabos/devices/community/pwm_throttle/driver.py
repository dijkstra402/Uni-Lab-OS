...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PWMThrottle")
...
class PWMThrottle:
    ...
    def __init__(self, controller, max_pulse, min_pulse, zero_pulse):
        print("[UNILAB] PWMThrottle.__init__() called", flush=True)
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] PWMThrottle.update() called")
        while self.running:
            self.controller.set_pulse(self.pulse)

    def run_threaded(self, throttle):
        _unilab_logger.debug("[UNILAB] PWMThrottle.run_threaded() called")
    ...
    def run(self, throttle):
        _unilab_logger.debug("[UNILAB] PWMThrottle.run() called")
        self.run_threaded(throttle)
        self.controller.set_pulse(self.pulse)

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] PWMThrottle.shutdown() called")
        # stop vehicle
        self.run(0)
        self.running = False
