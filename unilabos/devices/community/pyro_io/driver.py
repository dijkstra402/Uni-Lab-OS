...
Original: src/Logger-PyroScience_FireSting-O2/libs/FireSting3.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.PyroIO")
...
class PyroIO:
    def __init__(self, port, baud=None):
        print("[UNILAB] PyroIO.__init__() called", flush=True)
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] PyroIO.__del__() called")
        self.disconnect()
    ...
    def connect(self, baud=None):
        _unilab_logger.debug("[UNILAB] PyroIO.connect() called")
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] PyroIO.disconnect() called")
        if self.connected:
            self.connection.close()

    @property
    def connected(self):
        _unilab_logger.debug("[UNILAB] PyroIO.connected() called")
        try:
    ...
    def send(self, msg, repeat_on_fail=True):
        _unilab_logger.debug("[UNILAB] PyroIO.send() called")
    ...
    def write(self, msg):
        _unilab_logger.debug("[UNILAB] PyroIO.write() called")
    ...
    def read(self):
        _unilab_logger.debug("[UNILAB] PyroIO.read() called")
    ...
    def get_device_information(self):
        _unilab_logger.debug("[UNILAB] PyroIO.get_device_information() called")
    ...
    def read_unique_id(self):
        _unilab_logger.debug("[UNILAB] PyroIO.read_unique_id() called")
    ...
    def blink(self):
        _unilab_logger.debug("[UNILAB] PyroIO.blink() called")
    ...
    def calibrate_zero(self, channel: int, temperature: float, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO.calibrate_zero() called")
    ...
    def calibrate_air(self, channel: int, temperature: float, pressure: float, humidity: float, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO.calibrate_air() called")
    ...
    def _calibrate_zero_firesting(self, channel: int, temperature: float, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO._calibrate_zero_firesting() called")
    ...
    def _calibrate_air_firesting(self, channel: int, temperature: float, pressure: float, humidity: float, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO._calibrate_air_firesting() called")
    ...
    def trigger_oxygen_measurement(self, channel: int):
        _unilab_logger.debug("[UNILAB] PyroIO.trigger_oxygen_measurement() called")
    ...
    def trigger_temperature_measurement(self, channel: int):
        _unilab_logger.debug("[UNILAB] PyroIO.trigger_temperature_measurement() called")
    ...
    def trigger_pressure_measurement(self, channel: int):
        _unilab_logger.debug("[UNILAB] PyroIO.trigger_pressure_measurement() called")
    ...
    def trigger_humidity_measurement(self, channel: int):
        _unilab_logger.debug("[UNILAB] PyroIO.trigger_humidity_measurement() called")
    ...
    def get_version_info(self):
        _unilab_logger.debug("[UNILAB] PyroIO.get_version_info() called")
        """ get information about the device
        """
        return self.send('#VERS')

    def clear_background(self, channel: int, save: bool = True):
        _unilab_logger.debug("[UNILAB] PyroIO.clear_background() called")
    ...
    def measure_background(self, channel: int, save: bool = True):
        _unilab_logger.debug("[UNILAB] PyroIO.measure_background() called")
    ...
    def read_register(self, channel, reg_type, addr) -> str:
        _unilab_logger.debug("[UNILAB] PyroIO.read_register() called")
    ...
    def read_multiple_registers(self, channel, reg_type, addr, number):
        _unilab_logger.debug("[UNILAB] PyroIO.read_multiple_registers() called")
    ...
    def write_register(self, channel, reg_type, addr, value: int):
        _unilab_logger.debug("[UNILAB] PyroIO.write_register() called")
    ...
    def save_to_flash(self, channel: int = 1):
        _unilab_logger.debug("[UNILAB] PyroIO.save_to_flash() called")
    ...
    def load_from_flash(self, channel: int = 1):
        _unilab_logger.debug("[UNILAB] PyroIO.load_from_flash() called")
    ...
    def read_all_settings_registers(self, channel) -> dict:
        _unilab_logger.debug("[UNILAB] PyroIO.read_all_settings_registers() called")
    ...
    def read_calibration_register(self, channel, addr):
        _unilab_logger.debug("[UNILAB] PyroIO.read_calibration_register() called")
    ...
    def read_cal_register_by_name(self, channel, name) -> float:
        _unilab_logger.debug("[UNILAB] PyroIO.read_cal_register_by_name() called")
    ...
    def read_result_register(self, channel, addr) -> str:
        _unilab_logger.debug("[UNILAB] PyroIO.read_result_register() called")
    ...
    def read_result_register_by_name(self, channel, name):
        _unilab_logger.debug("[UNILAB] PyroIO.read_result_register_by_name() called")
    ...
    def read_status(self, channel) -> int:
        _unilab_logger.debug("[UNILAB] PyroIO.read_status() called")
    ...
    def read_dphi(self, channel) -> float:
        _unilab_logger.debug("[UNILAB] PyroIO.read_dphi() called")
    ...
    def read_sample_temperature(self, channel) -> float:
        _unilab_logger.debug("[UNILAB] PyroIO.read_sample_temperature() called")
    ...
    def read_pressure(self, channel) -> float:
        _unilab_logger.debug("[UNILAB] PyroIO.read_pressure() called")
    ...
    def read_signal_intensity(self, channel) -> float:
        _unilab_logger.debug("[UNILAB] PyroIO.read_signal_intensity() called")
    ...
    def read_ambient_light(self, channel) -> float:
        _unilab_logger.debug("[UNILAB] PyroIO.read_ambient_light() called")
    ...
    def read_all_result_registers(self, channel: int) -> dict:
        _unilab_logger.debug("[UNILAB] PyroIO.read_all_result_registers() called")
    ...
    def parse_result_registers(result: str):
        _unilab_logger.debug("[UNILAB] PyroIO.parse_result_registers() called")
    ...
    def _write_setting_register(self, channel: int, addr: int, value: int, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO._write_setting_register() called")
    ...
    def write_temperature_setting(self, channel: int, value: float):
        _unilab_logger.debug("[UNILAB] PyroIO.write_temperature_setting() called")
    ...
    def write_pressure_setting(self, channel: int, value: float):
        _unilab_logger.debug("[UNILAB] PyroIO.write_pressure_setting() called")
    ...
    def write_salinity_setting(self, channel: int, value: float):
        _unilab_logger.debug("[UNILAB] PyroIO.write_salinity_setting() called")
    ...
    def write_measure_time_setting(self, channel, value):
        _unilab_logger.debug("[UNILAB] PyroIO.write_measure_time_setting() called")
    ...
    def write_intensity_setting(self, channel, value):
        _unilab_logger.debug("[UNILAB] PyroIO.write_intensity_setting() called")
    ...
    def write_amplification_setting(self, channel, value):
        _unilab_logger.debug("[UNILAB] PyroIO.write_amplification_setting() called")
    ...
    def write_frequency_setting(self, channel, value, save=False):
        _unilab_logger.debug("[UNILAB] PyroIO.write_frequency_setting() called")
    ...
    def _write_firesting_frequency_setting(self, channel, value, save=False):
        _unilab_logger.debug("[UNILAB] PyroIO._write_firesting_frequency_setting() called")
    ...
    def write_fiber_type_setting(self, channel: int, fiber_type: int):
        _unilab_logger.debug("[UNILAB] PyroIO.write_fiber_type_setting() called")
    ...
    def _write_calibration_register(self, channel: int, addr: int, value: int, save=False):
        _unilab_logger.debug("[UNILAB] PyroIO._write_calibration_register() called")
    ...
    def write_calibration_register_by_name(self, channel, name, value: float, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO.write_calibration_register_by_name() called")
    ...
    def write_bkgd_amp(self, channel: int, value: float, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO.write_bkgd_amp() called")
    ...
    def write_bkgd_dphi(self, channel: int, value: float, save=True):
        _unilab_logger.debug("[UNILAB] PyroIO.write_bkgd_dphi() called")
