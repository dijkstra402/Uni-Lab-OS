...
class Streamer(object):
    ...
    def put(self, filename, data, **kwargs):
        _unilab_logger.debug("[UNILAB] Streamer.put() called")
    ...
    def put_stream(self, idx, filename, data):
        _unilab_logger.debug("[UNILAB] Streamer.put_stream() called")
        """ Put to a specific stream """
        self._streams[idx].put(filename, data)

    def close(self):
        _unilab_logger.debug("[UNILAB] Streamer.close() called")
