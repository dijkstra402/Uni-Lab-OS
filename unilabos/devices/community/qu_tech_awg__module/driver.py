...
Original: pycqed/instrument_drivers/physical_instruments/QuTech_AWG_Module.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.QuTech_AWG_Module")
...
# Vendored repo packages: pycqed, pycqed.instrument_drivers.physical_instruments.QuTech.QWG
import sys as _sys
...
from pycqed.instrument_drivers.physical_instruments.SCPI import SCPI
...
class QuTech_AWG_Module(SCPI):
    def __init__(self, *args, **kwargs):
        print("[UNILAB] QuTech_AWG_Module.__init__() called", flush=True)
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.stop() called")
        """
    ...
    def _add_codeword_parameters(self):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._add_codeword_parameters() called")
...
#                    snapshot_exclude=True,
    ...
    def _set_cw_waveform(self, ch: int, cw: int, waveform):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._set_cw_waveform() called")
    ...
    def _get_cw_waveform(self, ch: int, cw: int):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._get_cw_waveform() called")
        wf_name = 'wave_ch{}_cw{:03}'.format(ch, cw)
        return self.getWaveformDataFloat(wf_name)

    def start(self):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.start() called")
        """
    ...
    def _setMatrix(self, chPair, mat):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._setMatrix() called")
        """
        Args:
    ...
    def _getMatrix(self, chPair):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._getMatrix() called")
        # function used internally for the parameters because of formatting
    ...
    def _setCodewordProtocol(self, protocol_name):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._setCodewordProtocol() called")
        """
        Args:
    ...
    def _getCodewordProtocol(self):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._getCodewordProtocol() called")
        channels_bit_maps = []
    ...
    def detect_underdrive(self, status):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.detect_underdrive() called")
        """
    ...
    def getErrors(self):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.getErrors() called")
        """
    ...
    def JSON_parser(self, msg):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.JSON_parser() called")
        """
    ...
    def _int_to_array(msg):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._int_to_array() called")
        """
    ...
    def _set_bit_map(self, ch: int, bit_map: List[int]):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._set_bit_map() called")
        """
    ...
    def dio_calibrate(self, target_index: int = ''):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.dio_calibrate() called")
        """
    ...
    def dio_calibration_rapport(self, extended: bool=False) -> str:
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.dio_calibration_rapport() called")
        """
    ...
    def setSeqLength(self, length):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.setSeqLength() called")
        """
        Args:
    ...
    def setSeqElemLoopInfiniteOn(self, element):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.setSeqElemLoopInfiniteOn() called")
        """
        Args:
    ...
    def _getWlistName(self, idx):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._getWlistName() called")
        """
        Args:
            idx(int): 0..size-1
        """
    ...
    def _getWlist(self):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._getWlist() called")
        """
    ...
    def deleteWaveform(self, name):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.deleteWaveform() called")
        """
        Args:
    ...
    def getWaveformType(self, name):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.getWaveformType() called")
        """
        Args:
            name (string):  waveform name excluding double quotes, e.g.
            '*Sine100'
    ...
    def getWaveformLength(self, name):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.getWaveformLength() called")
        """
        Args:
            name (string):  waveform name excluding double quotes, e.g.
            '*Sine100'
    ...
    def newWaveformReal(self, name, len):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.newWaveformReal() called")
        """
        Args:
            name (string):  waveform name excluding double quotes, e.g.
            '*Sine100'
    ...
    def getWaveformDataFloat(self, name):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.getWaveformDataFloat() called")
        """
        Args:
            name (string):  waveform name excluding double quotes, e.g.
            '*Sine100'
    ...
    def sendWaveformDataReal(self, name, waveform):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.sendWaveformDataReal() called")
        """
    ...
    def createWaveformReal(self, name, waveform):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.createWaveformReal() called")
        """
    ...
    def _dio_bit_diff_table(self):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._dio_bit_diff_table() called")
        """
    ...
    def _dio_calibrate_param(self, meas_time: float, nr_itr: int, target_index: int = ""):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._dio_calibrate_param() called")
        """
    ...
    def _dio_set_signals(self, signals: List):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._dio_set_signals() called")
        """
    ...
    def loadWaveformOrSequence(self, awgFileName):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.snapshot_base() called")
        """
    ...
    def _gen_ch_set_func(self, fun, ch):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._gen_ch_set_func() called")
        def set_func(val):
            _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.set_func() called")
            return fun(ch, val)
        return set_func

    def _gen_ch_get_func(self, fun, ch):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._gen_ch_get_func() called")
        def get_func():
            _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.get_func() called")
            return fun(ch)
        return get_func

    def _gen_ch_cw_set_func(self, fun, ch, cw):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._gen_ch_cw_set_func() called")
        def set_func(val):
            _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.set_func() called")
    ...
    def _gen_ch_cw_get_func(self, fun, ch, cw):
        _unilab_logger.debug("[UNILAB] QuTech_AWG_Module._gen_ch_cw_get_func() called")
        def get_func():
            _unilab_logger.debug("[UNILAB] QuTech_AWG_Module.get_func() called")
            return fun(ch, cw)
        return get_func
