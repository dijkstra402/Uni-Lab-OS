...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RawClient")
...
class RawClient(netclient.Netclient):
    ...
    def __init__(self, addr, port):
        print("[UNILAB] RawClient.__init__() called", flush=True)
        """init RawClient
    ...
    def read(self, nelems, data_size=2):
        _unilab_logger.debug("[UNILAB] RawClient.read() called")
    ...
    def get_blocks(self, nelems, data_size=2):
        _unilab_logger.debug("[UNILAB] RawClient.get_blocks() called")
        block = np.array([1])
        while len(block) > 0:
