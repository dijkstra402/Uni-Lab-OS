...
Original: pycqed/instrument_drivers/physical_instruments/RIGOL_DS4043.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RIGOL_DS4043")
...
class RIGOL_DS4043(VisaInstrument):
    ...
    def __init__(self, name, address, **kwargs):
        print("[UNILAB] RIGOL_DS4043.__init__() called", flush=True)
        '''
    ...
    def _set_trigger_mode(self, mode):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043._set_trigger_mode() called")
    ...
    def _set_trigger_source(self, source, mode=None):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043._set_trigger_source() called")
    ...
    def _set_current_channel(self,val):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043._set_current_channel() called")
    ...
    def _set_measurement_source(self, source, mode=None):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043._set_measurement_source() called")
        if source in self._trig_sources:
...
###################
    ...
    def _set_trig_func_par_value(self, mode, par, val):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043._set_trig_func_par_value() called")
        '''
    ...
    def _get_trig_func_par(self, mode, par):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043._get_trig_func_par() called")
        '''
        For internal use only!!
...
##################
    ...
    def read_channels(self,channel_list):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043.read_channels() called")
    ...
    def readwfm(self, channel, npoints=None):
        _unilab_logger.debug("[UNILAB] RIGOL_DS4043.readwfm() called")
        readCnt = 0
        readSum = 0
        readTim = 0
        maxPacket = 0
