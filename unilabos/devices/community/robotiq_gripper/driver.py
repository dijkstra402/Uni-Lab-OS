...
Original: robotiq_hande_ros2_driver/robotiq_hande_ros2_driver/robotiq_gripper.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RobotiqGripper")
...
# Vendored repo packages: robotiq_hande_ros2_driver
import sys as _sys
...
class RobotiqGripper:
    ...
    def __init__(self):
        print("[UNILAB] RobotiqGripper.__init__() called", flush=True)
        """Constructor."""
        self.socket = None
    ...
    def connect(self, hostname, port, socket_timeout = 2.0):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.connect() called")
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.disconnect() called")
        """Closes the connection with the gripper."""
        self.socket.close()

    def _set_vars(self, var_dict):
        _unilab_logger.debug("[UNILAB] RobotiqGripper._set_vars() called")
    ...
    def _set_var(self, variable, value):
        _unilab_logger.debug("[UNILAB] RobotiqGripper._set_var() called")
    ...
    def _get_var(self, variable):
        _unilab_logger.debug("[UNILAB] RobotiqGripper._get_var() called")
    ...
    @staticmethod
    def _is_ack(data):
        _unilab_logger.debug("[UNILAB] RobotiqGripper._is_ack() called")
        return data == b'ack'

    def _reset(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper._reset() called")
        """
        Reset the gripper.
        The following code is executed in the corresponding script function
        def rq_reset(gripper_socket="1"):
            _unilab_logger.debug("[UNILAB] RobotiqGripper.rq_reset() called")
    ...
    def activate(self, auto_calibrate = True):
        ...
        def rq_activate_and_wait(gripper_socket="1"):
            _unilab_logger.debug("[UNILAB] RobotiqGripper.rq_activate_and_wait() called")
            if (not rq_is_gripper_activated(gripper_socket)):
    ...
    def is_active(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.is_active() called")
        """Returns whether the gripper is active."""
        status = self._get_var(self.STA)
        return RobotiqGripper.GripperStatus(status) == RobotiqGripper.GripperStatus.ACTIVE

    def get_min_position(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.get_min_position() called")
        """Returns the minimum position the gripper can reach (open position)."""
        return self._min_position

    def get_max_position(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.get_max_position() called")
        """Returns the maximum position the gripper can reach (closed position)."""
        return self._max_position

    def get_open_position(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.get_open_position() called")
    ...
    def get_closed_position(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.get_closed_position() called")
        """Returns what is considered the closed position for gripper (maximum position value)."""
        return self.get_max_position()

    def is_open(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.is_open() called")
    ...
    def is_closed(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.is_closed() called")
    ...
    def get_current_position(self):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.get_current_position() called")
        """Returns the current position as returned by the physical hardware."""
        return self._get_var(self.POS)

    def auto_calibrate(self, log = True):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.auto_calibrate() called")
    ...
    def move(self, position, speed, force):
        _unilab_logger.debug("[UNILAB] RobotiqGripper.move() called")
        ...
        def clip_val(min_val, val, max_val):
            _unilab_logger.debug("[UNILAB] RobotiqGripper.clip_val() called")
