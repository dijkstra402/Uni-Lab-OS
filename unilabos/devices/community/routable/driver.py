...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Routable")
...
# Vendored repo packages: pv, pv, grugbus, config, misc
import sys as _sys
...
class Routable():
    def __init__( self, router, key ):
        print("[UNILAB] Routable.__init__() called", flush=True)
        self.router = router
        self.key  = key
    ...
    def load_config( self ):
        _unilab_logger.debug("[UNILAB] Routable.load_config() called")
    ...
    """
    async def stop( self ):
        _unilab_logger.debug("[UNILAB] Routable.stop() called")
        pass
    ...
    """
    def dump( self ):
        _unilab_logger.debug("[UNILAB] Routable.dump() called")
        pass
    ...
    """
    async def run( self ):
        _unilab_logger.debug("[UNILAB] Routable.run() called")
        return
    ...
    """
    def get_power( self ):
        _unilab_logger.debug("[UNILAB] Routable.get_power() called")
        pass
    ...
    def get_releaseable_power( self, ctx ):
        _unilab_logger.debug("[UNILAB] Routable.get_releaseable_power() called")
        pass
    ...
    async def take_power( self, ctx ):
        _unilab_logger.debug("[UNILAB] Routable.take_power() called")
        pass
    ...
    """
    def publish( self ):
        _unilab_logger.debug("[UNILAB] Routable.publish() called")
        pass
