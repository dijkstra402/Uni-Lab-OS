...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RPLidar")
...
class RPLidar2(object):
    ...
    def poll(self):
        print("[UNILAB] RPLidar.__init__() called", flush=True)
        if self.running:
            try:
                #
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] RPLidar.update() called")
    ...
    def run_threaded(self):
        _unilab_logger.debug("[UNILAB] RPLidar.run_threaded() called")
        if self.running:
            return self.measurements
        return []
    
    def run(self):
        _unilab_logger.debug("[UNILAB] RPLidar.run() called")
        if not self.running:
            return []
        #
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] RPLidar.shutdown() called")
        self.running = False
        time.sleep(2)
