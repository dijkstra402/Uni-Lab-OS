...
Original: pica/keithley/k2400/RT_K2400_L350_T_Sensing_GUI.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.RT_Backend_Passive")
...
class RT_Backend_Passive:
    ...
    def __init__(self):
        print("[UNILAB] RT_Backend_Passive.__init__() called", flush=True)
    ...
    def connect(self, k2400_visa, ls_visa):
        _unilab_logger.debug("[UNILAB] RT_Backend_Passive.connect() called")
        if not self.rm:
    ...
    def configure_instruments(self, current_ma, compliance_v):
        _unilab_logger.debug("[UNILAB] RT_Backend_Passive.configure_instruments() called")
    ...
    def get_measurement(self):
        _unilab_logger.debug("[UNILAB] RT_Backend_Passive.get_measurement() called")
        voltage = self.k2400.voltage
        temperature = float(self.lakeshore.query('KRDG? A').strip())
        return temperature, voltage

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] RT_Backend_Passive.shutdown() called")
        if self.k2400:
            try:
                self.k2400.shutdown()
