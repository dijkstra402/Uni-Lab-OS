...
Original: PYME/cluster/rules.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Rule")
...
class RuleWatcher(object):
    ...
    def __init__(self):
        print("[UNILAB] Rule.__init__() called", flush=True)
        self.active = True
    ...
    def _ipy_status_update(self):
        _unilab_logger.debug("[UNILAB] Rule._ipy_status_update() called")
    ...
    def watch(self, rule):
        _unilab_logger.debug("[UNILAB] Rule.watch() called")
        import uuid
...
class RuleGroupWatcher(object):
    ...
    def _pre_run_cell(self, info):
        _unilab_logger.debug("[UNILAB] Rule._pre_run_cell() called")
        #print(info)
        import uuid
        self._info = info
    ...
    def _update(self):
        _unilab_logger.debug("[UNILAB] Rule._update() called")
        from IPython.display import update_display
    ...
    def register(self):
        _unilab_logger.debug("[UNILAB] Rule.register() called")
        import IPython
...
class Rule(object):
    ...
    def _populate_rule(self, context, on_completion=None):
        _unilab_logger.debug("[UNILAB] Rule._populate_rule() called")
        """
    ...
    def _task_template(self, context):
        _unilab_logger.debug("[UNILAB] Rule._task_template() called")
        """
    ...
    def prepare(self):
        _unilab_logger.debug("[UNILAB] Rule.prepare() called")
        """
    ...
    def _output_files(self):
        _unilab_logger.debug("[UNILAB] Rule._output_files() called")
    ...
    def output_files(self):
        _unilab_logger.debug("[UNILAB] Rule.output_files() called")
        return self._output_files()
    
    @property
    def complete(self):
        _unilab_logger.debug("[UNILAB] Rule.complete() called")
        """
    ...
    def data_complete(self):
        _unilab_logger.debug("[UNILAB] Rule.data_complete() called")
        """ Is the underlying data complete?"""
        return True
    
    def on_data_complete(self):
        _unilab_logger.debug("[UNILAB] Rule.on_data_complete() called")
        '''Over-ride in derived rules so that, e.g. events can be written at the end of a real-time acquisition '''
        pass
    
    def get_new_tasks(self):
        _unilab_logger.debug("[UNILAB] Rule.get_new_tasks() called")
        """
    ...
    def _getTaskQueueURI(cls, n_retries=2):
        _unilab_logger.debug("[UNILAB] Rule._getTaskQueueURI() called")
        ...
        def _search():
            _unilab_logger.debug("[UNILAB] Rule._search() called")
    ...
    def push(self):
        _unilab_logger.debug("[UNILAB] Rule.push() called")
        self._ruleID = None
    ...
    def _post_rule(self, timeout=3600, max_tasks=1e6, release_start=None, release_end=None):
        _unilab_logger.debug("[UNILAB] Rule._post_rule() called")
    ...
    def _release_tasks(self, release_start, release_end):
        _unilab_logger.debug("[UNILAB] Rule._release_tasks() called")
    ...
    def _mark_complete(self):
        _unilab_logger.debug("[UNILAB] Rule._mark_complete() called")
        """ Thin wrapper around release_rule_tasks api endpoint"""
        from PYME.IO import clusterIO
        s = clusterIO._getSession(self.taskQueueURI)
    ...
    def _poll_loop(self):
        _unilab_logger.debug("[UNILAB] Rule._poll_loop() called")
    ...
    def cleanup(self):
        _unilab_logger.debug("[UNILAB] Rule.cleanup() called")
        self.doPoll = False

    def status(self):
        _unilab_logger.debug("[UNILAB] Rule.status() called")
        from PYME.cluster.distribution import get_cached_queue_info
        return self._get_info(get_cached_queue_info(self.taskQueueURI), errors=False)

    def join(self):
        _unilab_logger.debug("[UNILAB] Rule.join() called")
    ...
    def _watch(self):
        _unilab_logger.debug("[UNILAB] Rule._watch() called")
        import uuid
        from IPython.display import display
    ...
    def _get_info(self, queue_info, errors=True):
        _unilab_logger.debug("[UNILAB] Rule._get_info() called")
        """
    ...
    def _repr_html_(self):
        _unilab_logger.debug("[UNILAB] Rule._repr_html_() called")
        info = self.status()
...
class RuleFactory(object):
    ...
    def get_rule(self, context):
        _unilab_logger.debug("[UNILAB] Rule.get_rule() called")
        """
    ...
    def chain(self, on_completion):
        _unilab_logger.debug("[UNILAB] Rule.chain() called")
        """
    ...
    @property
    def rule_type(self):
        _unilab_logger.debug("[UNILAB] Rule.rule_type() called")
