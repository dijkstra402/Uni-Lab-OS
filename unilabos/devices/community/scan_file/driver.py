...
Original: epicsscan/datafile.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ScanFile")
...
"""
import numpy as np
from epicsscan.file_utils import new_filename, get_timestamp, fix_filename
...
class ScanFile():
    ...
    def __init__(self, name=None, scan=None):
        print("[UNILAB] ScanFile.__init__() called", flush=True)
        self.filename = name
        self.fh = None
        self.scan = scan

    def open_for_write(self, filename=None, mode='a'):
        _unilab_logger.debug("[UNILAB] ScanFile.open_for_write() called")
    ...
    def check_writeable(self):
        _unilab_logger.debug("[UNILAB] ScanFile.check_writeable() called")
    ...
    def flush(self):
        _unilab_logger.debug("[UNILAB] ScanFile.flush() called")
        "flush file"
        if self.fh is not None:
            self.fh.flush()

    def write(self, s):
        _unilab_logger.debug("[UNILAB] ScanFile.write() called")
        "write to file"
        if self.fh is not None:
            self.fh.write(s)

    def close(self):
        _unilab_logger.debug("[UNILAB] ScanFile.close() called")
        "close file"
        if self.fh is not None:
            self.fh.close()

    def write_extrapvs(self):
        _unilab_logger.debug("[UNILAB] ScanFile.write_extrapvs() called")
        "write extra PVS"
        return

    def write_comments(self):
        _unilab_logger.debug("[UNILAB] ScanFile.write_comments() called")
        "write legend"
        return

    def write_legend(self):
        _unilab_logger.debug("[UNILAB] ScanFile.write_legend() called")
        "write legend"
        return

    def write_timestamp(self):
        _unilab_logger.debug("[UNILAB] ScanFile.write_timestamp() called")
        "write timestamp"
        return

    def write_data(self, breakpoint=0, clear=False):
        _unilab_logger.debug("[UNILAB] ScanFile.write_data() called")
        "write data"
        return
