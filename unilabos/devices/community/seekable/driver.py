...
Original: donkeycar/parts/datastore_v2.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Seekable")
...
class Seekable(object):
    ...
    def __init__(self, file, read_only=False, line_lengths=list()):
        print("[UNILAB] Seekable.__init__() called", flush=True)
    ...
    def _read_contents(self):
        _unilab_logger.debug("[UNILAB] Seekable._read_contents() called")
    ...
    def __enter__(self):
        _unilab_logger.debug("[UNILAB] Seekable.__enter__() called")
        return self

    def writeline(self, contents):
        _unilab_logger.debug("[UNILAB] Seekable.writeline() called")
        if self.method == 'r':
    ...
    def seek_line_start(self, line_number):
        _unilab_logger.debug("[UNILAB] Seekable.seek_line_start() called")
        self.file.seek(self._line_start_offset(line_number))

    def seek_end_of_file(self):
        _unilab_logger.debug("[UNILAB] Seekable.seek_end_of_file() called")
        self.file.seek(self.total_length)

    def truncate_until_end(self, line_number):
        _unilab_logger.debug("[UNILAB] Seekable.truncate_until_end() called")
    ...
    def read_from(self, line_number):
        _unilab_logger.debug("[UNILAB] Seekable.read_from() called")
    ...
    def update_line(self, line_number, contents):
        _unilab_logger.debug("[UNILAB] Seekable.update_line() called")
    ...
    def lines(self):
        _unilab_logger.debug("[UNILAB] Seekable.lines() called")
        return len(self.line_lengths)

    def has_content(self):
        _unilab_logger.debug("[UNILAB] Seekable.has_content() called")
        return self.lines() > 0

    def close(self):
        _unilab_logger.debug("[UNILAB] Seekable.close() called")
        self.file.close()

    def __exit__(self, type, value, traceback):
        _unilab_logger.debug("[UNILAB] Seekable.__exit__() called")
        self.close()
