...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SerialConnection")
...
class SerialConnection(AbstractConnection):
    ...
    def __init__(self, connection_parameters: ConnectionParameters):
        print("[UNILAB] SerialConnection.__init__() called", flush=True)
        """
        Args:
    ...
    def open_connection(self):
        _unilab_logger.debug("[UNILAB] SerialConnection.open_connection() called")
    ...
    def connection_listener(self):
        _unilab_logger.debug("[UNILAB] SerialConnection.connection_listener() called")
    ...
    def close_connection(self):
        _unilab_logger.debug("[UNILAB] SerialConnection.close_connection() called")
    ...
    def is_connection_open(self) -> bool:
        _unilab_logger.debug("[UNILAB] SerialConnection.is_connection_open() called")
    ...
    def transmit(self, msg: str):
        _unilab_logger.debug("[UNILAB] SerialConnection.transmit() called")
    ...
    def receive(self, retries: int = 3):
        _unilab_logger.debug("[UNILAB] SerialConnection.receive() called")
