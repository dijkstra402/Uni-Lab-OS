...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ServoBlaster")
...
class ServoBlaster(object):
    ...
    def __init__(self, pin):
        print("[UNILAB] ServoBlaster.__init__() called", flush=True)
        self.pin = pin
    ...
    def set_pulse(self, pulse):
        _unilab_logger.debug("[UNILAB] ServoBlaster.set_pulse() called")
        s = 'P1-%d=%d\n' % (self.pin, pulse)
        self.servoblaster.write(s)
        self.servoblaster.flush()

    def run(self, pulse):
        _unilab_logger.debug("[UNILAB] ServoBlaster.run() called")
        self.set_pulse(pulse)

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] ServoBlaster.shutdown() called")
