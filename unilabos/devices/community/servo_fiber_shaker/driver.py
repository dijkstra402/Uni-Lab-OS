...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ServoFiberShaker")
...
class ServoFiberShaker(FiberShaker):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] ServoFiberShaker.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def TurnOn(self):
        _unilab_logger.debug("[UNILAB] ServoFiberShaker.TurnOn() called")
        self.is_on = True
        self.SetServo(self.channel, self.on_value)

    def TurnOff(self):
        _unilab_logger.debug("[UNILAB] ServoFiberShaker.TurnOff() called")
        self.is_on = False
