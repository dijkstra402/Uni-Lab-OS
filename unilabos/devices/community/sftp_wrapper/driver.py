...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SFTPWrapper")
...
class SFTPWrapper(FTPBaseWrapper):
    ...
    def connect(self, host=None, username=None, password=None):
        print("[UNILAB] SFTPWrapper.__init__() called", flush=True)
        if host is not None:
            self.host = host
    ...
    def cwd(self, remotedir):
        _unilab_logger.debug("[UNILAB] SFTPWrapper.cwd() called")
    ...
    def save(self, remotefile, localfile):
        _unilab_logger.debug("[UNILAB] SFTPWrapper.save() called")
        "save remote file to local file"
        self._conn.get(remotefile, localfile)

    def getlines(self, remotefile):
        _unilab_logger.debug("[UNILAB] SFTPWrapper.getlines() called")
        "read text of remote file"
        tmp = BytesIO()
    ...
    def put(self, text, remotefile):
        _unilab_logger.debug("[UNILAB] SFTPWrapper.put() called")
