...
Original: can/interfaces/slcan.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.slcanBus")
...
class slcanBus(BusABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("[UNILAB] slcanBus.__init__() called", flush=True)
        """
        :param str channel:
    ...
    def set_bitrate(self, bitrate: int, data_bitrate: int | None = None) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus.set_bitrate() called")
        """
        :param bitrate:
            Bitrate in bit/s
        :param data_bitrate:
    ...
    def set_bitrate_reg(self, btr: str) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus.set_bitrate_reg() called")
        """
        :param btr:
    ...
    def _write(self, string: str) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus._write() called")
    ...
    def _read(self, timeout: float | None) -> str | None:
        _unilab_logger.debug("[UNILAB] slcanBus._read() called")
    ...
    def flush(self) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus.flush() called")
        self._buffer.clear()
        with error_check("Could not flush"):
            self.serialPortOrig.reset_input_buffer()

    def open(self) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus.open() called")
    ...
    def close(self) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus.close() called")
        self._write("C")

    def _recv_internal(self, timeout: float | None) -> tuple[Message | None, bool]:
        _unilab_logger.debug("[UNILAB] slcanBus._recv_internal() called")
        canId = None
        remote = False
        extended = False
        data = None
    ...
    def send(self, msg: Message, timeout: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus.send() called")
    ...
    def shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] slcanBus.shutdown() called")
        super().shutdown()
        self.close()
    ...
    def fileno(self) -> int:
        _unilab_logger.debug("[UNILAB] slcanBus.fileno() called")
        try:
    ...
    def get_version(self, timeout: float | None) -> tuple[int | None, int | None]:
        _unilab_logger.debug("[UNILAB] slcanBus.get_version() called")
    ...
    def get_serial_number(self, timeout: float | None) -> str | None:
        _unilab_logger.debug("[UNILAB] slcanBus.get_serial_number() called")
