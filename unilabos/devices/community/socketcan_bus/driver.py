...
Original: can/interfaces/socketcan/socketcan.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SocketcanBus")
...
class SocketcanBus(BusABC):  # pylint: disable=abstract-method
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("[UNILAB] SocketcanBus.__init__() called", flush=True)
    ...
    def shutdown(self) -> None:
        _unilab_logger.debug("[UNILAB] SocketcanBus.shutdown() called")
    ...
    def _recv_internal(self, timeout: float | None) -> tuple[Message | None, bool]:
        _unilab_logger.debug("[UNILAB] SocketcanBus._recv_internal() called")
        try:
    ...
    def send(self, msg: Message, timeout: float | None = None) -> None:
        _unilab_logger.debug("[UNILAB] SocketcanBus.send() called")
    ...
    def _send_once(self, data: bytes, channel: str | None = None) -> int:
        _unilab_logger.debug("[UNILAB] SocketcanBus._send_once() called")
        try:
    ...
    def _send_periodic_internal(
        ...
        _unilab_logger.debug("[UNILAB] SocketcanBus._send_periodic_internal() called")
    ...
    def _get_next_task_id(self) -> int:
        _unilab_logger.debug("[UNILAB] SocketcanBus._get_next_task_id() called")
        with self._task_id_guard:
            self._task_id = (self._task_id + 1) % (2**32 - 1)
            return self._task_id

    def _get_bcm_socket(self, channel: str) -> socket.socket:
        _unilab_logger.debug("[UNILAB] SocketcanBus._get_bcm_socket() called")
    ...
    def _apply_filters(self, filters: can.typechecking.CanFilters | None) -> None:
        _unilab_logger.debug("[UNILAB] SocketcanBus._apply_filters() called")
        try:
            self.socket.setsockopt(
    ...
    def fileno(self) -> int:
        _unilab_logger.debug("[UNILAB] SocketcanBus.fileno() called")
        return self.socket.fileno()

    @staticmethod
    def _detect_available_configs() -> list[can.typechecking.AutoDetectedConfig]:
        _unilab_logger.debug("[UNILAB] SocketcanBus._detect_available_configs() called")
        return [
            {"interface": "socketcan", "channel": channel}
            for channel in find_available_interfaces()
        ]

__all__ = ["SocketcanBus"]
