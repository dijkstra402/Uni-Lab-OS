...
Original: microscope/controllers/lumencor.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.SpectraIIILightEngine")
...
class SpectraIIILightEngine(microscope.abc.Controller):
    ...
    def __init__(self, port: str, **kwargs) -> None:
        print("[UNILAB] SpectraIIILightEngine.__init__() called", flush=True)
    ...
    def devices(self) -> Mapping[str, microscope.abc.Device]:
        _unilab_logger.debug("[UNILAB] SpectraIIILightEngine.devices() called")
        return self._lights
