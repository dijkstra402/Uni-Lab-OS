...
Original: PYME/Acquire/Hardware/driftTracking.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.StandardFrameSource")
...
class StandardFrameSource(object):
    ...
    def __init__(self, frameWrangler):
        print("[UNILAB] StandardFrameSource.__init__() called", flush=True)
    ...
    def tick(self, *args, **kwargs):
        _unilab_logger.debug("[UNILAB] StandardFrameSource.tick() called")
        self._on_frame.send(sender=self, frameData=self._fw.currentFrame)

    @property
    def shape(self):
        _unilab_logger.debug("[UNILAB] StandardFrameSource.shape() called")
        return self._fw.currentFrame.shape
    
    def connect(self, callback):
        _unilab_logger.debug("[UNILAB] StandardFrameSource.connect() called")
        self._on_frame.connect(callback)

    def disconnect(self, callback):
        _unilab_logger.debug("[UNILAB] StandardFrameSource.disconnect() called")
