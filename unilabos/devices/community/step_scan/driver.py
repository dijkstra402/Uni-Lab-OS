...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.StepScan")
...
from epicsscan.file_utils import fix_varname, fix_filename, new_filename

from epicsscan.utils import hms
from epicsscan.detectors import (Counter, Trigger, AreaDetector, SCALER_MODE)
from epicsscan.datafile import ASCIIScanFile
...
class StepScan(object):
    ...
    def set_info(self, attr, value):
        print("[UNILAB] StepScan.__init__() called", flush=True)
    ...
    def open_output_file(self, filename=None, comments=None):
        _unilab_logger.debug("[UNILAB] StepScan.open_output_file() called")
    ...
    def add_counter(self, counter, label=None):
        _unilab_logger.debug("[UNILAB] StepScan.add_counter() called")
        "add simple counter"
    ...
    def add_trigger(self, trigger, label=None, value=1):
        _unilab_logger.debug("[UNILAB] StepScan.add_trigger() called")
    ...
    def add_extra_pvs(self, extra_pvs):
        _unilab_logger.debug("[UNILAB] StepScan.add_extra_pvs() called")
    ...
    def add_positioner(self, pos):
        _unilab_logger.debug("[UNILAB] StepScan.add_positioner() called")
        """ add a Positioner """
    ...
    def add_detector(self, det):
        _unilab_logger.debug("[UNILAB] StepScan.add_detector() called")
    ...
    def set_dwelltime(self, dtime=None):
        _unilab_logger.debug("[UNILAB] StepScan.set_dwelltime() called")
    ...
    def at_break(self, breakpoint=0, clear=False):
        _unilab_logger.debug("[UNILAB] StepScan.at_break() called")
    ...
    def pre_scan(self, row=0, filename=None, **kws):
        _unilab_logger.debug("[UNILAB] StepScan.pre_scan() called")
        dtimer = debugtimer()
    ...
    def post_scan(self, row=0, filename=None, **kws):
        _unilab_logger.debug("[UNILAB] StepScan.post_scan() called")
    ...
    def verify_scan(self):
        _unilab_logger.debug("[UNILAB] StepScan.verify_scan() called")
    ...
    def check_outputs(self, out, msg='unknown'):
        _unilab_logger.debug("[UNILAB] StepScan.check_outputs() called")
    ...
    def read_extra_pvs(self):
        _unilab_logger.debug("[UNILAB] StepScan.read_extra_pvs() called")
    ...
    def clear_data(self):
        _unilab_logger.debug("[UNILAB] StepScan.clear_data() called")
        """clear scan data"""
    ...
    def publish_data(self, cpt, npts=0, scan=None, **kws):
        _unilab_logger.debug("[UNILAB] StepScan.publish_data() called")
    ...
    def set_all_scandata(self):
        _unilab_logger.debug("[UNILAB] StepScan.set_all_scandata() called")
    ...
    def init_scandata(self):
        _unilab_logger.debug("[UNILAB] StepScan.init_scandata() called")
        if self.scandb is None:
            return
    ...
    def set_error(self, msg):
        _unilab_logger.debug("[UNILAB] StepScan.set_error() called")
    ...
    def get_bool(self, key):
        _unilab_logger.debug("[UNILAB] StepScan.get_bool() called")
        if self.scandb is None:
            val = False
        else:
    ...
    def look_for_interrupts(self):
        _unilab_logger.debug("[UNILAB] StepScan.look_for_interrupts() called")
    ...
    def write(self, msg):
        _unilab_logger.debug("[UNILAB] StepScan.write() called")
        self.messenger(msg)

    def clear_interrupts(self):
        _unilab_logger.debug("[UNILAB] StepScan.clear_interrupts() called")
    ...
    def estimate_scan_time(self):
        _unilab_logger.debug("[UNILAB] StepScan.estimate_scan_time() called")
        "estimate scan time"
    ...
    def prepare_scan(self, debug=False):
        _unilab_logger.debug("[UNILAB] StepScan.prepare_scan() called")
        """prepare stepscan"""
        self.pos_settle_time = max(MIN_POLL_TIME, self.pos_settle_time)
        self.det_settle_time = max(MIN_POLL_TIME, self.det_settle_time)
    ...
    def run(self, filename=None, comments=None, debug=False):
        _unilab_logger.debug("[UNILAB] StepScan.run() called")
        """ run a stepscan:
