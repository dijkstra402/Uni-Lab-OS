...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.StreamPipe")
...
class StreamPipe(IStream):
    ...
    def __init__(self, filename):
        print("[UNILAB] StreamPipe.__init__() called", flush=True)
    ...
    def __del__(self):
        _unilab_logger.debug("[UNILAB] StreamPipe.__del__() called")
        self.close()

    def write(self, data):
        _unilab_logger.debug("[UNILAB] StreamPipe.write() called")
        if CONFIG.DEBUG_STREAM_TX:
    ...
    def read(self, size=1):
        _unilab_logger.debug("[UNILAB] StreamPipe.read() called")
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] StreamPipe.close() called")
        if self.pipe:
