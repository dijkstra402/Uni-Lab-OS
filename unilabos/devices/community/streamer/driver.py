...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Streamer")
...
# Vendored repo packages: ble2lsl
import sys as _sys
...
class Streamer(BaseStreamer):
    ...
    def _init_timestamp(self, name, chunk_idx):
        print("[UNILAB] Streamer.__init__() called", flush=True)
    ...
    def start(self):
        _unilab_logger.debug("[UNILAB] Streamer.start() called")
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] Streamer.stop() called")
    ...
    def send_command(self, value):
        _unilab_logger.debug("[UNILAB] Streamer.send_command() called")
    ...
    def disconnect(self):
        _unilab_logger.debug("[UNILAB] Streamer.disconnect() called")
    ...
    def connect(self, max_attempts=20):
        _unilab_logger.debug("[UNILAB] Streamer.connect() called")
    ...
    def _resolve_address(self, name):
        _unilab_logger.debug("[UNILAB] Streamer._resolve_address() called")
    ...
    def _transmit_chunks(self):
        _unilab_logger.debug("[UNILAB] Streamer._transmit_chunks() called")
    ...
    @property
    def backend(self):
        _unilab_logger.debug("[UNILAB] Streamer.backend() called")
        """The name of the `pygatt` backend used by the instance."""
        return self._backend

    @property
    def address(self):
        _unilab_logger.debug("[UNILAB] Streamer.address() called")
