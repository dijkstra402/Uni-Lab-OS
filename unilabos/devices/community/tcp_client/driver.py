...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TcpClient")
...
class TcpClient(Client):
    ...
    def __init__(self, address: str, timeout: float=1.0):
        print("[UNILAB] TcpClient.__init__() called", flush=True)
    ...
    async def __aenter__(self) -> Client:
        _unilab_logger.debug("[UNILAB] TcpClient.__aenter__() called")
    ...
    async def __aexit__(self, *args: Any) -> None:
        _unilab_logger.debug("[UNILAB] TcpClient.__aexit__() called")
        """Provide async exit to context manager."""
        await self.close()

    async def _connect(self) -> None:
        _unilab_logger.debug("[UNILAB] TcpClient._connect() called")
    ...
    async def _read(self, length: int) -> str:
        _unilab_logger.debug("[UNILAB] TcpClient._read() called")
        """Read a fixed number of bytes from the device."""
        await self._handle_connection()
    ...
    async def _readline(self) -> str:
        _unilab_logger.debug("[UNILAB] TcpClient._readline() called")
    ...
    async def _write(self, command: str) -> None:
        _unilab_logger.debug("[UNILAB] TcpClient._write() called")
    ...
    async def _handle_connection(self) -> None:
        _unilab_logger.debug("[UNILAB] TcpClient._handle_connection() called")
    ...
    async def _handle_communication(self, command: str) -> Optional[str]:
        _unilab_logger.debug("[UNILAB] TcpClient._handle_communication() called")
        """Manage communication, including timeouts and logging."""
        try:
            await self._write(command)
    ...
    async def close(self) -> None:
        _unilab_logger.debug("[UNILAB] TcpClient.close() called")
