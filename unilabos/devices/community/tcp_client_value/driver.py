...
Original: donkeycar/parts/network.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TCPClientValue")
...
class TCPClientValue(object):
    ...
    def __init__(self, name, host, port=3233):
        print("[UNILAB] TCPClientValue.__init__() called", flush=True)
        self.name = name
        self.port = port
        self.addr = (host, port)
        self.sock = None
    ...
    def connect(self):
        _unilab_logger.debug("[UNILAB] TCPClientValue.connect() called")
    ...
    def is_connected(self):
        _unilab_logger.debug("[UNILAB] TCPClientValue.is_connected() called")
        return self.sock is not None

    def read(self, sock):
        _unilab_logger.debug("[UNILAB] TCPClientValue.read() called")
    ...
    def reset(self):
        _unilab_logger.debug("[UNILAB] TCPClientValue.reset() called")
        self.sock.close()
        self.sock = None
        self.lastread = time.time()
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] TCPClientValue.run() called")
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] TCPClientValue.shutdown() called")
        self.sock.close()
