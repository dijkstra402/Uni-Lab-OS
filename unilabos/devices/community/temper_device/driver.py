...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.TemperDevice")
...
# Vendored repo packages: temperusb, temperusb
import sys as _sys
...
class TemperDevice(object):
    ...
    def __init__(self, device, sensor_count=1):
        print("[UNILAB] TemperDevice.__init__() called", flush=True)
    ...
    def set_calibration_data(self, scale=None, offset=None):
        _unilab_logger.debug("[UNILAB] TemperDevice.set_calibration_data() called")
        """
    ...
    def lookup_offset(self, sensor):
        _unilab_logger.debug("[UNILAB] TemperDevice.lookup_offset() called")
        """
    ...
    def lookup_humidity_offset(self, sensor):
        _unilab_logger.debug("[UNILAB] TemperDevice.lookup_humidity_offset() called")
        """
    ...
    def lookup_sensor_count(self):
        _unilab_logger.debug("[UNILAB] TemperDevice.lookup_sensor_count() called")
        """
        Lookup the number of sensors on the device by product name.
        """
    ...
    def get_sensor_count(self):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_sensor_count() called")
        """
    ...
    def set_sensor_count(self, count):
        _unilab_logger.debug("[UNILAB] TemperDevice.set_sensor_count() called")
        """
    ...
    def get_product(self):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_product() called")
        """
    ...
    def get_ports(self):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_ports() called")
        """
    ...
    def get_bus(self):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_bus() called")
        """
        Get device USB bus.
        """
        if self._bus:
    ...
    def get_data(self, reset_device=False):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_data() called")
        """
    ...
    def get_temperature(self, format='celsius', sensor=0):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_temperature() called")
        """
    ...
    def get_temperatures(self, sensors=None):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_temperatures() called")
        """
        Get device temperature reading.
    ...
    def get_humidity(self, sensors=None):
        _unilab_logger.debug("[UNILAB] TemperDevice.get_humidity() called")
        """
    ...
    def _control_transfer(self, data):
        _unilab_logger.debug("[UNILAB] TemperDevice._control_transfer() called")
        """
    ...
    def _interrupt_read(self):
        _unilab_logger.debug("[UNILAB] TemperDevice._interrupt_read() called")
        """
    ...
    def close(self):
        _unilab_logger.debug("[UNILAB] TemperDevice.close() called")
