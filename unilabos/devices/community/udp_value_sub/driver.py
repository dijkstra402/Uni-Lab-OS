...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UDPValueSub")
...
class UDPValueSub(object):
    ...
    def __init__(self, name, port = 37021, def_value=None):
        print("[UNILAB] UDPValueSub.__init__() called", flush=True)
    ...
    def run(self):
        _unilab_logger.debug("[UNILAB] UDPValueSub.run() called")
        self.poll()
        return self.last

    def run_threaded(self):
        _unilab_logger.debug("[UNILAB] UDPValueSub.run_threaded() called")
        return self.last

    def update(self):
        _unilab_logger.debug("[UNILAB] UDPValueSub.update() called")
        while self.running:
            self.poll()

    def poll(self):
        _unilab_logger.debug("[UNILAB] UDPValueSub.poll() called")
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] UDPValueSub.shutdown() called")
        self.running = False
        self.client.close()
