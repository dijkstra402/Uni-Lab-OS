...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UP20")
...
# Vendored repo packages: pyusbus, pyusbus
import sys as _sys
...
class UP20:
    ...
    def __init__(self):
        print("[UNILAB] UP20.__init__() called", flush=True)
        """Configure the FTDI interface. 
        """ 
    ...
    def Read512(self):
        _unilab_logger.debug("[UNILAB] UP20.InitOneA() called")
        self.ControlOut(179,1,0,16)
        return struct.unpack( '<512B', self.BulkIn(512) )

    def BulkOutTwo(self,Two):
        _unilab_logger.debug("[UNILAB] UP20.BulkOutTwo() called")
        self.ControlOut(178,1,0,16)
        self.BulkOut(Two)

    def BulkOutTwo512(self,Two):
        _unilab_logger.debug("[UNILAB] UP20.BulkOutTwo512() called")
        self.ControlOut(178,1,0,16)
        self.BulkOut(Two)
        return self.Read512() 

    def BulkOutFour(self,Four):
        _unilab_logger.debug("[UNILAB] UP20.BulkOutFour() called")
        self.ControlOut(178,2,0,16)
        self.BulkOut(Four)
        
    def BulkOutLarge(self,Large):
        _unilab_logger.debug("[UNILAB] UP20.BulkOutLarge() called")
        self.ControlOut(178,2,0,16)
        if len(Large)<=4096:
            self.BulkOut(Large)
        else:
    ...
    def readWrite(self,command):
        _unilab_logger.debug("[UNILAB] UP20.readWrite() called")
    ...
    def Init1004(self,FourBytes):
        _unilab_logger.debug("[UNILAB] UP20.Init1004() called")
    ...
    def InitSeries10(self):               
        _unilab_logger.debug("[UNILAB] UP20.InitOn() called")
    ...
    def InitRegisters(self) :
        _unilab_logger.debug("[UNILAB] UP20.InitArrays() called")
    ...
    def freeze(self):
        _unilab_logger.debug("[UNILAB] UP20.freeze() called")
        self.readWrite(b'\x11\x01') 

    def unfreeze(self):
        _unilab_logger.debug("[UNILAB] UP20.unfreeze() called")
        self.readWrite(b'\x11\x00')
        self.ControlOut(179,0,0,16) # Seems to start: without it, no acqs


    def getImages(self,n=1):
        _unilab_logger.debug("[UNILAB] UP20.getImages() called")
        IMG = self.DLImgs(n)
    ...
    def saveImage(self,n=0):
        _unilab_logger.debug("[UNILAB] UP20.saveImage() called")
    ...
    def DLImgs(self,n=1):
        _unilab_logger.debug("[UNILAB] UP20.DLImgs() called")
        IMG = []
        timings = []
        self.unfreeze()
        k = 0
    ...
    def checkAddress(self,address): 
        _unilab_logger.debug("[UNILAB] UP20.checkAddress() called")
        return self.checkAddressFull(address)[1:2]
    def checkAddressFull(self,address): 
        _unilab_logger.debug("[UNILAB] UP20.checkAddressFull() called")
