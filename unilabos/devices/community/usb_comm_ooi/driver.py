...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.USBCommOOI")
...
class USBCommOOI(USBCommBase):
    ...
    def __init__(self, *args, **kwargs):
        print("[UNILAB] USBCommOOI.__init__() called", flush=True)
        super().__init__(*args, **kwargs)
    def send_command(self, msgtype, payload):
        _unilab_logger.debug("[UNILAB] USBCommOOI.send_command() called")
        data = msgtype % payload
        return self.usb_send(data)

    def innitiate_query(self, msgtype, payload):
        _unilab_logger.debug("[UNILAB] USBCommOOI.innitiate_query() called")
        data = msgtype % payload
        return self.usb_send(data)

    def receive_query(self, alternate_endpoint=False):
        _unilab_logger.debug("[UNILAB] USBCommOOI.receive_query() called")
    ...
    def query(self, msgtype, payload):
        _unilab_logger.debug("[UNILAB] USBCommOOI.query() called")
