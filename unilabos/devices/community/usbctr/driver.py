...
Original: epicsscan/detectors/usbctr.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.USBCTR")
...
from epicsscan.detectors.counter import MCSCounter
...
class USBCTR(Device):
    ...
    def __init__(self, prefix, scaler=None, nchan=8, clockrate=24.0):
        print("[UNILAB] USBCTR.__init__() called", flush=True)
        self._nchan = nchan
        self.scaler = None
    ...
    def InternalMode(self, prescale=None):
        _unilab_logger.debug("[UNILAB] USBCTR.ExternalMode() called")
    ...
    def set_dwelltime(self, val):
        _unilab_logger.debug("[UNILAB] USBCTR.set_dwelltime() called")
        "Set Dwell Time"
    ...
    def ContinuousMode(self, dwelltime=None, numframes=None):
        _unilab_logger.debug("[UNILAB] USBCTR.ContinuousMode() called")
    ...
    def ScalerMode(self, dwelltime=1.0, numframes=1):
        _unilab_logger.debug("[UNILAB] USBCTR.ScalerMode() called")
    ...
    Arguments:
        _unilab_logger.debug("[UNILAB] USBCTR.NDArrayMode() called")
    ...
    def start(self, wait=False):
        _unilab_logger.debug("[UNILAB] USBCTR.ROIMode() called")
        "Start MCS"
        if self.scaler is not None:
    ...
    def stop(self):
        _unilab_logger.debug("[UNILAB] USBCTR.stop() called")
        "Stop MCS Collection"
        self.put('StopAll', 1)
        time.sleep(0.005)
        """
    ...
    def erase(self):
        _unilab_logger.debug("[UNILAB] USBCTR.erase() called")
        "Start MCS"
        return self.put('EraseAll', 1)

    def mcaNread(self, nmcas=1):
        _unilab_logger.debug("[UNILAB] USBCTR.mcaNread() called")
        "Read a MCS MCA"
        return self.get(f'mca{nmcas}.NORD')

    def readmca(self, nmca=1, count=None):
        _unilab_logger.debug("[UNILAB] USBCTR.readmca() called")
        "Read a MCS MCA"
        return self.get(f'mca{nmca}', count=count)

    def read_all_mcas(self):
        _unilab_logger.debug("[UNILAB] USBCTR.read_all_mcas() called")
        return [self.readmca(nmca=i+1) for i in range(self._nchan)]

    def read_scaler_config(self):
        _unilab_logger.debug("[UNILAB] USBCTR.read_scaler_config() called")
    ...
    def save_arraydata(self, filename='sis.dat', npts=None, **kws):
        _unilab_logger.debug("[UNILAB] USBCTR.save_arraydata() called")
    ...
    def get_arraydata(self, npts=None, **kws):
        _unilab_logger.debug("[UNILAB] USBCTR.get_arraydata() called")
        "save MCA spectra to ASCII file"
        t0 = time.time()
...
class USBCTRDetector(DetectorMixin):
    ...
    def apply_offsets(self):
        _unilab_logger.debug("[UNILAB] USBCTR.apply_offsets() called")
    ...
    def arm(self, mode=None, fnum=None, wait=True, numframes=None):
        _unilab_logger.debug("[UNILAB] USBCTR.arm() called")
    ...
    def start(self, mode=None, arm=False, wait=True):
        _unilab_logger.debug("[UNILAB] USBCTR.start() called")
    ...
    def disarm(self, mode=None, wait=False):
        _unilab_logger.debug("[UNILAB] USBCTR.disarm() called")
        self.mcs.stop()
        self.mcs.InternalMode()

    def post_scan(self, **kws):
        _unilab_logger.debug("[UNILAB] USBCTR.post_scan() called")
        "run just after scan"
        self.disarm()
    ...
    def config_filesaver(self, **kws):
        _unilab_logger.debug("[UNILAB] USBCTR.config_filesaver() called")
        "configure filesaver"
        pass
