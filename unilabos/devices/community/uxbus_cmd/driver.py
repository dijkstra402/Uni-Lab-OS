...
Original: xarm/core/wrapper/uxbus_cmd.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.UxbusCmd")
...
class UxbusCmd(object):
    ...
    def __init__(self, set_feedback_key_tranid=None):
        print("[UNILAB] UxbusCmd.__init__() called", flush=True)
    ...
    def last_comm_time(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.last_comm_time() called")
        return self._last_comm_time

    @property
    def state_is_ready(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.state_is_ready() called")
        return self._state_is_ready
    
    def _get_trans_id(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd._get_trans_id() called")
        return 0

    def set_timeout(self, timeout):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_timeout() called")
        try:
    ...
    def getset_nu8(self, funcode, datas, num_send, num_get):
        _unilab_logger.debug("[UNILAB] UxbusCmd.getset_nu8() called")
    ...
    def get_nu8(self, funcode, num):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_nu8() called")
    ...
    def set_nu16(self, funcode, datas, num, additional_bytes=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_nu16() called")
    ...
    def get_nu16(self, funcode, num):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_nu16() called")
        ret = self.send_modbus_request(funcode, 0, 0)
        if ret == -1:
    ...
    def set_nfp32(self, funcode, datas, num, feedback_key=None, feedback_type=XCONF.FeedbackType.MOTION_FINISH):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_nfp32() called")
        need_set_fb = feedback_type != 0 and (self._feedback_type & feedback_type) != feedback_type
        if feedback_key and need_set_fb:
            self._set_feedback_type_no_lock(self._feedback_type | feedback_type)
    ...
    def set_nfp32_with_bytes(self, funcode, datas, num, additional_bytes, rx_len=0, timeout=None, feedback_key=None, feedback_type=XCONF.FeedbackType.MOTION_FINISH):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_nfp32_with_bytes() called")
        need_set_fb = feedback_type != 0 and (self._feedback_type & feedback_type) != feedback_type
        if feedback_key and need_set_fb:
            self._set_feedback_type_no_lock(self._feedback_type | feedback_type)
    ...
    def set_nint32(self, funcode, datas, num, feedback_key=None, feedback_type=XCONF.FeedbackType.MOTION_FINISH):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_nint32() called")
        need_set_fb = feedback_type != 0 and (self._feedback_type & feedback_type) != feedback_type
        if feedback_key and need_set_fb:
            self._set_feedback_type_no_lock(self._feedback_type | feedback_type)
    ...
    def get_nfp32(self, funcode, num, timeout=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_nfp32() called")
        ret = self.send_modbus_request(funcode, 0, 0)
        if ret == -1:
    ...
    def get_nfp32_with_datas(self, funcode, datas, num_send, num_get, timeout=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_nfp32_with_datas() called")
        ret = self.send_modbus_request(funcode, datas, num_send)
        if ret == -1:
            return [XCONF.UxbusState.ERR_NOTTCP]
    ...
    def swop_nfp32(self, funcode, datas, txn, rxn, additional_bytes=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.swop_nfp32() called")
    ...
    def is_nfp32(self, funcode, datas, txn):
        _unilab_logger.debug("[UNILAB] UxbusCmd.is_nfp32() called")
        hexdata = convert.fp32s_to_bytes(datas, txn)
        ret = self.send_modbus_request(funcode, hexdata, txn * 4)
        if ret == -1:
    ...
    def get_version(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_version() called")
        return self.get_nu8(XCONF.UxbusReg.GET_VERSION, 40)

    def get_robot_sn(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_robot_sn() called")
        return self.get_nu8(XCONF.UxbusReg.GET_ROBOT_SN, 40)

    def check_verification(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.check_verification() called")
    ...
    def playback_traj_old(self, value):
        _unilab_logger.debug("[UNILAB] UxbusCmd.playback_traj_old() called")
        txdata = [value]
        return self.set_nint32(XCONF.UxbusReg.PLAY_TRAJ, txdata, 1)

    def save_traj(self, filename, wait_time=2, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.save_traj() called")
    ...
    def load_traj(self, filename, wait_time=2, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.load_traj() called")
        char_list = list(filename)
        txdata = [ord(i) for i in char_list]
        name_len = len(txdata)
        if name_len > 80:
    ...
    def set_xyz_limits(self, xyz_list):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_xyz_limits() called")
    ...
    def get_report_tau_or_i(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_report_tau_or_i() called")
    ...
    def set_allow_approx_motion(self, on_off):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_cartesian_velo_continuous() called")
        txdata = [int(on_off)]
        return self.set_nu8(XCONF.UxbusReg.SET_ALLOW_APPROX_MOTION, txdata, 1)

    def get_allow_approx_motion(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_allow_approx_motion() called")
    ...
    def move_line(self, mvpose, mvvelo, mvacc, mvtime, only_check_type=0, motion_type=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_line() called")
    ...
    def move_line_common(self, mvpose, mvvelo, mvacc, mvtime, radius=-1, coord=0, is_axis_angle=False, only_check_type=0, motion_type=0, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_line_common() called")
        """
        通用指令, 固件1.10.0开始支持 
        """
        txdata = [mvpose[i] for i in range(6)]
    ...
    def move_line_aa(self, mvpose, mvvelo, mvacc, mvtime, mvcoord, relative, only_check_type=0, motion_type=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_line_aa() called")
    ...
    def move_servo_cart_aa(self, mvpose, mvvelo, mvacc, tool_coord, relative):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_servo_cart_aa() called")
        float_data = [mvpose[i] for i in range(6)]
    ...
    def move_relative(self, pose, mvvelo, mvacc, mvtime, radius, is_joint_motion=False, is_angle_axis=False, only_check_type=0, motion_type=0, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_relative() called")
        float_data = [0] * 7
    ...
    def get_position_aa(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_position_aa() called")
    ...
    def get_pose_offset(self, pose1, pose2, orient_type_in=0, orient_type_out=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_pose_offset() called")
    ...
    def move_line_tool(self, mvpose, mvvelo, mvacc, mvtime, only_check_type=0, motion_type=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_line_tool() called")
        txdata = [mvpose[i] for i in range(6)]
        txdata += [mvvelo, mvacc, mvtime]
        if only_check_type <= 0 and motion_type == 0:
    ...
    def move_lineb(self, mvpose, mvvelo, mvacc, mvtime, mvradii, only_check_type=0, motion_type=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_lineb() called")
        txdata = [mvpose[i] for i in range(6)]
    ...
    def move_joint(self, mvjoint, mvvelo, mvacc, mvtime, only_check_type=0, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_joint() called")
    ...
    def move_jointb(self, mvjoint, mvvelo, mvacc, mvradii, only_check_type=0, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_jointb() called")
        txdata = [mvjoint[i] for i in range(7)]
    ...
    def move_gohome(self, mvvelo, mvacc, mvtime, only_check_type=0, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_gohome() called")
        txdata = [mvvelo, mvacc, mvtime]
        if only_check_type <= 0:
    ...
    def move_servoj(self, mvjoint, mvvelo, mvacc, mvtime):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_servoj() called")
        txdata = [mvjoint[i] for i in range(7)]
        txdata += [mvvelo, mvacc, mvtime]
        return self.set_nfp32(XCONF.UxbusReg.MOVE_SERVOJ, txdata, 10)

    def move_servo_cartesian(self, mvpose, mvvelo, mvacc, mvtime):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_servo_cartesian() called")
        txdata = [mvpose[i] for i in range(6)]
        txdata += [mvvelo, mvacc, mvtime]
    ...
    def move_circle(self, pose1, pose2, mvvelo, mvacc, mvtime, percent, only_check_type=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_circle() called")
        txdata = [0] * 16
        for i in range(6):
            txdata[i] = pose1[i]
            txdata[6 + i] = pose2[i]
    ...
    def move_circle_common(self, pose1, pose2, mvvelo, mvacc, mvtime, percent, coord=0, is_axis_angle=False, only_check_type=0, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.move_circle_common() called")
        """
        通用指令, 固件1.10.0开始支持 
        """
        txdata = [0] * 16
    ...
    def set_tcp_load(self, load_mass, load_com, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_tcp_load() called")
    ...
    def tgpio_addr_w16(self, addr, value, bid=XCONF.ROBOT_RS485_HOST_ID, additional_bytes=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_addr_w16() called")
        txdata = bytes([bid])
    ...
    def tgpio_addr_r16(self, addr, bid=XCONF.ROBOT_RS485_HOST_ID, fmt='>i'):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_addr_r16() called")
        txdata = bytes([bid])
        txdata += convert.u16_to_bytes(addr)
    ...
    def tgpio_addr_w32(self, addr, value, bid=XCONF.ROBOT_RS485_HOST_ID):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_addr_w32() called")
        txdata = bytes([bid])
        txdata += convert.u16_to_bytes(addr)
        txdata += convert.fp32_to_bytes(value)
    ...
    def tgpio_addr_r32(self, addr, bid=XCONF.ROBOT_RS485_HOST_ID, fmt='>i'):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_addr_r32() called")
        txdata = bytes([bid])
        txdata += convert.u16_to_bytes(addr)
    ...
    def tgpio_get_digital(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_get_digital() called")
    ...
    def tgpio_set_digital(self, ionum, value, sync=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_set_digital() called")
        tmp = 0
        if ionum == 1:
            tmp = tmp | 0x0100
            if value:
    ...
    def tgpio_get_analog1(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_get_analog1() called")
    ...
    def tgpio_get_analog2(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_get_analog2() called")
    ...
    def set_modbus_timeout(self, value, is_transparent_transmission=False):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_modbus_timeout() called")
        txdata = [int(value)]
    ...
    def set_modbus_baudrate(self, baudrate):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_modbus_baudrate() called")
    ...
    def tgpio_set_modbus(self, modbus_t, len_t, host_id=XCONF.ROBOT_RS485_HOST_ID, limit_sec=0.0, is_transparent_transmission=False, debug=False):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_set_modbus() called")
    ...
    def tgpio_delay_set_digital(self, ionum, on_off, delay_sec):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_delay_set_digital() called")
    ...
    def cgpio_delay_set_digital(self, ionum, on_off, delay_sec):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_delay_set_digital() called")
        txdata = bytes([ionum, on_off])
        txdata += convert.fp32_to_bytes(delay_sec)
    ...
    def cgpio_position_set_digital(self, ionum, on_off, xyz, tol_r):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_position_set_digital() called")
        txdata = bytes([ionum, on_off])
    ...
    def tgpio_position_set_digital(self, ionum, on_off, xyz, tol_r):
        _unilab_logger.debug("[UNILAB] UxbusCmd.tgpio_position_set_digital() called")
        txdata = bytes([ionum, on_off])
        txdata += convert.fp32s_to_bytes(xyz, 3)
        txdata += convert.fp32_to_bytes(tol_r)
    ...
    def cgpio_position_set_analog(self, ionum, value, xyz, tol_r):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_position_set_analog() called")
        txdata = bytes([ionum])
    ...
    def config_io_stop_reset(self, io_type, on_off):
        _unilab_logger.debug("[UNILAB] UxbusCmd.config_io_stop_reset() called")
    ...
    def gripper_modbus_w16s(self, addr, value, count):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_w16s() called")
    ...
    def gripper_modbus_r16s(self, addr, count):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_r16s() called")
        txdata = bytes([XCONF.GRIPPER_ID])
        txdata += bytes([0x03])
        txdata += convert.u16_to_bytes(addr)
        txdata += convert.u16_to_bytes(count)
    ...
    def gripper_modbus_set_en(self, value):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_set_en() called")
    ...
    def gripper_modbus_set_mode(self, value):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_set_mode() called")
        value = convert.u16_to_bytes(int(value))
        return self.gripper_modbus_w16s(XCONF.ServoConf.CON_MODE, value, 1)

    def gripper_modbus_set_zero(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_set_zero() called")
    ...
    def gripper_modbus_get_pos(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_get_pos() called")
    ...
    def gripper_modbus_set_pos(self, pulse):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_set_pos() called")
    ...
    def gripper_modbus_set_posspd(self, speed):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_set_posspd() called")
    ...
    def gripper_modbus_get_errcode(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.gripper_modbus_get_errcode() called")
    ...
    def servo_addr_r16(self, axis_id, addr):
        _unilab_logger.debug("[UNILAB] UxbusCmd.servo_addr_r16() called")
        txdata = bytes([axis_id])
        txdata += convert.u16_to_bytes(addr)
    ...
    def servo_addr_w32(self, axis_id, addr, value):
        _unilab_logger.debug("[UNILAB] UxbusCmd.servo_addr_w32() called")
        txdata = bytes([axis_id])
        txdata += convert.u16_to_bytes(addr)
        txdata += convert.fp32_to_bytes(value)
    ...
    def servo_addr_r32(self, axis, addr):
        _unilab_logger.debug("[UNILAB] UxbusCmd.servo_addr_r32() called")
        txdata = bytes([axis])
        txdata += convert.u16_to_bytes(addr)
    ...
    def cgpio_get_auxdigit(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_get_auxdigit() called")
    ...
    def cgpio_get_analog1(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_get_analog1() called")
    ...
    def cgpio_get_analog2(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_get_analog2() called")
    ...
    def cgpio_set_auxdigit(self, ionum, value, sync=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_set_auxdigit() called")
        tmp = [0] * 2
        if ionum > 7:
    ...
    def cgpio_set_analog1(self, value, sync=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_set_analog1() called")
    ...
    def cgpio_set_analog2(self, value, sync=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cgpio_set_analog2() called")
        txdata = [int(value / 10.0 * 4095.0)]
        if sync is not None:
    ...
    def set_self_collision_detection(self, on_off):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_self_collision_detection() called")
        txdata = [on_off]
        return self.set_nu8(XCONF.UxbusReg.SET_SELF_COLLIS_CHECK, txdata, 1)

    def set_collision_tool_model(self, tool_type, params):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_collision_tool_model() called")
        if len(params) > 0:
    ...
    def vc_set_linev(self, line_v, coord, duration=-1):
        _unilab_logger.debug("[UNILAB] UxbusCmd.vc_set_linev() called")
    ...
    def iden_load(self, iden_type, num_get, timeout=500, estimated_mass=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.iden_load() called")
    ...
    def iden_joint_friction(self, sn, timeout=500):
        _unilab_logger.debug("[UNILAB] UxbusCmd.iden_joint_friction() called")
    ...
    def set_admittance(self, coord, c_axis, M, K, B):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_admittance() called")
        txdata = bytes([coord])
    ...
    def set_admittance_mbk(self, M, K, B):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_admittance_mbk() called")
        txdata = convert.fp32s_to_bytes(M, 6)
        txdata += convert.fp32s_to_bytes(K, 6)
        txdata += convert.fp32s_to_bytes(B, 6)
    ...
    def set_admittance_config(self, coord, c_axis):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_admittance_config() called")
        txdata = bytes([coord])
        txdata += bytes(c_axis[:6])
    ...
    def config_force_control(self, coord, c_axis, f_ref, limits):
        _unilab_logger.debug("[UNILAB] UxbusCmd.config_force_control() called")
        txdata = bytes([coord])
        txdata += bytes(c_axis[:6])
    ...
    def set_force_control_pid(self, kp, ki, kd, xe_limit):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_force_control_pid() called")
    ...
    def ft_sensor_set_zero(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.ft_sensor_set_zero() called")
    ...
    def ft_sensor_get_config(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.ft_sensor_get_config() called")
    ...
    def ft_sensor_get_error(self, is_new=True):
        _unilab_logger.debug("[UNILAB] UxbusCmd.ft_sensor_get_error() called")
        txdata = bytes([8])
    ...
    def cali_tcp_pose(self, four_pnts):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cali_tcp_pose() called")
        txdata = []
        for k in range(4):
    ...
    def cali_user_orient(self, three_pnts, mode=0, trust_ind=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cali_user_orient() called")
        txdata = []
        for k in range(3):
    ...
    def cali_tcp_orient(self, rpy_be, rpy_bt):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cali_tcp_orient() called")
    ...
    def cali_user_pos(self, rpy_ub, pos_b_uorg):
        _unilab_logger.debug("[UNILAB] UxbusCmd.cali_user_pos() called")
    ...
    def get_tcp_rotation_radius(self, value):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_tcp_rotation_radius() called")
        txdata = [value]
        data = [0] * 2
    ...
    def get_max_joint_velocity(self, eveloc, joint_pos):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_max_joint_velocity() called")
        txdata = [eveloc]
    ...
    def linear_motor_modbus_w16s(self, addr, value, length):
        _unilab_logger.debug("[UNILAB] UxbusCmd.linear_motor_modbus_w16s() called")
    ...
    def linear_motor_modbus_r16s(self, addr, length, fcode=0x03):
        _unilab_logger.debug("[UNILAB] UxbusCmd.linear_motor_modbus_r16s() called")
        txdata = bytes([XCONF.LINEAR_MOTOR_ID])
        txdata += bytes([fcode])
        txdata += convert.u16_to_bytes(addr)
        txdata += convert.u16_to_bytes(length)
    ...
    def iden_tcp_load(self, estimated_mass=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.iden_tcp_load() called")
        return self.iden_load(1, 4, timeout=300, estimated_mass=estimated_mass)

    @lock_require
    def servo_error_addr_r32(self, axis, addr):
        _unilab_logger.debug("[UNILAB] UxbusCmd.servo_error_addr_r32() called")
        txdata = bytes([axis])
        txdata += convert.u16_to_bytes(addr)
    ...
    def get_dh_params(self):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_dh_params() called")
        return self.get_nfp32(XCONF.UxbusReg.GET_DH, 28)
    
    def set_dh_params(self, dh_params, flag=0):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_dh_params() called")
        if len(dh_params) < 28:
    ...
    def _set_feedback_type_no_lock(self, feedback_type):
        _unilab_logger.debug("[UNILAB] UxbusCmd._set_feedback_type_no_lock() called")
    ...
    def set_feedback_type(self, feedback_type):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_feedback_type() called")
    ...
    def check_feedback(self, feedback_key=None):
        _unilab_logger.debug("[UNILAB] UxbusCmd.check_feedback() called")
    ...
    def set_modbus_tcp_data(self, datas, raw=True, debug=False):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_modbus_tcp_data() called")
    ...
    def send_hex_cmd(self, datas, timeout=10):
        _unilab_logger.debug("[UNILAB] UxbusCmd.send_hex_cmd() called")
        if len(datas) < 7:
            # datas length error
            return [-2]
    ...
    def set_common_param(self, param_type, param_val):
        _unilab_logger.debug("[UNILAB] UxbusCmd.set_common_param() called")
    ...
    def get_common_param(self, param_type):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_common_param() called")
        txdata = bytes([param_type])
    ...
    def get_common_info(self, param_type):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_common_info() called")
        txdata = bytes([param_type])
    ...
    def get_traj_speeding(self, rate):
        _unilab_logger.debug("[UNILAB] UxbusCmd.get_traj_speeding() called")
        txdata = bytes([rate])
