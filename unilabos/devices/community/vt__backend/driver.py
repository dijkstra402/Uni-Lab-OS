...
Original: pica/keithley/k2400_2182/RT_K2400_K2182_T_Control_GUI.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.VT_Backend")
...
class VT_Backend:
    ...
    def __init__(self):
        print("[UNILAB] VT_Backend.__init__() called", flush=True)
        self.k2400 = None
        self.k2182 = None
        self.lakeshore = None
        if pyvisa:
    ...
    def connect(self, k2400_visa, k2182_visa, ls_visa):
        _unilab_logger.debug("[UNILAB] VT_Backend.connect() called")
        if not self.rm:
    ...
    def configure_instruments(self, current_ma, compliance_v):
        _unilab_logger.debug("[UNILAB] VT_Backend.configure_instruments() called")
        # Lakeshore setup
    ...
    def get_temperature(self):
        _unilab_logger.debug("[UNILAB] VT_Backend.get_temperature() called")
        if not self.lakeshore:
            return 0.0
        return float(self.lakeshore.query('KRDG? A').strip())

    def set_heater_range(self, output, heater_range):
        _unilab_logger.debug("[UNILAB] VT_Backend.set_heater_range() called")
    ...
    def set_setpoint(self, output, temperature_k):
        _unilab_logger.debug("[UNILAB] VT_Backend.set_setpoint() called")
        self.lakeshore.write(f'SETP {output},{temperature_k}')

    def start_ramp(self, end_temp, rate_k_min):
        _unilab_logger.debug("[UNILAB] VT_Backend.start_ramp() called")
    ...
    def get_measurement(self):
        _unilab_logger.debug("[UNILAB] VT_Backend.get_measurement() called")
    ...
    def shutdown(self):
        _unilab_logger.debug("[UNILAB] VT_Backend.shutdown() called")
        if self.k2400:
            try:
                self.k2400.shutdown()
            except Exception:
