...
Original: wasatch/WasatchDeviceWrapper.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.WasatchDeviceWrapper")
...
from wasatch.WrapperWorker import WrapperWorker
...
class WasatchDeviceWrapper:
    ...
    def __init__(self, device_id, log_level, callback=None):
        print("[UNILAB] WasatchDeviceWrapper.__init__() called", flush=True)
    ...
    #
    def connect(self):
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.connect() called")
    ...
    def wait_for_settings(self):
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.wait_for_settings() called")
        while True:
    ...
    def poll_settings(self): 
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.poll_settings() called")
        """ 
    ...
    def reset(self):
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.reset() called")
        if "USB" in str(self.device_id):
            self.reset_tries += 1
            self.command_queue.put(ControlObject("reset", None))

    def disconnect(self):
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.disconnect() called")
    ...
    def acquire_status_message(self):
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.acquire_status_message() called")
    ...
    def send_alert(self, setting, value):
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.send_alert() called")
    ...
    def change_setting(self, setting, value=None):
        _unilab_logger.debug("[UNILAB] WasatchDeviceWrapper.acquire_data() called")
        try:
