...
Original: src/pywatlow/watlow.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Watlow")
...
# Vendored repo packages: pywatlow
import sys as _sys
...
class Watlow():
    ...
    * **address** (int): Watlow controller address (found in the setup menu). Acceptable values are 1 through 16.
    ...
    def __init__(self, serial=None, port=None, timeout=0.5, address=1):
        print("[UNILAB] Watlow.__init__() called", flush=True)
    ...
    def open(self):
        _unilab_logger.debug("[UNILAB] Watlow.open() called")
        self.serial = ser.Serial(self.port, self.baudrate, timeout=self.timeout)

    def close(self):
        _unilab_logger.debug("[UNILAB] Watlow.close() called")
        self.serial.flush()
        self.serial.close()

    def _headerCheckByte(self, headerBytes):
        _unilab_logger.debug("[UNILAB] Watlow._headerCheckByte() called")
        '''
    ...
    def _dataCheckByte(self, dataBytes):
        _unilab_logger.debug("[UNILAB] Watlow._dataCheckByte() called")
        '''
    ...
    def _intDataParamToHex(self, dataParam):
        _unilab_logger.debug("[UNILAB] Watlow._intDataParamToHex() called")
    ...
    def _byteDataParamToInt(self, hexParam):
        _unilab_logger.debug("[UNILAB] Watlow._byteDataParamToInt() called")
    ...
    def _buildZone(self, address):
        _unilab_logger.debug("[UNILAB] Watlow._buildZone() called")
        '''
    ...
    def _buildReadRequest(self, dataParam, instance='01'):
        _unilab_logger.debug("[UNILAB] Watlow._buildReadRequest() called")
        '''
    ...
    def _buildWriteRequest(self, dataParam, value, data_type, instance='01'):
        _unilab_logger.debug("[UNILAB] Watlow._buildWriteRequest() called")
        '''
    ...
    def _validateResponse(self, bytesResponse):
        _unilab_logger.debug("[UNILAB] Watlow._validateResponse() called")
        '''
    ...
    def _parseResponse(self, bytesResponse):
        _unilab_logger.debug("[UNILAB] Watlow._parseResponse() called")
        '''
    ...
    def read(self, instance='01'):
        _unilab_logger.debug("[UNILAB] Watlow.read() called")
        '''
    ...
    def readSetpoint(self, instance='01'):
        _unilab_logger.debug("[UNILAB] Watlow.readSetpoint() called")
        '''
    ...
    def readParam(self, param, data_type, instance='01'):
        _unilab_logger.debug("[UNILAB] Watlow.readParam() called")
        '''
    ...
    def write(self, value, instance='01'):
        _unilab_logger.debug("[UNILAB] Watlow.write() called")
        '''
    ...
    def writeParam(self, param, value, data_type, instance='01'):
        _unilab_logger.debug("[UNILAB] Watlow.writeParam() called")
        '''
