...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.WebFpv")
...
class WebFpv(Application):
    ...
    def __init__(self, port=8890):
        print("[UNILAB] WebFpv.__init__() called", flush=True)
        self.port = port
        this_dir = os.path.dirname(os.path.realpath(__file__))
        self.static_file_path = os.path.join(this_dir, 'templates', 'static')
    ...
    def update(self):
        _unilab_logger.debug("[UNILAB] WebFpv.update() called")
        """ Start the tornado webserver. """
        asyncio.set_event_loop(asyncio.new_event_loop())
        self.listen(self.port)
    ...
    def run_threaded(self, img_arr=None):
        _unilab_logger.debug("[UNILAB] WebFpv.run_threaded() called")
        self.img_arr = img_arr

    def run(self, img_arr=None):
        _unilab_logger.debug("[UNILAB] WebFpv.run() called")
        self.img_arr = img_arr

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] WebFpv.shutdown() called")
        pass
