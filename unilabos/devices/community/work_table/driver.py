...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.WorkTable")
...
# Vendored repo packages: EvoScriPy, EvoScriPy
import sys as _sys
...
class WorkTable:
    ...
    def __init__(self, template_file, robot_protocol=None, grids=67, sites=127):
        print("[UNILAB] WorkTable.__init__() called", flush=True)
    ...
    class Location:
        ...
        def __str__(self):
            _unilab_logger.debug("[UNILAB] WorkTable.__str__() called")
    ...
    class File:
        ...
        def write(self, worktable):
            _unilab_logger.debug("[UNILAB] WorkTable.write() called")
            lines = [
                self.check_summa,
        ...
        def grid_carrier_line(self):
            _unilab_logger.debug("[UNILAB] WorkTable.grid_carrier_line() called")
            line = "14;"
            labw = {}

    def parse_worktable_file(self, template_file, robot_protocol):
        _unilab_logger.debug("[UNILAB] WorkTable.parse_worktable_file() called")
    ...
    def _read_worktable_header(self, template):
        _unilab_logger.debug("[UNILAB] WorkTable._read_worktable_header() called")
    ...
    def _read_worktable_carriers_grid(self, template, robot_protocol):
        _unilab_logger.debug("[UNILAB] WorkTable._read_worktable_carriers_grid() called")
        template_list = []  # a grid-line first list the types
    ...
    def _read_worktable_labwares_grid(self, template, robot_protocol):
        _unilab_logger.debug("[UNILAB] WorkTable._read_worktable_labwares_grid() called")
    ...
    def add_new_labware(self, labware, loc: Location = None):
        _unilab_logger.debug("[UNILAB] WorkTable.add_new_labware() called")
        """
    ...
    def add_labware(self, labware, loc : Location):
        _unilab_logger.debug("[UNILAB] WorkTable.add_labware() called")
        """
    ...
    def get_current_labware(self, labware):
        _unilab_logger.debug("[UNILAB] WorkTable.get_current_labware() called")
    ...
    def set_current(self, labware):
        _unilab_logger.debug("[UNILAB] WorkTable.set_current() called")
        assert isinstance(labware, Labware)
    ...
    def get_labware(self, label: (str, int) = None, labw_type=None):
        _unilab_logger.debug("[UNILAB] WorkTable.get_labware() called")
        """
    ...
    def set_first_pos(self, labw_type_name=None, posstr=None):
        _unilab_logger.debug("[UNILAB] WorkTable.set_first_pos() called")
        """
    ...
    def retire_labware(self, labw):
        _unilab_logger.debug("[UNILAB] WorkTable.retire_labware() called")
    ...
    def replace_with_new(self, labw, label):
        _unilab_logger.debug("[UNILAB] WorkTable.replace_with_new() called")
        assert isinstance(labw, Labware )
        loc = labw.location
    ...
    def set_def_DiTi(self, tips):                 # :Labware.DITIrackType) ->Labware.DITIrackType:
        _unilab_logger.debug("[UNILAB] WorkTable.set_def_DiTi() called")
    ...
    def get_DITI_series(self, rack =None):
        _unilab_logger.debug("[UNILAB] WorkTable.get_DITI_series() called")
        """
