...
Original: epicsscan/detectors/xspress3.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.Xspress3Detector")
...
from epicsscan.detectors.ad_mca import ADMCA
from epicsscan.detectors.counter import (Counter, DummyCounter, DeviceCounter, Saveable,
                      ROISumCounter)
from epicsscan.detectors.base import DetectorMixin, SCALER_MODE, NDARRAY_MODE, ROI_MODE
from epicsscan.detectors.areadetector import ADFileMixin, get_adversion
...
class Xspress3Detector(DetectorMixin):
    ...
    def __repr__(self):
        print("[UNILAB] Xspress3Detector.__init__() called", flush=True)
    ...
    def connect_counters(self):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.connect_counters() called")
    ...
    def config_filesaver(self, **kws):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.config_filesaver() called")
        self._xsp3.config_filesaver(**kws)

    def save_calibration(self, filename, **kws):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.save_calibration() called")
    ...
    def post_scan(self, **kws):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.pre_scan() called")
        "run just after scan"
        self.disarm()
        self.ContinuousMode()
        time.sleep(0.025)
    ...
    def ContinuousMode(self, dwelltime=0.25, numframes=16384):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.ContinuousMode() called")
    ...
    def ScalerMode(self, dwelltime=None, numframes=1, erase=True):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.ScalerMode() called")
    ...
    def ROIMode(self, dwelltime=None, numframes=None):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.ROIMode() called")
    ...
    def NDArrayMode(self, dwelltime=None, numframes=None):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.NDArrayMode() called")
    ...
    def set_dwelltime(self, dwelltime):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.set_dwelltime() called")
        """set dwell time in seconds
    ...
    def get_next_filename(self):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.get_next_filename() called")
        return self._xsp3.getNextFileName()

    def get_numcaptured(self):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.get_numcaptured() called")
        return self._xsp3.getNumCaptured_RBV()

    def get_last_filename(self):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.get_last_filename() called")
        return self._xsp3.getLastFileName()

    def finish_capture(self):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.finish_capture() called")
        # print("FINISH CAPTURE ")
        self._xsp3.FileCaptureOff()
        time.sleep(0.1)

    def arm(self, mode=None, fnum=None, wait=True, numframes=None):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.arm() called")
        t0 = time.time()
        if mode is not None:
            self.mode = mode
    ...
    def arm_complete(self):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.arm_complete() called")
        return self._xsp3._pvs['ERASE'].put_complete

    def disarm(self, mode=None, wait=False):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.disarm() called")
        if mode is not None:
            self.mode = mode
        if wait:
    ...
    def start(self, mode=None, arm=False, wait=True):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.start() called")
        if mode is not None:
            self.mode = mode
        if arm:
    ...
    def stop(self, mode=None, disarm=False, wait=False):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.stop() called")
        self._xsp3.put('Acquire', 0, wait=wait)
        if disarm:
            self.disarm()

    def save_arraydata(self, filenasme=None):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.save_arraydata() called")
        pass

    def file_write_complete(self):
        _unilab_logger.debug("[UNILAB] Xspress3Detector.file_write_complete() called")
        return self._xsp3.FileWriteComplete()

__all__ = ["Xspress3Detector"]
