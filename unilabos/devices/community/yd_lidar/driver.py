...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.YDLidar")
...
class YDLidar(object):
    ...
    def __init__(self, port='/dev/ttyUSB0'):
        print("[UNILAB] YDLidar.__init__() called", flush=True)
        import PyLidar3
        self.port = port
        self.distances = [] #a list of distance measurements
        self.angles = [] # a list of angles corresponding to dist meas above
    ...
    def init(self, port='/dev/ttyUSB0'):
        _unilab_logger.debug("[UNILAB] YDLidar.init() called")
        import PyLidar3
    ...
    def update(self, lidar, debug = False):
        _unilab_logger.debug("[UNILAB] YDLidar.update() called")
        while self.on:
            try:
    ...
    def run_threaded(self):
        _unilab_logger.debug("[UNILAB] YDLidar.run_threaded() called")
        return self.distances, self.angles

    def shutdown(self):
        _unilab_logger.debug("[UNILAB] YDLidar.shutdown() called")
        self.on = False
        time.sleep(2)
