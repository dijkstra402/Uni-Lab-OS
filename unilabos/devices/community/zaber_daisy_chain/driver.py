...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ZaberDaisyChain")
...
class ZaberDaisyChain(microscope.abc.Controller):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("[UNILAB] ZaberDaisyChain.__init__() called", flush=True)
        super().__init__(**kwargs)
    ...
    def devices(self) -> Dict[str, microscope.abc.Device]:
        _unilab_logger.debug("[UNILAB] ZaberDaisyChain.devices() called")
