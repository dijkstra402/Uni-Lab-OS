...
Original: deprecated/pycqed/instrument_drivers/physical_instruments/ZurichInstruments/attic/zishell.py
...
# Unilab 驱动调试日志
_unilab_logger = logging.getLogger("unilab.driver.ziShellDevice")
...
class ziShellDevice:
    ...
    def __init__(self, device="", host="", port=8004, interface="1GbE", api_level=5):
        print("[UNILAB] ziShellDevice.__init__() called", flush=True)
    ...
    def connect_server(self, host, port=8004, api_level=5):
        _unilab_logger.debug("[UNILAB] ziShellDevice.connect_server() called")
    ...
    def reconnect(self):
        _unilab_logger.debug("[UNILAB] ziShellDevice.reconnect() called")
    ...
    def connect_device(self, device, interface='1GbE'):
        _unilab_logger.debug("[UNILAB] ziShellDevice.connect_device() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def load_settings(self, path):
        _unilab_logger.debug("[UNILAB] ziShellDevice.load_settings() called")
        if not self.daq:
            raise(ziShellDAQError())

        def _load_settings(r, path, nodes):
            _unilab_logger.debug("[UNILAB] ziShellDevice._load_settings() called")
            if not len(r):
                # Got leaf
                value = float(r.text)
    ...
    def features(self):
        _unilab_logger.debug("[UNILAB] ziShellDevice.features() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def setd(self, path, value, sync = False):
        _unilab_logger.debug("[UNILAB] ziShellDevice.setd() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def seti(self, path, value, sync = False):
        _unilab_logger.debug("[UNILAB] ziShellDevice.seti() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def setv(self, path, value):
        _unilab_logger.debug("[UNILAB] ziShellDevice.setv() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def geti(self, path, deep=True):
        _unilab_logger.debug("[UNILAB] ziShellDevice.geti() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def getd(self, path, deep=True):
        _unilab_logger.debug("[UNILAB] ziShellDevice.getd() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def getv(self, path):
        _unilab_logger.debug("[UNILAB] ziShellDevice.getv() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def find(self, *args):
        _unilab_logger.debug("[UNILAB] ziShellDevice.find() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def finds(self, *args):
        _unilab_logger.debug("[UNILAB] ziShellDevice.finds() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def subs(self, path):
        _unilab_logger.debug("[UNILAB] ziShellDevice.subs() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def unsubs(self, path):
        _unilab_logger.debug("[UNILAB] ziShellDevice.unsubs() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def poll(self, length=0.1):
        _unilab_logger.debug("[UNILAB] ziShellDevice.poll() called")
        if not self.daq:
            raise(ziShellDAQError())
    ...
    def sync(self):
        _unilab_logger.debug("[UNILAB] ziShellDevice.sync() called")
        global env
    ...
    def __str__(self):
        _unilab_logger.debug("[UNILAB] ziShellDevice.__str__() called")
        return self.device
